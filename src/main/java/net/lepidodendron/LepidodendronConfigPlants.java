...
public class LepidodendronConfigPlants {
    ...
    public static boolean genPalaeognetaleanaGlossopterisAmpla = false;
    ...
    public static boolean syncConfigPlantsPart2() {
        ...
        prop.setComment("Set to true to generate Palaeognetaleana naturally on Glossopteris cyclopteroides trees [default: false]");
        ...
        prop.setComment("Set to true to generate Palaeognetaleana naturally on Glossopteris angustifolia trees [default: false]");
        genPalaeognetaleanaGlossopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palaeognetaleana", "genPalaeognetaleanaGlossopterisAmpla", genPalaeognetaleanaGlossopterisAmpla);
        prop.setComment("Set to true to generate Palaeognetaleana naturally on Glossopteris ampla trees [default: false]");
        genPalaeognetaleanaGlossopterisAmpla = prop.getBoolean();
        propOrder.add(prop.getName());
