...
public class LepidodendronConfigPlants {
    ...
    public static boolean syncConfigPlantsPart1() {
        ...
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "genGangamopteris", genGangamopteris);
        prop.setComment("Set to true to generate Glossopteris cyclopteroides trees naturally [default: false]");
        genGangamopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "genGangamopterisBlacklistBiomes", genGangamopterisBlacklistBiomes);
        prop.setComment("List of biomes Glossopteris cyclopteroides trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGangamopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "genGangamopterisOverrideBiomes", genGangamopterisOverrideBiomes);
        prop.setComment("List of biomes Glossopteris cyclopteroides trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGangamopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "genGangamopterisBush", genGangamopterisBush);
        prop.setComment("Set to true to generate Glossopteris cyclopteroides bushy variants naturally [default: false]");
        genGangamopterisBush = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "dimGangamopteris", dimGangamopteris);
        prop.setComment("List of dimension IDs Glossopteris cyclopteroides trees can generate in [default: 0]");
        dimGangamopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "minheightGangamopteris", minheightGangamopteris);
        prop.setComment("Minimum height that Glossopteris cyclopteroides trees can generate (1 to 250) [default: 1]");
        minheightGangamopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "maxheightGangamopteris", maxheightGangamopteris);
        prop.setComment("Maximum height that Glossopteris cyclopteroides trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightGangamopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris cyclopteroides", "multiplierGangamopteris", multiplierGangamopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
