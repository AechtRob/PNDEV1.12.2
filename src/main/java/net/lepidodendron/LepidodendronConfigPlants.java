...
public class LepidodendronConfigPlants {
    ...
    public static boolean syncConfigPlantsPart1() {
        ...
        prop.setComment("Set to true to generate Embothrium naturally [default: false]");
        genEmbothrium = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "genEmbothriumBlacklistBiomes", genEmbothriumBlacklistBiomes);
        prop.setComment("List of biomes Embothrium are blacklisted from, in the format: modid:biomeid [default: empty]");
        ...
        prop.setComment("List of biomes Embothrium are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genEmbothriumOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Embothrium", "dimEmbothrium", dimEmbothrium);
        prop.setComment("List of dimension IDs Embothrium can generate in [default: 0]");
        dimEmbothrium = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "minheightEmbothrium", minheightEmbothrium);
        prop.setComment("Minimum height that Embothrium can generate (1 to 250) [default: 1]");
        minheightEmbothrium = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "maxheightEmbothrium", maxheightEmbothrium);
        prop.setComment("Maximum height that Embothrium can generate (1 to 250, or set to 0 for unlimited) [default: 150]");
