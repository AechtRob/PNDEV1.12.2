...
public class LepidodendronConfigPlants {
    ...
    public static boolean genGangamopteris = false;
    public static String[] genGangamopterisBlacklistBiomes = new String[0];
    public static String[] genGangamopterisOverrideBiomes = new String[0];
    public static int[] dimGangamopteris = new int[]{0};
    public static boolean genGangamopterisBush = false;
    public static int minheightGangamopteris = 1;
    public static int maxheightGangamopteris = 90;
    public static double multiplierGangamopteris = 1;
    public static boolean genGlossopterisAmpla = false;
    public static String[] genGlossopterisAmplaBlacklistBiomes = new String[0];
    public static String[] genGlossopterisAmplaOverrideBiomes = new String[0];
    public static int[] dimGlossopterisAmpla = new int[]{0};
    public static boolean genGlossopterisAmplaBush = false;
    public static int minheightGlossopterisAmpla = 1;
    public static int maxheightGlossopterisAmpla = 90;
    public static double multiplierGlossopterisAmpla = 1;
    public static boolean genGlossopterisDuocaudata = false;
    public static String[] genGlossopterisDuocaudataBlacklistBiomes = new String[0];
    public static String[] genGlossopterisDuocaudataOverrideBiomes = new String[0];
    public static int[] dimGlossopterisDuocaudata = new int[]{0};
    public static boolean genGlossopterisDuocaudataBush = false;
    public static int minheightGlossopterisDuocaudata = 1;
    public static int maxheightGlossopterisDuocaudata = 90;
    public static double multiplierGlossopterisDuocaudata = 1;
    ...
    public static boolean genFig = false;
    public static String[] genFigBlacklistBiomes = new String[0];
    public static String[] genFigOverrideBiomes = new String[0];
    public static int[] dimFig = new int[]{0};
    public static int minheightFig = 1;
    public static int maxheightFig = 100;
    public static double multiplierFig = 1;
    public static boolean genFigBanyan = false;
    public static String[] genFigBanyanBlacklistBiomes = new String[0];
    public static String[] genFigBanyanOverrideBiomes = new String[0];
    public static int[] dimFigBanyan = new int[]{0};
    public static int minheightFigBanyan = 1;
    public static int maxheightFigBanyan = 100;
    public static double multiplierFigBanyan = 1;
    public static boolean genCalycanthus = false;
    public static String[] genCalycanthusBlacklistBiomes = new String[0];
    public static String[] genCalycanthusOverrideBiomes = new String[0];
    public static int[] dimCalycanthus = new int[]{0};
    public static int minheightCalycanthus = 1;
    public static int maxheightCalycanthus = 90;
    public static double multiplierCalycanthus = 1;
    public static boolean genJerseyanthus = false;
    public static String[] genJerseyanthusBlacklistBiomes = new String[0];
    public static String[] genJerseyanthusOverrideBiomes = new String[0];
    public static int[] dimJerseyanthus = new int[]{0};
    public static int minheightJerseyanthus = 1;
    public static int maxheightJerseyanthus = 90;
    public static double multiplierJerseyanthus = 1;
    public static boolean genIlicium = false;
    public static String[] genIliciumBlacklistBiomes = new String[0];
    public static String[] genIliciumOverrideBiomes = new String[0];
    public static int[] dimIlicium = new int[]{0};
    public static int minheightIlicium = 1;
    public static int maxheightIlicium = 90;
    public static double multiplierIlicium = 1;
    public static boolean genAmborella = false;
    public static String[] genAmborellaBlacklistBiomes = new String[0];
    public static String[] genAmborellaOverrideBiomes = new String[0];
    public static int[] dimAmborella = new int[]{0};
    public static int minheightAmborella = 1;
    public static int maxheightAmborella = 90;
    public static double multiplierAmborella = 1;
    public static boolean genPandan = false;
    public static String[] genPandanBlacklistBiomes = new String[0];
    public static String[] genPandanOverrideBiomes = new String[0];
    public static int[] dimPandan = new int[]{0};
    public static int minheightPandan = 1;
    public static int maxheightPandan = 90;
    public static double multiplierPandan = 1;
    public static boolean genRattan = false;
    public static String[] genRattanBlacklistBiomes = new String[0];
    public static String[] genRattanOverrideBiomes = new String[0];
    public static int[] dimRattan = new int[]{0};
    public static int minheightRattan = 1;
    public static int maxheightRattan = 90;
    public static double multiplierRattan = 1;
    ...
    public static boolean spreadArthropitys = true;
    public static boolean spreadWorldGenArthropitys = true;
    public static boolean spreadUnlimitedArthropitys = false;
    public static int spreadLimitArthropitys = 16;
    public static int spreadWaterArthropitys = 6;
    public static int spreadSpeedArthropitys = 50;
    ...
    public static boolean genMonanthesia = false;
    public static String[] genMonanthesiaBlacklistBiomes = new String[0];
    public static String[] genMonanthesiaOverrideBiomes = new String[0];
    public static int[] dimMonanthesia = new int[]{0};
    public static int minheightMonanthesia = 1;
    public static int maxheightMonanthesia = 90;
    public static double multiplierMonanthesia = 1;
    ...
    public static boolean genCedar = false;
    ...
    public static boolean genPalissya = false;
    public static String[] genPalissyaBlacklistBiomes = new String[0];
    public static String[] genPalissyaOverrideBiomes = new String[0];
    public static int[] dimPalissya = new int[]{0};
    public static int minheightPalissya = 1;
    public static int maxheightPalissya = 90;
    public static double multiplierPalissya = 1;
    ...
    public static boolean genTodea = false;
    public static String[] genTodeaBlacklistBiomes = new String[0];
    public static String[] genTodeaOverrideBiomes = new String[0];
    public static int[] dimTodea = new int[]{0};
    public static int minheightTodea = 1;
    public static int maxheightTodea = 90;
    public static double multiplierTodea = 1;
    ...
    public static int[] dimEmbothrium = new int[]{0};
    public static int minheightEmbothrium = 1;
    public static int maxheightEmbothrium = 150;
    public static double multiplierEmbothrium = 1;
    ...
    public static boolean genBurnishedTreefern = false;
    public static String[] genBurnishedTreefernBlacklistBiomes = new String[0];
    public static String[] genBurnishedTreefernOverrideBiomes = new String[0];
    public static int[] dimBurnishedTreefern = new int[]{0};
    public static int minheightBurnishedTreefern = 1;
    public static int maxheightBurnishedTreefern = 190;
    public static double multiplierBurnishedTreefern = 1;
    ...
    public static boolean genCordaitesDry = false;
    public static String[] genCordaitesDryBlacklistBiomes = new String[0];
    public static String[] genCordaitesDryOverrideBiomes = new String[0];
    public static int[] dimCordaitesDry = new int[]{0};
    public static int minheightCordaitesDry = 1;
    public static int maxheightCordaitesDry = 90;
    public static double multiplierCordaitesDry = 1;
    ...
    public static boolean genSinocarpus = false;
    public static String[] genSinocarpusBlacklistBiomes = new String[0];
    public static String[] genSinocarpusOverrideBiomes = new String[0];
    public static int[] dimSinocarpus = new int[]{0};
    public static int minheightSinocarpus = 1;
    public static int maxheightSinocarpus = 90;
    public static double multiplierSinocarpus = 1;
    ...
    public static boolean genZingiberopsis = false;
    public static String[] genZingiberopsisBlacklistBiomes = new String[0];
    public static String[] genZingiberopsisOverrideBiomes = new String[0];
    public static int[] dimZingiberopsis = new int[]{0};
    public static int minheightZingiberopsis = 1;
    public static int maxheightZingiberopsis = 85;
    public static double multiplierZingiberopsis = 1;
    public static boolean genRehezamites = false;
    public static String[] genRehezamitesBlacklistBiomes = new String[0];
    public static String[] genRehezamitesOverrideBiomes = new String[0];
    public static int[] dimRehezamites = new int[]{0};
    public static int minheightRehezamites = 1;
    public static int maxheightRehezamites = 85;
    public static double multiplierRehezamites = 1;
    ...
    public static boolean genIrania = false;
    public static String[] genIraniaBlacklistBiomes = new String[0];
    public static String[] genIraniaOverrideBiomes = new String[0];
    public static int[] dimIrania = new int[]{0};
    public static int minheightIrania = 1;
    public static int maxheightIrania = 0;
    public static double multiplierIrania = 1;

    public static boolean genGunnera = false;
    public static String[] genGunneraBlacklistBiomes = new String[0];
    public static String[] genGunneraOverrideBiomes = new String[0];
    public static int[] dimGunnera = new int[]{0};
    public static int minheightGunnera = 1;
    public static int maxheightGunnera = 0;
    public static double multiplierGunnera = 1;
    ...
    public static boolean genCalamopitys = false;
    public static String[] genCalamopitysBlacklistBiomes = new String[0];
    public static String[] genCalamopitysOverrideBiomes = new String[0];
    public static int[] dimCalamopitys = new int[]{0};
    ...
    public static boolean genBotrychiopsis = false;
    public static String[] genBotrychiopsisBlacklistBiomes = new String[0];
    public static String[] genBotrychiopsisOverrideBiomes = new String[0];
    public static int[] dimBotrychiopsis = new int[]{0};
    public static int minheightBotrychiopsis = 1;
    public static int maxheightBotrychiopsis = 90;
    public static double multiplierBotrychiopsis = 1;
    ...
    public static boolean genMicrovictoria = false;
    public static String[] genMicrovictoriaBlacklistBiomes = new String[0];
    public static String[] genMicrovictoriaOverrideBiomes = new String[0];
    public static int[] dimMicrovictoria = new int[]{0};
    public static int minheightMicrovictoria = 1;
    public static int maxheightMicrovictoria = 90;
    public static double multiplierMicrovictoria = 1;
    public static boolean genNuphar = false;
    public static String[] genNupharBlacklistBiomes = new String[0];
    public static String[] genNupharOverrideBiomes = new String[0];
    public static int[] dimNuphar = new int[]{0};
    public static int minheightNuphar = 1;
    public static int maxheightNuphar = 90;
    public static double multiplierNuphar = 1;
    ...
    public static boolean genThinnfeldia = false;
    public static String[] genThinnfeldiaBlacklistBiomes = new String[0];
    public static String[] genThinnfeldiaOverrideBiomes = new String[0];
    public static int[] dimThinnfeldia = new int[]{0};
    public static int minheightThinnfeldia = 0;
    public static int maxheightThinnfeldia = 70;
    public static double multiplierThinnfeldia = 1;
    ...
    public static boolean genSapindopsis = false;
    public static String[] genSapindopsisBlacklistBiomes = new String[0];
    public static String[] genSapindopsisOverrideBiomes = new String[0];
    public static int[] dimSapindopsis = new int[]{0};
    public static int minheightSapindopsis = 110;
    public static int maxheightSapindopsis = 0;
    public static double multiplierSapindopsis = 1;
    ...
    public static boolean genKtalenia = false;
    public static String[] genKtaleniaBlacklistBiomes = new String[0];
    public static String[] genKtaleniaOverrideBiomes = new String[0];
    public static int[] dimKtalenia = new int[]{0};
    public static int minheightKtalenia = 1;
    public static int maxheightKtalenia = 90;
    public static double multiplierKtalenia = 1;
    ...
    public static boolean genRhacopteris = false;
    public static String[] genRhacopterisBlacklistBiomes = new String[0];
    public static String[] genRhacopterisOverrideBiomes = new String[0];
    public static int[] dimRhacopteris = new int[]{0};
    public static int minheightRhacopteris = 1;
    public static int maxheightRhacopteris = 90;
    public static double multiplierRhacopteris = 1;
    ...
    public static boolean genAtliRedwood = false;
    public static boolean genAtliThuja = false;
    public static boolean genAtliBisonia = false;
    public static String[] genAtliBlacklistBiomes = new String[0];
    public static String[] genAtliOverrideBiomes = new String[0];
    public static int[] dimAtli = new int[]{0};
    ...
    public static boolean genChloranthus = false;
    public static String[] genChloranthusBlacklistBiomes = new String[0];
    public static String[] genChloranthusOverrideBiomes = new String[0];
    public static int[] dimChloranthus = new int[]{0};
    public static int minheightChloranthus = 1;
    public static int maxheightChloranthus = 0;
    public static double multiplierChloranthus = 1;
    ...
    public static boolean genWelwitschia = false;
    public static String[] genWelwitschiaBlacklistBiomes = new String[0];
    public static String[] genWelwitschiaOverrideBiomes = new String[0];
    public static int[] dimWelwitschia = new int[]{0};
    public static int minheightWelwitschia = 1;
    public static int maxheightWelwitschia = 0;
    public static double multiplierWelwitschia = 1;
    public static boolean genWelwitschiophyllum = false;
    public static String[] genWelwitschiophyllumBlacklistBiomes = new String[0];
    public static String[] genWelwitschiophyllumOverrideBiomes = new String[0];
    public static int[] dimWelwitschiophyllum = new int[]{0};
    ...
    public static String[] genProtognetumOverrideBiomes = new String[0];
    public static int[] dimProtognetum = new int[]{0};
    ...
    public static int[] dimAnemoneFlower = new int[]{0};
    public static int minheightAnemoneFlower = 1;
    public static int maxheightAnemoneFlower = 0;
    public static double multiplierAnemoneFlower = 1;

    public static boolean genDaisy = false;
    public static String[] genDaisyBlacklistBiomes = new String[0];
    public static String[] genDaisyOverrideBiomes = new String[0];
    public static int[] dimDaisy = new int[]{0};
    public static int minheightDaisy = 1;
    public static int maxheightDaisy = 0;
    public static double multiplierDaisy = 1;

    public static boolean genGansufructus = false;
    public static String[] genGansufructusBlacklistBiomes = new String[0];
    public static String[] genGansufructusOverrideBiomes = new String[0];
    public static int[] dimGansufructus = new int[]{0};
    public static int minheightGansufructus = 1;
    public static int maxheightGansufructus = 0;
    public static double multiplierGansufructus = 1;

    public static boolean genSantaniella = false;
    public static String[] genSantaniellaBlacklistBiomes = new String[0];
    public static String[] genSantaniellaOverrideBiomes = new String[0];
    public static int[] dimSantaniella = new int[]{0};
    public static int minheightSantaniella = 1;
    public static int maxheightSantaniella = 0;
    public static double multiplierSantaniella = 1;

    public static boolean genSinoherba = false;
    public static String[] genSinoherbaBlacklistBiomes = new String[0];
    public static String[] genSinoherbaOverrideBiomes = new String[0];
    public static int[] dimSinoherba = new int[]{0};
    public static int minheightSinoherba = 1;
    public static int maxheightSinoherba = 0;
    public static double multiplierSinoherba = 1;

    public static boolean genBellendena = false;
    public static String[] genBellendenaBlacklistBiomes = new String[0];
    public static String[] genBellendenaOverrideBiomes = new String[0];
    public static int[] dimBellendena = new int[]{0};
    public static int minheightBellendena = 80;
    public static int maxheightBellendena = 0;
    public static double multiplierBellendena = 1;

    public static boolean genTelopea = false;
    public static String[] genTelopeaBlacklistBiomes = new String[0];
    public static String[] genTelopeaOverrideBiomes = new String[0];
    public static int[] dimTelopea = new int[]{0};
    public static int minheightTelopea = 80;
    public static int maxheightTelopea = 0;
    public static double multiplierTelopea = 1;

    public static boolean genOrites = false;
    public static String[] genOritesBlacklistBiomes = new String[0];
    public static String[] genOritesOverrideBiomes = new String[0];
    public static int[] dimOrites = new int[]{0};
    public static int minheightOrites = 80;
    public static int maxheightOrites = 0;
    public static double multiplierOrites = 1;

    public static boolean genDrimys = false;
    public static String[] genDrimysBlacklistBiomes = new String[0];
    public static String[] genDrimysOverrideBiomes = new String[0];
    public static int[] dimDrimys = new int[]{0};
    public static int minheightDrimys = 80;
    public static int maxheightDrimys = 0;
    public static double multiplierDrimys = 1;

    public static boolean genLomatia = false;
    public static String[] genLomatiaBlacklistBiomes = new String[0];
    public static String[] genLomatiaOverrideBiomes = new String[0];
    public static int[] dimLomatia = new int[]{0};
    public static int minheightLomatia = 80;
    public static int maxheightLomatia = 0;
    public static double multiplierLomatia = 1;

    public static boolean genBuckthorn = false;
    public static String[] genBuckthornBlacklistBiomes = new String[0];
    public static String[] genBuckthornOverrideBiomes = new String[0];
    public static int[] dimBuckthorn = new int[]{0};
    public static int minheightBuckthorn = 80;
    public static int maxheightBuckthorn = 0;
    public static double multiplierBuckthorn = 1;

    public static boolean genButtercup = false;
    public static String[] genButtercupBlacklistBiomes = new String[0];
    public static String[] genButtercupOverrideBiomes = new String[0];
    public static int[] dimButtercup = new int[]{0};
    public static int minheightButtercup = 1;
    public static int maxheightButtercup = 0;
    public static double multiplierButtercup = 1;
    ...
    public static int[] dimHydrangea = new int[]{0};
    public static int minheightHydrangea = 1;
    public static int maxheightHydrangea = 90;
    public static double multiplierHydrangea = 1;
    ...
    public static boolean genLiquidambar = false;
    public static String[] genLiquidambarBlacklistBiomes = new String[0];
    public static String[] genLiquidambarOverrideBiomes = new String[0];
    public static int[] dimLiquidambar = new int[]{0};
    public static int minheightLiquidambar = 1;
    public static int maxheightLiquidambar = 110;
    public static double multiplierLiquidambar = 1;
    
    public static boolean genBisonia = false;
    public static String[] genBisoniaBlacklistBiomes = new String[0];
    public static String[] genBisoniaOverrideBiomes = new String[0];
    public static int[] dimBisonia = new int[]{0};
    public static int minheightBisonia = 1;
    public static int maxheightBisonia = 110;
    public static double multiplierBisonia = 1;
    ...
    public static boolean genCallianthus = false;
    public static String[] genCallianthusBlacklistBiomes = new String[0];
    public static String[] genCallianthusOverrideBiomes = new String[0];
    public static int[] dimCallianthus = new int[]{0};
    public static int minheightCallianthus = 1;
    public static int maxheightCallianthus = 100;
    public static double multiplierCallianthus = 1;
    public static boolean spreadCallianthus = true;
    public static boolean genPotamogeton = false;
    public static String[] genPotamogetonBlacklistBiomes = new String[0];
    public static String[] genPotamogetonOverrideBiomes = new String[0];
    public static int[] dimPotamogeton = new int[]{0};
    public static int minheightPotamogeton = 1;
    public static int maxheightPotamogeton = 100;
    public static double multiplierPotamogeton = 1;
    public static boolean spreadPotamogeton = true;
    public static boolean genMontsechia = false;
    public static String[] genMontsechiaBlacklistBiomes = new String[0];
    public static String[] genMontsechiaOverrideBiomes = new String[0];
    public static int[] dimMontsechia = new int[]{0};
    public static int minheightMontsechia = 1;
    public static int maxheightMontsechia = 100;
    public static double multiplierMontsechia = 1;
    public static boolean spreadMontsechia = true;
    ...
    public static boolean genSphenopterisSeed = false;
    public static String[] genSphenopterisSeedBlacklistBiomes = new String[0];
    public static String[] genSphenopterisSeedOverrideBiomes = new String[0];
    public static int[] dimSphenopterisSeed = new int[]{0};
    public static int minheightSphenopterisSeed = 1;
    public static int maxheightSphenopterisSeed = 100;
    public static double multiplierSphenopterisSeed = 1;
    public static boolean genSphenopterisFern = false;
    public static String[] genSphenopterisFernBlacklistBiomes = new String[0];
    public static String[] genSphenopterisFernOverrideBiomes = new String[0];
    public static int[] dimSphenopterisFern = new int[]{0};
    public static int minheightSphenopterisFern = 1;
    public static int maxheightSphenopterisFern = 100;
    public static double multiplierSphenopterisFern = 1;
    ...
    public static boolean genGoldenLarch = false;
    public static String[] genGoldenLarchBlacklistBiomes = new String[0];
    public static String[] genGoldenLarchOverrideBiomes = new String[0];
    public static int[] dimGoldenLarch = new int[]{0};
    public static int minheightGoldenLarch = 75;
    public static int maxheightGoldenLarch = 110;
    public static double multiplierGoldenLarch = 1;
    ...
    public static String[] genUnderwaterDebrisBlacklistBiomes = new String[0];
    public static String[] genUnderwaterDebrisOverrideBiomes = new String[0];
    public static int weightUnderwaterDebris = 100;
    ...
    public static boolean genChestnut = false;
    public static String[] genChestnutBlacklistBiomes = new String[0];
    public static String[] genChestnutOverrideBiomes = new String[0];
    public static int[] dimChestnut = new int[]{0};
    public static int minheightChestnut = 1;
    public static int maxheightChestnut = 110;
    public static double multiplierChestnut = 1;

    public static boolean genLaurus = false;
    public static String[] genLaurusBlacklistBiomes = new String[0];
    public static String[] genLaurusOverrideBiomes = new String[0];
    public static int[] dimLaurus = new int[]{0};
    public static int minheightLaurus = 1;
    public static int maxheightLaurus = 110;
    public static double multiplierLaurus = 1;
    ...
    public static int maxheightPagiophyllum = 110;
    ...
    public static int[] dimHirmeriella = new int[]{0};
    public static int minheightHirmeriella = 1;
    public static int maxheightHirmeriella = 110;
    public static double multiplierHirmeriella = 1;
    ...
    public static int[] dimAristolochia = new int[]{0};
    public static boolean genAristolochia = false;
    public static String[] genAristolochiaBlacklistBiomes = new String[0];
    ...
    public static String[] genHopsOverrideBiomes = new String[0];
    public static double multiplierHops = 1;

    public static int[] dimHedera = new int[]{0};
    public static boolean genHedera = false;
    public static String[] genHederaBlacklistBiomes = new String[0];
    public static String[] genHederaOverrideBiomes = new String[0];
    public static double multiplierHedera = 1;

    public static int[] dimVitis = new int[]{0};
    public static boolean genVitis = false;
    public static String[] genVitisBlacklistBiomes = new String[0];
    public static String[] genVitisOverrideBiomes = new String[0];
    public static double multiplierVitis = 1;

    public static int[] dimActinidea = new int[]{0};
    public static boolean genActinidea = false;
    ...
    public static String[] genYamBlacklistBiomes = new String[0];
    public static String[] genYamOverrideBiomes = new String[0];
    public static double multiplierYam = 1;
    ...
    public static boolean syncConfigPlantsPart1() {
        ...
        prop.setComment("List of biomes Underwater Gunk is blacklisted from, in the format: modid:biomeid [default: empty]");
        ...
        prop.setComment("List of biomes Underwater Gunk is forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genUnderwaterGunkOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Algae-Sponges", "weightUnderwaterDebris", weightUnderwaterDebris);
        prop.setComment("Percentage chance that Underwater Debris generates in a suitable chunk (0 to 100) [default: 100]");
        weightUnderwaterDebris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Algae-Sponges", "genUnderwaterDebrisBlacklistBiomes", genUnderwaterDebrisBlacklistBiomes);
        prop.setComment("List of biomes Underwater Debris is blacklisted from, in the format: modid:biomeid [default: empty]");
        genUnderwaterDebrisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Algae-Sponges", "genUnderwaterDebrisOverrideBiomes", genUnderwaterDebrisOverrideBiomes);
        prop.setComment("List of biomes Underwater Debris is forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genUnderwaterDebrisOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Glossopteris angustifolia", "genGlossopteris", genGlossopteris);
        prop.setComment("Set to true to generate Glossopteris angustifolia trees naturally [default: false]");
        genGlossopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "genGlossopterisBlacklistBiomes", genGlossopterisBlacklistBiomes);
        prop.setComment("List of biomes Glossopteris angustifolia trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGlossopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "genGlossopterisOverrideBiomes", genGlossopterisOverrideBiomes);
        prop.setComment("List of biomes Glossopteris angustifolia trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGlossopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Glossopteris angustifolia", "genGlossopterisBush", genGlossopterisBush);
        prop.setComment("Set to true to generate Glossopteris angustifolia bushy variants naturally [default: false]");
        genGlossopterisBush = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "dimGlossopteris", dimGlossopteris);
        prop.setComment("List of dimension IDs Glossopteris angustifolia trees can generate in [default: 0]");
        dimGlossopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "minheightGlossopteris", minheightGlossopteris);
        prop.setComment("Minimum height that Glossopteris angustifolia trees can generate (1 to 250) [default: 1]");
        minheightGlossopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "maxheightGlossopteris", maxheightGlossopteris);
        prop.setComment("Maximum height that Glossopteris angustifolia trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightGlossopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris angustifolia", "multiplierGlossopteris", multiplierGlossopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGlossopteris = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Glossopteris ampla", "genGlossopterisAmpla", genGlossopterisAmpla);
        prop.setComment("Set to true to generate Glossopteris ampla trees naturally [default: false]");
        genGlossopterisAmpla = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "genGlossopterisAmplaBlacklistBiomes", genGlossopterisAmplaBlacklistBiomes);
        prop.setComment("List of biomes Glossopteris ampla trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGlossopterisAmplaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "genGlossopterisAmplaOverrideBiomes", genGlossopterisAmplaOverrideBiomes);
        prop.setComment("List of biomes Glossopteris ampla trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGlossopterisAmplaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Glossopteris ampla", "genGlossopterisAmplaBush", genGlossopterisAmplaBush);
        prop.setComment("Set to true to generate Glossopteris ampla bushy variants naturally [default: false]");
        genGlossopterisAmplaBush = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "dimGlossopterisAmpla", dimGlossopterisAmpla);
        prop.setComment("List of dimension IDs Glossopteris ampla trees can generate in [default: 0]");
        dimGlossopterisAmpla = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "minheightGlossopterisAmpla", minheightGlossopterisAmpla);
        prop.setComment("Minimum height that Glossopteris ampla trees can generate (1 to 250) [default: 1]");
        minheightGlossopterisAmpla = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "maxheightGlossopterisAmpla", maxheightGlossopterisAmpla);
        prop.setComment("Maximum height that Glossopteris ampla trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightGlossopterisAmpla = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris ampla", "multiplierGlossopterisAmpla", multiplierGlossopterisAmpla);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGlossopterisAmpla = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Glossopteris duocaudata", "genGlossopterisDuocaudata", genGlossopterisDuocaudata);
        prop.setComment("Set to true to generate Glossopteris duocaudata trees naturally [default: false]");
        genGlossopterisDuocaudata = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "genGlossopterisDuocaudataBlacklistBiomes", genGlossopterisDuocaudataBlacklistBiomes);
        prop.setComment("List of biomes Glossopteris duocaudata trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGlossopterisDuocaudataBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "genGlossopterisDuocaudataOverrideBiomes", genGlossopterisDuocaudataOverrideBiomes);
        prop.setComment("List of biomes Glossopteris duocaudata trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGlossopterisDuocaudataOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Glossopteris duocaudata", "genGlossopterisDuocaudataBush", genGlossopterisDuocaudataBush);
        prop.setComment("Set to true to generate Glossopteris duocaudata bushy variants naturally [default: false]");
        genGlossopterisDuocaudataBush = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "dimGlossopterisDuocaudata", dimGlossopterisDuocaudata);
        prop.setComment("List of dimension IDs Glossopteris duocaudata trees can generate in [default: 0]");
        dimGlossopterisDuocaudata = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "minheightGlossopterisDuocaudata", minheightGlossopterisDuocaudata);
        prop.setComment("Minimum height that Glossopteris duocaudata trees can generate (1 to 250) [default: 1]");
        minheightGlossopterisDuocaudata = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "maxheightGlossopterisDuocaudata", maxheightGlossopterisDuocaudata);
        prop.setComment("Maximum height that Glossopteris duocaudata trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightGlossopterisDuocaudata = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Glossopteris duocaudata", "multiplierGlossopterisDuocaudata", multiplierGlossopterisDuocaudata);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGlossopterisDuocaudata = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Gangamopteris", "genGangamopteris", genGangamopteris);
        prop.setComment("Set to true to generate Gangamopteris trees naturally [default: false]");
        genGangamopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "genGangamopterisBlacklistBiomes", genGangamopterisBlacklistBiomes);
        prop.setComment("List of biomes Gangamopteris trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGangamopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "genGangamopterisOverrideBiomes", genGangamopterisOverrideBiomes);
        prop.setComment("List of biomes Gangamopteris trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGangamopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Gangamopteris", "genGangamopterisBush", genGangamopterisBush);
        prop.setComment("Set to true to generate Gangamopteris bushy variants naturally [default: false]");
        genGangamopterisBush = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "dimGangamopteris", dimGangamopteris);
        prop.setComment("List of dimension IDs Gangamopteris trees can generate in [default: 0]");
        dimGangamopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "minheightGangamopteris", minheightGangamopteris);
        prop.setComment("Minimum height that Gangamopteris trees can generate (1 to 250) [default: 1]");
        minheightGangamopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "maxheightGangamopteris", maxheightGangamopteris);
        prop.setComment("Maximum height that Gangamopteris trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightGangamopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gangamopteris", "multiplierGangamopteris", multiplierGangamopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGangamopteris = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Rattan", "genRattan", genRattan);
        prop.setComment("Set to true to generate Rattan palms naturally [default: false]");
        genRattan = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rattan", "genRattanBlacklistBiomes", genRattanBlacklistBiomes);
        prop.setComment("List of biomes Rattan palms are blacklisted from, in the format: modid:biomeid [default: empty]");
        genRattanBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rattan", "genRattanOverrideBiomes", genRattanOverrideBiomes);
        prop.setComment("List of biomes Rattan palms are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genRattanOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Rattan", "dimRattan", dimRattan);
        prop.setComment("List of dimension IDs Rattan palms can generate in [default: 0]");
        dimRattan = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rattan", "minheightRattan", minheightRattan);
        prop.setComment("Minimum height that Rattan palms can generate (1 to 250) [default: 1]");
        minheightRattan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rattan", "maxheightRattan", maxheightRattan);
        prop.setComment("Maximum height that Rattan palms can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightRattan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rattan", "multiplierRattan", multiplierRattan);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierRattan = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Pandan", "genPandan", genPandan);
        prop.setComment("Set to true to generate Pandan trees naturally [default: false]");
        genPandan = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pandan", "genPandanBlacklistBiomes", genPandanBlacklistBiomes);
        prop.setComment("List of biomes Pandan trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genPandanBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pandan", "genPandanOverrideBiomes", genPandanOverrideBiomes);
        prop.setComment("List of biomes Pandan trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genPandanOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Pandan", "dimPandan", dimPandan);
        prop.setComment("List of dimension IDs Pandan trees can generate in [default: 0]");
        dimPandan = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pandan", "minheightPandan", minheightPandan);
        prop.setComment("Minimum height that Pandan trees can generate (1 to 250) [default: 1]");
        minheightPandan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pandan", "maxheightPandan", maxheightPandan);
        prop.setComment("Maximum height that Pandan trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightPandan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pandan", "multiplierPandan", multiplierPandan);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierPandan = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Amborella", "genAmborella", genAmborella);
        prop.setComment("Set to true to generate Amborella naturally [default: false]");
        genAmborella = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Amborella", "genAmborellaBlacklistBiomes", genAmborellaBlacklistBiomes);
        prop.setComment("List of biomes Amborella are blacklisted from, in the format: modid:biomeid [default: empty]");
        genAmborellaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Amborella", "genAmborellaOverrideBiomes", genAmborellaOverrideBiomes);
        prop.setComment("List of biomes Amborella are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genAmborellaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Amborella", "dimAmborella", dimAmborella);
        prop.setComment("List of dimension IDs Amborella can generate in [default: 0]");
        dimAmborella = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Amborella", "minheightAmborella", minheightAmborella);
        prop.setComment("Minimum height that Amborella can generate (1 to 250) [default: 1]");
        minheightAmborella = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Amborella", "maxheightAmborella", maxheightAmborella);
        prop.setComment("Maximum height that Amborella can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightAmborella = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Amborella", "multiplierAmborella", multiplierAmborella);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierAmborella = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Ilicium", "genIlicium", genIlicium);
        prop.setComment("Set to true to generate Ilicium naturally [default: false]");
        genIlicium = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ilicium", "genIliciumBlacklistBiomes", genIliciumBlacklistBiomes);
        prop.setComment("List of biomes Ilicium are blacklisted from, in the format: modid:biomeid [default: empty]");
        genIliciumBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ilicium", "genIliciumOverrideBiomes", genIliciumOverrideBiomes);
        prop.setComment("List of biomes Ilicium are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genIliciumOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Ilicium", "dimIlicium", dimIlicium);
        prop.setComment("List of dimension IDs Ilicium can generate in [default: 0]");
        dimIlicium = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ilicium", "minheightIlicium", minheightIlicium);
        prop.setComment("Minimum height that Ilicium can generate (1 to 250) [default: 1]");
        minheightIlicium = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ilicium", "maxheightIlicium", maxheightIlicium);
        prop.setComment("Maximum height that Ilicium can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightIlicium = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ilicium", "multiplierIlicium", multiplierIlicium);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierIlicium = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Jerseyanthus", "genJerseyanthus", genJerseyanthus);
        prop.setComment("Set to true to generate Jerseyanthus naturally [default: false]");
        genJerseyanthus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Jerseyanthus", "genJerseyanthusBlacklistBiomes", genJerseyanthusBlacklistBiomes);
        prop.setComment("List of biomes Jerseyanthus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genJerseyanthusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Jerseyanthus", "genJerseyanthusOverrideBiomes", genJerseyanthusOverrideBiomes);
        prop.setComment("List of biomes Jerseyanthus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genJerseyanthusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Jerseyanthus", "dimJerseyanthus", dimJerseyanthus);
        prop.setComment("List of dimension IDs Jerseyanthus can generate in [default: 0]");
        dimJerseyanthus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Jerseyanthus", "minheightJerseyanthus", minheightJerseyanthus);
        prop.setComment("Minimum height that Jerseyanthus can generate (1 to 250) [default: 1]");
        minheightJerseyanthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Jerseyanthus", "maxheightJerseyanthus", maxheightJerseyanthus);
        prop.setComment("Maximum height that Jerseyanthus can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightJerseyanthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Jerseyanthus", "multiplierJerseyanthus", multiplierJerseyanthus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierJerseyanthus = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Calycanthus", "genCalycanthus", genCalycanthus);
        prop.setComment("Set to true to generate Calycanthus naturally [default: false]");
        genCalycanthus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calycanthus", "genCalycanthusBlacklistBiomes", genCalycanthusBlacklistBiomes);
        prop.setComment("List of biomes Calycanthus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCalycanthusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calycanthus", "genCalycanthusOverrideBiomes", genCalycanthusOverrideBiomes);
        prop.setComment("List of biomes Calycanthus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCalycanthusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Calycanthus", "dimCalycanthus", dimCalycanthus);
        prop.setComment("List of dimension IDs Calycanthus can generate in [default: 0]");
        dimCalycanthus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calycanthus", "minheightCalycanthus", minheightCalycanthus);
        prop.setComment("Minimum height that Calycanthus can generate (1 to 250) [default: 1]");
        minheightCalycanthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calycanthus", "maxheightCalycanthus", maxheightCalycanthus);
        prop.setComment("Maximum height that Calycanthus can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightCalycanthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calycanthus", "multiplierCalycanthus", multiplierCalycanthus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierCalycanthus = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen FigBanyan", "genFigBanyan", genFigBanyan);
        prop.setComment("Set to true to generate Banyan trees naturally [default: false]");
        genFigBanyan = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen FigBanyan", "genFigBanyanBlacklistBiomes", genFigBanyanBlacklistBiomes);
        prop.setComment("List of biomes Banyan trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genFigBanyanBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Banyan", "genFigBanyanOverrideBiomes", genFigBanyanOverrideBiomes);
        prop.setComment("List of biomes Banyan trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genFigBanyanOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen FigBanyan", "dimFigBanyan", dimFigBanyan);
        prop.setComment("List of dimension IDs Banyan trees can generate in [default: 0]");
        dimFigBanyan = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Banyan", "minheightFigBanyan", minheightFigBanyan);
        prop.setComment("Minimum height that Banyan trees can generate (1 to 250) [default: 1]");
        minheightFigBanyan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Banyan", "maxheightFigBanyan", maxheightFigBanyan);
        prop.setComment("Maximum height that Banyan trees can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightFigBanyan = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Banyan", "multiplierFigBanyan", multiplierFigBanyan);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierFigBanyan = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Fig", "genFig", genFig);
        prop.setComment("Set to true to generate Fig trees naturally [default: false]");
        genFig = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Fig", "genFigBlacklistBiomes", genFigBlacklistBiomes);
        prop.setComment("List of biomes Fig trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genFigBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Fig", "genFigOverrideBiomes", genFigOverrideBiomes);
        prop.setComment("List of biomes Fig trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genFigOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Fig", "dimFig", dimFig);
        prop.setComment("List of dimension IDs Fig trees can generate in [default: 0]");
        dimFig = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Fig", "minheightFig", minheightFig);
        prop.setComment("Minimum height that Fig trees can generate (1 to 250) [default: 1]");
        minheightFig = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Fig", "maxheightFig", maxheightFig);
        prop.setComment("Maximum height that Fig trees can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightFig = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Fig", "multiplierFig", multiplierFig);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierFig = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Monanthesia", "genMonanthesia", genMonanthesia);
        prop.setComment("Set to true to generate Monanthesia naturally [default: false]");
        genMonanthesia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Monanthesia", "genMonanthesiaBlacklistBiomes", genMonanthesiaBlacklistBiomes);
        prop.setComment("List of biomes Monanthesia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genMonanthesiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Monanthesia", "genMonanthesiaOverrideBiomes", genMonanthesiaOverrideBiomes);
        prop.setComment("List of biomes Monanthesia are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genMonanthesiaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Monanthesia", "dimMonanthesia", dimMonanthesia);
        prop.setComment("List of dimension IDs Monanthesia can generate in [default: 0]");
        dimMonanthesia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Monanthesia", "minheightMonanthesia", minheightMonanthesia);
        prop.setComment("Minimum height that Monanthesia can generate (1 to 250) [default: 1]");
        minheightMonanthesia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Monanthesia", "maxheightMonanthesia", maxheightMonanthesia);
        prop.setComment("Maximum height that Monanthesia can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightMonanthesia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Monanthesia", "multiplierMonanthesia", multiplierMonanthesia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierMonanthesia = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Cedar", "genCedar", genCedar);
        prop.setComment("Set to true to generate Cedar trees naturally [default: false]");
        genCedar = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Cedar", "genCedarBlacklistBiomes", genCedarBlacklistBiomes);
        prop.setComment("List of biomes Cedar trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCedarBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Cedar", "genCedarOverrideBiomes", genCedarOverrideBiomes);
        prop.setComment("List of biomes Cedar trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCedarOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Cedar", "dimCedar", dimCedar);
        prop.setComment("List of dimension IDs Cedar trees can generate in [default: 0]");
        ...
        prop.setComment("Maximum height that Cedar trees can generate (1 to 250, or set to 0 for unlimited) [default: 120]");
        maxheightCedar = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Cedar", "multiplierCedar", multiplierCedar);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierCedar = prop.getDouble();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Cedar", "podzolCedar", podzolCedar);
        prop.setComment("Radius for podzol generation at base of Cedar trees. Increasing this may cause lag. (0 - 16: set to 0 to disable) [default: 6]");
        podzolCedar = prop.getInt();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Todea", "genTodea", genTodea);
        prop.setComment("Set to true to generate Todea naturally [default: false]");
        genTodea = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Todea", "genTodeaBlacklistBiomes", genTodeaBlacklistBiomes);
        prop.setComment("List of biomes Todea are blacklisted from, in the format: modid:biomeid [default: empty]");
        genTodeaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Todea", "genTodeaOverrideBiomes", genTodeaOverrideBiomes);
        prop.setComment("List of biomes Todea are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genTodeaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Todea", "dimTodea", dimTodea);
        prop.setComment("List of dimension IDs Todea can generate in [default: 0]");
        dimTodea = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Todea", "minheightTodea", minheightTodea);
        prop.setComment("Minimum height that Todea can generate (1 to 250) [default: 1]");
        minheightTodea = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Todea", "maxheightTodea", maxheightTodea);
        prop.setComment("Maximum height that Todea can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightTodea = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Todea", "multiplierTodea", multiplierTodea);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierTodea = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Palissya", "genPalissya", genPalissya);
        prop.setComment("Set to true to generate Palissya naturally [default: false]");
        genPalissya = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palissya", "genPalissyaBlacklistBiomes", genPalissyaBlacklistBiomes);
        prop.setComment("List of biomes Palissya are blacklisted from, in the format: modid:biomeid [default: empty]");
        genPalissyaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palissya", "genPalissyaOverrideBiomes", genPalissyaOverrideBiomes);
        prop.setComment("List of biomes Palissya are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genPalissyaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Palissya", "dimPalissya", dimPalissya);
        prop.setComment("List of dimension IDs Palissya can generate in [default: 0]");
        dimPalissya = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palissya", "minheightPalissya", minheightPalissya);
        prop.setComment("Minimum height that Palissya can generate (1 to 250) [default: 1]");
        minheightPalissya = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palissya", "maxheightPalissya", maxheightPalissya);
        prop.setComment("Maximum height that Palissya can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightPalissya = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Palissya", "multiplierPalissya", multiplierPalissya);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierPalissya = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop.setComment("Set to true to generate Embothrium trees naturally [default: false]");
        genEmbothrium = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "genEmbothriumBlacklistBiomes", genEmbothriumBlacklistBiomes);
        prop.setComment("List of biomes Embothrium trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genEmbothriumBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "genEmbothriumOverrideBiomes", genEmbothriumOverrideBiomes);
        prop.setComment("List of biomes Embothrium trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genEmbothriumOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Embothrium", "dimEmbothrium", dimEmbothrium);
        prop.setComment("List of dimension IDs Embothrium trees can generate in [default: 0]");
        dimEmbothrium = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "minheightEmbothrium", minheightEmbothrium);
        prop.setComment("Minimum height that Embothrium trees can generate (1 to 250) [default: 1]");
        minheightEmbothrium = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "maxheightEmbothrium", maxheightEmbothrium);
        prop.setComment("Maximum height that Embothrium trees can generate (1 to 250, or set to 0 for unlimited) [default: 150]");
        maxheightEmbothrium = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Embothrium", "multiplierEmbothrium", multiplierEmbothrium);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierEmbothrium = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Burnished Treefern", "genBurnishedTreefern", genBurnishedTreefern);
        prop.setComment("Set to true to generate Burnished Treeferns naturally [default: false]");
        genBurnishedTreefern = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Burnished Treefern", "genBurnishedTreefernBlacklistBiomes", genBurnishedTreefernBlacklistBiomes);
        prop.setComment("List of biomes Burnished Treeferns are blacklisted from, in the format: modid:biomeid [default: empty]");
        genBurnishedTreefernBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Burnished Treefern", "genBurnishedTreefernOverrideBiomes", genBurnishedTreefernOverrideBiomes);
        prop.setComment("List of biomes Burnished Treeferns are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genBurnishedTreefernOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Burnished Treefern", "dimBurnishedTreefern", dimBurnishedTreefern);
        prop.setComment("List of dimension IDs Burnished Treeferns can generate in [default: 0]");
        dimBurnishedTreefern = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Burnished Treefern", "minheightBurnishedTreefern", minheightBurnishedTreefern);
        prop.setComment("Minimum height that Burnished Treeferns can generate (1 to 250) [default: 1]");
        minheightBurnishedTreefern = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Burnished Treefern", "maxheightBurnishedTreefern", maxheightBurnishedTreefern);
        prop.setComment("Maximum height that Burnished Treeferns can generate (1 to 250, or set to 0 for unlimited) [default: 190]");
        maxheightBurnishedTreefern = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Burnished Treefern", "multiplierBurnishedTreefern", multiplierBurnishedTreefern);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierBurnishedTreefern = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Scolecopteris", "genZygopteridaceae", genZygopteridaceae);
        prop.setComment("Set to true to generate Scolecopteris naturally [default: false]");
        genZygopteridaceae = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Scolecopteris", "genZygopteridaceaeBlacklistBiomes", genZygopteridaceaeBlacklistBiomes);
        ...
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Scolecopteris", "genZygopteridaceaeOverrideBiomes", genZygopteridaceaeOverrideBiomes);
        ...
        prop = cfg.get("WorldGen Scolecopteris", "dimZygopteridaceae", dimZygopteridaceae);
        prop.setComment("List of dimension IDs Scolecopteris can generate in [default: 0]");
        dimZygopteridaceae = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Scolecopteris", "minheightZygopteridaceae", minheightZygopteridaceae);
        prop.setComment("Minimum height that Scolecopteris can generate (1 to 250) [default: 1]");
        minheightZygopteridaceae = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Scolecopteris", "maxheightZygopteridaceae", maxheightZygopteridaceae);
        ...
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Scolecopteris", "multiplierZygopteridaceae", multiplierZygopteridaceae);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierZygopteridaceae = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Dryland Cordaites", "genCordaitesDry", genCordaitesDry);
        prop.setComment("Set to true to generate Dryland Cordaites trees naturally [default: false]");
        genCordaitesDry = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dryland Cordaites", "genCordaitesDryBlacklistBiomes", genCordaitesDryBlacklistBiomes);
        prop.setComment("List of biomes Dryland Cordaites trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCordaitesDryBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dryland Cordaites", "genCordaitesDryOverrideBiomes", genCordaitesDryOverrideBiomes);
        prop.setComment("List of biomes Dryland Cordaites trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCordaitesDryOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Dryland Cordaites", "dimCordaitesDry", dimCordaitesDry);
        prop.setComment("List of dimension IDs Dryland Cordaites trees can generate in [default: 0]");
        dimCordaitesDry = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dryland Cordaites", "minheightCordaitesDry", minheightCordaitesDry);
        prop.setComment("Minimum height that Dryland Cordaites trees can generate (1 to 250) [default: 1]");
        minheightCordaitesDry = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dryland Cordaites", "maxheightCordaitesDry", maxheightCordaitesDry);
        prop.setComment("Maximum height that Dryland Cordaites trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightCordaitesDry = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dryland Cordaites", "multiplierCordaitesDry", multiplierCordaitesDry);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierCordaitesDry = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Wetland Cordaites", "genCordaites", genCordaites);
        prop.setComment("Set to true to generate Wetland Cordaites trees naturally [default: false]");
        genCordaites = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Wetland Cordaites", "genCordaitesBlacklistBiomes", genCordaitesBlacklistBiomes);
        prop.setComment("List of biomes Wetland Cordaites trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCordaitesBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Wetland Cordaites", "genCordaitesOverrideBiomes", genCordaitesOverrideBiomes);
        prop.setComment("List of biomes Wetland Cordaites trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCordaitesOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Wetland Cordaites", "dimCordaites", dimCordaites);
        prop.setComment("List of dimension IDs Wetland Cordaites trees can generate in [default: 0]");
        dimCordaites = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Wetland Cordaites", "minheightCordaites", minheightCordaites);
        prop.setComment("Minimum height that Wetland Cordaites trees can generate (1 to 250) [default: 1]");
        minheightCordaites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Wetland Cordaites", "maxheightCordaites", maxheightCordaites);
        prop.setComment("Maximum height that Wetland Cordaites trees can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightCordaites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Wetland Cordaites", "multiplierCordaites", multiplierCordaites);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        ...
        prop.setComment("Set to true to generate Seagrass naturally [default: true]");
        ...
        prop = cfg.get("WorldGen Sinocarpus", "genSinocarpus", genSinocarpus);
        prop.setComment("Set to true to generate Sinocarpus naturally [default: false]");
        genSinocarpus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinocarpus", "genSinocarpusBlacklistBiomes", genSinocarpusBlacklistBiomes);
        prop.setComment("List of biomes Sinocarpus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSinocarpusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinocarpus", "genSinocarpusOverrideBiomes", genSinocarpusOverrideBiomes);
        prop.setComment("List of biomes Sinocarpus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSinocarpusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Sinocarpus", "dimSinocarpus", dimSinocarpus);
        prop.setComment("List of dimension IDs Sinocarpus can generate in [default: 0]");
        dimSinocarpus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinocarpus", "minheightSinocarpus", minheightSinocarpus);
        prop.setComment("Minimum height that Sinocarpus can generate (1 to 250) [default: 1]");
        minheightSinocarpus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinocarpus", "maxheightSinocarpus", maxheightSinocarpus);
        prop.setComment("Maximum height that Sinocarpus can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightSinocarpus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinocarpus", "multiplierSinocarpus", multiplierSinocarpus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSinocarpus = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Zingiberopsis", "genZingiberopsis", genZingiberopsis);
        prop.setComment("Set to true to generate Zingiberopsis naturally [default: false]");
        genZingiberopsis = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Zingiberopsis", "genZingiberopsisBlacklistBiomes", genZingiberopsisBlacklistBiomes);
        prop.setComment("List of biomes Zingiberopsis are blacklisted from, in the format: modid:biomeid [default: empty]");
        genZingiberopsisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Zingiberopsis", "genZingiberopsisOverrideBiomes", genZingiberopsisOverrideBiomes);
        prop.setComment("List of biomes Zingiberopsis are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genZingiberopsisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Zingiberopsis", "dimZingiberopsis", dimZingiberopsis);
        prop.setComment("List of dimension IDs Zingiberopsis can generate in [default: 0]");
        dimZingiberopsis = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Zingiberopsis", "minheightZingiberopsis", minheightZingiberopsis);
        prop.setComment("Minimum height that Zingiberopsis can generate (1 to 250) [default: 1]");
        minheightZingiberopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Zingiberopsis", "maxheightZingiberopsis", maxheightZingiberopsis);
        prop.setComment("Maximum height that Zingiberopsis can generate (1 to 250, or set to 0 for unlimited) [default: 85]");
        maxheightZingiberopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Zingiberopsis", "multiplierZingiberopsis", multiplierZingiberopsis);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierZingiberopsis = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Rehezamites", "genRehezamites", genRehezamites);
        prop.setComment("Set to true to generate Rehezamites naturally [default: false]");
        genRehezamites = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rehezamites", "genRehezamitesBlacklistBiomes", genRehezamitesBlacklistBiomes);
        prop.setComment("List of biomes Rehezamites are blacklisted from, in the format: modid:biomeid [default: empty]");
        genRehezamitesBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rehezamites", "genRehezamitesOverrideBiomes", genRehezamitesOverrideBiomes);
        prop.setComment("List of biomes Rehezamites are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genRehezamitesOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Rehezamites", "dimRehezamites", dimRehezamites);
        prop.setComment("List of dimension IDs Rehezamites can generate in [default: 0]");
        dimRehezamites = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rehezamites", "minheightRehezamites", minheightRehezamites);
        prop.setComment("Minimum height that Rehezamites can generate (1 to 250) [default: 1]");
        minheightRehezamites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rehezamites", "maxheightRehezamites", maxheightRehezamites);
        prop.setComment("Maximum height that Rehezamites can generate (1 to 250, or set to 0 for unlimited) [default: 85]");
        maxheightRehezamites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rehezamites", "multiplierRehezamites", multiplierRehezamites);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierRehezamites = prop.getDouble();
        propOrder.add(prop.getName());
    ...
    public static boolean syncConfigPlantsPart2() {
        ...
        prop = cfg.get("WorldGen Gunnera", "genGunnera", genGunnera);
        prop.setComment("Set to true to generate Gunnera naturally [default: false]");
        genGunnera = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gunnera", "genGunneraBlacklistBiomes", genGunneraBlacklistBiomes);
        prop.setComment("List of biomes Gunnera are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGunneraBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gunnera", "genGunneraOverrideBiomes", genGunneraOverrideBiomes);
        prop.setComment("List of biomes Gunnera are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGunneraOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Gunnera", "dimGunnera", dimGunnera);
        prop.setComment("List of dimension IDs Gunnera can generate in [default: 0]");
        dimGunnera = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gunnera", "minheightGunnera", minheightGunnera);
        prop.setComment("Minimum height that Gunnera can generate (1 to 250) [default: 1]");
        minheightGunnera = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gunnera", "maxheightGunnera", maxheightGunnera);
        prop.setComment("Maximum height that Gunnera can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightGunnera = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gunnera", "multiplierGunnera", multiplierGunnera);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGunnera = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Irania", "genIrania", genIrania);
        prop.setComment("Set to true to generate Irania naturally [default: false]");
        genIrania = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Irania", "genIraniaBlacklistBiomes", genIraniaBlacklistBiomes);
        prop.setComment("List of biomes Irania are blacklisted from, in the format: modid:biomeid [default: empty]");
        genIraniaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Irania", "genIraniaOverrideBiomes", genIraniaOverrideBiomes);
        prop.setComment("List of biomes Irania are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genIraniaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Irania", "dimIrania", dimIrania);
        prop.setComment("List of dimension IDs Irania can generate in [default: 0]");
        dimIrania = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Irania", "minheightIrania", minheightIrania);
        prop.setComment("Minimum height that Irania can generate (1 to 250) [default: 1]");
        minheightIrania = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Irania", "maxheightIrania", maxheightIrania);
        prop.setComment("Maximum height that Irania can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightIrania = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Irania", "multiplierIrania", multiplierIrania);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierIrania = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Calamopitys", "genCalamopitys", genCalamopitys);
        prop.setComment("Set to true to generate Sphenophyllales naturally [default: false]");
        genCalamopitys = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calamopitys", "genCalamopitysBlacklistBiomes", genCalamopitysBlacklistBiomes);
        prop.setComment("List of biomes Shrubby Sphenophyllales are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCalamopitysBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calamopitys", "genCalamopitysOverrideBiomes", genCalamopitysOverrideBiomes);
        prop.setComment("List of biomes Calamopitys are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCalamopitysOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Calamopitys", "dimCalamopitys", dimCalamopitys);
        prop.setComment("List of dimension IDs Calamopitys can generate in [default: 0]");
        dimCalamopitys = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calamopitys", "minheightCalamopitys", minheightCalamopitys);
        prop.setComment("Minimum height that Calamopitys can generate (1 to 250) [default: 1]");
        minheightCalamopitys = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Calamopitys", "maxheightCalamopitys", maxheightCalamopitys);
        prop.setComment("Maximum height that Calamopitys can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightCalamopitys = prop.getInt();
        propOrder.add(prop.getName());
        ...
        prop.setComment("Set to true to generate Sturdy Sphenophyllales naturally [default: false]");
        genSphenophyllales2 = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenophyllales (Sturdy)", "genSphenophyllales2BlacklistBiomes", genSphenophyllales2BlacklistBiomes);
        prop.setComment("List of biomes Sturdy Sphenophyllales are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSphenophyllales2BlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenophyllales (Sturdy)", "genSphenophyllales2OverrideBiomes", genSphenophyllales2OverrideBiomes);
        prop.setComment("List of biomes Sturdy Sphenophyllales are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSphenophyllales2OverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Sphenophyllales (Sturdy)", "dimSphenophyllales2", dimSphenophyllales2);
        prop.setComment("List of dimension IDs Sturdy Sphenophyllales can generate in [default: 0]");
        dimSphenophyllales2 = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenophyllales (Sturdy)", "minheightSphenophyllales2", minheightSphenophyllales2);
        prop.setComment("Minimum height that Sturdy Sphenophyllales can generate (1 to 250) [default: 1]");
        minheightSphenophyllales2 = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenophyllales (Sturdy)", "maxheightSphenophyllales2", maxheightSphenophyllales2);
        prop.setComment("Maximum height that Sturdy Sphenophyllales can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        ...
        prop = cfg.get("WorldGen Botrychiopsis", "genBotrychiopsis", genBotrychiopsis);
        prop.setComment("Set to true to generate Botrychiopsis naturally [default: false]");
        genBotrychiopsis = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Botrychiopsis", "genBotrychiopsisBlacklistBiomes", genBotrychiopsisBlacklistBiomes);
        prop.setComment("List of biomes Botrychiopsis are blacklisted from, in the format: modid:biomeid [default: empty]");
        genBotrychiopsisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Botrychiopsis", "genBotrychiopsisOverrideBiomes", genBotrychiopsisOverrideBiomes);
        prop.setComment("List of biomes Botrychiopsis are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genBotrychiopsisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Botrychiopsis", "dimBotrychiopsis", dimBotrychiopsis);
        prop.setComment("List of dimension IDs Botrychiopsis can generate in [default: 0]");
        dimBotrychiopsis = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Botrychiopsis", "minheightBotrychiopsis", minheightBotrychiopsis);
        prop.setComment("Minimum height that Botrychiopsis can generate (1 to 250) [default: 1]");
        minheightBotrychiopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Botrychiopsis", "maxheightBotrychiopsis", maxheightBotrychiopsis);
        prop.setComment("Maximum height that Botrychiopsis can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightBotrychiopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Botrychiopsis", "multiplierBotrychiopsis", multiplierBotrychiopsis);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierBotrychiopsis = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Dizeugotheca", "genScolecopteris", genScolecopteris);
        prop.setComment("Set to true to generate Dizeugotheca naturally [default: false]");
        genScolecopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dizeugotheca", "genScolecopterisBlacklistBiomes", genScolecopterisBlacklistBiomes);
        prop.setComment("List of biomes Dizeugotheca are blacklisted from, in the format: modid:biomeid [default: empty]");
        genScolecopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dizeugotheca", "genScolecopterisOverrideBiomes", genScolecopterisOverrideBiomes);
        prop.setComment("List of biomes Dizeugotheca are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genScolecopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Dizeugotheca", "dimScolecopteris", dimScolecopteris);
        prop.setComment("List of dimension IDs Dizeugotheca can generate in [default: 0]");
        dimScolecopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dizeugotheca", "minheightScolecopteris", minheightScolecopteris);
        prop.setComment("Minimum height that Dizeugotheca can generate (1 to 250) [default: 1]");
        minheightScolecopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dizeugotheca", "maxheightScolecopteris", maxheightScolecopteris);
        prop.setComment("Maximum height that Dizeugotheca can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightScolecopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Dizeugotheca", "multiplierScolecopteris", multiplierScolecopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        ...
        prop = cfg.get("WorldGen Nuphar", "genNuphar", genNuphar);
        prop.setComment("Set to true to generate Nuphar naturally [default: false]");
        genNuphar = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "genNupharBlacklistBiomes", genNupharBlacklistBiomes);
        prop.setComment("List of biomes Nuphar are blacklisted from, in the format: modid:biomeid [default: empty]");
        genNupharBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "genNupharOverrideBiomes", genNupharOverrideBiomes);
        prop.setComment("List of biomes Nuphar are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genNupharOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "dimNuphar", dimNuphar);
        prop.setComment("List of dimension IDs Nuphar can generate in [default: 0]");
        dimNuphar = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "minheightNuphar", minheightNuphar);
        prop.setComment("Minimum height that Nuphar can generate (1 to 250) [default: 1]");
        minheightNuphar = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "maxheightNuphar", maxheightNuphar);
        prop.setComment("Maximum height that Nuphar can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightNuphar = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Nuphar", "multiplierNuphar", multiplierNuphar);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierNuphar = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Microvictoria", "genMicrovictoria", genMicrovictoria);
        prop.setComment("Set to true to generate Microvictoria naturally [default: false]");
        genMicrovictoria = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "genMicrovictoriaBlacklistBiomes", genMicrovictoriaBlacklistBiomes);
        prop.setComment("List of biomes Microvictoria are blacklisted from, in the format: modid:biomeid [default: empty]");
        genMicrovictoriaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "genMicrovictoriaOverrideBiomes", genMicrovictoriaOverrideBiomes);
        prop.setComment("List of biomes Microvictoria are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genMicrovictoriaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "dimMicrovictoria", dimMicrovictoria);
        prop.setComment("List of dimension IDs Microvictoria can generate in [default: 0]");
        dimMicrovictoria = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "minheightMicrovictoria", minheightMicrovictoria);
        prop.setComment("Minimum height that Microvictoria can generate (1 to 250) [default: 1]");
        minheightMicrovictoria = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "maxheightMicrovictoria", maxheightMicrovictoria);
        prop.setComment("Maximum height that Microvictoria can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightMicrovictoria = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Microvictoria", "multiplierMicrovictoria", multiplierMicrovictoria);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierMicrovictoria = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop.setComment("Maximum height that Komlopteris trees can generate (1 to 250, or set to 0 for unlimited) [default: 120]");
        ...
        prop = cfg.get("WorldGen Thinnfeldia", "genThinnfeldia", genThinnfeldia);
        prop.setComment("Set to true to generate Thinnfeldia trees naturally [default: false]");
        genThinnfeldia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "genThinnfeldiaBlacklistBiomes", genThinnfeldiaBlacklistBiomes);
        prop.setComment("List of biomes Thinnfeldia trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genThinnfeldiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "genThinnfeldiaOverrideBiomes", genThinnfeldiaOverrideBiomes);
        prop.setComment("List of biomes Thinnfeldia trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genThinnfeldiaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "dimThinnfeldia", dimThinnfeldia);
        prop.setComment("List of dimension IDs Thinnfeldia trees can generate in [default: 0]");
        dimThinnfeldia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "minheightThinnfeldia", minheightThinnfeldia);
        prop.setComment("Minimum height that Thinnfeldia trees can generate (1 to 250) [default: 0]");
        minheightThinnfeldia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "maxheightThinnfeldia", maxheightThinnfeldia);
        prop.setComment("Maximum height that Thinnfeldia trees can generate (1 to 250, or set to 0 for unlimited) [default: 70]");
        maxheightThinnfeldia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Thinnfeldia", "multiplierThinnfeldia", multiplierThinnfeldia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierThinnfeldia = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Sapindopsis", "genSapindopsis", genSapindopsis);
        prop.setComment("Set to true to generate Sapindopsis naturally [default: false]");
        genSapindopsis = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "genSapindopsisBlacklistBiomes", genSapindopsisBlacklistBiomes);
        prop.setComment("List of biomes Sapindopsis are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSapindopsisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "genSapindopsisOverrideBiomes", genSapindopsisOverrideBiomes);
        prop.setComment("List of biomes Sapindopsis are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSapindopsisOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "dimSapindopsis", dimSapindopsis);
        prop.setComment("List of dimension IDs Sapindopsis can generate in [default: 0]");
        dimSapindopsis = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "minheightSapindopsis", minheightSapindopsis);
        prop.setComment("Minimum height that Sapindopsis can generate (1 to 250) [default: 110]");
        minheightSapindopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "maxheightSapindopsis", maxheightSapindopsis);
        prop.setComment("Minimum height that Sapindopsis can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightSapindopsis = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sapindopsis", "multiplierSapindopsis", multiplierSapindopsis);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSapindopsis = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Rhacopteris", "genRhacopteris", genRhacopteris);
        prop.setComment("Set to true to generate Rhacopteris naturally [default: false]");
        genRhacopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rhacopteris", "genRhacopterisBlacklistBiomes", genRhacopterisBlacklistBiomes);
        prop.setComment("List of biomes Rhacopteris are blacklisted from, in the format: modid:biomeid [default: empty]");
        genRhacopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rhacopteris", "genRhacopterisOverrideBiomes", genRhacopterisOverrideBiomes);
        prop.setComment("List of biomes Rhacopteris are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genRhacopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Rhacopteris", "dimRhacopteris", dimRhacopteris);
        prop.setComment("List of dimension IDs Rhacopteris can generate in [default: 0]");
        dimRhacopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rhacopteris", "minheightRhacopteris", minheightRhacopteris);
        prop.setComment("Minimum height that Rhacopteris can generate (1 to 250) [default: 1]");
        minheightRhacopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rhacopteris", "maxheightRhacopteris", maxheightRhacopteris);
        prop.setComment("Maximum height that Rhacopteris can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightRhacopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Rhacopteris", "multiplierRhacopteris", multiplierRhacopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierRhacopteris = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Atli", "genAtliRedwood", genAtliRedwood);
        prop.setComment("Set to true to generate Atli naturally on Redwood trees [default: false]");
        genAtliRedwood = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Atli", "genAtliThuja", genAtliThuja);
        prop.setComment("Set to true to generate Atli naturally on Thuja trees [default: false]");
        genAtliThuja = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Atli", "genAtliBisonia", genAtliBisonia);
        prop.setComment("Set to true to generate Atli naturally on Bisonia trees [default: false]");
        genAtliBisonia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Atli", "genAtliBlacklistBiomes", genAtliBlacklistBiomes);
        prop.setComment("List of biomes Atli are blacklisted from, in the format: modid:biomeid [default: empty]");
        genAtliBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Atli", "genAtliOverrideBiomes", genAtliOverrideBiomes);
        prop.setComment("List of biomes Atli are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genAtliOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Atli", "dimAtli", dimAtli);
        prop.setComment("List of dimension IDs Atli can generate in [default: 0]");
        dimAtli = prop.getIntList();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Welwitschia", "genWelwitschia", genWelwitschia);
        prop.setComment("Set to true to generate Welwitschia naturally [default: false]");
        genWelwitschia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "genWelwitschiaBlacklistBiomes", genWelwitschiaBlacklistBiomes);
        prop.setComment("List of biomes Welwitschia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genWelwitschiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "genWelwitschiaOverrideBiomes", genWelwitschiaOverrideBiomes);
        prop.setComment("List of biomes Welwitschia are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genWelwitschiaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "dimWelwitschia", dimWelwitschia);
        prop.setComment("List of dimension IDs Welwitschia can generate in [default: 0]");
        dimWelwitschia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "minheightWelwitschia", minheightWelwitschia);
        prop.setComment("Minimum height that Welwitschia can generate (1 to 250) [default: 1]");
        minheightWelwitschia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "maxheightWelwitschia", maxheightWelwitschia);
        prop.setComment("Maximum height that Welwitschia can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightWelwitschia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschia", "multiplierWelwitschia", multiplierWelwitschia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierWelwitschia = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Welwitschiophyllum", "genWelwitschiophyllum", genWelwitschiophyllum);
        prop.setComment("Set to true to generate Welwitschiophyllum naturally [default: false]");
        genWelwitschiophyllum = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "genWelwitschiophyllumBlacklistBiomes", genWelwitschiophyllumBlacklistBiomes);
        prop.setComment("List of biomes Welwitschiophyllum are blacklisted from, in the format: modid:biomeid [default: empty]");
        genWelwitschiophyllumBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "genWelwitschiophyllumOverrideBiomes", genWelwitschiophyllumOverrideBiomes);
        prop.setComment("List of biomes Welwitschiophyllum are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genWelwitschiophyllumOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "dimWelwitschiophyllum", dimWelwitschiophyllum);
        prop.setComment("List of dimension IDs Welwitschiophyllum can generate in [default: 0]");
        dimWelwitschiophyllum = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "minheightWelwitschiophyllum", minheightWelwitschiophyllum);
        prop.setComment("Minimum height that Welwitschiophyllum can generate (1 to 250) [default: 1]");
        minheightWelwitschiophyllum = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "maxheightWelwitschiophyllum", maxheightWelwitschiophyllum);
        prop.setComment("Maximum height that Welwitschiophyllum can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightWelwitschiophyllum = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Welwitschiophyllum", "multiplierWelwitschiophyllum", multiplierWelwitschiophyllum);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierWelwitschiophyllum = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Anemone", "genAnemoneFlower", genAnemoneFlower);
        prop.setComment("Set to true to generate Anemone naturally [default: false]");
        genAnemoneFlower = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "genAnemoneFlowerBlacklistBiomes", genAnemoneFlowerBlacklistBiomes);
        prop.setComment("List of biomes Anemone are blacklisted from, in the format: modid:biomeid [default: empty]");
        genAnemoneFlowerBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "genAnemoneFlowerOverrideBiomes", genAnemoneFlowerOverrideBiomes);
        prop.setComment("List of biomes Anemone are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genAnemoneFlowerOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "dimAnemoneFlower", dimAnemoneFlower);
        prop.setComment("List of dimension IDs Anemone can generate in [default: 0]");
        dimAnemoneFlower = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "minheightAnemoneFlower", minheightAnemoneFlower);
        prop.setComment("Minimum height that Anemone can generate (1 to 250) [default: 1]");
        minheightAnemoneFlower = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "maxheightAnemoneFlower", maxheightAnemoneFlower);
        prop.setComment("Maximum height that Anemone can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightAnemoneFlower = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Anemone", "multiplierAnemoneFlower", multiplierAnemoneFlower);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierAnemoneFlower = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Buttercup", "genButtercup", genButtercup);
        prop.setComment("Set to true to generate Buttercup naturally [default: false]");
        genButtercup = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "genButtercupBlacklistBiomes", genButtercupBlacklistBiomes);
        prop.setComment("List of biomes Buttercup are blacklisted from, in the format: modid:biomeid [default: empty]");
        genButtercupBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "genButtercupOverrideBiomes", genButtercupOverrideBiomes);
        prop.setComment("List of biomes Buttercup are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genButtercupOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "dimButtercup", dimButtercup);
        prop.setComment("List of dimension IDs Buttercup can generate in [default: 0]");
        dimButtercup = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "minheightButtercup", minheightButtercup);
        prop.setComment("Minimum height that Buttercup can generate (1 to 250) [default: 1]");
        minheightButtercup = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "maxheightButtercup", maxheightButtercup);
        prop.setComment("Maximum height that Buttercup can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightButtercup = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buttercup", "multiplierButtercup", multiplierButtercup);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierButtercup = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Telopea", "genTelopea", genTelopea);
        prop.setComment("Set to true to generate Telopea naturally [default: false]");
        genTelopea = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "genTelopeaBlacklistBiomes", genTelopeaBlacklistBiomes);
        prop.setComment("List of biomes Telopea are blacklisted from, in the format: modid:biomeid [default: empty]");
        genTelopeaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "genTelopeaOverrideBiomes", genTelopeaOverrideBiomes);
        prop.setComment("List of biomes Telopea are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genTelopeaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "dimTelopea", dimTelopea);
        prop.setComment("List of dimension IDs Telopea can generate in [default: 0]");
        dimTelopea = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "minheightTelopea", minheightTelopea);
        prop.setComment("Minimum height that Telopea can generate (1 to 250) [default: 80]");
        minheightTelopea = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "maxheightTelopea", maxheightTelopea);
        prop.setComment("Maximum height that Telopea can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightTelopea = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Telopea", "multiplierTelopea", multiplierTelopea);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierTelopea = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Lomatia", "genLomatia", genLomatia);
        prop.setComment("Set to true to generate Lomatia naturally [default: false]");
        genLomatia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "genLomatiaBlacklistBiomes", genLomatiaBlacklistBiomes);
        prop.setComment("List of biomes Lomatia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genLomatiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "genLomatiaOverrideBiomes", genLomatiaOverrideBiomes);
        prop.setComment("List of biomes Lomatia are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genLomatiaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "dimLomatia", dimLomatia);
        prop.setComment("List of dimension IDs Lomatia can generate in [default: 0]");
        dimLomatia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "minheightLomatia", minheightLomatia);
        prop.setComment("Minimum height that Lomatia can generate (1 to 250) [default: 80]");
        minheightLomatia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "maxheightLomatia", maxheightLomatia);
        prop.setComment("Maximum height that Lomatia can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightLomatia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Lomatia", "multiplierLomatia", multiplierLomatia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierLomatia = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Buckthorn", "genBuckthorn", genBuckthorn);
        prop.setComment("Set to true to generate Buckthorn naturally [default: false]");
        genBuckthorn = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "genBuckthornBlacklistBiomes", genBuckthornBlacklistBiomes);
        prop.setComment("List of biomes Buckthorn are blacklisted from, in the format: modid:biomeid [default: empty]");
        genBuckthornBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "genBuckthornOverrideBiomes", genBuckthornOverrideBiomes);
        prop.setComment("List of biomes Buckthorn are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genBuckthornOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "dimBuckthorn", dimBuckthorn);
        prop.setComment("List of dimension IDs Buckthorn can generate in [default: 0]");
        dimBuckthorn = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "minheightBuckthorn", minheightBuckthorn);
        prop.setComment("Minimum height that Buckthorn can generate (1 to 250) [default: 80]");
        minheightBuckthorn = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "maxheightBuckthorn", maxheightBuckthorn);
        prop.setComment("Maximum height that Buckthorn can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightBuckthorn = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Buckthorn", "multiplierBuckthorn", multiplierBuckthorn);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierBuckthorn = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Drimys", "genDrimys", genDrimys);
        prop.setComment("Set to true to generate Drimys naturally [default: false]");
        genDrimys = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "genDrimysBlacklistBiomes", genDrimysBlacklistBiomes);
        prop.setComment("List of biomes Drimys are blacklisted from, in the format: modid:biomeid [default: empty]");
        genDrimysBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "genDrimysOverrideBiomes", genDrimysOverrideBiomes);
        prop.setComment("List of biomes Drimys are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genDrimysOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "dimDrimys", dimDrimys);
        prop.setComment("List of dimension IDs Drimys can generate in [default: 0]");
        dimDrimys = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "minheightDrimys", minheightDrimys);
        prop.setComment("Minimum height that Drimys can generate (1 to 250) [default: 80]");
        minheightDrimys = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "maxheightDrimys", maxheightDrimys);
        prop.setComment("Maximum height that Drimys can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightDrimys = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Drimys", "multiplierDrimys", multiplierDrimys);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierDrimys = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Orites", "genOrites", genOrites);
        prop.setComment("Set to true to generate Orites naturally [default: false]");
        genOrites = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "genOritesBlacklistBiomes", genOritesBlacklistBiomes);
        prop.setComment("List of biomes Orites are blacklisted from, in the format: modid:biomeid [default: empty]");
        genOritesBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "genOritesOverrideBiomes", genOritesOverrideBiomes);
        prop.setComment("List of biomes Orites are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genOritesOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "dimOrites", dimOrites);
        prop.setComment("List of dimension IDs Orites can generate in [default: 0]");
        dimOrites = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "minheightOrites", minheightOrites);
        prop.setComment("Minimum height that Orites can generate (1 to 250) [default: 80]");
        minheightOrites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "maxheightOrites", maxheightOrites);
        prop.setComment("Maximum height that Orites can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightOrites = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Orites", "multiplierOrites", multiplierOrites);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierOrites = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Bellendena", "genBellendena", genBellendena);
        prop.setComment("Set to true to generate Bellendena naturally [default: false]");
        genBellendena = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "genBellendenaBlacklistBiomes", genBellendenaBlacklistBiomes);
        prop.setComment("List of biomes Bellendena are blacklisted from, in the format: modid:biomeid [default: empty]");
        genBellendenaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "genBellendenaOverrideBiomes", genBellendenaOverrideBiomes);
        prop.setComment("List of biomes Bellendena are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genBellendenaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "dimBellendena", dimBellendena);
        prop.setComment("List of dimension IDs Bellendena can generate in [default: 0]");
        dimBellendena = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "minheightBellendena", minheightBellendena);
        prop.setComment("Minimum height that Bellendena can generate (1 to 250) [default: 80]");
        minheightBellendena = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "maxheightBellendena", maxheightBellendena);
        prop.setComment("Maximum height that Bellendena can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightBellendena = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bellendena", "multiplierBellendena", multiplierBellendena);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierBellendena = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Gansufructus", "genGansufructus", genGansufructus);
        prop.setComment("Set to true to generate Gansufructus naturally [default: false]");
        genGansufructus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "genGansufructusBlacklistBiomes", genGansufructusBlacklistBiomes);
        prop.setComment("List of biomes Gansufructus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGansufructusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "genGansufructusOverrideBiomes", genGansufructusOverrideBiomes);
        prop.setComment("List of biomes Gansufructus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGansufructusOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "dimGansufructus", dimGansufructus);
        prop.setComment("List of dimension IDs Gansufructus can generate in [default: 0]");
        dimGansufructus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "minheightGansufructus", minheightGansufructus);
        prop.setComment("Minimum height that Gansufructus can generate (1 to 250) [default: 1]");
        minheightGansufructus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "maxheightGansufructus", maxheightGansufructus);
        prop.setComment("Maximum height that Gansufructus can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightGansufructus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Gansufructus", "multiplierGansufructus", multiplierGansufructus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGansufructus = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Santaniella", "genSantaniella", genSantaniella);
        prop.setComment("Set to true to generate Santaniella naturally [default: false]");
        genSantaniella = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "genSantaniellaBlacklistBiomes", genSantaniellaBlacklistBiomes);
        prop.setComment("List of biomes Santaniella are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSantaniellaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "genSantaniellaOverrideBiomes", genSantaniellaOverrideBiomes);
        prop.setComment("List of biomes Santaniella are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSantaniellaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "dimSantaniella", dimSantaniella);
        prop.setComment("List of dimension IDs Santaniella can generate in [default: 0]");
        dimSantaniella = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "minheightSantaniella", minheightSantaniella);
        prop.setComment("Minimum height that Santaniella can generate (1 to 250) [default: 1]");
        minheightSantaniella = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "maxheightSantaniella", maxheightSantaniella);
        prop.setComment("Maximum height that Santaniella can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightSantaniella = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Santaniella", "multiplierSantaniella", multiplierSantaniella);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSantaniella = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Sinoherba", "genSinoherba", genSinoherba);
        prop.setComment("Set to true to generate Sinoherba naturally [default: false]");
        genSinoherba = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "genSinoherbaBlacklistBiomes", genSinoherbaBlacklistBiomes);
        prop.setComment("List of biomes Sinoherba are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSinoherbaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "genSinoherbaOverrideBiomes", genSinoherbaOverrideBiomes);
        prop.setComment("List of biomes Sinoherba are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSinoherbaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "dimSinoherba", dimSinoherba);
        prop.setComment("List of dimension IDs Sinoherba can generate in [default: 0]");
        dimSinoherba = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "minheightSinoherba", minheightSinoherba);
        prop.setComment("Minimum height that Sinoherba can generate (1 to 250) [default: 1]");
        minheightSinoherba = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "maxheightSinoherba", maxheightSinoherba);
        prop.setComment("Maximum height that Sinoherba can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightSinoherba = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sinoherba", "multiplierSinoherba", multiplierSinoherba);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSinoherba = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Daisy", "genDaisy", genDaisy);
        prop.setComment("Set to true to generate Daisy naturally [default: false]");
        genDaisy = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Daisy", "genDaisyBlacklistBiomes", genDaisyBlacklistBiomes);
        prop.setComment("List of biomes Daisy are blacklisted from, in the format: modid:biomeid [default: empty]");
        genDaisyBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Daisy", "genDaisyOverrideBiomes", genDaisyOverrideBiomes);
        prop.setComment("List of biomes Daisy are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genDaisyOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Daisy", "dimDaisy", dimDaisy);
        prop.setComment("List of dimension IDs Daisy can generate in [default: 0]");
        dimDaisy = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Daisy", "minheightDaisy", minheightDaisy);
        prop.setComment("Minimum height that Daisy can generate (1 to 250) [default: 1]");
        minheightDaisy = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Daisy", "maxheightDaisy", maxheightDaisy);
        prop.setComment("Maximum height that Daisy can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightDaisy = prop.getInt();
        propOrder.add(prop.getName());
        ...
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "genProtognetumBlacklistBiomes", genProtognetumBlacklistBiomes);
        prop.setComment("List of biomes Protognetum are blacklisted from, in the format: modid:biomeid [default: empty]");
        genProtognetumBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "genProtognetumOverrideBiomes", genProtognetumOverrideBiomes);
        prop.setComment("List of biomes Protognetum are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genProtognetumOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "dimProtognetum", dimProtognetum);
        prop.setComment("List of dimension IDs Protognetum can generate in [default: 0]");
        dimProtognetum = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "minheightProtognetum", minheightProtognetum);
        prop.setComment("Minimum height that Protognetum can generate (1 to 250) [default: 1]");
        minheightProtognetum = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "maxheightProtognetum", maxheightProtognetum);
        prop.setComment("Maximum height that Protognetum can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightProtognetum = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Protognetum", "multiplierProtognetum", multiplierProtognetum);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        ...
        prop = cfg.get("WorldGen Hydrangea", "genHydrangea", genHydrangea);
        prop.setComment("Set to true to generate Hydrangea naturally [default: false]");
        genHydrangea = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hydrangea", "genHydrangeaBlacklistBiomes", genHydrangeaBlacklistBiomes);
        prop.setComment("List of biomes Hydrangea are blacklisted from, in the format: modid:biomeid [default: empty]");
        genHydrangeaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hydrangea", "genHydrangeaOverrideBiomes", genHydrangeaOverrideBiomes);
        prop.setComment("List of biomes Hydrangea are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genHydrangeaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Hydrangea", "dimHydrangea", dimHydrangea);
        prop.setComment("List of dimension IDs Hydrangea can generate in [default: 0]");
        dimHydrangea = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hydrangea", "minheightHydrangea", minheightHydrangea);
        prop.setComment("Minimum height that Hydrangea can generate (1 to 250) [default: 1]");
        minheightHydrangea = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hydrangea", "maxheightHydrangea", maxheightHydrangea);
        prop.setComment("Maximum height that Hydrangea can generate (1 to 250, or set to 0 for unlimited) [default: 90]");
        maxheightHydrangea = prop.getInt();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Bisonia", "genBisonia", genBisonia);
        prop.setComment("Set to true to generate Bisonia trees naturally [default: false]");
        genBisonia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bisonia", "genBisoniaBlacklistBiomes", genBisoniaBlacklistBiomes);
        prop.setComment("List of biomes Bisonia trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genBisoniaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bisonia", "genBisoniaOverrideBiomes", genBisoniaOverrideBiomes);
        prop.setComment("List of biomes Bisonia trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genBisoniaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Bisonia", "dimBisonia", dimBisonia);
        prop.setComment("List of dimension IDs Bisonia trees can generate in [default: 0]");
        dimBisonia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bisonia", "minheightBisonia", minheightBisonia);
        prop.setComment("Minimum height that Bisonia trees can generate (1 to 250) [default: 1]");
        minheightBisonia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bisonia", "maxheightBisonia", maxheightBisonia);
        prop.setComment("Maximum height that Bisonia trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightBisonia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Bisonia", "multiplierBisonia", multiplierBisonia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierBisonia = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Liquidambar", "genLiquidambar", genLiquidambar);
        prop.setComment("Set to true to generate Liquidambar trees naturally [default: false]");
        genLiquidambar = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Liquidambar", "genLiquidambarBlacklistBiomes", genLiquidambarBlacklistBiomes);
        prop.setComment("List of biomes Liquidambar trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genLiquidambarBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Liquidambar", "genLiquidambarOverrideBiomes", genLiquidambarOverrideBiomes);
        prop.setComment("List of biomes Liquidambar trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genLiquidambarOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Liquidambar", "dimLiquidambar", dimLiquidambar);
        prop.setComment("List of dimension IDs Liquidambar trees can generate in [default: 0]");
        dimLiquidambar = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Liquidambar", "minheightLiquidambar", minheightLiquidambar);
        prop.setComment("Minimum height that Liquidambar trees can generate (1 to 250) [default: 1]");
        minheightLiquidambar = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Liquidambar", "maxheightLiquidambar", maxheightLiquidambar);
        prop.setComment("Maximum height that Liquidambar trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightLiquidambar = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Liquidambar", "multiplierLiquidambar", multiplierLiquidambar);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierLiquidambar = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Callianthus", "genCallianthus", genCallianthus);
        prop.setComment("Set to true to generate Callianthus naturally [default: false]");
        genCallianthus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "genCallianthusBlacklistBiomes", genCallianthusBlacklistBiomes);
        prop.setComment("List of biomes Callianthus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genCallianthusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "genCallianthusOverrideBiomes", genCallianthusOverrideBiomes);
        prop.setComment("List of biomes Callianthus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genCallianthusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Callianthus", "dimCallianthus", dimCallianthus);
        prop.setComment("List of dimension IDs Callianthus can generate in [default: 0]");
        dimCallianthus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "minheightCallianthus", minheightCallianthus);
        prop.setComment("Minimum height that Callianthus can generate (1 to 250) [default: 1]");
        minheightCallianthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "maxheightCallianthus", maxheightCallianthus);
        prop.setComment("Maximum height that Callianthus can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightCallianthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "multiplierCallianthus", multiplierCallianthus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierCallianthus = prop.getDouble();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Callianthus", "spreadCallianthus", spreadCallianthus);
        prop.setComment("Set to true for Callianthus to spread naturally, and to false to require bonemeal to spread [default: true]");
        spreadCallianthus = prop.getBoolean();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Montsechia", "genMontsechia", genMontsechia);
        prop.setComment("Set to true to generate Montsechia naturally [default: false]");
        genMontsechia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "genMontsechiaBlacklistBiomes", genMontsechiaBlacklistBiomes);
        prop.setComment("List of biomes Montsechia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genMontsechiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "genMontsechiaOverrideBiomes", genMontsechiaOverrideBiomes);
        prop.setComment("List of biomes Montsechia are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genMontsechiaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Montsechia", "dimMontsechia", dimMontsechia);
        prop.setComment("List of dimension IDs Montsechia can generate in [default: 0]");
        dimMontsechia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "minheightMontsechia", minheightMontsechia);
        prop.setComment("Minimum height that Montsechia can generate (1 to 250) [default: 1]");
        minheightMontsechia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "maxheightMontsechia", maxheightMontsechia);
        prop.setComment("Maximum height that Montsechia can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightMontsechia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "multiplierMontsechia", multiplierMontsechia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierMontsechia = prop.getDouble();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Montsechia", "spreadMontsechia", spreadMontsechia);
        prop.setComment("Set to true for Montsechia to spread naturally, and to false to require bonemeal to spread [default: true]");
        spreadMontsechia = prop.getBoolean();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Crossotheca", "genSphenopteris", genSphenopteris);
        prop.setComment("Set to true to generate Crossotheca naturally [default: false]");
        genSphenopteris = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Crossotheca", "genSphenopterisBlacklistBiomes", genSphenopterisBlacklistBiomes);
        prop.setComment("List of biomes Crossotheca are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSphenopterisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Crossotheca", "genSphenopterisOverrideBiomes", genSphenopterisOverrideBiomes);
        prop.setComment("List of biomes Crossotheca are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSphenopterisOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Crossotheca", "dimSphenopteris", dimSphenopteris);
        prop.setComment("List of dimension IDs Crossotheca can generate in [default: 0]");
        dimSphenopteris = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Crossotheca", "minheightSphenopteris", minheightSphenopteris);
        prop.setComment("Minimum height that Crossotheca can generate (1 to 250) [default: 1]");
        minheightSphenopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Crossotheca", "maxheightSphenopteris", maxheightSphenopteris);
        prop.setComment("Maximum height that Crossotheca can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightSphenopteris = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Crossotheca", "multiplierSphenopteris", multiplierSphenopteris);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSphenopteris = prop.getDouble();
        propOrder.add(prop.getName());
        
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "genSphenopterisSeed", genSphenopterisSeed);
        prop.setComment("Set to true to generate Sphenopteris Seed-Plants naturally [default: false]");
        genSphenopterisSeed = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "genSphenopterisSeedBlacklistBiomes", genSphenopterisSeedBlacklistBiomes);
        prop.setComment("List of biomes Sphenopteris Seed-Plants are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSphenopterisSeedBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "genSphenopterisSeedOverrideBiomes", genSphenopterisSeedOverrideBiomes);
        prop.setComment("List of biomes Sphenopteris Seed-Plants are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSphenopterisSeedOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "dimSphenopterisSeed", dimSphenopterisSeed);
        prop.setComment("List of dimension IDs Sphenopteris Seed-Plants can generate in [default: 0]");
        dimSphenopterisSeed = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "minheightSphenopterisSeed", minheightSphenopterisSeed);
        prop.setComment("Minimum height that Sphenopteris Seed-Plants can generate (1 to 250) [default: 1]");
        minheightSphenopterisSeed = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "maxheightSphenopterisSeed", maxheightSphenopterisSeed);
        prop.setComment("Maximum height that Sphenopteris Seed-Plants can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightSphenopterisSeed = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Seed-Plant", "multiplierSphenopterisSeed", multiplierSphenopterisSeed);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSphenopterisSeed = prop.getDouble();
        propOrder.add(prop.getName());
        
        prop = cfg.get("WorldGen Sphenopteris Fern", "genSphenopterisFern", genSphenopterisFern);
        prop.setComment("Set to true to generate Sphenopteris Ferns naturally [default: false]");
        genSphenopterisFern = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Fern", "genSphenopterisFernBlacklistBiomes", genSphenopterisFernBlacklistBiomes);
        prop.setComment("List of biomes Sphenopteris Ferns are blacklisted from, in the format: modid:biomeid [default: empty]");
        genSphenopterisFernBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Fern", "genSphenopterisFernOverrideBiomes", genSphenopterisFernOverrideBiomes);
        prop.setComment("List of biomes Sphenopteris Ferns are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genSphenopterisFernOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Sphenopteris Fern", "dimSphenopterisFern", dimSphenopterisFern);
        prop.setComment("List of dimension IDs Sphenopteris Ferns can generate in [default: 0]");
        dimSphenopterisFern = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Fern", "minheightSphenopterisFern", minheightSphenopterisFern);
        prop.setComment("Minimum height that Sphenopteris Ferns can generate (1 to 250) [default: 1]");
        minheightSphenopterisFern = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Fern", "maxheightSphenopterisFern", maxheightSphenopterisFern);
        prop.setComment("Maximum height that Sphenopteris Ferns can generate (1 to 250, or set to 0 for unlimited) [default: 100]");
        maxheightSphenopterisFern = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sphenopteris Fern", "multiplierSphenopterisFern", multiplierSphenopterisFern);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierSphenopterisFern = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Golden Larch", "genGoldenLarch", genGoldenLarch);
        prop.setComment("Set to true to generate GoldenLarch (Golden Larch) trees naturally [default: false]");
        genGoldenLarch = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Golden Larch", "genGoldenLarchBlacklistBiomes", genGoldenLarchBlacklistBiomes);
        prop.setComment("List of biomes GoldenLarch (Golden Larch) trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genGoldenLarchBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Golden Larch", "genGoldenLarchOverrideBiomes", genGoldenLarchOverrideBiomes);
        prop.setComment("List of biomes GoldenLarch (Golden Larch) trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genGoldenLarchOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Golden Larch", "dimGoldenLarch", dimGoldenLarch);
        prop.setComment("List of dimension IDs GoldenLarch (Golden Larch) trees can generate in [default: 0]");
        dimGoldenLarch = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Golden Larch", "minheightGoldenLarch", minheightGoldenLarch);
        prop.setComment("Minimum height that GoldenLarch (Golden Larch) trees can generate (1 to 250) [default: 75]");
        minheightGoldenLarch = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Golden Larch", "maxheightGoldenLarch", maxheightGoldenLarch);
        prop.setComment("Maximum height that GoldenLarch (Golden Larch) trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightGoldenLarch = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Golden Larch", "multiplierGoldenLarch", multiplierGoldenLarch);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierGoldenLarch = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop.setComment("Set to true to generate Pagiophyllum trees naturally [default: false]");
        ...
        prop.setComment("List of biomes Pagiophyllum trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        ...
        prop.setComment("List of biomes Pagiophyllum trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genPagiophyllumOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Pagiophyllum", "dimPagiophyllum", dimPagiophyllum);
        prop.setComment("List of dimension IDs Pagiophyllum trees can generate in [default: 0]");
        dimPagiophyllum = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pagiophyllum", "minheightPagiophyllum", minheightPagiophyllum);
        prop.setComment("Minimum height that Pagiophyllum trees can generate (1 to 250) [default: 1]");
        minheightPagiophyllum = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Pagiophyllum", "maxheightPagiophyllum", maxheightPagiophyllum);
        prop.setComment("Maximum height that Pagiophyllum trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        ...
        prop = cfg.get("WorldGen Laurus", "genLaurus", genLaurus);
        prop.setComment("Set to true to generate Laurus trees naturally [default: false]");
        genLaurus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Laurus", "genLaurusBlacklistBiomes", genLaurusBlacklistBiomes);
        prop.setComment("List of biomes Laurus trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genLaurusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Laurus", "genLaurusOverrideBiomes", genLaurusOverrideBiomes);
        prop.setComment("List of biomes Laurus trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genLaurusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Laurus", "dimLaurus", dimLaurus);
        prop.setComment("List of dimension IDs Laurus trees can generate in [default: 0]");
        dimLaurus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Laurus", "minheightLaurus", minheightLaurus);
        prop.setComment("Minimum height that Laurus trees can generate (1 to 250) [default: 1]");
        minheightLaurus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Laurus", "maxheightLaurus", maxheightLaurus);
        prop.setComment("Maximum height that Laurus trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightLaurus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Laurus", "multiplierLaurus", multiplierLaurus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierLaurus = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Chestnut", "genChestnut", genChestnut);
        prop.setComment("Set to true to generate Chestnut trees naturally [default: false]");
        genChestnut = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chestnut", "genChestnutBlacklistBiomes", genChestnutBlacklistBiomes);
        prop.setComment("List of biomes Chestnut trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genChestnutBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chestnut", "genChestnutOverrideBiomes", genChestnutOverrideBiomes);
        prop.setComment("List of biomes Chestnut trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genChestnutOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Chestnut", "dimChestnut", dimChestnut);
        prop.setComment("List of dimension IDs Chestnut trees can generate in [default: 0]");
        dimChestnut = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chestnut", "minheightChestnut", minheightChestnut);
        prop.setComment("Minimum height that Chestnut trees can generate (1 to 250) [default: 1]");
        minheightChestnut = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chestnut", "maxheightChestnut", maxheightChestnut);
        prop.setComment("Maximum height that Chestnut trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightChestnut = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chestnut", "multiplierChestnut", multiplierChestnut);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierChestnut = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Hirmeriella", "genHirmeriella", genHirmeriella);
        prop.setComment("Set to true to generate Hirmeriella trees naturally [default: false]");
        genHirmeriella = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hirmeriella", "genHirmeriellaBlacklistBiomes", genHirmeriellaBlacklistBiomes);
        prop.setComment("List of biomes Hirmeriella trees are blacklisted from, in the format: modid:biomeid [default: empty]");
        genHirmeriellaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hirmeriella", "genHirmeriellaOverrideBiomes", genHirmeriellaOverrideBiomes);
        prop.setComment("List of biomes Hirmeriella trees are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genHirmeriellaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hirmeriella", "dimHirmeriella", dimHirmeriella);
        prop.setComment("List of dimension IDs Hirmeriella trees can generate in [default: 0]");
        dimHirmeriella = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hirmeriella", "minheightHirmeriella", minheightHirmeriella);
        prop.setComment("Minimum height that Hirmeriella trees can generate (1 to 250) [default: 1]");
        minheightHirmeriella = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hirmeriella", "maxheightHirmeriella", maxheightHirmeriella);
        prop.setComment("Maximum height that Hirmeriella trees can generate (1 to 250, or set to 0 for unlimited) [default: 110]");
        maxheightHirmeriella = prop.getInt();
        propOrder.add(prop.getName());
        ...
        prop.setComment("Set to true to generate Chloranthus naturally [default: false]");
        genChloranthus = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chloranthus", "genChloranthusBlacklistBiomes", genChloranthusBlacklistBiomes);
        prop.setComment("List of biomes Chloranthus are blacklisted from, in the format: modid:biomeid [default: empty]");
        genChloranthusBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chloranthus", "genChloranthusOverrideBiomes", genChloranthusOverrideBiomes);
        prop.setComment("List of biomes Chloranthus are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genChloranthusOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Chloranthus", "dimChloranthus", dimChloranthus);
        prop.setComment("List of dimension IDs Chloranthus can generate in [default: 0]");
        dimChloranthus = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chloranthus", "minheightChloranthus", minheightChloranthus);
        prop.setComment("Minimum height that Chloranthus can generate (1 to 250) [default: 1]");
        minheightChloranthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chloranthus", "maxheightChloranthus", maxheightChloranthus);
        prop.setComment("Maximum height that Chloranthus can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightChloranthus = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Chloranthus", "multiplierChloranthus", multiplierChloranthus);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierChloranthus = prop.getDouble();
        ...
        prop = cfg.get("WorldGen Ktalenia", "genKtalenia", genKtalenia);
        prop.setComment("Set to true to generate Ktalenia naturally [default: false]");
        genKtalenia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ktalenia", "genKtaleniaBlacklistBiomes", genKtaleniaBlacklistBiomes);
        prop.setComment("List of biomes Ktalenia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genKtaleniaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ktalenia", "genKtaleniaOverrideBiomes", genKtaleniaOverrideBiomes);
        prop.setComment("List of biomes Ktalenia are forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genKtaleniaOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Ktalenia", "dimKtalenia", dimKtalenia);
        prop.setComment("List of dimension IDs Ktalenia can generate in [default: 0]");
        dimKtalenia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ktalenia", "minheightKtalenia", minheightKtalenia);
        prop.setComment("Minimum height that Ktalenia can generate (1 to 250) [default: 1]");
        minheightKtalenia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ktalenia", "maxheightKtalenia", maxheightKtalenia);
        prop.setComment("Maximum height that Ktalenia can generate (1 to 250, or set to 0 for unlimited) [default: 85]");
        maxheightKtalenia = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Ktalenia", "multiplierKtalenia", multiplierKtalenia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierKtalenia = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop.setComment("List of dimension IDs Aristolochia can generate in [default: 0]");
        dimAristolochia = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Aristolochia", "genAristolochia", genAristolochia);
        prop.setComment("Set to true to generate Aristolochia naturally [default: false]");
        genAristolochia = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Aristolochia", "genAristolochiaBlacklistBiomes", genAristolochiaBlacklistBiomes);
        prop.setComment("List of biomes Aristolochia are blacklisted from, in the format: modid:biomeid [default: empty]");
        genAristolochiaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Aristolochia", "genAristolochiaOverrideBiomes", genAristolochiaOverrideBiomes);
        prop.setComment("List of biomes Aristolochia are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genAristolochiaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Aristolochia", "multiplierAristolochia", multiplierAristolochia);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierAristolochia = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Hops", "dimHops", dimHops);
        prop.setComment("List of dimension IDs Hops can generate in [default: 0]");
        dimHops = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hops", "genHops", genHops);
        prop.setComment("Set to true to generate Hops naturally [default: false]");
        genHops = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hops", "genHopsBlacklistBiomes", genHopsBlacklistBiomes);
        prop.setComment("List of biomes Hops are blacklisted from, in the format: modid:biomeid [default: empty]");
        genHopsBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hops", "genHopsOverrideBiomes", genHopsOverrideBiomes);
        prop.setComment("List of biomes Hops are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genHopsOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hops", "multiplierHops", multiplierHops);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierHops = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Hedera", "dimHedera", dimHedera);
        prop.setComment("List of dimension IDs Hedera can generate in [default: 0]");
        dimHedera = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hedera", "genHedera", genHedera);
        prop.setComment("Set to true to generate Hedera naturally [default: false]");
        genHedera = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hedera", "genHederaBlacklistBiomes", genHederaBlacklistBiomes);
        prop.setComment("List of biomes Hedera are blacklisted from, in the format: modid:biomeid [default: empty]");
        genHederaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hedera", "genHederaOverrideBiomes", genHederaOverrideBiomes);
        prop.setComment("List of biomes Hedera are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genHederaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Hedera", "multiplierHedera", multiplierHedera);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierHedera = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Vitis", "dimVitis", dimVitis);
        prop.setComment("List of dimension IDs Vitis can generate in [default: 0]");
        dimVitis = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Vitis", "genVitis", genVitis);
        prop.setComment("Set to true to generate Vitis naturally [default: false]");
        genVitis = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Vitis", "genVitisBlacklistBiomes", genVitisBlacklistBiomes);
        prop.setComment("List of biomes Vitis are blacklisted from, in the format: modid:biomeid [default: empty]");
        genVitisBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Vitis", "genVitisOverrideBiomes", genVitisOverrideBiomes);
        prop.setComment("List of biomes Vitis are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genVitisOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Vitis", "multiplierVitis", multiplierVitis);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierVitis = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Actinidea", "dimActinidea", dimActinidea);
        prop.setComment("List of dimension IDs Actinidea can generate in [default: 0]");
        dimActinidea = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Actinidea", "genActinidea", genActinidea);
        prop.setComment("Set to true to generate Actinidea naturally [default: false]");
        genActinidea = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Actinidea", "genActinideaBlacklistBiomes", genActinideaBlacklistBiomes);
        prop.setComment("List of biomes Actinidea are blacklisted from, in the format: modid:biomeid [default: empty]");
        genActinideaBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Actinidea", "genActinideaOverrideBiomes", genActinideaOverrideBiomes);
        prop.setComment("List of biomes Actinidea are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genActinideaOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Actinidea", "multiplierActinidea", multiplierActinidea);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierActinidea = prop.getDouble();
        propOrder.add(prop.getName());

        prop = cfg.get("WorldGen Yam", "dimYam", dimYam);
        prop.setComment("List of dimension IDs Yams can generate in [default: 0]");
        dimYam = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Yam", "genYam", genYam);
        prop.setComment("Set to true to generate Yams naturally [default: false]");
        genYam = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Yam", "genYamBlacklistBiomes", genYamBlacklistBiomes);
        prop.setComment("List of biomes Yams are blacklisted from, in the format: modid:biomeid [default: empty]");
        genYamBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Yam", "genYamOverrideBiomes", genYamOverrideBiomes);
        prop.setComment("List of biomes Yams are forced to generate in (provided the dimension is also valid), in the format: modid:biomeid [default: empty]");
        genYamOverrideBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Yam", "multiplierYam", multiplierYam);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierYam = prop.getDouble();
        propOrder.add(prop.getName());
        ...
        prop = cfg.get("WorldGen Sedge", "genPrimaevalGrass", genPrimaevalGrass);
        prop.setComment("Set to true to generate Sedge naturally [default: false]");
        genPrimaevalGrass = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "genPrimaevalGrassBlacklistBiomes", genPrimaevalGrassBlacklistBiomes);
        prop.setComment("List of biomes Sedge is blacklisted from, in the format: modid:biomeid [default: empty]");
        genPrimaevalGrassBlacklistBiomes = prop.getStringList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "genPrimaevalGrassOverrideBiomes", genPrimaevalGrassOverrideBiomes);
        prop.setComment("List of biomes Sedge is forced to generate in provided the dimension is also valid (this will override the global blacklist setting), in the format: modid:biomeid [default: empty]");
        genPrimaevalGrassOverrideBiomes = prop.getStringList();
        prop = cfg.get("WorldGen Sedge", "dimPrimaevalGrass", dimPrimaevalGrass);
        prop.setComment("List of dimension IDs Sedge can generate in [default: 0]");
        dimPrimaevalGrass = prop.getIntList();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "minheightPrimaevalGrass", minheightPrimaevalGrass);
        prop.setComment("Minimum height that Sedge can generate (1 to 250) [default: 1]");
        minheightPrimaevalGrass = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "maxheightPrimaevalGrass", maxheightPrimaevalGrass);
        prop.setComment("Maximum height that Sedge can generate (1 to 250, or set to 0 for unlimited) [default: 0]");
        maxheightPrimaevalGrass = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "multiplierPrimaevalGrass", multiplierPrimaevalGrass);
        prop.setComment("Number to multiply the spawn chance by (eg. 0.5 will halve the chance, and 2 will double it, etc., up to some fixed internal values) [default: 1]");
        multiplierPrimaevalGrass = prop.getDouble();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Sedge", "spreadPrimaevalGrass", spreadPrimaevalGrass);
        prop.setComment("Set to true for Sedge to spread naturally, and to false to require bonemeal to spread [default: true]");
        ...
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadArthropitys", spreadArthropitys);
        prop.setComment("Set to true to allow Arthropitys to spread [default: true]");
        spreadArthropitys = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadWorldGenArthropitys", spreadWorldGenArthropitys);
        prop.setComment("Set to true to allow Arthropitys created during world-generation to spread [default: true]");
        spreadWorldGenArthropitys = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadUnlimitedArthropitys", spreadUnlimitedArthropitys);
        prop.setComment("Set to true to allow each new child Arthropitys plant to in turn be able to be a parent [default: false]");
        spreadUnlimitedArthropitys = prop.getBoolean();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadLimitArthropitys", spreadLimitArthropitys);
        prop.setComment("Maximum blocks distance a child Arthropitys plant can appear from a parent [default: 16]");
        spreadLimitArthropitys = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadWaterArthropitys", spreadWaterArthropitys);
        prop.setComment("Minimum blocks distance for water for a world-gen or a child Arthropitys plant to appear [default: 6]");
        spreadWaterArthropitys = prop.getInt();
        propOrder.add(prop.getName());
        prop = cfg.get("WorldGen Arthropitys", "spreadSpeedArthropitys", spreadSpeedArthropitys);
        prop.setComment("The percentage chance that, on receiving a random tick, a parent Arthropitys plant makes attempts to spawn a child [default: 50]");
        spreadSpeedArthropitys = prop.getInt();
        propOrder.add(prop.getName());
