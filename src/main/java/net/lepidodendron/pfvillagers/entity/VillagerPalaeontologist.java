...
public class VillagerPalaeontologist {
    ...
    public static void register() {
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellAnthracoceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellAustraliceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellArcestes.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellCassinoceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellCenoceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellElephantoceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellGoldringia.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellHamulina.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellHypophylloceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellIvoites.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellKosmoceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellMoutoniceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellPhylloceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellSphooceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellSpiroceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellTetrameroceras.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockNautiloidShellTropaeum.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockDecacuminaster.block, 1), new EntityVillager.PriceInfo(1, 2)));
        ...
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockHemiaster.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockLepidaster.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockLepidasterella.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockVillebrunaster.block, 1), new EntityVillager.PriceInfo(1, 2)));
        palaeoCareer.addTrade(1, new EntityVillager.ListItemForEmeralds(new ItemStack(BlockUrasterella.block, 1), new EntityVillager.PriceInfo(1, 2)));
