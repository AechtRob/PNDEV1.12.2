...
public class GenPalaeobotanistHouse extends WorldGenerator {
    ...
    public static void fillUnderHouse(Biome biome, World world, BlockPos pos, int x, int z) {
        ...
        while (xx <= Math.abs(x)) {
            int zz = 0;
            while (zz <= Math.abs(z)) {
                if (world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.SANDSTONE.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.SANDSTONE_STAIRS.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.RED_SANDSTONE.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.RED_SANDSTONE_STAIRS.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.LOG.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.MOSSY_COBBLESTONE.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.LOG2.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.STONE_STAIRS.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.OAK_STAIRS.getDefaultState(), biome).getBlock()
                        || world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == PalaeontologisthouseBlocks.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState(), biome).getBlock())
                {
                    int yy = 1;
                    ...
                    while (pos1.getY() - yy > 0
                        ...
                        world.setBlockState(pos1.add(0, -yy, 0), PalaeobotanisthouseBlocks.getBiomeSpecificBlockState(Blocks.COBBLESTONE.getDefaultState(), biome));
                        yy ++;
                    }
                }
                if (world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getBlock() == Blocks.DIRT)
                {
                    int yy = 1;
                    BlockPos pos1 = pos.add(xx * xxx, 0, zz * zzz);
                    while (pos1.getY() - yy > 0
                        ...
                        world.setBlockState(pos1.add(0, -yy, 0), Blocks.DIRT.getDefaultState());
                        yy ++;
                    }
                }
                if (world.getBlockState(pos.add(xx * xxx, 0, zz * zzz)).getMaterial() == Material.WATER)
                {
                    int yy = 1;
                    BlockPos pos1 = pos.add(xx * xxx, 0, zz * zzz);
                    while (pos1.getY() - yy > 0
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (rotation == Rotation.NONE) {
            template.addBlocksToWorld(worldIn, position.up(3).north(template.getSize().getZ() - 1), new PalaeobotanisthouseBlocks(position.up(3), settings, LepidodendronMod.PALAEOBOTANIST_LOOT, biome, facing.getOpposite()), settings, 2);
            fillUnderHouse(biome, worldIn, position.up(3).east(template.getSize().getZ()), -(template.getSize().getX() - 2), -(template.getSize().getZ() - 1));
        }
        ...
        if (rotation == Rotation.COUNTERCLOCKWISE_90) {
            template.addBlocksToWorld(worldIn, position.up(3).west(template.getSize().getZ()-2), new PalaeobotanisthouseBlocks(position.up(3), settings, LepidodendronMod.PALAEOBOTANIST_LOOT, biome, facing.getOpposite()), settings, 2);
            fillUnderHouse(biome, worldIn, position.up(3).north(template.getSize().getX() - 1).east(), -(template.getSize().getZ() - 1), (template.getSize().getX() - 2));
        }
