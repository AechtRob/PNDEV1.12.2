...
public class LepidodendronSorter {
    ...
    public static final int santanachelys_raw = 5667;
    public static final int eggs_desmatochelys = 5668;
    public static final int desmatochelys_raw = 5667;
    public static final int eggs_cratochelone = 5668;
    public static final int cratochelone_raw = 5667;
