...
public class BlockSycamoreSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sycamore_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:sycamore_slab_double")
	public static final Block block_slab_double = null;
	public BlockSycamoreSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sycamore_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sycamore_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sycamore_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sycamore_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_sycamore_slab");
