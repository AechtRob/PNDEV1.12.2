...
public class BlockMagnoliaLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:magnolia_litterbin")
	public static final Block block = null;
	public BlockMagnoliaLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.magnolia_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("magnolia_litterbin"));
