...
public class BlockDicksoniaLeavesPlaceable extends ElementsLepidodendronMod.ModElement {
	...
	public BlockDicksoniaLeavesPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicksonia_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicksonia_leaves"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dicksonia_leaves", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dicksonia_sapling", BlockDicksoniaLeavesPlaceable.block);
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter, IPottable {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			//super(Material.PLANTS);
			setTranslationKey("pf_dicksonia_leaves");
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) 
	    {
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				if (world.isAirBlock(pos.north()) && world.isAirBlock(pos.north(2)) && world.isAirBlock(pos.north(3)) ) {
					world.setBlockState(pos.north(), BlockDicksoniaLeaves2.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 3);
					world.setBlockState(pos.north(2), BlockDicksoniaLeaves3.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 3);
					world.setBlockState(pos.north(3), BlockDicksoniaLeaves4.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 3);
				}
				else {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.SOUTH) {
				if (world.isAirBlock(pos.south()) && world.isAirBlock(pos.south(2)) && world.isAirBlock(pos.south(3)) ) {
					world.setBlockState(pos.south(), BlockDicksoniaLeaves2.block.getDefaultState().withProperty(FACING, EnumFacing.SOUTH), 3);
					world.setBlockState(pos.south(2), BlockDicksoniaLeaves3.block.getDefaultState().withProperty(FACING, EnumFacing.SOUTH), 3);
					world.setBlockState(pos.south(3), BlockDicksoniaLeaves4.block.getDefaultState().withProperty(FACING, EnumFacing.SOUTH), 3);
				}
				else {
					world.destroyBlock(pos, false);
					if (!world.isRemote) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.EAST) {
				if (world.isAirBlock(pos.east()) && world.isAirBlock(pos.east(2)) && world.isAirBlock(pos.east(3)) ) {
					world.setBlockState(pos.east(), BlockDicksoniaLeaves2.block.getDefaultState().withProperty(FACING, EnumFacing.EAST), 3);
					world.setBlockState(pos.east(2), BlockDicksoniaLeaves3.block.getDefaultState().withProperty(FACING, EnumFacing.EAST), 3);
					world.setBlockState(pos.east(3), BlockDicksoniaLeaves4.block.getDefaultState().withProperty(FACING, EnumFacing.EAST), 3);
				}
				else {
					world.destroyBlock(pos, false);
					if (!world.isRemote) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.WEST) {
				if (world.isAirBlock(pos.west()) && world.isAirBlock(pos.west(2)) && world.isAirBlock(pos.west(3)) ) {
					world.setBlockState(pos.west(), BlockDicksoniaLeaves2.block.getDefaultState().withProperty(FACING, EnumFacing.WEST), 3);
					world.setBlockState(pos.west(2), BlockDicksoniaLeaves3.block.getDefaultState().withProperty(FACING, EnumFacing.WEST), 3);
					world.setBlockState(pos.west(3), BlockDicksoniaLeaves4.block.getDefaultState().withProperty(FACING, EnumFacing.WEST), 3);
				}
				else {
					world.destroyBlock(pos, false);
					if (!world.isRemote) {
		...
		public Block planted() {
			return BlockDicksoniaSapling.block;
		}
