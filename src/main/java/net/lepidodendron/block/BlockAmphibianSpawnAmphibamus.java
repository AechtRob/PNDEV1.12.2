...
public class BlockAmphibianSpawnAmphibamus extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amphibian_spawn_amphibamus_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAmphibianSpawnAmphibamus.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 1; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_amphibamus", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn  {
		public BlockCustom() {
			setTranslationKey("pf_amphibian_spawn_amphibamus_worldgen");
