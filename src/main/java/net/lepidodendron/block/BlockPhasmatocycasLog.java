...
public class BlockPhasmatocycasLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phasmatocycas_log")
	public static final Block block = null;
	public BlockPhasmatocycasLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phasmatocycas_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("phasmatocycas_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:phasmatocycas_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:phasmatocycas_sapling", BlockPhasmatocycasLog.block);
    ...
    public static final PropertyBool ATTACHMENT = PropertyBool.create("attachment");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_phasmatocycas_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if ((block1 == BlockPhasmatocycasShoot.block) || (block1 == BlockPhasmatocycasShootPlaceable.block) || (block1 == BlockPhasmatocycasShootCone.block)) {
