...
public class BlockDioonShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dioon_shoot")
	public static final Block block = null;
	public BlockDioonShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dioon_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dioon_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dioon_shoot", "inventory"));
