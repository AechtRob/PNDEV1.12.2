...
public class BlockHymenaeaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hymenaea_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:hymenaea_slab_double")
	public static final Block block_slab_double = null;
	public BlockHymenaeaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hymenaea_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hymenaea_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("hymenaea_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:hymenaea_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_hymenaea_slab");
