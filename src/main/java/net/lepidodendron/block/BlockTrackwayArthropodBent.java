...
public class BlockTrackwayArthropodBent extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:trackway_arthropod_bent")
	public static final Block block = null;
	public BlockTrackwayArthropodBent(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.trackway_arthropod_bent);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("trackway_arthropod_bent"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:trackway_arthropod_bent", "inventory"));
	}
