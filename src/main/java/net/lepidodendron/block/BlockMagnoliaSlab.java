...
public class BlockMagnoliaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:magnolia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:magnolia_slab_double")
	public static final Block block_slab_double = null;
	public BlockMagnoliaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.magnolia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("magnolia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("magnolia_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:magnolia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_magnolia_slab");
