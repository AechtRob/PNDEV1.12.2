...
public class BlockDawnRedwoodSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dawn_redwood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:dawn_redwood_slab_double")
	public static final Block block_slab_double = null;
	public BlockDawnRedwoodSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dawn_redwood_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dawn_redwood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("dawn_redwood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dawn_redwood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_dawn_redwood_slab");
