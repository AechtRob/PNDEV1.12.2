...
public class BlockRedAlgaeMat extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:red_algae_mat")
	public static final Block block = null;
	public BlockRedAlgaeMat(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.red_algae_mat);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("red_algae_mat"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("plantdnaPNlepidodendron:red_algae_mat", BlockRedAlgaeMat.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:red_algae_mat", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockRedAlgaeMat.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
	   ...
	   // public static final PropertyInteger LEVEL = PropertyInteger.create("level", 0, 15);
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_red_algae_mat");
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
	        	...
	        	tooltip.add("Periods: Periods: [Paleoproterozoic (Rhyacian (?) - Orosirian (?) - Statherian (?)) - Mesoproterozoic (Calymmian (?) - Ectasian (?) - Stenian (?)) - ] Neoproterozoic (Tonian - Cryogenian - Ediacaran) - Cambrian - Ordovician - Silurian - Devonian - Carboniferous - Permian - Triassic - Jurassic - Cretaceous - Paleogene - Neogene - Pleistocene - present");
