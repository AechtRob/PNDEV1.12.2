...
public class BlockRedAlgaeMat extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightRedAlgaeMat;
		...
		if (!matchBiome(biome, LepidodendronConfig.genRedAlgaeMatBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genRedAlgaeMatOverrideBiomes))
			biomeCriteria = true;
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        ...
	        tooltip.add("Periods: Ectasian - Stenian - Tonian - Cryogenian - Ediacaran - Cambrian - Ordovician - Silurian - Devonian - Carboniferous - Permian - Triassic - Jurassic - Cretaceous - Paleogene - Neogene - Quaternary");
