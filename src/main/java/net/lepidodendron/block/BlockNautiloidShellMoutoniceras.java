...
public class BlockNautiloidShellMoutoniceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_moutoniceras")
	public static final Block block = null;
	public BlockNautiloidShellMoutoniceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_moutoniceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_moutoniceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellMoutoniceras.TileEntityCustom.class, "lepidodendron:tileentityshell_moutoniceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_moutoniceras", BlockNautiloidShellMoutoniceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_moutoniceras", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < 10; i++) {
			...
			if (world.isAirBlock(pos) && pos.getY() < Functions.getAdjustedSeaLevel(world, pos) + 3
				...
				if (tileEntity != null) {
					BlockNautiloidShellMoutoniceras.TileEntityCustom te = (BlockNautiloidShellMoutoniceras.TileEntityCustom) tileEntity;
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_moutoniceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellMoutoniceras.TileEntityCustom();
		}

		public BlockNautiloidShellMoutoniceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellMoutoniceras.TileEntityCustom();
		}
