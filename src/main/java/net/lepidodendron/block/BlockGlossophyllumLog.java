...
public class BlockGlossophyllumLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:glossophyllum_log")
	public static final Block block = null;
	public BlockGlossophyllumLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.glossophyllum_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glossophyllum_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:glossophyllum_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:glossophyllum_sapling", BlockGlossophyllumLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_glossophyllum_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockGlossophyllumShoot.block) || (block1 == BlockGlossophyllumShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
