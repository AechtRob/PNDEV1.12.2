...
public class BlockUtrechtiaLeavesSmallPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:utrechtia_leaves_small")
	public static final Block block = null;
	public BlockUtrechtiaLeavesSmallPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.utrechtia_leaves_small);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("utrechtia_leaves_small"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:utrechtia_sapling", BlockUtrechtiaLeavesSmallPlaceable.block);
	...
	public static class BlockCustom extends BlockLeaves {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_utrechtia_leaves_small");
