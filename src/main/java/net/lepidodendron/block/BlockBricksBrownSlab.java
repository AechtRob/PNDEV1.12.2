...
public class BlockBricksBrownSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:brick_brown_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:brick_brown_slab_double")
	public static final Block block_slab_double = null;
	public BlockBricksBrownSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.brick_brown_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brick_brown_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brick_brown_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:brick_brown_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.BROWN);
			setTranslationKey("pf_brick_brown_slab");
