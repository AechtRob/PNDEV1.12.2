...
public class BlockStalkedAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stalked_algae")
	public static final Block block = null;
	public BlockStalkedAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stalked_algae);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stalked_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stalked_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockStalkedAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int weight = LepidodendronConfigPlants.weightStalkedAlgae;
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genStalkedAlgaeBlacklistBiomes)) {
			biomeCriteria = true;
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genStalkedAlgaeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_stalked_algae");
