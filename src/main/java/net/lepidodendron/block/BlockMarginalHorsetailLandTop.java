...
public class BlockMarginalHorsetailLandTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:marginal_horsetail_land_top")
	public static final Block block = null;
	public BlockMarginalHorsetailLandTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.marginal_horsetail_land);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("marginal_horsetail_land_top"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockMarginalHorsetailLandMiddle.block) {
