...
public class BlockIronSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:iron_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:iron_slab_double")
	public static final Block block_slab_double = null;
	public BlockIronSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.iron_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("iron_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("iron_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:iron_slab", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabIron", BlockIronSlab.block);
	}

	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setTranslationKey("pf_iron_slab");
