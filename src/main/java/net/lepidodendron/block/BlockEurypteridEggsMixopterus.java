...
public class BlockEurypteridEggsMixopterus extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eurypterid_eggs_mixopterus_worldgen"));
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 3; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_mixopterus", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_eurypterid_eggs_mixopterus_worldgen");
