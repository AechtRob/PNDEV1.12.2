...
public class BlockNautiloidShellTemperoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_temperoceras")
	public static final Block block = null;
	public BlockNautiloidShellTemperoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_temperoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_temperoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellTemperoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_temperoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_temperoceras", BlockNautiloidShellTemperoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_temperoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_temperoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellTemperoceras.TileEntityCustom();
		}

		public BlockNautiloidShellTemperoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellTemperoceras.TileEntityCustom();
		}
