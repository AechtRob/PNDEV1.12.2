...
public class BlockBunyaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bunya_sapling")
	public static final Block block = null;
	public BlockBunyaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bunya_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bunya_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bunya_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:bunya_sapling", BlockBunyaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_bunya_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BUNYA;
		}
