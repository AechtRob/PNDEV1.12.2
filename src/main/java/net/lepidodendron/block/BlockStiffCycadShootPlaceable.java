...
public class BlockStiffCycadShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stiff_cycad_shoot")
	public static final Block block = null;
	public BlockStiffCycadShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stiff_cycad_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stiff_cycad_shoot"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNstiff_cycad_sapling", BlockStiffCycadShootPlaceable.block);
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_stiff_cycad_shoot");
