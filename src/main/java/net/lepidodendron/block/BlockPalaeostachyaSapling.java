...
public class BlockPalaeostachyaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:palaeostachya_sapling")
	public static final Block block = null;
	public BlockPalaeostachyaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.palaeostachya_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("palaeostachya_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:palaeostachya_sapling", "inventory"));
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_palaeostachya_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PALAEOSTACHYA;
		}
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
	            ...
	            && world.isAirBlock(pos.up()) && world.isAirBlock((pos.up(2))) && world.isAirBlock((pos.up(3))) && world.isAirBlock((pos.up(4)))) {
					world.setBlockState(pos, BlockPalaeostachyaStem.block.getDefaultState(), 3);
					if (Math.random() > 0.6) {
						world.setBlockState(pos.up(), BlockPalaeostachyaStem.block.getDefaultState(), 3);
						world.setBlockState(pos.up(2), BlockPalaeostachyaBottom.block.getDefaultState(), 3);
						world.setBlockState(pos.up(3), BlockPalaeostachyaTop.block.getDefaultState(), 3);
					}
					else {
						world.setBlockState(pos.up(), BlockPalaeostachyaBottom.block.getDefaultState(), 3);
						world.setBlockState(pos.up(2), BlockPalaeostachyaTop.block.getDefaultState(), 3);
					}
	            }
	        }
	    }
