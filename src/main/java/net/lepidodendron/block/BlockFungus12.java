...
public class BlockFungus12 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_12")
	public static final Block block = null;
	public BlockFungus12(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_12);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_12"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_12", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus12.BlockCustom.SPREADABLE).ignore(BlockFungus12.BlockCustom.NORTH).ignore(BlockFungus12.BlockCustom.SOUTH).ignore(BlockFungus12.BlockCustom.EAST).ignore(BlockFungus12.BlockCustom.WEST).ignore(BlockFungus12.BlockCustom.UP).ignore(BlockFungus12.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus12", BlockFungus12.block);
		OreDictionary.registerOre("itemFungus", BlockFungus12.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus12.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_fungus_12");
