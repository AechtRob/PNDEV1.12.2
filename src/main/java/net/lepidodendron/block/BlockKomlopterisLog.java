...
public class BlockKomlopterisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:komlopteris_log")
	public static final Block block = null;
	public BlockKomlopterisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.komlopteris_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("komlopteris_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:komlopteris_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:komlopteris_sapling", BlockKomlopterisLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_komlopteris_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_KOMLOPTERIS;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockKomlopterisShoot.block) || (block1 == BlockKomlopterisShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
