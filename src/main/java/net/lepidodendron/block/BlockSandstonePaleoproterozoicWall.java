...
public class BlockSandstonePaleoproterozoicWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_wall_paleoproterozoic")
	public static final Block block = null;
	public BlockSandstonePaleoproterozoicWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandstone_wall_paleoproterozoic);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstone_wall_paleoproterozoic"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandstone_wall_paleoproterozoic", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sandstone_wall_paleoproterozoic");
