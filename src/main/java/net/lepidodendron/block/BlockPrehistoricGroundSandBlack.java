...
public class BlockPrehistoricGroundSandBlack extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_prehistoric_ground_cover_black")
	public static final Block block = null;
	public BlockPrehistoricGroundSandBlack(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_prehistoric_ground_cover_black);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_prehistoric_ground_cover_black", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling implements IGrowable, ISustainsPlantType {
		public BlockCustom() {
			super(Material.SAND);
			setTranslationKey("pf_sandy_prehistoric_ground_cover_black");
	    ...
	    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        if (!worldIn.isRemote)
	        {
	            ...
	            {
	                worldIn.setBlockState(pos, BlockSandBlack.block.getDefaultState());
	            }
	            else
	            {
					...
					else
					{
		                ...
		                if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
		                {
		                    for (int i = 0; i < 4; ++i)
		                    {
								...
								if (
									(
										((iblockstate1.getBlock() == BlockSandBlack.block)
										)
								...
								)
		                        {
									...
									if (waterCriteria)
		                            	worldIn.setBlockState(blockpos, BlockPrehistoricGroundSandBlack.block.getDefaultState());
		                        }
		                    }
	                    }
	                }
