...
public class BlockLadiniaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ladinia_log")
	public static final Block block = null;
	public BlockLadiniaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ladinia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ladinia_log"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:ladinia_sapling", BlockLadiniaLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockLadiniaShoot.block) || (block1 == BlockLadiniaShootPlaceable.block) || (block1 == BlockLadiniaShootMale.block) || (block1 == BlockLadiniaShootMalePlaceable.block) || (block1 == BlockLadiniaShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
