...
public class BlockCoralStonyBlooming extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_stony_blooming")
	public static final Block block = null;
	public BlockCoralStonyBlooming(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_stony_blooming);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_stony_blooming"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_stony_blooming", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralStonyBlooming.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_stony_blooming", BlockCoralStonyBlooming.block);
		OreDictionary.registerOre("coral", BlockCoralStonyBlooming.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralStonyBlooming.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_stony_blooming");
