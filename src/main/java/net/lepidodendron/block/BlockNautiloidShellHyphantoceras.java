...
public class BlockNautiloidShellHyphantoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_hyphantoceras")
	public static final Block block = null;
	public BlockNautiloidShellHyphantoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_hyphantoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_hyphantoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellHyphantoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_hyphantoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_hyphantoceras", BlockNautiloidShellHyphantoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_hyphantoceras", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_hyphantoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellHyphantoceras.TileEntityCustom();
		}

		public BlockNautiloidShellHyphantoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellHyphantoceras.TileEntityCustom();
		}
