...
public class BlockAtliStemSW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:atli_stem_sw")
	public static final Block block = null;
	public BlockAtliStemSW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.atli_stem_sw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("atli_stem_sw"));
	...
	//			new ModelResourceLocation("lepidodendron:atli_stem_sw", "inventory"));
	//}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_atli_stem_sw");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockAtliStemNW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
