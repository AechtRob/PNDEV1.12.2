...
public class BlockCystoidBolboporites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cystoid_bolboporites")
	public static final Block block = null;
	public BlockCystoidBolboporites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cystoid_bolboporites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cystoid_bolboporites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cystoid_bolboporites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCystoidBolboporites.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("holdfastDrops", BlockCystoidBolboporites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_cystoid_bolboporites");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CYSTOID_BOLBOPORITES;
		}
