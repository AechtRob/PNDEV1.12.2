...
public class BlockPseudobornia2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pseudobornia_2")
	public static final Block block = null;
	public BlockPseudobornia2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pseudobornia2);
	}
	...
	//public void registerModels(ModelRegistryEvent event) {
		//ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				//new ModelResourceLocation("lepidodendron:pseudobornia_2", "inventory"));
	//}
	public static class BlockCustomFlower extends SeedSporeReedBase implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_pseudobornia_2");
			setRegistryName("pseudobornia_2");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if ((world.getBlockState(pos.down())).getBlock() != BlockPseudobornia.block) {
