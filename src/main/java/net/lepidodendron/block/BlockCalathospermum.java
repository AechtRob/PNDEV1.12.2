...
public class BlockCalathospermum extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calathospermum")
	public static final Block block = null;
	public BlockCalathospermum(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calathospermum);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:calathospermum", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:calathospermum", BlockCalathospermum.block);
		OreDictionary.registerOre("plantPrehistoric", BlockCalathospermum.block);
		OreDictionary.registerOre("plant", BlockCalathospermum.block);
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_calathospermum");
			setRegistryName("calathospermum");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CALATHOSPERMUM;
		}
		...
		public Block planted() {
			return BlockCalathospermum.block;
		}
