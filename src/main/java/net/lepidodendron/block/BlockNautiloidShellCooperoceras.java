...
public class BlockNautiloidShellCooperoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_cooperoceras")
	public static final Block block = null;
	public BlockNautiloidShellCooperoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_cooperoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_cooperoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellCooperoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_cooperoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_cooperoceras", BlockNautiloidShellCooperoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_cooperoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_cooperoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellCooperoceras.TileEntityCustom();
		}

		public BlockNautiloidShellCooperoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellCooperoceras.TileEntityCustom();
		}
