...
public class BlockBeechSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:beech_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:beech_slab_double")
	public static final Block block_slab_double = null;
	public BlockBeechSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.beech_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("beech_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("beech_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:beech_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_beech_slab");
