...
public class BlockEoandromeda extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eoandromedastatic")
	public static final Block block = null;
	public BlockEoandromeda(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eoandromedastatic);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eoandromedastatic"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:eoandromedastatic", BlockEoandromeda.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_EOANDROMEDA;
		}
