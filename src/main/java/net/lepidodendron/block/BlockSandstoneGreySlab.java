...
public class BlockSandstoneGreySlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_slab_grey")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_slab_grey_double")
	public static final Block block_slab_double = null;
	public BlockSandstoneGreySlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandstone_slab_grey);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstone_slab_grey"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sandstone_slab_grey_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandstone_slab_grey", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_sandstone_slab_grey");
