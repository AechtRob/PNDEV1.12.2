...
public class BlockBivalvePolyconites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_polyconites")
	public static final Block block = null;
	public BlockBivalvePolyconites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_polyconites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_polyconites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_polyconites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalvePolyconites.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_polyconites", BlockBivalvePolyconites.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalvePolyconites.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalvePolyconites.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalvePolyconites.block);
	}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalvePolyconites.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_polyconites");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_POLYCONITES;
		}
