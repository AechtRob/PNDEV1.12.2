...
public class BlockPleuromeiaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pleuromeia_sapling")
	public static final Block block = null;
	public BlockPleuromeiaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pleuromeia_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pleuromeia_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pleuromeia_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:pleuromeia_sapling", BlockPleuromeiaSapling.block);
