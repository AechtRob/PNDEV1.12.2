...
public class BlockTreefernBurnishedLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:burnished_treefern_log")
	public static final Block block = null;
	public BlockTreefernBurnishedLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.burnished_treefern_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("burnished_treefern_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:burnished_treefern_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:burnished_treefern_sapling", BlockTreefernBurnishedLog.block);
		OreDictionary.registerOre("logWood", BlockTreefernBurnishedLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_burnished_treefern_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockTreefernBurnishedShoot.block) || (block1 == BlockTreefernBurnishedShootPlaceable.block)) {
				leavesattached = true;
	    	}
			
	        return state.withProperty(DOWN, Boolean.valueOf(block == this || block != Blocks.AIR)).withProperty(UP, Boolean.valueOf(block1 == this || leavesattached)).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this));
	    }
