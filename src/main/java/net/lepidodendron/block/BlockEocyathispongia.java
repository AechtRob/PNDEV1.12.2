...
public class BlockEocyathispongia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eocyathispongia")
	public static final Block block = null;
	public BlockEocyathispongia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eocyathispongia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eocyathispongia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:eocyathispongia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockEocyathispongia.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:eocyathispongia", BlockEocyathispongia.block);
		OreDictionary.registerOre("itemSponge", BlockEocyathispongia.block);
		OreDictionary.registerOre("pndietSponge", BlockEocyathispongia.block);
	}
						...
						if (world.getBlockState(blockpos1).getBlock() == Blocks.WATER) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockEocyathispongia.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_eocyathispongia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_EOCYATHISPONGIA;
		}
