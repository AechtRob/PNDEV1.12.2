...
public class BlockValmeyerodendronLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:valmeyerodendron_log")
	public static final Block block = null;
	public BlockValmeyerodendronLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.valmeyerodendron_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("valmeyerodendron_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:valmeyerodendron_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:valmeyerodendron_sapling", BlockValmeyerodendronLog.block);
    ...
    public static final PropertyBool SHOOT = PropertyBool.create("shoot");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_VALMEYERODENDRON;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
	        ...
	        if (block1 == BlockValmeyerodendronStrobilus.block) {isShoot = true;}
			
	        return state.withProperty(SHOOT, isShoot).withProperty(DOWN, Boolean.valueOf(block == this || block != Blocks.AIR)).withProperty(UP, Boolean.valueOf(block1 == this || block1 == BlockValmeyerodendronStrobilus.block)).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this));
	    }
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
			...
			if ((Math.random() > 0.75) && (!LepidodendronConfig.doPropagation)) {
				...
				if (!worldIn.isRemote) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockValmeyerodendronSapling.block, (int) (1)));
