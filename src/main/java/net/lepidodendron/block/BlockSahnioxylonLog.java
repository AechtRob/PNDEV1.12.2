...
public class BlockSahnioxylonLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sahnioxylon_log")
	public static final Block block = null;
	public BlockSahnioxylonLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sahnioxylon_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sahnioxylon_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:sahnioxylon_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:sahnioxylon_sapling", BlockSahnioxylonLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockSahnioxylonFlower.block) || (block == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockSahnioxylonShoot.block) || (block1 == BlockSahnioxylonShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
			
			if ((block1 == BlockSahnioxylonFlower.block) || (block1 == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockSahnioxylonFlower.block) || (block2 == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockSahnioxylonFlower.block) || (block3 == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockSahnioxylonFlower.block) || (block4 == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockSahnioxylonFlower.block) || (block5 == BlockSahnioxylonFlowerPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
