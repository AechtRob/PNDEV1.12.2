...
public class BlockHironoiaLog extends ElementsLepidodendronMod.ModElement {
	...
	public BlockHironoiaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hironoia_log);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:hironoia_sapling", BlockHironoiaLog.block);
	...
	public static class BlockCustom extends BlockLogPF {
		...
		public BlockCustom() {
			setTranslationKey("pf_hironoia_log");
		}
