...
public class BlockTelopea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:telopea")
	public static final Block block = null;
	public BlockTelopea(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telopea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("telopea"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:telopea", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:telopea", BlockTelopea.block);
		OreDictionary.registerOre("plantPrehistoric", BlockTelopea.block);
		OreDictionary.registerOre("plant", BlockTelopea.block);
	}

	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_telopea");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_TELOPEA;
		}
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockTelopea2.block.getDefaultState(), 3);
			world.setBlockState(pos.up(2), BlockTelopea3.block.getDefaultState(), 3);
			world.setBlockState(pos.up(3), BlockTelopea4.block.getDefaultState(), 3);
			world.setBlockState(pos.up(4), BlockTelopea5.block.getDefaultState(), 3);
