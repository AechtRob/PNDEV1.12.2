...
public class BlockBalticAmberBrickWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:baltic_amber_brick_wall")
	public static final Block block = null;
	public BlockBalticAmberBrickWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.baltic_amber_brick_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("baltic_amber_brick_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:baltic_amber_brick_wall", "inventory"));
	}
