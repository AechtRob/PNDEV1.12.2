...
public class BlockNautiloidShellRayonnoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_rayonnoceras")
	public static final Block block = null;
	public BlockNautiloidShellRayonnoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_rayonnoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_rayonnoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellRayonnoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_rayonnoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_rayonnoceras", BlockNautiloidShellRayonnoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_rayonnoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_rayonnoceras");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0.25D, 0.0D, 0.25D, 0.75D, 0.45D, 0.75D);
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellRayonnoceras.TileEntityCustom();
		}

		public BlockNautiloidShellRayonnoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellRayonnoceras.TileEntityCustom();
		}
