...
public class BlockEurypteridEggsJaekelopterus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eurypterid_eggs_jaekelopterus_worldgen")
	public static final Block block = null;
	public BlockEurypteridEggsJaekelopterus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eurypterid_eggs_jaekelopterus_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eurypterid_eggs_jaekelopterus_worldgen"));
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 3; i++) {
			...
			if (SpawnLocations.spawnsHere("lepidodendron:prehistoric_flora_jaekelopterus", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_eurypterid_eggs_jaekelopterus_worldgen");
