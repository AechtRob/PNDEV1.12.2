...
import net.lepidodendron.item.ItemMacroneuropterisSeeds;
import net.lepidodendron.procedure.ProcedureMacroneuropterisStrobilusNeighbourBlockChanges;
...
public class BlockMacroneuropterisStrobilus extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends Block implements ITileEntityProvider, net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_macroneuropteris_strobilus");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureMacroneuropterisStrobilusNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.5) {
						ItemStack stackSeed = new ItemStack(ItemMacroneuropterisSeeds.block, (int) (1));
