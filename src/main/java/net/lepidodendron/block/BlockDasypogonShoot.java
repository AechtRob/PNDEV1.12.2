...
public class BlockDasypogonShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dasypogon_shoot_worldgen")
	public static final Block block = null;
	public BlockDasypogonShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dasypogon_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dasypogon_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:dasypogon_shoot_worldgen", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_dasypogon_shoot_worldgen");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			...
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
			{
				...
				if (block != BlockDasypogonLog.block) {
					...
					worldIn.setBlockState(pos, BlockDasypogonShootFlower.block.getDefaultState(), 3);
				}
			}
