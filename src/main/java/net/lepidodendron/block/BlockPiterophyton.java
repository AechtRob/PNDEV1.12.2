...
public class BlockPiterophyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:piterophyton")
	public static final Block block = null;
	public BlockPiterophyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.piterophyton);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:piterophyton", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:piterophyton", BlockPiterophyton.block);
		OreDictionary.registerOre("plantPrehistoric", BlockPiterophyton.block);
		OreDictionary.registerOre("plant", BlockPiterophyton.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_piterophyton");
			setRegistryName("piterophyton");
		}

		@Override
		public IBlockState getPotState() {
			return BlockPiterophytonSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockPiterophytonSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
