...
public class BlockNehvizdyellaLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nehvizdyella_litterbin")
	public static final Block block = null;
	public BlockNehvizdyellaLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nehvizdyella_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nehvizdyella_litterbin"));
