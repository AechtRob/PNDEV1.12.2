...
public class BlockStonePeridotiteSlabSmooth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:peridotite_slab_smooth")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:peridotite_slab_smooth_double")
	public static final Block block_slab_double = null;
	public BlockStonePeridotiteSlabSmooth(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.peridotite_slab_smooth);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("peridotite_slab_smooth"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("peridotite_slab_smooth_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:peridotite_slab_smooth", "inventory"));
	}
