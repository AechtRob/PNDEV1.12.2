...
public class BlockNautiloidShellSpiroceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_spiroceras")
	public static final Block block = null;
	public BlockNautiloidShellSpiroceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_spiroceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_spiroceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellSpiroceras.TileEntityCustom.class, "lepidodendron:tileentityshell_spiroceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_spiroceras", BlockNautiloidShellSpiroceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_spiroceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_spiroceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellSpiroceras.TileEntityCustom();
		}

		public BlockNautiloidShellSpiroceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellSpiroceras.TileEntityCustom();
		}
