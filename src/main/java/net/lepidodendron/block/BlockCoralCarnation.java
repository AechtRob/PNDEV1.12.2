...
public class BlockCoralCarnation extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_carnation")
	public static final Block block = null;
	public BlockCoralCarnation(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_carnation);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_carnation"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_carnation", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralCarnation.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_carnation", BlockCoralCarnation.block);
		OreDictionary.registerOre("coral", BlockCoralCarnation.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralCarnation.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_carnation");
