...
public class BlockMapleDoor extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("maple_door"));
	...
	public static class BlockCustom extends BlockDoor {
	    ...
	    {
	        return new ItemStack(ItemMapleDoorItem.block, (int) (1));
	    }
	    ...
	    {
	        return "tile.maple_door.name";
	    }

		@Override
	    public String getLocalizedName()
   	 	{
        	return I18n.translateToLocal("item.maple_door_item.name");
    	}
    	
		@Override
		public Item getItemDropped(IBlockState state, Random rand, int fortune)
	    {
	        return state.getValue(HALF) == EnumDoorHalf.UPPER ? Items.AIR : (new ItemStack(ItemMapleDoorItem.block, (int) (1))).getItem();
	    }
