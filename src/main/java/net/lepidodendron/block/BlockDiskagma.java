...
public class BlockDiskagma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:diskagma")
	public static final Block block = null;
	public BlockDiskagma(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.diskagma);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("diskagma"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:diskagma", "inventory"));
	...
	public static class BlockCustom extends SeedSporeBlockBase implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_DISKAGMA;
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Palaeoproterozoic (Rhyacian)");}
