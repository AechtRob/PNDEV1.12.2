...
public class BlockCyclodendron extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cyclodendron")
	public static final Block block = null;
	public BlockCyclodendron(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cyclodendron);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cyclodendron", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cyclodendron", BlockCyclodendron.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		...
		public Block planted() {
			return BlockCyclodendron.block;
		}
