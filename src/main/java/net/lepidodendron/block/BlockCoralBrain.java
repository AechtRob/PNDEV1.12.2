...
public class BlockCoralBrain extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_brain")
	public static final Block block = null;
	public BlockCoralBrain(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_brain);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_brain"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_brain", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralBrain.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_brain", BlockCoralBrain.block);
		OreDictionary.registerOre("coral", BlockCoralBrain.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralBrain.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_brain");
