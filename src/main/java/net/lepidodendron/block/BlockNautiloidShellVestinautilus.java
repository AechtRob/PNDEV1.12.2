...
public class BlockNautiloidShellVestinautilus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_vestinautilus")
	public static final Block block = null;
	public BlockNautiloidShellVestinautilus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_vestinautilus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_vestinautilus"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellVestinautilus.TileEntityCustom.class, "lepidodendron:tileentityshell_vestinautilus");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_vestinautilus", BlockNautiloidShellVestinautilus.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_vestinautilus", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_vestinautilus");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0.45D, 0.0D, 0.45D, 0.55D, 0.15D, 0.55D);
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellVestinautilus.TileEntityCustom();
		}

		public BlockNautiloidShellVestinautilus.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellVestinautilus.TileEntityCustom();
		}
