...
import net.lepidodendron.item.ItemMiroviaNuts;
...
public class BlockMiroviaFruit extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mirovia_fruit")
	public static final Block block = null;
	public BlockMiroviaFruit(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mirovia_fruit);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mirovia_fruit"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockMiroviaFruit.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mirovia_fruit", "inventory"));
	}
	public static class BlockCustom extends BlockFalling implements IShearable {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_mirovia_fruit");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemMiroviaNuts.block, (int) (3)));
