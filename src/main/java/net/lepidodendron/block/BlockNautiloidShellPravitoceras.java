...
public class BlockNautiloidShellPravitoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_pravitoceras")
	public static final Block block = null;
	public BlockNautiloidShellPravitoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_pravitoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_pravitoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPravitoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_pravitoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_pravitoceras", BlockNautiloidShellPravitoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_pravitoceras", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_pravitoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPravitoceras.TileEntityCustom();
		}

		public BlockNautiloidShellPravitoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPravitoceras.TileEntityCustom();
		}
