...
public class BlockUtrechtiaLeaves extends ElementsLepidodendronMod.ModElement {
	...
	public BlockUtrechtiaLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.utrechtia_leaves_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("utrechtia_leaves_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:utrechtia_leaves_worldgen", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_utrechtia_leaves_worldgen");
