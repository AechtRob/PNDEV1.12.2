...
public class BlockNothofagusSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nothofagus_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:nothofagus_slab_double")
	public static final Block block_slab_double = null;
	public BlockNothofagusSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nothofagus_slab);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nothofagus_slab", "inventory"));
	}
