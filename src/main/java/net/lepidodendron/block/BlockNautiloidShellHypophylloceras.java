...
public class BlockNautiloidShellHypophylloceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_hypophylloceras")
	public static final Block block = null;
	public BlockNautiloidShellHypophylloceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_hypophylloceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_hypophylloceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellHypophylloceras.TileEntityCustom.class, "lepidodendron:tileentityshell_hypophylloceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_hypophylloceras", BlockNautiloidShellHypophylloceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_hypophylloceras", "inventory"));
	}
		...
		for (int i = 0; i < 10; i++) {
			...
			if (!(
					biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_beach_asia")
							|| biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_beach_asia_craggy")
							|| biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_beach_asia_marsh")
							|| biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_beach_namerica_cove")
			)
			) {
				break;
			}
			...
			if (world.isAirBlock(pos) && pos.getY() < Functions.getAdjustedSeaLevel(world, pos) + 3
				...
				if (tileEntity != null) {
					BlockNautiloidShellHypophylloceras.TileEntityCustom te = (BlockNautiloidShellHypophylloceras.TileEntityCustom) tileEntity;
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_hypophylloceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellHypophylloceras.TileEntityCustom();
		}

		public BlockNautiloidShellHypophylloceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellHypophylloceras.TileEntityCustom();
		}
