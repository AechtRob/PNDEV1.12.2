...
public class BlockBivalveInoceramusGigantocapulus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_inoceramus_gigantocapulus")
	public static final Block block = null;
	public BlockBivalveInoceramusGigantocapulus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_inoceramus_gigantocapulus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_inoceramus_gigantocapulus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_inoceramus_gigantocapulus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveInoceramusGigantocapulus.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("foodSeafood", BlockBivalveInoceramusGigantocapulus.block);
						...
						if (world.getBlockState(blockpos1).getBlock() == Blocks.WATER || world.getBlockState(blockpos1).getBlock() == Blocks.FLOWING_WATER) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveInoceramusGigantocapulus.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
