...
public class BlockGlossopterisBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:glossopteris_bench")
	public static final Block block = null;
	public BlockGlossopterisBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.glossopteris_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glossopteris_bench"));
