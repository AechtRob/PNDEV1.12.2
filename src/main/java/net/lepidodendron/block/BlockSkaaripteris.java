...
public class BlockSkaaripteris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:skaaripteris")
	public static final Block block = null;
	public BlockSkaaripteris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.skaaripteris);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:skaaripteris", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:skaaripteris", BlockSkaaripteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_skaaripteris");
			setRegistryName("skaaripteris");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SKAARIPTERIS;
		}
		...
		public Block planted() {
			return BlockSkaaripteris.block;
		}
