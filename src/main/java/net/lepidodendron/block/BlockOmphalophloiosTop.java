...
public class BlockOmphalophloiosTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:omphalophloios_top")
	public static final Block block = null;
	public BlockOmphalophloiosTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.omphalophloios_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("omphalophloios_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:omphalophloios_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_omphalophloios_top");
