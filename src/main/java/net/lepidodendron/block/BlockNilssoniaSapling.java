...
public class BlockNilssoniaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nilssonia_sapling")
	public static final Block block = null;
	public BlockNilssoniaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nilssonia_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nilssonia_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nilssonia_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nilssonia_sapling", BlockNilssoniaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_nilssonia_sapling");
