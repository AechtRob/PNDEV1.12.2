...
public class BlockAcrocomiaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:acrocomia_log")
	public static final Block block = null;
	public BlockAcrocomiaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.acrocomia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("acrocomia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:acrocomia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:acrocomia_sapling", BlockAcrocomiaLog.block);
		OreDictionary.registerOre("logWood", BlockAcrocomiaLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_acrocomia_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockAcrocomiaShoot.block) || (block1 == BlockAcrocomiaShootPlaceable.block)) {
				leavesattached = true;
	    	}
