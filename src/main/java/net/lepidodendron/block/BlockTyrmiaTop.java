...
public class BlockTyrmiaTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tyrmia_top")
	public static final Block block = null;
	public BlockTyrmiaTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tyrmia_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tyrmia_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:tyrmia_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter, IBennettites {
		public BlockCustom() {
			super();
			setTranslationKey("pf_tyrmia_top");
