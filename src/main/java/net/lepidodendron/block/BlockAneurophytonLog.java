...
public class BlockAneurophytonLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:aneurophyton_log")
	public static final Block block = null;
	public BlockAneurophytonLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.aneurophyton_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("aneurophyton_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:aneurophyton_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:aneurophyton_sapling", BlockAneurophytonLog.block);
    ...
    public static final PropertyBool ATTACHMENT = PropertyBool.create("attachment");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_aneurophyton_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ANEUROPHYTON;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if ((block1 == BlockAneurophytonShoot.block) || (block1 == BlockAneurophytonShootPlaceable.block)) {
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        ...
	        if (Math.random() > 0.66) {
				...
				if (!worldIn.isRemote) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockAneurophytonSapling.block, (int) (1)));
