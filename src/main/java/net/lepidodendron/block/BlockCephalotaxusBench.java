...
public class BlockCephalotaxusBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cephalotaxus_bench")
	public static final Block block = null;
	public BlockCephalotaxusBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cephalotaxus_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cephalotaxus_bench"));
