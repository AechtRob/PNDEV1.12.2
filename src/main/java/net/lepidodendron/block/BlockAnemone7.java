...
public class BlockAnemone7 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_7")
	public static final Block block = null;
	public BlockAnemone7(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_7);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_7"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_7", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAnemone7.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:sea_anemone_7", BlockAnemone7.block);
		OreDictionary.registerOre("pndietEncruster", BlockAnemone7.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sea_anemone_7");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			return new ItemStack(BlockAnemone7Dead.block, (int) (1)).getItem();
		}
