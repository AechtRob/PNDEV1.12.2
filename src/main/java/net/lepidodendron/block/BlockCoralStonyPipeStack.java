...
public class BlockCoralStonyPipeStack extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_stony_pipe_stack")
	public static final Block block = null;
	public BlockCoralStonyPipeStack(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_stony_pipe_stack);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_stony_pipe_stack"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_stony_pipe_stack", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralStonyPipeStack.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_stony_pipe_stack", BlockCoralStonyPipeStack.block);
		OreDictionary.registerOre("coral", BlockCoralStonyPipeStack.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralStonyPipeStack.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_stony_pipe_stack");
