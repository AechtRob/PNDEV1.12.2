...
public class BlockNautiloidShellPtychoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_ptychoceras")
	public static final Block block = null;
	public BlockNautiloidShellPtychoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_ptychoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_ptychoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPtychoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_ptychoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ptychoceras", BlockNautiloidShellPtychoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_ptychoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_ptychoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPtychoceras.TileEntityCustom();
		}

		public BlockNautiloidShellPtychoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPtychoceras.TileEntityCustom();
		}
