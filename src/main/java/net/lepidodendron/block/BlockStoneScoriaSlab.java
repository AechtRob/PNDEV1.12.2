...
public class BlockStoneScoriaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scoria_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:scoria_slab_double")
	public static final Block block_slab_double = null;
	public BlockStoneScoriaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scoria_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scoria_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("scoria_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:scoria_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.RED);
			setTranslationKey("pf_scoria_slab");
