...
public class BlockCoarseSandyDirtPangaean extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coarse_sandy_dirt_pangaean")
	public static final Block block = null;
	public BlockCoarseSandyDirtPangaean(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coarse_sandy_dirt_pangaean);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coarse_sandy_dirt_pangaean"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coarse_sandy_dirt_pangaean", "inventory"));
	}
