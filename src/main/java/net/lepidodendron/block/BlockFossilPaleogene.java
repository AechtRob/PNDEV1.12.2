...
public class BlockFossilPaleogene extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_paleogene")
	public static final Block block = null;

	public BlockFossilPaleogene(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_paleogene);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_paleogene"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_paleogene", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFossil {
		public BlockCustom() {
			setTranslationKey("pf_fossil_paleogene");
		}

		@Override
		public ItemStack getFossilDrop() {
			return new ItemStack(ItemFossilPaleogene.block, 1);
		}
	}
}
