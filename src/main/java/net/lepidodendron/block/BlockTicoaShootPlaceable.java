...
public class BlockTicoaShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ticoa_shoot")
	public static final Block block = null;
	public BlockTicoaShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ticoa_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ticoa_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:ticoa_shoot", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:ticoa_sapling", BlockTicoaShootPlaceable.block);
		OreDictionary.registerOre("plantPrehistoric", BlockTicoaShootPlaceable.block);
		OreDictionary.registerOre("plant", BlockTicoaShootPlaceable.block);
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockTicoaShootPlaceable.block, (int) (1)));
		}
