...
public class BlockCornusmasBerries extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas_berries")
	public static final Block block = null;
	public BlockCornusmasBerries(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas_berries"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					worldIn.setBlockState(pos, BlockCornusmas.block.getDefaultState(), 3);
					worldIn.setBlockState(pos.up(), BlockCornusmas2.block.getDefaultState(), 3);
					worldIn.setBlockState(pos.up(2), BlockCornusmas3.block.getDefaultState(), 3);
				}
			}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
			{
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					...
					world.setBlockState(pos, BlockCornusmas.block.getDefaultState(), 3);
					world.setBlockState(pos.up(), BlockCornusmas2.block.getDefaultState(), 3);
					world.setBlockState(pos.up(2), BlockCornusmas3.block.getDefaultState(), 3);
					return true;
				}
				return true;
			}
