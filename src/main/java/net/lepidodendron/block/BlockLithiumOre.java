...
public class BlockLithiumOre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lithium_ore")
	public static final Block block = null;
	public BlockLithiumOre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lithium_ore);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lithium_ore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lithium_ore", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == 0
			...
			for (int l1 = 0; l1 < 2; ++l1) {
				...
				int y = random.nextInt(28) + 1; //Level 1 to 28
	...
	public static class BlockCustom extends BlockOre {
		public BlockCustom() {
			...
			setTranslationKey("pf_lithium_ore");
