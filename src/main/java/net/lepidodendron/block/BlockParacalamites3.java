...
public class BlockParacalamites3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paracalamites_3")
	public static final Block block = null;
	public BlockParacalamites3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.paracalamites_3);
	}
	...
	//			new ModelResourceLocation("lepidodendron:paracalamites_3", "inventory"));
	//}
	public static class BlockCustomFlower extends SeedSporeReedBase implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_paracalamites_3");
			setRegistryName("paracalamites_3");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if (((world.getBlockState(pos.down())).getBlock() != BlockParacalamites2.block)
				&& ((world.getBlockState(pos.down())).getBlock() != BlockParacalamites.block)) {
