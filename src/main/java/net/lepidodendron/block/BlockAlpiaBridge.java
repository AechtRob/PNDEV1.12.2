...
public class BlockAlpiaBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:alpia_bridge")
	public static final Block block = null;
	public BlockAlpiaBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.alpia_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("alpia_bridge"));
