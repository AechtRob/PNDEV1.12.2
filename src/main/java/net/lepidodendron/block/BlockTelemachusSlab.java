...
public class BlockTelemachusSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:telemachus_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:telemachus_slab_double")
	public static final Block block_slab_double = null;
	public BlockTelemachusSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telemachus_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("telemachus_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("telemachus_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:telemachus_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_telemachus_slab");
