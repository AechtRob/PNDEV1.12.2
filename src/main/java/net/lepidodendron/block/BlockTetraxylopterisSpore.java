...
public class BlockTetraxylopterisSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tetraxylopteris_spore")
	public static final Block block = null;
	public BlockTetraxylopterisSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tetraxylopteris_spore);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tetraxylopteris_spore"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(Blocks.AIR, (int) (1)));
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockTetraxylopteris.block, (int) (1));
		}
