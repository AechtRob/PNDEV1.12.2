...
public class BlockLophosoriaCentreNorthWest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_north_west")
	public static final Block block = null;
	public BlockLophosoriaCentreNorthWest(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_north_west"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_north_west", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_north_west", Blocklophosoria_centre_north_westCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_north_westCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_north_westCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_north_west");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockE != BlockLophosoriaCentreNorth.block) {
				world.setBlockToAir(pos);
			}
			if (blockS != BlockLophosoriaCentreWest.block) {
				world.setBlockToAir(pos);
			}
