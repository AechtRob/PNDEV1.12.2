...
public class BlockPebblestoneSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pebblestone_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:pebblestone_slab_double")
	public static final Block block_slab_double = null;
	public BlockPebblestoneSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pebblestone_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pebblestone_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pebblestone_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pebblestone_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_pebblestone_slab");
