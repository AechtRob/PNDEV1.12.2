...
public class BlockLophosoriaCentreSouthEast extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_south_east")
	public static final Block block = null;
	public BlockLophosoriaCentreSouthEast(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_south_east"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_south_east", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_south_east", Blocklophosoria_centre_south_eastCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_south_eastCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_south_eastCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_south_east");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockW != BlockLophosoriaCentreSouth.block) {
				world.setBlockToAir(pos);
			}
			if (blockN != BlockLophosoriaCentreEast.block) {
				world.setBlockToAir(pos);
			}
