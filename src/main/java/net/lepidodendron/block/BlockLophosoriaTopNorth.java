...
public class BlockLophosoriaTopNorth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_top_north")
	public static final Block block = null;
	public BlockLophosoriaTopNorth(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_top_north"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_top_north", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_top_north", Blocklophosoria_top_northTop.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_top_northTop.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_top_northTop.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_top_north");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockS != BlockLophosoriaTop.block) {
				world.setBlockToAir(pos);
			}
//			if (blockE != BlockLophosoriaTopNorthEast.block) {
//				world.setBlockToAir(pos);
//			}
//			if (blockW != BlockLophosoriaTopNorthWest.block) {
//				world.setBlockToAir(pos);
//			}
