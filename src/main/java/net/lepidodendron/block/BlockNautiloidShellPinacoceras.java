...
public class BlockNautiloidShellPinacoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_pinacoceras")
	public static final Block block = null;
	public BlockNautiloidShellPinacoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_pinacoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_pinacoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPinacoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_pinacoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_pinacoceras", BlockNautiloidShellPinacoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_pinacoceras", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellpinacoceras.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_pinacoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPinacoceras.TileEntityCustom();
		}

		public BlockNautiloidShellPinacoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPinacoceras.TileEntityCustom();
		}
