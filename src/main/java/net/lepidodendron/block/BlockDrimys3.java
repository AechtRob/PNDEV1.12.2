...
public class BlockDrimys3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:drimys3")
	public static final Block block = null;
	public BlockDrimys3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telopea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("drimys3"));
	...
	public static class BlockCustom extends BlockBush implements IAdvancementGranter {
		...
		{
			return worldIn.getBlockState(pos.down()).getBlock() == BlockDrimys2.block;
		}
