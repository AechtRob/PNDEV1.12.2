...
public class BlockZygopteridaceaeLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:zygopteridaceae_leaves_worldgen")
	public static final Block block = null;
	public BlockZygopteridaceaeLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.zygopteridaceae_leaves_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zygopteridaceae_leaves_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Zygopteridaceae_leaves_worldgen", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_zygopteridaceae_leaves_worldgen");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) 
		{
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
				...
				if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
					...
					if (block != BlockZygopteridaceaeLog.block)
						{
							worldIn.setBlockToAir(pos);
							if ((Math.random() >= 0.9) && (!LepidodendronConfig.doPropagation)) {
									//Spawn another sapling:
									if (!worldIn.isRemote) {
										EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockZygopteridaceaeSapling.block, (int) (1)));
										entityToSpawn.setPickupDelay(10);
