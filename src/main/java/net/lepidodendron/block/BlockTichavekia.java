...
public class BlockTichavekia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tichavekia")
	public static final Block block = null;
	public BlockTichavekia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tichavekia);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tichavekia", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:tichavekia", BlockTichavekia.block);
		OreDictionary.registerOre("plantPrehistoric", BlockTichavekia.block);
		OreDictionary.registerOre("plant", BlockTichavekia.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_tichavekia");
			setRegistryName("tichavekia");
		}

		@Override
		public IBlockState getPotState() {
			return BlockTichavekiaSpore.block.getDefaultState();
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if ((Math.random() > 0.7)) {
						if ((Math.random() > 0.7)) {
							world.setBlockState(pos, BlockTichavekiaSpore.block.getDefaultState(), 3);
						}
					}
				}
			}
