...
public class BlockMarginalHorsetailWaterTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:marginal_horsetail_water_top")
	public static final Block block = null;
	public BlockMarginalHorsetailWaterTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.marginal_horsetail_water);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("marginal_horsetail_water_top"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockMarginalHorsetailWater.block) {
