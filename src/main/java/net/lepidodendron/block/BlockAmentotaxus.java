...
public class BlockAmentotaxus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus")
	public static final Block block = null;
	public BlockAmentotaxus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:amentotaxus", BlockAmentotaxus.block);
		OreDictionary.registerOre("plantPrehistoric", BlockAmentotaxus.block);
