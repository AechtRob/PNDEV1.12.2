...
public class BlockStalkyBrownAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stalky_brown_algae")
	public static final Block block = null;
	public BlockStalkyBrownAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stalky_brown_algae);
	}
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stalky_brown_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stalky_brown_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockStalkyBrownAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int weight = LepidodendronConfigPlants.weightBrownStalkyAlgae;
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genBrownStalkyAlgaeBlacklistBiomes)) {
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genBrownStalkyAlgaeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_stalky_brown_algae");
