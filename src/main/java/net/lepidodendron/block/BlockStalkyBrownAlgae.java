...
public class BlockStalkyBrownAlgae extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightBrownStalkyAlgae;
		...
		if (!matchBiome(biome, LepidodendronConfig.genBrownStalkyAlgaeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genBrownStalkyAlgaeOverrideBiomes))
			biomeCriteria = true;
