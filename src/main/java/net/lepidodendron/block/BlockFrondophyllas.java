...
public class BlockFrondophyllas extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:frondophyllas")
	public static final Block block = null;
	public BlockFrondophyllas(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.frondophyllas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frondophyllas"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		GameRegistry.registerTileEntity(BlockFrondophyllas.TileEntityCustom.class, "lepidodendron:tileentityfrondophyllas");
		OreDictionary.registerOre("staticdnaPNlepidodendron:frondophyllas", BlockFrondophyllas.block);
		OreDictionary.registerOre("holdfastDrops", BlockFrondophyllas.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:frondophyllas", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFrondophyllas.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_frondophyllas");
