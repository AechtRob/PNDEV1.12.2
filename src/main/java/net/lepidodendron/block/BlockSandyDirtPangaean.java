...
public class BlockSandyDirtPangaean extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_dirt_pangaean")
	public static final Block block = null;
	public BlockSandyDirtPangaean(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_dirt_pangaean);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandy_dirt_pangaean"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_dirt_pangaean", "inventory"));
	}
