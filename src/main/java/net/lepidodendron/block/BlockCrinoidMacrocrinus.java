...
public class BlockCrinoidMacrocrinus extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_macrocrinus", BlockCrinoidMacrocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidMacrocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidMacrocrinus.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_MACROCRINUS;
		}
