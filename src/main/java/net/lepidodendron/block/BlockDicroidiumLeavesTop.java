...
public class BlockDicroidiumLeavesTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_leaves_top")
	public static final Block block = null;
	public BlockDicroidiumLeavesTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_leaves_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_leaves_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:dicroidium_leaves_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_dicroidium_leaves_top");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if ((block == BlockDicroidiumLeaves.block) || (block == BlockDicroidiumLeavesPlaceable.block))
				{
					if (new Object() {
