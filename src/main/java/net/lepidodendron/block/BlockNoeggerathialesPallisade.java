...
public class BlockNoeggerathialesPallisade extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:noeggerathiales_pallisade")
	public static final Block block = null;
	public BlockNoeggerathialesPallisade(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.noeggerathiales_pallisade);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("noeggerathiales_pallisade"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:noeggerathiales_pallisade", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_noeggerathiales_pallisade");
