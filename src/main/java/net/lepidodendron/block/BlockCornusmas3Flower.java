...
public class BlockCornusmas3Flower extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas3_flower")
	public static final Block block = null;
	public BlockCornusmas3Flower(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas3_flower"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:cornusmas3_flower", "inventory"));
