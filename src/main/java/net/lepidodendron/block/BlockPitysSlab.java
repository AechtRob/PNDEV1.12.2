...
public class BlockPitysSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pitys_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:pitys_slab_double")
	public static final Block block_slab_double = null;
	public BlockPitysSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pitys_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pitys_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pitys_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pitys_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_pitys_slab");
