...
public class BlockCycadopterisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cycadopteris_log")
	public static final Block block = null;
	public BlockCycadopterisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cycadopteris_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cycadopteris_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:cycadopteris_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cycadopteris_sapling", BlockCycadopterisLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_cycadopteris_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CYCADOPTERIS;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockCycadopterisShoot.block) || (block1 == BlockCycadopterisShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
			
	        return state.withProperty(DOWN, Boolean.valueOf(block == this || (block != Blocks.AIR && worldIn.getBlockState(pos.down()).getBlockFaceShape(worldIn, pos.down(), EnumFacing.UP) == BlockFaceShape.SOLID))).withProperty(UP, Boolean.valueOf(block1 == this || leavesblock1)).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this)).withProperty(LEAVES, leavesattached);
	    }
