...
public class BlockUtrechtiaLeavesSmall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:utrechtia_leaves_small_worldgen")
	public static final Block block = null;
	public BlockUtrechtiaLeavesSmall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.utrechtia_leaves_small_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("utrechtia_leaves_small_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:utrechtia_leaves_small_worldgen", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockUtrechtiaLeavesSmallPlaceable.block, (int) (1)));
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockUtrechtiaLeavesSmallPlaceable.block, (int) (1));
        }
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) 
		{
			...
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
				...
				if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
					...
					if (block != BlockUtrechtiaStem.block)
						{
							worldIn.setBlockToAir(pos);
							if ((Math.random() >= 0.8) &&  (!worldIn.isRemote)) {
								if (!LepidodendronConfig.doPropagation) {
									entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockUtrechtiaSapling.block, (int) (1)));
								}
								else {
									entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemUtrechtiaFruit.block, (int) (1)));
								}
