...
public class BlockAmentotaxus4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus4")
	public static final Block block = null;
	public BlockAmentotaxus4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus4"));
