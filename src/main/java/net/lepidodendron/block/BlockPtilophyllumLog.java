...
public class BlockPtilophyllumLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ptilophyllum_log")
	public static final Block block = null;
	public BlockPtilophyllumLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ptilophyllum_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ptilophyllum_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:ptilophyllum_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:ptilophyllum_sapling", BlockPtilophyllumLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ptilophyllum_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PTILOPHYLLUM;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockPtilophyllumLeaves.block) || (block == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockPtilophyllumShoot.block) || (block1 == BlockPtilophyllumShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
			
			if ((block1 == BlockPtilophyllumLeaves.block) || (block1 == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockPtilophyllumLeaves.block) || (block2 == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockPtilophyllumLeaves.block) || (block3 == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockPtilophyllumLeaves.block) || (block4 == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockPtilophyllumLeaves.block) || (block5 == BlockPtilophyllumLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
