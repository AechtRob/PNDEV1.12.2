...
public class BlockBrownstoneSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:brownstone_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:brownstone_slab_double")
	public static final Block block_slab_double = null;
	public BlockBrownstoneSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.brownstone_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brownstone_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brownstone_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:brownstone_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.BLACK);
			setTranslationKey("pf_brownstone_slab");
