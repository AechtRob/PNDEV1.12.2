...
public class BlockAmblysiphonella extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amblysiphonella")
	public static final Block block = null;
	public BlockAmblysiphonella(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amblysiphonella);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amblysiphonella"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:amblysiphonella", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAmblysiphonella.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_amblysiphonella");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_AMBLYSIPHONELLA;
		}
