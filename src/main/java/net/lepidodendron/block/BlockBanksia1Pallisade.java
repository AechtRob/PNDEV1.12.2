...
public class BlockBanksia1Pallisade extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:banksia_1_pallisade")
	public static final Block block = null;
	public BlockBanksia1Pallisade(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.banksia_1_pallisade);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("banksia_1_pallisade"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:banksia_1_pallisade", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_banksia_1_pallisade");
