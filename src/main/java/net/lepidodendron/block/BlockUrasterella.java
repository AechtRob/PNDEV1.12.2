...
public class BlockUrasterella extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:urasterella_item")
	public static final Block block = null;
	public BlockUrasterella(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.urasterella_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("urasterella_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockUrasterella.TileEntityCustom.class, "lepidodendron:tileentityurasterella_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_urasterella", BlockUrasterella.block);
		OreDictionary.registerOre("pndietCrinoid", BlockUrasterella.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/urasterella_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_urasterella_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockUrasterella.TileEntityCustom();
		}

		public BlockUrasterella.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockUrasterella.TileEntityCustom();
		}
