...
public class BlockSelaginella extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:selaginella")
	public static final Block block = null;
	public BlockSelaginella(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.selaginella);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("selaginella"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("plantdnaPNlepidodendron:selaginella", BlockSelaginella.block);
	...
	public static class BlockCustom extends SeedSporeFacingBlockBase implements net.minecraftforge.common.IShearable, IAdvancementGranter, ILayableMoss {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SELAGINELLA;
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockSelaginella.TileEntityCustom();
		}

		public BlockSelaginella.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockSelaginella.TileEntityCustom();
		}
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) 
		{
			...
			if ((worldIn.getBlockState(pos).getBlock() == this && Math.random() > 0.8)) {
				if ((Boolean) state.getValue(SPREADABLE)) {
					...
					int spreadradius = (int) LepidodendronConfigPlants.radiusSelaginella;
