...
public class BlockCrinoidBoliviacrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_boliviacrinus")
	public static final Block block = null;
	public BlockCrinoidBoliviacrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_boliviacrinus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("crinoid_boliviacrinus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_boliviacrinus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCrinoidBoliviacrinus.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_boliviacrinus", BlockCrinoidBoliviacrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidBoliviacrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidBoliviacrinus.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_boliviacrinus");
