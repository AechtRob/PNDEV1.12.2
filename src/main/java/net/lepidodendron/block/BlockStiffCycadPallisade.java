...
public class BlockStiffCycadPallisade extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stiff_cycad_pallisade")
	public static final Block block = null;
	public BlockStiffCycadPallisade(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stiff_cycad_pallisade);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stiff_cycad_pallisade"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stiff_cycad_pallisade", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_stiff_cycad_pallisade");
