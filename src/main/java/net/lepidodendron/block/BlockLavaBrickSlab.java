...
public class BlockLavaBrickSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lava_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:lava_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockLavaBrickSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lava_brick_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lava_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("lava_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lava_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.BLACK);
			setTranslationKey("pf_lava_brick_slab");
