...
public class BlockNautiloidShellTrimeroceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_trimeroceras")
	public static final Block block = null;
	public BlockNautiloidShellTrimeroceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_trimeroceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_trimeroceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellTrimeroceras.TileEntityCustom.class, "lepidodendron:tileentityshell_trimeroceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_trimeroceras", BlockNautiloidShellTrimeroceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_trimeroceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_trimeroceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellTrimeroceras.TileEntityCustom();
		}

		public BlockNautiloidShellTrimeroceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellTrimeroceras.TileEntityCustom();
		}
