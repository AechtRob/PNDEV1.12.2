...
public class BlockChloranthus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:chloranthus")
	public static final Block block = null;
	public BlockChloranthus(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:chloranthus", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:chloranthus", BlockChloranthus.block);
		OreDictionary.registerOre("plantPrehistoric", BlockChloranthus.block);
		OreDictionary.registerOre("plant", BlockChloranthus.block);
	}
	...
	public static class BlockCustomFlower extends BlockBush implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_chloranthus");
			setRegistryName("chloranthus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CHLORANTHUS;
		}
		...
		{
			if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(BlockChloranthus.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
			{
				return true;
			}
			else {
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.35) {
						ItemStack stackSeed = new ItemStack(ItemChloranthusSeeds.block, (int) (1));
