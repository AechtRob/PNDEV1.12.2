...
public class BlockFungus9 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_9")
	public static final Block block = null;
	public BlockFungus9(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_9);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_9"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_9", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus9.BlockCustom.SPREADABLE).ignore(BlockFungus9.BlockCustom.NORTH).ignore(BlockFungus9.BlockCustom.SOUTH).ignore(BlockFungus9.BlockCustom.EAST).ignore(BlockFungus9.BlockCustom.WEST).ignore(BlockFungus9.BlockCustom.UP).ignore(BlockFungus9.BlockCustom.DOWN).build());
	}
