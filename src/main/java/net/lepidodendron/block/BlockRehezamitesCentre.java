...
public class BlockRehezamitesCentre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rehezamites_centre")
	public static final Block block = null;
	public BlockRehezamitesCentre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rehezamites_centre);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rehezamites_centre"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:rehezamites_centre", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter, IBennettites {
		public BlockCustom() {
			super();
			setTranslationKey("pf_rehezamites_centre");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_REHEZAMITES;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockRehezamites.block)
				world.setBlockToAir(pos);

			block = world.getBlockState(pos.up()).getBlock();
			if (block != BlockRehezamitesTop.block) {
				world.setBlockToAir(pos);
