...
public class BlockPinkSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightPinkSponge;
		...
		if (!matchBiome(biome, LepidodendronConfig.genPinkSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genPinkSpongeOverrideBiomes))
			biomeCriteria = true;
