...
public class BlockRibCage extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ribcage")
	public static final Block block = null;
	public BlockRibCage(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ribcage);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ribcage"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockRibCage.TileEntityCustom.class, "lepidodendron:tileentityribcage");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_vestinautilus", BlockRibCage.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:ribcage", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			return new ItemStack(Items.BONE, (int) (rand.nextInt(3 ) + 1)).getItem();
		}
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0.05D, 0.0D, 0.05D, 0.95D, 0.75D, 0.95D);
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockRibCage.TileEntityCustom();
		}

		public BlockRibCage.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockRibCage.TileEntityCustom();
		}
