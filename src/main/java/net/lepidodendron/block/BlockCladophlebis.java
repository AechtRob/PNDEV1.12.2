...
public class BlockCladophlebis extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cladophlebis")
	public static final Block block = null;
	public BlockCladophlebis(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cladophlebis);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cladophlebis", "inventory"));
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_cladophlebis");
			setRegistryName("cladophlebis");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CLADOPHLEBIS;
		}
		...
		public Block planted() {
			return BlockCladophlebis.block;
		}
