...
public class BlockCornulitida extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornulitida")
	public static final Block block = null;
	public BlockCornulitida(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornulitida);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornulitida"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cornulitida", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCornulitida.LEVEL).build());
	}
					...
					for (int i = 0; i < 40; ++i) {
						...
						{	boolean waterDepthCheckMax = false;
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								...
								//	world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockCornutilida.BlockCustom.FACING, enumfacing), 2);
								//	return true;
								//} else {
									for (EnumFacing enumfacing1 : BlockCornulitida.BlockCustom.FACING.getAllowedValues()) {
										pos1 = blockpos1;
										...
										if (enumfacing1 != EnumFacing.UP && enumfacing1 != EnumFacing.DOWN &&
											...
											world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockCornulitida.BlockCustom.FACING, enumfacing1), 2);
											return true;
										}
									}
								//}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_cornulitida");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CORNULITIDA;
		}
