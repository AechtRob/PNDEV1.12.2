...
public class BlockRenaliaSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:renalia_spore")
	public static final Block block = null;
	public BlockRenaliaSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.renalia_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:renalia_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setLightOpacity(0);
			setCreativeTab(null);
			if (LepidodendronConfigPlants.spreadRenalia && LepidodendronConfig.spreadPlantsAtAll) {
				setTickRandomly(true);
			}
			else {
				setTickRandomly(false);
			}
			setTranslationKey("pf_renalia_spore");
			setRegistryName("renalia_spore");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_RENALIA;
		}
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (stack.getItem() == Items.SHEARS && LepidodendronConfig.doPropagation
				...
				EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockRenalia.block, (int) (1)));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockRenalia.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockRenalia.block, (int) (1)));
			}
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockRenalia.block.getDefaultState(), 3);	
					}
					//Chance of collapsing:
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockRenalia.block.getDefaultState(), 3);
		        	}
				}
			}
		}
	    ...
	    {
	    	if (!LepidodendronConfigPlants.spreadRenalia) {return true;}
	        return false;
	    }
...
//	    	}
			...
			int distH = (int) LepidodendronConfigPlants.waterRenaliaHorizontal;
			if (distH < 1) distH = 1;
			if (distH > 16) distH = 16;
			int distV = (int) LepidodendronConfigPlants.waterRenaliaVertical;
			if (distV < 1) distV = 1;
			if (distV > 6) distV = 6;
