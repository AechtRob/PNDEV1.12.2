...
public class BlockAnemone extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:anemone")
	public static final Block block = null;
	public BlockAnemone(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:anemone", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:anemone", BlockAnemone.block);
		OreDictionary.registerOre("plantPrehistoric", BlockAnemone.block);
		OreDictionary.registerOre("plant", BlockAnemone.block);
	}
	...
	public static class BlockCustomFlower extends BlockBush implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_anemone");
			setRegistryName("anemone");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ANEMONE;
		}
		...
		{
			if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(BlockAnemone.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
			{
				return true;
			}
			else {
