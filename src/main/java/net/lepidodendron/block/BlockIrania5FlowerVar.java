...
public class BlockIrania5FlowerVar extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania5_flower_var")
	public static final Block block = null;
	public BlockIrania5FlowerVar(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania5_flower_var"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania5_flower_var", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		public BlockCustom() {
			super();
			setTranslationKey("pf_irania5_flower_var");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
			...
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					...
					worldIn.setBlockState(pos, BlockIrania5Var.block.getDefaultState().withProperty(VAR, isVar), 3);
				}
			}
