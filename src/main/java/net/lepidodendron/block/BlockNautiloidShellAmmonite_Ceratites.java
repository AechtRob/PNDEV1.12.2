...
public class BlockNautiloidShellAmmonite_Ceratites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_ceratites")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Ceratites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_ceratites);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAmmonite_Ceratites.TileEntityCustom.class, "lepidodendron:tileentityshell_ceratites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ammonite_ceratites", BlockNautiloidShellAmmonite_Ceratites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_ceratites", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellAmmonite_ceratites.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Ceratites.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Ceratites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Ceratites.TileEntityCustom();
		}
