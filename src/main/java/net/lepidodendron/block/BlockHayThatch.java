...
public class BlockHayThatch extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hay_thatch")
	public static final Block block = null;
	public BlockHayThatch(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hay_thatch);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hay_thatch"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:hay_thatch", "inventory"));
	}
