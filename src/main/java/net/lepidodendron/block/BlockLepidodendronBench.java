...
public class BlockLepidodendronBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lepidodendron_bench")
	public static final Block block = null;
	public BlockLepidodendronBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lepidodendron_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lepidodendron_bench"));
