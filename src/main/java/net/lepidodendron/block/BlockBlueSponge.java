...
public class BlockBlueSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genBlueSpongeBlacklistBiomes)) {
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genBlueSpongeOverrideBiomes))
			biomeCriteria = true;
