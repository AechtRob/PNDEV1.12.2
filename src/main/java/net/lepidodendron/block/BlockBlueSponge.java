...
public class BlockBlueSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightBlueSponge;
		...
		if (!matchBiome(biome, LepidodendronConfig.genBlueSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genBlueSpongeOverrideBiomes))
			biomeCriteria = true;
