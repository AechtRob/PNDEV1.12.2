...
public class BlockBlueSponge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:blue_sponge")
	public static final Block block = null;
	public BlockBlueSponge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.blue_sponge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blue_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:blue_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBlueSponge.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:blue_sponge", BlockBlueSponge.block);
		OreDictionary.registerOre("itemSponge", BlockBlueSponge.block);
		OreDictionary.registerOre("pndietSponge", BlockBlueSponge.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightBlueSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genBlueSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genBlueSpongeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_blue_sponge");
