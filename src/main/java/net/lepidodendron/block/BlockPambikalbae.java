...
public class BlockPambikalbae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pambikalbae")
	public static final Block block = null;
	public BlockPambikalbae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pambikalbae);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pambikalbae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pambikalbae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockPambikalbae.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_pambikalbae");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PAMBIKALBAE;
		}
