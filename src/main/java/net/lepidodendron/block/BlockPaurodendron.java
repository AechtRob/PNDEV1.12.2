...
public class BlockPaurodendron extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paurodendron")
	public static final Block block = null;
	public BlockPaurodendron(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.paurodendron);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:paurodendron", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:paurodendron", BlockPaurodendron.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_paurodendron");
			setRegistryName("paurodendron");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PAURODENDRON;
		}
		...
		public Block planted() {
			return BlockPaurodendron.block;
		}
