...
public class BlockLiriodendronBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:liriodendron_bench")
	public static final Block block = null;
	public BlockLiriodendronBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.liriodendron_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("liriodendron_bench"));
