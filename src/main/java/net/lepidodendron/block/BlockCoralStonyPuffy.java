...
public class BlockCoralStonyPuffy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_stony_puffy")
	public static final Block block = null;
	public BlockCoralStonyPuffy(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_stony_puffy);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_stony_puffy"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_stony_puffy", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralStonyPuffy.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_stony_puffy", BlockCoralStonyPuffy.block);
		OreDictionary.registerOre("coral", BlockCoralStonyPuffy.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralStonyPuffy.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_stony_puffy");
