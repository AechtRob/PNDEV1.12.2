...
public class BlockInsectEggsPalaeodictyopteraPerm extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_palaeodictyoptera_worldgen_perm")
	public static final Block block = null;
	public BlockInsectEggsPalaeodictyopteraPerm(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.insect_eggs_palaeodictyoptera_worldgen_perm);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("insect_eggs_palaeodictyoptera_worldgen_perm"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockInsectEggsPalaeodictyopteraPerm.BlockCustom.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_insect_eggs_palaeodictyoptera_worldgen_perm");
