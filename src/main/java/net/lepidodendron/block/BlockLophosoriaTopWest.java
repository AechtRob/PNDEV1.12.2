...
public class BlockLophosoriaTopWest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_top_west")
	public static final Block block = null;
	public BlockLophosoriaTopWest(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_top_west"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_top_west", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_top_west", Blocklophosoria_top_westTop.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_top_westTop.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_top_westTop.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_top_west");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockE != BlockLophosoriaTop.block) {
				world.setBlockToAir(pos);
			}
//			if (blockN != BlockLophosoriaTopNorthWest.block) {
//				world.setBlockToAir(pos);
//			}
			if (blockS != BlockLophosoriaTopSouthWest.block) {
				world.setBlockToAir(pos);
			}
