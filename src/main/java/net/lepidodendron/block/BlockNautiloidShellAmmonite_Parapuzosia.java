...
public class BlockNautiloidShellAmmonite_Parapuzosia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_parapuzosia")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Parapuzosia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_parapuzosia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_parapuzosia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_parapuzosia", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Parapuzosia.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Parapuzosia.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Parapuzosia.TileEntityCustom();
		}
