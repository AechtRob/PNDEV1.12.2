...
public class BlockFenestellaGiantGreen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_giant_green")
	public static final Block block = null;
	public BlockFenestellaGiantGreen(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_giant_green);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_giant_green"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_giant_green", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestellaGiantGreen.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:fenestella_giant_green", BlockFenestellaGiantGreen.block);
		OreDictionary.registerOre("pndietEncruster", BlockFenestellaGiantGreen.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_giant_green");
