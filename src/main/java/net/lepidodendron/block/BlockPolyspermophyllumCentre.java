...
public class BlockPolyspermophyllumCentre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:polyspermophyllum_centre")
	public static final Block block = null;
	public BlockPolyspermophyllumCentre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.polyspermophyllum_centre);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("polyspermophyllum_centre"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Polyspermophyllum_centre", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_polyspermophyllum_centre");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockPolyspermophyllum.block)
				world.setBlockToAir(pos);

			block = world.getBlockState(pos.up()).getBlock();
			if (block != BlockPolyspermophyllumTop.block) {
				world.setBlockToAir(pos);
