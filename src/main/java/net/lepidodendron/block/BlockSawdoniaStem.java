...
public class BlockSawdoniaStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sawdonia_stem")
	public static final Block block = null;
	public BlockSawdoniaStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sawdonia_stem);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sawdonia_stem", "inventory"));
	}
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_sawdonia_stem");
			setRegistryName("sawdonia_stem");
		}
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (stack.getItem() == Items.SHEARS && LepidodendronConfig.doPropagation
				...
				EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockSawdonia.block, (int) (1)));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockSawdonia.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockSawdonia.block, (int) (1)));
			}
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance to collapse:
					if ((Math.random() > 0.5)) {
						if (((world.getBlockState(pos.up())).getBlock() == BlockSawdonia.block)
						|| (world.getBlockState(pos.up())).getBlock() == BlockSawdoniaSpore.block) {
							world.setBlockToAir(pos.up());
						}
						world.setBlockState(pos, BlockSawdonia.block.getDefaultState(), 3);
		        	}
				}
			}
		}
