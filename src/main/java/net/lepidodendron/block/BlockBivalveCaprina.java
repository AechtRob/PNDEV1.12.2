...
public class BlockBivalveCaprina extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_caprina")
	public static final Block block = null;
	public BlockBivalveCaprina(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_caprina);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_caprina"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_caprina", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveCaprina.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_caprina", BlockBivalveCaprina.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveCaprina.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveCaprina.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveCaprina.block);
	}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveCaprina.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_caprina");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_CAPRINA;
		}
