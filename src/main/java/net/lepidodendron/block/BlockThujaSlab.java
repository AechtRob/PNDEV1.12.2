...
public class BlockThujaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thuja_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:thuja_slab_double")
	public static final Block block_slab_double = null;
	public BlockThujaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thuja_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thuja_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("thuja_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockThujaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:thuja_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_thuja_slab");
