...
public class BlockAmentotaxus4Berries extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus4_berries")
	public static final Block block = null;
	public BlockAmentotaxus4Berries(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus4_berries"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:amentotaxus4_berries", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_amentotaxus4_berries");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockAmentotaxus3.block && block != BlockAmentotaxus3Berries.block)) {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
			{
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					...
					world.setBlockState(pos.down(3), BlockAmentotaxus.block.getDefaultState(), 3);
					world.setBlockState(pos.down(2), BlockAmentotaxus2.block.getDefaultState(), 3);
					world.setBlockState(pos.down(), BlockAmentotaxus3.block.getDefaultState(), 3);
					world.setBlockState(pos, BlockAmentotaxus4.block.getDefaultState(), 3);
					return true;
				}
				return true;
			}
