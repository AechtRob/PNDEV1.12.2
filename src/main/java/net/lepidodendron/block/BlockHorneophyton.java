...
public class BlockHorneophyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:horneophyton")
	public static final Block block = null;
	public BlockHorneophyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.horneophyton);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:horneophyton", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:horneophyton", BlockHorneophyton.block);
		OreDictionary.registerOre("plantPrehistoric", BlockHorneophyton.block);
		OreDictionary.registerOre("plant", BlockHorneophyton.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_horneophyton");
			setRegistryName("horneophyton");
		}

		@Override
		public IBlockState getPotState() {
			return BlockHorneophytonSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if (YouAreNotAloneNooneIsAlone && Math.random() > 0.9) {
						...
						if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockHorneophytonSpore.block.getDefaultState(), 3);
							}
						}
					}
				}
