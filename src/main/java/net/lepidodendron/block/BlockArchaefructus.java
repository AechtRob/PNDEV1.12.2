...
public class BlockArchaefructus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:archaefructus")
	public static final Block block = null;
	public BlockArchaefructus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.archaefructus);
	}
	...
	public static class BlockCustom extends BlockLilyPad implements IGrowable, net.minecraftforge.common.IShearable {
		public BlockCustom() {
			...
			setLightOpacity(0);
			setCreativeTab(null);
			if (LepidodendronConfig.spreadArchaefructus) {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(ItemArchaefructusItem.block, (int) (1)));
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemArchaefructusItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemArchaefructusItem.block, (int) (1)));
			}
		}
	    ...
	    {
	    	if (!LepidodendronConfig.spreadArchaefructus) {return true;}
	        return false;
	    }
	    ...
	    {
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(ItemArchaefructusItem.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
	        {
	            return true;
	        }
	        else {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.35) {
						ItemStack stackSeed = new ItemStack(ItemArchaefructusSeeds.block, (int) (1));
