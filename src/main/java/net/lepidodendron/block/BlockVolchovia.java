...
public class BlockVolchovia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:volchovia_item")
	public static final Block block = null;
	public BlockVolchovia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.volchovia_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("volchovia_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockVolchovia.TileEntityCustom.class, "lepidodendron:tileentityvolchovia_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_volchovia", BlockVolchovia.block);
		OreDictionary.registerOre("pndietCrinoid", BlockVolchovia.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/volchovia_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_volchovia_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockVolchovia.TileEntityCustom();
		}

		public BlockVolchovia.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockVolchovia.TileEntityCustom();
		}
