...
public class BlockFungus10 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_10")
	public static final Block block = null;
	public BlockFungus10(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_10);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_10"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_10", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus10.BlockCustom.SPREADABLE).ignore(BlockFungus10.BlockCustom.NORTH).ignore(BlockFungus10.BlockCustom.SOUTH).ignore(BlockFungus10.BlockCustom.EAST).ignore(BlockFungus10.BlockCustom.WEST).ignore(BlockFungus10.BlockCustom.UP).ignore(BlockFungus10.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus10", BlockFungus10.block);
		OreDictionary.registerOre("itemFungus", BlockFungus10.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus10.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_fungus_10");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: Fungus");
				tooltip.add("Periods: Carboniferous - Permian - Triassic - Jurassic - Early Cretaceous - Late Cretaceous - Palaeogene  - Neogene - Pleistocene");
