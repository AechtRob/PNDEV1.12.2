...
public class BlockScrubbyPineFruit extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_fruit")
	public static final Block block = null;
	public BlockScrubbyPineFruit(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scrubby_pine_fruit"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockScrubbyPineFruit.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:scrubby_pine_fruit", "inventory"));
	}
	public static class BlockCustom extends BlockFalling {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_scrubby_pine_fruit");
