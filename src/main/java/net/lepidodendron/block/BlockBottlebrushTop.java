...
public class BlockBottlebrushTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bottlebrush_top")
	public static final Block block = null;
	public BlockBottlebrushTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bottlebrush_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bottlebrush_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:bottlebrush_top", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:bottlebrush", BlockBottlebrushTop.block);
//		OreDictionary.registerOre("plantPrehistoric", BlockBottlebrushTop.block);
//		OreDictionary.registerOre("plant", BlockBottlebrushTop.block);
	}
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (stack.getItem() == Items.SHEARS && LepidodendronConfig.doPropagation
					&&
					(worldIn.getBlockState(pos.down()).getBlock() == BlockBottlebrushCentre.block)
			) {
		...
		public boolean canSurviveAt(World worldIn, BlockPos pos) {
			...
			if (worldIn.getBlockState(pos.down()).getBlock() != BlockBottlebrushCentre.block)
			{
				return false;
			}
			return true;
