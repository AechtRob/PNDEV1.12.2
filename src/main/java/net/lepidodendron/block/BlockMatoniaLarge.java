...
public class BlockMatoniaLarge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:matonia_large")
	public static final Block block = null;
	public BlockMatoniaLarge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.matonia_large);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:matonia_large", "inventory"));
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase {
		...
		public Block planted() {
			return BlockMatoniaLarge.block;
		}
