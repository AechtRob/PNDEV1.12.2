...
public class BlockNautiloidShellOrthoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_orthoceras")
	public static final Block block = null;
	public BlockNautiloidShellOrthoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_orthoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_orthoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellOrthoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_orthoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_orthoceras", BlockNautiloidShellOrthoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_orthoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_orthoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellOrthoceras.TileEntityCustom();
		}

		public BlockNautiloidShellOrthoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellOrthoceras.TileEntityCustom();
		}
