...
public class BlockCinnamonFern extends ElementsLepidodendronMod.ModElement {
	...
	public BlockCinnamonFern(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cinnamon_fern);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cinnamon_fern", BlockCinnamonFern.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CINNAMON_FERN;
		}
		...
		public Block planted() {
			return BlockCinnamonFern.block;
		}
