...
public class BlockNautiloidShellGonioceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_gonioceras")
	public static final Block block = null;
	public BlockNautiloidShellGonioceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_gonioceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_gonioceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellGonioceras.TileEntityCustom.class, "lepidodendron:tileentityshell_gonioceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_gonioceras", BlockNautiloidShellGonioceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_gonioceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_gonioceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellGonioceras.TileEntityCustom();
		}

		public BlockNautiloidShellGonioceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellGonioceras.TileEntityCustom();
		}
