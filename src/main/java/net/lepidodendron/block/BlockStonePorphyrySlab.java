...
public class BlockStonePorphyrySlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:porphyry_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:porphyry_slab_double")
	public static final Block block_slab_double = null;
	public BlockStonePorphyrySlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.porphyry_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("porphyry_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("porphyry_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:porphyry_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.RED);
			setTranslationKey("pf_porphyry_slab");
