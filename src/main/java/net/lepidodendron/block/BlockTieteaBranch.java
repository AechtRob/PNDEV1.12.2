...
public class BlockTieteaBranch extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tietea_branch")
	public static final Block block = null;
	public BlockTieteaBranch(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tietea_branch);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tietea_branch"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tietea_branch", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:tietea_sapling", BlockTieteaBranch.block);
		OreDictionary.registerOre("plantPrehistoric", BlockTieteaBranch.block);
		OreDictionary.registerOre("plant", BlockTieteaBranch.block);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_tietea_branch");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			{
				if (block2 == this || block2 == BlockTieteaLeaves.block || block2 == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
				...
				if (block3 == this || block3 == BlockTieteaLeaves.block || block3 == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block4 == this || block4 == BlockTieteaLeaves.block || block4 == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block5 == this || block5 == BlockTieteaLeaves.block || block5 == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				|| ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.WEST))
			{
				...
				if (block == this || block == BlockTieteaLeaves.block || block == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block1 == this || block1 == BlockTieteaLeaves.block || block1 == BlockTieteaLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
			...
			if (worldIn.isAirBlock(pos)) {
				...
				if (block1 == BlockTieteaLeaves.block || block1 == BlockTieteaLeavesSmall.block) {
				...
				if (block2 == BlockTieteaLeaves.block || block2 == BlockTieteaLeavesSmall.block) {
				...
				if (block3 == BlockTieteaLeaves.block || block3 == BlockTieteaLeavesSmall.block) {
				...
				if (block4 == BlockTieteaLeaves.block || block4 == BlockTieteaLeavesSmall.block) {
				...
				if (block5 == BlockTieteaLeaves.block || block5 == BlockTieteaLeavesSmall.block) {
