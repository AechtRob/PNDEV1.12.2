...
public class BlockGinkgoitesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ginkgoites_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:ginkgoites_slab_double")
	public static final Block block_slab_double = null;
	public BlockGinkgoitesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ginkgoites_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ginkgoites_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ginkgoites_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:ginkgoites_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ginkgoites_slab");
