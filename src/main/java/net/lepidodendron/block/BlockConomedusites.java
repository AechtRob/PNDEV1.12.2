...
public class BlockConomedusites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:conomedusites")
	public static final Block block = null;
	public BlockConomedusites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.conomedusites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("conomedusites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:conomedusites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockConomedusites.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_conomedusites");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CONOMEDUSITES;
		}
