...
public class BlockNautiloidShellScaphites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_scaphites")
	public static final Block block = null;
	public BlockNautiloidShellScaphites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_scaphites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_scaphites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellScaphites.TileEntityCustom.class, "lepidodendron:tileentityshell_scaphites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_scaphites", BlockNautiloidShellScaphites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_scaphites", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_scaphites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellScaphites.TileEntityCustom();
		}

		public BlockNautiloidShellScaphites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellScaphites.TileEntityCustom();
		}
