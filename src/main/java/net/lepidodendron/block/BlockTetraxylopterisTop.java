...
public class BlockTetraxylopterisTop extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tetraxylopteris_top"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_tetraxylopteris_top");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockTetraxylopteris.block) {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			//add spores sometimes:
			if (Math.random() >0.7 && Math.random()>0.7) {
				if (worldIn.isAirBlock(pos.up())) {
					worldIn.setBlockState(pos.up(), BlockTetraxylopterisSpore.block.getDefaultState(), 3);
				}
			}
