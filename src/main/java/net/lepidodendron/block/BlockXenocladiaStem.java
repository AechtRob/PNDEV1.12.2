...
public class BlockXenocladiaStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:xenocladia_stem")
	public static final Block block = null;
	public BlockXenocladiaStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.xenocladia_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("xenocladia_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:xenocladia_stem", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:xenocladia_sapling", BlockXenocladiaStem.block);
		OreDictionary.registerOre("logWood", BlockXenocladiaStem.block);
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_xenocladia_stem");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
	        ...
	        if ((block == BlockXenocladiaShoot.block) || (block == BlockXenocladiaShootPlaceable.block)) {
