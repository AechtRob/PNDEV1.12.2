...
public class BlockInsectEggsDragonfly extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_dragonfly_worldgen")
	public static final Block block = null;
	public BlockInsectEggsDragonfly(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.insect_eggs_dragonfly_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("insect_eggs_dragonfly_worldgen"));
		//elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockInsectEggsDragonfly.TileEntityCustom.class, "lepidodendron:tileentityinsect_eggs_dragonfly_worldgen");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockInsectEggsDragonfly.BlockCustom.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_insect_eggs_dragonfly_worldgen");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockInsectEggsDragonfly.TileEntityCustom();
		}

		public BlockInsectEggsDragonfly.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockInsectEggsDragonfly.TileEntityCustom();
		}
