...
public class BlockToditesLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:todites_log")
	public static final Block block = null;
	public BlockToditesLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.todites_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("todites_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:todites_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:todites_sapling", BlockToditesLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_todites_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockToditesShoot.block) || (block1 == BlockToditesShootPlaceable.block)) {
				leavesattached = true;
	    	}
