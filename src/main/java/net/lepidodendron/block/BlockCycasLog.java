...
public class BlockCycasLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cycas_log")
	public static final Block block = null;
	public BlockCycasLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cycas_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cycas_log"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cycas_sapling", BlockCycasLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockCycasShoot.block) || (block1 == BlockCycasShootPlaceable.block) || (block1 == BlockCycasShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
