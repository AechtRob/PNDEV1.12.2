...
import net.lepidodendron.procedure.ProcedureWorldGenAgathis;
...
public class BlockAgathisSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:agathis_sapling")
	public static final Block block = null;
	public BlockAgathisSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.agathis_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("agathis_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:agathis_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:agathis_sapling", BlockAgathisSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_agathis_sapling");
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				boolean SaplingSpawn = true;
				{
					...
					ProcedureWorldGenAgathis.executeProcedure($_dependencies);
				}
	        }
	    }
