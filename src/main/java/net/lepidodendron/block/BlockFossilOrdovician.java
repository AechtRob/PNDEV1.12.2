...
public class BlockFossilOrdovician extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_ordovician")
	public static final Block block = null;

	public BlockFossilOrdovician(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_ordovician);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_ordovician"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_ordovician", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFossil {
		public BlockCustom() {
			setTranslationKey("pf_fossil_ordovician");
		}

		@Override
		public ItemStack getFossilDrop() {
			return new ItemStack(ItemFossilOrdovician.block, 1);
		}
	}
}
