...
public class BlockTelopea4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:telopea4")
	public static final Block block = null;
	public BlockTelopea4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telopea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("telopea4"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockTelopea3.block)
					|| (blockU != BlockTelopea5.block)) {
