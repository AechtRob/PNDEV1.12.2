...
public class BlockWilliamsoniaShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:williamsonia_shoot_worldgen")
	public static final Block block = null;
	public BlockWilliamsoniaShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.williamsonia_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("williamsonia_shoot_worldgen"));
