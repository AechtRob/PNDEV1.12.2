...
public class BlockParadoxopterisSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paradoxopteris_sapling")
	public static final Block block = null;
	public BlockParadoxopterisSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.paradoxopteris_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("paradoxopteris_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:paradoxopteris_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:paradoxopteris_sapling", BlockParadoxopterisSapling.block);
		OreDictionary.registerOre("treeSapling", BlockParadoxopterisSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockParadoxopterisSapling.block);
		OreDictionary.registerOre("plant", BlockParadoxopterisSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_paradoxopteris_sapling");
