...
public class BlockMopHorsetail extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mop_horsetail")
	public static final Block block = null;
	public BlockMopHorsetail(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mop_horsetail);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mop_horsetail"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mop_horsetail", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:mop_horsetail", BlockMopHorsetail.block);
		OreDictionary.registerOre("plantPrehistoric", BlockMopHorsetail.block);
		OreDictionary.registerOre("plant", BlockMopHorsetail.block);
		OreDictionary.registerOre("stemHorsetail", BlockMopHorsetail.block);
	}

	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_mop_horsetail");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isAirBlock(pos.down())) {
				...
				if (block != BlockMopHorsetailTop.block) {
		...
		public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockMopHorsetailTop.block.getDefaultState(), 3);
