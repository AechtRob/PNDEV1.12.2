...
public class BlockTabulata_Block1 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tabulata_block_1")
	public static final Block block = null;
	public BlockTabulata_Block1(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tabulata_block_1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tabulata_block_1"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tabulata_block_1", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:tabulata_block_1", BlockTabulata_Block1.block);
		OreDictionary.registerOre("pndietCoral", BlockTabulata_Block1.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_tabulata_block_1");
