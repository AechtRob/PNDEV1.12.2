...
public class BlockStiffCycadLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stiff_cycad_log")
	public static final Block block = null;
	public BlockStiffCycadLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stiff_cycad_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stiff_cycad_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:stiff_cycad_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:stiff_cycad_sapling", BlockStiffCycadLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_stiff_cycad_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_STIFF_CYCAD;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockStiffCycadShoot.block) || (block1 == BlockStiffCycadShootPlaceable.block) || (block1 == BlockStiffCycadShootCone.block)) {
				leavesattached = true;
	    	}
