...
public class BlockThucydia2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thucydia2")
	public static final Block block = null;
	public BlockThucydia2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thucydia2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thucydia2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:thucydia2", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_thucydia2");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_THUCYDIA;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockThucydia.block, (int) (1));
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockThucydia.block || blockU != BlockThucydia3.block) {
