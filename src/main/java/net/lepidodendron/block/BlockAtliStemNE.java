...
public class BlockAtliStemNE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:atli_stem_ne")
	public static final Block block = null;
	public BlockAtliStemNE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.atli_stem_ne);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("atli_stem_ne"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:atli_stem_ne", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:atli_sapling", BlockAtliStemNE.block);
		OreDictionary.registerOre("logWood", BlockAtliStemNE.block);
		OreDictionary.registerOre("itemRope", BlockAtliStemNE.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_atli_stem_ne");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockAtliStemSE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
