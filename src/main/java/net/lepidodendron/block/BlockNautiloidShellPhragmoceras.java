...
public class BlockNautiloidShellPhragmoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_phragmoceras")
	public static final Block block = null;
	public BlockNautiloidShellPhragmoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_phragmoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_phragmoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPhragmoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_phragmoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_phragmoceras", BlockNautiloidShellPhragmoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_phragmoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_phragmoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPhragmoceras.TileEntityCustom();
		}

		public BlockNautiloidShellPhragmoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPhragmoceras.TileEntityCustom();
		}
