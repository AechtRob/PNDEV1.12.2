...
public class BlockVillebrunaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:villebrunaster_item")
	public static final Block block = null;
	public BlockVillebrunaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.villebrunaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("villebrunaster_item"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/villebrunaster_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_villebrunaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockVillebrunaster.TileEntityCustom();
		}

		public BlockVillebrunaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockVillebrunaster.TileEntityCustom();
		}
