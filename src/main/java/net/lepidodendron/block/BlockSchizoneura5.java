...
public class BlockSchizoneura5 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:schizoneura_5")
	public static final Block block = null;
	public BlockSchizoneura5(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.schizoneura_5);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("schizoneura_5"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockSchizoneura4.block && block != BlockSchizoneura3.block) {
