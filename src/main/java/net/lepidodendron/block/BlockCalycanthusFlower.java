...
import net.lepidodendron.item.ItemCalycanthusSeeds;
import net.lepidodendron.procedure.ProcedureCalycanthusFlowerNeighbourBlockChanges;
...
public class BlockCalycanthusFlower extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calycanthus_flower")
	public static final Block block = null;
	public BlockCalycanthusFlower(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calycanthus_flower);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calycanthus_flower"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "lepidodendron:tileentitycalycanthus_flower");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:calycanthus_flower", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider, net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_calycanthus_flower");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
...

			{
				...
				ProcedureCalycanthusFlowerNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
        ...
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != Item.getItemFromBlock(this)) || !LepidodendronConfig.doPropagation)
	        {
	        	...
	        	if ((new Object() {
		        	...
		        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
						if (Math.random() > 0.4) {
							ItemStack stackSeed = new ItemStack(ItemCalycanthusSeeds.block, (int) (1));
