...
public class BlockLycopiaTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lycopia_top")
	public static final Block block = null;
	public BlockLycopiaTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lycopia_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lycopia_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:lycopia_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_lycopia_top");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_LYCOPIA;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockLycopia.block, (int) (1));
		}
