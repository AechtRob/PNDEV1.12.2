...
public class BlockSandWhite extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sand_white")
	public static final Block block = null;
	public BlockSandWhite(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sand_white);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sand_white", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling implements ISustainsPlantType {
		public BlockCustom() {
			...
			setHardness(0.5F);
			setResistance(0.5F);
			setTranslationKey("pf_sand_white");
