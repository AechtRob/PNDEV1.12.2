...
public class BlockWaterClover extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:water_clover")
	public static final Block block = null;
	public BlockWaterClover(ElementsLepidodendronMod instance) {
		...
		if (biome instanceof BiomeCretaceousEarly)
		{
			...
			if (biomeCretaceousEarly.getBiomeType() == EnumBiomeTypeCretaceousEarly.Early_Cretaceous_Euro_America) {
				if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_ocean_shore_tethys_europe")
						...
						|| biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_namerica_lagoons")
...
//		GenChance = Math.min(100, (int) Math.round((double) GenChance * GenMultiplier));
		...
		for (int i = 0; i < (int) GenChance; i++) {
			...
			(new WaterCloverGenerator((Block) block)).generate(world, random, new BlockPos(l6, i11, l14));
		}
	}
	...
	public static class BlockCustom extends SeedSporeLilyPadBase implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
			...
			if (entityIn instanceof EntityBoat)
			{
				...
				if (!LepidodendronConfig.doPropagation) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemWaterCloverItem.block, (int) (1)));
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(ItemWaterCloverItem.block, (int) (1)));
		}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemWaterCloverItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemWaterCloverItem.block, (int) (1)));
			}
		}
	    ...
	    {
	    	if (!LepidodendronConfigPlants.spreadWaterClover) {return true;}
	        return false;
	    }
...
//	    }
		...
		public Item blockItem() {
			return ItemWaterCloverItem.block;
		}
	}
}
