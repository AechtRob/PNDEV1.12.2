...
public class BlockDarkOrangeSponge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dark_orange_sponge")
	public static final Block block = null;
	public BlockDarkOrangeSponge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dark_orange_sponge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dark_orange_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dark_orange_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockDarkOrangeSponge.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightFireSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genFireSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genFireSpongeOverrideBiomes))
			biomeCriteria = true;
