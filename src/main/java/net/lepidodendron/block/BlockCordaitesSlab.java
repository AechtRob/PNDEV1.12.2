...
public class BlockCordaitesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cordaites_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:cordaites_slab_double")
	public static final Block block_slab_double = null;
	public BlockCordaitesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cordaites_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cordaites_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cordaites_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cordaites_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_cordaites_slab");
