...
public class BlockNautiloidShellAmmonite_Pachydesmoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_pachydesmoceras")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Pachydesmoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_pachydesmoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_pachydesmoceras"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_pachydesmoceras", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Pachydesmoceras.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Pachydesmoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Pachydesmoceras.TileEntityCustom();
		}
