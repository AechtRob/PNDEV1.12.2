...
public class BlockNautiloidShellParawocklumeria extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_parawocklumeria")
	public static final Block block = null;
	public BlockNautiloidShellParawocklumeria(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_parawocklumeria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_parawocklumeria"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellParawocklumeria.TileEntityCustom.class, "lepidodendron:tileentityshell_parawocklumeria");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_parawocklumeria", BlockNautiloidShellParawocklumeria.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_parawocklumeria", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_parawocklumeria");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellParawocklumeria.TileEntityCustom();
		}

		public BlockNautiloidShellParawocklumeria.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellParawocklumeria.TileEntityCustom();
		}
