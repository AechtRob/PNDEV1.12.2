...
public class BlockGreenCharaAlgae extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenCharaAlgaeBlacklistBiomes)) {
			biomeCriteria = true;
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenCharaAlgaeOverrideBiomes))
			biomeCriteria = true;
