...
public class BlockFenestella3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_3")
	public static final Block block = null;
	public BlockFenestella3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_3", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestella3.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFenestella3", BlockFenestella3.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_3");
