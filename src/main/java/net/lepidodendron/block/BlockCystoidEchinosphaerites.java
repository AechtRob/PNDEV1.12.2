...
public class BlockCystoidEchinosphaerites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cystoid_echinosphaerites")
	public static final Block block = null;
	public BlockCystoidEchinosphaerites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cystoid_echinosphaerites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cystoid_echinosphaerites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cystoid_echinosphaerites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCystoidEchinosphaerites.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pndietCrinoid", BlockCystoidEchinosphaerites.block);
		OreDictionary.registerOre("holdfastDrops", BlockCystoidEchinosphaerites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_cystoid_echinosphaerites");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CYSTOID_ECHINOSPHAERITES;
		}
