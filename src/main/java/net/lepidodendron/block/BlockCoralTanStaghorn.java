...
public class BlockCoralTanStaghorn extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_tan_staghorn")
	public static final Block block = null;
	public BlockCoralTanStaghorn(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_tan_staghorn);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_tan_staghorn"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_tan_staghorn", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralTanStaghorn.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_tan_staghorn", BlockCoralTanStaghorn.block);
		OreDictionary.registerOre("coral", BlockCoralTanStaghorn.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralTanStaghorn.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_tan_staghorn");
