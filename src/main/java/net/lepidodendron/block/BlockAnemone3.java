...
public class BlockAnemone3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_3")
	public static final Block block = null;
	public BlockAnemone3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_3", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAnemone3.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:sea_anemone_3", BlockAnemone3.block);
		OreDictionary.registerOre("pndietEncruster", BlockAnemone3.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sea_anemone_3");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			return new ItemStack(BlockAnemone3Dead.block, (int) (1)).getItem();
		}
