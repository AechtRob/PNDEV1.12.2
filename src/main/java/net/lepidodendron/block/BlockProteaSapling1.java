...
public class BlockProteaSapling1 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:protea_sapling_1")
	public static final Block block = null;
	public BlockProteaSapling1(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.protea_sapling_1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("protea_sapling_1"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:protea_sapling_1", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNprotea_1_sapling", BlockProteaSapling1.block);
