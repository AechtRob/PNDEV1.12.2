...
import net.lepidodendron.procedure.ProcedureChooseRedWoodType;
...
public class BlockRedwoodSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:redwood_sapling")
	public static final Block block = null;
	public BlockRedwoodSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.redwood_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("redwood_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:redwood_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:redwood_sapling", BlockRedwoodSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_redwood_sapling");
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				boolean SaplingSpawn = true;
				{
					...
					ProcedureChooseRedWoodType.executeProcedure($_dependencies);
				}
	        }
	    }
