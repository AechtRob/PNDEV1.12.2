...
public class BlockSabalLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sabal_log")
	public static final Block block = null;
	public BlockSabalLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sabal_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sabal_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:sabal_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:sabal_sapling", BlockSabalLog.block);
		OreDictionary.registerOre("logWood", BlockSabalLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_sabal_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockSabalShoot.block) || (block1 == BlockSabalShootPlaceable.block)) {
				leavesattached = true;
	    	}
