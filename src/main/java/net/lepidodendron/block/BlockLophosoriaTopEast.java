...
public class BlockLophosoriaTopEast extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_top_east")
	public static final Block block = null;
	public BlockLophosoriaTopEast(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_top_east"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_top_east", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_top_east", Blocklophosoria_top_eastTop.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_top_eastTop.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_top_eastTop.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_top_east");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockW != BlockLophosoriaTop.block) {
				world.setBlockToAir(pos);
			}
//			if (blockN != BlockLophosoriaTopNorthEast.block) {
//				world.setBlockToAir(pos);
//			}
			if (blockS != BlockLophosoriaTopSouthEast.block) {
				world.setBlockToAir(pos);
			}
