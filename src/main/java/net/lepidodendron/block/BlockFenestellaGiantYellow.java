...
public class BlockFenestellaGiantYellow extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_giant_yellow")
	public static final Block block = null;
	public BlockFenestellaGiantYellow(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_giant_yellow);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_giant_yellow"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_giant_yellow", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestellaGiantYellow.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:fenestella_giant_yellow", BlockFenestellaGiantYellow.block);
		OreDictionary.registerOre("pndietEncruster", BlockFenestellaGiantYellow.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_giant_yellow");
