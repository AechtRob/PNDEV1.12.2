...
public class BlockAnkyropterisStemSE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ankyropteris_stem_se")
	public static final Block block = null;
	public BlockAnkyropterisStemSE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ankyropteris_stem_se);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ankyropteris_stem_se"));
	...
	//			new ModelResourceLocation("lepidodendron:ankyropteris_stem_se", "inventory"));
	//}
	public static class BlockCustom extends SeedSporeFacingBlockBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ankyropteris_stem_se");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockAnkyropterisStemSW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
