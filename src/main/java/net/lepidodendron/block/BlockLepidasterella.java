...
public class BlockLepidasterella extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lepidasterella_item")
	public static final Block block = null;
	public BlockLepidasterella(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lepidasterella_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lepidasterella_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockLepidasterella.TileEntityCustom.class, "lepidodendron:tileentitylepidasterella_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_lepidasterella", BlockLepidasterella.block);
		OreDictionary.registerOre("pndietCrinoid", BlockLepidasterella.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/lepidasterella_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_lepidasterella_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockLepidasterella.TileEntityCustom();
		}

		public BlockLepidasterella.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockLepidasterella.TileEntityCustom();
		}
