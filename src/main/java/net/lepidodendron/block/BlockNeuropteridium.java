...
public class BlockNeuropteridium extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:neuropteridium")
	public static final Block block = null;
	public BlockNeuropteridium(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.neuropteridium);
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_NEUROPTERIDIUM;
		}
		...
		public Block planted() {
			return BlockNeuropteridium.block;
		}
