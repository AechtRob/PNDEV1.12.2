...
public class BlockInsectEggsMegasecoptera extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_megasecoptera_worldgen")
	public static final Block block = null;
	public BlockInsectEggsMegasecoptera(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.insect_eggs_megasecoptera_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("insect_eggs_megasecoptera_worldgen"));
		//elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockInsectEggsMegasecoptera.TileEntityCustom.class, "lepidodendron:tileentityinsect_eggs_megasecoptera_worldgen");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockInsectEggsMegasecoptera.BlockCustom.LEVEL).build());
	}
...
//			}
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_insect_eggs_megasecoptera_worldgen");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockInsectEggsMegasecoptera.TileEntityCustom();
		}

		public BlockInsectEggsMegasecoptera.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockInsectEggsMegasecoptera.TileEntityCustom();
		}
