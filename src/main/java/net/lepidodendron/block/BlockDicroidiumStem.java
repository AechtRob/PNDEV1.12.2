...
public class BlockDicroidiumStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_stem")
	public static final Block block = null;
	public BlockDicroidiumStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dicroidium_stem", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:dicroidium_sapling", BlockDicroidiumStem.block);
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_DICROIDIUM;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			{
				if (block2 == this || block2 == BlockDicroidiumLeaves.block || block2 == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
				...
				if (block3 == this || block3 == BlockDicroidiumLeaves.block || block3 == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block4 == this || block4 == BlockDicroidiumLeaves.block || block4 == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block5 == this || block5 == BlockDicroidiumLeaves.block || block5 == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				|| ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.WEST))
			{
				...
				if (block == this || block == BlockDicroidiumLeaves.block || block == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block1 == this || block1 == BlockDicroidiumLeaves.block || block1 == BlockDicroidiumLeavesPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        ...
	        if (block1 == BlockDicroidiumLeaves.block || block1 == BlockDicroidiumLeavesSmall.block) {
	        ...
	        if (block2 == BlockDicroidiumLeaves.block || block2 == BlockDicroidiumLeavesSmall.block) {
	        ...
	        if (block3 == BlockDicroidiumLeaves.block || block3 == BlockDicroidiumLeavesSmall.block) {
	        ...
	        if (block4 == BlockDicroidiumLeaves.block || block4 == BlockDicroidiumLeavesSmall.block) {
	        ...
	        if (block5 == BlockDicroidiumLeaves.block || block5 == BlockDicroidiumLeavesSmall.block) {
