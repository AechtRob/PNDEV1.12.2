...
public class BlockArthropitysSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arthropitys_sapling")
	public static final Block block = null;
	public BlockArthropitysSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arthropitys_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("arthropitys_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:arthropitys_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:arthropitys_sapling", BlockArthropitysSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_arthropitys_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ARTHROPITYS;
		}
