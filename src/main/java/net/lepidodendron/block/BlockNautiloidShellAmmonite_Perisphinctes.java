...
public class BlockNautiloidShellAmmonite_Perisphinctes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_perisphinctes")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Perisphinctes(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_perisphinctes);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_perisphinctes"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAmmonite_Perisphinctes.TileEntityCustom.class, "lepidodendron:tileentityshell_perisphinctes");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ammonite_perisphinctes", BlockNautiloidShellAmmonite_Perisphinctes.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_perisphinctes", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellAmmonite_perisphinctes.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_perisphinctes");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Perisphinctes.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Perisphinctes.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Perisphinctes.TileEntityCustom();
		}
