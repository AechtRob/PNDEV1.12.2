...
public class BlockIrania5Var extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania5_var")
	public static final Block block = null;
	public BlockIrania5Var(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania5_var"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania5_var", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_irania5_var");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
			...
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					...
					worldIn.setBlockState(pos, BlockIrania5FlowerVar.block.getDefaultState().withProperty(VAR, isVar), 3);
				}
			}
