...
public class BlockMicrovictoriaLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:microvictoria_leaves")
	public static final Block block = null;
	public BlockMicrovictoriaLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.microvictoria_leaves);
	}
