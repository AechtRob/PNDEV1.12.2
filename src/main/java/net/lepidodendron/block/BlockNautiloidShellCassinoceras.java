...
public class BlockNautiloidShellCassinoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_cassinoceras")
	public static final Block block = null;
	public BlockNautiloidShellCassinoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_cassinoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_cassinoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellCassinoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_cassinoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_cassinoceras", BlockNautiloidShellCassinoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_cassinoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_cassinoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellCassinoceras.TileEntityCustom();
		}

		public BlockNautiloidShellCassinoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellCassinoceras.TileEntityCustom();
		}
