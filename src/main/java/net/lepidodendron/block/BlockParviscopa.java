...
public class BlockParviscopa extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:parviscopa")
	public static final Block block = null;
	public BlockParviscopa(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.parviscopa);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("parviscopa"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:parviscopa", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockParviscopa.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_parviscopa");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PARVISCOPA;
		}
