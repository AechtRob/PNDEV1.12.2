...
public class BlockGosslingiaSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gosslingia_spore")
	public static final Block block = null;
	public BlockGosslingiaSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gosslingia_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:gosslingia_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_gosslingia_spore");
			setRegistryName("gosslingia_spore");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_GOSSLINGIA;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockGosslingia.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockGosslingia.block, (int) (1)));
			}
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockGosslingia.block.getDefaultState(), 3);
					}
					//Chance of collapsing:
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockGosslingia.block.getDefaultState(), 3);
		        	}
				}
			}
		}
