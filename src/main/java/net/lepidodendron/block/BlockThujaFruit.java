...
public class BlockThujaFruit extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thuja_fruit")
	public static final Block block = null;
	public BlockThujaFruit(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thuja_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thuja_fruit"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:thuja_fruit", "inventory"));
	}
