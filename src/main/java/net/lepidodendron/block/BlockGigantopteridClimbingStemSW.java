...
public class BlockGigantopteridClimbingStemSW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigantopterid_climbing_stem_sw")
	public static final Block block = null;
	public BlockGigantopteridClimbingStemSW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantopterid_climbing_stem_sw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantopterid_climbing_stem_sw"));
	...
	//			new ModelResourceLocation("lepidodendron:gigantopterid_climbing_stem_sw", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_gigantopterid_climbing_stem_sw");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockGigantopteridClimbingStemNW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
