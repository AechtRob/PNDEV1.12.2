...
public class BlockAulaceraSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:aulacera_sapling")
	public static final Block block = null;
	public BlockAulaceraSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.aulacera_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("aulacera_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:aulacera_sapling", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAulaceraSapling.LEVEL).build());
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNaulacera_sapling", BlockAulaceraSapling.block);
