...
public class BlockLepidophloiosLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lepidophloios_litterbin")
	public static final Block block = null;
	public BlockLepidophloiosLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lepidophloios_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lepidophloios_litterbin"));
