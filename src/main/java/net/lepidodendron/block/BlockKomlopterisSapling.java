...
public class BlockKomlopterisSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:komlopteris_sapling")
	public static final Block block = null;
	public BlockKomlopterisSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.komlopteris_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("komlopteris_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:komlopteris_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:komlopteris_sapling", BlockKomlopterisSapling.block);
