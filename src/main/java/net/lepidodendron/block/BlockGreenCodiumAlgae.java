...
public class BlockGreenCodiumAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:green_codium_algae")
	public static final Block block = null;
	public BlockGreenCodiumAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.green_codium_algae);
	}
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("green_codium_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:green_codium_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockGreenCodiumAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenBranchedAlgaeBlacklistBiomes)) {
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenBranchedAlgaeOverrideBiomes))
			biomeCriteria = true;
