...
import net.lepidodendron.world.gen.CambrianSeaPenGenerator;
...
public class BlockThaumaptilon extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thaumaptilon")
	public static final Block block = null;
	public BlockThaumaptilon(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thaumaptilon);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thaumaptilon"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("staticdnaPNlepidodendron:thaumaptilon", BlockThaumaptilon.block);
		OreDictionary.registerOre("holdfastDrops", BlockThaumaptilon.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:thaumaptilon", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockThaumaptilon.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 8; i++) {
			...
			(new CambrianSeaPenGenerator((Block) block)).generate(world, random, new BlockPos(l6, i11, l14));
		}
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_thaumaptilon");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_THAUMAPTILON;
		}
