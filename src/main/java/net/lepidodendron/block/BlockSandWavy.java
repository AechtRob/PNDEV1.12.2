...
public class BlockSandWavy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sand_wavy")
	public static final Block block = null;
	public BlockSandWavy(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sand_wavy);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sand_wavy"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sand_wavy", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling implements ISustainsPlantType {
		public BlockCustom() {
			...
			setHardness(0.5F);
			setResistance(0.5F);
			setTranslationKey("pf_sand_wavy");
