...
public class BlockStachyophytonSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stachyophyton_spore")
	public static final Block block = null;
	public BlockStachyophytonSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stachyophyton_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:stachyophyton_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_stachyophyton_spore");
			setRegistryName("stachyophyton_spore");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_STACHYOPHYTON;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockStachyophyton.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockStachyophyton.block, (int) (1)));
			}
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockStachyophyton.block.getDefaultState(), 3);
					}
					//Chance of collapsing:
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockStachyophyton.block.getDefaultState(), 3);
		        	}
				}
			}
		}
...
//	    	}
		...
		public Block planted() {
			return BlockStachyophyton.block;
		}
