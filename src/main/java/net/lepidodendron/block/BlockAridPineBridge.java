...
public class BlockAridPineBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arid_pine_bridge")
	public static final Block block = null;
	public BlockAridPineBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arid_pine_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("arid_pine_bridge"));
