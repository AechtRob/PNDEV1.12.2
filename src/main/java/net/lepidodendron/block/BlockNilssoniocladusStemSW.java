...
public class BlockNilssoniocladusStemSW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nilssoniocladus_stem_sw")
	public static final Block block = null;
	public BlockNilssoniocladusStemSW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nilssoniocladus_stem_sw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nilssoniocladus_stem_sw"));
	...
	//			new ModelResourceLocation("lepidodendron:nilssoniocladus_stem_sw", "inventory"));
	//}
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockNilssoniocladusStemNW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
