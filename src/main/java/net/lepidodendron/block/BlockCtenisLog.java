...
public class BlockCtenisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ctenis_log")
	public static final Block block = null;
	public BlockCtenisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ctenis_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ctenis_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:ctenis_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:ctenis_sapling", BlockCtenisLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ctenis_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockCtenisShoot.block) || (block1 == BlockCtenisShootPlaceable.block) || (block1 == BlockCtenisShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
