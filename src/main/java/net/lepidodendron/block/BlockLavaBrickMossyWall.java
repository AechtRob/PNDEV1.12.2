...
public class BlockLavaBrickMossyWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lava_brick_mossy_wall")
	public static final Block block = null;
	public BlockLavaBrickMossyWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lava_brick_mossy_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lava_brick_mossy_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lava_brick_mossy_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_lava_brick_mossy_wall");
