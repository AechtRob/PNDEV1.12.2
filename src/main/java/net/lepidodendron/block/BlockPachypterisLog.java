...
public class BlockPachypterisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pachypteris_log")
	public static final Block block = null;
	public BlockPachypterisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pachypteris_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pachypteris_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:pachypteris_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:pachypteris_sapling", BlockPachypterisLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_pachypteris_log");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PACHYPTERIS;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockPachypterisShoot.block) || (block1 == BlockPachypterisShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
