...
public class BlockPsaroniusLeavesSmall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psaronius_leaves_small_worldgen")
	public static final Block block = null;
	public BlockPsaroniusLeavesSmall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psaronius_leaves_small_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("psaronius_leaves_small_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:psaronius_leaves_small_worldgen", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_psaronius_leaves_small_worldgen");
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockPsaroniusLeavesSmallPlaceable.block, (int) (1)));
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockPsaroniusLeavesSmallPlaceable.block, (int) (1));
        }
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) 
		{
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
				...
				if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
					...
					if (block != BlockPsaroniusBranch.block)
						{
		...
		public Block planted() {
			return BlockPsaroniusSapling.block;
		}
