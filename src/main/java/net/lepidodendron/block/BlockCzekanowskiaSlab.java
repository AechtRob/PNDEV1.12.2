...
public class BlockCzekanowskiaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:czekanowskia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:czekanowskia_slab_double")
	public static final Block block_slab_double = null;
	public BlockCzekanowskiaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.czekanowskia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("czekanowskia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("czekanowskia_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:czekanowskia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_czekanowskia_slab");
