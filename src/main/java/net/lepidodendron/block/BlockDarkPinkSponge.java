...
public class BlockDarkPinkSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dark_pink_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dark_pink_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockDarkPinkSponge.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("itemSponge", BlockDarkPinkSponge.block);
		OreDictionary.registerOre("pndietSponge", BlockDarkPinkSponge.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightDarkPinkSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genDarkPinkSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genDarkPinkSpongeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_dark_pink_sponge");
