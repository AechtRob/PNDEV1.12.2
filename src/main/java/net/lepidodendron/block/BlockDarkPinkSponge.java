...
public class BlockDarkPinkSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightDarkPinkSponge;
		...
		if (!matchBiome(biome, LepidodendronConfig.genDarkPinkSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genDarkPinkSpongeOverrideBiomes))
			biomeCriteria = true;
