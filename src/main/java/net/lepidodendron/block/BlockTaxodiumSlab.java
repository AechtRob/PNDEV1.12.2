...
public class BlockTaxodiumSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:taxodium_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:taxodium_slab_double")
	public static final Block block_slab_double = null;
	public BlockTaxodiumSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.taxodium_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("taxodium_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("taxodium_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:taxodium_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_taxodium_slab");
