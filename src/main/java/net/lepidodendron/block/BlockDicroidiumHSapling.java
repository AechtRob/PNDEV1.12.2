...
public class BlockDicroidiumHSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_h_sapling")
	public static final Block block = null;
	public BlockDicroidiumHSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_h_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_h_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dicroidium_h_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dicroidium_h_sapling", BlockDicroidiumHSapling.block);
		OreDictionary.registerOre("treeSapling", BlockDicroidiumHSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockDicroidiumHSapling.block);
		OreDictionary.registerOre("plant", BlockDicroidiumHSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_dicroidium_h_sapling");
