...
public class BlockSandyDirtRed extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_dirt_red")
	public static final Block block = null;
	public BlockSandyDirtRed(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_dirt_red);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandy_dirt_red"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_dirt_red", "inventory"));
	}

	public static class BlockCustom extends Block implements ISustainsPlantType {
		public BlockCustom() {
			super(Material.GROUND);
			setTranslationKey("pf_sandy_dirt_red");
