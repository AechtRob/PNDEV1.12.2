...
public class BlockSandstoneWhiteSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_slab_white")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_slab_white_double")
	public static final Block block_slab_double = null;
	public BlockSandstoneWhiteSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandstone_slab_white);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstone_slab_white"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sandstone_slab_white_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandstone_slab_white", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_sandstone_slab_white");
