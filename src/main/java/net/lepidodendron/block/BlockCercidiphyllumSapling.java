...
public class BlockCercidiphyllumSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cercidiphyllum_sapling")
	public static final Block block = null;
	public BlockCercidiphyllumSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cercidiphyllum_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cercidiphyllum_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cercidiphyllum_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cercidiphyllum_sapling", BlockCercidiphyllumSapling.block);
		OreDictionary.registerOre("treeSapling", BlockCercidiphyllumSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockCercidiphyllumSapling.block);
		OreDictionary.registerOre("plant", BlockCercidiphyllumSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_cercidiphyllum_sapling");
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				ProcedureWorldGenCercidiphyllum.executeProcedure(world, pos.up(BareTrunk), TreeHeight, false);
