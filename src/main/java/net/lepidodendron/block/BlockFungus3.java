...
public class BlockFungus3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_3")
	public static final Block block = null;
	public BlockFungus3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_3", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus3.BlockCustom.SPREADABLE).ignore(BlockFungus3.BlockCustom.NORTH).ignore(BlockFungus3.BlockCustom.SOUTH).ignore(BlockFungus3.BlockCustom.EAST).ignore(BlockFungus3.BlockCustom.WEST).ignore(BlockFungus3.BlockCustom.UP).ignore(BlockFungus3.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus3", BlockFungus3.block);
		OreDictionary.registerOre("itemFungus", BlockFungus3.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus3.block);
	}
