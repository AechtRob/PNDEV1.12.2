...
public class BlockPagiophyllumBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pagiophyllum_bridge")
	public static final Block block = null;
	public BlockPagiophyllumBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pagiophyllum_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pagiophyllum_bridge"));
