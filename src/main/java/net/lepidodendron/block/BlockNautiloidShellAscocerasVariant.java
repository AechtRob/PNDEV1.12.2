...
public class BlockNautiloidShellAscocerasVariant extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_ascoceras_variant")
	public static final Block block = null;
	public BlockNautiloidShellAscocerasVariant(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_ascoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_ascoceras_variant"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAscocerasVariant.TileEntityCustom.class, "lepidodendron:tileentityshell_ascoceras_variant");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_ascoceras_variant", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_shell_ascoceras_variant");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAscocerasVariant.TileEntityCustom();
		}

		public BlockNautiloidShellAscocerasVariant.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAscocerasVariant.TileEntityCustom();
		}
