...
public class BlockPrimevalGrassLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:primaeval_grass_land")
	public static final Block block = null;
	public BlockPrimevalGrassLand(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.primaeval_grass_land);
	}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					else if (BlockPrimevalGrassWater.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockPrimevalGrassWater.block.getDefaultState(), 3);
						}
					}
