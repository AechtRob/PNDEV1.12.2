...
public class BlockSaururusLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:saururus_land")
	public static final Block block = null;
	public BlockSaururusLand(ElementsLepidodendronMod instance) {
	...
	public static class BlockCustom extends BlockBush implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_saururus_land");
			setRegistryName("saururus_land");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					else if (BlockSaururusWater.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockSaururusWater.block.getDefaultState(), 3);
						}
					}
