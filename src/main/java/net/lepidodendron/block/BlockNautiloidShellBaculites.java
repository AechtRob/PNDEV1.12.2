...
public class BlockNautiloidShellBaculites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_baculites")
	public static final Block block = null;
	public BlockNautiloidShellBaculites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_baculites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_baculites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellBaculites.TileEntityCustom.class, "lepidodendron:tileentityshell_baculites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_baculites", BlockNautiloidShellBaculites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_baculites", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_baculites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellBaculites.TileEntityCustom();
		}

		public BlockNautiloidShellBaculites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellBaculites.TileEntityCustom();
		}
