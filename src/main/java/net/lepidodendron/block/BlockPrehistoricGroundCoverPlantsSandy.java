...
public class BlockPrehistoricGroundCoverPlantsSandy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:prehistoric_ground_cover_plants_sandy")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("prehistoric_ground_cover_plants_sandy"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:prehistoric_ground_cover_plants_sandy", "inventory"));
	}
	public static class BlockCustom extends BlockBush implements net.minecraftforge.common.IShearable {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_prehistoric_ground_cover_plants_sandy");
