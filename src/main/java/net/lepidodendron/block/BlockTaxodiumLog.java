...
public class BlockTaxodiumLog extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("taxodium_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:taxodium_log", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:taxodium_sapling", BlockTaxodiumLog.block);
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_taxodium_log");
