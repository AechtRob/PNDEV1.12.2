...
public class BlockDioonLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dioon_log")
	public static final Block block = null;
	public BlockDioonLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dioon_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dioon_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:dioon_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dioon_sapling", BlockDioonLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_dioon_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockDioonShoot.block) || (block1 == BlockDioonShootPlaceable.block) || (block1 == BlockDioonShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
