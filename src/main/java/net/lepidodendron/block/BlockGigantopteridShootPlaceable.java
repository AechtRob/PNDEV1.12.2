...
public class BlockGigantopteridShootPlaceable extends ElementsLepidodendronMod.ModElement {
	...
	public BlockGigantopteridShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantopterid_shoot);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:gigantopterid_sapling", BlockGigantopteridShootPlaceable.block);
