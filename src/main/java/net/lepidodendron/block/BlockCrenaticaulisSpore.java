...
public class BlockCrenaticaulisSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crenaticaulis_spore")
	public static final Block block = null;
	public BlockCrenaticaulisSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crenaticaulis_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:crenaticaulis_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_crenaticaulis_spore");
			setRegistryName("crenaticaulis_spore");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRENATICAULIS;
		}
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (stack.getItem() == Items.SHEARS && LepidodendronConfig.doPropagation
				...
				EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockCooksonia.block, (int) (1)));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockCrenaticaulis.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockCrenaticaulis.block, (int) (1)));
			}
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockCrenaticaulis.block.getDefaultState(), 3);
					}
					//Chance of collapsing:
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockCrenaticaulis.block.getDefaultState(), 3);
		        	}
				}
			}
		}
...
//	    	}
		...
		public Block planted() {
			return BlockCrenaticaulis.block;
		}
