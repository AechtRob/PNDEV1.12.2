...
public class BlockBanksia2Sapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:banksia_2_sapling")
	public static final Block block = null;
	public BlockBanksia2Sapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.banksia_2_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("banksia_2_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:banksia_2_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:banksia_2_sapling", BlockBanksia2Sapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_banksia_2_sapling");
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				int z = pos.getZ();
				{
					...
					ProcedureWorldGenBanksia2.executeProcedure($_dependencies);
				}
	        }
	    }
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Palaeogene (Eocene) - Neogene - Pleistocene [- present]");
