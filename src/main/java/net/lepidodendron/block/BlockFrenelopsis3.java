...
public class BlockFrenelopsis3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:frenelopsis_03")
	public static final Block block = null;
	public BlockFrenelopsis3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.frenelopsis_03);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frenelopsis_03"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:frenelopsis3", "inventory"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockFrenelopsis2.block || blockU != BlockFrenelopsis4.block) {
