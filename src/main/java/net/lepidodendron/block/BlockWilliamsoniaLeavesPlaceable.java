...
public class BlockWilliamsoniaLeavesPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:williamsonia_leaves")
	public static final Block block = null;
	public BlockWilliamsoniaLeavesPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.williamsonia_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("williamsonia_leaves"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:williamsonia_sapling", BlockWilliamsoniaLeavesPlaceable.block);
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter, IBennettites, IPottable {
		...
		public BlockCustom() {
			//super();
			setTranslationKey("pf_williamsonia_leaves");
