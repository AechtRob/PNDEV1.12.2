...
public class BlockCrinoidPisocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_pisocrinus")
	public static final Block block = null;
	public BlockCrinoidPisocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_pisocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_pisocrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_pisocrinus", BlockCrinoidPisocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidPisocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidPisocrinus.block);
	}
	...
	private static int crinoidHeight(World worldIn, BlockPos pos, Random random) {
		if (worldIn.getBiome(pos).getRegistryName().toString().equalsIgnoreCase("lepidodendron:silurian_sea_garden")) {
			if (random.nextInt(8) != 0) {
				return BlockCrinoidPisocrinus.BlockCustom.crinoidheight;
			}
		}
		return 1 + random.nextInt(random.nextInt(random.nextInt(BlockCrinoidPisocrinus.BlockCustom.crinoidheight) + 1) + 1);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_pisocrinus");
			setRegistryName("crinoid_pisocrinus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_PISOCRINUS;
		}
