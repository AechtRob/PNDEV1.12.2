...
public class BlockYellowSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightYellowSponge;
		...
		if (!matchBiome(biome, LepidodendronConfig.genYellowSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genYellowSpongeOverrideBiomes))
			biomeCriteria = true;
