...
public class BlockLophosoriaTopSouthWest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_top_south_west")
	public static final Block block = null;
	public BlockLophosoriaTopSouthWest(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_top_south_west"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_top_south_west", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_top_south_west", Blocklophosoria_top_south_westTop.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_top_south_westTop.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_top_south_westTop.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_top_south_west");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockE != BlockLophosoriaTopSouth.block) {
				world.setBlockToAir(pos);
			}
			if (blockN != BlockLophosoriaTopWest.block) {
				world.setBlockToAir(pos);
			}
