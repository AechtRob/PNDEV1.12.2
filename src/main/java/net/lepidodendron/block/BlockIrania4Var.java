...
public class BlockIrania4Var extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania4_var")
	public static final Block block = null;
	public BlockIrania4Var(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania4_var"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania4_var", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_irania4_var");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockIrania3Var.block)
				world.destroyBlock(pos, false);

				if (blockU != BlockIrania5Var.block
					&& blockU != BlockIrania5FlowerVar.block) {
					world.destroyBlock(pos, false);
