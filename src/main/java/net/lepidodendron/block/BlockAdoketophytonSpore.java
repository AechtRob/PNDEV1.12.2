...
public class BlockAdoketophytonSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:adoketophyton_spore")
	public static final Block block = null;
	public BlockAdoketophytonSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.adoketophyton_spore);
	}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockAdoketophyton.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockAdoketophyton.block, (int) (1)));
			}
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
		        	...
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockAdoketophyton.block.getDefaultState(), 3);
		        	}
				}
			}
		}
