...
public class BlockBurntStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:burnt_stem")
	public static final Block block = null;
	public BlockBurntStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.burnt_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("burnt_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:burnt_stem", "inventory"));
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_burnt_stem");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.COAL, (int) (2), 1));
		}
