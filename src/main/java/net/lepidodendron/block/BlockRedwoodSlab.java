...
public class BlockRedwoodSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:redwood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:redwood_slab_double")
	public static final Block block_slab_double = null;
	public BlockRedwoodSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.redwood_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("redwood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("redwood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:redwood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_redwood_slab");
