...
public class BlockCornusmas2Flower extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas2_flower")
	public static final Block block = null;
	public BlockCornusmas2Flower(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas2_flower"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:cornusmas2_flower", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockCornusmas.block && block != BlockCornusmasBerries.block && block != BlockCornusmasFlower.block)
					|| (blockU != BlockCornusmas3.block && blockU != BlockCornusmas3.block && blockU != BlockCornusmas3Flower.block)) {
