...
public class BlockBumbudendronWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bumbudendron_water")
	public static final Block block = null;
	public BlockBumbudendronWater(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bumbudendron_water);
	}
	...
	public static class BlockCustom extends SeedSporeLilyPadBase implements IGrowable, net.minecraftforge.common.IShearable {
		public BlockCustom() {
			...
			setLightOpacity(0);
			setCreativeTab(null);
			if (LepidodendronConfig.spreadBumbudendron) {
				setTickRandomly(true);
			}
			else {
				setTickRandomly(false);
			}
			setTranslationKey("pf_bumbudendron_water");
			setRegistryName("bumbudendron_water");
		}
		...
		public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
			...
			if (entityIn instanceof EntityBoat)
			{
				...
				if (!LepidodendronConfig.doPropagation) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemBumbudendronItem.block, (int) (1)));
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(ItemBumbudendronItem.block, (int) (1)));
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemBumbudendronItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemBumbudendronItem.block, (int) (1)));
			}
		}
				...
				if (!this.canSurviveAt(world, pos))
		        {
					...
					if (canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockBumbudendronWater.block.getDefaultState(), 3);
						}
					}
					else if (BlockBumbudendronLand.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockBumbudendronLand.block.getDefaultState(), 3);
						}
					}
	    ...
	    {
	    	if (!LepidodendronConfig.spreadBumbudendron) {return true;}
	        return false;
	    }
		...
		public Item blockItem() {
			return ItemBumbudendronItem.block;
		}
	}
}
