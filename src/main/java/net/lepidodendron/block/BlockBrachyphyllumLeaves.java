...
public class BlockBrachyphyllumLeaves extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:brachyphyllum_sapling", BlockBrachyphyllumLeaves.block);
	...
	public static class BlockCustom extends BlockLeavesPF {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)  {
			...
			if (state.getBlock() != BlockBrachyphyllumLeaves1.block) {
