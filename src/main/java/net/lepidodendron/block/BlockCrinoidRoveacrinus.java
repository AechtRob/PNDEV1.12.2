...
//public class BlockCrinoidRoveacrinus extends ElementsLepidodendronMod.ModElement {
//	@GameRegistry.ObjectHolder("lepidodendron:crinoid_roveacrinus")
//	public static final Block block = null;
//	public BlockCrinoidRoveacrinus(ElementsLepidodendronMod instance) {
//		super(instance, LepidodendronSorter.crinoid_roveacrinus);
//	}
//
//	@Override
...
//				new ModelResourceLocation("lepidodendron:crinoid_roveacrinus", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_roveacrinus", BlockCrinoidRoveacrinus.block);
//		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidRoveacrinus.block);
//		OreDictionary.registerOre("holdfastDrops", BlockCrinoidRoveacrinus.block);
//	}
//
//
...
//			if (random.nextInt(8) != 0) {
//				return BlockCrinoidRoveacrinus.BlockCustom.crinoidheight;
//			}
//		}
//		return 1 + random.nextInt(random.nextInt(random.nextInt(BlockCrinoidRoveacrinus.BlockCustom.crinoidheight) + 1) + 1);
//	}
//
...
//			setTranslationKey("pf_crinoid_roveacrinus");
//			setRegistryName("crinoid_roveacrinus");
//		}
//
//		@Nullable
//		@Override
//		public CustomTrigger getModTrigger() {
//			return ModTriggers.CLICK_CRINOID_ROVEACRINUS;
//		}
//
//
//
