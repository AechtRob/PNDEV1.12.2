...
public class BlockRugosa1 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rugosa_1")
	public static final Block block = null;
	public BlockRugosa1(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rugosa_1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rugosa_1"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:rugosa_1", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockRugosa1.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pndietCoral", BlockRugosa1.block);
	}
