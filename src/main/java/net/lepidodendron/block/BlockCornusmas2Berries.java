...
public class BlockCornusmas2Berries extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas2_berries")
	public static final Block block = null;
	public BlockCornusmas2Berries(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas2_berries"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:cornusmas2_berries", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockCornusmas.block && block != BlockCornusmasBerries.block && block != BlockCornusmasFlower.block)
					|| (blockU != BlockCornusmas3.block && blockU != BlockCornusmas3Berries.block && blockU != BlockCornusmas3Flower.block)) {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
			{
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					...
					world.setBlockState(pos.down(), BlockCornusmas.block.getDefaultState(), 3);
					world.setBlockState(pos, BlockCornusmas2.block.getDefaultState(), 3);
					world.setBlockState(pos.up(), BlockCornusmas3.block.getDefaultState(), 3);
					return true;
				}
				return true;
			}
