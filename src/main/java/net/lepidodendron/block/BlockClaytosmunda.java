...
public class BlockClaytosmunda extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:claytosmunda")
	public static final Block block = null;
	public BlockClaytosmunda(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.claytosmunda);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:claytosmunda", "inventory"));
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_claytosmunda");
			setRegistryName("claytosmunda");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CLAYTOSMUNDA;
		}
		...
		public Block planted() {
			return BlockClaytosmunda.block;
		}
