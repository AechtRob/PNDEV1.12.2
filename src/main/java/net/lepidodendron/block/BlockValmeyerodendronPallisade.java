...
public class BlockValmeyerodendronPallisade extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:valmeyerodendron_pallisade")
	public static final Block block = null;
	public BlockValmeyerodendronPallisade(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.valmeyerodendron_pallisade);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("valmeyerodendron_pallisade"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:valmeyerodendron_pallisade", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_valmeyerodendron_pallisade");
