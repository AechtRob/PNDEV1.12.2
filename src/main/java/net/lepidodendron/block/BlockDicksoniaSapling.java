...
public class BlockDicksoniaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicksonia_sapling")
	public static final Block block = null;
	public BlockDicksoniaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicksonia_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicksonia_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dicksonia_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dicksonia_sapling", BlockDicksoniaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_dicksonia_sapling");
