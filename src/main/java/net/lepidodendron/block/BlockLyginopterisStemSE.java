...
public class BlockLyginopterisStemSE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lyginopteris_stem_se")
	public static final Block block = null;
	public BlockLyginopterisStemSE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lyginopteris_stem_se);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lyginopteris_stem_se"));
	...
	//			new ModelResourceLocation("lepidodendron:lyginopteris_stem_se", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_lyginopteris_stem_se");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockLyginopterisStemSW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
