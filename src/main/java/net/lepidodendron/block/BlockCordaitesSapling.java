...
public class BlockCordaitesSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cordaites_sapling")
	public static final Block block = null;
	public BlockCordaitesSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cordaites_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cordaites_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cordaites_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cordaites_sapling", BlockCordaitesSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_cordaites_sapling");
