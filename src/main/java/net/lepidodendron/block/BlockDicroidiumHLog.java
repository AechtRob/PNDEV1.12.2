...
public class BlockDicroidiumHLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_h_log")
	public static final Block block = null;
	public BlockDicroidiumHLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_h_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_h_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:dicroidium_h_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:dicroidium_h_sapling", BlockDicroidiumHLog.block);
		OreDictionary.registerOre("logWood", BlockDicroidiumHLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_dicroidium_h_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockDicroidiumHShoot.block) || (block1 == BlockDicroidiumHShootPlaceable.block)) {
				leavesattached = true;
	    	}
