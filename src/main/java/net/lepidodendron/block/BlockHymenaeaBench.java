...
public class BlockHymenaeaBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hymenaea_bench")
	public static final Block block = null;
	public BlockHymenaeaBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hymenaea_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hymenaea_bench"));
