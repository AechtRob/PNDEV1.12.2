...
public class BlockPteridinium extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pteridinium")
	public static final Block block = null;
	public BlockPteridinium(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pteridinium);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pteridinium"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("dnaPNPteridinium", BlockPteridinium.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pteridinium", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockPteridinium.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_pteridinium");
