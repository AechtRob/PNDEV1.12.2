...
public class BlockLophosoriaCentreSouth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_south")
	public static final Block block = null;
	public BlockLophosoriaCentreSouth(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_south"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_south", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_south", Blocklophosoria_centre_southCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_southCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_southCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_south");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockN != BlockLophosoriaCentre.block) {
				world.setBlockToAir(pos);
			}
			if (blockE != BlockLophosoriaCentreSouthEast.block) {
				world.setBlockToAir(pos);
			}
			if (blockW != BlockLophosoriaCentreSouthWest.block) {
				world.setBlockToAir(pos);
			}
