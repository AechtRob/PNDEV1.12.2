...
public class BlockGoldenLarchSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:golden_larch_sapling")
	public static final Block block = null;
	public BlockGoldenLarchSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.golden_larch_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("golden_larch_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:golden_larch_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:golden_larch_sapling", BlockGoldenLarchSapling.block);
		OreDictionary.registerOre("treeSapling", BlockGoldenLarchSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockGoldenLarchSapling.block);
		OreDictionary.registerOre("plant", BlockGoldenLarchSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_golden_larch_sapling");
