...
public class BlockAnkyropterisStemSW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ankyropteris_stem_sw")
	public static final Block block = null;
	public BlockAnkyropterisStemSW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ankyropteris_stem_sw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ankyropteris_stem_sw"));
	...
	//			new ModelResourceLocation("lepidodendron:ankyropteris_stem_sw", "inventory"));
	//}
	public static class BlockCustom extends SeedSporeFacingBlockBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ankyropteris_stem_sw");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ANKYROPTERIS;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if (state.getValue(FACING) == EnumFacing.NORTH) {
				...
				if (block == BlockAnkyropterisStemSE.block || block == BlockAnkyropterisStemNE.block 
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockAnkyropterisStemNW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockAnkyropterisStemNE.block, (int) (1));
        }
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockAnkyropterisStemNE.block, (int) (1)));
		}		
