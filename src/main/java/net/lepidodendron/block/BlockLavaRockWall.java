...
public class BlockLavaRockWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lava_rock_wall")
	public static final Block block = null;
	public BlockLavaRockWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lava_rock_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lava_rock_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lava_rock_wall", "inventory"));
	}
