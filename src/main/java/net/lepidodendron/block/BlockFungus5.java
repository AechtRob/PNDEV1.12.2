...
public class BlockFungus5 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_5")
	public static final Block block = null;
	public BlockFungus5(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_5);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_5"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_5", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus5.BlockCustom.SPREADABLE).ignore(BlockFungus5.BlockCustom.NORTH).ignore(BlockFungus5.BlockCustom.SOUTH).ignore(BlockFungus5.BlockCustom.EAST).ignore(BlockFungus5.BlockCustom.WEST).ignore(BlockFungus5.BlockCustom.UP).ignore(BlockFungus5.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus5", BlockFungus5.block);
		OreDictionary.registerOre("itemFungus", BlockFungus5.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus5.block);
	}
