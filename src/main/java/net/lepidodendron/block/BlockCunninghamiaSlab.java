...
public class BlockCunninghamiaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cunninghamia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:cunninghamia_slab_double")
	public static final Block block_slab_double = null;
	public BlockCunninghamiaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cunninghamia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cunninghamia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cunninghamia_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cunninghamia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_cunninghamia_slab");
