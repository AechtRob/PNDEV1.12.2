...
public class BlockPsaroniusLeavesTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psaronius_leaves_top")
	public static final Block block = null;
	public BlockPsaroniusLeavesTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psaronius_leaves_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("psaronius_leaves_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:psaronius_leaves_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_psaronius_leaves_top");
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockPsaroniusLeavesPlaceable.block, (int) (1));
        }
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if ((block == BlockPsaroniusLeaves.block) || (block == BlockPsaroniusLeavesPlaceable.block))
				{
					if (new Object() {
