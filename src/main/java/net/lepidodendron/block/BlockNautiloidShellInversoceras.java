...
public class BlockNautiloidShellInversoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_inversoceras")
	public static final Block block = null;
	public BlockNautiloidShellInversoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_inversoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_inversoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellInversoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_inversoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_inversoceras", BlockNautiloidShellInversoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_inversoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_inversoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellInversoceras.TileEntityCustom();
		}

		public BlockNautiloidShellInversoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellInversoceras.TileEntityCustom();
		}
