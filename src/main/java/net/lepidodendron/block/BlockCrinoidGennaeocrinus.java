...
public class BlockCrinoidGennaeocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_gennaeocrinus")
	public static final Block block = null;
	public BlockCrinoidGennaeocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_gennaeocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_gennaeocrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_gennaeocrinus", BlockCrinoidGennaeocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidGennaeocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidGennaeocrinus.block);
	}
	...
	private static int crinoidHeight(World worldIn, BlockPos pos, Random random) {
		if (worldIn.getBiome(pos).getRegistryName().toString().equalsIgnoreCase("lepidodendron:silurian_sea_garden")) {
			if (random.nextInt(8) != 0) {
				return BlockCrinoidGennaeocrinus.BlockCustom.crinoidheight;
			}
		}
		return 1 + random.nextInt(random.nextInt(random.nextInt(BlockCrinoidGennaeocrinus.BlockCustom.crinoidheight) + 1) + 1);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_gennaeocrinus");
			setRegistryName("crinoid_gennaeocrinus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_GENNAEOCRINUS;
		}
