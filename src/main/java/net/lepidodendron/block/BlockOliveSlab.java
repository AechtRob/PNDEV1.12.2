...
public class BlockOliveSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:olive_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:olive_slab_double")
	public static final Block block_slab_double = null;
	public BlockOliveSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.olive_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("olive_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("olive_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockOliveSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:olive_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_olive_slab");
