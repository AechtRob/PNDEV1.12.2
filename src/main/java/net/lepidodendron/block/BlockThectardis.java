...
public class BlockThectardis extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thectardis")
	public static final Block block = null;
	public BlockThectardis(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thectardis);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thectardis"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:thectardis", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockThectardis.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:thectardis", BlockThectardis.block);
	}
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 12; ++i) {
						...
						if (!(biomeName.equalsIgnoreCase("lepidodendron:ediacaran_stromatolite_pavement")
								...
								|| biomeName.equalsIgnoreCase("lepidodendron:ediacaran_trench"))
						) {
							continue;
						}
						if (world.getBlockState(blockpos1).getBlock() == Blocks.WATER) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockThectardis.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_thectardis");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_THECTARDIS;
		}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: Undetermined cone-like organism");
