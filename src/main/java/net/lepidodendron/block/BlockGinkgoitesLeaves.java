...
public class BlockGinkgoitesLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ginkgoites_leaves")
	public static final Block block = null;
	public BlockGinkgoitesLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ginkgoites_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ginkgoites_leaves"));
