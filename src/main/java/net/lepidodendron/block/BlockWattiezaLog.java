...
public class BlockWattiezaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wattieza_log")
	public static final Block block = null;
	public BlockWattiezaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wattieza_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wattieza_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:wattieza_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:wattieza_sapling", BlockWattiezaLog.block);
    ...
    public static final PropertyBool GROUND = PropertyBool.create("ground");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockWattiezaShoot.block) || (block1 == BlockWattiezaShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
