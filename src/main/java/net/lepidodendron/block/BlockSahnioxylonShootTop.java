...
public class BlockSahnioxylonShootTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sahnioxylon_shoot_top")
	public static final Block block = null;
	public BlockSahnioxylonShootTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sahnioxylon_shoot_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sahnioxylon_shoot_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:sahnioxylon_shoot_top", "inventory"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockSahnioxylonShoot.block) && (block != BlockSahnioxylonShootPlaceable.block)) {
