...
public class BlockIrania3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania3")
	public static final Block block = null;
	public BlockIrania3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania3", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockIrania4.block
				&& block != BlockIrania4Flower.block) {
				world.destroyBlock(pos, false);
