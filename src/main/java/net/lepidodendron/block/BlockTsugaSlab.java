...
public class BlockTsugaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tsuga_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:tsuga_slab_double")
	public static final Block block_slab_double = null;
	public BlockTsugaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tsuga_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tsuga_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("tsuga_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockTsugaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tsuga_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_tsuga_slab");
