...
public class BlockCrinoidCallicrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_callicrinus")
	public static final Block block = null;
	public BlockCrinoidCallicrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_callicrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_callicrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNCrinoidCallicrinus", BlockCrinoidCallicrinus.block);
	}
	...
	private static int crinoidHeight(World worldIn, BlockPos pos, Random random) {
		if (worldIn.getBiome(pos).getRegistryName().toString().equalsIgnoreCase("lepidodendron:silurian_sea_garden")) {
			if (random.nextInt(8) != 0) {
				return BlockCustom.crinoidheight;
			}
		}
