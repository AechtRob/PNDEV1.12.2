...
public class BlockArchaeopterisLeaves4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:archaeopteris_leaves_4")
	public static final Block block = null;
	public BlockArchaeopterisLeaves4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.archaeopteris_leaves_4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("archaeopteris_leaves_4"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:archaeopteris_leaves_4", "inventory"));
