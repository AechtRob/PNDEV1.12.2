...
public class BlockLadiniaShootMale extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ladinia_shoot_male_worldgen")
	public static final Block block = null;
	public BlockLadiniaShootMale(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ladinia_shoot_male_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ladinia_shoot_male_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:ladinia_shoot_male_worldgen", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_ladinia_shoot_male_worldgen");
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockLadiniaShootMale.block, (int) (1));
        }
