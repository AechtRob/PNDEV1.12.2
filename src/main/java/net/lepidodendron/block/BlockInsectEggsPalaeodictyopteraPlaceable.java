...
public class BlockInsectEggsPalaeodictyopteraPlaceable extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockInsectEggsPalaeodictyopteraPlaceable.TileEntityCustom.class, "lepidodendron:tileentityinsect_eggs_palaeodictyoptera");
	}
	...
	public static class BlockCustom extends BlockMobSpawn {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockInsectEggsPalaeodictyopteraPlaceable.TileEntityCustom();
		}

		public BlockInsectEggsPalaeodictyopteraPlaceable.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockInsectEggsPalaeodictyopteraPlaceable.TileEntityCustom();
		}
