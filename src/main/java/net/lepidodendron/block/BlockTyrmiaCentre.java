...
public class BlockTyrmiaCentre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tyrmia_centre")
	public static final Block block = null;
	public BlockTyrmiaCentre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tyrmia_centre);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tyrmia_centre"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_TYRMIA;
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockTyrmia.block)
				world.setBlockToAir(pos);

			block = world.getBlockState(pos.up()).getBlock();
			if (block != BlockTyrmiaTop.block) {
				world.setBlockToAir(pos);
