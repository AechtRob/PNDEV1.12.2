...
public class BlockSahnioxylonShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sahnioxylon_shoot")
	public static final Block block = null;
	public BlockSahnioxylonShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sahnioxylon_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sahnioxylon_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sahnioxylon_shoot", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNSahnioxylon", BlockSahnioxylonShootPlaceable.block);
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_sahnioxylon_shoot");
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockSahnioxylonShootTop.block.getDefaultState(), 3);
