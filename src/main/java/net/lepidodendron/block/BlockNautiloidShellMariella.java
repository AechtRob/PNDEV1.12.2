...
public class BlockNautiloidShellMariella extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_mariella")
	public static final Block block = null;
	public BlockNautiloidShellMariella(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_mariella);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_mariella"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellMariella.TileEntityCustom.class, "lepidodendron:tileentityshell_mariella");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_mariella", BlockNautiloidShellMariella.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_mariella", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_mariella");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellMariella.TileEntityCustom();
		}

		public BlockNautiloidShellMariella.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellMariella.TileEntityCustom();
		}
