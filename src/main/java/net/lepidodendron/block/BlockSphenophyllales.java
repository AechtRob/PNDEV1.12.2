...
public class BlockSphenophyllales extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sphenophyllales")
	public static final Block block = null;
	public BlockSphenophyllales(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sphenophyllales);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sphenophyllales"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNsphenophyllales", BlockSphenophyllales.block);
