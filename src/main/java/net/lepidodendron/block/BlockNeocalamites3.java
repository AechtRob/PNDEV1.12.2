...
public class BlockNeocalamites3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:neocalamites_3")
	public static final Block block = null;
	public BlockNeocalamites3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.neocalamites_3);
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if (((world.getBlockState(pos.down())).getBlock() != BlockNeocalamites2.block)
				&& ((world.getBlockState(pos.down())).getBlock() != BlockNeocalamites.block)) {
