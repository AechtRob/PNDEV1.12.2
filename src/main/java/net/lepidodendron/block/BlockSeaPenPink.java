...
public class BlockSeaPenPink extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_pen_pink")
	public static final Block block = null;
	public BlockSeaPenPink(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_pen_pink);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_pen_pink"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		GameRegistry.registerTileEntity(BlockSeaPenPink.TileEntityCustom.class, "lepidodendron:tileentitysea_pen_pink");
		OreDictionary.registerOre("staticdnaPNlepidodendron:sea_pen_pink", BlockSeaPenPink.block);
		OreDictionary.registerOre("holdfastDrops", BlockSeaPenPink.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_pen_pink", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockSeaPenPink.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sea_pen_pink");
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Ordovician - Silurian - Devonian - Carboniferous - Permian - Triassic - Jurassic - Early Cretaceous - Late Cretaceous - Palaeogene  - Neogene - Pleistocene - present");
			}
