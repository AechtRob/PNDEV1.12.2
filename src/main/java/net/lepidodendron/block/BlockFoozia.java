...
public class BlockFoozia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:foozia")
	public static final Block block = null;
	public BlockFoozia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.foozia);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:foozia", "inventory"));
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_foozia");
			setRegistryName("foozia");
		}

		@Override
		public IBlockState getPotState() {
			return BlockFooziaSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockFooziaSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
