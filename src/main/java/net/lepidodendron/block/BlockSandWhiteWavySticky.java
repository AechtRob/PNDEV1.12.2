...
public class BlockSandWhiteWavySticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sand_white_wavy_sticky")
	public static final Block block = null;
	public BlockSandWhiteWavySticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sand_white_wavy_sticky);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sand_white_wavy_sticky"));
	...
	public static class BlockCustom extends Block implements ISustainsPlantType {
		public BlockCustom() {
			...
			setHardness(0.5F);
			setResistance(0.5F);
			setTranslationKey("pf_sand_white_wavy_sticky");
