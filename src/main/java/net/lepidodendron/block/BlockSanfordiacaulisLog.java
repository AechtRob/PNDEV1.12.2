...
public class BlockSanfordiacaulisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sanfordiacaulis_log")
	public static final Block block = null;
	public BlockSanfordiacaulisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sanfordiacaulis_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sanfordiacaulis_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:sanfordiacaulis_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:sanfordiacaulis_sapling", BlockSanfordiacaulisLog.block);
		OreDictionary.registerOre("logWood", BlockSanfordiacaulisLog.block);
	}
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_sanfordiacaulis_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockSanfordiacaulisShoot.block) || (block1 == BlockSanfordiacaulisShootPlaceable.block) || (block1 == BlockSanfordiacaulisShoot.block)) {
				leavesattached = true;
	    	}
			
	        return state.withProperty(UP, Boolean.valueOf(block1 == this || leavesattached)).withProperty(DOWN, Boolean.valueOf(block == this || block != Blocks.AIR)).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this)).withProperty(LEAVES, leavesattached);
	    }
