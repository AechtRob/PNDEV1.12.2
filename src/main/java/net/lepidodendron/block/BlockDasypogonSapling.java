...
public class BlockDasypogonSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dasypogon_sapling")
	public static final Block block = null;
	public BlockDasypogonSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dasypogon_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dasypogon_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dasypogon_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dasypogon_sapling", BlockDasypogonSapling.block);
		OreDictionary.registerOre("treeSapling", BlockDasypogonSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockDasypogonSapling.block);
		OreDictionary.registerOre("plant", BlockDasypogonSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_dasypogon_sapling");
