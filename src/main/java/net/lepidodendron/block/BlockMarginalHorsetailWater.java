...
public class BlockMarginalHorsetailWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:marginal_horsetail_water")
	public static final Block block = null;
	public BlockMarginalHorsetailWater(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.marginal_horsetail_water);
	}
	...
	public static class BlockCustom extends SeedSporeLilyPadBase implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setRegistryName("marginal_horsetail_water");
		}
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0D, -0.5D, 0D, 1D, 1.0D, 1D);
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			{
				if (world.getBlockState(pos.up()).getBlock() != BlockMarginalHorsetailWaterTop.block) {
