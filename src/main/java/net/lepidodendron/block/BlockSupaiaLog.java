...
public class BlockSupaiaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:supaia_log")
	public static final Block block = null;
	public BlockSupaiaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.supaia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("supaia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:supaia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:supaia_sapling", BlockSupaiaLog.block);
		OreDictionary.registerOre("logWood", BlockSupaiaLog.block);
	}
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_supaia_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockSupaiaShoot.block) || (block1 == BlockSupaiaShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
