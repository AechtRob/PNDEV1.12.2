...
public class BlockOsmunda extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:osmunda")
	public static final Block block = null;
	public BlockOsmunda(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.osmunda);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:osmunda", "inventory"));
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_OSMUNDA;
		}
