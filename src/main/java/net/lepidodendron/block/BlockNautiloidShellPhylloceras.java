...
public class BlockNautiloidShellPhylloceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_phylloceras")
	public static final Block block = null;
	public BlockNautiloidShellPhylloceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_phylloceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_phylloceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPhylloceras.TileEntityCustom.class, "lepidodendron:tileentityshell_phylloceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_phylloceras", BlockNautiloidShellPhylloceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_phylloceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_phylloceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPhylloceras.TileEntityCustom();
		}

		public BlockNautiloidShellPhylloceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPhylloceras.TileEntityCustom();
		}
