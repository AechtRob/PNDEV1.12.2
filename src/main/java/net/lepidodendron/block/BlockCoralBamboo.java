...
public class BlockCoralBamboo extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_bamboo")
	public static final Block block = null;
	public BlockCoralBamboo(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_bamboo);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_bamboo"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_bamboo", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_bamboo", BlockCoralBamboo.block);
		OreDictionary.registerOre("coral", BlockCoralBamboo.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralBamboo.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_bamboo");
			setSoundType(SoundType.STONE);
			setHardness(0.2F);
			setResistance(0.2F);
			setLightLevel(3F); //Glows!
			setLightOpacity(3);
