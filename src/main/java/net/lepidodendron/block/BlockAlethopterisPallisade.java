...
public class BlockAlethopterisPallisade extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:alethopteris_pallisade")
	public static final Block block = null;
	public BlockAlethopterisPallisade(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.alethopteris_pallisade);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("alethopteris_pallisade"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:alethopteris_pallisade", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_alethopteris_pallisade");
