...
public class BlockAmentotaxus3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus3")
	public static final Block block = null;
	public BlockAmentotaxus3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus3"));
