...
public class BlockParacalamitesStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paracalamites_stem")
	public static final Block block = null;
	public BlockParacalamitesStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.paracalamites_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("paracalamites_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:paracalamites_stem", "inventory"));
			ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockParacalamitesStem.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_paracalamites_stem");
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
			...
			worldIn.scheduleUpdate(pos.up(2), BlockParacalamites.block, 1);
