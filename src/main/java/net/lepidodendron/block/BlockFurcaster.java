...
public class BlockFurcaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:furcaster_item")
	public static final Block block = null;
	public BlockFurcaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.furcaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("furcaster_item"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_furcaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockFurcaster.TileEntityCustom();
		}

		public BlockFurcaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockFurcaster.TileEntityCustom();
		}
