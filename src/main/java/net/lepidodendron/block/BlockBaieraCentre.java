...
public class BlockBaieraCentre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:baiera_centre")
	public static final Block block = null;
	public BlockBaieraCentre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.baiera_centre);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("baiera_centre"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:baiera_centre", "inventory"));
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockBaiera.block)
				world.setBlockToAir(pos);

			block = world.getBlockState(pos.up()).getBlock();
			if (block != BlockBaieraTop.block) {
				world.setBlockToAir(pos);
