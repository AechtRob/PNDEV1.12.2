...
public class BlockCharnia extends ElementsLepidodendronMod.ModElement {
	...
	public BlockCharnia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.charnia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("charnia"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		GameRegistry.registerTileEntity(BlockCharnia.TileEntityCustom.class, "lepidodendron:tileentitycharnia");
		OreDictionary.registerOre("staticdnaPNlepidodendron:charnia", BlockCharnia.block);
		OreDictionary.registerOre("holdfastDrops", BlockCharnia.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:charnia", "inventory"));
