...
public class BlockInsectEggsErasipteroides extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_erasipteroides_worldgen")
	public static final Block block = null;
	public BlockInsectEggsErasipteroides(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.insect_eggs_erasipteroides_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("insect_eggs_erasipteroides_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockInsectEggsErasipteroides.BlockCustom.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 3; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_erasipteroides", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_insect_eggs_erasipteroides_worldgen");
