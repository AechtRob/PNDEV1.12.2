...
public class BlockPsilophytonStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psilophyton_stem")
	public static final Block block = null;
	public BlockPsilophytonStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psilophyton_stem);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:psilophyton_stem", "inventory"));
	}
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_psilophyton_stem");
			setRegistryName("psilophyton_stem");
		}
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (stack.getItem() == Items.SHEARS && LepidodendronConfig.doPropagation
				...
				EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockPsilophyton.block, (int) (1)));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockPsilophyton.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockPsilophyton.block, (int) (1)));
			}
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance to collapse:
					if ((Math.random() > 0.5)) {
						if (((world.getBlockState(pos.up())).getBlock() == BlockPsilophyton.block)
						|| (world.getBlockState(pos.up())).getBlock() == BlockPsilophytonSpore.block) {
							world.setBlockToAir(pos.up());
						}
						world.setBlockState(pos, BlockPsilophyton.block.getDefaultState(), 3);
		        	}
				}
			}
		}
	    ...
	    {
	    	if (!LepidodendronConfigPlants.spreadPsilophyton) {return true;}
	        return false;
	    }
