...
public class BlockBaragwanathia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:baragwanathia")
	public static final Block block = null;
	public BlockBaragwanathia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.baragwanathia);
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemBaragwanathiaItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemBaragwanathiaItem.block, (int) (1)));
			}
		}
