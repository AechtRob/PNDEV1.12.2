...
import net.lepidodendron.item.ItemMahoganySeeds;
...
public class BlockMahoganyFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mahogany_fruit_block")
	public static final Block block = null;
	public BlockMahoganyFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mahogany_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mahogany_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockMahoganyFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mahogany_fruit_block", "inventory"));
	}
	public static class BlockCustom extends BlockFalling implements IShearable {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_mahogany_fruit_block");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			if ((worldIn.getBlockState(pos.up())).getBlock() != BlockMahoganyLeaves.block) {
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			if (LepidodendronConfig.doPropagation) {
				drops.add(new ItemStack(ItemMahoganySeeds.block, (int) (3)));
				}
			else {
		...
		public void onEntityCollision(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			if ((entity instanceof EntityLiving) ||(entity instanceof EntityPlayer)) {
				entity.attackEntityFrom(DamageSource.FALLING_BLOCK, (float) 10);
