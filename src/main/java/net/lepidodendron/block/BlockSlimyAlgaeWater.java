...
public class BlockSlimyAlgaeWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:slimy_algae_water")
	public static final Block block = null;
	public BlockSlimyAlgaeWater(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.slimy_algae_water);
	}
