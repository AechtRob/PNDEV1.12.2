...
public class BlockYewSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:yew_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:yew_slab_double")
	public static final Block block_slab_double = null;
	public BlockYewSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.yew_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("yew_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("yew_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:yew_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_yew_slab");
