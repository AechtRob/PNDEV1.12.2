...
public class BlockSandBlackSticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sand_black_sticky")
	public static final Block block = null;
	public BlockSandBlackSticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sand_black_sticky);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sand_black_sticky"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sand_black_sticky", "inventory"));
	}
	
	public static class BlockCustom extends Block implements ISustainsPlantType {
		public BlockCustom() {
			super(Material.SAND);
			setTranslationKey("pf_sand_black_sticky");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockSandBlack.block, 1));
		}
		...
		public ItemStack getSilkTouchDrop(IBlockState state)  {
			return new ItemStack(BlockSandBlack.block, 1);
		}
