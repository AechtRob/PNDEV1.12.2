...
public class BlockPandanLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pandan_log")
	public static final Block block = null;
	public BlockPandanLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pandan_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pandan_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:pandan_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:pandan_sapling", BlockPandanLog.block);
		OreDictionary.registerOre("logWood", BlockPandanLog.block);
	}
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_pandan_log");
