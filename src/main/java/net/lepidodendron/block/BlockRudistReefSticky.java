...
public class BlockRudistReefSticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rudist_reef_sticky")
	public static final Block block = null;

	public BlockRudistReefSticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rudist_reef_sticky);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rudist_reef_sticky"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietShellfish", BlockRudistReefSticky.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:rudist_reef_sticky", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_rudist_reef_sticky");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			if (worldIn.getBlockState(pos.up()).getMaterial() == Material.WATER) {
				return state.withProperty(WATER, 2);
			}
			if (worldIn.getBlockState(pos.north()).getMaterial() == Material.WATER
				...
				return state.withProperty(WATER, 1);
			}
			return state.withProperty(WATER, 0);
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_REEF_RUDIST;
		}
