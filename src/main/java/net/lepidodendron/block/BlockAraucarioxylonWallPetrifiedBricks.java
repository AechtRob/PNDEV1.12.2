...
public class BlockAraucarioxylonWallPetrifiedBricks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:araucarioxylon_wall_petrified_bricks")
	public static final Block block = null;
	public BlockAraucarioxylonWallPetrifiedBricks(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.araucarioxylon_wall_petrified_bricks);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("araucarioxylon_wall_petrified_bricks"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:araucarioxylon_wall_petrified_bricks", "inventory"));
	}
