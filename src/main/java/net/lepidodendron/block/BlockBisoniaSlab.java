...
public class BlockBisoniaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bisonia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:bisonia_slab_double")
	public static final Block block_slab_double = null;
	public BlockBisoniaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bisonia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bisonia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("bisonia_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockBisoniaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bisonia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_bisonia_slab");
