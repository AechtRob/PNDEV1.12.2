...
public class BlockBivalveTitanosarcolites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_titanosarcolites")
	public static final Block block = null;
	public BlockBivalveTitanosarcolites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_titanosarcolites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_titanosarcolites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_titanosarcolites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveTitanosarcolites.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_titanosarcolites", BlockBivalveTitanosarcolites.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveTitanosarcolites.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveTitanosarcolites.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveTitanosarcolites.block);
	}
...
//		}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveTitanosarcolites.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_titanosarcolites");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_TITANOSARCOLITES;
		}
