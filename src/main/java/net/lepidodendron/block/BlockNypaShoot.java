...
public class BlockNypaShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nypa_shoot_worldgen")
	public static final Block block = null;
	public BlockNypaShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nypa_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nypa_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:nypa_shoot_worldgen", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_nypa_shoot_worldgen");
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				return new ItemStack(ItemNypaFruit.block, (int) (1)).getItem();
			}
			else {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.getBlockState(pos.up()).getBlock() != BlockNypaShoot02.block
				&& world.getBlockState(pos.up()).getBlock() != BlockNypaShoot02Fruiting.block)
			{
