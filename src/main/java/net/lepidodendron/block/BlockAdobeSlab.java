...
public class BlockAdobeSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:adobe_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:adobe_slab_double")
	public static final Block block_slab_double = null;
	public BlockAdobeSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.adobe_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("adobe_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("adobe_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:adobe_slab", "inventory"));
	}
