...
public class BlockBisoniaBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bisonia_bench")
	public static final Block block = null;
	public BlockBisoniaBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bisonia_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bisonia_bench"));
