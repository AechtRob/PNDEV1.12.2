...
public class BlockLaurusSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:laurus_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:laurus_slab_double")
	public static final Block block_slab_double = null;
	public BlockLaurusSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.laurus_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("laurus_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("laurus_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockLaurusSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:laurus_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_laurus_slab");
