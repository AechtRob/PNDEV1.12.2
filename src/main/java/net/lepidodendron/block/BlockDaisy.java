...
import net.lepidodendron.item.ItemDaisySeeds;
...
public class BlockDaisy extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:daisy")
	public static final Block block = null;
	public BlockDaisy(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.daisy);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:daisy", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:daisy", BlockDaisy.block);
		OreDictionary.registerOre("plantPrehistoric", BlockDaisy.block);
		OreDictionary.registerOre("plant", BlockDaisy.block);
	}
	...
	public static class BlockCustomFlower extends BlockBush implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_daisy");
			setRegistryName("daisy");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_DAISY;
		}
		...
		{
			if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(BlockDaisy.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
			{
				return true;
			}
			else {
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.35) {
						ItemStack stackSeed = new ItemStack(ItemDaisySeeds.block, (int) (1));
