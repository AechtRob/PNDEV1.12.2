...
public class BlockWilliamsoniaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:williamsonia_log")
	public static final Block block = null;
	public BlockWilliamsoniaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.williamsonia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("williamsonia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:williamsonia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNwilliamsonia_sapling", BlockWilliamsoniaLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_williamsonia_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockWilliamsoniaLeaves.block) || (block == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockWilliamsoniaShoot.block) || (block1 == BlockWilliamsoniaShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
			
			if ((block1 == BlockWilliamsoniaLeaves.block) || (block1 == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockWilliamsoniaLeaves.block) || (block2 == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockWilliamsoniaLeaves.block) || (block3 == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockWilliamsoniaLeaves.block) || (block4 == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockWilliamsoniaLeaves.block) || (block5 == BlockWilliamsoniaLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
