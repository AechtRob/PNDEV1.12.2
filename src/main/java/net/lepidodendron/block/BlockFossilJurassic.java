...
public class BlockFossilJurassic extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_jurassic")
	public static final Block block = null;

	public BlockFossilJurassic(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_jurassic);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_jurassic"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_jurassic", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFossil {
		public BlockCustom() {
			setTranslationKey("pf_fossil_jurassic");
		}

		@Override
		public ItemStack getFossilDrop() {
			return new ItemStack(ItemFossilJurassic.block, 1);
		}
	}
}
