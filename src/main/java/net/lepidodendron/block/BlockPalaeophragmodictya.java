...
public class BlockPalaeophragmodictya extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:palaeophragmodictya")
	public static final Block block = null;
	public BlockPalaeophragmodictya(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.palaeophragmodictya);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("palaeophragmodictya"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:palaeophragmodictya", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockPalaeophragmodictya.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:palaeophragmodictya", BlockPalaeophragmodictya.block);
		OreDictionary.registerOre("itemSponge", BlockPalaeophragmodictya.block);
		OreDictionary.registerOre("pndietSponge", BlockPalaeophragmodictya.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (biome instanceof BiomePrecambrian) {
			...
			if (biome.getRegistryName().toString().equals("lepidodendron:ediacaran_stromatolite_pavement")
			) {
				biomeCriteria = true;
			}
			else {
						...
						{	boolean waterDepthCheckMax = false;
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockPalaeophragmodictya.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_palaeophragmodictya");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PALAEOPHRAGMODICTYA;
		}
