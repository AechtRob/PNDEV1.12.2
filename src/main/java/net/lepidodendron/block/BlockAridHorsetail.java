...
public class BlockAridHorsetail extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:arid_horsetail", BlockAridHorsetail.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ARID_HORSETAIL;
		}
		...
		public Block planted() {
			return BlockAridHorsetail.block;
		}
