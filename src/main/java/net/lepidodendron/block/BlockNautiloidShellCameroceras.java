...
public class BlockNautiloidShellCameroceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_cameroceras")
	public static final Block block = null;
	public BlockNautiloidShellCameroceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_cameroceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_cameroceras"));
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellCameroceras.TileEntityCustom();
		}

		public BlockNautiloidShellCameroceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellCameroceras.TileEntityCustom();
		}
