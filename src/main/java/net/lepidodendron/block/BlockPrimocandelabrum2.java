...
public class BlockPrimocandelabrum2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:primocandelabrum_2")
	public static final Block block = null;
	public BlockPrimocandelabrum2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.primocandelabrum_2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("primocandelabrum_2"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("dnaPNPrimocandelabrum", BlockPrimocandelabrum2.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:primocandelabrum_2", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockPrimocandelabrum2.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_primocandelabrum_2");
