...
public class BlockCunninghamiaLog extends ElementsLepidodendronMod.ModElement {
	...
	public BlockCunninghamiaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cunninghamia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cunninghamia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cunninghamia_log", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:cunninghamia_sapling", BlockCunninghamiaLog.block);
		OreDictionary.registerOre("logWood", BlockCunninghamiaLog.block);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_cunninghamia_log");
