...
public class BlockDawnRedwoodLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dawn_redwood_leaves")
	public static final Block block = null;
	public BlockDawnRedwoodLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dawn_redwood_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dawn_redwood_leaves"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dawn_redwood_sapling", BlockDawnRedwoodLeaves.block);
