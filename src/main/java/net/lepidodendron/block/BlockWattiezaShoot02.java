...
public class BlockWattiezaShoot02 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wattieza_shoot_02")
	public static final Block block = null;
	public BlockWattiezaShoot02(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wattieza_shoot_02);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wattieza_shoot_02"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:wattieza_shoot_02", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_wattieza_shoot_02");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockWattiezaShoot.block) && (block != BlockWattiezaShootPlaceable.block)) {
				...
				if (world.getBlockState(pos.north(2)).getBlock() == BlockWattiezaShootSide02.block) {
					world.scheduleUpdate(pos.north(2), world.getBlockState(pos.north(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.south(2)).getBlock() == BlockWattiezaShootSide02.block) {
					world.scheduleUpdate(pos.south(2), world.getBlockState(pos.south(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.east(2)).getBlock() == BlockWattiezaShootSide02.block) {
					world.scheduleUpdate(pos.east(2), world.getBlockState(pos.east(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.west(2)).getBlock() == BlockWattiezaShootSide02.block) {
			...
			if (block != BlockWattiezaShoot03.block) {
				world.setBlockToAir(pos);
