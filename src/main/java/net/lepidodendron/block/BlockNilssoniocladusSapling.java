...
public class BlockNilssoniocladusSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nilssoniocladus_sapling")
	public static final Block block = null;
	public BlockNilssoniocladusSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nilssoniocladus_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nilssoniocladus_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nilssoniocladus_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nilssoniocladus_sapling", BlockNilssoniocladusSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_NILSSONIOCLADUS;
		}
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				//	$_dependencies.put("world", world);
					ProcedureWorldGenNilssoniocladus.executeProcedure(x, y, z, world);
				//}
	        }
	    }
