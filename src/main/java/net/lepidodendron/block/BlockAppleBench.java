...
public class BlockAppleBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:apple_bench")
	public static final Block block = null;
	public BlockAppleBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.apple_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("apple_bench"));
