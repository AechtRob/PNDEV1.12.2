...
public class BlockAnomozamitesLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:anomozamites_log")
	public static final Block block = null;
	public BlockAnomozamitesLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.anomozamites_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("anomozamites_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:anomozamites_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:anomozamites_sapling", BlockAnomozamitesLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_anomozamites_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockAnomozamitesLeaves.block) || (block == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockAnomozamitesShoot.block) || (block1 == BlockAnomozamitesShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
			
			if ((block1 == BlockAnomozamitesLeaves.block) || (block1 == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockAnomozamitesLeaves.block) || (block2 == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockAnomozamitesLeaves.block) || (block3 == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockAnomozamitesLeaves.block) || (block4 == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockAnomozamitesLeaves.block) || (block5 == BlockAnomozamitesLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
