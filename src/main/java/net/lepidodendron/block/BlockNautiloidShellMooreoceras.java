...
public class BlockNautiloidShellMooreoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_mooreoceras")
	public static final Block block = null;
	public BlockNautiloidShellMooreoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_mooreoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_mooreoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellMooreoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_mooreoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_mooreoceras", BlockNautiloidShellMooreoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_mooreoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_mooreoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellMooreoceras.TileEntityCustom();
		}

		public BlockNautiloidShellMooreoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellMooreoceras.TileEntityCustom();
		}
