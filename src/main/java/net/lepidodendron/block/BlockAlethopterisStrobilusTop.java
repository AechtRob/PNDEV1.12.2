...
public class BlockAlethopterisStrobilusTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:alethopteris_strobilus_top")
	public static final Block block = null;
	public BlockAlethopterisStrobilusTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.alethopteris_strobilus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("alethopteris_strobilus_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:alethopteris_strobilus_top", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_alethopteris_strobilus_top");
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockAlethopterisStrobilus.block, (int) (1));
		}
...
//			}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockAlethopterisStrobilus.block) {
