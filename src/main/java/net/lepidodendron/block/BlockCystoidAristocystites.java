...
public class BlockCystoidAristocystites extends ElementsLepidodendronMod.ModElement {
	...
	public BlockCystoidAristocystites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cystoid_aristocystites);
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pndietCrinoid", BlockCystoidAristocystites.block);
		OreDictionary.registerOre("holdfastDrops", BlockCystoidAristocystites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CYSTOID_ARISTOCYSTITES;
		}
