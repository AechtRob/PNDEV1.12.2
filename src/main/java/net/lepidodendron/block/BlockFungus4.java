...
public class BlockFungus4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_4")
	public static final Block block = null;
	public BlockFungus4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_4"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_4", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus4.BlockCustom.SPREADABLE).ignore(BlockFungus4.BlockCustom.NORTH).ignore(BlockFungus4.BlockCustom.SOUTH).ignore(BlockFungus4.BlockCustom.EAST).ignore(BlockFungus4.BlockCustom.WEST).ignore(BlockFungus4.BlockCustom.UP).ignore(BlockFungus4.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus4", BlockFungus4.block);
		OreDictionary.registerOre("itemFungus", BlockFungus4.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus4.block);
	}
