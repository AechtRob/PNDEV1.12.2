...
public class BlockDominicanAmberBrickSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dominican_amber_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:dominican_amber_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockDominicanAmberBrickSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dominican_amber_brick_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dominican_amber_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("dominican_amber_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dominican_amber_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_dominican_amber_brick_slab");
