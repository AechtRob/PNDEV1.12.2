...
public class BlockXenocladiaStemNW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:xenocladia_stem_nw")
	public static final Block block = null;
	public BlockXenocladiaStemNW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.xenocladia_stem_nw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("xenocladia_stem_nw"));
	...
	//			new ModelResourceLocation("lepidodendron:xenocladia_stem_nw", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_xenocladia_stem_nw");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockXenocladiaStemNE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
