...
public class BlockCharniodiscus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:charniodiscus")
	public static final Block block = null;
	public BlockCharniodiscus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.charniodiscus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("charniodiscus"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("holdfastDrops", BlockCharniodiscus.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:charniodiscus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCharniodiscus.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_charniodiscus");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CHARNIODISCUS;
		}
