...
public class BlockCornusmas extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas")
	public static final Block block = null;
	public BlockCornusmas(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cornusmas", BlockCornusmas.block);
		OreDictionary.registerOre("plantPrehistoric", BlockCornusmas.block);
		OreDictionary.registerOre("plant", BlockCornusmas.block);
	}
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					worldIn.setBlockState(pos, BlockCornusmasFlower.block.getDefaultState(), 3);
					worldIn.setBlockState(pos.up(), BlockCornusmas2Flower.block.getDefaultState(), 3);
					worldIn.setBlockState(pos.up(2), BlockCornusmas3Flower.block.getDefaultState(), 3);
				}
			}
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Propagation: Produces harvestable berries on a flowering and fruiting cycle");}
