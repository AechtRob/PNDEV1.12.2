...
public class BlockSandstonePangaeanSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_slab_pangaean")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstone_slab_pangaean"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sandstone_slab_pangaean_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandstone_slab_pangaean", "inventory"));
	}
