...
public class BlockSpaciinodum extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spaciinodum")
	public static final Block block = null;
	public BlockSpaciinodum(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.spaciinodum);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:spaciinodum", BlockSpaciinodum.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_spaciinodum");
			setRegistryName("spaciinodum");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SPACIINODUM;
		}
