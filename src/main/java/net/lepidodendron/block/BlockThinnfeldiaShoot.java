...
public class BlockThinnfeldiaShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thinnfeldia_shoot_worldgen")
	public static final Block block = null;
	public BlockThinnfeldiaShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thinnfeldia_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thinnfeldia_shoot_worldgen"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:thinnfeldia_shoot", BlockThinnfeldiaShoot.block);
		//OreDictionary.registerOre("plantPrehistoric", BlockThinnfeldiaShoot.block);
		//OreDictionary.registerOre("plant", BlockThinnfeldiaShoot.block);
	}
	...
	public static class BlockCustom extends SeedSporeFacingBlockBase implements IAdvancementGranter, IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_thinnfeldia_shoot_worldgen");
