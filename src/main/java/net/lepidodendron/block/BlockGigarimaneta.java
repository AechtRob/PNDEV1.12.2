...
public class BlockGigarimaneta extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigarimaneta")
	public static final Block block = null;
	public BlockGigarimaneta(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigarimaneta);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigarimaneta"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		GameRegistry.registerTileEntity(BlockGigarimaneta.TileEntityCustom.class, "lepidodendron:tileentitygigarimaneta");
		OreDictionary.registerOre("staticdnaPNlepidodendron:gigarimaneta", BlockGigarimaneta.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:gigarimaneta", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockGigarimaneta.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_gigarimaneta");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_GIGARIMANETA;
		}
