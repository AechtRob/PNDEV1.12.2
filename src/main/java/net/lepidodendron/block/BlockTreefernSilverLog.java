...
public class BlockTreefernSilverLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silver_treefern_log")
	public static final Block block = null;
	public BlockTreefernSilverLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.silver_treefern_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("silver_treefern_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:silver_treefern_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNTreefernSilver", BlockTreefernSilverLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_silver_treefern_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockTreefernSilverShoot.block) || (block1 == BlockTreefernSilverShootPlaceable.block)) {
				leavesattached = true;
	    	}
