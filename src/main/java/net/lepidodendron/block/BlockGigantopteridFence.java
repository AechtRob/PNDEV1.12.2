...
public class BlockGigantopteridFence extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantopterid_fence_thin"));
	...
	public static class BlockCustom extends BlockFence {
		public BlockCustom() {
			...
			setTranslationKey("pf_gigantopterid_fence_thin");
