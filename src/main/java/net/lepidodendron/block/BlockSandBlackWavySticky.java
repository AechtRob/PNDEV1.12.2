...
public class BlockSandBlackWavySticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sand_black_wavy_sticky")
	public static final Block block = null;
	public BlockSandBlackWavySticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sand_black_wavy_sticky);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sand_black_wavy_sticky"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sand_black_wavy_sticky", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements ISustainsPlantType {
		public BlockCustom() {
			...
			setHardness(0.5F);
			setResistance(0.5F);
			setTranslationKey("pf_sand_black_wavy_sticky");
