...
public class BlockPhoenicopsisBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phoenicopsis_bench")
	public static final Block block = null;
	public BlockPhoenicopsisBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phoenicopsis_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("phoenicopsis_bench"));
