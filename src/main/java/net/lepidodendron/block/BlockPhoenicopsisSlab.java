...
public class BlockPhoenicopsisSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phoenicopsis_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:phoenicopsis_slab_double")
	public static final Block block_slab_double = null;
	public BlockPhoenicopsisSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phoenicopsis_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("phoenicopsis_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("phoenicopsis_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:phoenicopsis_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_phoenicopsis_slab");
