...
public class BlockRetiophyllia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:retiophyllia")
	public static final Block block = null;
	public BlockRetiophyllia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.retiophyllia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("retiophyllia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:retiophyllia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockRetiophyllia.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:retiophyllia", BlockRetiophyllia.block);
		OreDictionary.registerOre("itemSponge", BlockRetiophyllia.block);
		OreDictionary.registerOre("pndietSponge", BlockRetiophyllia.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_retiophyllia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_RETIOPHYLLIA;
		}
