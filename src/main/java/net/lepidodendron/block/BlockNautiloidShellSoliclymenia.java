...
public class BlockNautiloidShellSoliclymenia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_soliclymenia")
	public static final Block block = null;
	public BlockNautiloidShellSoliclymenia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_soliclymenia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_soliclymenia"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellSoliclymenia.TileEntityCustom.class, "lepidodendron:tileentityshell_soliclymenia");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_soliclymenia", BlockNautiloidShellSoliclymenia.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_soliclymenia", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_soliclymenia");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellSoliclymenia.TileEntityCustom();
		}

		public BlockNautiloidShellSoliclymenia.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellSoliclymenia.TileEntityCustom();
		}
