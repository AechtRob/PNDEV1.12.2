...
public class BlockBivalveAgriopleura extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_agriopleura")
	public static final Block block = null;
	public BlockBivalveAgriopleura(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_agriopleura);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_agriopleura"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_agriopleura", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveAgriopleura.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_agriopleura", BlockBivalveAgriopleura.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveAgriopleura.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveAgriopleura.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveAgriopleura.block);
	}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveAgriopleura.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_agriopleura");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_AGRIOPLEURA;
		}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: Elevator Rudist Bivalve");
				tooltip.add("Periods: Early - Late Cretaceous");}
