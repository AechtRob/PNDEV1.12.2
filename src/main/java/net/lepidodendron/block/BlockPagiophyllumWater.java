...
public class BlockPagiophyllumWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pagiophyllum")
	public static final Block block = null;
	public BlockPagiophyllumWater(ElementsLepidodendronMod instance) {
	...
	public static class BlockCustom extends BlockLilyPad {
		public BlockCustom() {
			...
			setLightOpacity(0);
			setCreativeTab(null);
			setTranslationKey("pf_pagiophyllum");
			setRegistryName("pagiophyllum");
		...
		public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
			...
			worldIn.setBlockState(pos.up(), BlockPagiophyllumBottom.block.getDefaultState(),2);
			worldIn.setBlockState(pos.up(2), BlockPagiophyllumTop.block.getDefaultState(),2);
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.getBlockState(pos.up()).getBlock() != BlockPagiophyllumBottom.block) {
