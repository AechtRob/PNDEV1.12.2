...
public class BlockGigantopteridClimbingShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigantopterid_climbing_shoot")
	public static final Block block = null;
	public BlockGigantopteridClimbingShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantopterid_climbing_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantopterid_climbing_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:gigantopterid_climbing_shoot", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:gigantopterid_climbing_sapling", BlockGigantopteridClimbingShootPlaceable.block);
		OreDictionary.registerOre("plantPrehistoric", BlockGigantopteridClimbingShootPlaceable.block);
		OreDictionary.registerOre("plant", BlockGigantopteridClimbingShootPlaceable.block);
		OreDictionary.registerOre("treeLeaves", BlockGigantopteridClimbingShootPlaceable.block);
	}
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_gigantopterid_climbing_shoot");
