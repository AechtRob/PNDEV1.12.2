...
public class BlockPsaroniusLeavesSmallPlaceable extends ElementsLepidodendronMod.ModElement {
	...
	public BlockPsaroniusLeavesSmallPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psaronius_leaves_small);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("psaronius_leaves_small"));
