...
public class BlockTallAraucariaFruitBlock extends ElementsLepidodendronMod.ModElement {
	...
	public BlockTallAraucariaFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mirabilis_fruit_block);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockTallAraucariaFruitBlock.block);
	}
	...
	public static class BlockCustom extends BlockFalling implements IShearable {
		public BlockCustom() {
			...
			setTranslationKey("pf_mirabilis_fruit_block");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemTallAraucariaNuts.block, (int) (3)));
