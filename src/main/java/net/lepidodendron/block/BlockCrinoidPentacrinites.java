...
public class BlockCrinoidPentacrinites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_pentacrinites")
	public static final Block block = null;
	public BlockCrinoidPentacrinites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_pentacrinites);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_pentacrinites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCrinoidPentacrinites.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_pentacrinites", BlockCrinoidPentacrinites.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidPentacrinites.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidPentacrinites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_pentacrinites");
			setRegistryName("crinoid_pentacrinites");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_PENTACRINITES;
		}
