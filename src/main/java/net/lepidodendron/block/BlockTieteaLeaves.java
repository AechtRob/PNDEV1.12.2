...
public class BlockTieteaLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tietea_leaves_worldgen")
	public static final Block block = null;
	public BlockTieteaLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tietea_leaves_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tietea_leaves_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Tietea_leaves_worldgen", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_tietea_leaves_worldgen");
