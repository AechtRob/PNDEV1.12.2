...
public class BlockWollemiSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wollemi_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:wollemi_slab_double")
	public static final Block block_slab_double = null;
	public BlockWollemiSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wollemi_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wollemi_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("wollemi_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:wollemi_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_wollemi_slab");
