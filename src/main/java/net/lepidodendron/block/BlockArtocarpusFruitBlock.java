...
public class BlockArtocarpusFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:artocarpus_fruit_block")
	public static final Block block = null;
	public BlockArtocarpusFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.artocarpus_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("artocarpus_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockArtocarpusFruitBlock.block);
	}
	...
	public static class BlockCustom extends BlockFalling implements IShearable {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			if ((worldIn.getBlockState(pos.up())).getBlock() != BlockArtocarpusLeaves.block) {
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			if (LepidodendronConfig.doPropagation) {
				drops.add(new ItemStack(ItemArtocarpusSeeds.block, (int) (3)));
				}
			else {
