...
public class BlockSigillariaStrobilus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sigillaria_strobilus")
	public static final Block block = null;
	public BlockSigillariaStrobilus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sigillaria_strobilus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sigillaria_strobilus"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "lepidodendron:tileentitysigillaria_strobilus");
	}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
...

			{
				...
				ProcedureSigillariaStrobilusNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
