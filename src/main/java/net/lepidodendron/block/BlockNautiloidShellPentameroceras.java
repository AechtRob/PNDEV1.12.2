...
public class BlockNautiloidShellPentameroceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_pentameroceras")
	public static final Block block = null;
	public BlockNautiloidShellPentameroceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_pentameroceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_pentameroceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellPentameroceras.TileEntityCustom.class, "lepidodendron:tileentityshell_pentameroceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_pentameroceras", BlockNautiloidShellPentameroceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_pentameroceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_pentameroceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellPentameroceras.TileEntityCustom();
		}

		public BlockNautiloidShellPentameroceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellPentameroceras.TileEntityCustom();
		}
