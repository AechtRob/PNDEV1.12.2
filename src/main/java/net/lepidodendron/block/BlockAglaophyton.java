...
public class BlockAglaophyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:aglaophyton")
	public static final Block block = null;
	public BlockAglaophyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.aglaophyton);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:aglaophyton", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:aglaophyton", BlockAglaophyton.block);
		OreDictionary.registerOre("plantPrehistoric", BlockAglaophyton.block);
		OreDictionary.registerOre("plant", BlockAglaophyton.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_aglaophyton");
			setRegistryName("aglaophyton");
		}

		@Override
		public IBlockState getPotState() {
			return BlockAglaophytonSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockAglaophytonSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
