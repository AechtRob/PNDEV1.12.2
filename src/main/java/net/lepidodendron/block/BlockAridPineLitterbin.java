...
public class BlockAridPineLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arid_pine_litterbin")
	public static final Block block = null;
	public BlockAridPineLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arid_pine_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("arid_pine_litterbin"));
