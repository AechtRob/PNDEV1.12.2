...
public class BlockProtolepidodendropsisSapling extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("protolepidodendropsis_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:protolepidodendropsis_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:protolepidodendropsis_sapling", BlockProtolepidodendropsisSapling.block);
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				if (world.isAirBlock(pos.up())) {
					world.setBlockState(pos, BlockProtolepidodendropsis.block.getDefaultState(), 3);
					world.setBlockState(pos.up(), BlockProtolepidodendropsis.block.getDefaultState(), 3);
				}
