...
public class BlockFenestellaGiantOrange extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_giant_orange")
	public static final Block block = null;
	public BlockFenestellaGiantOrange(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_giant_orange);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_giant_orange"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_giant_orange", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestellaGiantOrange.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:fenestella_giant_orange", BlockFenestellaGiantOrange.block);
		OreDictionary.registerOre("pndietEncruster", BlockFenestellaGiantOrange.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_giant_orange");
