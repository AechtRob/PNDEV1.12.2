...
import net.lepidodendron.item.ItemZirconGlassDoorIronItem;
...
public class BlockZirconGlassDoorIron extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:zircon_glass_door_iron")
	public static final Block block = null;
	public BlockZirconGlassDoorIron(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.zircon_glass_door_iron);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zircon_glass_door_iron"));
	...
	public static class BlockCustom extends BlockDoor {
		public BlockCustom() {
			...
			setTranslationKey("pf_zircon_glass_door_iron");
		...
		{
			return new ItemStack(ItemZirconGlassDoorIronItem.block, (int) (1));
		}
		...
		{
			return "tile.zircon_glass_door_iron.name";
		}

		@Override
		public String getLocalizedName()
		{
			return I18n.translateToLocal("item.zircon_glass_door_iron_item.name");
		}

		@Override
		public Item getItemDropped(IBlockState state, Random rand, int fortune)
		{
			return state.getValue(HALF) == EnumDoorHalf.UPPER ? Items.AIR : (new ItemStack(ItemZirconGlassDoorIronItem.block, (int) (1))).getItem();
		}
