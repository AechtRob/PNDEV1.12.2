...
public class BlockDavidiaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:davidia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:davidia_slab_double")
	public static final Block block_slab_double = null;
	public BlockDavidiaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.davidia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("davidia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("davidia_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockDavidiaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:davidia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_davidia_slab");
