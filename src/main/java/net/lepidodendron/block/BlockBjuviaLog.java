...
public class BlockBjuviaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bjuvia_log")
	public static final Block block = null;
	public BlockBjuviaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bjuvia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bjuvia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:bjuvia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:bjuvia_sapling", BlockBjuviaLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockBjuviaShoot.block) || (block1 == BlockBjuviaShootPlaceable.block) || (block1 == BlockBjuviaShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
