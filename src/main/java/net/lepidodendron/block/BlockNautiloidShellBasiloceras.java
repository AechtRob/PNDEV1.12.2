...
public class BlockNautiloidShellBasiloceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_basiloceras")
	public static final Block block = null;
	public BlockNautiloidShellBasiloceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_basiloceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_basiloceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellBasiloceras.TileEntityCustom.class, "lepidodendron:tileentityshell_basiloceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_basiloceras", BlockNautiloidShellBasiloceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_basiloceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_basiloceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellBasiloceras.TileEntityCustom();
		}

		public BlockNautiloidShellBasiloceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellBasiloceras.TileEntityCustom();
		}
