...
public class BlockThucydia3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thucydia3")
	public static final Block block = null;
	public BlockThucydia3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thucydia3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thucydia3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:thucydia3", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_thucydia3");
