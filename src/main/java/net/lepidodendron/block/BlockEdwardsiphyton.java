...
public class BlockEdwardsiphyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:edwardsiphyton")
	public static final Block block = null;
	public BlockEdwardsiphyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.edwardsiphyton);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("edwardsiphyton"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("staticdnaPNlepidodendron:edwardsiphyton", BlockEdwardsiphyton.block);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:edwardsiphyton", "inventory"));
	}
	public static class BlockCustom extends SeedSporeFacingBlockBase implements net.minecraftforge.common.IShearable, IAdvancementGranter, ILayableMoss {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_edwardsiphyton");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_EDWARDSIPHYTON;
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockEdwardsiphyton.TileEntityCustom();
		}

		public BlockEdwardsiphyton.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockEdwardsiphyton.TileEntityCustom();
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Block planted() {
			return BlockEdwardsiphyton.block;
		}
