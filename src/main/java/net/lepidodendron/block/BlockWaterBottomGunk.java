...
public class BlockWaterBottomGunk extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:underwater_gunk")
	public static final Block block = null;
	public BlockWaterBottomGunk(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.underwater_gunk);
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietMicrobial", BlockWaterBottomGunk.block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("underwater_gunk"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:underwater_gunk", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockWaterBottomGunk.LEVEL).build());
	}

	@Override
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		
		int weight = LepidodendronConfigPlants.weightUnderwaterGunk;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genUnderwaterGunkBlacklistBiomes)) {
		...
		if ((dimID == LepidodendronConfig.dimOrdovician)
			...
			multiplier = 18;
			BiomeOrdovician biomeOrdovician = (BiomeOrdovician) biome;
			if (biomeOrdovician.getBiomeType() == EnumBiomeTypeOrdovician.Bog) {
				multiplier = 4;
            }
		}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_underwater_gunk");
