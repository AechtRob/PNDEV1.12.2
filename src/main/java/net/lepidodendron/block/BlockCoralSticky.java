...
public class BlockCoralSticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_sticky")
	public static final Block block = null;
	public BlockCoralSticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_sticky);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_sticky"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietCoral", BlockCoralSticky.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_sticky");
