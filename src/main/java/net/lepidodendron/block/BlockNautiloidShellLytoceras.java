...
public class BlockNautiloidShellLytoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_lytoceras")
	public static final Block block = null;
	public BlockNautiloidShellLytoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_lytoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_lytoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellLytoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_lytoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_lytoceras", BlockNautiloidShellLytoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_lytoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_lytoceras");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0.15D, 0.0D, 0.15D, 0.95D, 0.45D, 0.95D);
		}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellLytoceras.TileEntityCustom();
		}

		public BlockNautiloidShellLytoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellLytoceras.TileEntityCustom();
		}
