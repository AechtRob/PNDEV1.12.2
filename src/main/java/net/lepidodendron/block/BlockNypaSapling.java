...
public class BlockNypaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nypa_sapling")
	public static final Block block = null;
	public BlockNypaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nypa_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nypa_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nypa_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nypa_sapling", BlockNypaSapling.block);
		OreDictionary.registerOre("treeSapling", BlockNypaSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockNypaSapling.block);
		OreDictionary.registerOre("plant", BlockNypaSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_nypa_sapling");
