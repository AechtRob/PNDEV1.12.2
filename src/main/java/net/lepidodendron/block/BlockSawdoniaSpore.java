...
public class BlockSawdoniaSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sawdonia_spore")
	public static final Block block = null;
	public BlockSawdoniaSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sawdonia_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		//ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				//new ModelResourceLocation("lepidodendron:sawdonia_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_sawdonia_spore");
			setRegistryName("sawdonia_spore");
		}
