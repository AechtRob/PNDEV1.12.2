...
public class BlockSurangephyllum extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:surangephyllum")
	public static final Block block = null;
	public BlockSurangephyllum(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.surangephyllum);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("surangephyllum"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:surangephyllum", BlockSurangephyllum.block);
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_surangephyllum");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SURANGEPHYLLUM;
		}
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockSurangephyllum.block, (int) (1)));
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, java.util.Random rand, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				return Item.getItemFromBlock(BlockSurangephyllum.block);
			}
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isAirBlock(pos.down())) {
				...
				if ((Math.random() > 0.66) && (!LepidodendronConfig.doPropagation)) {
					...
					if (!world.isRemote) {
						EntityItem entityToSpawn = new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockSurangephyllum.block, (int) (1)));
						entityToSpawn.setPickupDelay(10);
				...
				if (block != BlockSurangephyllumTop.block) {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockSurangephyllumTop.block.getDefaultState(), 3);
