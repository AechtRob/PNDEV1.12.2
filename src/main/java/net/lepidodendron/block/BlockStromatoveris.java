...
public class BlockStromatoveris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stromatoveris")
	public static final Block block = null;
	public BlockStromatoveris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stromatoveris);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stromatoveris"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("staticdnaPNstromatoveris", BlockStromatoveris.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stromatoveris", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockStromatoveris.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_stromatoveris");
