...
public class BlockCrinoidCrotalocrinites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_crotalocrinites")
	public static final Block block = null;
	public BlockCrinoidCrotalocrinites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_crotalocrinites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("crinoid_crotalocrinites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_crotalocrinites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCrinoidCrotalocrinites.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_crotalocrinites", BlockCrinoidCrotalocrinites.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidCrotalocrinites.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidCrotalocrinites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_crotalocrinites");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_CROTALOCRINITES;
		}
