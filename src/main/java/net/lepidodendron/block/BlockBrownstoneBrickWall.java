...
public class BlockBrownstoneBrickWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:brownstone_brick_wall")
	public static final Block block = null;
	public BlockBrownstoneBrickWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.brownstone_brick_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brownstone_brick_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:brownstone_brick_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_brownstone_brick_wall");
