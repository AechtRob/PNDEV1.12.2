...
public class BlockLyginopterisStemNW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lyginopteris_stem_nw")
	public static final Block block = null;
	public BlockLyginopterisStemNW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lyginopteris_stem_nw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lyginopteris_stem_nw"));
	...
	//			new ModelResourceLocation("lepidodendron:lyginopteris_stem_nw", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_lyginopteris_stem_nw");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if (state.getValue(FACING) == EnumFacing.NORTH) {
				...
				if (block == BlockLyginopterisStemSE.block || block == BlockLyginopterisStemNE.block 
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockLyginopterisStemNE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockLyginopterisStemNE.block, (int) (1));
        }
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockLyginopterisStemNE.block, (int) (1)));
		}
