...
public class BlockNautiloidShellAnthracoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_anthracoceras")
	public static final Block block = null;
	public BlockNautiloidShellAnthracoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_anthracoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_anthracoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAnthracoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_anthracoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_anthracoceras", BlockNautiloidShellAnthracoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_anthracoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_anthracoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAnthracoceras.TileEntityCustom();
		}

		public BlockNautiloidShellAnthracoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAnthracoceras.TileEntityCustom();
		}
