...
public class BlockArchaeocidaris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:archaeocidaris_item")
	public static final Block block = null;
	public BlockArchaeocidaris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.archaeocidaris_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockArchaeocidaris.TileEntityCustom.class, "lepidodendron:tileentityarchaeocidaris_item");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/archaeocidaris_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockArchaeocidaris.TileEntityCustom();
		}

		public BlockArchaeocidaris.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockArchaeocidaris.TileEntityCustom();
		}
