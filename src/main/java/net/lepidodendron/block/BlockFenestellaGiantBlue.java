...
public class BlockFenestellaGiantBlue extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_giant_blue")
	public static final Block block = null;
	public BlockFenestellaGiantBlue(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_giant_blue);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_giant_blue"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_giant_blue", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestellaGiantBlue.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:fenestella_giant_blue", BlockFenestellaGiantBlue.block);
		OreDictionary.registerOre("pndietEncruster", BlockFenestellaGiantBlue.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_giant_blue");
