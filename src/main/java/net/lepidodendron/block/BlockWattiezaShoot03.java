...
public class BlockWattiezaShoot03 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wattieza_shoot_03")
	public static final Block block = null;
	public BlockWattiezaShoot03(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wattieza_shoot_03);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wattieza_shoot_03"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:wattieza_shoot_03", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_wattieza_shoot_03");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockWattiezaShoot02.block) {
				...
				if (world.getBlockState(pos.north(2)).getBlock() == BlockWattiezaShootSide03.block) {
					world.scheduleUpdate(pos.north(2), world.getBlockState(pos.north(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.south(2)).getBlock() == BlockWattiezaShootSide03.block) {
					world.scheduleUpdate(pos.south(2), world.getBlockState(pos.south(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.east(2)).getBlock() == BlockWattiezaShootSide03.block) {
					world.scheduleUpdate(pos.east(2), world.getBlockState(pos.east(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.west(2)).getBlock() == BlockWattiezaShootSide03.block) {
