...
public class BlockNautiloidShellGoldringia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_goldringia")
	public static final Block block = null;
	public BlockNautiloidShellGoldringia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_goldringia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_goldringia"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellGoldringia.TileEntityCustom.class, "lepidodendron:tileentityshell_goldringia");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_goldringia", BlockNautiloidShellGoldringia.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_goldringia", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_goldringia");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellGoldringia.TileEntityCustom();
		}

		public BlockNautiloidShellGoldringia.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellGoldringia.TileEntityCustom();
		}
