...
public class BlockBrownSponge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:brown_sponge")
	public static final Block block = null;
	public BlockBrownSponge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.brown_sponge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brown_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:brown_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBrownSponge.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:brown_sponge", BlockBrownSponge.block);
		OreDictionary.registerOre("itemSponge", BlockBrownSponge.block);
		OreDictionary.registerOre("pndietSponge", BlockBrownSponge.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightBrownSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genBrownSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genBrownSpongeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_brown_sponge");
