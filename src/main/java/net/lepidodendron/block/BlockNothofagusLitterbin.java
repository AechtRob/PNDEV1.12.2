...
public class BlockNothofagusLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nothofagus_litterbin")
	public static final Block block = null;
	public BlockNothofagusLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nothofagus_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nothofagus_litterbin"));
