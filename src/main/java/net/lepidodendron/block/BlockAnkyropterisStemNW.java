...
public class BlockAnkyropterisStemNW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ankyropteris_stem_nw")
	public static final Block block = null;
	public BlockAnkyropterisStemNW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ankyropteris_stem_nw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ankyropteris_stem_nw"));
	...
	//			new ModelResourceLocation("lepidodendron:ankyropteris_stem_nw", "inventory"));
	//}
	public static class BlockCustom extends SeedSporeFacingBlockBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_ankyropteris_stem_nw");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockAnkyropterisStemNE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
