...
public class BlockCooksonia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cooksonia")
	public static final Block block = null;
	public BlockCooksonia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cooksonia);
	}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockCooksoniaSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
