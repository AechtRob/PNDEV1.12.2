...
public class BlockPebblestoneWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pebblestone_wall")
	public static final Block block = null;
	public BlockPebblestoneWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pebblestone_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pebblestone_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pebblestone_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_pebblestone_wall");
