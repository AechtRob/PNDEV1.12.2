...
public class BlockStonePeridotiteSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:peridotite_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:peridotite_slab_double")
	public static final Block block_slab_double = null;
	public BlockStonePeridotiteSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.peridotite_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("peridotite_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("peridotite_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:peridotite_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.RED);
			setTranslationKey("pf_peridotite_slab");
