...
public class BlockNautiloidShellKosmoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_kosmoceras")
	public static final Block block = null;
	public BlockNautiloidShellKosmoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_kosmoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_kosmoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellKosmoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_kosmoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_kosmoceras", BlockNautiloidShellKosmoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_kosmoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_kosmoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellKosmoceras.TileEntityCustom();
		}

		public BlockNautiloidShellKosmoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellKosmoceras.TileEntityCustom();
		}
