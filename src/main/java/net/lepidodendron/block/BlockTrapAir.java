...
import net.lepidodendron.world.biome.TrapAirSpawner;
...
public class BlockTrapAir extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends Block {
		...
		public static void releaseTrapped(World world, BlockPos pos) {
			...
			List<EntityLivingBase> listcheckspace = world.<EntityLivingBase>getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(pos.up()));
			if (!listcheckspace.isEmpty()) {
				return;
			}
		...
		public void makeTrapped(World world, BlockPos pos) {
			...
			if (tileEntity instanceof TileEntityTrapAir) {
				...
				TrapAirSpawner.executeProcedure(world, pos.up(), world.rand, stack);
			}
		}
