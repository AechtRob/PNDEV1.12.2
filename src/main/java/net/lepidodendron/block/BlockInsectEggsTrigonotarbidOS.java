...
public class BlockInsectEggsTrigonotarbidOS extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends BlockInsectEggs {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			...
			if (!(worldIn.isRemote)) {
				EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraTrigonotarbid_Palaeotarbus.class).toString(), "", (double)pos.getX() , (double)pos.getY(), (double)pos.getZ());
			}
