...
public class BlockEmplectopterisSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:emplectopteris_sapling")
	public static final Block block = null;
	public BlockEmplectopterisSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.emplectopteris_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("emplectopteris_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:emplectopteris_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:emplectopteris_sapling", BlockEmplectopterisSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_emplectopteris_sapling");
