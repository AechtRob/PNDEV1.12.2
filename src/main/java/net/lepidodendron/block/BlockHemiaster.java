...
public class BlockHemiaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hemiaster_item")
	public static final Block block = null;
	public BlockHemiaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hemiaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hemiaster_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockHemiaster.TileEntityCustom.class, "lepidodendron:tileentityhemiaster_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_hemiaster", BlockHemiaster.block);
		OreDictionary.registerOre("pndietCrinoid", BlockHemiaster.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/hemiaster_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_hemiaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockHemiaster.TileEntityCustom();
		}

		public BlockHemiaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockHemiaster.TileEntityCustom();
		}
