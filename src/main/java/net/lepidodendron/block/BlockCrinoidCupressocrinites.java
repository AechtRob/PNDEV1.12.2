...
public class BlockCrinoidCupressocrinites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_cupressocrinites")
	public static final Block block = null;
	public BlockCrinoidCupressocrinites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_cupressocrinites);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_cupressocrinites", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNCrinoidCupressocrinites", BlockCrinoidCupressocrinites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_cupressocrinites");
			setRegistryName("crinoid_cupressocrinites");
		}
