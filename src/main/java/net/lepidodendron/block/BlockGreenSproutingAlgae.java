...
public class BlockGreenSproutingAlgae extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightGreenSproutingAlgae;
		...
		if (!matchBiome(biome, LepidodendronConfig.genGreenSproutingAlgaeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genGreenSproutingAlgaeOverrideBiomes))
			biomeCriteria = true;
