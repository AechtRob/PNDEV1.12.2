...
public class BlockCrinoidJimbacrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_jimbacrinus")
	public static final Block block = null;
	public BlockCrinoidJimbacrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_jimbacrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_jimbacrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNCrinoidJimbacrinus", BlockCrinoidJimbacrinus.block);
	}
			...
			(new WorldGenReed() {
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 6; ++i) {
						...
						if (((BlockCustom) block).isWaterBlock(world, blockpos1) && ((BlockCustom) block).isWaterBlock(world, blockpos1.up()) && ((BlockCustom) block).isWaterBlock(world, blockpos1.up(2)) && i11 <= (world.getSeaLevel()-20)) {
