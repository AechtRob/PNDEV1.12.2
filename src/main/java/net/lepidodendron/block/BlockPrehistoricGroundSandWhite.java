...
public class BlockPrehistoricGroundSandWhite extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_prehistoric_ground_cover_white")
	public static final Block block = null;
	public BlockPrehistoricGroundSandWhite(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_prehistoric_ground_cover_white);
	}
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandy_prehistoric_ground_cover_white"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_prehistoric_ground_cover_white", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling implements IGrowable {
		public BlockCustom() {
			super(Material.SAND);
			setTranslationKey("pf_sandy_prehistoric_ground_cover_white");
	    ...
	    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        if (!worldIn.isRemote)
	        {
	            ...
	            {
	                worldIn.setBlockState(pos, BlockSandWhite.block.getDefaultState());
	            }
	            else
	            {
					...
					else
					{
		                ...
		                if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
		                {
		                    for (int i = 0; i < 4; ++i)
		                    {
								...
								if (
									(
										((iblockstate1.getBlock() == BlockSandWhite.block)
										)
								...
								)
		                        {
									...
									if (waterCriteria)
		                            	worldIn.setBlockState(blockpos, BlockPrehistoricGroundSandWhite.block.getDefaultState());
		                        }
		                    }
	                    }
	                }
