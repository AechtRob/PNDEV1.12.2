...
public class BlockNypaShoot02 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nypa_shoot_02")
	public static final Block block = null;
	public BlockNypaShoot02(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nypa_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nypa_shoot_02"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:nypa_shoot_02", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_nypa_shoot_02");
...
//				}
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			if (Math.random()>0.8 && Math.random()>0.8) {
					worldIn.setBlockState(pos, BlockNypaShoot02Fruiting.block.getDefaultState(), 3);
			}
		}
