...
public class BlockTreefernBlackShoot03 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:black_treefern_shoot_03")
	public static final Block block = null;
	public BlockTreefernBlackShoot03(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.black_treefern_shoot_03);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("black_treefern_shoot_03"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:black_treefern_shoot_03", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_black_treefern_shoot_03");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockTreefernBlackShoot02.block) {
				...
				if (world.getBlockState(pos.north(2)).getBlock() == BlockTreefernBlackShootSide03.block) {
					world.scheduleUpdate(pos.north(2), world.getBlockState(pos.north(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.south(2)).getBlock() == BlockTreefernBlackShootSide03.block) {
					world.scheduleUpdate(pos.south(2), world.getBlockState(pos.south(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.east(2)).getBlock() == BlockTreefernBlackShootSide03.block) {
					world.scheduleUpdate(pos.east(2), world.getBlockState(pos.east(2)).getBlock(), (int) 0);
				}
				if (world.getBlockState(pos.west(2)).getBlock() == BlockTreefernBlackShootSide03.block) {
