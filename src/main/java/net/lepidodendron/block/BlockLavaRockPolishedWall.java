...
public class BlockLavaRockPolishedWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lava_rock_polished_wall")
	public static final Block block = null;
	public BlockLavaRockPolishedWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lava_rock_polished_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lava_rock_polished_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lava_rock_polished_wall", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_lava_rock_polished_wall");
