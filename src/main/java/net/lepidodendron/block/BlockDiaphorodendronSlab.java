...
public class BlockDiaphorodendronSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:diaphorodendron_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:diaphorodendron_slab_double")
	public static final Block block_slab_double = null;
	public BlockDiaphorodendronSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.diaphorodendron_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("diaphorodendron_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("diaphorodendron_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:diaphorodendron_slab", "inventory"));
	}
