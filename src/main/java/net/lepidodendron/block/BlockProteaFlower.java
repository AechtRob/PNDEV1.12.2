...
import net.lepidodendron.procedure.ProcedureProteaFlowerNeighbourBlockChanges;
...
public class BlockProteaFlower extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:protea_flower")
	public static final Block block = null;
	public BlockProteaFlower(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.protea_flower);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("protea_flower"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "lepidodendron:tileentityprotea_flower");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:protea_flower", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider, net.minecraftforge.common.IShearable {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_protea_flower");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
...

			{
				...
				ProcedureProteaFlowerNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
        ...
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != Item.getItemFromBlock(this)) || !LepidodendronConfig.doPropagation)
	        {
	        	...
	        	if ((new Object() {
		        	...
		        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
						if (Math.random() > 0.4) {
							ItemStack stackSeed = new ItemStack(ItemProtea1Seeds.block, (int) (1));
