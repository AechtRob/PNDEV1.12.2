...
public class BlockZamitesLeavesPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:zamites_leaves")
	public static final Block block = null;
	public BlockZamitesLeavesPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.zamites_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zamites_leaves"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:zamites_leaves", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNzamites_sapling", BlockZamitesLeavesPlaceable.block);
