...
public class BlockTieteaThatch extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tietea_thatch"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tietea_thatch", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_tietea_thatch");
