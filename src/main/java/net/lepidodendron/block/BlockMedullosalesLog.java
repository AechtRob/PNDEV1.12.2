...
public class BlockMedullosalesLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:medullosales_log")
	public static final Block block = null;
	public BlockMedullosalesLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.medullosales_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("medullosales_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:medullosales_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:medullosales_sapling", BlockMedullosalesLog.block);
    ...
    public static final PropertyBool ROOTS = PropertyBool.create("roots");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_MEDULLOSALES;
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        ...
	        if ((Math.random() > 0.66) && (!LepidodendronConfig.doPropagation)) {
				...
				if (!worldIn.isRemote) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockMedullosalesSapling.block, (int) (1)));
