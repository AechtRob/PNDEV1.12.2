...
public class BlockNautiloidShellDiplomoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_diplomoceras")
	public static final Block block = null;
	public BlockNautiloidShellDiplomoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_diplomoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_diplomoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellDiplomoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_diplomoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_diplomoceras", BlockNautiloidShellDiplomoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_diplomoceras", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_diplomoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellDiplomoceras.TileEntityCustom();
		}

		public BlockNautiloidShellDiplomoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellDiplomoceras.TileEntityCustom();
		}
