...
public class BlockGigantospongia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigantospongia")
	public static final Block block = null;
	public BlockGigantospongia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantospongia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantospongia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:gigantospongia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockGigantospongia.LEVEL).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("itemSponge", BlockGigantospongia.block);
		OreDictionary.registerOre("pndietSponge", BlockGigantospongia.block);
	}

	@Override
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		
		int weight = LepidodendronConfigPlants.weightGigantospongia;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genGigantospongiaBlacklistBiomes)) {
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_gigantospongia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_GIGANTOSPONGIA;
		}
