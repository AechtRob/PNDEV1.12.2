...
public class BlockArborea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arborea")
	public static final Block block = null;
	public BlockArborea(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arborea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("arborea"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("dnaPNArborea", BlockArborea.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:arborea", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockArborea.LEVEL).build());
	}
