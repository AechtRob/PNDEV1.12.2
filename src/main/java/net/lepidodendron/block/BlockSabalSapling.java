...
public class BlockSabalSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sabal_sapling")
	public static final Block block = null;
	public BlockSabalSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sabal_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sabal_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sabal_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:sabal_sapling", BlockSabalSapling.block);
		OreDictionary.registerOre("treeSapling", BlockSabalSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockSabalSapling.block);
		OreDictionary.registerOre("plant", BlockSabalSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_sabal_sapling");
