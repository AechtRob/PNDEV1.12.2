...
public class BlockBivalveEpidiceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_epidiceras")
	public static final Block block = null;
	public BlockBivalveEpidiceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_epidiceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_epidiceras"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_epidiceras", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveEpidiceras.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_epidiceras", BlockBivalveEpidiceras.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveEpidiceras.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveEpidiceras.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveEpidiceras.block);
	}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveEpidiceras.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_epidiceras");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_EPIDICERAS;
		}
