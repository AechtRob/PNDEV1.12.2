...
public class BlockBivalveToucasia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_toucasia")
	public static final Block block = null;
	public BlockBivalveToucasia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_toucasia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_toucasia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_toucasia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveToucasia.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_toucasia", BlockBivalveToucasia.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveToucasia.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveToucasia.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveToucasia.block);
	}
					...
					for (int i = 0; i < 1; ++i) {
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								...
								for (EnumFacing enumfacing1 : BlockBivalveToucasia.BlockCustom.FACING.getAllowedValues()) {
									pos1 = blockpos1;
									...
									if (enumfacing1 != EnumFacing.UP && enumfacing1 != EnumFacing.DOWN &&
										...
										world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveToucasia.BlockCustom.FACING, enumfacing1), 2);
										return true;
									}
								}
							}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_toucasia");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_TOUCASIA;
		}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: Clinger Rudist Bivalve");
