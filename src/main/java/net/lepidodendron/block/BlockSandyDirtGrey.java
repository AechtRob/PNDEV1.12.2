...
public class BlockSandyDirtGrey extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_dirt_grey")
	public static final Block block = null;
	public BlockSandyDirtGrey(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_dirt_grey);
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dirt", BlockSandyDirtGrey.block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandy_dirt_grey"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_dirt_grey", "inventory"));
	}

	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.GROUND);
			setTranslationKey("pf_sandy_dirt_grey");
