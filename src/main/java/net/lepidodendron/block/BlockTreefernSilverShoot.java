...
public class BlockTreefernSilverShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:silver_treefern_shoot_worldgen")
	public static final Block block = null;
	public BlockTreefernSilverShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.silver_treefern_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("silver_treefern_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:silver_treefern_shoot_worldgen", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends SeedSporeLeavesBase {
		public BlockCustom() {
			super();
			setTranslationKey("pf_silver_treefern_shoot_worldgen");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.getBlockState(pos.up()).getBlock() != BlockTreefernSilverShoot02.block)
			{
