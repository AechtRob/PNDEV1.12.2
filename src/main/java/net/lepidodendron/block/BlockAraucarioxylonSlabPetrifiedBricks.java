...
public class BlockAraucarioxylonSlabPetrifiedBricks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:araucarioxylon_slab_petrified_bricks")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:araucarioxylon_slab_petrified_bricks_double")
	public static final Block block_slab_double = null;
	public BlockAraucarioxylonSlabPetrifiedBricks(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.araucarioxylon_slab_petrified_bricks);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("araucarioxylon_slab_petrified_bricks"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("araucarioxylon_slab_petrified_bricks_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:araucarioxylon_slab_petrified_bricks", "inventory"));
	}
