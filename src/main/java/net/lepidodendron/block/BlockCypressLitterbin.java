...
public class BlockCypressLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cypress_litterbin")
	public static final Block block = null;
	public BlockCypressLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cypress_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cypress_litterbin"));
