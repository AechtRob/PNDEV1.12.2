...
public class BlockNothia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nothia")
	public static final Block block = null;
	public BlockNothia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nothia);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nothia", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nothia", BlockNothia.block);
		OreDictionary.registerOre("plantPrehistoric", BlockNothia.block);
		OreDictionary.registerOre("plant", BlockNothia.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_nothia");
			setRegistryName("nothia");
		}

		@Override
		public IBlockState getPotState() {
			return BlockNothiaSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockNothiaSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
