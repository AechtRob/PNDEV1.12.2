...
public class BlockTempskyaLeavesPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tempskya_leaves")
	public static final Block block = null;
	public BlockTempskyaLeavesPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tempskya_leaves);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tempskya_leaves"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:tempskya_leaves", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNTempskya", BlockTempskyaLeavesPlaceable.block);
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public Block planted() {
			return BlockTempskyaSapling.block;
		}
