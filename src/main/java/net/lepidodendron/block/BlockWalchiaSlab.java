...
public class BlockWalchiaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:walchia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:walchia_slab_double")
	public static final Block block_slab_double = null;
	public BlockWalchiaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.walchia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("walchia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("walchia_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:walchia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_walchia_slab");
