...
public class BlockNamapoikia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:namapoikia")
	public static final Block block = null;
	public BlockNamapoikia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.namapoikia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("namapoikia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:namapoikia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNamapoikia.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_namapoikia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_NAMAPOIKIA;
		}
