...
public class BlockThylacocercus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thylacocercus")
	public static final Block block = null;
	public BlockThylacocercus(ElementsLepidodendronMod instance) { super(instance, LepidodendronSorter.thylacocercus); }

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thylacocercus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:thylacocercus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockThylacocercus.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:thylacocercus", BlockThylacocercus.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int minWaterDepth = 20;
		int maxWaterDepth = 200;
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 64; ++i) {
						...
						if (biome instanceof BiomeCambrian) {
							era = biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cambrian_estuary");
						}
						if (!era) {
							continue;
						}
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockThylacocercus.BlockCustom.FACING, enumfacing), 2);
									return true;
								} else {
									for (EnumFacing enumfacing1 : BlockThylacocercus.BlockCustom.FACING.getAllowedValues()) {
										pos1 = blockpos1;
										...
										if (enumfacing1 != EnumFacing.UP && enumfacing1 != EnumFacing.DOWN &&
											...
											world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockThylacocercus.BlockCustom.FACING, enumfacing1), 2);
											return true;
										}
									}
								}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_thylacocercus");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_THYLACOCERCUS;
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: Enigmatic organism");
