...
public class BlockNautiloidShellJeppssonoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_jeppssonoceras")
	public static final Block block = null;
	public BlockNautiloidShellJeppssonoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_jeppssonoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_jeppssonoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellJeppssonoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_jeppssonoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_jeppssonoceras", BlockNautiloidShellJeppssonoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_jeppssonoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_jeppssonoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellJeppssonoceras.TileEntityCustom();
		}

		public BlockNautiloidShellJeppssonoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellJeppssonoceras.TileEntityCustom();
		}
