...
public class BlockPleuromeiaStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pleuromeia_stem")
	public static final Block block = null;
	public BlockPleuromeiaStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pleuromeia_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pleuromeia_stem"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:pleuromeia_sapling", BlockPleuromeiaStem.block);
    ...
    public static final PropertyBool ATTACHMENT = PropertyBool.create("attachment");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if ((block1 == BlockPleuromeiaShoot.block) || (block1 == BlockPleuromeiaShootPlaceable.block)) {
