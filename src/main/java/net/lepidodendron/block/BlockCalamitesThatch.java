...
public class BlockCalamitesThatch extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calamites_thatch")
	public static final Block block = null;
	public BlockCalamitesThatch(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calamites_thatch);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calamites_thatch"));
