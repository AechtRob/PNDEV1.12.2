...
public class BlockNereocystisKelp extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nereocystis_kelp")
	public static final Block block = null;
	public BlockNereocystisKelp(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nereocystis_kelp);
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("holdfastDrops", BlockNereocystisKelp.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nereocystis_kelp", "inventory"));
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int weight = LepidodendronConfigPlants.weightNereocystis;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genNereocystisBlacklistBiomes)) {
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 30; ++i) {
						...
						if (((BlockCustom) block).isWaterBlock(world, blockpos1) && ((BlockCustom) block).isWaterBlock(world, blockpos1.up()) && ((BlockCustom) block).isWaterBlock(world, blockpos1.up(2))) {
							...
							int j = 1 + random.nextInt(random.nextInt(random.nextInt(30) + 1) + 1);
							j = Math.min(30, j);
							for (int k = 0; k < j; ++k)
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public boolean canPlaceBlockAt(World world, BlockPos pos) {
	        ...
	        if ((isWaterBlock(world, pos)) && (isWaterBlock(world, pos.up())) && (isWaterBlock(world, pos.up(2)))) {
				water = true;
			}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if (!canPlaceBlockAt(world, pos)) {
				...
				if (isWaterBlock(world, pos.up()) && isWaterBlock(world, pos.up(2)) && isWaterBlock(world, pos.up(3))) {
					int l;
