...
public class BlockNereocystisKelp extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int weight = LepidodendronConfig.weightNereocystis;
		...
		if (!matchBiome(biome, LepidodendronConfig.genNereocystisBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genNereocystisOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
