...
public class BlockAnemone1 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_1")
	public static final Block block = null;
	public BlockAnemone1(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_1"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_1", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAnemone1.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:sea_anemone_1", BlockAnemone1.block);
		OreDictionary.registerOre("pndietEncruster", BlockAnemone1.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sea_anemone_1");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			return new ItemStack(BlockAnemone1Dead.block, (int) (1)).getItem();
		}
