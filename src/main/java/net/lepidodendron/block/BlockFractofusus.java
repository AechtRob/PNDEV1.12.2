...
public class BlockFractofusus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fractofusus")
	public static final Block block = null;
	public BlockFractofusus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fractofusus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fractofusus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fractofusus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFractofusus.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fractofusus");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_FRACTOFUSUS;
		}
