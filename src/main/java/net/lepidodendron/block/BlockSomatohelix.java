...
public class BlockSomatohelix extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:somatohelix")
	public static final Block block = null;
	public BlockSomatohelix(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.somatohelix);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("somatohelix"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:somatohelix", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockSomatohelix.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_somatohelix");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SOMATOHELIX;
		}
