...
public class BlockCrenaticaulis extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crenaticaulis")
	public static final Block block = null;
	public BlockCrenaticaulis(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crenaticaulis);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crenaticaulis", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:crenaticaulis", BlockCrenaticaulis.block);
		OreDictionary.registerOre("plantPrehistoric", BlockCrenaticaulis.block);
		OreDictionary.registerOre("plant", BlockCrenaticaulis.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_crenaticaulis");
			setRegistryName("crenaticaulis");
		}

		@Override
		public IBlockState getPotState() {
			return BlockCrenaticaulisSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockCrenaticaulisSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
