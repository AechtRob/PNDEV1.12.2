...
public class BlockFrenelopsis4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:frenelopsis_04")
	public static final Block block = null;
	public BlockFrenelopsis4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.frenelopsis_04);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("frenelopsis_04"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:frenelopsis4", "inventory"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockFrenelopsis3.block) {
