...
public class BlockYuccitesLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:yuccites_log")
	public static final Block block = null;
	public BlockYuccitesLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.yuccites_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("yuccites_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:yuccites_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:yuccites_sapling", BlockYuccitesLog.block);
		OreDictionary.registerOre("logWood", BlockYuccitesLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_yuccites_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockYuccitesShoot.block) || (block1 == BlockYuccitesShootPlaceable.block)) {
				leavesattached = true;
	    	}
