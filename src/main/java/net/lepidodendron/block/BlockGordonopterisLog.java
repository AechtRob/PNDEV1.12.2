...
public class BlockGordonopterisLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gordonopteris_log")
	public static final Block block = null;
	public BlockGordonopterisLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gordonopteris_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gordonopteris_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:gordonopteris_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:gordonopteris_sapling", BlockGordonopterisLog.block);
		OreDictionary.registerOre("logWood", BlockGordonopterisLog.block);
	}
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_gordonopteris_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockGordonopterisShoot.block) || (block1 == BlockGordonopterisShootPlaceable.block)) {
				leavesattached = true;
	    	}
