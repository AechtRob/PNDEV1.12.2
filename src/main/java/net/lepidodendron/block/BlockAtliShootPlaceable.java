...
public class BlockAtliShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:atli_shoot")
	public static final Block block = null;
	public BlockAtliShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.atli_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("atli_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:atli_shoot", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:atli_sapling", BlockAtliShootPlaceable.block);
		OreDictionary.registerOre("plantPrehistoric", BlockAtliShootPlaceable.block);
		OreDictionary.registerOre("plant", BlockAtliShootPlaceable.block);
		OreDictionary.registerOre("treeLeaves", BlockAtliShootPlaceable.block);
	}
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_atli_shoot");
