...
public class BlockPlaneSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:plane_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:plane_slab_double")
	public static final Block block_slab_double = null;
	public BlockPlaneSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.plane_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("plane_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("plane_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:plane_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_plane_slab");
