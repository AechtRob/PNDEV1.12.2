...
public class BlockEncblueLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:encblue_log")
	public static final Block block = null;
	public BlockEncblueLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.encblue_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("encblue_log"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:encblue_sapling", BlockEncblueLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockEncblueShoot.block) || (block1 == BlockEncblueShootPlaceable.block) || (block1 == BlockEncblueShootCone.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
