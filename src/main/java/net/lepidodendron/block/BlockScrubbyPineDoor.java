...
public class BlockScrubbyPineDoor extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_door")
	public static final Block block = null;
	public BlockScrubbyPineDoor(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_door);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scrubby_pine_door"));
	...
	public static class BlockCustom extends BlockDoor {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_scrubby_pine_door");
	    ...
	    {
	        return "tile.scrubby_pine_door.name";
	    }

		@Override
	    public String getLocalizedName()
   	 	{
        	return I18n.translateToLocal("item.scrubby_pine_door_item.name");
    	}
