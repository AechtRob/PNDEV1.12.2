...
public class BlockGoldenLarchFruit extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:golden_larch_fruit")
	public static final Block block = null;
	public BlockGoldenLarchFruit(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.golden_larch_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("golden_larch_fruit"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockGoldenLarchFruit.block);
	}
