...
public class BlockFurculaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:furcula_sapling")
	public static final Block block = null;
	public BlockFurculaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.furcula_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("furcula_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:furcula_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:furcula_sapling", BlockFurculaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_furcula_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_FURCULA;
		}
