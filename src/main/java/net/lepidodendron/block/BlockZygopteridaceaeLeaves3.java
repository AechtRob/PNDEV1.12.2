...
public class BlockZygopteridaceaeLeaves3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:zygopteridaceae_leaves_3")
	public static final Block block = null;
	public BlockZygopteridaceaeLeaves3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.zygopteridaceae_leaves_3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zygopteridaceae_leaves_3"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Zygopteridaceae_leaves_3", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_zygopteridaceae_leaves_3");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if (block == BlockZygopteridaceaeLeaves4.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
