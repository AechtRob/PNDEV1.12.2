...
public class BlockBivalveTexicaprina extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_texicaprina")
	public static final Block block = null;
	public BlockBivalveTexicaprina(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_texicaprina);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_texicaprina"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_texicaprina", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveTexicaprina.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_texicaprina", BlockBivalveTexicaprina.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveTexicaprina.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveTexicaprina.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveTexicaprina.block);
	}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveTexicaprina.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_texicaprina");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_TEXICAPRINA;
		}
