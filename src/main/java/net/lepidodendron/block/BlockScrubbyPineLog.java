...
public class BlockScrubbyPineLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_log")
	public static final Block block = null;
	public BlockScrubbyPineLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scrubby_pine_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:scrubby_pine_log", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_scrubby_pine_log");
