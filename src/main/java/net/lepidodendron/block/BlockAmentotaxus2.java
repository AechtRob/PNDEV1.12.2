...
public class BlockAmentotaxus2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus2")
	public static final Block block = null;
	public BlockAmentotaxus2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus2"));
