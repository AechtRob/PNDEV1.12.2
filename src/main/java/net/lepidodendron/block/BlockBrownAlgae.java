...
public class BlockBrownAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:leafy_brown_algae")
	public static final Block block = null;
	public BlockBrownAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.leafy_brown_algae);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("leafy_brown_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:leafy_brown_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBrownAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		int weight = LepidodendronConfigPlants.weightBrownLeafyAlgae;
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genBrownLeafyAlgaeBlacklistBiomes)) {
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genBrownLeafyAlgaeOverrideBiomes))
			biomeCriteria = true;
