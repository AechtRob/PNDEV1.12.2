...
public class BlockCedarSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cedar_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:cedar_slab_double")
	public static final Block block_slab_double = null;
	public BlockCedarSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cedar_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cedar_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cedar_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockCedarSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cedar_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_cedar_slab");
