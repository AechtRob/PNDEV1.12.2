...
public class BlockAnemone5 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_5")
	public static final Block block = null;
	public BlockAnemone5(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_5);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_5"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_5", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAnemone5.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:sea_anemone_5", BlockAnemone5.block);
		OreDictionary.registerOre("pndietEncruster", BlockAnemone5.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sea_anemone_5");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, Random rand, int fortune) {
			return new ItemStack(BlockAnemone5Dead.block, (int) (1)).getItem();
		}
