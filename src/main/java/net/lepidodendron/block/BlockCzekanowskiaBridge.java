...
public class BlockCzekanowskiaBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:czekanowskia_bridge")
	public static final Block block = null;
	public BlockCzekanowskiaBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.czekanowskia_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("czekanowskia_bridge"));
