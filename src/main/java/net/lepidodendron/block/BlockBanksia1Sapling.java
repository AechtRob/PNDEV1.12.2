...
public class BlockBanksia1Sapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:banksia_1_sapling")
	public static final Block block = null;
	public BlockBanksia1Sapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.banksia_1_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("banksia_1_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:banksia_1_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:banksia_1_sapling", BlockBanksia1Sapling.block);
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				int z = pos.getZ();
				{
					...
					ProcedureWorldGenBanksia1.executeProcedure($_dependencies);
				}
	        }
	    }
