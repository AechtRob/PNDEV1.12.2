...
public class BlockRattanStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rattan_stem")
	public static final Block block = null;
	public BlockRattanStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rattan_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rattan_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:rattan_stem", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:rattan_sapling", BlockRattanStem.block);
		OreDictionary.registerOre("logWood", BlockRattanStem.block);
		OreDictionary.registerOre("itemRope", BlockRattanStem.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_rattan_stem");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
	        ...
	        if ((block == BlockRattanShoot.block) || (block == BlockRattanShootPlaceable.block)) {
