...
public class BlockKomlopterisSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:komlopteris_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:komlopteris_slab_double")
	public static final Block block_slab_double = null;
	public BlockKomlopterisSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.komlopteris_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("komlopteris_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("komlopteris_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:komlopteris_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_komlopteris_slab");
