...
public class BlockLomatia3 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lomatia3")
	public static final Block block = null;
	public BlockLomatia3(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telopea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lomatia3"));
	...
	public static class BlockCustom extends BlockBush {
		...
		{
			return worldIn.getBlockState(pos.down()).getBlock() == BlockLomatia2.block;
		}
