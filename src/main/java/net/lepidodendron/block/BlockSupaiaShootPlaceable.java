...
public class BlockSupaiaShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:supaia_shoot")
	public static final Block block = null;
	public BlockSupaiaShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.supaia_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("supaia_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:supaia_shoot", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:supaia_sapling", BlockSupaiaShootPlaceable.block);
		OreDictionary.registerOre("plantPrehistoric", BlockSupaiaShootPlaceable.block);
		OreDictionary.registerOre("plant", BlockSupaiaShootPlaceable.block);
		OreDictionary.registerOre("treeLeaves", BlockSupaiaShootPlaceable.block);
	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_supaia_shoot");
