...
public class BlockDinomischus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dinomischus")
	public static final Block block = null;
	public BlockDinomischus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dinomischus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dinomischus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dinomischus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockDinomischus.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_dinomischus");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_DINOMISCHUS;
		}
