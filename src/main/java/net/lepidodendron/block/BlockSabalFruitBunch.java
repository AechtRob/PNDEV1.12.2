...
import net.lepidodendron.procedure.ProcedureSabalFruitNeighbourBlockChanges;
...
public class BlockSabalFruitBunch extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sabal_fruit_bunch")
	public static final Block block = null;
	public BlockSabalFruitBunch(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sabal_fruit_bunch);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sabal_fruit_bunch"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sabal_fruit_bunch", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider, IShearable {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_sabal_fruit_bunch");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
...

			{
				...
				ProcedureSabalFruitNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
