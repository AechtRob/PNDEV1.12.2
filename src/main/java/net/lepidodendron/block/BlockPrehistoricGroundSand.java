...
public class BlockPrehistoricGroundSand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_prehistoric_ground_cover")
	public static final Block block = null;
	public BlockPrehistoricGroundSand(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_prehistoric_ground_cover);
	}
	...
	public static class BlockCustom extends BlockFalling implements IGrowable, ISustainsPlantType {
		public BlockCustom() {
			super(Material.SAND);
			setTranslationKey("pf_sandy_prehistoric_ground_cover");
