...
public class BlockCalamitesShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calamites_shoot")
	public static final Block block = null;
	public BlockCalamitesShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calamites_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calamites_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:calamites_shoot", "inventory"));
    	...
    	public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockCalamitesShootTop.block.getDefaultState(), 3);
