...
public class BlockDicksoniaLeaves4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicksonia_leaves_4")
	public static final Block block = null;
	public BlockDicksoniaLeaves4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicksonia_leaves_4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicksonia_leaves_4"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:dicksonia_leaves_4", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_dicksonia_leaves_4");
