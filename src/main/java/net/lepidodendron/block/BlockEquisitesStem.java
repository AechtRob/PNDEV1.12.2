...
public class BlockEquisitesStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:equisetites_stem")
	public static final Block block = null;
	public BlockEquisitesStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.equisetites_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("equisetites_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:equisetites_stem", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:equisetites_sapling", BlockEquisitesStem.block);
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_EQUISETITES;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			{
				if (block2 == this || block2 == BlockEquisitesShoot.block || block2 == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
				...
				if (block3 == this || block3 == BlockEquisitesShoot.block || block3 == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block4 == this || block4 == BlockEquisitesShoot.block || block4 == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block5 == this || block5 == BlockEquisitesShoot.block || block5 == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				|| ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.WEST))
			{
				...
				if (block == this || block == BlockEquisitesShoot.block || block == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
				...
				if (block1 == this || block1 == BlockEquisitesShoot.block || block1 == BlockEquisitesShootPlaceable.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
