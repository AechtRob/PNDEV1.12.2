...
public class BlockBeltanelliformis extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:beltanelliformis")
	public static final Block block = null;
	public BlockBeltanelliformis(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.beltanelliformis);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("beltanelliformis"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:beltanelliformis", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBeltanelliformis.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:beltanelliformis", BlockBeltanelliformis.block);
		OreDictionary.registerOre("pndietMicrobial", BlockBeltanelliformis.block);
	}
						...
						{	boolean waterDepthCheckMax = false;
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBeltanelliformis.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_beltanelliformis");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BELTANELLIFORMIS;
		}
