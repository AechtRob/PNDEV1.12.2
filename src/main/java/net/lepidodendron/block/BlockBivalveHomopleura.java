...
public class BlockBivalveHomopleura extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_homopleura")
	public static final Block block = null;
	public BlockBivalveHomopleura(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_homopleura);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_homopleura"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_homopleura", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveHomopleura.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:bivalve_homopleura", BlockBivalveHomopleura.block);
		OreDictionary.registerOre("itemShellfish", BlockBivalveHomopleura.block);
		OreDictionary.registerOre("pnfurnaceSeafood", BlockBivalveHomopleura.block);
		OreDictionary.registerOre("pndietShellfish", BlockBivalveHomopleura.block);
	}
...
//		}
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveHomopleura.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
	...
	public static class BlockCustom extends BlockBivalve  {
		...
		public BlockCustom() {
			super();
			setTranslationKey("pf_bivalve_homopleura");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BIVALVE_HOMOPLEURA;
		}
