...
public class BlockPodozamitesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:podozamites_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:podozamites_slab_double")
	public static final Block block_slab_double = null;
	public BlockPodozamitesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.podozamites_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("podozamites_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("podozamites_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:podozamites_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_podozamites_slab");
