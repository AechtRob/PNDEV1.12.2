...
public class BlockMagnoliaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:magnolia_sapling")
	public static final Block block = null;
	public BlockMagnoliaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.magnolia_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("magnolia_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:magnolia_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:magnolia_sapling", BlockMagnoliaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_magnolia_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_MAGNOLIA;
		}
