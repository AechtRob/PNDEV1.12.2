...
public class BlockStachyophyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stachyophyton")
	public static final Block block = null;
	public BlockStachyophyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stachyophyton);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stachyophyton", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:stachyophyton", BlockStachyophyton.block);
		OreDictionary.registerOre("plantPrehistoric", BlockStachyophyton.block);
		OreDictionary.registerOre("plant", BlockStachyophyton.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_stachyophyton");
			setRegistryName("stachyophyton");
		}

		@Override
		public IBlockState getPotState() {
			return BlockStachyophytonSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockStachyophytonSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
