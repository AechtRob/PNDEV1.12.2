...
public class BlockMonanthesiaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:monanthesia_log")
	public static final Block block = null;
	public BlockMonanthesiaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.monanthesia_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("monanthesia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:monanthesia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:monanthesia_sapling", BlockMonanthesiaLog.block);
		OreDictionary.registerOre("logWood", BlockMonanthesiaLog.block);
	}
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_monanthesia_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockMonanthesiaShoot.block) || (block1 == BlockMonanthesiaShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
