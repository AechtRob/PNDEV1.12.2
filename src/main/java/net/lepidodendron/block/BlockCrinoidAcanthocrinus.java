...
public class BlockCrinoidAcanthocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_acanthocrinus")
	public static final Block block = null;
	public BlockCrinoidAcanthocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_acanthocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_acanthocrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_acanthocrinus", BlockCrinoidAcanthocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidAcanthocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidAcanthocrinus.block);
	}
	...
	private static int crinoidHeight(World worldIn, BlockPos pos, Random random) {
		if (worldIn.getBiome(pos).getRegistryName().toString().equalsIgnoreCase("lepidodendron:silurian_sea_garden")) {
			if (random.nextInt(8) != 0) {
				return BlockCrinoidAcanthocrinus.BlockCustom.crinoidheight;
			}
		}
		return 1 + random.nextInt(random.nextInt(random.nextInt(BlockCrinoidAcanthocrinus.BlockCustom.crinoidheight) + 1) + 1);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_acanthocrinus");
			setRegistryName("crinoid_acanthocrinus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_ACANTHOCRINUS;
		}
