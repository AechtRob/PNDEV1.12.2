...
public class BlockCrinoidApiocrinites extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidApiocrinites.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidApiocrinites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_APIOCRINITES;
		}
