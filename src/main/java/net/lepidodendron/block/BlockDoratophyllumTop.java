...
public class BlockDoratophyllumTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:doratophyllum_top")
	public static final Block block = null;
	public BlockDoratophyllumTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.doratophyllum_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("doratophyllum_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:doratophyllum_top", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:doratophyllum_top", BlockDoratophyllumTop.block);
...
//	}
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_doratophyllum_top");
			...
			if (block != BlockDoratophyllum.block) {
				...
				if (Math.random() > 0.66) {
					if (!world.isRemote) {
						...
						if (!LepidodendronConfig.doPropagation) {
							entityToSpawn = new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockDoratophyllumTop.block, (int) (1)));
							entityToSpawn.setPickupDelay(10);
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			...
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
			{
				...
				if (block != BlockDoratophyllum.block) {
					...
					worldIn.setBlockState(pos, BlockDoratophyllumTopCone.block.getDefaultState(), 3);
				}
			}
