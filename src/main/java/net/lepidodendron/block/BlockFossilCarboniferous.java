...
public class BlockFossilCarboniferous extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_carboniferous")
	public static final Block block = null;

	public BlockFossilCarboniferous(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_carboniferous);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_carboniferous"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_carboniferous", "inventory"));
	}
