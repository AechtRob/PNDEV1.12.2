...
public class BlockSandyDirt extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_dirt")
	public static final Block block = null;
	public BlockSandyDirt(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandy_dirt);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandy_dirt"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandy_dirt", "inventory"));
	}

	public static class BlockCustom extends Block implements ISustainsPlantType {
		public BlockCustom() {
			super(Material.GROUND);
			setTranslationKey("pf_sandy_dirt");
