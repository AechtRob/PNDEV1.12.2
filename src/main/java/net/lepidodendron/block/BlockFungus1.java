...
public class BlockFungus1 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_1")
	public static final Block block = null;
	public BlockFungus1(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_1"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pndietFungus", BlockFungus1.block);
	}
