...
public class BlockArthropitysSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arthropitys_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:arthropitys_slab_double")
	public static final Block block_slab_double = null;
	public BlockArthropitysSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arthropitys_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("arthropitys_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("arthropitys_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:arthropitys_slab", "inventory"));
	}
