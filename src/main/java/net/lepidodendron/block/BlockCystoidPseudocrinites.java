...
public class BlockCystoidPseudocrinites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cystoid_pseudocrinites")
	public static final Block block = null;
	public BlockCystoidPseudocrinites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cystoid_pseudocrinites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cystoid_pseudocrinites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cystoid_pseudocrinites", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCystoidPseudocrinites.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNCystoidPseudocrinites", BlockCystoidPseudocrinites.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_cystoid_pseudocrinites");
