...
public class BlockBranchedSponge extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfig.weightBranchedSponge;
		...
		if (!matchBiome(biome, LepidodendronConfig.genBranchedSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfig.genBranchedSpongeOverrideBiomes))
			biomeCriteria = true;
