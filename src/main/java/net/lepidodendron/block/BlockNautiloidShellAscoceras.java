...
public class BlockNautiloidShellAscoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_ascoceras")
	public static final Block block = null;
	public BlockNautiloidShellAscoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_ascoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_ascoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAscoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_ascoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ascoceras_baby", BlockNautiloidShellAscoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_ascoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_ascoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAscoceras.TileEntityCustom();
		}

		public BlockNautiloidShellAscoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAscoceras.TileEntityCustom();
		}
