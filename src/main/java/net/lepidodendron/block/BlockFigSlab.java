...
public class BlockFigSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fig_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:fig_slab_double")
	public static final Block block_slab_double = null;
	public BlockFigSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fig_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fig_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("fig_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockFigSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fig_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_fig_slab");
