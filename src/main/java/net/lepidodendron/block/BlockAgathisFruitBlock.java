...
public class BlockAgathisFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:agathis_fruit_block")
	public static final Block block = null;
	public BlockAgathisFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.agathis_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("agathis_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockAgathisFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:agathis_fruit_block", "inventory"));
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemAgathisNuts.block, (int) (3)));
		...
		public void onEntityCollision(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			if ((entity instanceof EntityLiving) ||(entity instanceof EntityPlayer)) {
				entity.attackEntityFrom(DamageSource.FALLING_BLOCK, (float) 3);
