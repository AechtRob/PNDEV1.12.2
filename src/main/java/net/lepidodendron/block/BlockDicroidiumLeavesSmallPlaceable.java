...
public class BlockDicroidiumLeavesSmallPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_leaves_small")
	public static final Block block = null;
	public BlockDicroidiumLeavesSmallPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_leaves_small);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_leaves_small"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:dicroidium_sapling", BlockDicroidiumLeavesSmallPlaceable.block);
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_dicroidium_leaves_small");
