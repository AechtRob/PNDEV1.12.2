...
public class BlockVentarura extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ventarura")
	public static final Block block = null;
	public BlockVentarura(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ventarura);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:ventarura", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:ventarura", BlockVentarura.block);
		OreDictionary.registerOre("plantPrehistoric", BlockVentarura.block);
		OreDictionary.registerOre("plant", BlockVentarura.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_ventarura");
			setRegistryName("ventarura");
		}

		@Override
		public IBlockState getPotState() {
			return BlockVentaruraSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockVentaruraSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
