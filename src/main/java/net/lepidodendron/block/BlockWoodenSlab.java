...
public class BlockWoodenSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:woodenslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:woodenslab_double")
	public static final Block block_slab_double = null;
	public BlockWoodenSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.woodenslab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("woodenslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("woodenslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:woodenslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_lepidodendron_slab");
