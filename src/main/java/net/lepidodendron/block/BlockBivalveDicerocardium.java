...
public class BlockBivalveDicerocardium extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bivalve_dicerocardium")
	public static final Block block = null;
	public BlockBivalveDicerocardium(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bivalve_dicerocardium);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bivalve_dicerocardium"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bivalve_dicerocardium", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBivalveDicerocardium.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (shouldGenerateInDimension(dimID, LepidodendronConfig.dimBivalvePrehistoric))
		...
		int weight = LepidodendronConfig.weightBivalvePrehistoric;
		...
		if (matchBiome(biome, LepidodendronConfig.genBivalvePrehistoricOverrideBiomes))
			biomeCriteria = true;
						...
						if (world.getBlockState(blockpos1).getBlock() == Blocks.WATER || world.getBlockState(blockpos1).getBlock() == Blocks.FLOWING_WATER) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								if (((world.getBlockState(pos1).getMaterial() == Material.SAND)
									...
									world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBivalveDicerocardium.BlockCustom.FACING, enumfacing), 2);
									return true;
								}
							}
						}
