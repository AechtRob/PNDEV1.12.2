...
public class BlockLomatia2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lomatia2")
	public static final Block block = null;
	public BlockLomatia2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lomatia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lomatia2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:lomatia2", "inventory"));
	...
	public static class BlockCustom extends BlockBush implements IAdvancementGranter {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockLomatia.block, (int) (1));
		}
		...
		public Item getItemDropped(IBlockState state, java.util.Random rand, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				return Item.getItemFromBlock(BlockLomatia.block);
			}
		}
		...
		{
			return worldIn.getBlockState(pos.down()).getBlock() == BlockLomatia.block;
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockLomatia.block)
					|| (blockU != BlockLomatia3.block)) {
