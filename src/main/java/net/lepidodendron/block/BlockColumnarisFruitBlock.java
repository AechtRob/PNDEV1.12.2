...
public class BlockColumnarisFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:columnaris_fruit_block")
	public static final Block block = null;
	public BlockColumnarisFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.columnaris_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("columnaris_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockColumnarisFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:columnaris_fruit_block", "inventory"));
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemColumnarisNuts.block, (int) (3)));
