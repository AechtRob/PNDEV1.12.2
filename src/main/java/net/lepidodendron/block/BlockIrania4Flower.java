...
public class BlockIrania4Flower extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania4_flower")
	public static final Block block = null;
	public BlockIrania4Flower(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania4_flower"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania4_flower", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		public BlockCustom() {
			super();
			setTranslationKey("pf_irania4_flower");
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
			...
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					...
					worldIn.setBlockState(pos, BlockIrania4.block.getDefaultState().withProperty(VAR, isVar), 3);
				}
			}
			this.neighborChanged(state, worldIn, pos, BlockIrania3.block, pos.down());
		}
