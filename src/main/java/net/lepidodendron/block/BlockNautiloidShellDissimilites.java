...
public class BlockNautiloidShellDissimilites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_dissimilites")
	public static final Block block = null;
	public BlockNautiloidShellDissimilites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_dissimilites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_dissimilites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellDissimilites.TileEntityCustom.class, "lepidodendron:tileentityshell_dissimilites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_dissimilites", BlockNautiloidShellDissimilites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_dissimilites", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_dissimilites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellDissimilites.TileEntityCustom();
		}

		public BlockNautiloidShellDissimilites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellDissimilites.TileEntityCustom();
		}
