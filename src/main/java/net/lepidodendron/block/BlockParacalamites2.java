...
public class BlockParacalamites2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:paracalamites_2")
	public static final Block block = null;
	public BlockParacalamites2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.paracalamites_2);
	}
	...
	//public void registerModels(ModelRegistryEvent event) {
		//ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				//new ModelResourceLocation("lepidodendron:paracalamites_2", "inventory"));
	//}
	public static class BlockCustomFlower extends SeedSporeReedBase implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_paracalamites_2");
			setRegistryName("paracalamites_2");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if ((world.getBlockState(pos.down())).getBlock() != BlockParacalamites.block) {
