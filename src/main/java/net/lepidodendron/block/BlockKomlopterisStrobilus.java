...
import net.lepidodendron.item.ItemKomlopterisSeeds;
import net.lepidodendron.procedure.ProcedureKomlopterisStrobilusNeighbourBlockChanges;
...
public class BlockKomlopterisStrobilus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:komlopteris_strobilus")
	public static final Block block = null;
	public BlockKomlopterisStrobilus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.komlopteris_strobilus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("komlopteris_strobilus"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "lepidodendron:tileentitykomlopteris_strobilus");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:komlopteris_strobilus", "inventory"));
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureKomlopterisStrobilusNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.5) {
						ItemStack stackSeed = new ItemStack(ItemKomlopterisSeeds.block, (int) (1));
