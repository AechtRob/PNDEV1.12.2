...
public class BlockFungus13 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_13")
	public static final Block block = null;
	public BlockFungus13(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_13);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_13"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_13", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus13.BlockCustom.SPREADABLE).ignore(BlockFungus13.BlockCustom.NORTH).ignore(BlockFungus13.BlockCustom.SOUTH).ignore(BlockFungus13.BlockCustom.EAST).ignore(BlockFungus13.BlockCustom.WEST).ignore(BlockFungus13.BlockCustom.UP).ignore(BlockFungus13.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus13", BlockFungus13.block);
		OreDictionary.registerOre("itemFungus", BlockFungus13.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus13.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_fungus_13");
