...
public class BlockNilssoniocladusStemNE extends ElementsLepidodendronMod.ModElement {
	...
	public BlockNilssoniocladusStemNE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nilssoniocladus_stem_ne);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:lyginopteris_sapling", BlockNilssoniocladusStemNE.block);
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_nilssoniocladus_stem_ne");
