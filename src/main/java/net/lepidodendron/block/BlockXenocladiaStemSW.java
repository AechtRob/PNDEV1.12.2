...
public class BlockXenocladiaStemSW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:xenocladia_stem_sw")
	public static final Block block = null;
	public BlockXenocladiaStemSW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.xenocladia_stem_sw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("xenocladia_stem_sw"));
	...
	//			new ModelResourceLocation("lepidodendron:xenocladia_stem_sw", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_xenocladia_stem_sw");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if (state.getValue(FACING) == EnumFacing.NORTH) {
				...
				if (block == BlockXenocladiaStemSE.block || block == BlockXenocladiaStemNE.block 
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockXenocladiaStemNW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockXenocladiaStemNE.block, (int) (1));
        }
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockXenocladiaStemNE.block, (int) (1)));
		}		
