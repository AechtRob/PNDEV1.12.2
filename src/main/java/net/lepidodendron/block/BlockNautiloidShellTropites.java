...
public class BlockNautiloidShellTropites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_tropites")
	public static final Block block = null;
	public BlockNautiloidShellTropites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_tropites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_tropites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellTropites.TileEntityCustom.class, "lepidodendron:tileentityshell_tropites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_tropites", BlockNautiloidShellTropites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_tropites", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShelltropites.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_tropites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellTropites.TileEntityCustom();
		}

		public BlockNautiloidShellTropites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellTropites.TileEntityCustom();
		}
