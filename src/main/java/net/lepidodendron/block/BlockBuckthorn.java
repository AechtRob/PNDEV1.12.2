...
public class BlockBuckthorn extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:buckthorn")
	public static final Block block = null;
	public BlockBuckthorn(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.buckthorn);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("buckthorn"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:buckthorn", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:buckthorn", BlockBuckthorn.block);
		OreDictionary.registerOre("plantPrehistoric", BlockBuckthorn.block);
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_buckthorn");
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockBuckthorn.block, (int) (1)));
		}
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isAirBlock(pos.down())) {
				...
				if (block != BlockBuckthorn2.block) {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockBuckthorn2.block.getDefaultState(), 3);
