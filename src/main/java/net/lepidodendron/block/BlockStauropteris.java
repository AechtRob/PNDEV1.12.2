...
public class BlockStauropteris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stauropteris")
	public static final Block block = null;
	public BlockStauropteris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.stauropteris);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stauropteris", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:stauropteris", BlockStauropteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_STAUROPTERIS;
		}
		...
		public Block planted() {
			return BlockStauropteris.block;
		}
