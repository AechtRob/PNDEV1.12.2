...
public class BlockFenestellaGiantRed extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fenestella_giant_red")
	public static final Block block = null;
	public BlockFenestellaGiantRed(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fenestella_giant_red);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fenestella_giant_red"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fenestella_giant_red", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFenestellaGiantRed.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:fenestella_giant_red", BlockFenestellaGiantRed.block);
		OreDictionary.registerOre("pndietEncruster", BlockFenestellaGiantRed.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_fenestella_giant_red");
