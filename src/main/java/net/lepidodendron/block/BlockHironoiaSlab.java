...
public class BlockHironoiaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:hironoia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:hironoia_slab_double")
	public static final Block block_slab_double = null;
	public BlockHironoiaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.hironoia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("hironoia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("hironoia_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:hironoia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_hironoia_slab");
