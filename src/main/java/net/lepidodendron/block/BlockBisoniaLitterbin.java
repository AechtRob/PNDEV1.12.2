...
public class BlockBisoniaLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bisonia_litterbin")
	public static final Block block = null;
	public BlockBisoniaLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bisonia_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bisonia_litterbin"));
