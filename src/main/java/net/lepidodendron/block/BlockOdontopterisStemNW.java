...
public class BlockOdontopterisStemNW extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:odontopteris_stem_nw")
	public static final Block block = null;
	public BlockOdontopterisStemNW(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.odontopteris_stem_nw);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("odontopteris_stem_nw"));
	...
	//			new ModelResourceLocation("lepidodendron:odontopteris_stem_nw", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_odontopteris_stem_nw");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos){
			...
			if (state.getValue(FACING) == EnumFacing.NORTH) {
				...
				if (block == BlockOdontopterisStemSE.block || block == BlockOdontopterisStemNE.block 
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockOdontopterisStemNE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockOdontopterisStemNE.block, (int) (1));
        }
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockOdontopterisStemNE.block, (int) (1)));
		}
