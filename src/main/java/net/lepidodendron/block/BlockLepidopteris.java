...
public class BlockLepidopteris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lepidopteris")
	public static final Block block = null;
	public BlockLepidopteris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lepidopteris);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:lepidopteris", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:lepidopteris", BlockLepidopteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_LEPIDOPTERIS;
		}
		...
		public Block planted() {
			return BlockLepidopteris.block;
		}
