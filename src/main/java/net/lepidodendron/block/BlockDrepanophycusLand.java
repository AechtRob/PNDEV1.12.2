...
public class BlockDrepanophycusLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:drepanophycus_land")
	public static final Block block = null;
	public BlockDrepanophycusLand(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.drepanophycus_land);
	}
	...
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_drepanophycus_land");
			setRegistryName("drepanophycus_land");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			if (!world.isRemote)
			{
				...
				if (!canSurviveAt(world, pos))
				{
					...
					else if (BlockDrepanophycusWater.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockDrepanophycusWater.block.getDefaultState(), 3);
						}
					}
