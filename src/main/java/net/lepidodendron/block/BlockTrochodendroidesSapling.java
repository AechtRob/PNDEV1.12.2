...
public class BlockTrochodendroidesSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:trochodendroides_sapling")
	public static final Block block = null;
	public BlockTrochodendroidesSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.trochodendroides_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("trochodendroides_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:trochodendroides_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:trochodendroides_sapling", BlockTrochodendroidesSapling.block);
		OreDictionary.registerOre("treeSapling", BlockTrochodendroidesSapling.block);
		OreDictionary.registerOre("plantPrehistoric", BlockTrochodendroidesSapling.block);
		OreDictionary.registerOre("plant", BlockTrochodendroidesSapling.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_trochodendroides_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_TROCHODENDROIDES;
		}
		...
		public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	    {
	        ...
	        else
	        {
				...
				ProcedureWorldGenTrochodendroides.executeProcedure(world, pos.up(BareTrunk), TreeHeight);
				...
				for (int d = 0; d <= 3; d++) {
					...
					ProcedureWorldGenTrochodendroides.executeProcedure(world, newPos.up(BareTrunkSide), TreeHeight - BareTrunkSide);
				}
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Early Cretaceous - Late Cretaceous - Paleogene (Paleocene)");
