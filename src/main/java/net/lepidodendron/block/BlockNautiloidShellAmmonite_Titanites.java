...
public class BlockNautiloidShellAmmonite_Titanites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_titanites")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Titanites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_titanites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_titanites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAmmonite_Titanites.TileEntityCustom.class, "lepidodendron:tileentityshell_titanites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ammonite_titanites", BlockNautiloidShellAmmonite_Titanites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_titanites", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellAmmonite_titanites.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_titanites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Titanites.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Titanites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Titanites.TileEntityCustom();
		}
