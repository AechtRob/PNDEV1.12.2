...
public class BlockPentoxylalesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pentoxylales_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:pentoxylales_slab_double")
	public static final Block block_slab_double = null;
	public BlockPentoxylalesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pentoxylales_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pentoxylales_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("pentoxylales_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:pentoxylales_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_pentoxylales_slab");
