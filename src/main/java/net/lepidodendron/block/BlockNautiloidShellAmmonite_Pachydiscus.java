...
public class BlockNautiloidShellAmmonite_Pachydiscus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_pachydiscus")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Pachydiscus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_pachydiscus);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAmmonite_Pachydiscus.TileEntityCustom.class, "lepidodendron:tileentityshell_pachydiscus");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ammonite_pachydiscus", BlockNautiloidShellAmmonite_Pachydiscus.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_pachydiscus", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellAmmonite_pachydiscus.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Pachydiscus.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Pachydiscus.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Pachydiscus.TileEntityCustom();
		}
