...
public class BlockNautiloidShellLituites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_lituites")
	public static final Block block = null;
	public BlockNautiloidShellLituites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_lituites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_lituites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellLituites.TileEntityCustom.class, "lepidodendron:tileentityshell_lituites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_lituites", BlockNautiloidShellLituites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_lituites", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_lituites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellLituites.TileEntityCustom();
		}

		public BlockNautiloidShellLituites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellLituites.TileEntityCustom();
		}
