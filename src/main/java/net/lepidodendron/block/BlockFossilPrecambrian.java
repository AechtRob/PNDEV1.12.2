...
public class BlockFossilPrecambrian extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_precambrian")
	public static final Block block = null;

	public BlockFossilPrecambrian(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_precambrian);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_precambrian"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_precambrian", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFossil {
		public BlockCustom() {
			setTranslationKey("pf_fossil_precambrian");
		}

		@Override
		public ItemStack getFossilDrop() {
			return new ItemStack(ItemFossilPrecambrian.block, 1);
		}
	}
}
