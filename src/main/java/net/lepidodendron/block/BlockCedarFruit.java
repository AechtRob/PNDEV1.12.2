...
public class BlockCedarFruit extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cedar_fruit")
	public static final Block block = null;
	public BlockCedarFruit(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cedar_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cedar_fruit"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockCedarFruit.block);
	}
