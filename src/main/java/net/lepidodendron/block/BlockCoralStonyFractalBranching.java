...
public class BlockCoralStonyFractalBranching extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_stony_fractal_branching")
	public static final Block block = null;
	public BlockCoralStonyFractalBranching(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_stony_fractal_branching);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_stony_fractal_branching"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_stony_fractal_branching", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralStonyFractalBranching.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_stony_fractal_branching", BlockCoralStonyFractalBranching.block);
		OreDictionary.registerOre("coral", BlockCoralStonyFractalBranching.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralStonyFractalBranching.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_stony_fractal_branching");
