...
public class BlockAmphibianSpawnPhlegethontia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amphibian_spawn_phlegethontia_worldgen")
	public static final Block block = null;
	public BlockAmphibianSpawnPhlegethontia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amphibian_spawn_phlegethontia_worldgen);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 1; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_phlegethontia", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn  {
		public BlockCustom() {
			setTranslationKey("pf_amphibian_spawn_phlegethontia_worldgen");
