...
public class BlockNautiloidShellEndoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_endoceras")
	public static final Block block = null;
	public BlockNautiloidShellEndoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_endoceras);
	}
	...
	public static class BlockCustom extends Block {
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellEndoceras.TileEntityCustom();
		}

		public BlockNautiloidShellEndoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellEndoceras.TileEntityCustom();
		}
