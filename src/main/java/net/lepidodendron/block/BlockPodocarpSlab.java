...
public class BlockPodocarpSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:podocarp_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:podocarp_slab_double")
	public static final Block block_slab_double = null;
	public BlockPodocarpSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.podocarp_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("podocarp_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("podocarp_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:podocarp_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_podocarp_slab");
