...
public class BlockOdontopterisStemSE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:odontopteris_stem_se")
	public static final Block block = null;
	public BlockOdontopterisStemSE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.odontopteris_stem_se);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("odontopteris_stem_se"));
	...
	//			new ModelResourceLocation("lepidodendron:odontopteris_stem_se", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_odontopteris_stem_se");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockOdontopterisStemSW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
