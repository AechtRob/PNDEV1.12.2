...
public class BlockFurculaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:furcula_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:furcula_slab_double")
	public static final Block block_slab_double = null;
	public BlockFurculaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.furcula_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("furcula_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("furcula_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:furcula_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_furcula_slab");
