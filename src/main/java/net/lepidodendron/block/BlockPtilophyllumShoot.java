...
public class BlockPtilophyllumShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ptilophyllum_shoot_worldgen")
	public static final Block block = null;
	public BlockPtilophyllumShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ptilophyllum_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ptilophyllum_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:ptilophyllum_shoot_worldgen", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter, IBennettites {
		public BlockCustom() {
			super();
			setTranslationKey("pf_ptilophyllum_shoot_worldgen");
