...
public class BlockGinkgoitesBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ginkgoites_bridge")
	public static final Block block = null;
	public BlockGinkgoitesBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ginkgoites_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ginkgoites_bridge"));
