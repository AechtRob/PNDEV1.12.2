...
public class BlockCrinoidEncrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_encrinus")
	public static final Block block = null;
	public BlockCrinoidEncrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_encrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_encrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNCrinoidEncrinus", BlockCrinoidEncrinus.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_encrinus");
			setRegistryName("crinoid_encrinus");
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Silurian - Devonian - Carboniferous - Permian - Triassic");
			}
