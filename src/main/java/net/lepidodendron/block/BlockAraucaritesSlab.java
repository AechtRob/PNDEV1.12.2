...
public class BlockAraucaritesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:araucarites_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:araucarites_slab_double")
	public static final Block block_slab_double = null;
	public BlockAraucaritesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.araucarites_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("araucarites_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("araucarites_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:araucarites_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_araucarites_slab");
