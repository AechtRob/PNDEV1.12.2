...
public class BlockPhyllothecaTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phyllotheca_shoot")
	public static final Block block = null;
	public BlockPhyllothecaTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phyllotheca_shoot);
	}
	...
	//			new ModelResourceLocation("lepidodendron:phyllotheca_shoot", "inventory"));
	//}
	public static class BlockCustomFlower extends SeedSporeReedBase implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_phyllotheca_shoot");
			setRegistryName("phyllotheca_shoot");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if ((world.getBlockState(pos.down())).getBlock() != BlockPhyllotheca.block) {
		...
		public Item blockItem() {
			return ItemPhyllothecaItem.block;
		}
	}
}
