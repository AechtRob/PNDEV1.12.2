...
public class BlockNypaShoot02SideCorner extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nypa_shoot_02_side_corner")
	public static final Block block = null;
	public BlockNypaShoot02SideCorner(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nypa_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nypa_shoot_02_side_corner"));
	...
	//			new ModelResourceLocation("lepidodendron:nypa_shoot_02_side_corner", "inventory"));
	//}
	...
	public static class BlockCustom extends BlockLeaves {
		...
		public BlockCustom() {
			setTranslationKey("pf_nypa_shoot_02_side_corner");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (((world.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.NORTH) 
				&& (world.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02.block)
				&& (world.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
			...
			if (((world.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.SOUTH) 
				&& (world.getBlockState(pos.north().east()).getBlock() != BlockNypaShoot02.block)
				&& (world.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				world.destroyBlock(pos, false);
				return;
			...
			if (((world.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.EAST) 
				&& (world.getBlockState(pos.west().north()).getBlock() != BlockNypaShoot02.block)
				&& (world.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				world.destroyBlock(pos, false);
				return;
			...
			if (((world.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.WEST) 
				&& (world.getBlockState(pos.east().south()).getBlock() != BlockNypaShoot02.block)
				&& (world.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				world.destroyBlock(pos, false);
				return;
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
			//North
			if (((worldIn.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.NORTH) 
				&& (worldIn.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02.block)
				&& (worldIn.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
			...
			//South
			if (((worldIn.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.SOUTH) 
				&& (worldIn.getBlockState(pos.north().east()).getBlock() != BlockNypaShoot02.block)
				&& (worldIn.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				worldIn.destroyBlock(pos, false);
				return;
			...
			//East
			if (((worldIn.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.EAST) 
				&& (worldIn.getBlockState(pos.west().north()).getBlock() != BlockNypaShoot02.block)
				&& (worldIn.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				worldIn.destroyBlock(pos, false);
				return;
			...
			//West
			if (((worldIn.getBlockState(pos)).getValue(BlockHorizontal.FACING) == EnumFacing.WEST) 
				&& (worldIn.getBlockState(pos.east().south()).getBlock() != BlockNypaShoot02.block)
				&& (worldIn.getBlockState(pos.south().west()).getBlock() != BlockNypaShoot02Fruiting.block))
				{
				worldIn.destroyBlock(pos, false);
				return;
