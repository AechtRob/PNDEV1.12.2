...
public class BlockRhacophyton extends ElementsLepidodendronMod.ModElement {
	...
	public BlockRhacophyton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rhacophyton);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:rhacophyton", BlockRhacophyton.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_RHACOPHYTON;
		}
