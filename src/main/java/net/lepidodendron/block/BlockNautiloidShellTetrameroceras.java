...
public class BlockNautiloidShellTetrameroceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_tetrameroceras")
	public static final Block block = null;
	public BlockNautiloidShellTetrameroceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_tetrameroceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_tetrameroceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellTetrameroceras.TileEntityCustom.class, "lepidodendron:tileentityshell_tetrameroceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_tetrameroceras", BlockNautiloidShellTetrameroceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_tetrameroceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_tetrameroceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellTetrameroceras.TileEntityCustom();
		}

		public BlockNautiloidShellTetrameroceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellTetrameroceras.TileEntityCustom();
		}
