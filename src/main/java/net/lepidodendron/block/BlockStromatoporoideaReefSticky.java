...
public class BlockStromatoporoideaReefSticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:stromatoporoidea_reef_sticky")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stromatoporoidea_reef_sticky"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:stromatoporoidea_reef_sticky", "inventory"));
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_stromatoporoidea_reef_sticky");
		...
		public ItemStack getSilkTouchDrop(IBlockState state)  {
			return new ItemStack(BlockStromatoporoideaReef.block, (int) (1));
		}
