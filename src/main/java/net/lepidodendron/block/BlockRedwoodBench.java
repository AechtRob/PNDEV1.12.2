...
public class BlockRedwoodBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:redwood_bench")
	public static final Block block = null;
	public BlockRedwoodBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.redwood_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("redwood_bench"));
