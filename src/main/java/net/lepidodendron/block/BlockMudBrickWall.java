...
public class BlockMudBrickWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mud_brick_wall")
	public static final Block block = null;
	public BlockMudBrickWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mud_brick_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mud_brick_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mud_brick_wall", "inventory"));
	}
