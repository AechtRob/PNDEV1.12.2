...
public class BlockAbiesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:abies_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:abies_slab_double")
	public static final Block block_slab_double = null;
	public BlockAbiesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.abies_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("abies_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("abies_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockAbiesSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:abies_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_abies_slab");
