...
public class BlockAmentotaxus3Berries extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus3_berries")
	public static final Block block = null;
	public BlockAmentotaxus3Berries(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus3_berries"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:amentotaxus3_berries", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_amentotaxus3_berries");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockAmentotaxus2.block && block != BlockAmentotaxus2Berries.block)
					|| (blockU != BlockAmentotaxus4.block && blockU != BlockAmentotaxus4Berries.block)) {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
			{
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					...
					world.setBlockState(pos.down(2), BlockAmentotaxus.block.getDefaultState(), 3);
					world.setBlockState(pos.down(), BlockAmentotaxus2.block.getDefaultState(), 3);
					world.setBlockState(pos, BlockAmentotaxus3.block.getDefaultState(), 3);
					world.setBlockState(pos.up(), BlockAmentotaxus4.block.getDefaultState(), 3);
					return true;
				}
				return true;
			}
