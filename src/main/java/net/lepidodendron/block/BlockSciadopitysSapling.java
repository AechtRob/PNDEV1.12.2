...
public class BlockSciadopitysSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sciadopitys_sapling")
	public static final Block block = null;
	public BlockSciadopitysSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sciadopitys_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sciadopitys_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sciadopitys_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:sciadopitys_sapling", BlockSciadopitysSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_sciadopitys_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SCIADOPITYS;
		}
