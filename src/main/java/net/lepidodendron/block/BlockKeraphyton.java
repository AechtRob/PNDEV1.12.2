...
public class BlockKeraphyton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:keraphyton")
	public static final Block block = null;
	public BlockKeraphyton(ElementsLepidodendronMod instance) {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:keraphyton", BlockKeraphyton.block);
		OreDictionary.registerOre("plantPrehistoric", BlockKeraphyton.block);
	...
	public static class BlockCustomFlower extends BlockLeaves {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isAirBlock(pos.down())) {
				...
				if (block != BlockKeraphytonCentre.block) {
		...
		public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockKeraphytonCentre.block.getDefaultState(), 3);
			world.setBlockState(pos.up(2), BlockKeraphytonTop.block.getDefaultState(), 3);
