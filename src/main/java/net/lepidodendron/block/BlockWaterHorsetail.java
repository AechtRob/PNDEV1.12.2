...
public class BlockWaterHorsetail extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:water_horsetail")
	public static final Block block = null;
	public BlockWaterHorsetail(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.water_horsetail);
	}
	...
	public static class BlockCustom extends SeedSporeLilyPadBase implements IGrowable, IAdvancementGranter {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_WATER_HORSETAIL;
		}
	         ...
	         if (!world.isRemote)
	        {
				...
				if (!this.canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockWaterHorsetail.block.getDefaultState(), 3);
					}
