...
public class BlockFossilSilurian extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fossil_silurian")
	public static final Block block = null;

	public BlockFossilSilurian(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fossil_silurian);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fossil_silurian"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fossil_silurian", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFossil {
		public BlockCustom() {
			setTranslationKey("pf_fossil_silurian");
		}
