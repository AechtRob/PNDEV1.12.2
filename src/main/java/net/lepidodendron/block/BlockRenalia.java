...
public class BlockRenalia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:renalia")
	public static final Block block = null;
	public BlockRenalia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.renalia);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:renalia", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:renalia", BlockRenalia.block);
		OreDictionary.registerOre("plantPrehistoric", BlockRenalia.block);
		OreDictionary.registerOre("plant", BlockRenalia.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_renalia");
			setRegistryName("renalia");
		}

		@Override
		public IBlockState getPotState() {
			return BlockRenaliaSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockRenaliaSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
