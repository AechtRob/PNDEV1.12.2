...
public class BlockScrubbyPineLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_litterbin")
	public static final Block block = null;
	public BlockScrubbyPineLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scrubby_pine_litterbin"));
