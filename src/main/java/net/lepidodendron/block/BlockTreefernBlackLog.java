...
public class BlockTreefernBlackLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:black_treefern_log")
	public static final Block block = null;
	public BlockTreefernBlackLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.black_treefern_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("black_treefern_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:black_treefern_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:black_treefern_sapling", BlockTreefernBlackLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_black_treefern_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockTreefernBlackShoot.block) || (block1 == BlockTreefernBlackShootPlaceable.block)) {
				leavesattached = true;
	    	}
