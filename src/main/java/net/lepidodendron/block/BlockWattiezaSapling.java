...
public class BlockWattiezaSapling extends ElementsLepidodendronMod.ModElement {
	...
	public BlockWattiezaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wattieza_sapling);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:wattieza_sapling", BlockWattiezaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_wattieza_sapling");
