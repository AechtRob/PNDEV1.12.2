...
public class BlockTieteaLeavesTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tietea_leaves_top")
	public static final Block block = null;
	public BlockTieteaLeavesTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tietea_leaves_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tietea_leaves_top"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Tietea_leaves_top", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_tietea_leaves_top");
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockTieteaLeavesPlaceable.block, (int) (1));
        }
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if ((block == BlockTieteaLeaves.block) || (block == BlockTieteaLeavesPlaceable.block))
				{
					if (new Object() {
