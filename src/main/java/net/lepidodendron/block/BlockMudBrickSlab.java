...
public class BlockMudBrickSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mud_brick_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:mud_brick_slab_double")
	public static final Block block_slab_double = null;
	public BlockMudBrickSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mud_brick_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mud_brick_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("mud_brick_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mud_brick_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_mud_slab");
