...
public class BlockNautiloidShellMortoniceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_mortoniceras")
	public static final Block block = null;
	public BlockNautiloidShellMortoniceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_mortoniceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_mortoniceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellMortoniceras.TileEntityCustom.class, "lepidodendron:tileentityshell_mortoniceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_mortoniceras", BlockNautiloidShellMortoniceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_mortoniceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_mortoniceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellMortoniceras.TileEntityCustom();
		}

		public BlockNautiloidShellMortoniceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellMortoniceras.TileEntityCustom();
		}
