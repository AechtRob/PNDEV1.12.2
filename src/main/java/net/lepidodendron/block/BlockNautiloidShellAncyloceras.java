...
public class BlockNautiloidShellAncyloceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_ancyloceras")
	public static final Block block = null;
	public BlockNautiloidShellAncyloceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_ancyloceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_ancyloceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAncyloceras.TileEntityCustom.class, "lepidodendron:tileentityshell_ancyloceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ancyloceras", BlockNautiloidShellAncyloceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_ancyloceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_ancyloceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAncyloceras.TileEntityCustom();
		}

		public BlockNautiloidShellAncyloceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAncyloceras.TileEntityCustom();
		}
