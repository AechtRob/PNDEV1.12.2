...
public class BlockNilssoniaLog extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nilssonia_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:nilssonia_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nilssonia_sapling", BlockNilssoniaLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_nilssonia_log");
