...
public class BlockProteaSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:protea_sapling")
	public static final Block block = null;
	public BlockProteaSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.protea_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("protea_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:protea_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:protea_sapling", BlockProteaSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_protea_sapling");
