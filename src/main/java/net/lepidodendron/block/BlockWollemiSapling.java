...
public class BlockWollemiSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wollemi_sapling")
	public static final Block block = null;
	public BlockWollemiSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wollemi_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wollemi_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:wollemi_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:wollemi_sapling", BlockWollemiSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_wollemi_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_WOLLEMI;
		}
