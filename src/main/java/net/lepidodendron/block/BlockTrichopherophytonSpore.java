...
public class BlockTrichopherophytonSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:trichopherophyton_spore")
	public static final Block block = null;
	public BlockTrichopherophytonSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.trichopherophyton_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:trichopherophyton_spore", "inventory"));
	}
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_trichopherophyton_spore");
			setRegistryName("trichopherophyton_spore");
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockTrichopherophyton.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(BlockTrichopherophyton.block, (int) (1)));
			}
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
		        	...
		        	if ((Math.random() > 0.3)) {
						world.setBlockState(pos, BlockTrichopherophyton.block.getDefaultState(), 3);
		        	}
				}
			}
		}
...
//	    	}
		...
		public Block planted() {
			return BlockTrichopherophyton.block;
		}
