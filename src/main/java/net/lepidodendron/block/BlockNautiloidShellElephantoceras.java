...
public class BlockNautiloidShellElephantoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_elephantoceras")
	public static final Block block = null;
	public BlockNautiloidShellElephantoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_elephantoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_elephantoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellElephantoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_elephantoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_elephantoceras", BlockNautiloidShellElephantoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_elephantoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_elephantoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellElephantoceras.TileEntityCustom();
		}

		public BlockNautiloidShellElephantoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellElephantoceras.TileEntityCustom();
		}
