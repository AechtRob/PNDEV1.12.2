...
public class BlockTorreyaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:torreya_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:torreya_slab_double")
	public static final Block block_slab_double = null;
	public BlockTorreyaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.torreya_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("torreya_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("torreya_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockTorreyaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:torreya_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_torreya_slab");
