...
public class BlockGreenCrustedAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:green_crusted_algae")
	public static final Block block = null;
	public BlockGreenCrustedAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.green_crusted_algae);
	}
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("green_crusted_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:green_crusted_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockGreenCrustedAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenCrustedAlgaeBlacklistBiomes)) {
			biomeCriteria = true;
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genGreenCrustedAlgaeOverrideBiomes))
			biomeCriteria = true;
