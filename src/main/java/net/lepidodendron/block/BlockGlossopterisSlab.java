...
public class BlockGlossopterisSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:glossopterisslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:glossopterisslab_double")
	public static final Block block_slab_double = null;
	public BlockGlossopterisSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.glossopterisslab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("glossopterisslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("glossopterisslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:glossopterisslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_glossopterisslab");
