...
public class BlockLepidaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lepidaster_item")
	public static final Block block = null;
	public BlockLepidaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lepidaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lepidaster_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockLepidaster.TileEntityCustom.class, "lepidodendron:tileentitylepidaster_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_lepidaster", BlockLepidaster.block);
		OreDictionary.registerOre("pndietCrinoid", BlockLepidaster.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/lepidaster_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_lepidaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockLepidaster.TileEntityCustom();
		}

		public BlockLepidaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockLepidaster.TileEntityCustom();
		}
