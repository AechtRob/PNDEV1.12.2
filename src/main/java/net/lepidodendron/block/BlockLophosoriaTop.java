...
public class BlockLophosoriaTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_top")
	public static final Block block = null;
	public BlockLophosoriaTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_top"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_top", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_top", Blocklophosoria_topCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_topCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_topCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_top");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockD != BlockLophosoriaCentre.block
					|| blockN != BlockLophosoriaTopNorth.block
					|| blockE != BlockLophosoriaTopEast.block
					|| blockS != BlockLophosoriaTopSouth.block
					|| blockW != BlockLophosoriaTopWest.block) {
