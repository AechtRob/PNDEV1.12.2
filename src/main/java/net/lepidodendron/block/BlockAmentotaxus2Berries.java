...
public class BlockAmentotaxus2Berries extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amentotaxus2_berries")
	public static final Block block = null;
	public BlockAmentotaxus2Berries(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amentotaxus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amentotaxus2_berries"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:amentotaxus2_berries", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			//super();
			setTranslationKey("pf_amentotaxus2_berries");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockAmentotaxus.block && block != BlockAmentotaxusBerries.block)
					|| (blockU != BlockAmentotaxus3.block && blockU != BlockAmentotaxus3Berries.block)) {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()) || !LepidodendronConfig.doPropagation)
			{
				...
				if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					...
					world.setBlockState(pos.down(), BlockAmentotaxus.block.getDefaultState(), 3);
					world.setBlockState(pos, BlockAmentotaxus2.block.getDefaultState(), 3);
					world.setBlockState(pos.up(), BlockAmentotaxus3.block.getDefaultState(), 3);
					world.setBlockState(pos.up(2), BlockAmentotaxus4.block.getDefaultState(), 3);
					return true;
				}
				return true;
			}
