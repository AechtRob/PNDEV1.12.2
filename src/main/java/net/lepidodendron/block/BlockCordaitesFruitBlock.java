...
public class BlockCordaitesFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cordaites_fruit_block")
	public static final Block block = null;
	public BlockCordaitesFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cordaites_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cordaites_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockCordaitesFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cordaites_fruit_block", "inventory"));
	}
	public static class BlockCustom extends BlockFalling implements IShearable {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_cordaites_fruit_block");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemCordaitesSeeds.block, (int) (3)));
		...
		public void onEntityCollision(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			if ((entity instanceof EntityLiving) ||(entity instanceof EntityPlayer)) {
				entity.attackEntityFrom(DamageSource.FALLING_BLOCK, (float) 7);
