...
public class BlockDrimys extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:drimys")
	public static final Block block = null;
	public BlockDrimys(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.drimys);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("drimys"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:drimys", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:drimys", BlockDrimys.block);
		OreDictionary.registerOre("plantPrehistoric", BlockDrimys.block);
		OreDictionary.registerOre("plant", BlockDrimys.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IAdvancementGranter {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockDrimys2.block.getDefaultState(), 3);
			world.setBlockState(pos.up(2), BlockDrimys3.block.getDefaultState(), 3);
					...
					if ((Math.random() > 0.7)) {
						if ((Math.random() > 0.7)) {
							if (world.getBlockState(pos).getValue(FLOWERS)) {
								world.setBlockState(pos, BlockDrimys.block.getDefaultState().withProperty(FLOWERS, false), 3);
								world.setBlockState(pos.up(), BlockDrimys2.block.getDefaultState().withProperty(FLOWERS, false), 3);
								world.setBlockState(pos.up(2), BlockDrimys3.block.getDefaultState().withProperty(FLOWERS, false), 3);
							}
							else {
								world.setBlockState(pos, BlockDrimys.block.getDefaultState().withProperty(FLOWERS, true), 3);
								world.setBlockState(pos.up(), BlockDrimys2.block.getDefaultState().withProperty(FLOWERS, true), 3);
								world.setBlockState(pos.up(2), BlockDrimys3.block.getDefaultState().withProperty(FLOWERS, true), 3);
							}
