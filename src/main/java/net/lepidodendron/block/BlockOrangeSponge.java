...
public class BlockOrangeSponge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:orange_sponge")
	public static final Block block = null;
	public BlockOrangeSponge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.orange_sponge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("orange_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:orange_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockOrangeSponge.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:orange_sponge", BlockOrangeSponge.block);
		OreDictionary.registerOre("itemSponge", BlockOrangeSponge.block);
		OreDictionary.registerOre("pndietSponge", BlockOrangeSponge.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightOrangeSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genOrangeSpongeBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genOrangeSpongeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_orange_sponge");
