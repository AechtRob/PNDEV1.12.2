...
public class BlockMackenzia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mackenzia")
	public static final Block block = null;
	public BlockMackenzia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mackenzia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mackenzia"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mackenzia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockMackenzia.LEVEL).build());
	}
...
//								}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_mackenzia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_MACKENZIA;
		}
