...
public class BlockWattiezaShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:wattieza_shoot_worldgen")
	public static final Block block = null;
	public BlockWattiezaShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.wattieza_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wattieza_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:wattieza_shoot_worldgen", "inventory"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.getBlockState(pos.up()).getBlock() != BlockWattiezaShoot02.block)
			{
