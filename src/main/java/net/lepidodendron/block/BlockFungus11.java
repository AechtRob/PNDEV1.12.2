...
public class BlockFungus11 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_11")
	public static final Block block = null;
	public BlockFungus11(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_11);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_11"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_11", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus11.BlockCustom.SPREADABLE).ignore(BlockFungus11.BlockCustom.NORTH).ignore(BlockFungus11.BlockCustom.SOUTH).ignore(BlockFungus11.BlockCustom.EAST).ignore(BlockFungus11.BlockCustom.WEST).ignore(BlockFungus11.BlockCustom.UP).ignore(BlockFungus11.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus11", BlockFungus11.block);
		OreDictionary.registerOre("itemFungus", BlockFungus11.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus11.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_fungus_11");
