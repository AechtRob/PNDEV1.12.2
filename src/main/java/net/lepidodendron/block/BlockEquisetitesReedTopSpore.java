...
public class BlockEquisetitesReedTopSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:equisetites_reed_shoot_spore")
	public static final Block block = null;
	public BlockEquisetitesReedTopSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.equisetites_reed_shoot_spore);
	}
	...
	public static class BlockCustomFlower extends SeedSporeReedBase implements IAdvancementGranter {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			if ((world.getBlockState(pos.down())).getBlock() != BlockEquisetitesReed.block) {
				...
				world.setBlockState(pos, BlockEquisetitesReedTop.block.getDefaultState(), 3);
			}
		}
		...
		public Item blockItem() {
			return ItemEquisetitesReedItem.block;
		}
	}
}
