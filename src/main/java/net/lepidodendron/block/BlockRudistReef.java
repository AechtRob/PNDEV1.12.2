...
public class BlockRudistReef extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rudist_reef")
	public static final Block block = null;

	public BlockRudistReef(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rudist_reef);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rudist_reef"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietShellfish", BlockRudistReef.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:rudist_reef", "inventory"));
	}
