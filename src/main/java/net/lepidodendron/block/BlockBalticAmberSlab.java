...
public class BlockBalticAmberSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:baltic_amber_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:baltic_amber_slab_double")
	public static final Block block_slab_double = null;
	public BlockBalticAmberSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.baltic_amber_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("baltic_amber_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("baltic_amber_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:baltic_amber_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_baltic_amber_slab");
