...
public class BlockBelemnopteris extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:belemnopteris", BlockBelemnopteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BELEMNOPTERIS;
		}
		...
		public Block planted() {
			return BlockBelemnopteris.block;
		}
