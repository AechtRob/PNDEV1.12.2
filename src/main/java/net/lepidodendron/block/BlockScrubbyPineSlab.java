...
public class BlockScrubbyPineSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_slab_double")
	public static final Block block_slab_double = null;
	public BlockScrubbyPineSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("scrubby_pine_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("scrubby_pine_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:scrubby_pine_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_scrubby_pine_slab");
