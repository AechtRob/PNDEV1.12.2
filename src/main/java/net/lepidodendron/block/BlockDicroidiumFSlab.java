...
public class BlockDicroidiumFSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_f_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:dicroidium_f_slab_double")
	public static final Block block_slab_double = null;
	public BlockDicroidiumFSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicroidium_fremouwensis_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicroidium_f_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("dicroidium_f_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dicroidium_f_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_dicroidium_f_slab");
