...
public class BlockOrites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:orites")
	public static final Block block = null;
	public BlockOrites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.orites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("orites"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:orites", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:orites", BlockOrites.block);
		OreDictionary.registerOre("plantPrehistoric", BlockOrites.block);
		OreDictionary.registerOre("plant", BlockOrites.block);
	}

	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_orites");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_ORITES;
		}
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockOrites2.block.getDefaultState(), 3);
