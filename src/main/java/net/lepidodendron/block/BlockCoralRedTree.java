...
public class BlockCoralRedTree extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_red_tree")
	public static final Block block = null;
	public BlockCoralRedTree(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_red_tree);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_red_tree"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_red_tree", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralRedTree.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_red_tree", BlockCoralRedTree.block);
		OreDictionary.registerOre("coral", BlockCoralRedTree.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralRedTree.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_red_tree");
