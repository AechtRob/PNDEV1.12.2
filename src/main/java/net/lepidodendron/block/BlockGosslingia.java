...
public class BlockGosslingia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gosslingia")
	public static final Block block = null;
	public BlockGosslingia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gosslingia);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:gosslingia", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:gosslingia", BlockGosslingia.block);
		OreDictionary.registerOre("plantPrehistoric", BlockGosslingia.block);
		OreDictionary.registerOre("plant", BlockGosslingia.block);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setTranslationKey("pf_gosslingia");
			setRegistryName("gosslingia");
		}

		@Override
		public IBlockState getPotState() {
			return BlockGosslingiaSpore.block.getDefaultState();
		}
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					//Chance of spores:
		        		...
		        		if ((Math.random() > 0.7)) {
							if ((Math.random() > 0.7)) {
								world.setBlockState(pos, BlockGosslingiaSpore.block.getDefaultState(), 3);
							}
			        	}
		        	}
				}
