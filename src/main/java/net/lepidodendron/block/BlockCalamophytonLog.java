...
public class BlockCalamophytonLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calamophyton_log")
	public static final Block block = null;
	public BlockCalamophytonLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calamophyton_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calamophyton_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:calamophyton_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		//OreDictionary.registerOre("plantdnaPNlepidodendron:calamophyton_sapling", BlockCalamophytonLog.block);
	...
	public static class BlockCustom extends Block  implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_calamophyton_log");
			...
			this.setDefaultState(this.blockState.getBaseState().withProperty(GROUND, Boolean.valueOf(false)).withProperty(NORTH, Boolean.valueOf(false)).withProperty(EAST, Boolean.valueOf(false)).withProperty(SOUTH, Boolean.valueOf(false)).withProperty(WEST, Boolean.valueOf(false)).withProperty(UP, Boolean.valueOf(false)).withProperty(DOWN, Boolean.valueOf(false)).withProperty(LEAVES, Boolean.valueOf(false)));
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CALAMOPHYTON;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
		{
			...
			if ((block1 == BlockCalamophytonShoot.block) || (block1 == BlockCalamophytonShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
			}

			return state.withProperty(GROUND, Boolean.valueOf(block != this && block != Blocks.AIR)).withProperty(DOWN, Boolean.valueOf(block == this || block != Blocks.AIR)).withProperty(UP, Boolean.valueOf(block1 == this || leavesblock1)).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this)).withProperty(LEAVES, leavesattached);
		}
		...
		{
			return new BlockStateContainer(this, new IProperty[] {GROUND, NORTH, EAST, SOUTH, WEST, UP, DOWN, LEAVES});
		}
