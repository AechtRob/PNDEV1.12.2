...
public class BlockCalamitesSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:calamites_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:calamites_slab_double")
	public static final Block block_slab_double = null;
	public BlockCalamitesSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.calamites_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("calamites_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("calamites_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:calamites_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_calamites_slab");
