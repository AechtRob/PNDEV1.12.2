...
public class BlockUnderwaterDebris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:underwater_debris")
	public static final Block block = null;
	public BlockUnderwaterDebris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.underwater_debris);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("underwater_debris"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:underwater_debris", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockUnderwaterDebris.LEVEL).build());
	}

	@Override
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		
		int weight = LepidodendronConfigPlants.weightUnderwaterDebris;
...
//			}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable  {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_underwater_debris");
