...
public class BlockThamnobeatricea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:thamnobeatricea")
	public static final Block block = null;
	public BlockThamnobeatricea(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.thamnobeatricea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("thamnobeatricea"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:thamnobeatricea", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNthamnobeatricea_sapling", BlockThamnobeatricea.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			...
			setTranslationKey("pf_thamnobeatricea");
    	...
    	public BlockRenderLayer getRenderLayer()
    {
	    ...
	    {
	        return new BlockStateContainer(this, new IProperty[] {LEVEL, NORTH, EAST, SOUTH, WEST, UP, DOWN});
	    }
