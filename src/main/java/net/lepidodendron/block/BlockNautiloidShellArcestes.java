...
public class BlockNautiloidShellArcestes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_arcestes")
	public static final Block block = null;
	public BlockNautiloidShellArcestes(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_arcestes);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_arcestes"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellArcestes.TileEntityCustom.class, "lepidodendron:tileentityshell_arcestes");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_arcestes", BlockNautiloidShellArcestes.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_arcestes", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_arcestes");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellArcestes.TileEntityCustom();
		}

		public BlockNautiloidShellArcestes.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellArcestes.TileEntityCustom();
		}
