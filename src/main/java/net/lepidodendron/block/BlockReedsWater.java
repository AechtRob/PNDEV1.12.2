...
public class BlockReedsWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:reeds_water")
	public static final Block block = null;
	public BlockReedsWater(ElementsLepidodendronMod instance) {
	...
	public static class BlockCustom extends BlockLilyPad implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_reeds_water");
			setRegistryName("reeds_water");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	         ...
	         if (!world.isRemote)
	        {
				...
				if (!this.canSurviveAt(world, pos))
		        {
					...
					else if (BlockReedsLand.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockReedsLand.block.getDefaultState(), 3);
						}
					}
