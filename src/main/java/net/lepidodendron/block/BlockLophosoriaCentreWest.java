...
public class BlockLophosoriaCentreWest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_west")
	public static final Block block = null;
	public BlockLophosoriaCentreWest(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_west"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_west", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_west", Blocklophosoria_centre_westCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_westCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_westCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_west");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockE != BlockLophosoriaCentre.block) {
				world.setBlockToAir(pos);
			}
			if (blockN != BlockLophosoriaCentreNorthWest.block) {
				world.setBlockToAir(pos);
			}
			if (blockS != BlockLophosoriaCentreSouthWest.block) {
				world.setBlockToAir(pos);
			}
