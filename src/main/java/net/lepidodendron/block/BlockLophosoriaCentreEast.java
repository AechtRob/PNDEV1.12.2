...
public class BlockLophosoriaCentreEast extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_east")
	public static final Block block = null;
	public BlockLophosoriaCentreEast(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_east"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_east", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_east", Blocklophosoria_centre_eastCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_eastCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_eastCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_east");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockW != BlockLophosoriaCentre.block) {
				world.setBlockToAir(pos);
			}
			if (blockN != BlockLophosoriaCentreNorthEast.block) {
				world.setBlockToAir(pos);
			}
			if (blockS != BlockLophosoriaCentreSouthEast.block) {
				world.setBlockToAir(pos);
			}
