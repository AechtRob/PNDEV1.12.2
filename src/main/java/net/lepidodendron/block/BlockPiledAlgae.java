...
public class BlockPiledAlgae extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:piled_algae")
	public static final Block block = null;
	public BlockPiledAlgae(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.piled_algae);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("piled_algae"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:piled_algae", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockPiledAlgae.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!Functions.matchBiome(biome, LepidodendronConfigPlants.genPiledAlgaeBlacklistBiomes)) {
			biomeCriteria = true;
		...
		if (Functions.matchBiome(biome, LepidodendronConfigPlants.genPiledAlgaeOverrideBiomes))
			biomeCriteria = true;
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_piled_algae");
