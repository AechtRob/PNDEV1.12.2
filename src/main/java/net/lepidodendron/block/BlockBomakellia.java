...
public class BlockBomakellia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bomakellia")
	public static final Block block = null;
	public BlockBomakellia(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bomakellia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bomakellia"));
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("holdfastDrops", BlockBomakellia.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bomakellia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBomakellia.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_bomakellia");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BOMAKELLIA;
		}
