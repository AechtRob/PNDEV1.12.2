...
public class BlockLophosoriaCentreNorth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_north")
	public static final Block block = null;
	public BlockLophosoriaCentreNorth(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_north"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_north", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_north", Blocklophosoria_centre_northCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_northCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_northCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_north");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockS != BlockLophosoriaCentre.block) {
				world.setBlockToAir(pos);
			}
			if (blockE != BlockLophosoriaCentreNorthEast.block) {
				world.setBlockToAir(pos);
			}
			if (blockW != BlockLophosoriaCentreNorthWest.block) {
				world.setBlockToAir(pos);
			}
