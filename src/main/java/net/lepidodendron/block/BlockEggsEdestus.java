...
public class BlockEggsEdestus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eggs_edestus_worldgen")
	public static final Block block = null;
	public BlockEggsEdestus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eggs_edestus_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eggs_edestus_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockEggsEdestus.BlockCustom.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 3; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_edestus", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn {
		public BlockCustom() {
			setTranslationKey("pf_eggs_edestus_worldgen");
