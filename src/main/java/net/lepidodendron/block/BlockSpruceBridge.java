...
public class BlockSpruceBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spruce_bridge")
	public static final Block block = null;
	public BlockSpruceBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.spruce_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("spruce_bridge"));
