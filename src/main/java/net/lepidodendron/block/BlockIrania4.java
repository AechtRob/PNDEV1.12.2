...
public class BlockIrania4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:irania4")
	public static final Block block = null;
	public BlockIrania4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.irania);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("irania4"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:irania4", "inventory"));
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
			...
			if ((Math.random() > 0.7)) {
				if ((Math.random() > 0.7)) {
					...
					worldIn.setBlockState(pos, BlockIrania4Flower.block.getDefaultState().withProperty(VAR, isVar), 3);
				}
			}
