...
public class BlockMacroneuropterisBench extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:macroneuropteris_bench")
	public static final Block block = null;
	public BlockMacroneuropterisBench(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.macroneuropteris_bench);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("macroneuropteris_bench"));
