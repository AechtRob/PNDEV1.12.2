...
public class BlockMiroviaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mirovia_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:mirovia_slab_double")
	public static final Block block_slab_double = null;
	public BlockMiroviaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.mirovia_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mirovia_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("mirovia_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockMiroviaSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:mirovia_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_mirovia_slab");
