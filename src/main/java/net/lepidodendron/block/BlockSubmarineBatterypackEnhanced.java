...
import static net.lepidodendron.LepidodendronSorter.battery_submarine;

@ElementsLepidodendronMod.ModElement.Tag
public class BlockSubmarineBatterypackEnhanced extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:battery_submarine_enhanced")
	public static final Block block = null;
	public BlockSubmarineBatterypackEnhanced(ElementsLepidodendronMod instance) {
		super(instance, battery_submarine);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("battery_submarine_enhanced"));
		//elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntitySubmarineBatterypackEnhanced.class, "lepidodendron:tileentitybattery_submarine_enhanced");
	}
...
//				new ModelResourceLocation("lepidodendron:battery_submarine_enhanced", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setTranslationKey("pf_battery_submarine_enhanced");
...
//			}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			ItemStack stack = new ItemStack(ItemSubmarineBatterypackEnhanced.block, 1, this.damageDropped(state));
			TileEntity tileEntity = world.getTileEntity(pos);
			int rf = 0;
			if (tileEntity != null) {
				if (tileEntity instanceof TileEntitySubmarineBatterypackEnhanced) {
					rf = ((TileEntitySubmarineBatterypackEnhanced)tileEntity).getEnergyStored();
				}
			}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new TileEntitySubmarineBatterypackEnhanced();
		}

		public TileEntitySubmarineBatterypackEnhanced createNewTileEntity(World worldIn, int meta) {
			return new TileEntitySubmarineBatterypackEnhanced();
		}
	...
	public static class TileEntitySubmarineBatterypackEnhanced extends TileEntity implements ITickable, IEnergyStorage {
		...
		public void update() {
			...
			if (LepidodendronConfig.machinesRF) {
				...
				if (tileEntity instanceof TileEntitySubmarineBatterypackEnhanced) {
					TileEntitySubmarineBatterypackEnhanced te = (TileEntitySubmarineBatterypackEnhanced) tileEntity;
		...
		protected int capacity = 5000000;
		...
		public boolean hasCapability(Capability<?> capability, @Nullable EnumFacing facing) {
			...
			if (blockstate != null) {
				if (blockstate.getBlock() == BlockSubmarineBatterypackEnhanced.block) {
