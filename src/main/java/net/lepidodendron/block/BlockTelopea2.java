...
public class BlockTelopea2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:telopea2")
	public static final Block block = null;
	public BlockTelopea2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.telopea);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("telopea2"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockTelopea.block)
					|| (blockU != BlockTelopea3.block)) {
