...
public class BlockNoeggerathialesShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:noeggerathiales_shoot")
	public static final Block block = null;
	public BlockNoeggerathialesShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.noeggerathiales_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("noeggerathiales_shoot"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:noeggerathiales_shoot", "inventory"));
