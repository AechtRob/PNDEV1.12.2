...
import net.lepidodendron.item.ItemPotamogetonSeeds;
...
public class BlockPotamogeton extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:potamogeton")
	public static final Block block = null;
	public BlockPotamogeton(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.potamogeton);
	}
	...
	//			new ModelResourceLocation("lepidodendron:potamogeton", "inventory"));
	//}
	...
	public static class BlockCustom extends BlockLilyPad implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_potamogeton");
			setRegistryName("potamogeton");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_POTAMOGETON;
		}
		...
		public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
			...
			if (entityIn instanceof EntityBoat) {
				...
				if (!LepidodendronConfig.doPropagation) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemPotamogetonItem.block, (int) (1)));
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(ItemPotamogetonItem.block, (int) (1)));
		}
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemPotamogetonItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemPotamogetonItem.block, (int) (1)));
			}
		}
	         ...
	         if (!world.isRemote)
	        {
				...
				if (!this.canSurviveAt(world, pos))
		        {
					...
					if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock)) && (canSurviveAt(world, targetBlock))) {
						world.setBlockState(targetBlock, BlockPotamogeton.block.getDefaultState(), 3);
					}
	    ...
	    {
	    	if (!LepidodendronConfigPlants.spreadPotamogeton) {return true;}
	        return false;
	    }
	    ...
	    {
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(ItemPotamogetonItem.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
	        {
	            return true;
	        }
	        else {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					if (Math.random() > 0.35) {
						ItemStack stackSeed = new ItemStack(ItemPotamogetonSeeds.block, (int) (1));
