...
public class BlockCrinoidDizygocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_dizygocrinus")
	public static final Block block = null;
	public BlockCrinoidDizygocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_dizygocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_dizygocrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_dizygocrinus", BlockCrinoidDizygocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidDizygocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidDizygocrinus.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_dizygocrinus");
			setRegistryName("crinoid_dizygocrinus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_DIZYGOCRINUS;
		}
