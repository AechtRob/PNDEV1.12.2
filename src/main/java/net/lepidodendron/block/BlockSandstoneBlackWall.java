...
public class BlockSandstoneBlackWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandstone_wall_black")
	public static final Block block = null;
	public BlockSandstoneBlackWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sandstone_wall_black);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sandstone_wall_black"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sandstone_wall_black", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_sandstone_wall_black");
