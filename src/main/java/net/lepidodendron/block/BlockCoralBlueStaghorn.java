...
public class BlockCoralBlueStaghorn extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_blue_staghorn")
	public static final Block block = null;
	public BlockCoralBlueStaghorn(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_blue_staghorn);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_blue_staghorn"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:coral_blue_staghorn", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCoralBlueStaghorn.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:coral_blue_staghorn", BlockCoralBlueStaghorn.block);
		OreDictionary.registerOre("coral", BlockCoralBlueStaghorn.block);
		OreDictionary.registerOre("pndietCoral", BlockCoralBlueStaghorn.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_blue_staghorn");
