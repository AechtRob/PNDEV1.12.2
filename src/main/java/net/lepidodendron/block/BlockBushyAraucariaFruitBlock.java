...
public class BlockBushyAraucariaFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:monkeypuzzle_fruit_block")
	public static final Block block = null;
	public BlockBushyAraucariaFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.monkeypuzzle_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("monkeypuzzle_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockBushyAraucariaFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:monkeypuzzle_fruit_block", "inventory"));
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemBushyAraucariaNuts.block, (int) (3)));
