...
public class BlockFungus7 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:fungus_7")
	public static final Block block = null;
	public BlockFungus7(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.fungus_7);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fungus_7"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:fungus_7", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockFungus7.BlockCustom.SPREADABLE).ignore(BlockFungus7.BlockCustom.NORTH).ignore(BlockFungus7.BlockCustom.SOUTH).ignore(BlockFungus7.BlockCustom.EAST).ignore(BlockFungus7.BlockCustom.WEST).ignore(BlockFungus7.BlockCustom.UP).ignore(BlockFungus7.BlockCustom.DOWN).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("dnaPNFungus7", BlockFungus7.block);
		OreDictionary.registerOre("itemFungus", BlockFungus7.block);
		OreDictionary.registerOre("pndietFungus", BlockFungus7.block);
	}
