...
public class BlockNematophyta extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nematophyta")
	public static final Block block = null;
	public BlockNematophyta(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nematophyta);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nematophyta"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:nematophyta", BlockNematophyta.block);
	...
	public static class BlockCustom extends SeedSporeFacingBlockBase implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.VINE);
			setTranslationKey("pf_nematophyta");
