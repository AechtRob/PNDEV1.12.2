...
public class BlockLophosoriaCentreSouthWest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_south_west")
	public static final Block block = null;
	public BlockLophosoriaCentreSouthWest(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_south_west"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_south_west", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_south_west", Blocklophosoria_centre_south_westCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_south_westCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_south_westCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_south_west");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockE != BlockLophosoriaCentreSouth.block) {
				world.setBlockToAir(pos);
			}
			if (blockN != BlockLophosoriaCentreWest.block) {
				world.setBlockToAir(pos);
			}
