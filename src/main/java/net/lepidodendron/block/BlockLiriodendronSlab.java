...
public class BlockLiriodendronSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:liriodendron_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:liriodendron_slab_double")
	public static final Block block_slab_double = null;
	public BlockLiriodendronSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.liriodendron_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("liriodendron_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("liriodendron_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:liriodendron_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_liriodendron_slab");
