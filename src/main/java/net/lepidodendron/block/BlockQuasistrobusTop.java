...
public class BlockQuasistrobusTop extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:quasistrobus_top")
	public static final Block block = null;
	public BlockQuasistrobusTop(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.quasistrobus_top);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("quasistrobus_top"));
	...
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setTranslationKey("pf_quasistrobus_top");
