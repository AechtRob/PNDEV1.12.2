...
public class BlockCornusmas2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cornusmas2")
	public static final Block block = null;
	public BlockCornusmas2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cornusmas);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cornusmas2"));
