...
public class BlockSelkirkiaBurrow extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:selkirkia_burrow")
	public static final Block block = null;
	public BlockSelkirkiaBurrow(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.selkirkia);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("selkirkia_burrow"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:entities/selkirkia", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockSelkirkiaBurrow.LEVEL, BlockSelkirkiaBurrow.OCCUPIED).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genSelkirkiaBlacklistBiomes)) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genSelkirkiaOverrideBiomes))
			biomeCriteria = true;
...
//			}
				...
				public boolean generate(World world, Random random, BlockPos pos) {
					for (int i = 0; i < 6; ++i) {
						...
						{	boolean waterDepthCheckMax = false;
							...
							IBlockState state = BlockSelkirkiaBurrow.block.getDefaultState();
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_selkirkia_burrow");
		...
		public void hideSelkirkia(World world, BlockPos pos) {
			TileEntity te = world.getTileEntity(pos);
			int intHidden = 0;
			if (te != null) {
				if (te instanceof TileEntitySelkirkia) {
					TileEntitySelkirkia Selkirkia = (TileEntitySelkirkia) te;
					intHidden = Selkirkia.getHidden();
		...
		public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te, ItemStack stack) {
			if (state.getValue(OCCUPIED) && !worldIn.isRemote) {
				...
				if (MobSpawn != null) {
					EntityPrehistoricFloraSelkirkia selkirkia = (EntityPrehistoricFloraSelkirkia) MobSpawn;
