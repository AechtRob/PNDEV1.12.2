...
public class BlockCordaitesBridge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cordaites_bridge")
	public static final Block block = null;
	public BlockCordaitesBridge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cordaites_bridge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cordaites_bridge"));
