...
public class BlockNautiloidShellAraxoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_araxoceras")
	public static final Block block = null;
	public BlockNautiloidShellAraxoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_araxoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_araxoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAraxoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_araxoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_araxoceras", BlockNautiloidShellAraxoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_araxoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_araxoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAraxoceras.TileEntityCustom();
		}

		public BlockNautiloidShellAraxoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAraxoceras.TileEntityCustom();
		}
