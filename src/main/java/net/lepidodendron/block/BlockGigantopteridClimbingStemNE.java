...
public class BlockGigantopteridClimbingStemNE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigantopterid_climbing_stem_ne")
	public static final Block block = null;
	public BlockGigantopteridClimbingStemNE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantopterid_climbing_stem_ne);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantopterid_climbing_stem_ne"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:gigantopterid_climbing_stem_ne", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:gigantopterid_climbing_sapling", BlockGigantopteridClimbingStemNE.block);
		OreDictionary.registerOre("logWood", BlockGigantopteridClimbingStemNE.block);
		OreDictionary.registerOre("itemRope", BlockGigantopteridClimbingStemNE.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_gigantopterid_climbing_stem_ne");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockGigantopteridClimbingStemSE.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
