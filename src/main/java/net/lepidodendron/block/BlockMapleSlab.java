...
public class BlockMapleSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:maple_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:maple_slab_double")
	public static final Block block_slab_double = null;
	public BlockMapleSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.maple_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("maple_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("maple_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:maple_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_maple_slab");
