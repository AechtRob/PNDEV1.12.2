...
public class BlockCephalotaxusSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cephalotaxus_sapling")
	public static final Block block = null;
	public BlockCephalotaxusSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cephalotaxus_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cephalotaxus_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:cephalotaxus_sapling", "inventory"));
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_cephalotaxus_sapling");
