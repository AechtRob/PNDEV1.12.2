...
public class BlockClathropteris extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:clathropteris")
	public static final Block block = null;
	public BlockClathropteris(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.clathropteris);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:clathropteris", BlockClathropteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_clathropteris");
			setRegistryName("clathropteris");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CLATHROPTERIS;
		}
		...
		public Block planted() {
			return BlockClathropteris.block;
		}
