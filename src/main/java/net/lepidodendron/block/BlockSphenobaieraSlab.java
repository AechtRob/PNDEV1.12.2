...
public class BlockSphenobaieraSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sphenobaiera_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:sphenobaiera_slab_double")
	public static final Block block_slab_double = null;
	public BlockSphenobaieraSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sphenobaiera_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sphenobaiera_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sphenobaiera_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sphenobaiera_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_sphenobaiera_slab");
