...
public class BlockAnemone7Dead extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_7_dead")
	public static final Block block = null;
	public BlockAnemone7Dead(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_7_dead);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_7_dead"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_7_dead", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNsea_anemone_7", BlockAnemone7Dead.block);
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_sea_anemone_7_dead");
