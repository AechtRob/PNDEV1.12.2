...
public class BlockZygopteridaceaeLeaves2 extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zygopteridaceae_leaves_2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:Zygopteridaceae_leaves_2", "inventory"));
	...
	public static class BlockCustom extends SeedSporeLeavesBase {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_zygopteridaceae_leaves_2");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if ((block == BlockZygopteridaceaeLeaves.block) || (block == BlockZygopteridaceaeLeavesPlaceable.block))
				{
					if (new Object() {
