...
public class BlockButtercup extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:buttercup")
	public static final Block block = null;
	public BlockButtercup(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:buttercup", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:buttercup", BlockButtercup.block);
		OreDictionary.registerOre("plantPrehistoric", BlockButtercup.block);
		OreDictionary.registerOre("plant", BlockButtercup.block);
	}
	...
	public static class BlockCustomFlower extends BlockBush implements IAdvancementGranter {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setTranslationKey("pf_buttercup");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BUTTERCUP;
		}
		...
		{
			if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(BlockButtercup.block, (int) (1)).getItem()) || !LepidodendronConfig.doPropagation)
			{
				return true;
			}
			else {
