...
public class BlockPsaroniusLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psaronius_log")
	public static final Block block = null;
	public BlockPsaroniusLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psaronius_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("psaronius_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:psaronius_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:psaronius_sapling", BlockPsaroniusLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_PSARONIUS;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockPsaroniusBranch.block) || (block == BlockPsaroniusLeaves.block) || (block == BlockPsaroniusLeavesPlaceable.block) || (block == BlockPsaroniusLeavesSmall.block) || (block == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockPsaroniusBranch.block) || (block1 == BlockPsaroniusLeaves.block) || (block1 == BlockPsaroniusLeavesPlaceable.block) || (block1 == BlockPsaroniusLeavesSmall.block) || (block1 == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockPsaroniusBranch.block) || (block2 == BlockPsaroniusLeaves.block) || (block2 == BlockPsaroniusLeavesPlaceable.block) || (block2 == BlockPsaroniusLeavesSmall.block) || (block2 == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockPsaroniusBranch.block) || (block3 == BlockPsaroniusLeaves.block) || (block3 == BlockPsaroniusLeavesPlaceable.block) || (block3 == BlockPsaroniusLeavesSmall.block) || (block3 == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockPsaroniusBranch.block) || (block4 == BlockPsaroniusLeaves.block) || (block4 == BlockPsaroniusLeavesPlaceable.block) || (block4 == BlockPsaroniusLeavesSmall.block) || (block4 == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockPsaroniusBranch.block) || (block5 == BlockPsaroniusLeaves.block) || (block5 == BlockPsaroniusLeavesPlaceable.block) || (block5 == BlockPsaroniusLeavesSmall.block) || (block5 == BlockPsaroniusLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
