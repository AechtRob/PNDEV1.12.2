...
public class BlockCoralBleached extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:coral_bleached")
	public static final Block block = null;
	public BlockCoralBleached(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.coral_bleached);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("coral_bleached"));
	...
	public static class BlockCustom extends BlockFalling implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_coral_bleached");
