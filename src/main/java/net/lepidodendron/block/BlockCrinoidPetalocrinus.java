...
public class BlockCrinoidPetalocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_petalocrinus")
	public static final Block block = null;
	public BlockCrinoidPetalocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_petalocrinus);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("crinoid_petalocrinus"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_petalocrinus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCrinoidPetalocrinus.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_petalocrinus", BlockCrinoidPetalocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidPetalocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidPetalocrinus.block);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_petalocrinus");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_PETALOCRINUS;
		}
