...
public class BlockBristleconeSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bristlecone_sapling")
	public static final Block block = null;
	public BlockBristleconeSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bristlecone_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("bristlecone_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:bristlecone_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:bristlecone_sapling", BlockBristleconeSapling.block);
	...
	public static class BlockCustom extends BlockBush implements IGrowable, IAdvancementGranter, IPottable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("pf_bristlecone_sapling");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BRISTLECONE;
		}
