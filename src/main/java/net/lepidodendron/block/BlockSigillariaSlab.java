...
public class BlockSigillariaSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sigillaria_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:sigillaria_slab_double")
	public static final Block block_slab_double = null;
	public BlockSigillariaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sigillaria_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sigillaria_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("sigillaria_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sigillaria_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_sigillaria_slab");
