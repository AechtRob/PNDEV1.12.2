...
public class BlockEukaryoticMat extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eukaryotic_mat")
	public static final Block block = null;
	public BlockEukaryoticMat(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eukaryotic_mat);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("eukaryotic_mat"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:eukaryotic_mat", BlockEukaryoticMat.block);
		OreDictionary.registerOre("pndietMicrobial", BlockEukaryoticMat.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:eukaryotic_mat", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockEukaryoticMat.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (biome instanceof BiomePrecambrian) {
			...
			if (biomePrecambrian.getBiomeType() == EnumBiomeTypePrecambrian.Paleoproterozoic) {
				multiplier = 2;
			}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
	   ...
	   // public static final PropertyInteger LEVEL = PropertyInteger.create("level", 0, 15);
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_eukaryotic_mat");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_EUKARYOTIC_MAT;
		}
...
//	        	tooltip.add("Periods: [Paleoproterozoic (Rhyacian (?) - Orosirian (?) - Statherian (?)) - Mesoproterozoic (Calymmian (?) - Ectasian (?) - Stenian (?)) - ] Neoproterozoic (Tonian - Cryogenian - Ediacaran) - Cambrian - Ordovician - Silurian - Devonian - Carboniferous - Permian - Triassic - Jurassic - Early Cretaceous - Late Cretaceous - Palaeogene  - Neogene - Pleistocene - present");
