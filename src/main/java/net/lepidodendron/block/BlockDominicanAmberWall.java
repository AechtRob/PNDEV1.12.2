...
public class BlockDominicanAmberWall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dominican_amber_wall")
	public static final Block block = null;
	public BlockDominicanAmberWall(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dominican_amber_wall);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dominican_amber_wall"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:dominican_amber_wall", "inventory"));
	}
