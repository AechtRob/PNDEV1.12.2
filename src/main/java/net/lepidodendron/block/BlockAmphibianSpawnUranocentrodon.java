...
public class BlockAmphibianSpawnUranocentrodon extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:amphibian_spawn_uranocentrodon_worldgen")
	public static final Block block = null;
	public BlockAmphibianSpawnUranocentrodon(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.amphibian_spawn_uranocentrodon);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amphibian_spawn_uranocentrodon_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockAmphibianSpawnUranocentrodon.LEVEL).build());
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < (int) 1; i++) {
			...
			if (SpawnLocations1.spawnsHere("lepidodendron:prehistoric_flora_uranocentrodon", biome.getRegistryName().toString())) {
	...
	public static class BlockCustom extends BlockMobSpawn  {
		public BlockCustom() {
			setTranslationKey("pf_amphibian_spawn_uranocentrodon_worldgen");
