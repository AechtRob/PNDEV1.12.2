...
public class BlockAlgalReefSticky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:algal_reef_sticky")
	public static final Block block = null;
	public BlockAlgalReefSticky(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.algal_reef);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("algal_reef_sticky"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("itemAlgae", BlockAlgalReefSticky.block);
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_algal_reef_sticky");
