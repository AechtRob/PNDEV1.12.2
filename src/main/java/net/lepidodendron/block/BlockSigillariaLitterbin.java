...
public class BlockSigillariaLitterbin extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sigillaria_litterbin")
	public static final Block block = null;
	public BlockSigillariaLitterbin(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sigillaria_litterbin);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sigillaria_litterbin"));
