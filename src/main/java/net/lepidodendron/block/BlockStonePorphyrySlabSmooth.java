...
public class BlockStonePorphyrySlabSmooth extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:porphyry_slab_smooth")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:porphyry_slab_smooth_double")
	public static final Block block_slab_double = null;
	public BlockStonePorphyrySlabSmooth(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.porphyry_slab_smooth);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("porphyry_slab_smooth"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("porphyry_slab_smooth_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:porphyry_slab_smooth", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK, MapColor.RED);
			setTranslationKey("pf_porphyry_slab_smooth");
