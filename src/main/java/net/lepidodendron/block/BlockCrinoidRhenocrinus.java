...
public class BlockCrinoidRhenocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_rhenocrinus")
	public static final Block block = null;
	public BlockCrinoidRhenocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_rhenocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_rhenocrinus", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_rhenocrinus", BlockCrinoidRhenocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidRhenocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidRhenocrinus.block);
	}
	...
	private static int crinoidHeight(World worldIn, BlockPos pos, Random random) {
		if (worldIn.getBiome(pos).getRegistryName().toString().equalsIgnoreCase("lepidodendron:silurian_sea_garden")) {
			if (random.nextInt(8) != 0) {
				return BlockCrinoidRhenocrinus.BlockCustom.crinoidheight;
			}
		}
		return 1 + random.nextInt(random.nextInt(random.nextInt(BlockCrinoidRhenocrinus.BlockCustom.crinoidheight) + 1) + 1);
	}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_crinoid_rhenocrinus");
			setRegistryName("crinoid_rhenocrinus");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CRINOID_RHENOCRINUS;
		}
