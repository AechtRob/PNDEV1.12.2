...
public class BlockRattanStemSE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rattan_stem_se")
	public static final Block block = null;
	public BlockRattanStemSE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.rattan_stem_se);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rattan_stem_se"));
	...
	//			new ModelResourceLocation("lepidodendron:rattan_stem_se", "inventory"));
	//}
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_rattan_stem_se");
    ...
    public BlockRenderLayer getRenderLayer()
    {
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockRattanStemSW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockRattanStemNE.block, (int) (1));
        }
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockRattanStemNE.block, (int) (1)));
		}
