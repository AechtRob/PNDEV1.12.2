...
public class BlockRedSponge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:red_sponge")
	public static final Block block = null;
	public BlockRedSponge(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.red_sponge);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("red_sponge"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:red_sponge", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockRedSponge.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:red_sponge", BlockRedSponge.block);
		OreDictionary.registerOre("itemSponge", BlockRedSponge.block);
		OreDictionary.registerOre("pndietSponge", BlockRedSponge.block);
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {		
		...
		int weight = LepidodendronConfigPlants.weightRedSponge;
		...
		if (!matchBiome(biome, LepidodendronConfigPlants.genRedSpongeBlacklistBiomes)) {
