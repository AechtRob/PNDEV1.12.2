...
public class BlockArchaeocalamitesStem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:archaeocalamites_stem")
	public static final Block block = null;
	public BlockArchaeocalamitesStem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.archaeocalamites_stem);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("archaeocalamites_stem"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:archaeocalamites_stem", "inventory"));
			ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockArchaeocalamitesStem.LEVEL).build());
	}
	...
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_archaeocalamites_stem");
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
			...
			worldIn.scheduleUpdate(pos.up(2), BlockArchaeocalamites.block, 1);
