...
import net.lepidodendron.item.ItemWoodworthiaNuts;
...
public class BlockWoodworthiaFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:woodworthia_fruit_block")
	public static final Block block = null;
	public BlockWoodworthiaFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.woodworthia_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("woodworthia_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockWoodworthiaFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:woodworthia_fruit_block", "inventory"));
	}
	public static class BlockCustom extends BlockFalling implements IShearable {
		public BlockCustom() {
			super(Material.PLANTS);
			setTranslationKey("pf_woodworthia_fruit_block");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemWoodworthiaNuts.block, (int) (3)));
