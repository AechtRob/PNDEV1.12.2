...
public class BlockDroseraSmall extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:drosera_small")
	public static final Block block = null;
	public BlockDroseraSmall(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:drosera_small", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:drosera_small", BlockDroseraSmall.block);
		OreDictionary.registerOre("plantPrehistoric", BlockDroseraSmall.block);
		OreDictionary.registerOre("plant", BlockDroseraSmall.block);
	}
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public Block planted() {
			return BlockDroseraSmall.block;
		}
