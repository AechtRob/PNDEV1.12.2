...
public class BlockNoeggerathialesLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:noeggerathiales_log")
	public static final Block block = null;
	public BlockNoeggerathialesLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.noeggerathiales_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("noeggerathiales_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:noeggerathiales_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:noeggerathiales_sapling", BlockNoeggerathialesLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockNoeggerathialesShoot.block) || (block1 == BlockNoeggerathialesShootPlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
