...
public class BlockNautiloidShellCenoceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_cenoceras")
	public static final Block block = null;
	public BlockNautiloidShellCenoceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_cenoceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_cenoceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellCenoceras.TileEntityCustom.class, "lepidodendron:tileentityshell_cenoceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_cenoceras", BlockNautiloidShellCenoceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_cenoceras", "inventory"));
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_cenoceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellCenoceras.TileEntityCustom();
		}

		public BlockNautiloidShellCenoceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellCenoceras.TileEntityCustom();
		}
