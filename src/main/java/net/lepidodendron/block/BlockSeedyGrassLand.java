...
public class BlockSeedyGrassLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:seedy_grass_land")
	public static final Block block = null;
	public BlockSeedyGrassLand(ElementsLepidodendronMod instance) {
	...
	public static class BlockCustom extends BlockBush implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setTranslationKey("pf_seedy_grass_land");
			setRegistryName("seedy_grass_land");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					else if (BlockSeedyGrassWater.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockSeedyGrassWater.block.getDefaultState(), 3);
						}
					}
