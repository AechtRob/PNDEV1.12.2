...
public class BlockAraucarioxylonSlabPetrified extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:araucarioxylon_slab_petrified")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:araucarioxylon_slab_petrified_double")
	public static final Block block_slab_double = null;
	public BlockAraucarioxylonSlabPetrified(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.araucarioxylon_slab_petrified);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("araucarioxylon_slab_petrified"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("araucarioxylon_slab_petrified_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:araucarioxylon_slab_petrified", "inventory"));
	}
