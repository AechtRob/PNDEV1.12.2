...
public class BlockPsilophytonSpore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psilophyton_spore")
	public static final Block block = null;
	public BlockPsilophytonSpore(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psilophyton_spore);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		//ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				//new ModelResourceLocation("lepidodendron:psilophyton_spore", "inventory"));
	}
