...
public class BlockOmphalophloiosCentre extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:omphalophloios_centre")
	public static final Block block = null;
	public BlockOmphalophloiosCentre(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.omphalophloios_centre);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("omphalophloios_centre"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:omphalophloios_centre", "inventory"));
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((block != BlockOmphalophloiosPlaceable.block)
				&& (block != this))
				world.setBlockToAir(pos);

			block = world.getBlockState(pos.up()).getBlock();
			if ((block != BlockOmphalophloiosTop.block)
				&& (block != this)) {
				world.setBlockToAir(pos);
		...
		public Block planted() {
			return BlockOmphalophloiosSapling.block;
		}
