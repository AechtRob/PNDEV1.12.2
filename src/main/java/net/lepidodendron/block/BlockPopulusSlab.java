...
public class BlockPopulusSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:populus_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:populus_slab_double")
	public static final Block block_slab_double = null;
	public BlockPopulusSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.populus_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("populus_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("populus_slab_double"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("slabWood", BlockPopulusSlab.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:populus_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_populus_slab");
