...
public class BlockGigantopteridClimbingStemSE extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:gigantopterid_climbing_stem_se")
	public static final Block block = null;
	public BlockGigantopteridClimbingStemSE(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.gigantopterid_climbing_stem_se);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gigantopterid_climbing_stem_se"));
	...
	//			new ModelResourceLocation("lepidodendron:gigantopterid_climbing_stem_se", "inventory"));
	//}
	public static class BlockCustom extends Block implements IAdvancementGranter {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_gigantopterid_climbing_stem_se");
        ...
        if ((!player.capabilities.allowEdit) || (!player.getHeldItemMainhand().isEmpty()))
	        {
	        	...
	        	if (!((hand != player.getActiveHand()) && (hand == EnumHand.MAIN_HAND))) {
					world.setBlockState(pos, BlockGigantopteridClimbingStemSW.block.getDefaultState().withProperty(FACING, world.getBlockState(pos).getValue(FACING)), 3);
