...
public class BlockLophosoriaCentreNorthEast extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lophosoria_centre_north_east")
	public static final Block block = null;
	public BlockLophosoriaCentreNorthEast(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lophosoria);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lophosoria_centre_north_east"));
...
//				new ModelResourceLocation("lepidodendron:lophosoria_centre_north_east", "inventory"));
...
//		super.init(event);
//		OreDictionary.registerOre("plantdnaPNlepidodendron:lophosoria_centre_north_east", Blocklophosoria_centre_north_eastCentre.block);
//		OreDictionary.registerOre("plantPrehistoric", Blocklophosoria_centre_north_eastCentre.block);
//		OreDictionary.registerOre("plant", Blocklophosoria_centre_north_eastCentre.block);
//	}

	public static class BlockCustom extends SeedSporeLeavesBase implements IAdvancementGranter {
		public BlockCustom() {
			super();
			setTranslationKey("pf_lophosoria_centre_north_east");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (blockW != BlockLophosoriaCentreNorth.block) {
				world.setBlockToAir(pos);
			}
			if (blockS != BlockLophosoriaCentreEast.block) {
				world.setBlockToAir(pos);
			}
