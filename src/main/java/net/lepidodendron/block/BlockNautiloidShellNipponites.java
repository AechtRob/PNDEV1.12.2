...
public class BlockNautiloidShellNipponites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_nipponites")
	public static final Block block = null;
	public BlockNautiloidShellNipponites(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_nipponites);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_nipponites"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellNipponites.TileEntityCustom.class, "lepidodendron:tileentityshell_nipponites");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_nipponites", BlockNautiloidShellNipponites.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_nipponites", "inventory"));
	}
...
//	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_nipponites");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellNipponites.TileEntityCustom();
		}

		public BlockNautiloidShellNipponites.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellNipponites.TileEntityCustom();
		}
