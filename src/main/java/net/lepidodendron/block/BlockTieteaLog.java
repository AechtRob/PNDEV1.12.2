...
public class BlockTieteaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:tietea_log")
	public static final Block block = null;
	public BlockTieteaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.tietea_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tietea_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:tietea_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:tietea_sapling", BlockTieteaLog.block);
    ...
    public static final PropertyBool DOWN = PropertyBool.create("down");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_tietea_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block == BlockTieteaBranch.block) || (block == BlockTieteaLeaves.block) || (block == BlockTieteaLeavesPlaceable.block) || (block == BlockTieteaLeavesSmall.block) || (block == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
			...
			if ((block1 == BlockTieteaBranch.block) || (block1 == BlockTieteaLeaves.block) || (block1 == BlockTieteaLeavesPlaceable.block) || (block1 == BlockTieteaLeavesSmall.block) || (block1 == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockTieteaBranch.block) || (block2 == BlockTieteaLeaves.block) || (block2 == BlockTieteaLeavesPlaceable.block) || (block2 == BlockTieteaLeavesSmall.block) || (block2 == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockTieteaBranch.block) || (block3 == BlockTieteaLeaves.block) || (block3 == BlockTieteaLeavesPlaceable.block) || (block3 == BlockTieteaLeavesSmall.block) || (block3 == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockTieteaBranch.block) || (block4 == BlockTieteaLeaves.block) || (block4 == BlockTieteaLeavesPlaceable.block) || (block4 == BlockTieteaLeavesSmall.block) || (block4 == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockTieteaBranch.block) || (block5 == BlockTieteaLeaves.block) || (block5 == BlockTieteaLeavesPlaceable.block) || (block5 == BlockTieteaLeavesSmall.block) || (block5 == BlockTieteaLeavesSmallPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
