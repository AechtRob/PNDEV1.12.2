...
public class BlockZygopteridaceaeLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:zygopteridaceae_log")
	public static final Block block = null;
	public BlockZygopteridaceaeLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.zygopteridaceae_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("zygopteridaceae_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("lepidodendron:Zygopteridaceae_log", "inventory"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:zygopteridaceae_sapling", BlockZygopteridaceaeLog.block);
    ...
    public static final PropertyBool SHOOT = PropertyBool.create("shoot");
    	...
    	public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_zygopteridaceae_log");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if (block == BlockZygopteridaceaeLeaves.block) {
				if (new Object() {
			...
			if ((block1 == BlockZygopteridaceaeLeaves.block) || (block1 == BlockZygopteridaceaeLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block2 == BlockZygopteridaceaeLeaves.block) || (block2 == BlockZygopteridaceaeLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block3 == BlockZygopteridaceaeLeaves.block) || (block3 == BlockZygopteridaceaeLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block4 == BlockZygopteridaceaeLeaves.block) || (block4 == BlockZygopteridaceaeLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
			...
			if ((block5 == BlockZygopteridaceaeLeaves.block) || (block5 == BlockZygopteridaceaeLeavesPlaceable.block)) {
				if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
							IBlockState _bs = worldIn.getBlockState(pos1);
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    {
	        return new BlockStateContainer(this, new IProperty[] {NORTH, EAST, SOUTH, WEST, UP, DOWN, SHOOT});
	    }
