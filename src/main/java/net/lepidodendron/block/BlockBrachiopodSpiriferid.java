...
public class BlockBrachiopodSpiriferid extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:brachiopod_spiriferid")
	public static final Block block = null;
	public BlockBrachiopodSpiriferid(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.brachiopod_spiriferid);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brachiopod_spiriferid"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:brachiopod_spiriferid", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockBrachiopodSpiriferid.LEVEL).build());
	}
					...
					for (int i = 0; i < 1; ++i) {
						...
						if (Functions.isWater(world, blockpos1)) {
							...
							if (waterDepthCheckMin & waterDepthCheckMax) {
								...
								for (EnumFacing enumfacing1 : BlockBrachiopodSpiriferid.BlockCustom.FACING.getAllowedValues()) {
									pos1 = blockpos1;
									...
									if (enumfacing1 != EnumFacing.UP && enumfacing1 != EnumFacing.DOWN &&
										...
										world.setBlockState(blockpos1, block.getDefaultState().withProperty(BlockBrachiopodSpiriferid.BlockCustom.FACING, enumfacing1), 2);
										return true;
									}
								}
							}
	...
	public static class BlockCustom extends Block implements net.minecraftforge.common.IShearable, IAdvancementGranter {
		...
		public BlockCustom() {
			...
			setTranslationKey("pf_brachiopod_spiriferid");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_BRACHIOPOD_SPIRIFERID;
		}
