...
public class BlockNautiloidShellAmmonite_Dactylioceras extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:shell_dactylioceras")
	public static final Block block = null;
	public BlockNautiloidShellAmmonite_Dactylioceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.shell_dactylioceras);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shell_dactylioceras"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNautiloidShellAmmonite_Dactylioceras.TileEntityCustom.class, "lepidodendron:tileentityshell_dactylioceras");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_ammonite_dactylioceras", BlockNautiloidShellAmmonite_Dactylioceras.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:shell_dactylioceras", "inventory"));
		//ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockNautiloidShellAmmonite_dactylioceras.LEVEL).build());
	}
	...
	public static class BlockCustom extends BlockPNTaxidermyItem {
		...
		public BlockCustom() {
			//super(Material.ROCK);
			setTranslationKey("pf_shell_dactylioceras");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNautiloidShellAmmonite_Dactylioceras.TileEntityCustom();
		}

		public BlockNautiloidShellAmmonite_Dactylioceras.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNautiloidShellAmmonite_Dactylioceras.TileEntityCustom();
		}
