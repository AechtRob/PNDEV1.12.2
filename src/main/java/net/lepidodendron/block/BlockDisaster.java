...
public class BlockDisaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:disaster_item")
	public static final Block block = null;
	public BlockDisaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.disaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("disaster_item"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()).setMaxStackSize(64));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockDisaster.TileEntityCustom.class, "lepidodendron:tileentitydisaster_item");
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_disaster", BlockDisaster.block);
		OreDictionary.registerOre("pndietCrinoid", BlockDisaster.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/disaster_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_disaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockDisaster.TileEntityCustom();
		}

		public BlockDisaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockDisaster.TileEntityCustom();
		}
