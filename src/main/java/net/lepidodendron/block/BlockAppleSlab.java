...
public class BlockAppleSlab extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:apple_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("lepidodendron:apple_slab_double")
	public static final Block block_slab_double = null;
	public BlockAppleSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.apple_slab);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("apple_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("apple_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:apple_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_apple_slab");
