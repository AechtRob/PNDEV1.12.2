...
public class BlockDicksoniaLeaves2 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dicksonia_leaves_2")
	public static final Block block = null;
	public BlockDicksoniaLeaves2(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dicksonia_leaves_2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("dicksonia_leaves_2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:dicksonia_leaves_2", "inventory"));
    	...
    	public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
				...
				if ((block == BlockDicksoniaLeaves.block) || (block == BlockDicksoniaLeavesPlaceable.block))
				{
					if (new Object() {
				...
				if (block == BlockDicksoniaLeaves3.block)
				{
					if (new Object() {
					public EnumFacing getEnumFacing(BlockPos pos1) {
						try {
