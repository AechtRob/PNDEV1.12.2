...
public class BlockWilliamsoniaShootPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:williamsonia_shoot")
	public static final Block block = null;
	public BlockWilliamsoniaShootPlaceable(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.williamsonia_shoot);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("williamsonia_shoot"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNwilliamsonia_sapling", BlockWilliamsoniaShootPlaceable.block);
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (block != BlockWilliamsoniaShootTop.block) {
	    ...
	    public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
			world.setBlockState(pos.up(), BlockWilliamsoniaShootTop.block.getDefaultState(), 3);
