...
public class BlockDecacuminaster extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:decacuminaster_item")
	public static final Block block = null;
	public BlockDecacuminaster(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.decacuminaster_item);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("decacuminaster_item"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:entities/decacuminaster_item", "inventory"));
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_decacuminaster_item");
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockDecacuminaster.TileEntityCustom();
		}

		public BlockDecacuminaster.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockDecacuminaster.TileEntityCustom();
		}
