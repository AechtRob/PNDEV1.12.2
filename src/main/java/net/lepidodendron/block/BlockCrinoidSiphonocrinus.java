...
public class BlockCrinoidSiphonocrinus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:crinoid_siphonocrinus")
	public static final Block block = null;
	public BlockCrinoidSiphonocrinus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.crinoid_siphonocrinus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:crinoid_siphonocrinus", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockCrinoidSiphonocrinus.LEVEL).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("staticdnaPNlepidodendron:crinoid_siphonocrinus", BlockCrinoidSiphonocrinus.block);
		OreDictionary.registerOre("pndietCrinoid", BlockCrinoidSiphonocrinus.block);
		OreDictionary.registerOre("holdfastDrops", BlockCrinoidSiphonocrinus.block);
	}
