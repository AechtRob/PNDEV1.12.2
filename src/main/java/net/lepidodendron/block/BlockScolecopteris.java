...
public class BlockScolecopteris extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:scolecopteris", BlockScolecopteris.block);
	...
	public static class BlockCustomFlower extends SeedSporeBushBase implements IAdvancementGranter, IPottable {
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_SCOLECOPTERIS;
		}
		...
		public Block planted() {
			return BlockScolecopteris.block;
		}
