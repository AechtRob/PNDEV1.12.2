...
import net.lepidodendron.item.ItemDrepanophycusItem;
...
public class BlockDrepanophycusWater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:drepanophycus_water")
	public static final Block block = null;
	public BlockDrepanophycusWater(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.drepanophycus_water);
	}
	...
	public static class BlockCustom extends SeedSporeLilyPadBase implements IGrowable, net.minecraftforge.common.IShearable, IAdvancementGranter {
		public BlockCustom() {
			...
			setLightOpacity(0);
			setCreativeTab(null);
			if (LepidodendronConfigPlants.spreadDrepanophycus && LepidodendronConfig.spreadPlantsAtAll) {
				setTickRandomly(true);
			}
			else {
				setTickRandomly(false);
			}
			setTranslationKey("pf_drepanophycus_water");
			setRegistryName("drepanophycus_water");
		}

		@Nullable
		@Override
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_DREPANOPHYCUS;
		}
		...
		public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
			...
			if (entityIn instanceof EntityBoat)
			{
				...
				if (!LepidodendronConfig.doPropagation) {
					EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ItemDrepanophycusItem.block, (int) (1)));
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(ItemDrepanophycusItem.block, (int) (1)));
		}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemDrepanophycusItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				drops.add(new ItemStack(ItemDrepanophycusItem.block, (int) (1)));
			}
		}
				...
				if (!this.canSurviveAt(world, pos))
				{
					...
					if (canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockDrepanophycusWater.block.getDefaultState(), 3);
						}
					}
					else if (BlockDrepanophycusLand.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockDrepanophycusLand.block.getDefaultState(), 3);
						}
					}
		...
		{
			if (!LepidodendronConfigPlants.spreadDrepanophycus) {return true;}
			return false;
		}
...
//	    	}
		...
		public Block planted() {
			return BlockDrepanophycusWater.block;
		}
		...
		public Item blockItem() {
			return ItemDrepanophycusItem.block;
		}
	}
}
