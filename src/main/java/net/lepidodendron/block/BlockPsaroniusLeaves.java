...
public class BlockPsaroniusLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:psaronius_leaves_worldgen")
	public static final Block block = null;
	public BlockPsaroniusLeaves(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.psaronius_leaves_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("psaronius_leaves_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:psaronius_leaves_worldgen", "inventory"));
