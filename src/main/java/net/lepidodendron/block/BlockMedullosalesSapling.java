...
public class BlockMedullosalesSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:medullosales_sapling")
	public static final Block block = null;
	public BlockMedullosalesSapling(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.medullosales_sapling);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("medullosales_sapling"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:medullosales_sapling", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:medullosales_sapling", BlockMedullosalesSapling.block);
