...
public class BlockSwampHorsetailLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:swamp_horsetail_land")
	public static final Block block = null;
	public BlockSwampHorsetailLand(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.swamp_horsetail_land);
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public Block planted() {
			return BlockSwampHorsetailLandNoSpore.block;
		}
