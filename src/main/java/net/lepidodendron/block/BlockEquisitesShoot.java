...
public class BlockEquisitesShoot extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:equisetites_shoot_worldgen")
	public static final Block block = null;
	public BlockEquisitesShoot(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.equisetites_shoot_worldgen);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("equisetites_shoot_worldgen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		//		new ModelResourceLocation("lepidodendron:equisetites_shoot_worldgen", "inventory"));
	...
	public static class BlockCustom extends BlockLeaves implements IAdvancementGranter {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockEquisitesShootPlaceable.block, (int) (1)));
		}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, java.util.Random rand, int fortune) {
			if (LepidodendronConfig.doPropagation) {
				...
				return Item.getItemFromBlock(BlockEquisitesSapling.block);
			}
		}
        ...
        public ItemStack getSilkTouchDrop(IBlockState state)  {
            return new ItemStack(BlockEquisitesShootPlaceable.block, (int) (1));
        }
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			if (((Boolean)state.getValue(CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue(DECAYABLE)).booleanValue())
				...
				if ((EnumFacing) state.getValue(BlockDirectional.FACING) == EnumFacing.NORTH) {
					...
					if ((block != BlockEquisitesStem.block) & (block != BlockEquisitesShootPlaceable.block) & (block != BlockEquisitesShoot.block))
						{
							world.setBlockToAir(pos);
							if ((Math.random() >= 0.66) && (!LepidodendronConfig.doPropagation)) {
									//Spawn another sapling:
									if (!world.isRemote) {
										EntityItem entityToSpawn = new EntityItem(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockEquisitesSapling.block, (int) (1)));
					...
					if ((block != BlockEquisitesStem.block) & (block != BlockEquisitesShootPlaceable.block) & (block != BlockEquisitesShoot.block))
						{
							...
							if ((Math.random() >= 0.66) && (!LepidodendronConfig.doPropagation)) {
									//Spawn another sapling:
									if (!worldIn.isRemote) {
										EntityItem entityToSpawn = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockEquisitesSapling.block, (int) (1)));
										entityToSpawn.setPickupDelay(10);
