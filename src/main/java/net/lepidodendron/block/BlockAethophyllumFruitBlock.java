...
public class BlockAethophyllumFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:aethophyllum_fruit_block")
	public static final Block block = null;
	public BlockAethophyllumFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.aethophyllum_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("aethophyllum_fruit_block"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietFruit", BlockAethophyllumFruitBlock.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:aethophyllum_fruit_block", "inventory"));
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemAethophyllumNuts.block, (int) (3)));
