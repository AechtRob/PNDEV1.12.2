...
public class BlockAraucariaSlab extends ElementsLepidodendronMod.ModElement {
	...
	public BlockAraucariaSlab(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.monkey_puzzle_slab);
	}
	...
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setTranslationKey("pf_monkey_puzzle_slab");
