...
public class BlockBumbudendronLand extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bumbudendron_land")
	public static final Block block = null;
	public BlockBumbudendronLand(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bumbudendron_land);
	}
	...
	public static class BlockCustom extends SeedSporeBushBase implements IGrowable, net.minecraftforge.common.IShearable {
		public BlockCustom() {
			...
			setTranslationKey("pf_bumbudendron_land");
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
	        ...
	        if (!world.isRemote)
	        {
				...
				if (!canSurviveAt(world, pos))
		        {
					...
					else if (BlockBumbudendronWater.BlockCustom.canSurviveAt(world, targetBlock)) {
						if (Math.random() > (1-(spread/100)) && (targetBlock != pos) && (world.isAirBlock(targetBlock))) {
							world.setBlockState(targetBlock, BlockBumbudendronWater.block.getDefaultState(), 3);
						}
					}
