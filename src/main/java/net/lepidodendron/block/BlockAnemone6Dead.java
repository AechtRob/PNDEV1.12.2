...
public class BlockAnemone6Dead extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sea_anemone_6_dead")
	public static final Block block = null;
	public BlockAnemone6Dead(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.sea_anemone_6_dead);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("sea_anemone_6_dead"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:sea_anemone_6_dead", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setTranslationKey("pf_sea_anemone_6_dead");
