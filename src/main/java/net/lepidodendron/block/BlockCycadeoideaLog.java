...
public class BlockCycadeoideaLog extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cycadeoidea_log")
	public static final Block block = null;
	public BlockCycadeoideaLog(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cycadeoidea_log);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cycadeoidea_log"));
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:cycadeoidea_sapling", BlockCycadeoideaLog.block);
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_CYCADEOIDEA;
		}
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockCycadeoideaLeaves.block) || (block1 == BlockCycadeoideaLeavesPlaceable.block))
				leavesattached = true;
			
	        return state.withProperty(DOWN, Boolean.valueOf(block == this || block != Blocks.AIR)).withProperty(UP, Boolean.valueOf(block1 == this || block1 == BlockCycadeoideaLeaves.block) || block1 == BlockCycadeoideaLeavesPlaceable.block).withProperty(NORTH, Boolean.valueOf(block2 == this)).withProperty(EAST, Boolean.valueOf(block3 == this)).withProperty(SOUTH, Boolean.valueOf(block4 == this)).withProperty(WEST, Boolean.valueOf(block5 == this)).withProperty(LEAVES, leavesattached);
	    }
