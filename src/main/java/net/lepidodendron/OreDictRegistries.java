...
public class OreDictRegistries extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("plantPrehistoric", ItemPetrifiedCephalotaxusSapling.block);
		OreDictionary.registerOre("plantPrehistoric", ItemPetrifiedCunninghamiaSapling.block);
		OreDictionary.registerOre("plantPrehistoric", ItemPetrifiedHoopSapling.block);
