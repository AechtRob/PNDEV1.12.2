...
public class ItemSeedyGrassItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:seedy_grass_item")
	public static final Item block = null;
	public ItemSeedyGrassItem(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:seedy_grass_item", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:seedy_grass_item", ItemSeedyGrassItem.block);
		OreDictionary.registerOre("plantPrehistoric", ItemSeedyGrassItem.block);
		OreDictionary.registerOre("plant", ItemSeedyGrassItem.block);
	}

	public static class ItemCustom extends Item implements IPottable {
		public ItemCustom() {
			setTranslationKey("pf_seedy_grass_item");
			setRegistryName("seedy_grass_item");
