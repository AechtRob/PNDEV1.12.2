...
public class ItemBuriadiaSeed extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemBuriadiaSeed.block);
		OreDictionary.registerOre("foodPinenuts", ItemBuriadiaSeed.block);
	}
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockBuriadia.block.getDefaultState(),1);
