...
public class ItemRedwoodDoorItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:redwood_door_item")
	public static final Item block = null;
	public ItemRedwoodDoorItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.redwood_door_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:redwood_door_item", "inventory"));
	}
