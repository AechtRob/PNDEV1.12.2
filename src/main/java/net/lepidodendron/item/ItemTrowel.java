...
public class ItemTrowel extends ElementsLepidodendronMod.ModElement {
    @GameRegistry.ObjectHolder("lepidodendron:trowel")
    public static final Item block = null;
    public ItemTrowel(ElementsLepidodendronMod instance) {
        super(instance, LepidodendronSorter.trowel);
    }

    @Override
    public void initElements() {
        elements.items.add(() -> new ItemToolCustom() {
        }.setTranslationKey("pf_trowel").setRegistryName("trowel").setCreativeTab(TabLepidodendronPlants.tab));
    }
