...
public class ItemNathorstianaItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nathorstiana_item")
	public static final Item block = null;
	public ItemNathorstianaItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nathorstiana_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:nathorstiana_item", "inventory"));
	}
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
	                ...
	                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
	                {
	                    ...
	                    worldIn.setBlockState(blockpos1, BlockNathorstiana.block.getDefaultState(), 11);
