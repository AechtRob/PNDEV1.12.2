...
public class ItemAraucaritesNuts extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemAraucaritesNuts.block);
		OreDictionary.registerOre("foodPinenuts", ItemAraucaritesNuts.block);
	}
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockAraucaritesSapling.block.getDefaultState(),1);
