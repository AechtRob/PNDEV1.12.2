...
public class ItemCobbaniaItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cobbania_item")
	public static final Item block = null;
	public ItemCobbaniaItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cobbania_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:cobbania_item", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: mid-Cretaceous - Paleogene - Neogene - Quaternary");
