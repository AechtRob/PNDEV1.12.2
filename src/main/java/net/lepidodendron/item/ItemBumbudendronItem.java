...
public class ItemBumbudendronItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bumbudendron_item")
	public static final Item block = null;
	public ItemBumbudendronItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bumbudendron_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:bumbudendron_item", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_bumbudendron_item");
			setRegistryName("bumbudendron_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	    {
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
					...
					if (BlockBumbudendronLand.BlockCustom.canSurviveAt(worldIn, blockpos1) && (iblockstate1.getMaterial().isReplaceable())) {
						worldIn.setBlockState(blockpos1, BlockBumbudendronLand.block.getDefaultState(), 3);
		                ...
		                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
		                {
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockBumbudendronWater.block.getDefaultState());
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockBumbudendronWater.block.getDefaultState(), 11);
