...
public class ItemScrubbyPineDoorItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:scrubby_pine_door_item")
	public static final Item block = null;
	public ItemScrubbyPineDoorItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.scrubby_pine_door_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:scrubby_pine_door_item", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_scrubby_pine_door_item");
			setRegistryName("scrubby_pine_door_item");
