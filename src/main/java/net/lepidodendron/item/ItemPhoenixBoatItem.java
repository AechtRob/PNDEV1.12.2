...
public class ItemPhoenixBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phoenix_boat_item")
	public static final Item block = null;
	public ItemPhoenixBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phoenix_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemPhoenixBoatItem.block);
	}
	...
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_phoenix_boat_item");
			setRegistryName("phoenix_boat_item");
