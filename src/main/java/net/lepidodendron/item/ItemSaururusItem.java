...
import net.lepidodendron.block.BlockSaururusWater;
...
public class ItemSaururusItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:saururus_item")
	public static final Item block = null;
	public ItemSaururusItem(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:saururus_item", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:saururus_item", ItemSaururusItem.block);
		OreDictionary.registerOre("plantPrehistoric", ItemSaururusItem.block);
		OreDictionary.registerOre("plant", ItemSaururusItem.block);
	}

	public static class ItemCustom extends Item implements IPottable {
		public ItemCustom() {
			setTranslationKey("pf_saururus_item");
			setRegistryName("saururus_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	    {
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
					...
					if (BlockSaururusLand.BlockCustom.canSurviveAt(worldIn, blockpos1) && (iblockstate1.getMaterial().isReplaceable())) {
						worldIn.setBlockState(blockpos1, BlockSaururusLand.block.getDefaultState(), 3);
		                ...
		                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
		                {
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockSaururusWater.block.getDefaultState());
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockSaururusWater.block.getDefaultState(), 11);
		...
		public IBlockState getPotState() {
			return BlockSaururusLand.block.getDefaultState();
		}
	}
