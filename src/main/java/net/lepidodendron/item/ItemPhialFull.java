...
public class ItemPhialFull extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelBakery.registerItemVariants(block,
			...
			new ModelResourceLocation("lepidodendron:entities/phial_eggs_titanoptera_mesotitan", "inventory"),
			new ModelResourceLocation("lepidodendron:entities/phial_eggs_titanoptera_cltrotitan", "inventory"),
			new ModelResourceLocation("lepidodendron:entities/phial_eggs_titanoptera_gigatitan", "inventory"),
