...
public class ItemFurcifoliumSeed extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemFurcifoliumSeed.block);
		OreDictionary.registerOre("foodPinenuts", ItemFurcifoliumSeed.block);
	}
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockFurcifolium.block.getDefaultState(), 1);
