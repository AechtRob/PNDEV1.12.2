...
public class ItemWaterHorsetailItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:water_horsetail_item")
	public static final Item block = null;
	public ItemWaterHorsetailItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.water_horsetail_item);
	}
	...
	public static class ItemCustom extends Item {
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
	                ...
	                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
	                {
	                    ...
	                    worldIn.setBlockState(blockpos1, BlockWaterHorsetail.block.getDefaultState());
	                    ...
	                    worldIn.setBlockState(blockpos1, BlockWaterHorsetail.block.getDefaultState(), 11);
	    ...
	    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
	        if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Periods: Carboniferous - Permian - Triassic - Jurassic - Cretaceous - Palaeogene - Neogene - Pleistocene [- present]");
