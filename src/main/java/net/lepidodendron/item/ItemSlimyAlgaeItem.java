...
public class ItemSlimyAlgaeItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:slimy_algae_item")
	public static final Item block = null;
	public ItemSlimyAlgaeItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.slimy_algae_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:slimy_algae_item", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_slimy_algae_item");
			setRegistryName("slimy_algae_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	    {
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
					...
					if (BlockSlimyAlgaeLand.BlockCustom.canSurviveAt(worldIn, blockpos1) && (iblockstate1.getMaterial().isReplaceable())) {
						worldIn.setBlockState(blockpos1, BlockSlimyAlgaeLand.block.getDefaultState(), 3);
		                ...
		                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
		                {
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockSlimyAlgaeWater.block.getDefaultState());
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockSlimyAlgaeWater.block.getDefaultState(), 11);
