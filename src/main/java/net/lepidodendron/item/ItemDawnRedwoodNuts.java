...
public class ItemDawnRedwoodNuts extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemDawnRedwoodNuts.block);
		OreDictionary.registerOre("foodPinenuts", ItemDawnRedwoodNuts.block);
	}
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockDawnRedwoodSapling.block.getDefaultState(),1);
