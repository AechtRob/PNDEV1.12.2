...
public class ItemAridPineBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:arid_pine_boat_item")
	public static final Item block = null;
	public ItemAridPineBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.arid_pine_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemAridPineBoatItem.block);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:arid_pine_boat_item", "inventory"));
	}
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_arid_pine_boat_item");
			setRegistryName("arid_pine_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityPNboat.setBoatType(EntityPNBoat.Type.ARID_PINE.ordinal());
