...
public class ItemSchilderiaBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:schilderia_boat_item")
	public static final Item block = null;
	public ItemSchilderiaBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.schilderia_boat_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:schilderia_boat_item", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemSchilderiaBoatItem.block);
	}
	...
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_schilderia_boat_item");
			setRegistryName("schilderia_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityPNboat.setBoatType(EntityPNBoat.Type.SCHILDERIA.ordinal());
