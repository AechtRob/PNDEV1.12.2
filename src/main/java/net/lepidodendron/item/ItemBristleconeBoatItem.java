...
public class ItemBristleconeBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:bristlecone_boat_item")
	public static final Item block = null;
	public ItemBristleconeBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.bristlecone_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemBristleconeBoatItem.block);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:bristlecone_boat_item", "inventory"));
	}
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_bristlecone_boat_item");
			setRegistryName("bristlecone_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityPNboat.setBoatType(EntityPNBoat.Type.BRISTLECONE.ordinal());
