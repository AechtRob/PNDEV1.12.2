...
public class ItemBristleconeBoatItem extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("bristlecone:bristlecone_boat_item", "inventory"));
	}
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entitybopboat.setBoatType(EntityPNBoat.Type.BRISTLECONE.getMetadata());
