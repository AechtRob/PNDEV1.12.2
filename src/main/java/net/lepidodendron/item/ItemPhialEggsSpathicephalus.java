...
public class ItemPhialEggsSpathicephalus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:phial_eggs_spathicephalus")
	public static final Item block = null;
	public ItemPhialEggsSpathicephalus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.phial_eggs_spathicephalus);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:phial_eggs_spathicephalus", "inventory"));
	}
		...
		public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
			{
				...
				if (!player.canPlayerEdit(pos.offset(facing), facing, itemstack)) {
					...
					if (BlockAmphibianSpawnSpathicephalusPlaceable.block.canPlaceBlockOnSide(worldIn, pos.offset(facing), facing)) {
