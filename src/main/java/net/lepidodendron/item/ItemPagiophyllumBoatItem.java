...
public class ItemPagiophyllumBoatItem extends ElementsLepidodendronMod.ModElement {
	...
	public ItemPagiophyllumBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pagiophyllum_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemPagiophyllumBoatItem.block);
	}
	...
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_pagiophyllum_boat_item");
