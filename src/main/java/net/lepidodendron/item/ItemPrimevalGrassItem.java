...
public class ItemPrimevalGrassItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:primaeval_grass_item")
	public static final Item block = null;
	public ItemPrimevalGrassItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.primaeval_grass_item);
	}
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	    {
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
					...
					if (BlockPrimevalGrassLand.BlockCustom.canSurviveAt(worldIn, blockpos1) && (iblockstate1.getMaterial().isReplaceable())) {
						worldIn.setBlockState(blockpos1, BlockPrimevalGrassLand.block.getDefaultState(), 3);
		                ...
		                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
		                {
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockPrimevalGrassWater.block.getDefaultState());
		                    ...
		                    worldIn.setBlockState(blockpos1, BlockPrimevalGrassWater.block.getDefaultState(), 11);
