...
public class ItemAraucarioxylonNuts extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemAraucarioxylonNuts.block);
		OreDictionary.registerOre("foodPinenuts", ItemAraucarioxylonNuts.block);
	}
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockAraucarioxylonSapling.block.getDefaultState(),1);
