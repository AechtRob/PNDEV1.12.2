...
public class ItemArtocarpusBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:artocarpus_boat_item")
	public static final Item block = null;
	public ItemArtocarpusBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.artocarpus_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemArtocarpusBoatItem.block);
	}
	...
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_artocarpus_boat_item");
			setRegistryName("artocarpus_boat_item");
