...
import net.lepidodendron.block.BlockElatocladusDoor;
...
public class ItemElatocladusDoorItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:elatocladus_door_item")
	public static final Item block = null;
	public ItemElatocladusDoorItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.elatocladus_door_item);
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("doorWood", ItemElatocladusDoorItem.block);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:elatocladus_door_item", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_elatocladus_door_item");
			setRegistryName("elatocladus_door_item");
		...
		public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	    {
	        ...
	        else
	        {
	            ...
	            if (player.canPlayerEdit(pos, facing, itemstack) && BlockElatocladusDoor.block.canPlaceBlockAt(worldIn, pos))
	            {
	                ...
	                placeDoor(worldIn, pos, enumfacing, BlockElatocladusDoor.block, flag);
