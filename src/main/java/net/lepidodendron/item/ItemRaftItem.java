...
public class ItemRaftItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:raft_boat_item")
	public static final Item block = null;
	public ItemRaftItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.raft_boat_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:raft_boat_item", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemRaftItem.block);
	}
	...
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_raft_boat_item");
			setRegistryName("raft_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityRaft.setBoatType(EntityRaft.Type.RAFT.ordinal());
