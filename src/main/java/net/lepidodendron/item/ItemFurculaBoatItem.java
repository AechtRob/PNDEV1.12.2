...
public class ItemFurculaBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:furcula_boat_item")
	public static final Item block = null;
	public ItemFurculaBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.furcula_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemFurculaBoatItem.block);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:furcula_boat_item", "inventory"));
	}
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_furcula_boat_item");
			setRegistryName("furcula_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityPNboat.setBoatType(EntityPNBoat.Type.FURCULA.ordinal());
