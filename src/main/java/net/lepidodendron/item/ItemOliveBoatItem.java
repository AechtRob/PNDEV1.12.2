...
public class ItemOliveBoatItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:olive_boat_item")
	public static final Item block = null;
	public ItemOliveBoatItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.olive_boat_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("boat", ItemOliveBoatItem.block);
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:olive_boat_item", "inventory"));
	}
	public static class ItemCustom extends Item
	{
		...
		public ItemCustom()
		{
			setTranslationKey("pf_olive_boat_item");
			setRegistryName("olive_boat_item");
		...
		public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
		{
			...
			else
			{
				...
				else
				{
					...
					entityPNboat.setBoatType(EntityPNBoat.Type.OLIVE.ordinal());
