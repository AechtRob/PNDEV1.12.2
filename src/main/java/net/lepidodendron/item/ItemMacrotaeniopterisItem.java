...
public class ItemMacrotaeniopterisItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:macrotaeniopteris_item")
	public static final Item block = null;
	public ItemMacrotaeniopterisItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.macrotaeniopteris_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:macrotaeniopteris_item", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_macrotaeniopteris_item");
			setRegistryName("macrotaeniopteris_item");
