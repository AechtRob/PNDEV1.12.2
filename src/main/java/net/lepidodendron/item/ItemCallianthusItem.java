...
public class ItemCallianthusItem extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:callianthus_item")
	public static final Item block = null;
	public ItemCallianthusItem(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.callianthus_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:callianthus_item", "inventory"));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("plantdnaPNlepidodendron:callianthus_item", ItemCallianthusItem.block);
		OreDictionary.registerOre("plantPrehistoric", ItemCallianthusItem.block);
		OreDictionary.registerOre("plant", ItemCallianthusItem.block);
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_callianthus_item");
			setRegistryName("callianthus_item");
	        ...
	        else
	        {
	            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
	            {
	                ...
	                if (canSurviveAt(worldIn, blockpos1) && (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1)))
	                {
	                    ...
	                    worldIn.setBlockState(blockpos1, BlockCallianthus.block.getDefaultState());
	                    ...
	                    worldIn.setBlockState(blockpos1, BlockCallianthus.block.getDefaultState(), 11);
