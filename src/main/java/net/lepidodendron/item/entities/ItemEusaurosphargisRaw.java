...
public class ItemEusaurosphargisRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_eusaurosphargis", ItemEusaurosphargisRaw.block);
		OreDictionary.registerOre("listAllmeatraw", ItemEusaurosphargisRaw.block);
		OreDictionary.registerOre("pnfurnaceMeat", ItemEusaurosphargisRaw.block);
		OreDictionary.registerOre("pndietMeat", ItemEusaurosphargisRaw.block);
	}
