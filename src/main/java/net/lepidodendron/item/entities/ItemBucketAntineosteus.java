...
public class ItemBucketAntineosteus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:antineosteus_bucket")
	public static final Item block = null;

	public ItemBucketAntineosteus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.antineosteus_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/antineosteus_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_antineosteus_bucket");
			setRegistryName("antineosteus_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraAntineosteus.class).toString(), "{AgeTicks:0}", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				...
				tooltip.add("Habitat: (Fresh?)water, bottom-ambush predator");
				tooltip.add("Note: Also known as Heterostius or Ichthyosauroides");
