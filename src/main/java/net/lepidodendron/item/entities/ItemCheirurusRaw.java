...
public class ItemCheirurusRaw extends ElementsLepidodendronMod.ModElement {
	...
	public ItemCheirurusRaw(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.cheirurus_raw);
	}
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_cheirurus", ItemCheirurusRaw.block);
		OreDictionary.registerOre("pnfurnaceCrustacean", ItemCheirurusRaw.block);
		OreDictionary.registerOre("pndietCrustacean", ItemCheirurusRaw.block);
	}
