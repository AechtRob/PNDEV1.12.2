...
public class ItemPalaeocharinusRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/trigonotarbid_palaeocharinus_raw", "inventory"));
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pnfurnaceBug", ItemPalaeocharinusRaw.block);
	...
	public static class ItemFoodCustom extends ItemGlassCaseDisplayItem {
		...
		public String getMobStr() {
			return "lepidodendron:prehistoric_flora_trigonotarbid_palaeocharinus";
		}
