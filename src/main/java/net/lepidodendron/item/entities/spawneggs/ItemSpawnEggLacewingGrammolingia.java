...
public class ItemSpawnEggLacewingGrammolingia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_lacewing_grammolingia")
	public static final Item block = null;
	public ItemSpawnEggLacewingGrammolingia(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_lacewing_grammolingia", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_lacewing_grammolingia");
			setRegistryName("spawn_egg_lacewing_grammolingia");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "grammolingia";
		}
