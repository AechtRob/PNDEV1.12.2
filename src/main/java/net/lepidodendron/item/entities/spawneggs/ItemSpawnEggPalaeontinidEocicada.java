...
public class ItemSpawnEggPalaeontinidEocicada extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeontinid_eocicada")
	public static final Item block = null;
	public ItemSpawnEggPalaeontinidEocicada(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeontinid_eocicada", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeontinid_eocicada");
			setRegistryName("spawn_egg_palaeontinid_eocicada");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "eocicada";
		}
