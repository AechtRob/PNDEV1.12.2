...
public class ItemSpawnEggDragonflyDragonfly8 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_dragonfly_dragonfly8")
	public static final Item block = null;
	public ItemSpawnEggDragonflyDragonfly8(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_dragonfly_dragonfly8", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_dragonfly_dragonfly8");
			setRegistryName("spawn_egg_dragonfly_dragonfly8");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "dragonfly8";
		}
