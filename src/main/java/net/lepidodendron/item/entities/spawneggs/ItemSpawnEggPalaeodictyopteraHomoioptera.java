...
public class ItemSpawnEggPalaeodictyopteraHomoioptera extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_homoioptera")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraHomoioptera(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_homoioptera", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_homoioptera");
			setRegistryName("spawn_egg_palaeodictyoptera_homoioptera");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "homoioptera";
		}
