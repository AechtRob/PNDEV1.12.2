...
public class ItemSpawnEggAnurognathidAnurognathus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_anurognathid_anurognathus")
	public static final Item block = null;
	public ItemSpawnEggAnurognathidAnurognathus(ElementsLepidodendronMod instance) {
	...
	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_anurognathid_anurognathus");
			setRegistryName("spawn_egg_anurognathid_anurognathus");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "anurognathus";
		}
