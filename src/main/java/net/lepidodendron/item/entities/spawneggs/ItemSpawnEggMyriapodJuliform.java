...
public class ItemSpawnEggMyriapodJuliform extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_juliform")
	public static final Item block = null;
	public ItemSpawnEggMyriapodJuliform(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_juliform", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_juliform");
			setRegistryName("spawn_egg_myriapod_juliform");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "juliform";
		}
