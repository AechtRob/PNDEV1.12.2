...
public class ItemSpawnEggKalligrammatidMakarkinia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_makarkinia")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidMakarkinia(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_makarkinia", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_makarkinia");
			setRegistryName("spawn_egg_kalligrammatid_makarkinia");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "makarkinia";
		}
