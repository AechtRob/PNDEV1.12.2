...
public class ItemSpawnEggPalaeodictyopteraDelitzschala extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_delitzschala")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraDelitzschala(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.palaeodictyoptera_delitzschala_raw);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_delitzschala", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_delitzschala");
			setRegistryName("spawn_egg_palaeodictyoptera_delitzschala");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "delitzschala";
		}
