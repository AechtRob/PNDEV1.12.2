...
public class ItemSpawnEggPalaeontinidIlerdocossus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeontinid_ilerdocossus")
	public static final Item block = null;
	public ItemSpawnEggPalaeontinidIlerdocossus(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeontinid_ilerdocossus", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeontinid_ilerdocossus");
			setRegistryName("spawn_egg_palaeontinid_ilerdocossus");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "ilerdocossus";
		}
