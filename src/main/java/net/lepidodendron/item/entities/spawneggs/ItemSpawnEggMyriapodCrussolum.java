...
public class ItemSpawnEggMyriapodCrussolum extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_crussolum")
	public static final Item block = null;
	public ItemSpawnEggMyriapodCrussolum(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_crussolum", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_crussolum");
			setRegistryName("spawn_egg_myriapod_crussolum");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "crussolum";
		}
