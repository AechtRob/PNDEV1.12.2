...
public class ItemSpawnEggPalaeodictyopteraSinodunbaria extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_sinodunbaria")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraSinodunbaria(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_sinodunbaria", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_sinodunbaria");
			setRegistryName("spawn_egg_palaeodictyoptera_sinodunbaria");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "sinodunbaria";
		}
