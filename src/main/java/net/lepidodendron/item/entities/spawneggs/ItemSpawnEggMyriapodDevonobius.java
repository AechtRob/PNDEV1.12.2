...
public class ItemSpawnEggMyriapodDevonobius extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_devonobius")
	public static final Item block = null;
	public ItemSpawnEggMyriapodDevonobius(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_devonobius", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_devonobius");
			setRegistryName("spawn_egg_myriapod_devonobius");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "devonobius";
		}
