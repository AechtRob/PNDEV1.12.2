...
public class ItemSpawnEggPalaeodictyopteraMazothairos extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_mazothairos")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraMazothairos(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_mazothairos", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_mazothairos");
			setRegistryName("spawn_egg_palaeodictyoptera_mazothairos");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "mazothairos";
		}
