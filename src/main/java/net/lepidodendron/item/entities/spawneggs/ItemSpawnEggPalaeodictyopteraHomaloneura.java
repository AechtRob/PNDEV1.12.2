...
public class ItemSpawnEggPalaeodictyopteraHomaloneura extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_homaloneura")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraHomaloneura(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_homaloneura", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_homaloneura");
			setRegistryName("spawn_egg_palaeodictyoptera_homaloneura");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "homaloneura";
		}
