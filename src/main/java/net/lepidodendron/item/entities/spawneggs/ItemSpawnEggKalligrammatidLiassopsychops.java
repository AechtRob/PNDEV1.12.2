...
public class ItemSpawnEggKalligrammatidLiassopsychops extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_liassopsychops")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidLiassopsychops(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_liassopsychops", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_liassopsychops");
			setRegistryName("spawn_egg_kalligrammatid_liassopsychops");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "liassopsychops";
		}
