...
public class ItemSpawnEggMyriapodVelocipede extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_velocipede")
	public static final Item block = null;
	public ItemSpawnEggMyriapodVelocipede(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_velocipede", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_velocipede");
			setRegistryName("spawn_egg_myriapod_velocipede");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "velocipede";
		}
