...
public class ItemSpawnEggKalligrammatidKalligramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_kalligramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidKalligramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_kalligramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_kalligramma");
			setRegistryName("spawn_egg_kalligrammatid_kalligramma");
