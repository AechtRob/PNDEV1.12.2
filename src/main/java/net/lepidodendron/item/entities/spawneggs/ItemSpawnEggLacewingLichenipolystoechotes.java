...
public class ItemSpawnEggLacewingLichenipolystoechotes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_lacewing_lichenipolystoechotes")
	public static final Item block = null;
	public ItemSpawnEggLacewingLichenipolystoechotes(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lacewing_lichenipolystoechotes_raw);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_lacewing_lichenipolystoechotes", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_lacewing_lichenipolystoechotes");
			setRegistryName("spawn_egg_lacewing_lichenipolystoechotes");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "lichenipolystoechotes";
		}
