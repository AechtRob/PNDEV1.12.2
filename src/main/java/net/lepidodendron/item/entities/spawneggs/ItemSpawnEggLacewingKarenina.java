...
public class ItemSpawnEggLacewingKarenina extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_lacewing_karenina")
	public static final Item block = null;
	public ItemSpawnEggLacewingKarenina(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_lacewing_karenina", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_lacewing_karenina");
			setRegistryName("spawn_egg_lacewing_karenina");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "karenina";
		}
