...
public class ItemSpawnEggLacewingCretapsychops extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_lacewing_cretapsychops")
	public static final Item block = null;
	public ItemSpawnEggLacewingCretapsychops(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_lacewing_cretapsychops", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_lacewing_cretapsychops");
			setRegistryName("spawn_egg_lacewing_cretapsychops");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "cretapsychops";
		}
