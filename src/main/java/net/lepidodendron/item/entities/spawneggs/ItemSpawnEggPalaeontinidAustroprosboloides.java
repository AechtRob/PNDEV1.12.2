...
public class ItemSpawnEggPalaeontinidAustroprosboloides extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeontinid_austroprosboloides")
	public static final Item block = null;
	public ItemSpawnEggPalaeontinidAustroprosboloides(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeontinid_austroprosboloides", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeontinid_austroprosboloides");
			setRegistryName("spawn_egg_palaeontinid_austroprosboloides");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "austroprosboloides";
		}
