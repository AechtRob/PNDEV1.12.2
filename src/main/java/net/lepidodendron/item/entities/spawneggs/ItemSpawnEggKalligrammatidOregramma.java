...
public class ItemSpawnEggKalligrammatidOregramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_oregramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidOregramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_oregramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_oregramma");
			setRegistryName("spawn_egg_kalligrammatid_oregramma");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "oregramma";
		}
