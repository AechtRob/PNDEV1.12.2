...
public class ItemSpawnEggKalligrammatidIthigramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_ithigramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidIthigramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_ithigramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_ithigramma");
			setRegistryName("spawn_egg_kalligrammatid_ithigramma");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "ithigramma";
		}
