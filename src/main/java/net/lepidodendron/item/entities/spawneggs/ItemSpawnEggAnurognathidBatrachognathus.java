...
public class ItemSpawnEggAnurognathidBatrachognathus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_anurognathid_batrachognathus")
	public static final Item block = null;
	public ItemSpawnEggAnurognathidBatrachognathus(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_anurognathid_batrachognathus", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_anurognathid_batrachognathus");
			setRegistryName("spawn_egg_anurognathid_batrachognathus");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "batrachognathus";
		}
