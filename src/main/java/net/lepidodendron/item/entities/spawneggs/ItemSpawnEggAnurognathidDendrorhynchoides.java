...
public class ItemSpawnEggAnurognathidDendrorhynchoides extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_anurognathid_dendrorhynchoides")
	public static final Item block = null;
	public ItemSpawnEggAnurognathidDendrorhynchoides(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_anurognathid_dendrorhynchoides", "inventory"));
	}
	...
	public static class ItemCustom extends ItemPNSpawnEgg {
		...
		public ItemCustom() {
			...
			setMaxStackSize(64);
			this.variant = "dendrorhynchoides";
		}
