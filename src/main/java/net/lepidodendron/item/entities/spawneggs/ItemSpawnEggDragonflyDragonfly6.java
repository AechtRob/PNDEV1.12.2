...
public class ItemSpawnEggDragonflyDragonfly6 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_dragonfly_dragonfly6")
	public static final Item block = null;
	public ItemSpawnEggDragonflyDragonfly6(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_dragonfly_dragonfly6", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_dragonfly_dragonfly6");
			setRegistryName("spawn_egg_dragonfly_dragonfly6");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "dragonfly6";
		}
