...
public class ItemSpawnEggMyriapodEoarthropleura extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_eoarthropleura")
	public static final Item block = null;
	public ItemSpawnEggMyriapodEoarthropleura(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_eoarthropleura", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_eoarthropleura");
			setRegistryName("spawn_egg_myriapod_eoarthropleura");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "eoarthropleura";
		}
