...
public class ItemSpawnEggKalligrammatidMeioneurites extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_meioneurites")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidMeioneurites(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_meioneurites", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_meioneurites");
			setRegistryName("spawn_egg_kalligrammatid_meioneurites");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "meioneurites";
		}
