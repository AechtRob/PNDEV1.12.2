...
public class ItemSpawnEggKalligrammatidSophogramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_sophogramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidSophogramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_sophogramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_sophogramma");
			setRegistryName("spawn_egg_kalligrammatid_sophogramma");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "sophogramma";
		}
