...
public class ItemSpawnEggLacewingNuddsia extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_lacewing_nuddsia")
	public static final Item block = null;
	public ItemSpawnEggLacewingNuddsia(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_lacewing_nuddsia", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_lacewing_nuddsia");
			setRegistryName("spawn_egg_lacewing_nuddsia");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "nuddsia";
		}
