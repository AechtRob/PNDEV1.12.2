...
public class ItemSpawnEggPalaeontinidPachypsyche extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeontinid_pachypsyche")
	public static final Item block = null;
	public ItemSpawnEggPalaeontinidPachypsyche(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeontinid_pachypsyche", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeontinid_pachypsyche");
			setRegistryName("spawn_egg_palaeontinid_pachypsyche");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "pachypsyche";
		}
