...
public class ItemSpawnEggMyriapodFulmenocursor extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_myriapod_fulmenocursor")
	public static final Item block = null;
	public ItemSpawnEggMyriapodFulmenocursor(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_myriapod_fulmenocursor", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_myriapod_fulmenocursor");
			setRegistryName("spawn_egg_myriapod_fulmenocursor");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "fulmenocursor";
		}
