...
public class ItemSpawnEggKalligrammatidHuiyingogramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_huiyingogramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidHuiyingogramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_huiyingogramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_huiyingogramma");
			setRegistryName("spawn_egg_kalligrammatid_huiyingogramma");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "huiyingogramma";
		}
