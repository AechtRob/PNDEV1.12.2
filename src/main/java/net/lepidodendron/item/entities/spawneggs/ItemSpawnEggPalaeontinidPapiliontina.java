...
public class ItemSpawnEggPalaeontinidPapiliontina extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeontinid_papiliontina")
	public static final Item block = null;
	public ItemSpawnEggPalaeontinidPapiliontina(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeontinid_papiliontina", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeontinid_papiliontina");
			setRegistryName("spawn_egg_palaeontinid_papiliontina");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "papiliontina";
		}
