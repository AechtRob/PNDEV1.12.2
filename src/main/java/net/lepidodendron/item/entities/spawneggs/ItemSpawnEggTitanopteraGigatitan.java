...
public class ItemSpawnEggTitanopteraGigatitan extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_titanoptera_gigatitan")
	public static final Item block = null;
	public ItemSpawnEggTitanopteraGigatitan(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_titanoptera_gigatitan", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_titanoptera_gigatitan");
			setRegistryName("spawn_egg_titanoptera_gigatitan");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "gigatitan";
		}
