...
public class ItemSpawnEggPalaeodictyopteraDunbaria extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_dunbaria")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraDunbaria(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_dunbaria", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_dunbaria");
			setRegistryName("spawn_egg_palaeodictyoptera_dunbaria");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "dunbaria";
		}
