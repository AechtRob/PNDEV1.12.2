...
public class ItemSpawnEggPalaeodictyopteraStenodictya extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_palaeodictyoptera_stenodictya")
	public static final Item block = null;
	public ItemSpawnEggPalaeodictyopteraStenodictya(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_palaeodictyoptera_stenodictya", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_palaeodictyoptera_stenodictya");
			setRegistryName("spawn_egg_palaeodictyoptera_stenodictya");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "stenodictya";
		}
