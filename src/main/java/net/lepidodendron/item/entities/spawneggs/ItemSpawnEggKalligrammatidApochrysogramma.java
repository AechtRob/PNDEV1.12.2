...
public class ItemSpawnEggKalligrammatidApochrysogramma extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:spawn_egg_kalligrammatid_apochrysogramma")
	public static final Item block = null;
	public ItemSpawnEggKalligrammatidApochrysogramma(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/spawneggs/spawn_egg_kalligrammatid_apochrysogramma", "inventory"));
	}

	public static class ItemCustom extends ItemPNSpawnEgg {
		String variant;
		public ItemCustom() {
			setTranslationKey("pf_spawn_egg_kalligrammatid_apochrysogramma");
			setRegistryName("spawn_egg_kalligrammatid_apochrysogramma");
			setCreativeTab(CreativeTabs.MISC);
			setMaxStackSize(64);
			this.variant = "apochrysogramma";
		}
