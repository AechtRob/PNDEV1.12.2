...
public class ItemViviparus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:viviparus_item")
	public static final Item block = null;

	public ItemViviparus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.viviparus_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/viviparus_item", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_viviparus_item");
			setRegistryName("viviparus_item");
			maxStackSize = 1;
		...
		public static boolean placeEntity(ItemStack stack, World worldIn, BlockPos target, EntityPlayer player, @Nullable EnumHand hand)
		{
			...
			{
				//Place it here:
				EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraViviparus.class).toString(), "", (double) target.getX() + 0.5D, (double) target.getY(), (double) target.getZ() + 0.5D);
				return true;
			}
			return false;
		}
