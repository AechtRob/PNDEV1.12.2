...
public class ItemBucketOfMob extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/reticulolepis_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/deltoptychius_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/fadenia_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/megactenoptetalus_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/eretomorphis_bucket", "inventory"),
