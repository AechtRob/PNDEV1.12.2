...
public class ItemBucketOfMob extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/tribrachidium_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/rhynchonkos_bucket", "inventory"),
