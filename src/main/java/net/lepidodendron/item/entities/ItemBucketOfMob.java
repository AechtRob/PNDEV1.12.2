...
public class ItemBucketOfMob extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/triops1_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/triops2_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/triops3_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/ischyodus_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/megasecoptera_nymph_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/echinochimaera_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/pseudorhina_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/phorcynis_bucket", "inventory"),
