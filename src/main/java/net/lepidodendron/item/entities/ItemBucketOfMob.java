...
public class ItemBucketOfMob extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/heteropetalus_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/harpagofututor_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/pseudangustidontus_bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/flagellopantopus_bucket", "inventory"),
				new ModelResourceLocation("lepidodendron:entities/waaganella_bucket", "inventory"),
