...
public class ItemBucketOfMob extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/megapterygius _bucket", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/anomalochelys_bucket", "inventory"),
