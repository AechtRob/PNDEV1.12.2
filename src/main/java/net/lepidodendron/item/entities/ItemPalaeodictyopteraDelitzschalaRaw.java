...
public class ItemPalaeodictyopteraDelitzschalaRaw extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:palaeodictyoptera_delitzschala_raw")
	public static final Item block = null;
	public ItemPalaeodictyopteraDelitzschalaRaw(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/palaeodictyoptera_delitzschala_raw", "inventory"));
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("listAllinsectraw", ItemPalaeodictyopteraDelitzschalaRaw.block);
		OreDictionary.registerOre("foodInsect", ItemPalaeodictyopteraDelitzschalaRaw.block);
		OreDictionary.registerOre("pndietBug", ItemPalaeodictyopteraDelitzschalaRaw.block);
	}
