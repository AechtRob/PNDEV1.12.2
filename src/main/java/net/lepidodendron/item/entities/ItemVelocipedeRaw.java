...
public class ItemVelocipedeRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_myriapod@velocipede", ItemVelocipedeRaw.block);
		OreDictionary.registerOre("pnfurnaceBug", ItemVelocipedeRaw.block);
		OreDictionary.registerOre("pndietBug", ItemVelocipedeRaw.block);
	}
