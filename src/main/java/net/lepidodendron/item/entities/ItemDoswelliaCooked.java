...
public class ItemDoswelliaCooked extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("foodCooked", ItemDoswelliaCooked.block);
		OreDictionary.registerOre("foodMeat", ItemDoswelliaCooked.block);
		OreDictionary.registerOre("listAllmeatcooked", ItemDoswelliaCooked.block);
	}
