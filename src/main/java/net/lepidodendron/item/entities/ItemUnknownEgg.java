...
public class ItemUnknownEgg extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eggs_unknown")
	public static final Item block = null;
	public ItemUnknownEgg(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eggs_unknown);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/eggs_unknown", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_eggs_unknown");
			setRegistryName("eggs_unknown");
