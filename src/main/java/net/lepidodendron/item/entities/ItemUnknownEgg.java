...
public class ItemUnknownEgg extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelBakery.registerItemVariants(block,
				...
				new ModelResourceLocation("lepidodendron:entities/egg_prehistoric_flora_reticulolepis", "inventory"),
				...
				new ModelResourceLocation("lepidodendron:entities/egg_prehistoric_flora_syllipsimopodi", "inventory"),
