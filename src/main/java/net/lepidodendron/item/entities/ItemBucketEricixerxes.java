...
public class ItemBucketEricixerxes extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ericixerxes_bucket")
	public static final Item block = null;

	public ItemBucketEricixerxes(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.ericixerxes_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/ericixerxes_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_ericixerxes_bucket");
			setRegistryName("ericixerxes_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraEricixerxes.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Type: (Dubious) Arthropod");
				tooltip.add("Periods: Ordovician? - Silurian?");
				tooltip.add("Habitat: Water, can briefly walk on land");
