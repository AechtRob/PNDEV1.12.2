...
public class ItemBucketJellyfish_Precambrian extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jellyfish_precambrian_bucket")
	public static final Item block = null;

	public ItemBucketJellyfish_Precambrian(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.jellyfish_precambrian_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/jellyfish_precambrian_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_jellyfish_precambrian_bucket");
			setRegistryName("jellyfish_precambrian_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraJellyfish_Precambrian.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
