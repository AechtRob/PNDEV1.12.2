...
public class ItemUnknownEdiacaranBlob extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:blob_unknown")
	public static final Item block = null;
	public ItemUnknownEdiacaranBlob(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.blob_unknown);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/blob_unknown", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_blob_unknown");
			setRegistryName("blob_unknown");
		...
		public String getTranslationKey(ItemStack stack)
		{
			...
			if (stringEgg != null) {
				stringEgg = stringEgg.replace(LepidodendronMod.MODID.toString() + ":", "reproductive_blob_");
