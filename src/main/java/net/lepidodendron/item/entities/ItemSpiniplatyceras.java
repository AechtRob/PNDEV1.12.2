...
public class ItemSpiniplatyceras extends ElementsLepidodendronMod.ModElement {
	...
	public ItemSpiniplatyceras(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.spiniplatyceras_item);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_spiniplatyceras_item");
