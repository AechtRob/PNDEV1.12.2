...
public class ItemBucketDunkleosteus extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:dunkleosteus_bucket")
	public static final Item block = null;

	public ItemBucketDunkleosteus(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.dunkleosteus_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/dunkleosteus_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_dunkleosteus_bucket");
			setRegistryName("dunkleosteus_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraDunkleosteus.class).toString(), "{AgeTicks:0}", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
