...
public class ItemFulmenocursorRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_myriapod@fulmenocursor", ItemFulmenocursorRaw.block);
		OreDictionary.registerOre("pnfurnaceBug", ItemFulmenocursorRaw.block);
		OreDictionary.registerOre("pndietBug", ItemFulmenocursorRaw.block);
	}
