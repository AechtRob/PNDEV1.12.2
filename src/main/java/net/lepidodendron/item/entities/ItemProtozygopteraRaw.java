...
public class ItemProtozygopteraRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pnfurnaceBug", ItemProtozygopteraRaw.block);
		OreDictionary.registerOre("pndietBug", ItemProtozygopteraRaw.block);
	}
	...
	public static class ItemFoodCustom extends ItemGlassCaseDisplayItem {
		...
		public String getMobStr() {
			return "lepidodendron:prehistoric_flora_protozygoptera";
		}
