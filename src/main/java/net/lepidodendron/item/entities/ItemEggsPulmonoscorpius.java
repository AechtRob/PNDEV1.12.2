...
public class ItemEggsPulmonoscorpius extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eggs_pulmonoscorpius")
	public static final Item block = null;
	public ItemEggsPulmonoscorpius(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eggs_pulmonoscorpius);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/eggs_pulmonoscorpius", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_eggs_pulmonoscorpius");
			setRegistryName("eggs_pulmonoscorpius");
