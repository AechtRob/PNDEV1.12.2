...
public class ItemBucketTraquairius extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:traquairius_bucket")
	public static final Item block = null;

	public ItemBucketTraquairius(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.traquairius_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/traquairius_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_traquairius_bucket");
			setRegistryName("traquairius_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraTraquairius.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
		...
		public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
			if (LepidodendronConfig.showTooltips) {
				tooltip.add("Periods: " + EntityPrehistoricFloraTraquairius.getPeriod());
				tooltip.add("Type: " + EntityPrehistoricFloraTraquairius.getHabitat() + " ratfish-like fish");
