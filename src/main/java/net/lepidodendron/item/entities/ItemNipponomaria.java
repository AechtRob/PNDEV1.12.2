...
public class ItemNipponomaria extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nipponomaria_item")
	public static final Item block = null;

	public ItemNipponomaria(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nipponomaria_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/nipponomaria_item", "inventory"));
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pnfurnaceSnail", ItemNipponomaria.block);
		OreDictionary.registerOre("pndietShellfish", ItemNipponomaria.block);
	}


	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_nipponomaria_item");
			setRegistryName("nipponomaria_item");
			maxStackSize = 1;
