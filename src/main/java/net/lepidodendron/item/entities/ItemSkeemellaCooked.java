...
public class ItemSkeemellaCooked extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("listAllfishcooked", ItemSkeemellaCooked.block);
		OreDictionary.registerOre("foodCooked", ItemSkeemellaCooked.block);
		OreDictionary.registerOre("foodMeat", ItemSkeemellaCooked.block);
		OreDictionary.registerOre("listAllmeatcooked", ItemSkeemellaCooked.block);
	}
