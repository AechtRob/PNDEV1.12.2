...
public class ItemBucketPalaeodictyopteraNymphPerm extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:palaeodictyoptera_nymph_bucket_perm")
	public static final Item block = null;

	public ItemBucketPalaeodictyopteraNymphPerm(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.palaeodictyoptera_nymph_bucket_perm);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/palaeodictyoptera_nymph_bucket_perm", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_palaeodictyoptera_nymph_bucket_perm");
			setRegistryName("palaeodictyoptera_nymph_bucket_perm");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraPalaeodictyopteraNymphPerm.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
