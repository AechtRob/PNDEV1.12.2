...
public class ItemBucketJellyfish_Palaeo4 extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jellyfish_palaeo_4_bucket")
	public static final Item block = null;

	public ItemBucketJellyfish_Palaeo4(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.jellyfish_palaeo_4_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/jellyfish_palaeo_4_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_jellyfish_palaeo_4_bucket");
			setRegistryName("jellyfish_palaeo_4_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraJellyfish_Palaeo4.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
