...
public class ItemPoleumita extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:poleumita_item")
	public static final Item block = null;

	public ItemPoleumita(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.poleumita_item);
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pnfurnaceSnail", ItemPoleumita.block);
		OreDictionary.registerOre("pndietShellfish", ItemPoleumita.block);
	}


	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_poleumita_item");
			setRegistryName("poleumita_item");
			maxStackSize = 1;
