...
public class ItemUnknownPlanula extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eggs_generic_planula")
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pnfurnaceSeafood", ItemUnknownPlanula.block);
	}
...
//		});
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_eggs_generic_planula");
			setRegistryName("eggs_generic_planula");
			setCreativeTab(null);
			setMaxStackSize(64);
		}
		...
		public String getItemStackDisplayName(ItemStack stack)
		{
			...
			if (stringEgg != null) {
				...
				return I18n.translateToLocal("item.pf_eggs_generic_planula_full.name").trim()
						+ ": "
