...
public class ItemPolydesmidRaw extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/myriapod_polydesmid_raw", "inventory"));
	}

	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("mobdnaPNlepidodendron:prehistoric_flora_myriapod@polydesmid", ItemPolydesmidRaw.block);
		OreDictionary.registerOre("pnfurnaceBug", ItemPolydesmidRaw.block);
		OreDictionary.registerOre("pndietBug", ItemPolydesmidRaw.block);
	}
