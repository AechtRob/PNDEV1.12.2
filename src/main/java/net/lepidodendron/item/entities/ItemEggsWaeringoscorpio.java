...
public class ItemEggsWaeringoscorpio extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:eggs_waeringoscorpio")
	public static final Item block = null;
	public ItemEggsWaeringoscorpio(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.eggs_waeringoscorpio);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/eggs_waeringoscorpio", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_eggs_waeringoscorpio");
			setRegistryName("eggs_waeringoscorpio");
