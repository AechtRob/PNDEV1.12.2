...
public class ItemBucketSaurichthysFreshwater extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:saurichthys_freshwater_bucket")
	public static final Item block = null;

	public ItemBucketSaurichthysFreshwater(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.saurichthys_freshwater_bucket);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/saurichthys_freshwater_bucket", "inventory"));
	}

	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_saurichthys_freshwater_bucket");
			setRegistryName("saurichthys_freshwater_bucket");
			maxStackSize = 1;
				...
				else
				{
					...
					else
					{
						...
						if (MobSpawn == null && !(worldIn.isRemote)) {
							EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraSaurichthysFreshwater.class).toString(), "", (double) posIn.getX() + 0.5D, (double) posIn.getY(), (double) posIn.getZ() + 0.5D);
						}
					}
