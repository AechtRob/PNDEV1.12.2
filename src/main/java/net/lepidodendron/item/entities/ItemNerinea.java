...
public class ItemNerinea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nerinea_item")
	public static final Item block = null;

	public ItemNerinea(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nerinea_item);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/nerinea_item", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setTranslationKey("pf_nerinea_item");
			setRegistryName("nerinea_item");
			maxStackSize = 1;
		...
		public static boolean placeEntity(ItemStack stack, World worldIn, BlockPos target, EntityPlayer player, @Nullable EnumHand hand)
		{
			...
			{
				//Place it here:
				EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraNerinea.class).toString(), "", (double) target.getX() + 0.5D, (double) target.getY(), (double) target.getZ() + 0.5D);
				return true;
			}
			return false;
		}
