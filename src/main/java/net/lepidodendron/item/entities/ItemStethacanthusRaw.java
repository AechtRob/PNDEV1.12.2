...
public class ItemStethacanthusRaw extends ElementsLepidodendronMod.ModElement {
	...
	public ItemStethacanthusRaw(ElementsLepidodendronMod instance) {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/stethacanthus_raw", "inventory"));
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		OreDictionary.registerOre("pnfurnaceFish", ItemStethacanthusRaw.block);
		OreDictionary.registerOre("pndietFish", ItemStethacanthusRaw.block);
	}

	public static class ItemFoodCustom extends ItemPNTaxidermyItem {
		public ItemFoodCustom() {
			super(2, 0.1f, false);
			setTranslationKey("pf_stethacanthus_raw");
