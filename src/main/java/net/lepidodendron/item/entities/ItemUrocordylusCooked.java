...
public class ItemUrocordylusCooked extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("foodCooked", ItemUrocordylusCooked.block);
		OreDictionary.registerOre("foodMeat", ItemUrocordylusCooked.block);
		OreDictionary.registerOre("listAllmeatcooked", ItemUrocordylusCooked.block);
	}
