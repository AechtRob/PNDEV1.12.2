...
public class ItemPrototaxitesChunk extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:prototaxites_chunk")
	public static final Item block = null;
	public ItemPrototaxitesChunk(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.prototaxites_chunk);
	}
