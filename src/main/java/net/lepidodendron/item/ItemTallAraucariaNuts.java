...
public class ItemTallAraucariaNuts extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mirabilis_nuts")
	public static final Item block = null;
	public ItemTallAraucariaNuts(ElementsLepidodendronMod instance) {
	...
	public void init(FMLInitializationEvent event) {
		super.init(event);
		OreDictionary.registerOre("pndietSeed", ItemTallAraucariaNuts.block);
		OreDictionary.registerOre("foodPinenuts", ItemTallAraucariaNuts.block);
	}
