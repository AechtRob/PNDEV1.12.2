...
public class EntityPrehistoricFloraLotosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLotosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderLotosaurus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LOTOSAURUS;
	}
