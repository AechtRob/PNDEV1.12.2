...
public class EntityPrehistoricFloraLuoxiongichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LUOXIONGICHTHYS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLuoxiongichthys;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LUOXIONGICHTHYS;
	}
