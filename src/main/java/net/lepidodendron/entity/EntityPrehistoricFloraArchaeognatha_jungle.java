...
public class EntityPrehistoricFloraArchaeognatha_jungle extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	protected void collideWithEntity(Entity entityIn) {
		...
		if(this.getIsMoving() && (!this.isJumping) && this.onGround && !this.isReallyInWater() && !this.getIsLaunching()){
			this.jump();
			this.setAnimation(this.JUMP_ANIMATION);
		}
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.moveTicks = rand.nextInt(8) + 20;
		return livingdata;
	}
	...
	public void onLivingUpdate() {
		...
		if (this.moveTicks > 0) {
			this.moveTicks -= rand.nextInt(3) + 1;
		}
		if (this.moveTicks <= 0) {
			this.moveTicks = rand.nextInt(8) + 20;
		}
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, EAT_ANIMATION, JUMP_ANIMATION};
	}
	...
	public static String getPeriod() {return "Devonian - Carboniferous - Permian - Triassic - Jurassic - Early Cretaceous - Late Cretaceous - Paleogene - Neogene - Pleistocene";}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ARCHAEOGNATHA_JUNGLE_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCHAEOGNATHA_JUNGLE;
	}
