...
public class EntityPrehistoricFloraAdamanteryon extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraAdamanteryon(World world) {
		super(world);
		setSize(0.25F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ADAMANTERYON_LOOT;
	}
