...
import net.lepidodendron.entity.render.entity.RenderUrokodia;
...
public class EntityPrehistoricFloraTitanokorys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTitanokorys(World world) {
		super(world);
		setSize(0.5F, 0.4F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TITANOKORYS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTitanokorys;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTitanokorys.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TITANOKORYS;
	}
}