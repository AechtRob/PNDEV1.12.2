...
public class EntityPrehistoricFloraEbenaqua extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EBENAQUA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelEbenaqua;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderEbenaqua.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EBENAQUA;
	}
