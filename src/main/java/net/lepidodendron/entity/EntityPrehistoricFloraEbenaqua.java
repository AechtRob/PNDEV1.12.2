...
import net.lepidodendron.item.entities.ItemBucketEbenaqua;
...
public class EntityPrehistoricFloraEbenaqua extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEbenaqua.block, (int) (1));
