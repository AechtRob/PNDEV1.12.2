...
import net.lepidodendron.entity.render.entity.RenderMieridduryn;
...
public class EntityPrehistoricFloraMieridduryn extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMieridduryn(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MIERIDDURYN_LOOT;
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.34;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderMieridduryn.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelMieridduryn;}
	public static float getScaler(@Nullable String variant) {return RenderMieridduryn.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.02F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MIERIDDURYN;
	}
}