...
public class EntityPrehistoricFloraPleurosaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPleurosaurus(World world) {
		super(world);
		setSize(0.4F, 0.35F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntitySquid.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PLEUROSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLEUROSAURUS;
	}
	//Rendering taxidermy:
	//--------------------
