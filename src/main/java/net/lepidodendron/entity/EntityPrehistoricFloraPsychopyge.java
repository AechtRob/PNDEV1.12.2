...
public class EntityPrehistoricFloraPsychopyge extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPsychopyge(World world) {
		super(world);
		setSize(0.25F, 0.15F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PSYCHOPYGE;
	}
}