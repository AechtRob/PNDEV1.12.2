...
import net.lepidodendron.item.entities.ItemFerussina;
...
public class EntityPrehistoricFloraFerussina extends EntityPrehistoricFloraLandSlitheringBase implements ITrappableAir {
	...
	public EntityPrehistoricFloraFerussina(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
	...
	public static String getPeriod() {return "Late Cretaceous - Palaeogene";}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemFerussina.block, (int) (1)));
