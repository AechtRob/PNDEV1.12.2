...
import net.lepidodendron.entity.render.entity.RenderManidens;
...
public class EntityPrehistoricFloraManidens extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraManidens(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.03F;
		maxWidth = 0.25F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraManidens> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraManidens.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraManidens currentYinlong : Yinlong) {
	...
	public int getDrinkLength() {
		return 315;  //grazes, does not drink
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MANIDENS_LOOT;
	}
    @Nullable
    @Override
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_MANIDENS;
    }
	//Rendering taxidermy:
	//--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderManidens.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelManidens;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderManidens.getScaler();
    }
