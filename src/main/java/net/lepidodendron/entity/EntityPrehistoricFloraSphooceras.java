...
public class EntityPrehistoricFloraSphooceras extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsSphooceras.block, (int) (1));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SPHOOCERAS;
	}
}
