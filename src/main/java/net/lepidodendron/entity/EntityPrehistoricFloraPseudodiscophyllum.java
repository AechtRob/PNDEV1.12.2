...
public class EntityPrehistoricFloraPseudodiscophyllum extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraPseudodiscophyllum(World world) {
        super(world);
        setSize(0.1F, 0.1F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_PSEUDODISCOPHYLLUM;
    }
