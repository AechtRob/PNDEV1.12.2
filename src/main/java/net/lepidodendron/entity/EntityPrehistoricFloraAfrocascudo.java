...
import net.lepidodendron.entity.render.entity.RenderAfrocascudo;
...
public class EntityPrehistoricFloraAfrocascudo extends EntityPrehistoricFloraAquaticSticker implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAfrocascudo(World world) {
		super(world);
		setSize(0.15F, 0.1F);
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_AFROCASCUDO;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AFROCASCUDO_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAfrocascudo.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAfrocascudo;}
	public static float getScaler(@Nullable String variant) {return RenderAfrocascudo.getScaler();}
