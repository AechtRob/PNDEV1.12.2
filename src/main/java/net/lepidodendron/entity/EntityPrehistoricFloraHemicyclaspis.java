...
import net.lepidodendron.item.entities.ItemBucketHemicyclaspis;
...
public class EntityPrehistoricFloraHemicyclaspis extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraHemicyclaspis(World world) {
		super(world);
		setSize(0.6F, 0.5F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HEMICYCLASPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHemicyclaspis.block, (int) (1));
