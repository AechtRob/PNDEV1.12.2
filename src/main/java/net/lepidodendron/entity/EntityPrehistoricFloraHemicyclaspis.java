...
public class EntityPrehistoricFloraHemicyclaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHemicyclaspis;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HEMICYCLASPIS;
	}
