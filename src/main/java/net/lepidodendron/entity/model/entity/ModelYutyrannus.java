...
public class ModelYutyrannus extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(throat2, -0.1353F, 0.0F, 0.0F);
        this.setRotateAngle(throat, -0.2225F, 0.0F, 0.0F);
        this.setRotateAngle(tail6, 0.0F, 0.4669F, 0.0F);
        this.setRotateAngle(tail5, 0.0F, 0.1396F, 0.0F);
        this.setRotateAngle(tail4, 0.0F, 0.4102F, 0.0F);
        this.setRotateAngle(tail3, 0.0F, 0.2182F, 0.0F);
        this.setRotateAngle(tail2, 0.0F, 0.1004F, 0.0F);
        this.setRotateAngle(tail, 0.0916F, 0.1178F, 0.0F);
        this.setRotateAngle(rightleg3, 0.1484F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg2, -0.1833F, 0.0F, 0.0F);
        this.setRotateAngle(righthand, 0.0F, 0.0F, -0.3752F);
        this.setRotateAngle(rightfoot, 0.2138F, 0.0F, 0.0F);
        this.setRotateAngle(rightarm2, 0.3796F, 0.0F, 0.0F);
        this.setRotateAngle(rightarm, -0.1789F, -0.1571F, 0.0F);
        this.setRotateAngle(neckfeathers3, 0.5192F, 0.0F, 0.0F);
        this.setRotateAngle(neckfeathers2, 0.6632F, 0.0F, 0.0F);
        this.setRotateAngle(neckfeathers, 0.6501F, 0.0F, 0.0F);
        this.setRotateAngle(neck4, 0.2269F, 0.0039F, -0.017F);
        this.setRotateAngle(neck3, 0.3054F, 0.0052F, -0.0166F);
        this.setRotateAngle(neck2, -0.0044F, -0.0003F, -0.0698F);
        this.setRotateAngle(neck, 0.0415F, 0.0083F, -0.1781F);
        this.setRotateAngle(lefttoe, -0.7374F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg3, -0.1004F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg2, 0.1658F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg, 0.2923F, 0.0F, 0.0F);
        this.setRotateAngle(lefthand, 0.0F, 0.0F, 0.24F);
        this.setRotateAngle(leftfoot, 0.576F, 0.0F, 0.0F);
        this.setRotateAngle(leftarm2, -0.3272F, 0.0F, 0.0F);
        this.setRotateAngle(leftarm, 0.3991F, 0.3074F, 0.0277F);
        this.setRotateAngle(jaw, -0.2138F, 0.0F, 0.0F);
        this.setRotateAngle(hips, -0.1833F, 0.0F, 0.0F);
        this.setRotateAngle(headcresttop, 0.4887F, 0.0F, 0.0F);
        this.setRotateAngle(head, 0.0664F, -0.1698F, -0.0112F);
        this.setRotateAngle(cube_r9, -0.2618F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r8, 0.0F, 0.1745F, 1.5708F);
        this.setRotateAngle(cube_r71, 0.0436F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r70, 0.6109F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(cube_r10, -0.0436F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r1, -0.2182F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.0742F, 0.0F, 0.0F);
        this.setRotateAngle(body, -0.0393F, 0.0F, 0.0F);
        this.hips.offsetY = -0.153F;
