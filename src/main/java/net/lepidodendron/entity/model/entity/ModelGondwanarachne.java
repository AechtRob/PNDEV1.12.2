...
public class ModelGondwanarachne extends ModelBasePalaeopedia {

    private final AdvancedModelRenderer body;
    private final AdvancedModelRenderer headkreish_r1;
    private final AdvancedModelRenderer headkreish_r2;
    private final AdvancedModelRenderer headkreish_r3;
    ...
    public ModelGondwanarachne() {
        this.textureWidth = 44;
        this.textureHeight = 32;

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 23.25F, -4.0F);
        this.body.cubeList.add(new ModelBox(body, 24, 25, -2.0F, -0.9F, 1.65F, 4, 1, 2, 0.0F, false));

        this.headkreish_r1 = new AdvancedModelRenderer(this);
        this.headkreish_r1.setRotationPoint(0.0F, -0.55F, 1.0F);
        this.body.addChild(headkreish_r1);
        this.setRotateAngle(headkreish_r1, 0.0873F, 0.0F, 0.0F);
        this.headkreish_r1.cubeList.add(new ModelBox(headkreish_r1, 3, 0, -0.5F, -0.3F, -2.65F, 1, 0, 2, 0.0F, false));

        this.headkreish_r2 = new AdvancedModelRenderer(this);
        this.headkreish_r2.setRotationPoint(0.0F, -0.15F, 2.05F);
        this.body.addChild(headkreish_r2);
        this.setRotateAngle(headkreish_r2, 0.0873F, 0.0F, 0.0F);
        this.headkreish_r2.cubeList.add(new ModelBox(headkreish_r2, 0, 0, -0.5F, -1.0F, -1.65F, 1, 1, 3, 0.0F, false));

        this.headkreish_r3 = new AdvancedModelRenderer(this);
        this.headkreish_r3.setRotationPoint(0.75F, 0.1F, 2.5F);
        this.body.addChild(headkreish_r3);
        this.setRotateAngle(headkreish_r3, 0.0F, -0.7854F, 0.0F);
        this.headkreish_r3.cubeList.add(new ModelBox(headkreish_r3, 15, 25, -2.65F, -1.0F, -1.65F, 3, 1, 3, -0.05F, false));
        ...
        this.pedipalpR.cubeList.add(new ModelBox(pedipalpR, 19, 8, -0.75F, 0.0F, -5.75F, 2, 0, 6, 0.0F, false));
        ...
        this.pedipalpL.cubeList.add(new ModelBox(pedipalpL, 19, 8, -1.25F, 0.0F, -5.75F, 2, 0, 6, 0.0F, true));
        ...
        this.LegR1.cubeList.add(new ModelBox(LegR1, 0, 8, -8.75F, 1.0F, -7.0F, 9, 0, 7, 0.0F, false));
        ...
        this.LegL1.cubeList.add(new ModelBox(LegL1, 0, 8, -0.25F, 1.0F, -7.0F, 9, 0, 7, 0.0F, true));

        this.legR2 = new AdvancedModelRenderer(this);
        this.legR2.setRotationPoint(-1.25F, -0.25F, 1.75F);
        this.body.addChild(legR2);
        this.setRotateAngle(legR2, 1.5621F, -0.2531F, 0.6545F);
        this.legR2.cubeList.add(new ModelBox(legR2, 0, 0, -8.75F, 0.0F, -8.0F, 9, 0, 8, 0.0F, false));

        this.legL2 = new AdvancedModelRenderer(this);
        this.legL2.setRotationPoint(1.25F, -0.25F, 1.75F);
        this.body.addChild(legL2);
        this.setRotateAngle(legL2, 1.5621F, 0.2531F, -0.6545F);
        this.legL2.cubeList.add(new ModelBox(legL2, 0, 0, -0.25F, 0.0F, -8.0F, 9, 0, 8, 0.0F, true));

        this.legR3 = new AdvancedModelRenderer(this);
        this.legR3.setRotationPoint(-1.5F, -0.25F, 2.5F);
        this.body.addChild(legR3);
        this.setRotateAngle(legR3, -0.8727F, 0.1745F, 0.3491F);
        this.legR3.cubeList.add(new ModelBox(legR3, 18, 15, -8.75F, 0.0F, -0.75F, 9, 0, 6, 0.0F, false));

        this.legL3 = new AdvancedModelRenderer(this);
        this.legL3.setRotationPoint(1.5F, -0.25F, 2.5F);
        this.body.addChild(legL3);
        this.setRotateAngle(legL3, -0.8727F, -0.1745F, -0.3491F);
        this.legL3.cubeList.add(new ModelBox(legL3, 18, 15, -0.25F, 0.0F, -0.75F, 9, 0, 6, 0.0F, true));

        this.legR4 = new AdvancedModelRenderer(this);
        this.legR4.setRotationPoint(-1.5F, -0.25F, 2.5F);
        this.body.addChild(legR4);
        this.setRotateAngle(legR4, -0.8727F, 0.6545F, 0.4363F);
        this.legR4.cubeList.add(new ModelBox(legR4, 0, 15, -8.75F, 0.0F, -0.75F, 9, 0, 6, 0.0F, false));

        this.legL4 = new AdvancedModelRenderer(this);
        this.legL4.setRotationPoint(1.5F, -0.25F, 2.5F);
        this.body.addChild(legL4);
        this.setRotateAngle(legL4, -0.8727F, -0.6545F, -0.4363F);
        this.legL4.cubeList.add(new ModelBox(legL4, 0, 15, -0.25F, 0.0F, -0.75F, 9, 0, 6, 0.0F, true));

        this.abdomen = new AdvancedModelRenderer(this);
        this.abdomen.setRotationPoint(0.0F, -0.75F, 3.5F);
        this.body.addChild(abdomen);
        this.abdomen.cubeList.add(new ModelBox(abdomen, 26, 2, -2.5F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
        this.abdomen.cubeList.add(new ModelBox(abdomen, 26, 0, -2.5F, 0.0F, 4.0F, 5, 1, 1, 0.0F, false));
        this.abdomen.cubeList.add(new ModelBox(abdomen, 26, 4, -2.0F, 0.0F, 5.0F, 4, 1, 1, 0.0F, false));
        this.abdomen.cubeList.add(new ModelBox(abdomen, 13, 21, -3.0F, 0.0F, 1.0F, 6, 1, 3, 0.0F, false));
        this.abdomen.cubeList.add(new ModelBox(abdomen, 0, 21, -2.0F, -0.5F, 0.0F, 4, 1, 5, 0.01F, false));
