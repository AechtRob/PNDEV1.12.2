...
public class ModelHualianceratops extends AdvancedModelBaseExtended {
    ...
    public ModelHualianceratops() {
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 17, -2.5F, 0.0F, -0.75F, 5, 7, 6, 0.0F, false));
        ...
        this.tail2.cubeList.add(new ModelBox(tail2, 22, 17, -2.0F, -0.0872F, -1.5038F, 4, 5, 7, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 16, 16, 1.0F, -2.0872F, 0.4962F, 0, 2, 5, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 16, 16, -1.0F, -2.0872F, 0.4962F, 0, 2, 5, 0.0F, true));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(0.0F, -1.1467F, -4.6292F);
        this.tail2.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.2182F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 16, 12, 0.0F, -4.0F, 5.25F, 0, 4, 5, 0.0F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, -0.0872F, 4.4962F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, -0.0436F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 37, 10, -1.5F, 0.0F, 0.0F, 3, 3, 5, -0.01F, false));
        this.tail3.cubeList.add(new ModelBox(tail3, 9, 38, 0.5F, -2.0F, 1.0F, 0, 2, 4, 0.0F, false));
        this.tail3.cubeList.add(new ModelBox(tail3, 9, 38, -0.5F, -2.0F, 1.0F, 0, 2, 4, 0.0F, true));
        this.tail3.cubeList.add(new ModelBox(tail3, 11, 28, 0.0F, -3.0F, 1.0F, 0, 3, 4, 0.0F, false));

        this.tail4 = new AdvancedModelRenderer(this);
        this.tail4.setRotationPoint(0.0F, 0.0F, 4.0F);
        this.tail3.addChild(tail4);
        this.setRotateAngle(tail4, 0.1745F, 0.0F, 0.0F);
        this.tail4.cubeList.add(new ModelBox(tail4, 38, 35, -1.0F, 0.1305F, -0.0086F, 2, 2, 5, 0.0F, false));
        this.tail4.cubeList.add(new ModelBox(tail4, 21, 4, 0.75F, -0.8695F, 0.9914F, 0, 1, 4, 0.0F, false));
        this.tail4.cubeList.add(new ModelBox(tail4, 21, 4, -0.75F, -0.8695F, 0.9914F, 0, 1, 4, 0.0F, true));
        this.tail4.cubeList.add(new ModelBox(tail4, 0, 3, 0.325F, -1.8695F, 0.9914F, 0, 2, 4, 0.0F, false));
        this.tail4.cubeList.add(new ModelBox(tail4, 0, 3, -0.325F, -1.8695F, 0.9914F, 0, 2, 4, 0.0F, true));

        this.tail5 = new AdvancedModelRenderer(this);
        this.tail5.setRotationPoint(0.0F, 0.1305F, 4.9914F);
        this.tail4.addChild(tail5);
        this.tail5.cubeList.add(new ModelBox(tail5, 29, 35, -0.5F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));
        this.tail5.cubeList.add(new ModelBox(tail5, 0, 0, -1.5F, 0.5F, 0.0F, 1, 0, 7, 0.0F, false));
        this.tail5.cubeList.add(new ModelBox(tail5, 0, 0, 0.5F, 0.5F, 0.0F, 1, 0, 7, 0.0F, true));
        this.tail5.cubeList.add(new ModelBox(tail5, 0, 33, 0.0F, -1.0F, 0.0F, 0, 1, 7, 0.0F, false));

        this.upperbody2 = new AdvancedModelRenderer(this);
        this.upperbody2.setRotationPoint(0.0F, -15.75F, 0.5F);
        this.body.addChild(upperbody2);


        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(0.0F, 3.25F, -4.5F);
        this.upperbody2.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.0436F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 0, -3.0F, -3.5F, -4.5F, 6, 8, 9, 0.0F, false));

        this.upperbody = new AdvancedModelRenderer(this);
        this.upperbody.setRotationPoint(0.0F, -0.409F, -8.9224F);
        this.upperbody2.addChild(upperbody);
        this.setRotateAngle(upperbody, -0.1745F, 0.0F, 0.0F);


        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(0.0F, 0.034F, 0.1224F);
        this.upperbody.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.3054F, 0.0F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 20, 33, -2.0F, 0.934F, -0.046F, 4, 6, 2, 0.0F, false));
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 16, 29, -2.0F, -0.066F, -6.046F, 4, 7, 6, 0.0F, false));

        this.leftarm = new AdvancedModelRenderer(this);
        this.leftarm.setRotationPoint(1.5F, 6.034F, -3.1276F);
        this.upperbody.addChild(leftarm);
        this.setRotateAngle(leftarm, -0.7132F, 0.3751F, -0.3069F);
        this.leftarm.cubeList.add(new ModelBox(leftarm, 41, 42, -1.0F, -1.0F, 0.0F, 2, 2, 4, 0.0F, false));

        this.leftarm2 = new AdvancedModelRenderer(this);
        this.leftarm2.setRotationPoint(0.25F, 0.25F, 3.5F);
        this.leftarm.addChild(leftarm2);
        this.setRotateAngle(leftarm2, 0.4363F, 0.0F, 0.0F);
        this.leftarm2.cubeList.add(new ModelBox(leftarm2, 0, 17, -0.5F, -0.5F, -1.0F, 1, 3, 2, -0.01F, false));

        this.leftarm3 = new AdvancedModelRenderer(this);
        this.leftarm3.setRotationPoint(0.5F, 2.5F, 0.0F);
        this.leftarm2.addChild(leftarm3);
        this.setRotateAngle(leftarm3, 0.0F, 0.0F, 0.4363F);
        this.leftarm3.cubeList.add(new ModelBox(leftarm3, 8, 48, -1.0F, 0.0F, -1.0F, 1, 2, 2, 0.0F, false));

        this.rightarm = new AdvancedModelRenderer(this);
        this.rightarm.setRotationPoint(-1.5F, 6.034F, -3.1276F);
        this.upperbody.addChild(rightarm);
        this.setRotateAngle(rightarm, -0.7132F, -0.3751F, 0.3069F);
        this.rightarm.cubeList.add(new ModelBox(rightarm, 41, 42, -1.0F, -1.0F, 0.0F, 2, 2, 4, 0.0F, true));

        this.rightarm2 = new AdvancedModelRenderer(this);
        this.rightarm2.setRotationPoint(-0.25F, 0.25F, 3.5F);
        this.rightarm.addChild(rightarm2);
        this.setRotateAngle(rightarm2, 0.4363F, 0.0F, 0.0F);
        this.rightarm2.cubeList.add(new ModelBox(rightarm2, 0, 17, -0.5F, -0.5F, -1.0F, 1, 3, 2, -0.01F, true));

        this.rightarm3 = new AdvancedModelRenderer(this);
        this.rightarm3.setRotationPoint(-0.5F, 2.5F, 0.0F);
        this.rightarm2.addChild(rightarm3);
        this.setRotateAngle(rightarm3, 0.0F, 0.0F, -0.4363F);
        this.rightarm3.cubeList.add(new ModelBox(rightarm3, 8, 48, 0.0F, 0.0F, -1.0F, 1, 2, 2, 0.0F, true));
        ...
        this.neck.cubeList.add(new ModelBox(neck, 0, 30, -1.0F, -1.0F, -3.0F, 3, 5, 5, 0.0F, false));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 21, 0, 0.5F, -2.025F, -2.225F, 0, 4, 4, 0.0F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(1.5F, -1.554F, -0.274F);
        this.neck.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0436F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 11, 25, 0.0F, -1.4F, -2.5F, 0, 2, 5, 0.0F, false));
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 11, 25, -2.0F, -1.4F, -2.5F, 0, 2, 5, 0.0F, true));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.5F, -0.875F, -3.0F);
        this.neck.addChild(head);
        this.setRotateAngle(head, 0.2094F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 30, 10, -1.5F, 1.0F, -5.0F, 3, 2, 3, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 40, 0, -2.0F, 3.0F, -2.0F, 4, 2, 2, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 41, 29, -2.5F, 0.0F, -2.0F, 5, 3, 2, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 48, 10, -1.5F, 1.0F, -6.0F, 3, 2, 1, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 0, 48, -1.0F, 1.975F, -7.675F, 2, 1, 2, -0.01F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(1.5F, 1.075F, -4.75F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, 0.2618F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 25, 22, -0.675F, -0.5F, -0.5F, 1, 1, 1, 0.0F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-1.5F, 1.075F, -4.75F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, -0.2618F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 25, 22, -0.325F, -0.5F, -0.5F, 1, 1, 1, 0.0F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.0F, 1.875F, -7.65F);
        this.head.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 1.1126F, 0.0F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 30, 15, -1.0F, 0.0161F, -1.0247F, 2, 1, 1, 0.01F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(0.9F, 3.475F, -6.175F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, -0.9163F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 1, -0.025F, -0.825F, -1.4F, 0, 1, 1, 0.0F, true));
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 1, -1.775F, -0.825F, -1.4F, 0, 1, 1, 0.0F, false));
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 2, 1, 0.0F, -1.125F, -1.125F, 0, 1, 1, 0.0F, true));
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 2, 1, -1.8F, -1.125F, -1.125F, 0, 1, 1, 0.0F, false));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(-1.5F, 2.0F, -6.0F);
        this.head.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, -0.48F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 30, 0, 0.0F, -0.5F, -1.0F, 1, 1, 1, 0.0F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(0.0F, 0.6199F, -6.1407F);
        this.head.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.6894F, 0.0F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 47, 18, -1.0F, 0.0123F, -1.9856F, 2, 1, 2, 0.0F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, -0.3801F, -4.4407F);
        this.head.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.5236F, 0.0F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 30, 43, -1.5F, 0.0283F, -1.9579F, 3, 1, 2, -0.001F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(0.0F, 0.0F, -1.5F);
        this.head.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.2618F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 37, 18, -1.5F, -1.1F, -2.7F, 3, 2, 4, 0.001F, false));

        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(2.5F, 2.0F, -2.0F);
        this.head.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.0F, 0.2487F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 31, 46, -1.0F, -2.0F, -3.0F, 1, 1, 3, 0.01F, true));
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 24, 43, -1.0F, -1.0F, -4.0F, 1, 2, 4, -0.001F, true));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(-2.5F, 2.0F, -2.0F);
        this.head.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 0.0F, -0.2487F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 31, 46, 0.0F, -2.0F, -3.0F, 1, 1, 3, 0.01F, false));
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 24, 43, 0.0F, -1.0F, -4.0F, 1, 2, 4, -0.001F, false));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(0.0F, 2.992F, -1.9802F);
        this.head.addChild(jaw);
        this.jaw.cubeList.add(new ModelBox(jaw, 47, 37, -1.5F, 0.008F, -1.0198F, 3, 2, 1, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 0, 1.4F, -2.992F, -2.4448F, 0, 3, 3, 0.0F, true));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 0, -1.4F, -2.992F, -2.4448F, 0, 3, 3, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 44, 24, -1.5F, 0.008F, -3.0198F, 3, 1, 2, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 28, -1.1F, -0.392F, -2.5448F, 0, 2, 2, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 28, 1.1F, -0.392F, -2.5448F, 0, 2, 2, 0.0F, true));
        this.jaw.cubeList.add(new ModelBox(jaw, 44, 27, -1.5F, 0.008F, -4.0198F, 3, 1, 1, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 0, -1.0F, 0.008F, -5.0198F, 2, 1, 1, 0.0F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(0.0F, 1.558F, -2.9948F);
        this.jaw.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.2618F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 47, 34, -1.0F, -1.0381F, -2.0244F, 2, 1, 2, -0.01F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(0.0F, 2.008F, -1.0198F);
        this.jaw.addChild(cube_r18);
        this.setRotateAngle(cube_r18, -0.2182F, 0.0F, 0.0F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 21, 0, -1.5F, -1.0F, -3.0F, 3, 1, 3, -0.001F, false));

        this.cube_r19 = new AdvancedModelRenderer(this);
        this.cube_r19.setRotationPoint(1.5F, 0.008F, -3.4448F);
        this.jaw.addChild(cube_r19);
        this.setRotateAngle(cube_r19, -0.7418F, 0.0F, 0.0F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 16, -0.125F, -2.0F, 0.0F, 0, 2, 1, 0.0F, true));
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 16, -2.875F, -2.0F, 0.0F, 0, 2, 1, 0.0F, false));

        this.leftleg = new AdvancedModelRenderer(this);
        this.leftleg.setRotationPoint(2.5F, -10.6565F, 1.4809F);
        this.body.addChild(leftleg);
        this.setRotateAngle(leftleg, -0.3927F, 0.0F, 0.0F);
        this.leftleg.cubeList.add(new ModelBox(leftleg, 30, 0, -1.5F, -2.9435F, -2.7309F, 3, 6, 4, 0.0F, false));

        this.leftleg2 = new AdvancedModelRenderer(this);
        this.leftleg2.setRotationPoint(0.0F, 2.8221F, -2.4795F);
        this.leftleg.addChild(leftleg2);
        this.setRotateAngle(leftleg2, 0.829F, 0.0F, 0.0F);
        this.leftleg2.cubeList.add(new ModelBox(leftleg2, 14, 42, -1.0F, 0.0056F, -0.1212F, 2, 5, 3, 0.0F, false));

        this.leftleg3 = new AdvancedModelRenderer(this);
        this.leftleg3.setRotationPoint(0.0F, 4.25F, 1.125F);
        this.leftleg2.addChild(leftleg3);
        this.setRotateAngle(leftleg3, -0.48F, 0.0F, 0.0F);
        this.leftleg3.cubeList.add(new ModelBox(leftleg3, 44, 4, -1.0F, 0.1084F, -0.6345F, 2, 4, 2, -0.01F, false));

        this.leftleg4 = new AdvancedModelRenderer(this);
        this.leftleg4.setRotationPoint(0.0F, 3.6084F, 0.3655F);
        this.leftleg3.addChild(leftleg4);
        this.setRotateAngle(leftleg4, 0.0436F, 0.0F, 0.0F);
        this.leftleg4.cubeList.add(new ModelBox(leftleg4, 30, 29, -1.5F, 0.0F, -4.0F, 3, 1, 5, 0.0F, false));

        this.rightleg = new AdvancedModelRenderer(this);
        this.rightleg.setRotationPoint(-2.5F, -10.6565F, 1.4809F);
        this.body.addChild(rightleg);
        this.setRotateAngle(rightleg, -0.3927F, 0.0F, 0.0F);
        this.rightleg.cubeList.add(new ModelBox(rightleg, 30, 0, -1.5F, -2.9435F, -2.7309F, 3, 6, 4, 0.0F, true));

        this.rightleg2 = new AdvancedModelRenderer(this);
        this.rightleg2.setRotationPoint(0.0F, 2.8221F, -2.4795F);
        this.rightleg.addChild(rightleg2);
        this.setRotateAngle(rightleg2, 0.829F, 0.0F, 0.0F);
        this.rightleg2.cubeList.add(new ModelBox(rightleg2, 14, 42, -1.0F, 0.0056F, -0.1212F, 2, 5, 3, 0.0F, true));

        this.rightleg3 = new AdvancedModelRenderer(this);
        this.rightleg3.setRotationPoint(0.0F, 4.25F, 1.125F);
        this.rightleg2.addChild(rightleg3);
        this.setRotateAngle(rightleg3, -0.48F, 0.0F, 0.0F);
        this.rightleg3.cubeList.add(new ModelBox(rightleg3, 44, 4, -1.0F, 0.1084F, -0.6345F, 2, 4, 2, -0.01F, true));

        this.rightleg4 = new AdvancedModelRenderer(this);
        this.rightleg4.setRotationPoint(0.0F, 3.6084F, 0.3655F);
        this.rightleg3.addChild(rightleg4);
        this.setRotateAngle(rightleg4, 0.0436F, 0.0F, 0.0F);
        this.rightleg4.cubeList.add(new ModelBox(rightleg4, 30, 29, -1.5F, 0.0F, -4.0F, 3, 1, 5, 0.0F, true));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraHualianceratops EntityHualianceratops = (EntityPrehistoricFloraHualianceratops) e;
        ...
        EntityHualianceratops.tailBuffer.applyChainSwingBuffer(Tail);

        if (EntityHualianceratops.getAnimation() == EntityHualianceratops.LAY_ANIMATION) {
            //this.chainSwing(Neck, 0.5F, 0.10F, 0.5, f2, 0.8F);
            //this.chainWave(Neck, 0.5F * 2, -0.02F, 0.5F, f2, 0.8F);
        }
        else {
            if (!EntityHualianceratops.isReallyInWater()) {

                if (f3 == 0.0F || !EntityHualianceratops.getIsMoving()) {
                    if (EntityHualianceratops.getAnimation() != EntityHualianceratops.EAT_ANIMATION
                        && EntityHualianceratops.getAnimation() != EntityHualianceratops.DRINK_ANIMATION) {
                ...
                if (EntityHualianceratops.getIsFast()) { //Running
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraHualianceratops ee = (EntityPrehistoricFloraHualianceratops) entitylivingbaseIn;
    ...
    public void animNoise(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraHualianceratops entity = (EntityPrehistoricFloraHualianceratops) entitylivingbaseIn;
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraHualianceratops e = (EntityPrehistoricFloraHualianceratops) entity;
