...
public class ModelCyrtoceras extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        //Start of pose:
        this.setRotateAngle(body, -0.6F, 0.8F, -0.2F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        AdvancedModelRendererExtended[] tentacle3 = {this.leg3, this.cube_r6};
        AdvancedModelRendererExtended[] tentacle4 = {this.leg4, this.cube_r8};
        AdvancedModelRendererExtended[] tentacle5 = {this.leg5, this.cube_r10};
        AdvancedModelRendererExtended[] tentacle6 = {this.leg6, this.cube_r3};
        AdvancedModelRendererExtended[] tentacle7 = {this.leg7, this.cube_r5};
        AdvancedModelRendererExtended[] tentacle8 = {this.leg8, this.cube_r7};
        AdvancedModelRendererExtended[] tentacle9 = {this.leg9, this.cube_r11};
        AdvancedModelRendererExtended[] tentacle10 = {this.leg10, this.cube_r9};
