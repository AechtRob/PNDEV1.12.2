...
public class ModelAustropotamobius extends ModelBasePalaeopedia {
    ...
    public ModelAustropotamobius() {
        this.textureWidth = 40;
        this.textureHeight = 40;

        this.bone = new AdvancedModelRenderer(this);
        this.bone.setRotationPoint(0.0F, 24.8F, 0.0F);
        this.bone.cubeList.add(new ModelBox(bone, 0, 13, -1.5F, -5.5F, -6.0F, 3, 2, 4, 0.02F, false));
        this.bone.cubeList.add(new ModelBox(bone, 14, 13, -1.5F, -4.0F, -6.0F, 3, 1, 4, 0.0F, false));
        this.bone.cubeList.add(new ModelBox(bone, 0, 30, -1.0F, -5.5F, -7.0F, 2, 2, 1, 0.02F, false));
        this.bone.cubeList.add(new ModelBox(bone, 10, 21, -0.5F, -5.5F, -8.0F, 1, 0, 1, 0.0F, false));

        this.eyeR = new AdvancedModelRenderer(this);
        this.eyeR.setRotationPoint(-0.25F, -4.5F, -6.9F);
        this.bone.addChild(eyeR);
        this.setRotateAngle(eyeR, 0.0F, 0.2182F, 0.0F);
        this.eyeR.cubeList.add(new ModelBox(eyeR, 10, 19, -0.85F, -1.0F, -1.0F, 1, 1, 1, 0.0F, false));

        this.eyeL = new AdvancedModelRenderer(this);
        this.eyeL.setRotationPoint(0.25F, -4.5F, -6.9F);
        this.bone.addChild(eyeL);
        this.setRotateAngle(eyeL, 0.0F, -0.2182F, 0.0F);
        this.eyeL.cubeList.add(new ModelBox(eyeL, 10, 19, -0.15F, -1.0F, -1.0F, 1, 1, 1, 0.0F, true));

        this.antennaR = new AdvancedModelRenderer(this);
        this.antennaR.setRotationPoint(-0.25F, -4.75F, -7.0F);
        this.bone.addChild(antennaR);
        this.setRotateAngle(antennaR, -0.1309F, 0.1309F, -0.1309F);
        this.antennaR.cubeList.add(new ModelBox(antennaR, 0, 0, 0.0F, -2.5F, -10.0F, 0, 3, 10, 0.0F, false));

        this.antennaL = new AdvancedModelRenderer(this);
        this.antennaL.setRotationPoint(0.25F, -4.75F, -7.0F);
        this.bone.addChild(antennaL);
        this.setRotateAngle(antennaL, -0.1309F, -0.1309F, 0.1309F);
        this.antennaL.cubeList.add(new ModelBox(antennaL, 0, 0, 0.0F, -2.5F, -10.0F, 0, 3, 10, 0.0F, true));

        this.antennaR2 = new AdvancedModelRenderer(this);
        this.antennaR2.setRotationPoint(-0.025F, -4.75F, -6.5F);
        this.bone.addChild(antennaR2);
        this.setRotateAngle(antennaR2, 0.1745F, 0.1309F, 0.0F);
        this.antennaR2.cubeList.add(new ModelBox(antennaR2, 28, 8, 0.0F, -0.5F, -3.0F, 0, 1, 3, 0.0F, false));

        this.antennaL2 = new AdvancedModelRenderer(this);
        this.antennaL2.setRotationPoint(0.025F, -4.75F, -6.5F);
        this.bone.addChild(antennaL2);
        this.setRotateAngle(antennaL2, 0.1745F, -0.1309F, 0.0F);
        this.antennaL2.cubeList.add(new ModelBox(antennaL2, 28, 8, 0.0F, -0.5F, -3.0F, 0, 1, 3, 0.0F, true));
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 16, 30, -0.1F, -0.5F, -1.0F, 1, 1, 2, -0.02F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(0.25F, 0.0F, -0.5F);
        this.armR.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 0.1745F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 24, 29, -0.65F, -0.5F, -1.0F, 1, 1, 2, -0.01F, false));

        this.armR2 = new AdvancedModelRenderer(this);
        this.armR2.setRotationPoint(-0.15F, 0.0F, -2.3F);
        this.armR.addChild(armR2);
        this.setRotateAngle(armR2, 0.0F, -0.2618F, 0.0F);
        this.armR2.cubeList.add(new ModelBox(armR2, 20, 7, -0.35F, -0.5F, -2.0F, 1, 1, 3, 0.01F, false));
        this.armR2.cubeList.add(new ModelBox(armR2, 16, 26, -0.05F, -0.5F, -2.0F, 1, 1, 3, 0.0F, false));

        this.armR3 = new AdvancedModelRenderer(this);
        this.armR3.setRotationPoint(0.3F, 0.0F, -1.65F);
        this.armR2.addChild(armR3);
        this.setRotateAngle(armR3, 0.0F, -0.4363F, 0.0F);
        this.armR3.cubeList.add(new ModelBox(armR3, 28, 0, -0.75F, -0.5F, -1.5F, 2, 1, 2, 0.02F, false));
        this.armR3.cubeList.add(new ModelBox(armR3, 24, 18, -0.8F, -0.5F, -4.0F, 1, 1, 3, 0.01F, false));

        this.clawR = new AdvancedModelRenderer(this);
        this.clawR.setRotationPoint(0.85F, 0.0F, -2.3F);
        this.armR3.addChild(clawR);
        this.setRotateAngle(clawR, 0.0F, -0.3927F, 0.0F);
        this.clawR.cubeList.add(new ModelBox(clawR, 24, 22, -0.25F, -0.5F, -1.5F, 1, 1, 3, -0.01F, false));
        ...
        this.armL.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, -0.1745F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 16, 30, -0.9F, -0.5F, -1.0F, 1, 1, 2, -0.02F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-0.25F, 0.0F, -0.5F);
        this.armL.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, -0.1745F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 24, 29, -0.35F, -0.5F, -1.0F, 1, 1, 2, -0.01F, true));

        this.armL2 = new AdvancedModelRenderer(this);
        this.armL2.setRotationPoint(0.15F, 0.0F, -2.3F);
        this.armL.addChild(armL2);
        this.setRotateAngle(armL2, 0.0F, 0.2618F, 0.0F);
        this.armL2.cubeList.add(new ModelBox(armL2, 20, 7, -0.65F, -0.5F, -2.0F, 1, 1, 3, 0.01F, true));
        this.armL2.cubeList.add(new ModelBox(armL2, 16, 26, -0.95F, -0.5F, -2.0F, 1, 1, 3, 0.0F, true));

        this.armL3 = new AdvancedModelRenderer(this);
        this.armL3.setRotationPoint(-0.3F, 0.0F, -1.65F);
        this.armL2.addChild(armL3);
        this.setRotateAngle(armL3, 0.0F, 0.4363F, 0.0F);
        this.armL3.cubeList.add(new ModelBox(armL3, 28, 0, -1.25F, -0.5F, -1.5F, 2, 1, 2, 0.02F, true));
        this.armL3.cubeList.add(new ModelBox(armL3, 24, 18, -0.2F, -0.5F, -4.0F, 1, 1, 3, 0.01F, true));

        this.clawL = new AdvancedModelRenderer(this);
        this.clawL.setRotationPoint(-0.85F, 0.0F, -2.3F);
        this.armL3.addChild(clawL);
        this.setRotateAngle(clawL, 0.0F, 0.3927F, 0.0F);
        this.clawL.cubeList.add(new ModelBox(clawL, 24, 22, -0.75F, -0.5F, -1.5F, 1, 1, 3, -0.01F, true));

        this.legR = new AdvancedModelRenderer(this);
        this.legR.setRotationPoint(-1.25F, -3.0F, -4.5F);
        this.bone.addChild(legR);
        this.setRotateAngle(legR, 0.0F, 1.1781F, 0.0F);
        this.legR.cubeList.add(new ModelBox(legR, 14, 18, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, false));

        this.legL = new AdvancedModelRenderer(this);
        this.legL.setRotationPoint(1.25F, -3.0F, -4.5F);
        this.bone.addChild(legL);
        this.setRotateAngle(legL, 0.0F, -1.1781F, 0.0F);
        this.legL.cubeList.add(new ModelBox(legL, 14, 18, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, true));

        this.legfrontR = new AdvancedModelRenderer(this);
        this.legfrontR.setRotationPoint(-0.75F, -3.0F, -5.75F);
        this.bone.addChild(legfrontR);
        this.setRotateAngle(legfrontR, 0.2182F, 0.3491F, 0.0F);
        this.legfrontR.cubeList.add(new ModelBox(legfrontR, 28, 3, 0.0F, -0.95F, -3.25F, 0, 2, 3, 0.0F, false));

        this.legfrontL = new AdvancedModelRenderer(this);
        this.legfrontL.setRotationPoint(0.75F, -3.0F, -5.75F);
        this.bone.addChild(legfrontL);
        this.setRotateAngle(legfrontL, 0.2182F, -0.3491F, 0.0F);
        this.legfrontL.cubeList.add(new ModelBox(legfrontL, 28, 3, 0.0F, -0.95F, -3.25F, 0, 2, 3, 0.0F, true));

        this.legR2 = new AdvancedModelRenderer(this);
        this.legR2.setRotationPoint(-1.25F, -3.0F, -3.65F);
        this.bone.addChild(legR2);
        this.setRotateAngle(legR2, 0.0F, 1.4399F, 0.0F);
        this.legR2.cubeList.add(new ModelBox(legR2, 0, 19, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, false));

        this.legL2 = new AdvancedModelRenderer(this);
        this.legL2.setRotationPoint(1.25F, -3.0F, -3.65F);
        this.bone.addChild(legL2);
        this.setRotateAngle(legL2, 0.0F, -1.4399F, 0.0F);
        this.legL2.cubeList.add(new ModelBox(legL2, 0, 19, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, true));

        this.legR3 = new AdvancedModelRenderer(this);
        this.legR3.setRotationPoint(-1.25F, -3.0F, -2.85F);
        this.bone.addChild(legR3);
        this.setRotateAngle(legR3, 0.0F, 1.8326F, 0.0F);
        this.legR3.cubeList.add(new ModelBox(legR3, 20, 0, 0.0F, -0.75F, -4.0F, 0, 3, 4, 0.0F, false));

        this.legL3 = new AdvancedModelRenderer(this);
        this.legL3.setRotationPoint(1.25F, -3.0F, -2.85F);
        this.bone.addChild(legL3);
        this.setRotateAngle(legL3, 0.0F, -1.8326F, 0.0F);
        this.legL3.cubeList.add(new ModelBox(legL3, 20, 0, 0.0F, -0.75F, -4.0F, 0, 3, 4, 0.0F, true));

        this.legR4 = new AdvancedModelRenderer(this);
        this.legR4.setRotationPoint(-1.25F, -3.0F, -2.2F);
        this.bone.addChild(legR4);
        this.setRotateAngle(legR4, 0.0F, 2.2253F, 0.0F);
        this.legR4.cubeList.add(new ModelBox(legR4, 10, 26, 0.0F, -0.75F, -3.0F, 0, 3, 3, 0.0F, false));

        this.legL4 = new AdvancedModelRenderer(this);
        this.legL4.setRotationPoint(1.25F, -3.0F, -2.2F);
        this.bone.addChild(legL4);
        this.setRotateAngle(legL4, 0.0F, -2.2253F, 0.0F);
        this.legL4.cubeList.add(new ModelBox(legL4, 10, 26, 0.0F, -0.75F, -3.0F, 0, 3, 3, 0.0F, true));

        this.body1 = new AdvancedModelRenderer(this);
        this.body1.setRotationPoint(0.0F, -4.9F, -2.0F);
        ...
        this.body2.cubeList.add(new ModelBox(body2, 24, 26, -1.0F, -0.25F, 0.0F, 2, 1, 2, 0.01F, false));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(1.25F, 0.75F, 0.75F);
        this.body2.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.0F, 0.8727F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 30, 31, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-1.25F, 0.75F, 0.75F);
        this.body2.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, 0.0F, -0.8727F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 30, 31, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, false));

        this.pleopodR = new AdvancedModelRenderer(this);
        this.pleopodR.setRotationPoint(-0.5F, 0.75F, 1.25F);
        this.body2.addChild(pleopodR);
        this.setRotateAngle(pleopodR, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR.cubeList.add(new ModelBox(pleopodR, 12, 22, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL = new AdvancedModelRenderer(this);
        this.pleopodL.setRotationPoint(0.5F, 0.75F, 1.25F);
        this.body2.addChild(pleopodL);
        this.setRotateAngle(pleopodL, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL.cubeList.add(new ModelBox(pleopodL, 12, 22, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.body3 = new AdvancedModelRenderer(this);
        this.body3.setRotationPoint(0.0F, -0.2F, 2.25F);
        this.body2.addChild(body3);
        this.setRotateAngle(body3, -0.1309F, 0.0F, 0.0F);
        this.body3.cubeList.add(new ModelBox(body3, 0, 27, -1.0F, 0.0F, -0.25F, 2, 1, 2, 0.0F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(1.2F, 0.95F, 0.5F);
        this.body3.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, 0.0F, 0.8727F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 6, 32, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-1.2F, 0.95F, 0.5F);
        this.body3.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.0F, -0.8727F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 6, 32, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, false));

        this.pleopodR2 = new AdvancedModelRenderer(this);
        this.pleopodR2.setRotationPoint(-0.5F, 0.95F, 0.1F);
        this.body3.addChild(pleopodR2);
        this.setRotateAngle(pleopodR2, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR2.cubeList.add(new ModelBox(pleopodR2, 10, 24, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL2 = new AdvancedModelRenderer(this);
        this.pleopodL2.setRotationPoint(0.5F, 0.95F, 0.1F);
        this.body3.addChild(pleopodL2);
        this.setRotateAngle(pleopodL2, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL2.cubeList.add(new ModelBox(pleopodL2, 10, 24, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.pleopodR3 = new AdvancedModelRenderer(this);
        this.pleopodR3.setRotationPoint(-0.5F, 0.95F, 0.85F);
        this.body3.addChild(pleopodR3);
        this.setRotateAngle(pleopodR3, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR3.cubeList.add(new ModelBox(pleopodR3, 12, 24, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL3 = new AdvancedModelRenderer(this);
        this.pleopodL3.setRotationPoint(0.5F, 0.95F, 0.85F);
        this.body3.addChild(pleopodL3);
        this.setRotateAngle(pleopodL3, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL3.cubeList.add(new ModelBox(pleopodL3, 12, 24, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.body4 = new AdvancedModelRenderer(this);
        this.body4.setRotationPoint(0.0F, 0.1F, 1.75F);
        this.body3.addChild(body4);
        this.setRotateAngle(body4, -0.2182F, 0.0F, 0.0F);
        this.body4.cubeList.add(new ModelBox(body4, 30, 29, -1.0F, 0.0F, -0.25F, 2, 1, 1, -0.01F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(1.175F, 0.85F, 0.8F);
        this.body4.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, 0.0F, 0.8727F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 32, 18, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, true));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-1.175F, 0.85F, 0.8F);
        this.body4.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, 0.0F, -0.8727F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 32, 18, -0.5F, 0.0F, -1.0F, 1, 0, 2, 0.0F, false));

        this.pleopodR4 = new AdvancedModelRenderer(this);
        this.pleopodR4.setRotationPoint(-0.5F, 0.75F, 0.2F);
        this.body4.addChild(pleopodR4);
        this.setRotateAngle(pleopodR4, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR4.cubeList.add(new ModelBox(pleopodR4, 10, 22, -0.5F, -0.65F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL4 = new AdvancedModelRenderer(this);
        this.pleopodL4.setRotationPoint(0.5F, 0.75F, 0.2F);
        this.body4.addChild(pleopodL4);
        this.setRotateAngle(pleopodL4, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL4.cubeList.add(new ModelBox(pleopodL4, 10, 22, -0.5F, -0.65F, 0.0F, 1, 2, 0, 0.0F, true));

        this.body6 = new AdvancedModelRenderer(this);
        this.body6.setRotationPoint(0.0F, 0.0F, 0.65F);
        this.body4.addChild(body6);
        this.setRotateAngle(body6, -0.2618F, 0.0F, 0.0F);
        this.body6.cubeList.add(new ModelBox(body6, 28, 16, -1.0F, 0.0F, 0.0F, 2, 1, 1, -0.02F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.0F, 1.0F);
        this.body6.addChild(tail2);
        this.setRotateAngle(tail2, -0.1745F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 20, 11, -1.0F, 0.25F, 0.0F, 2, 0, 2, 0.0F, false));

        this.tailfanR = new AdvancedModelRenderer(this);
        this.tailfanR.setRotationPoint(-0.25F, 0.25F, 0.0F);
        this.tail2.addChild(tailfanR);
        this.setRotateAngle(tailfanR, -0.1309F, -0.3054F, 0.0F);
        this.tailfanR.cubeList.add(new ModelBox(tailfanR, 28, 14, -1.01F, 0.0F, 0.2F, 2, 0, 2, 0.0F, false));

        this.tailfanL = new AdvancedModelRenderer(this);
        this.tailfanL.setRotationPoint(0.25F, 0.25F, 0.0F);
        this.tail2.addChild(tailfanL);
        this.setRotateAngle(tailfanL, -0.1309F, 0.3054F, 0.0F);
        this.tailfanL.cubeList.add(new ModelBox(tailfanL, 28, 14, -0.99F, 0.0F, 0.2F, 2, 0, 2, 0.0F, true));

        this.tailfanR2 = new AdvancedModelRenderer(this);
        this.tailfanR2.setRotationPoint(-0.25F, 0.425F, 0.0F);
        this.tail2.addChild(tailfanR2);
        this.setRotateAngle(tailfanR2, -0.1309F, -0.7854F, 0.0873F);
        this.tailfanR2.cubeList.add(new ModelBox(tailfanR2, 28, 12, -1.01F, 0.0F, 0.45F, 2, 0, 2, 0.0F, false));

        this.tailfanL2 = new AdvancedModelRenderer(this);
        this.tailfanL2.setRotationPoint(0.25F, 0.425F, 0.0F);
        this.tail2.addChild(tailfanL2);
        this.setRotateAngle(tailfanL2, -0.1309F, 0.7854F, -0.0873F);
        this.tailfanL2.cubeList.add(new ModelBox(tailfanL2, 28, 12, -0.99F, 0.0F, 0.45F, 2, 0, 2, 0.0F, true));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
       ...
       // this.body.offsetY = 0.4F;
        ...
        EntityPrehistoricFloraAustropotamobius slimon = (EntityPrehistoricFloraAustropotamobius) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraAustropotamobius ee = (EntityPrehistoricFloraAustropotamobius) entitylivingbaseIn;
        //Swimming pose:
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, boolean isStatic) {
        EntityPrehistoricFloraAustropotamobius entity = (EntityPrehistoricFloraAustropotamobius) entitylivingbaseIn;
        int animCycle = 40;
        ...
        this.setRotateAngle(antennaR, antennaR.rotateAngleX + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*90/0.25+115))*5), antennaR.rotateAngleY + (float) Math.toRadians(30+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25+145))*2.5), antennaR.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armR, armR.rotateAngleX + (float) Math.toRadians(-20+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25+115))*2), armR.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25+145))*4), armR.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(antennaL, antennaL.rotateAngleX + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*90/0.25-115))*5), antennaL.rotateAngleY + (float) Math.toRadians(-30+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25+145))*2.5), antennaL.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(armL, armL.rotateAngleX + (float) Math.toRadians(-20+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25-115))*2), armL.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*45/0.25-145))*4), armL.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(armR2, armR2.rotateAngleX + (float) Math.toRadians(31.02817), armR2.rotateAngleY + (float) Math.toRadians(16.08452), armR2.rotateAngleZ + (float) Math.toRadians(-23.45231));
        this.armR2.rotationPointX = this.armR2.rotationPointX + (float)(0.15582);
        this.armR2.rotationPointY = this.armR2.rotationPointY - (float)(-0.34356);
        this.armR2.rotationPointZ = this.armR2.rotationPointZ + (float)(0.32816);


        this.setRotateAngle(armR3, armR3.rotateAngleX + (float) Math.toRadians(20), armR3.rotateAngleY + (float) Math.toRadians(0), armR3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armL2, armL2.rotateAngleX + (float) Math.toRadians(31.02817), armL2.rotateAngleY + (float) Math.toRadians(-16.08452), armL2.rotateAngleZ + (float) Math.toRadians(23.45231));
        this.armL2.rotationPointX = this.armL2.rotationPointX + (float)(-0.15582);
        this.armL2.rotationPointY = this.armL2.rotationPointY - (float)(-0.34356);
        this.armL2.rotationPointZ = this.armL2.rotationPointZ + (float)(0.32816);


        this.setRotateAngle(armL3, armL3.rotateAngleX + (float) Math.toRadians(20), armL3.rotateAngleY + (float) Math.toRadians(0), armL3.rotateAngleZ + (float) Math.toRadians(0));
    ...
    public void animIdle(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, boolean isStatic) {
        ...
        this.setRotateAngle(armR, armR.rotateAngleX + (float) Math.toRadians(-16.23634), armR.rotateAngleY + (float) Math.toRadians(7.11814), armR.rotateAngleZ + (float) Math.toRadians(8.98535));
        ...
        this.setRotateAngle(armL, armL.rotateAngleX + (float) Math.toRadians(-16.23634), armL.rotateAngleY + (float) Math.toRadians(-7.11814), armL.rotateAngleZ + (float) Math.toRadians(-8.98535));
        ...
        this.setRotateAngle(armR2, armR2.rotateAngleX + (float) Math.toRadians(41.02817), armR2.rotateAngleY + (float) Math.toRadians(16.08452), armR2.rotateAngleZ + (float) Math.toRadians(-23.45231));
        this.armR2.rotationPointX = this.armR2.rotationPointX + (float)(0.15582);
        this.armR2.rotationPointY = this.armR2.rotationPointY - (float)(-0.34356);
        this.armR2.rotationPointZ = this.armR2.rotationPointZ + (float)(0.32816);
        ...
        this.setRotateAngle(armL2, armL2.rotateAngleX + (float) Math.toRadians(41.02817), armL2.rotateAngleY + (float) Math.toRadians(-16.08452), armL2.rotateAngleZ + (float) Math.toRadians(23.45231));
        this.armL2.rotationPointX = this.armL2.rotationPointX + (float)(-0.15582);
        this.armL2.rotationPointY = this.armL2.rotationPointY - (float)(-0.34356);
        this.armL2.rotationPointZ = this.armL2.rotationPointZ + (float)(0.32816);
        ...
        this.setRotateAngle(tailfanL, tailfanL.rotateAngleX + (float) Math.toRadians(-25), tailfanL.rotateAngleY + (float) Math.toRadians(0), tailfanL.rotateAngleZ + (float) Math.toRadians(0));
        
    }


    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraAustropotamobius e = (EntityPrehistoricFloraAustropotamobius) entity;
