...
public class ModelHyogobatrachus extends ModelBasePalaeopedia {
    ...
    public ModelHyogobatrachus() {
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 14, 12, -1.0F, -1.75F, -4.5F, 2, 1, 4, 0.0F, false));
        ...
        this.neck.cubeList.add(new ModelBox(neck, 0, 17, -2.0F, -0.85F, -2.2F, 4, 2, 2, 0.0F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, -0.1F, -2.25F);
        this.neck.addChild(head);
        this.setRotateAngle(head, 0.0873F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 22, 17, -1.0F, -0.5F, -2.45F, 2, 1, 3, 0.01F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(1.15F, 0.5F, -2.55F);
        this.head.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 0.0436F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 22, 27, -1.125F, -1.0F, 1.8F, 2, 1, 1, -0.01F, true));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(1.0F, 0.5F, -2.45F);
        this.head.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.5672F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 16, 23, -1.975F, -1.0F, 0.0F, 2, 1, 2, 0.0F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.0F, 0.5F, -2.45F);
        this.head.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, -0.5672F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 16, 23, -0.025F, -1.0F, 0.0F, 2, 1, 2, 0.0F, false));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(-1.15F, 0.5F, -2.55F);
        this.head.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, -0.0436F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 22, 27, -0.875F, -1.0F, 1.8F, 2, 1, 1, -0.01F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(0.0F, -0.5F, -2.45F);
        this.head.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.4363F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 28, 3, -1.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(0.0F, -0.9F, -1.55F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, -0.0436F, 0.0F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 8, 23, -1.0F, -0.025F, 0.0F, 2, 1, 2, 0.0F, false));
        ...
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 6, 28, -0.275F, -0.05F, -0.25F, 1, 1, 1, 0.0F, false));
        ...
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 6, 28, -0.725F, -0.05F, -0.25F, 1, 1, 1, 0.0F, true));

        this.lowerjaw = new AdvancedModelRenderer(this);
        this.lowerjaw.setRotationPoint(0.0F, 0.55F, -0.15F);
        this.head.addChild(lowerjaw);
        this.setRotateAngle(lowerjaw, -0.0873F, 0.0F, 0.0F);
        this.lowerjaw.cubeList.add(new ModelBox(lowerjaw, 12, 17, -1.0F, -0.45F, -2.25F, 2, 1, 3, -0.015F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(1.0F, 0.55F, -2.25F);
        this.lowerjaw.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, 0.5672F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 23, -1.975F, -1.0F, 0.0F, 2, 1, 2, -0.02F, true));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(1.125F, 0.55F, -2.325F);
        this.lowerjaw.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, 0.0436F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 28, -1.125F, -1.0F, 1.775F, 2, 1, 1, -0.03F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(-1.0F, 0.55F, -2.25F);
        this.lowerjaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0F, -0.5672F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 23, -0.025F, -1.0F, 0.0F, 2, 1, 2, -0.02F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(-1.125F, 0.55F, -2.325F);
        ...
        this.tongue.cubeList.add(new ModelBox(tongue, 26, 14, -0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F, false));
        ...
        this.throat.cubeList.add(new ModelBox(throat, 24, 24, -1.0F, -1.025F, -0.25F, 2, 1, 2, -0.01F, false));
        ...
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 24, 21, -1.0F, -1.0F, 0.0F, 2, 1, 2, 0.0F, false));

        this.rightarm = new AdvancedModelRenderer(this);
        this.rightarm.setRotationPoint(-1.5F, -0.6F, -2.95F);
        this.body.addChild(rightarm);
        this.setRotateAngle(rightarm, 0.0262F, 0.6109F, -0.3665F);
        ...
        this.rightarm2.cubeList.add(new ModelBox(rightarm2, 16, 26, -1.75F, -0.5F, -0.5F, 2, 1, 1, 0.0F, false));

        this.rightarm3 = new AdvancedModelRenderer(this);
        this.rightarm3.setRotationPoint(-1.75F, 0.25F, 0.25F);
        this.rightarm2.addChild(rightarm3);
        this.setRotateAngle(rightarm3, 0.1309F, -0.4363F, 0.0873F);
        this.rightarm3.cubeList.add(new ModelBox(rightarm3, 16, 3, -2.0F, 0.0F, -1.6F, 3, 0, 3, 0.0F, false));
        this.rightarm3.cubeList.add(new ModelBox(rightarm3, 24, 9, -2.0F, 0.05F, -1.6F, 3, 0, 3, 0.0F, false));

        this.leftarm = new AdvancedModelRenderer(this);
        this.leftarm.setRotationPoint(1.5F, -0.6F, -2.95F);
        this.body.addChild(leftarm);
        this.setRotateAngle(leftarm, 0.0262F, -0.6109F, 0.3665F);
        this.leftarm.cubeList.add(new ModelBox(leftarm, 0, 26, -1.0F, -0.5F, -1.0F, 3, 1, 1, 0.01F, true));

        this.leftarm2 = new AdvancedModelRenderer(this);
        this.leftarm2.setRotationPoint(2.0F, 0.0F, -0.5F);
        this.leftarm.addChild(leftarm2);
        this.setRotateAngle(leftarm2, 0.0F, 1.5708F, -0.2182F);
        this.leftarm2.cubeList.add(new ModelBox(leftarm2, 16, 26, -0.25F, -0.5F, -0.5F, 2, 1, 1, 0.0F, true));

        this.leftarm3 = new AdvancedModelRenderer(this);
        this.leftarm3.setRotationPoint(1.75F, 0.25F, 0.25F);
        this.leftarm2.addChild(leftarm3);
        this.setRotateAngle(leftarm3, 0.1309F, 0.4363F, -0.0873F);
        this.leftarm3.cubeList.add(new ModelBox(leftarm3, 16, 3, -1.0F, 0.0F, -1.6F, 3, 0, 3, 0.0F, true));
        this.leftarm3.cubeList.add(new ModelBox(leftarm3, 24, 9, -1.0F, 0.05F, -1.6F, 3, 0, 3, 0.0F, true));
        ...
        this.setRotateAngle(rightleg, 0.0F, -0.829F, -0.1134F);
        this.rightleg.cubeList.add(new ModelBox(rightleg, 16, 0, -4.25F, -1.0F, -1.25F, 5, 1, 2, 0.01F, false));

        this.rightleg2 = new AdvancedModelRenderer(this);
        this.rightleg2.setRotationPoint(-4.1F, 0.05F, 0.1F);
        this.rightleg.addChild(rightleg2);
        this.setRotateAngle(rightleg2, 0.0F, 2.138F, 0.0F);
        this.rightleg2.cubeList.add(new ModelBox(rightleg2, 12, 21, -4.5F, -1.0F, 0.0F, 5, 1, 1, -0.01F, false));
        this.rightleg2.cubeList.add(new ModelBox(rightleg2, 0, 21, -4.5F, -1.0F, -0.5F, 5, 1, 1, 0.0F, false));

        this.rightleg3 = new AdvancedModelRenderer(this);
        this.rightleg3.setRotationPoint(-4.5F, 0.025F, 0.4F);
        this.rightleg2.addChild(rightleg3);
        this.setRotateAngle(rightleg3, 0.1309F, -2.0071F, 0.0349F);
        this.rightleg3.cubeList.add(new ModelBox(rightleg3, 26, 12, -3.0F, -1.0F, -0.5F, 3, 1, 1, -0.02F, false));
        this.rightleg3.cubeList.add(new ModelBox(rightleg3, 8, 26, -3.0F, -1.0F, -1.0F, 3, 1, 1, -0.01F, false));

        this.rightleg4 = new AdvancedModelRenderer(this);
        this.rightleg4.setRotationPoint(-3.0F, -0.25F, 0.0F);
        this.rightleg3.addChild(rightleg4);
        this.setRotateAngle(rightleg4, 0.0F, -0.5672F, 0.0175F);
        this.rightleg4.cubeList.add(new ModelBox(rightleg4, 14, 6, -4.0F, 0.0F, -1.5F, 5, 0, 3, 0.0F, false));
        this.rightleg4.cubeList.add(new ModelBox(rightleg4, 14, 9, -4.0F, 0.1F, -1.5F, 5, 0, 3, 0.0F, false));

        this.leftleg = new AdvancedModelRenderer(this);
        this.leftleg.setRotationPoint(1.0F, -0.75F, 3.6F);
        this.hips.addChild(leftleg);
        this.setRotateAngle(leftleg, 0.0F, 0.829F, 0.1134F);
        this.leftleg.cubeList.add(new ModelBox(leftleg, 16, 0, -0.75F, -1.0F, -1.25F, 5, 1, 2, 0.01F, true));

        this.leftleg2 = new AdvancedModelRenderer(this);
        this.leftleg2.setRotationPoint(4.1F, 0.05F, 0.1F);
        this.leftleg.addChild(leftleg2);
        this.setRotateAngle(leftleg2, 0.0F, -2.138F, 0.0F);
        this.leftleg2.cubeList.add(new ModelBox(leftleg2, 12, 21, -0.5F, -1.0F, 0.0F, 5, 1, 1, -0.01F, true));
        this.leftleg2.cubeList.add(new ModelBox(leftleg2, 0, 21, -0.5F, -1.0F, -0.5F, 5, 1, 1, 0.0F, true));

        this.leftleg3 = new AdvancedModelRenderer(this);
        this.leftleg3.setRotationPoint(4.5F, 0.025F, 0.4F);
        this.leftleg2.addChild(leftleg3);
        this.setRotateAngle(leftleg3, 0.1309F, 2.0071F, -0.0349F);
        this.leftleg3.cubeList.add(new ModelBox(leftleg3, 26, 12, 0.0F, -1.0F, -0.5F, 3, 1, 1, -0.02F, true));
        this.leftleg3.cubeList.add(new ModelBox(leftleg3, 8, 26, 0.0F, -1.0F, -1.0F, 3, 1, 1, -0.01F, true));

        this.leftleg4 = new AdvancedModelRenderer(this);
        this.leftleg4.setRotationPoint(3.0F, -0.25F, 0.0F);
        this.leftleg3.addChild(leftleg4);
        this.setRotateAngle(leftleg4, 0.0F, 0.5672F, -0.0175F);
        this.leftleg4.cubeList.add(new ModelBox(leftleg4, 14, 6, -1.0F, 0.0F, -1.5F, 5, 0, 3, 0.0F, true));
        this.leftleg4.cubeList.add(new ModelBox(leftleg4, 14, 9, -1.0F, 0.1F, -1.5F, 5, 0, 3, 0.0F, true));
        updateDefaultPose();
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraHyogobatrachus entitySilesaurus = (EntityPrehistoricFloraHyogobatrachus) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraHyogobatrachus ee = (EntityPrehistoricFloraHyogobatrachus) entitylivingbaseIn;
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraHyogobatrachus entity = (EntityPrehistoricFloraHyogobatrachus) entitylivingbaseIn;
        int animCycle = 40;
        ...
        if (tickAnim >= 10 && tickAnim < 15) {
            xx = 0 + (((tickAnim - 10) / 5) * (0-(0)));
            yy = 0 + (((tickAnim - 10) / 5) * (0.4-(0)));
            zz = 0 + (((tickAnim - 10) / 5) * (0-(0)));
        }
        else if (tickAnim >= 15 && tickAnim < 25) {
            xx = 0 + (((tickAnim - 15) / 10) * (0-(0)));
            yy = 0.4 + (((tickAnim - 15) / 10) * (0-(0.4)));
    ...
    public void animSwim(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(rightleg, rightleg.rotateAngleX + (float) Math.toRadians(-5.9735+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360+30))*10), rightleg.rotateAngleY + (float) Math.toRadians(83.2765+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360))*50), rightleg.rotateAngleZ + (float) Math.toRadians(-3.6439+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360+30))*-10));
        ...
        this.setRotateAngle(leftleg, leftleg.rotateAngleX + (float) Math.toRadians(-5.9735+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360+30))*10), leftleg.rotateAngleY + (float) Math.toRadians(-83.2765+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360))*-50), leftleg.rotateAngleZ + (float) Math.toRadians(-3.6439+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360+30))*-10));
    ...
    public void animJump(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 3 && tickAnim < 3) {
            ...
            yy = 0.125 + (((tickAnim - 3) / 0) * (0.375-(0.125)));
            zz = 0 + (((tickAnim - 3) / 0) * (0-(0)));
        }
        else if (tickAnim >= 3 && tickAnim < 5) {
            xx = 0 + (((tickAnim - 3) / 2) * (0-(0)));
            yy = 0.375 + (((tickAnim - 3) / 2) * (0-(0.375)));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraHyogobatrachus e = (EntityPrehistoricFloraHyogobatrachus) entity;
