...
public class ModelLebachacanthus extends AdvancedModelBase {
    ...
    public ModelLebachacanthus() {
        ...
        this.pectoralfinL.setRotationPoint(3.25F, 0.5F, -1.0F);
        this.body.addChild(pectoralfinL);
        this.setRotateAngle(pectoralfinL, -0.1745F, 0.0F, -0.6981F);
        this.pectoralfinL.cubeList.add(new ModelBox(pectoralfinL, 0, 40, 0.01F, 0.0F, 0.0F, 0, 8, 10, 0.0F, false));

        this.pectoralfinR = new AdvancedModelRenderer(this);
        this.pectoralfinR.setRotationPoint(-3.25F, 0.5F, -1.0F);
        this.body.addChild(pectoralfinR);
        this.setRotateAngle(pectoralfinR, -0.1745F, 0.0F, 0.6981F);
        this.pectoralfinR.cubeList.add(new ModelBox(pectoralfinR, 38, 29, -0.01F, 0.0F, 0.0F, 0, 8, 10, 0.0F, false));
        ...
        this.spike.setRotationPoint(0.0F, -3.5F, 5.0F);
        this.tohead.addChild(spike);
        this.setRotateAngle(spike, -0.6981F, 0.0F, 0.0F);
        this.spike.cubeList.add(new ModelBox(spike, 4, 0, -0.5F, -2.5F, -0.5F, 1, 3, 1, 0.0F, false));
        ...
        this.body2.cubeList.add(new ModelBox(body2, 0, 37, 0.0F, -7.25F, 0.0F, 0, 4, 9, 0.0F, false));

        this.pelvicfinL = new AdvancedModelRenderer(this);
        this.pelvicfinL.setRotationPoint(2.85F, 2.75F, 7.5F);
        this.body2.addChild(pelvicfinL);
        this.setRotateAngle(pelvicfinL, -0.0873F, 0.0F, -0.6981F);
        this.pelvicfinL.cubeList.add(new ModelBox(pelvicfinL, 0, 8, 0.01F, -1.5F, -1.0F, 0, 8, 15, 0.0F, false));

        this.pelvicfinR = new AdvancedModelRenderer(this);
        this.pelvicfinR.setRotationPoint(-2.85F, 2.75F, 7.5F);
        this.body2.addChild(pelvicfinR);
        this.setRotateAngle(pelvicfinR, -0.0873F, 0.0F, 0.6981F);
        this.pelvicfinR.cubeList.add(new ModelBox(pelvicfinR, 0, 0, -0.01F, -1.5F, -1.0F, 0, 8, 15, 0.0F, false));
        ...
        this.body3.cubeList.add(new ModelBox(body3, 58, 53, 0.0F, -6.6F, 0.0F, 0, 4, 7, 0.0F, false));
        ...
        this.body4.cubeList.add(new ModelBox(body4, 54, 41, 0.0F, -6.5F, 0.0F, 0, 4, 7, 0.0F, false));

        this.belly4_r1 = new AdvancedModelRenderer(this);
        this.belly4_r1.setRotationPoint(0.0F, 2.5F, 0.0F);
        this.body4.addChild(belly4_r1);
        this.setRotateAngle(belly4_r1, 0.1396F, 0.0F, 0.0F);
        ...
        this.body5.cubeList.add(new ModelBox(body5, 26, 54, 0.0F, -5.5F, 0.0F, 0, 4, 7, 0.0F, false));

        this.analfinA_r1 = new AdvancedModelRenderer(this);
        this.analfinA_r1.setRotationPoint(0.0F, 3.25F, -15.0F);
        this.body5.addChild(analfinA_r1);
        this.setRotateAngle(analfinA_r1, 0.9163F, 0.0F, 0.0F);
        this.analfinA_r1.cubeList.add(new ModelBox(analfinA_r1, 44, 15, 0.0F, 11.0F, 9.5F, 0, 7, 3, 0.0F, false));
        ...
        this.analfinA_r2.setRotationPoint(0.0F, 3.5F, -22.0F);
        this.body6.addChild(analfinA_r2);
        this.setRotateAngle(analfinA_r2, 0.9163F, 0.0F, 0.0F);
        this.analfinA_r2.cubeList.add(new ModelBox(analfinA_r2, 0, 28, 0.0F, 16.5F, 14.5F, 0, 8, 3, 0.0F, false));

        this.body7 = new AdvancedModelRenderer(this);
        this.body7.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.body6.addChild(body7);
        this.body7.cubeList.add(new ModelBox(body7, 20, 40, 0.0F, -4.25F, 0.0F, 0, 7, 10, 0.0F, false));
        this.body7.cubeList.add(new ModelBox(body7, 0, 0, 0.0F, -4.25F, -2.0F, 0, 4, 2, 0.0F, false));
        this.body7.cubeList.add(new ModelBox(body7, 49, 60, -0.5F, -0.75F, -1.0F, 1, 2, 7, 0.0F, false));
