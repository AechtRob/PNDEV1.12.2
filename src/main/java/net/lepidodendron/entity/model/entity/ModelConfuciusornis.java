...
public class ModelConfuciusornis extends ModelBasePalaeopedia {
    ...
    public ModelConfuciusornis() {
        ...
        this.legright.cubeList.add(new ModelBox(legright, 35, 61, -0.8F, -0.75F, -0.45F, 2, 6, 2, 0.0F, false));
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 56, 10, -1.1F, 0.95F, -0.6F, 3, 3, 4, 0.0F, false));
        ...
        this.legright3.cubeList.add(new ModelBox(legright3, 0, 55, -1.4F, -0.25F, -3.45F, 3, 1, 5, 0.0F, false));
        ...
        this.legleft.cubeList.add(new ModelBox(legleft, 35, 61, -1.2F, -0.75F, -0.45F, 2, 6, 2, 0.0F, true));
        ...
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 56, 10, -1.9F, 0.95F, -0.6F, 3, 3, 4, 0.0F, true));
        ...
        this.legleft3.cubeList.add(new ModelBox(legleft3, 0, 55, -1.6F, -0.25F, -3.45F, 3, 1, 5, 0.0F, true));
        ...
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 43, -3.0F, 0.0F, -1.0F, 6, 6, 5, 0.02F, false));
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 47, 45, -2.0F, 0.0F, 0.0F, 4, 6, 6, 0.0F, false));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(0.0F, -1.4347F, 5.77F);
        this.hip.addChild(tail);
        this.setRotateAngle(tail, -0.1309F, 0.0F, 0.0F);
        this.tail.cubeList.add(new ModelBox(tail, 33, 53, -1.5F, -0.5F, -0.75F, 3, 2, 5, 0.0F, false));
        ...
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 58, 27, -2.0F, -2.0F, 0.0F, 3, 3, 4, -0.01F, false));
        ...
        this.tailfeatherright.cubeList.add(new ModelBox(tailfeatherright, 50, 19, -0.5027F, 0.0039F, -1.0478F, 1, 0, 7, 0.0F, false));

        this.tailfeatherright2 = new AdvancedModelRenderer(this);
        this.tailfeatherright2.setRotationPoint(-0.0027F, 0.0039F, 5.9522F);
        this.tailfeatherright.addChild(tailfeatherright2);
        this.setRotateAngle(tailfeatherright2, 0.1309F, 0.0F, 0.0F);
        this.tailfeatherright2.cubeList.add(new ModelBox(tailfeatherright2, 46, 11, -0.5F, 0.0F, 0.0F, 1, 0, 7, 0.0F, false));

        this.tailfeatherright3 = new AdvancedModelRenderer(this);
        this.tailfeatherright3.setRotationPoint(0.0F, 0.0F, 7.0F);
        this.tailfeatherright2.addChild(tailfeatherright3);
        this.setRotateAngle(tailfeatherright3, 0.0873F, 0.0F, 0.0F);
        this.tailfeatherright3.cubeList.add(new ModelBox(tailfeatherright3, 36, 10, -0.5F, 0.0F, 0.0F, 1, 0, 7, 0.0F, false));
        ...
        this.tailfeatherright4.cubeList.add(new ModelBox(tailfeatherright4, 62, 41, -0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F, false));
        ...
        this.tailfeatherright5.cubeList.add(new ModelBox(tailfeatherright5, 0, 62, -0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F, false));
        ...
        this.tailfeatherright6.cubeList.add(new ModelBox(tailfeatherright6, 60, 18, -0.5F, 0.0F, 0.0F, 2, 0, 5, 0.0F, false));
        this.tailfeatherright6.cubeList.add(new ModelBox(tailfeatherright6, 67, 18, 0.0F, -0.0074F, 0.0F, 1, 0, 5, 0.0F, false));
        this.tailfeatherright6.cubeList.add(new ModelBox(tailfeatherright6, 67, 18, 0.0F, 0.0126F, 0.0F, 1, 0, 5, 0.0F, false));
        this.tailfeatherright6.cubeList.add(new ModelBox(tailfeatherright6, 12, 15, 0.0F, 0.0F, 5.0F, 1, 0, 1, 0.0F, false));
        ...
        this.tailfeatherleft.cubeList.add(new ModelBox(tailfeatherleft, 50, 19, -0.4973F, 0.0039F, -1.0478F, 1, 0, 7, 0.0F, true));

        this.tailfeatherleft2 = new AdvancedModelRenderer(this);
        this.tailfeatherleft2.setRotationPoint(0.0027F, 0.0039F, 5.9522F);
        this.tailfeatherleft.addChild(tailfeatherleft2);
        this.setRotateAngle(tailfeatherleft2, 0.1309F, 0.0F, 0.0F);
        this.tailfeatherleft2.cubeList.add(new ModelBox(tailfeatherleft2, 46, 11, -0.5F, 0.0F, 0.0F, 1, 0, 7, 0.0F, true));

        this.tailfeatherleft3 = new AdvancedModelRenderer(this);
        this.tailfeatherleft3.setRotationPoint(0.0F, 0.0F, 7.0F);
        this.tailfeatherleft2.addChild(tailfeatherleft3);
        this.setRotateAngle(tailfeatherleft3, 0.0873F, 0.0F, 0.0F);
        this.tailfeatherleft3.cubeList.add(new ModelBox(tailfeatherleft3, 36, 10, -0.5F, 0.0F, 0.0F, 1, 0, 7, 0.0F, true));
        ...
        this.tailfeatherleft4.cubeList.add(new ModelBox(tailfeatherleft4, 62, 41, -0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F, true));
        ...
        this.tailfeatherleft5.cubeList.add(new ModelBox(tailfeatherleft5, 0, 62, -0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F, true));
        ...
        this.tailfeatherleft6.cubeList.add(new ModelBox(tailfeatherleft6, 60, 18, -1.5F, 0.0F, 0.0F, 2, 0, 5, 0.0F, true));
        this.tailfeatherleft6.cubeList.add(new ModelBox(tailfeatherleft6, 67, 18, -1.0F, -0.0074F, 0.0F, 1, 0, 5, 0.0F, true));
        this.tailfeatherleft6.cubeList.add(new ModelBox(tailfeatherleft6, 67, 18, -1.0F, 0.0126F, 0.0F, 1, 0, 5, 0.0F, true));
        this.tailfeatherleft6.cubeList.add(new ModelBox(tailfeatherleft6, 12, 15, -1.0F, 0.0F, 5.0F, 1, 0, 1, 0.0F, true));

        this.chest = new AdvancedModelRenderer(this);
        this.chest.setRotationPoint(0.0F, -0.9847F, -0.73F);
        this.hip.addChild(chest);
        this.chest.cubeList.add(new ModelBox(chest, 30, 25, -3.0F, -1.7F, -6.25F, 6, 4, 7, 0.0F, false));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 36, 0, -4.0F, -2.0F, 0.0F, 6, 2, 7, -0.01F, false));

        this.neck = new AdvancedModelRenderer(this);
        this.neck.setRotationPoint(0.0F, 0.9F, -5.8F);
        this.chest.addChild(neck);
        this.setRotateAngle(neck, -0.829F, 0.0F, 0.0F);
        this.neck.cubeList.add(new ModelBox(neck, 15, 25, -1.5F, -2.864F, -2.4075F, 3, 4, 3, 0.01F, false));

        this.neck2 = new AdvancedModelRenderer(this);
        this.neck2.setRotationPoint(0.0F, -1.564F, -1.9075F);
        this.neck.addChild(neck2);
        this.setRotateAngle(neck2, -0.3054F, 0.0F, 0.0F);
        this.neck2.cubeList.add(new ModelBox(neck2, 63, 5, -1.5F, -1.0F, -2.0F, 3, 2, 2, 0.0F, false));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 62, 46, -2.0F, 0.0F, -2.0F, 3, 2, 2, -0.01F, false));
        ...
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 13, 59, -2.0F, -1.8F, -0.9F, 3, 2, 4, -0.02F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 0.75F, -3.5F);
        this.neck2.addChild(head);
        this.setRotateAngle(head, 1.7017F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 55, 58, -1.5F, -1.0235F, -1.6621F, 3, 1, 3, 0.01F, false));
        this.head.cubeList.add(new ModelBox(head, 68, 51, -1.5F, -1.0235F, -2.3121F, 3, 1, 1, 0.015F, false));
        this.head.cubeList.add(new ModelBox(head, 18, 6, -1.6F, -1.3235F, -1.2121F, 1, 1, 1, 0.02F, false));
        this.head.cubeList.add(new ModelBox(head, 18, 6, 0.6F, -1.3235F, -1.2121F, 1, 1, 1, 0.02F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.5F, -1.4485F, -2.1121F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.4014F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 9, 66, -2.0F, 0.0F, 0.0F, 3, 1, 2, 0.0F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.5F, -1.3235F, -2.4371F);
        this.head.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.3578F, 0.0F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 67, 24, -2.0F, 0.0F, 0.0F, 3, 1, 1, -0.01F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-0.5F, -0.7235F, -3.1621F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.6632F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 18, 9, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(0.5F, -1.0235F, 1.3379F);
        this.head.addChild(cube_r11);
        this.setRotateAngle(cube_r11, -0.6545F, 0.0F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 44, 66, -2.0F, 0.0F, -2.0F, 3, 1, 2, -0.01F, false));

        this.upperjaw = new AdvancedModelRenderer(this);
        this.upperjaw.setRotationPoint(-0.5F, -0.7617F, -2.5718F);
        this.head.addChild(upperjaw);
        this.setRotateAngle(upperjaw, 0.3491F, 0.0F, 0.0F);
        this.upperjaw.cubeList.add(new ModelBox(upperjaw, 26, 6, 0.0F, -0.2618F, -2.2904F, 1, 1, 3, 0.01F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(1.0F, 0.6169F, -2.0457F);
        this.upperjaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, -0.134F, -0.2163F, 0.0289F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 61, 67, -1.0F, -0.8587F, 0.0417F, 1, 1, 3, -0.02F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, 0.6169F, -2.0457F);
        this.upperjaw.addChild(cube_r13);
        this.setRotateAngle(cube_r13, -0.134F, 0.2163F, -0.0289F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 68, 64, 0.0F, -0.8587F, 0.0417F, 1, 1, 3, -0.01F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(0.0F, 0.6169F, -2.2457F);
        this.upperjaw.addChild(cube_r14);
        this.setRotateAngle(cube_r14, -0.1309F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 65, 55, 0.0F, -0.883F, 0.0417F, 1, 1, 3, -0.01F, false));

        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(1.0F, 0.7382F, -2.1404F);
        this.upperjaw.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.0F, 0.2531F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 17, 67, -1.0F, -1.0F, 0.0F, 1, 1, 3, 0.0F, false));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(0.0F, 0.7382F, -2.1404F);
        this.upperjaw.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 0.0F, -0.2531F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 52, 67, 0.0F, -1.0F, 0.0F, 1, 1, 3, 0.0F, false));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(0.0F, 0.0765F, 0.1379F);
        this.head.addChild(jaw);
        this.jaw.cubeList.add(new ModelBox(jaw, 5, 21, -1.5F, -1.1F, -1.8F, 3, 2, 1, 0.005F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 60, 63, -1.5F, -0.1F, -0.8F, 3, 1, 2, 0.005F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 18, 43, -1.5F, -1.1F, -0.8F, 3, 1, 1, 0.005F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 67, 10, -1.5F, -0.1F, -2.45F, 3, 1, 1, -0.01F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 7, 0, -0.5F, -0.1143F, -4.6F, 1, 1, 3, -0.02F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(-0.4F, 0.7F, -4.45F);
        this.jaw.addChild(cube_r17);
        this.setRotateAngle(cube_r17, 0.0F, -0.2531F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 13, 5, 0.0F, -2.001F, 2.0F, 0, 2, 1, -0.01F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(0.4F, 0.7F, -4.45F);
        this.jaw.addChild(cube_r18);
        this.setRotateAngle(cube_r18, 0.0F, 0.2531F, 0.0F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 13, 9, 0.0F, -2.001F, 2.0F, 0, 2, 1, -0.01F, false));

        this.cube_r19 = new AdvancedModelRenderer(this);
        this.cube_r19.setRotationPoint(0.5F, 0.9F, -4.45F);
        this.jaw.addChild(cube_r19);
        this.setRotateAngle(cube_r19, 0.0F, 0.2531F, 0.0F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 0, 67, -1.0F, -1.001F, 0.0F, 1, 1, 3, -0.01F, false));

        this.cube_r20 = new AdvancedModelRenderer(this);
        this.cube_r20.setRotationPoint(-0.5F, 0.9F, -4.45F);
        this.jaw.addChild(cube_r20);
        this.setRotateAngle(cube_r20, 0.0F, -0.2531F, 0.0F);
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 67, 35, 0.0F, -1.002F, 0.0F, 1, 1, 3, -0.01F, false));
        ...
        this.headfluff3.cubeList.add(new ModelBox(headfluff3, 43, 44, -1.0F, 0.0F, 0.0F, 2, 0, 2, 0.0F, false));
        ...
        this.headfluff2.cubeList.add(new ModelBox(headfluff2, 36, 18, -1.5F, 0.0F, 0.0F, 3, 0, 2, 0.0F, false));
        ...
        this.headfluff1.cubeList.add(new ModelBox(headfluff1, 54, 42, -1.5F, 0.1F, 0.4F, 3, 0, 2, 0.0F, false));
        ...
        this.cube_r21.cubeList.add(new ModelBox(cube_r21, 24, 43, -2.5F, 0.0522F, -1.1034F, 5, 0, 3, 0.0F, false));
        ...
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 0, 39, -2.5F, 0.0522F, -1.1034F, 5, 0, 3, 0.0F, false));
        ...
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 56, 0, -4.0F, 0.0F, 0.0F, 6, 1, 3, -0.02F, false));
        ...
        this.cube_r24.cubeList.add(new ModelBox(cube_r24, 43, 41, -4.0F, 0.0F, 0.0F, 5, 1, 1, -0.01F, false));
        ...
        this.cube_r25.cubeList.add(new ModelBox(cube_r25, 18, 0, -4.0F, -0.4014F, -0.359F, 6, 1, 4, -0.03F, false));

        this.armright1 = new AdvancedModelRenderer(this);
        this.armright1.setRotationPoint(-2.5F, -0.4F, -5.2F);
        this.chest.addChild(armright1);
        this.setRotateAngle(armright1, 0.0636F, -0.0264F, 0.1374F);
        this.armright1.cubeList.add(new ModelBox(armright1, 45, 58, -1.0F, -1.0F, 0.0F, 2, 2, 5, 0.0F, false));
        ...
        this.tertialsright.cubeList.add(new ModelBox(tertialsright, 0, 0, 1.0F, -9.0F, -1.0F, 0, 9, 6, 0.0F, false));
        ...
        this.setRotateAngle(armright2, -2.5744F, 0.0F, 0.0F);
        this.armright2.cubeList.add(new ModelBox(armright2, 24, 47, -0.75F, -1.0F, 0.0F, 1, 2, 4, 0.0F, false));
        ...
        this.setRotateAngle(secondariesright, 0.829F, 0.0F, 0.0F);
        this.secondariesright.cubeList.add(new ModelBox(secondariesright, 0, 21, -0.51F, -7.7F, -0.2F, 0, 8, 4, 0.0F, false));
        ...
        this.setRotateAngle(secondariesrightfoldable, 0.0F, -3.1416F, 0.0F);
        this.secondariesrightfoldable.cubeList.add(new ModelBox(secondariesrightfoldable, 28, 59, 0.0F, -4.5F, -3.0F, 0, 8, 3, 0.0F, false));
        ...
        this.setRotateAngle(armright3, 2.2689F, 0.0F, 0.0F);
        this.armright3.cubeList.add(new ModelBox(armright3, 18, 6, 0.0F, -0.75F, -0.75F, 0, 3, 7, 0.0F, false));
        ...
        this.primaryright7.addChild(cube_r26);
        this.setRotateAngle(cube_r26, 0.2182F, 0.0F, 0.0F);
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 0, 0, 0.06F, -3.0F, -1.0F, 0, 3, 17, 0.0F, false));
        ...
        this.primaryright6.addChild(cube_r27);
        this.setRotateAngle(cube_r27, 0.2182F, 0.0F, 0.0F);
        this.cube_r27.cubeList.add(new ModelBox(cube_r27, 20, 6, 0.05F, -3.0F, -1.0F, 0, 3, 15, 0.0F, false));
        ...
        this.cube_r28.setRotationPoint(0.0253F, -0.162F, 1.1208F);
        this.primaryright5.addChild(cube_r28);
        this.setRotateAngle(cube_r28, 0.2182F, 0.0F, 0.0F);
        this.cube_r28.cubeList.add(new ModelBox(cube_r28, 0, 21, 0.04F, -3.0F, -1.0F, 0, 3, 14, 0.0F, false));
        ...
        this.primaryright4.addChild(cube_r29);
        this.setRotateAngle(cube_r29, 0.2182F, 0.0F, 0.0F);
        this.cube_r29.cubeList.add(new ModelBox(cube_r29, 17, 27, 0.03F, -3.0F, -1.0F, 0, 3, 12, 0.0F, false));
        ...
        this.primaryright3.addChild(cube_r30);
        this.setRotateAngle(cube_r30, 0.2182F, 0.0F, 0.0F);
        this.cube_r30.cubeList.add(new ModelBox(cube_r30, 32, 37, 0.02F, -3.0F, -1.0F, 0, 3, 10, 0.0F, false));
        ...
        this.primaryright2.addChild(cube_r31);
        this.setRotateAngle(cube_r31, 0.2182F, 0.0F, 0.0F);
        this.cube_r31.cubeList.add(new ModelBox(cube_r31, 48, 28, 0.01F, -3.0F, -1.0F, 0, 3, 9, 0.0F, false));
        ...
        this.primaryright1.addChild(cube_r32);
        this.setRotateAngle(cube_r32, 0.2182F, 0.0F, 0.0F);
        this.cube_r32.cubeList.add(new ModelBox(cube_r32, 14, 46, 0.0F, -3.0F, -1.0F, 0, 3, 9, 0.0F, false));

        this.armleft1 = new AdvancedModelRenderer(this);
        this.armleft1.setRotationPoint(2.5F, -0.4F, -5.2F);
        this.chest.addChild(armleft1);
        this.setRotateAngle(armleft1, 0.0636F, 0.0264F, -0.1374F);
        this.armleft1.cubeList.add(new ModelBox(armleft1, 45, 58, -1.0F, -1.0F, 0.0F, 2, 2, 5, 0.0F, true));
        ...
        this.tertialsleft.cubeList.add(new ModelBox(tertialsleft, 0, 0, -1.0F, -9.0F, -1.0F, 0, 9, 6, 0.0F, true));

        this.armleft2 = new AdvancedModelRenderer(this);
        this.armleft2.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.armleft1.addChild(armleft2);
        this.setRotateAngle(armleft2, -2.5744F, 0.0F, 0.0F);
        this.armleft2.cubeList.add(new ModelBox(armleft2, 24, 47, -0.25F, -1.0F, 0.0F, 1, 2, 4, 0.0F, true));
        ...
        this.setRotateAngle(secondariesleft, 0.829F, 0.0F, 0.0F);
        this.secondariesleft.cubeList.add(new ModelBox(secondariesleft, 0, 21, 0.51F, -7.7F, -0.2F, 0, 8, 4, 0.0F, true));
        ...
        this.setRotateAngle(secondariesleftfoldable, 0.0F, 3.1416F, 0.0F);
        this.secondariesleftfoldable.cubeList.add(new ModelBox(secondariesleftfoldable, 28, 59, 0.0F, -4.5F, -3.0F, 0, 8, 3, 0.0F, true));
        ...
        this.setRotateAngle(armleft3, 2.2689F, 0.0F, 0.0F);
        this.armleft3.cubeList.add(new ModelBox(armleft3, 18, 6, 0.0F, -0.75F, -0.75F, 0, 3, 7, 0.0F, true));
        ...
        this.primaryleft7.addChild(cube_r33);
        this.setRotateAngle(cube_r33, 0.2182F, 0.0F, 0.0F);
        this.cube_r33.cubeList.add(new ModelBox(cube_r33, 0, 0, -0.06F, -3.0F, -1.0F, 0, 3, 17, 0.0F, true));
        ...
        this.cube_r34.setRotationPoint(-0.0253F, 0.038F, 0.9208F);
        this.primaryleft6.addChild(cube_r34);
        this.setRotateAngle(cube_r34, 0.2182F, 0.0F, 0.0F);
        this.cube_r34.cubeList.add(new ModelBox(cube_r34, 20, 6, -0.05F, -3.0F, -1.0F, 0, 3, 15, 0.0F, true));
        ...
        this.cube_r35.setRotationPoint(-0.0253F, -0.162F, 1.1208F);
        this.primaryleft5.addChild(cube_r35);
        this.setRotateAngle(cube_r35, 0.2182F, 0.0F, 0.0F);
        this.cube_r35.cubeList.add(new ModelBox(cube_r35, 0, 21, -0.04F, -3.0F, -1.0F, 0, 3, 14, 0.0F, true));
        ...
        this.primaryleft4.addChild(cube_r36);
        this.setRotateAngle(cube_r36, 0.2182F, 0.0F, 0.0F);
        this.cube_r36.cubeList.add(new ModelBox(cube_r36, 17, 27, -0.03F, -3.0F, -1.0F, 0, 3, 12, 0.0F, true));
        ...
        this.cube_r37.setRotationPoint(-0.0253F, 0.038F, 0.9208F);
        this.primaryleft3.addChild(cube_r37);
        this.setRotateAngle(cube_r37, 0.2182F, 0.0F, 0.0F);
        this.cube_r37.cubeList.add(new ModelBox(cube_r37, 32, 37, -0.02F, -3.0F, -1.0F, 0, 3, 10, 0.0F, true));
        ...
        this.primaryleft2.addChild(cube_r38);
        this.setRotateAngle(cube_r38, 0.2182F, 0.0F, 0.0F);
        this.cube_r38.cubeList.add(new ModelBox(cube_r38, 48, 28, -0.01F, -3.0F, -1.0F, 0, 3, 9, 0.0F, true));
        ...
        this.primaryleft1.addChild(cube_r39);
        this.setRotateAngle(cube_r39, 0.2182F, 0.0F, 0.0F);
        this.cube_r39.cubeList.add(new ModelBox(cube_r39, 14, 46, 0.0F, -3.0F, -1.0F, 0, 3, 9, 0.0F, true));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraConfuciusornis ee = (EntityPrehistoricFloraConfuciusornis) e;
...
//        this.feathers4.setScale(1,1,1);
        EntityPrehistoricFloraConfuciusornis ee = (EntityPrehistoricFloraConfuciusornis) entitylivingbaseIn;
    ...
    public void animEat(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraConfuciusornis entity = (EntityPrehistoricFloraConfuciusornis) entitylivingbaseIn;
        int animCycle = 20;
    ...
    public void animLaunching(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(confuciusornis, confuciusornis.rotateAngleX + (float) Math.toRadians(15.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*720-150))*-10), confuciusornis.rotateAngleY + (float) Math.toRadians(0), confuciusornis.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(hip, hip.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*720-190))*10), hip.rotateAngleY + (float) Math.toRadians(0), hip.rotateAngleZ + (float) Math.toRadians(0));
    ...
    public void animGliding(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(confuciusornis, confuciusornis.rotateAngleX + (float) Math.toRadians(15.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80))*0.2), confuciusornis.rotateAngleY + (float) Math.toRadians(0), confuciusornis.rotateAngleZ + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80-50))*-2));
        this.confuciusornis.rotationPointX = this.confuciusornis.rotationPointX + (float)(0);
        this.confuciusornis.rotationPointY = this.confuciusornis.rotationPointY - (float)(0);
        this.confuciusornis.rotationPointZ = this.confuciusornis.rotationPointZ + (float)(0);
        ...
        this.setRotateAngle(tail, tail.rotateAngleX + (float) Math.toRadians(-4.25+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80-100))*1), tail.rotateAngleY + (float) Math.toRadians(0), tail.rotateAngleZ + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80-150))*3));


        this.setRotateAngle(neck, neck.rotateAngleX + (float) Math.toRadians(57.25), neck.rotateAngleY + (float) Math.toRadians(0), neck.rotateAngleZ + (float) Math.toRadians(0));
        this.neck.rotationPointX = this.neck.rotationPointX + (float)(0);
        this.neck.rotationPointY = this.neck.rotationPointY - (float)(-0.375);
        this.neck.rotationPointZ = this.neck.rotationPointZ + (float)(0);


        this.setRotateAngle(neck2, neck2.rotateAngleX + (float) Math.toRadians(-3), neck2.rotateAngleY + (float) Math.toRadians(0), neck2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(head, head.rotateAngleX + (float) Math.toRadians(-72.25), head.rotateAngleY + (float) Math.toRadians(0), head.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armright1, armright1.rotateAngleX + (float) Math.toRadians(-90.3264781502+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80/0.5))*0.5), armright1.rotateAngleY + (float) Math.toRadians(-0.16093), armright1.rotateAngleZ + (float) Math.toRadians(82.24635));
        this.armright1.rotationPointX = this.armright1.rotationPointX + (float)(0);
        this.armright1.rotationPointY = this.armright1.rotationPointY - (float)(0);
        this.armright1.rotationPointZ = this.armright1.rotationPointZ + (float)(0);


        this.setRotateAngle(tertialsright, tertialsright.rotateAngleX + (float) Math.toRadians(6), tertialsright.rotateAngleY + (float) Math.toRadians(0), tertialsright.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armright2, armright2.rotateAngleX + (float) Math.toRadians(134+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80/0.5-100))*0.2), armright2.rotateAngleY + (float) Math.toRadians(0), armright2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(secondariesright, secondariesright.rotateAngleX + (float) Math.toRadians(-30.5), secondariesright.rotateAngleY + (float) Math.toRadians(0), secondariesright.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armright3, armright3.rotateAngleX + (float) Math.toRadians(-121+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.4-150))*0.5), armright3.rotateAngleY + (float) Math.toRadians(0), armright3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright7, primaryright7.rotateAngleX + (float) Math.toRadians(-7.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryright7.rotateAngleY + (float) Math.toRadians(0), primaryright7.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright6, primaryright6.rotateAngleX + (float) Math.toRadians(2+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryright6.rotateAngleY + (float) Math.toRadians(0), primaryright6.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright5, primaryright5.rotateAngleX + (float) Math.toRadians(10.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryright5.rotateAngleY + (float) Math.toRadians(0), primaryright5.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright4, primaryright4.rotateAngleX + (float) Math.toRadians(24+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-250))*0.5), primaryright4.rotateAngleY + (float) Math.toRadians(0), primaryright4.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright3, primaryright3.rotateAngleX + (float) Math.toRadians(48.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-250))*0.5), primaryright3.rotateAngleY + (float) Math.toRadians(0), primaryright3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright2, primaryright2.rotateAngleX + (float) Math.toRadians(67.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-300))*0.5), primaryright2.rotateAngleY + (float) Math.toRadians(0), primaryright2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryright1, primaryright1.rotateAngleX + (float) Math.toRadians(79.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-350))*0.5), primaryright1.rotateAngleY + (float) Math.toRadians(0), primaryright1.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armleft1, armleft1.rotateAngleX + (float) Math.toRadians(-90.3264781502+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80/0.5))*0.5), armleft1.rotateAngleY + (float) Math.toRadians(0.16093), armleft1.rotateAngleZ + (float) Math.toRadians(-82.24635));
        this.armleft1.rotationPointX = this.armleft1.rotationPointX + (float)(0);
        this.armleft1.rotationPointY = this.armleft1.rotationPointY - (float)(0);
        this.armleft1.rotationPointZ = this.armleft1.rotationPointZ + (float)(0);


        this.setRotateAngle(tertialsleft, tertialsleft.rotateAngleX + (float) Math.toRadians(6), tertialsleft.rotateAngleY + (float) Math.toRadians(0), tertialsleft.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armleft2, armleft2.rotateAngleX + (float) Math.toRadians(134+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80/0.5-100))*0.2), armleft2.rotateAngleY + (float) Math.toRadians(0), armleft2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(secondariesleft, secondariesleft.rotateAngleX + (float) Math.toRadians(-30.5), secondariesleft.rotateAngleY + (float) Math.toRadians(0), secondariesleft.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(armleft3, armleft3.rotateAngleX + (float) Math.toRadians(-121+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.4-150))*0.5), armleft3.rotateAngleY + (float) Math.toRadians(0), armleft3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft7, primaryleft7.rotateAngleX + (float) Math.toRadians(-7.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryleft7.rotateAngleY + (float) Math.toRadians(0), primaryleft7.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft6, primaryleft6.rotateAngleX + (float) Math.toRadians(2+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryleft6.rotateAngleY + (float) Math.toRadians(0), primaryleft6.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft5, primaryleft5.rotateAngleX + (float) Math.toRadians(10.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.2-150))*0.5), primaryleft5.rotateAngleY + (float) Math.toRadians(0), primaryleft5.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft4, primaryleft4.rotateAngleX + (float) Math.toRadians(24+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-250))*0.5), primaryleft4.rotateAngleY + (float) Math.toRadians(0), primaryleft4.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft3, primaryleft3.rotateAngleX + (float) Math.toRadians(48.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-250))*0.5), primaryleft3.rotateAngleY + (float) Math.toRadians(0), primaryleft3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft2, primaryleft2.rotateAngleX + (float) Math.toRadians(67.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-300))*0.5), primaryleft2.rotateAngleY + (float) Math.toRadians(0), primaryleft2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(primaryleft1, primaryleft1.rotateAngleX + (float) Math.toRadians(79.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*65/0.201-350))*0.5), primaryleft1.rotateAngleY + (float) Math.toRadians(0), primaryleft1.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(hip, hip.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80-50))*0.4), hip.rotateAngleY + (float) Math.toRadians(0), hip.rotateAngleZ + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*80-150))*-2));


        this.setRotateAngle(tailfeatherright, tailfeatherright.rotateAngleX + (float) Math.toRadians(0), tailfeatherright.rotateAngleY + (float) Math.toRadians(0), tailfeatherright.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(tailfeatherright2, tailfeatherright2.rotateAngleX + (float) Math.toRadians(0), tailfeatherright2.rotateAngleY + (float) Math.toRadians(0), tailfeatherright2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(tailfeatherleft, tailfeatherleft.rotateAngleX + (float) Math.toRadians(0), tailfeatherleft.rotateAngleY + (float) Math.toRadians(0), tailfeatherleft.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(tailfeatherleft2, tailfeatherleft2.rotateAngleX + (float) Math.toRadians(0), tailfeatherleft2.rotateAngleY + (float) Math.toRadians(0), tailfeatherleft2.rotateAngleZ + (float) Math.toRadians(0));
