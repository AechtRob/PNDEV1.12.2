...
//        }
    ...
    public void animDrink(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 90) {
            ...
            xx = -5 + (((tickAnim - 140) / 41) * (-2.7711+Math.sin((Math.PI/180)*(tickAnim*150-50))*2-(-5)));
            ...
            xx = -2.7711+Math.sin((Math.PI/180)*(tickAnim*150-50))*2 + (((tickAnim - 181) / 54) * (0-(-2.7711+Math.sin((Math.PI/180)*(tickAnim*150-50))*2)));
