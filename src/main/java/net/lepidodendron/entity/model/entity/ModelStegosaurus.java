...
public class ModelStegosaurus extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        //Start of pose:
        this.setRotateAngle(main, 0.2F, 2.8F, -0.0F);
        this.setRotateAngle(upperbody, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(thagomizer4, 0.0F, -0.5236F, -0.3054F);
        this.setRotateAngle(thagomizer3, 0.0F, -0.2182F, -0.3054F);
        this.setRotateAngle(thagomizer2, 0.0F, 0.5236F, 0.3054F);
        ...
        this.setRotateAngle(tail5, 0.3494F, 0.041F, 0.0149F);
        this.setRotateAngle(tail4, 0.3124F, -0.2079F, -0.0666F);
        this.setRotateAngle(tail3, -0.0915F, -0.3042F, 0.0275F);
        this.setRotateAngle(tail2, -0.1372F, -0.3027F, 0.0411F);
        this.setRotateAngle(tail, -0.0962F, -0.4346F, 0.0406F);
        this.setRotateAngle(plate9, 0.6066F, -0.0883F, 0.0968F);
        this.setRotateAngle(Plate8, 0.0707F, 0.0106F, 0.1742F);
        this.setRotateAngle(plate7, 0.5208F, -0.0306F, 0.1287F);
        this.setRotateAngle(plate6, 0.0829F, -0.0522F, 0.1666F);
        ...
        this.setRotateAngle(frontrightleg4, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(frontrightleg3, -0.5634F, -0.045F, -0.1687F);
        this.setRotateAngle(frontrightleg2, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(frontrightleg, 0.3504F, -0.0969F, 0.1856F);
        this.setRotateAngle(frontleftleg4, 0.2618F, 0.0F, 0.0F);
        this.setRotateAngle(frontleftleg3, -0.0398F, 0.045F, 0.1687F);
        this.setRotateAngle(frontleftleg2, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(frontleftleg, -0.48F, 0.0F, -0.1745F);
        this.setRotateAngle(eye, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, 0.5934F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r8, -0.0524F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r7, 0.384F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(backrightleg2, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(backrightleg, -0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(backleftleg4, 0.3927F, 0.0F, 0.0F);
        this.setRotateAngle(backleftleg3, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(backleftleg2, 0.1745F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraStegosaurus stegosaurus = (EntityPrehistoricFloraStegosaurus) e;
        ...
        stegosaurus.tailBuffer.applyChainSwingBuffer(Tail);

        if (stegosaurus.getAnimation() == stegosaurus.LAY_ANIMATION) {
            this.chainSwing(Neck, 0.5F, 0.10F, 0.5, f2, 0.8F);
            this.chainWave(Neck, 0.5F * 2, -0.02F, 0.5F, f2, 0.8F);
        }
        else {
            if (!stegosaurus.isReallyInWater()) {

                if (f3 == 0.0F || !stegosaurus.getIsMoving()) {
                    if (stegosaurus.getAnimation() != stegosaurus.EAT_ANIMATION
                        && stegosaurus.getAnimation() != stegosaurus.DRINK_ANIMATION
                        && stegosaurus.getAnimation() != stegosaurus.ATTACK_ANIMATION) {
                        this.chainSwing(Neck, 0.05F, 0.10F, 0.5, f2, 0.8F);
                        this.chainWave(Neck, 0.05F * 2, -0.02F, 0.5F, f2, 0.8F);
                    }

                    if (stegosaurus.getAnimation() != stegosaurus.ATTACK_ANIMATION) {
                ...
                if (stegosaurus.getIsFast()) { //Running
