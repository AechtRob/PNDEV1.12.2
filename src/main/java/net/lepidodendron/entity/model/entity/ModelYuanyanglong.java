...
public class ModelYuanyanglong extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        setRotateAngle(tail3, 0.1865F, 0.1844F, 0.0346F);
        setRotateAngle(tail2, -0.3408F, 0.0535F, -0.019F);
        setRotateAngle(tail1, -0.4257F, 0.1194F, -0.0419F);
        setRotateAngle(root, 0.0F, 0.0F, -1.1476F);
        setRotateAngle(rightLeg3, -1.0482F, -0.098F, -0.0725F);
        setRotateAngle(rightLeg2, 1.002F, -0.0699F, 0.0446F);
        setRotateAngle(rightLeg1, -0.6579F, 0.1034F, -0.3976F);
        setRotateAngle(rightFoot, 0.8378F, -0.0029F, -0.0032F);
        setRotateAngle(rightArm1, 0.0758F, -0.1574F, -0.3201F);
        setRotateAngle(neck4, 0.2288F, -0.2452F, 0.1186F);
        setRotateAngle(neck3, 0.2988F, -0.3479F, 0.1356F);
        setRotateAngle(neck2, -0.08F, -0.3486F, 0.3525F);
        setRotateAngle(neck1, 0.4102F, -0.2051F, 0.0F);
        setRotateAngle(leftToes, 0.2225F, 0.0F, 0.0F);
        setRotateAngle(leftLeg3, -0.1512F, -0.0218F, -0.1423F);
        setRotateAngle(leftLeg2, 0.4622F, -0.1317F, -0.1673F);
        setRotateAngle(leftLeg1, 0.3415F, -0.0822F, -0.0292F);
        setRotateAngle(leftFoot, 1.6187F, 0.0027F, -0.0567F);
        setRotateAngle(leftArm3, 0.1552F, -0.0393F, -0.1249F);
        setRotateAngle(leftArm2, 0.4247F, -0.1247F, 0.1161F);
        setRotateAngle(leftArm1, 0.0586F, 0.7413F, 0.0305F);
        setRotateAngle(jaw, 0.3098F, 0.0F, 0.0F);
        setRotateAngle(head, -0.0785F, 0.0F, 0.0F);
        setRotateAngle(cube_r9, -0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r8, -0.5672F, 0.0F, 0.0F);
        setRotateAngle(cube_r7, 0.1745F, 0.0F, 0.0F);
        setRotateAngle(cube_r68, 1.5795F, 0.0F, 0.0F);
        setRotateAngle(cube_r67, 1.946F, 0.0F, 0.0F);
        setRotateAngle(cube_r66, 2.1031F, 0.0F, 0.0F);
        setRotateAngle(cube_r65, 0.7941F, 0.0F, 0.0F);
        setRotateAngle(cube_r64, 1.1257F, 0.0F, 0.0F);
        setRotateAngle(cube_r63, 0.794F, -0.0124F, 0.0122F);
        setRotateAngle(cube_r62, -0.6632F, 0.0F, 0.0F);
        setRotateAngle(cube_r61, -0.1222F, 0.0F, 0.0F);
        setRotateAngle(cube_r60, 1.5795F, 0.0F, 0.0F);
        setRotateAngle(cube_r6, -0.8203F, 0.0F, 0.0F);
        setRotateAngle(cube_r59, 1.946F, 0.0F, 0.0F);
        setRotateAngle(cube_r58, 2.1031F, 0.0F, 0.0F);
        setRotateAngle(cube_r57, 0.7941F, 0.0F, 0.0F);
        setRotateAngle(cube_r56, 1.1257F, 0.0F, 0.0F);
        setRotateAngle(cube_r55, 0.794F, 0.0124F, -0.0122F);
        setRotateAngle(cube_r54, -0.6632F, 0.0F, 0.0F);
        setRotateAngle(cube_r53, -0.1222F, 0.0F, 0.0F);
        setRotateAngle(cube_r52, 0.1063F, 0.1736F, 0.0184F);
        setRotateAngle(cube_r51, 0.1063F, -0.1736F, -0.0184F);
        setRotateAngle(cube_r50, -0.5236F, 0.0F, 0.0F);
        setRotateAngle(cube_r5, -0.0873F, 0.0F, 0.0F);
        setRotateAngle(cube_r49, 0.0873F, 0.0F, 0.0F);
        setRotateAngle(cube_r48, 0.4189F, 0.0F, 0.0F);
        setRotateAngle(cube_r47, 0.4189F, 0.0F, 0.0F);
        setRotateAngle(cube_r46, 0.1745F, 0.0F, 0.0F);
        setRotateAngle(cube_r45, -0.3316F, 0.0F, 0.0F);
        setRotateAngle(cube_r44, 0.3578F, 0.0F, 0.0F);
        setRotateAngle(cube_r43, -0.3316F, 0.0F, 0.0F);
        setRotateAngle(cube_r42, 0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r41, 0.4974F, 0.0F, 0.0F);
        setRotateAngle(cube_r40, 0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r4, -0.2618F, 0.0F, 0.0F);
        setRotateAngle(cube_r39, 0.4014F, 0.0F, 0.0F);
        setRotateAngle(cube_r38, -0.2531F, 0.0F, 0.0F);
        setRotateAngle(cube_r37, -1.1694F, 0.0F, 0.0F);
        setRotateAngle(cube_r36, -0.9163F, 0.0F, 0.0F);
        setRotateAngle(cube_r35, -0.6545F, 0.0F, 0.0F);
        setRotateAngle(cube_r34, -1.0908F, 0.0F, 0.0F);
        setRotateAngle(cube_r33, -1.1957F, -0.0036F, 0.0003F);
        setRotateAngle(cube_r32, -0.829F, 0.0F, 0.0F);
        setRotateAngle(cube_r31, -0.9512F, 0.0F, 0.0F);
        setRotateAngle(cube_r30, -0.4102F, 0.0F, 0.0F);
        setRotateAngle(cube_r3, -0.2094F, 0.0F, 0.0F);
        setRotateAngle(cube_r29, -0.8465F, 0.0F, 0.0F);
        setRotateAngle(cube_r28, -0.5498F, 0.0F, 0.0F);
        setRotateAngle(cube_r27, 0.1833F, 0.0F, 0.0F);
        setRotateAngle(cube_r26, 0.3054F, 0.0F, 0.0F);
        setRotateAngle(cube_r25, 0.4363F, 0.0F, 0.0F);
        setRotateAngle(cube_r24, -0.2967F, 0.0F, 0.0F);
        setRotateAngle(cube_r23, -0.6283F, 0.0F, 0.0F);
        setRotateAngle(cube_r22, -0.2287F, 0.1192F, 0.4025F);
        setRotateAngle(cube_r21, -0.2287F, -0.1192F, -0.4025F);
        setRotateAngle(cube_r20, -0.2793F, 0.0F, 0.0F);
        setRotateAngle(cube_r2, 0.0611F, 0.0F, 0.0F);
        setRotateAngle(cube_r19, -0.2724F, 0.1192F, 0.4025F);
        setRotateAngle(cube_r18, -0.2724F, -0.1192F, -0.4025F);
        setRotateAngle(cube_r17, -0.2618F, 0.0F, 0.0F);
        setRotateAngle(cube_r16, -0.0873F, 0.0F, 0.0F);
        setRotateAngle(cube_r15, -0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r14, -0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r13, -0.5672F, 0.0F, 0.0F);
        setRotateAngle(cube_r12, 0.1745F, 0.0F, 0.0F);
        setRotateAngle(cube_r11, -0.8203F, 0.0F, 0.0F);
        setRotateAngle(cube_r10, -0.1047F, 0.0F, 0.0F);
        setRotateAngle(cube_r1, 0.0087F, 0.0F, 0.0F);
        setRotateAngle(chest, 0.1073F, -0.2026F, 0.1085F);
