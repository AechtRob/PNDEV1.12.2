...
public class ModelLacewing extends AdvancedModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (ee.flyProgress != 0 && ee.getAttachmentPos() == null) {//if flying
            animFlying(entitylivingbaseIn, limbSwing, limbSwingAmount, partialTickTime);
                ...
                this.setRotateAngle(hindwingL, head.rotateAngleX+(float)Math.toRadians(2.5), head.rotateAngleY+(float)Math.toRadians(-37.5), head.rotateAngleZ+(float)Math.toRadians(42.5));
                ...
                this.setRotateAngle(hindwingR, head.rotateAngleX+(float)Math.toRadians(2.5), head.rotateAngleY+(float)Math.toRadians(37.5), head.rotateAngleZ+(float)Math.toRadians(-42.5));
