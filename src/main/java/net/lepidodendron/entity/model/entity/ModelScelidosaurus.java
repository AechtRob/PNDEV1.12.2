...
public class ModelScelidosaurus extends ModelBasePalaeopedia {
    ...
    public ModelScelidosaurus() {
        ...
        this.cube_r123.setRotationPoint(-3.3144F, 0.4369F, 0.0621F);
        this.bipartiteOsteoderm.addChild(cube_r123);
        this.setRotateAngle(cube_r123, -0.0853F, 0.0499F, -0.6517F);
        this.cube_r123.cubeList.add(new ModelBox(cube_r123, 43, 36, -1.0216F, 1.0518F, -0.3566F, 2, 0, 1, 0.0F, true));

        this.cube_r124 = new AdvancedModelRenderer(this);
        this.cube_r124.setRotationPoint(0.6856F, 0.4369F, 0.0621F);
        this.bipartiteOsteoderm.addChild(cube_r124);
        this.setRotateAngle(cube_r124, -0.0853F, -0.0499F, 0.6517F);
        this.cube_r124.cubeList.add(new ModelBox(cube_r124, 43, 36, -0.9784F, 1.0518F, -0.3566F, 2, 0, 1, 0.0F, false));

        this.cube_r125 = new AdvancedModelRenderer(this);
        this.cube_r125.setRotationPoint(-2.1446F, -1.314F, -0.4161F);
        this.bipartiteOsteoderm.addChild(cube_r125);
        this.setRotateAngle(cube_r125, 0.0F, 0.0F, -0.1309F);
        this.cube_r125.cubeList.add(new ModelBox(cube_r125, 6, 25, 0.0F, -0.4F, -1.0F, 0, 1, 2, 0.0F, true));

        this.cube_r126 = new AdvancedModelRenderer(this);
        this.cube_r126.setRotationPoint(-0.4843F, -1.314F, -0.4161F);
        this.bipartiteOsteoderm.addChild(cube_r126);
        this.setRotateAngle(cube_r126, 0.0F, 0.0F, 0.1309F);
        this.cube_r126.cubeList.add(new ModelBox(cube_r126, 6, 25, 0.0F, -0.4F, -1.0F, 0, 1, 2, 0.0F, false));

        this.cube_r127 = new AdvancedModelRenderer(this);
        this.cube_r127.setRotationPoint(-3.1006F, -0.9467F, 0.0621F);
        this.bipartiteOsteoderm.addChild(cube_r127);
        this.setRotateAngle(cube_r127, 0.0F, 0.0F, -0.8727F);
        this.cube_r127.cubeList.add(new ModelBox(cube_r127, 14, 62, -0.592F, -0.2621F, -0.8414F, 0, 2, 1, 0.0F, true));
