...
public class ModelBajadasaurus extends ModelBasePalaeopedia {
    ...
    public void renderStaticWall(float f) {
        this.neck1.offsetZ = 0.06F;
        this.neck1.render(0.01F);
        resetToDefaultPose();
    }
    public void renderStaticFloor(float f) {
        this.setRotateAngle(throat, -0.4669F, 0.0F, 0.0F);
        this.setRotateAngle(tail8, -0.3504F, 0.0861F, -0.0314F);
        this.setRotateAngle(tail7, 0.0176F, 0.144F, 0.0025F);
        this.setRotateAngle(tail6, 0.2228F, 0.0511F, 0.0116F);
        this.setRotateAngle(tail5, 0.2161F, 0.145F, 0.0317F);
        this.setRotateAngle(tail4, 0.3589F, 0.0827F, 0.0278F);
        this.setRotateAngle(tail3, 0.1345F, -0.0721F, -0.0536F);
        this.setRotateAngle(tail2, 0.0884F, -0.0459F, -0.0259F);
        this.setRotateAngle(tail1, -0.3316F, 0.0F, 0.0F);
        this.setRotateAngle(rightToes, 0.0F, 0.3054F, 0.0F);
        this.setRotateAngle(rightLeg2, 0.3927F, 0.0F, -0.1745F);
        this.setRotateAngle(rightLeg1, 0.2618F, 0.0F, 0.1745F);
        this.setRotateAngle(rightHand, 0.829F, 0.0F, 0.0F);
        this.setRotateAngle(rightFoot, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm2, -0.9381F, 0.0F, -0.0873F);
        this.setRotateAngle(rightArm1, 0.5716F, 0.0F, 0.0873F);
        this.setRotateAngle(neck4Bone, 0.7854F, 0.0F, 0.0F);
        this.setRotateAngle(neck4, 0.3864F, 0.1092F, 0.0443F);
        this.setRotateAngle(neck3BoneRight1, 0.0396F, -0.1248F, -0.3079F);
        this.setRotateAngle(neck3BoneLeft1, 0.0396F, 0.1248F, 0.3079F);
        this.setRotateAngle(neck3, 0.2076F, 0.112F, -0.0069F);
        this.setRotateAngle(neck2BoneRight2, -0.3491F, 0.0F, -0.3054F);
        this.setRotateAngle(neck2BoneRight1, -0.6641F, -0.0679F, -0.2578F);
        this.setRotateAngle(neck2BoneLeft2, -0.3491F, 0.0F, 0.3054F);
        this.setRotateAngle(neck2BoneLeft1, -0.6036F, 0.0785F, 0.2581F);
        this.setRotateAngle(neck2, 0.6181F, 0.1196F, -0.025F);
        this.setRotateAngle(neck1BoneRight1, -0.1523F, 0.1439F, -0.2646F);
        this.setRotateAngle(neck1BoneLeft1, -0.1523F, -0.1439F, 0.2646F);
        this.setRotateAngle(neck1, -0.0538F, 0.1408F, 0.0031F);
        this.setRotateAngle(leftToes, 0.0F, -0.3054F, 0.0F);
        this.setRotateAngle(leftLeg2, 0.384F, 0.0F, 0.1745F);
        this.setRotateAngle(leftLeg1, 0.2618F, 0.0F, -0.1745F);
        this.setRotateAngle(leftHand, 0.6458F, 0.0F, 0.0F);
        this.setRotateAngle(leftFoot, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm2, -0.9512F, 0.0F, 0.0873F);
        this.setRotateAngle(leftArm1, 0.1222F, 0.0F, -0.0873F);
        this.setRotateAngle(jaw, 0.2574F, 0.0F, 0.0F);
        this.setRotateAngle(hips, 2.6837F, -0.0421F, 3.1303F);
        this.setRotateAngle(head, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, -0.0341F, -0.1439F, 0.2646F);
        this.setRotateAngle(cube_r8, -0.0341F, 0.1439F, -0.2646F);
        this.setRotateAngle(cube_r7, 0.3054F, 0.0F, -0.6109F);
        ...
        this.setRotateAngle(cube_r10, 0.0F, 0.0F, -0.3054F);
        this.setRotateAngle(cube_r1, -0.0175F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.2188F, 0.0859F, 0.0152F);
        this.setRotateAngle(body, 0.1179F, 0.039F, 0.0046F);
        this.hips.offsetY = -0.146F;
