...
public class ModelGargoyleosaurus extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(Neck2, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(legright4, 0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(legright3, -0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(legright2, 0.5236F, 0.0F, 0.0F);
        this.setRotateAngle(legright, -0.3054F, 0.1309F, 0.0F);
        this.setRotateAngle(legleft4, 0.2182F, 0.0F, 0.0F);
        this.setRotateAngle(legleft3, -0.1308F, -0.0057F, -0.0433F);
        this.setRotateAngle(legleft2, 0.8297F, 0.0563F, -0.0027F);
        this.setRotateAngle(legleft, 0.3491F, -0.1309F, 0.0F);
        this.setRotateAngle(Jaw, 0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(Head, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, -0.1057F, 0.5225F, -0.3294F);
        this.setRotateAngle(cube_r8, 0.133F, 0.4333F, -0.2755F);
        ...
        this.setRotateAngle(bone2, -0.1134F, 0.0873F, -0.3491F);
        this.setRotateAngle(bone, -0.0436F, 0.1309F, -0.7854F);
        this.setRotateAngle(armright3, 0.8693F, -0.0045F, -0.0395F);
        this.setRotateAngle(armright2, -1.4825F, 0.0051F, 0.0023F);
        this.setRotateAngle(armright, 0.6588F, -0.438F, 0.2209F);
        this.setRotateAngle(armleft3, 0.2148F, 0.0045F, 0.0395F);
        this.setRotateAngle(armleft2, -0.6537F, 0.0345F, 0.045F);
        this.setRotateAngle(armleft, 0.3897F, 0.3036F, -0.1316F);
