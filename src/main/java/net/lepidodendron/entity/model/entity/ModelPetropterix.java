...
public class ModelPetropterix extends ModelBasePalaeopedia {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraPetropterix ee = (EntityPrehistoricFloraPetropterix) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraPetropterix ee = (EntityPrehistoricFloraPetropterix) entitylivingbaseIn;
    ...
    public void animGliding(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraPetropterix entity = (EntityPrehistoricFloraPetropterix) entitylivingbaseIn;
        int animCycle = 38;
