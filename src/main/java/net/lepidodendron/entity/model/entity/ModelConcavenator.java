...
public class ModelConcavenator extends ModelBasePalaeopedia {
    ...
    public void renderStaticWall(float f) {
        this.neck.offsetZ = 0.01F;
        this.neck.offsetY = -0.02F;
        this.setRotateAngle(neck, -0.7112F, 0.0F, 0.0F);
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(throat2, -0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(throat, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(tail5, -0.029F, -0.1527F, 0.037F);
        this.setRotateAngle(tail4, -0.0426F, -0.2025F, 0.0325F);
        this.setRotateAngle(tail3, -0.0754F, -0.1384F, 0.0183F);
        this.setRotateAngle(tail2, 0.1138F, -0.078F, -0.0089F);
        this.setRotateAngle(tail, 0.1706F, 0.0779F, 0.0103F);
        this.setRotateAngle(righttoes, 0.7374F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg3, -1.2523F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg2, 1.4748F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg, -0.0218F, 0.0F, 0.0F);
        this.setRotateAngle(righthand, 0.0F, 0.0F, -0.672F);
        this.setRotateAngle(rightfoot, 0.829F, 0.0F, 0.0F);
        this.setRotateAngle(rightarm2, -1.3832F, 0.0F, 0.0F);
        this.setRotateAngle(rightarm, 1.0305F, -0.3253F, 0.1273F);
        this.setRotateAngle(neck4, 0.2837F, -0.0251F, -0.0073F);
        this.setRotateAngle(neck3, 0.0521F, -0.2999F, -0.0271F);
        this.setRotateAngle(neck2, 0.2976F, -0.0751F, -0.023F);
        this.setRotateAngle(neck, -0.7112F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg3, -0.9468F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg2, 0.9905F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg, -0.6127F, -0.0828F, -0.107F);
        this.setRotateAngle(lefthand, 0.0F, 0.0F, 0.6109F);
        this.setRotateAngle(leftfoot, 0.6065F, 0.0F, 0.0F);
        this.setRotateAngle(leftarm2, -1.2444F, 0.1448F, 0.0488F);
        this.setRotateAngle(leftarm, 1.2151F, 0.4042F, -0.082F);
        this.setRotateAngle(JAWPART, -0.0436F, 0.0F, 0.0F);
        this.setRotateAngle(jaw, 0.7985F, 0.0F, 0.0F);
        this.setRotateAngle(hips, -0.0478F, 0.0042F, 0.0872F);
        this.setRotateAngle(HEADPART9, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(HEADPART8, 0.7854F, 0.0F, 0.0F);
        this.setRotateAngle(HEADPART7, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(HEADPART6, 0.5677F, 0.0021F, 0.198F);
        ...
        this.setRotateAngle(HEADPART10, 0.7854F, 0.0F, 0.0F);
        this.setRotateAngle(HEADPART, 0.1833F, 0.0F, 0.0F);
        this.setRotateAngle(head, -0.1717F, -0.0695F, -0.0435F);
        this.setRotateAngle(eyeright, -0.192F, 0.0F, 0.0F);
        this.setRotateAngle(eyeleft, -0.192F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, 0.8901F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r8, 1.7453F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(cube_r10, -0.3185F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r1, -2.906F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.0911F, -0.1534F, -0.0943F);
        this.setRotateAngle(body, 0.2254F, -0.1779F, 0.0661F);
