...
public class ModelSyllipsimopodi extends AdvancedModelBaseExtended {
    ...
    public ModelSyllipsimopodi() {
        ...
        this.body.cubeList.add(new ModelBox(body, 0, 0, -2.5F, -3.5F, -5.0F, 5, 3, 11, 0.0F, false));

        this.body2 = new AdvancedModelRendererExtended(this);
        this.body2.setRotationPoint(0.0F, -2.0F, 5.75F);
        this.body.addChild(body2);
        this.setRotateAngle(body2, -0.0436F, 0.0F, 0.0F);
        this.body2.cubeList.add(new ModelBox(body2, 0, 14, -2.0F, -1.0F, 0.0F, 4, 2, 6, 0.0F, false));

        this.body3 = new AdvancedModelRendererExtended(this);
        this.body3.setRotationPoint(0.0F, 0.0F, 5.75F);
        ...
        this.body3.cubeList.add(new ModelBox(body3, 8, 14, -2.5F, 0.0F, 0.0F, 5, 0, 6, 0.0F, false));
        ...
        this.head.cubeList.add(new ModelBox(head, 0, 14, -2.5F, 0.5F, -2.75F, 1, 2, 2, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 5, 0, -2.55F, 1.0F, -2.25F, 1, 1, 1, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 0, 14, 1.5F, 0.5F, -2.75F, 1, 2, 2, 0.0F, true));
        this.head.cubeList.add(new ModelBox(head, 5, 0, 1.6F, 1.0F, -2.25F, 1, 1, 1, 0.0F, true));
        ...
        this.arm.cubeList.add(new ModelBox(arm, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, false));

        this.arms = new AdvancedModelRendererExtended(this);
        this.arms.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm.addChild(arms);
        this.arms.cubeList.add(new ModelBox(arms, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, false));
        ...
        this.arm5.cubeList.add(new ModelBox(arm5, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, false));

        this.arms5 = new AdvancedModelRendererExtended(this);
        this.arms5.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm5.addChild(arms5);
        this.arms5.cubeList.add(new ModelBox(arms5, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, false));
        ...
        this.arm7.cubeList.add(new ModelBox(arm7, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, false));

        this.arms7 = new AdvancedModelRendererExtended(this);
        this.arms7.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm7.addChild(arms7);
        this.arms7.cubeList.add(new ModelBox(arms7, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, false));
        ...
        this.arm8.cubeList.add(new ModelBox(arm8, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, true));

        this.arms8 = new AdvancedModelRendererExtended(this);
        this.arms8.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm8.addChild(arms8);
        this.arms8.cubeList.add(new ModelBox(arms8, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, true));
        ...
        this.arm6.cubeList.add(new ModelBox(arm6, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, true));

        this.arms6 = new AdvancedModelRendererExtended(this);
        this.arms6.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm6.addChild(arms6);
        this.arms6.cubeList.add(new ModelBox(arms6, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, true));
        ...
        this.arm3.cubeList.add(new ModelBox(arm3, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, false));

        this.arms3 = new AdvancedModelRendererExtended(this);
        this.arms3.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm3.addChild(arms3);
        this.arms3.cubeList.add(new ModelBox(arms3, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, false));
        ...
        this.arm4.cubeList.add(new ModelBox(arm4, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, true));

        this.arms4 = new AdvancedModelRendererExtended(this);
        this.arms4.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm4.addChild(arms4);
        this.arms4.cubeList.add(new ModelBox(arms4, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, true));
        ...
        this.arm2.cubeList.add(new ModelBox(arm2, 21, 7, -0.5F, -0.5F, -3.0F, 1, 1, 3, 0.0F, true));

        this.arms2 = new AdvancedModelRendererExtended(this);
        this.arms2.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.arm2.addChild(arms2);
        this.arms2.cubeList.add(new ModelBox(arms2, 0, 4, -0.5F, -0.5F, -2.975F, 1, 1, 3, -0.01F, true));
        ...
        this.tentacle.cubeList.add(new ModelBox(tentacle, 0, 23, -0.5F, -0.5F, -6.0F, 1, 1, 6, 0.0F, false));

        this.tentacles = new AdvancedModelRendererExtended(this);
        this.tentacles.setRotationPoint(0.0F, 0.0F, -6.0F);
        this.tentacle.addChild(tentacles);
        this.tentacles.cubeList.add(new ModelBox(tentacles, 21, 0, -0.5F, -0.5F, -5.975F, 1, 1, 6, -0.01F, false));
        ...
        this.tentacle2.cubeList.add(new ModelBox(tentacle2, 0, 23, -0.5F, -0.5F, -6.0F, 1, 1, 6, 0.0F, true));

        this.tentacles2 = new AdvancedModelRendererExtended(this);
        this.tentacles2.setRotationPoint(0.0F, 0.0F, -6.0F);
        this.tentacle2.addChild(tentacles2);
        this.tentacles2.cubeList.add(new ModelBox(tentacles2, 21, 0, -0.5F, -0.5F, -5.975F, 1, 1, 6, -0.01F, true));
