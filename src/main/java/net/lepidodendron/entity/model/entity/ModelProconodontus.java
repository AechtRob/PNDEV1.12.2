...
public class ModelProconodontus extends ModelBasePalaeopedia {
    ...
    public ModelProconodontus() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 24.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 14, 18, -1.5F, -4.0F, -7.0F, 3, 3, 4, 0.0F, false));
        ...
        this.eyeL.cubeList.add(new ModelBox(eyeL, 24, 16, -0.25F, -1.25F, -1.25F, 2, 2, 2, 0.0F, false));
        this.eyeL.cubeList.add(new ModelBox(eyeL, 0, 0, 1.76F, -0.75F, -0.75F, 0, 1, 1, 0.0F, false));
        ...
        this.eyeR.cubeList.add(new ModelBox(eyeR, 24, 16, -1.75F, -1.25F, -1.25F, 2, 2, 2, 0.0F, true));
        this.eyeR.cubeList.add(new ModelBox(eyeR, 0, 0, -1.76F, -0.75F, -0.75F, 0, 1, 1, 0.0F, true));
        ...
        this.mouth.cubeList.add(new ModelBox(mouth, 14, 0, -1.5F, 0.05F, -2.0F, 3, 1, 4, 0.01F, false));
        ...
        this.toothL.cubeList.add(new ModelBox(toothL, 0, 2, -0.49F, -0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        this.toothL.cubeList.add(new ModelBox(toothL, 0, 0, -0.99F, 0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        ...
        this.toothR.cubeList.add(new ModelBox(toothR, 0, 2, -0.51F, -0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        this.toothR.cubeList.add(new ModelBox(toothR, 0, 0, -0.01F, 0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        ...
        this.toothR2.cubeList.add(new ModelBox(toothR2, 0, 2, -0.51F, -0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        this.toothR2.cubeList.add(new ModelBox(toothR2, 0, 0, -0.01F, 0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        ...
        this.toothR3.cubeList.add(new ModelBox(toothR3, 0, 2, -0.51F, -0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        this.toothR3.cubeList.add(new ModelBox(toothR3, 0, 0, -0.01F, 0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        ...
        this.toothR4.cubeList.add(new ModelBox(toothR4, 0, 2, -0.51F, -0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        this.toothR4.cubeList.add(new ModelBox(toothR4, 0, 0, -0.01F, 0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        ...
        this.toothR5.cubeList.add(new ModelBox(toothR5, 0, 2, -0.51F, -0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        this.toothR5.cubeList.add(new ModelBox(toothR5, 0, 0, -0.01F, 0.5F, 0.0F, 1, 1, 0, 0.0F, true));
        ...
        this.toothL2.cubeList.add(new ModelBox(toothL2, 0, 2, -0.49F, -0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        this.toothL2.cubeList.add(new ModelBox(toothL2, 0, 0, -0.99F, 0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        ...
        this.toothL3.cubeList.add(new ModelBox(toothL3, 0, 2, -0.49F, -0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        this.toothL3.cubeList.add(new ModelBox(toothL3, 0, 0, -0.99F, 0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        ...
        this.toothL4.cubeList.add(new ModelBox(toothL4, 0, 2, -0.49F, -0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        this.toothL4.cubeList.add(new ModelBox(toothL4, 0, 0, -0.99F, 0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        ...
        this.toothL5.cubeList.add(new ModelBox(toothL5, 0, 2, -0.49F, -0.5F, 0.0F, 1, 1, 0, 0.0F, false));
        this.toothL5.cubeList.add(new ModelBox(toothL5, 0, 0, -0.99F, 0.5F, 0.0F, 1, 1, 0, 0.0F, false));

        this.gill = new AdvancedModelRenderer(this);
        this.gill.setRotationPoint(0.0F, -2.5F, -3.0F);
        this.head.addChild(gill);
        this.gill.cubeList.add(new ModelBox(gill, 0, 12, -1.5F, -2.01F, 0.0F, 3, 4, 6, 0.0F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 0.0F, 6.0F);
        this.gill.addChild(body);
        this.body.cubeList.add(new ModelBox(body, 0, 0, -1.5F, -2.01F, 0.0F, 3, 4, 8, 0.0F, false));

        this.body2 = new AdvancedModelRenderer(this);
        this.body2.setRotationPoint(0.0F, -0.5F, 8.0F);
        this.body.addChild(body2);
        this.body2.cubeList.add(new ModelBox(body2, 16, 6, -1.0F, -1.51F, 0.0F, 2, 4, 6, 0.0F, false));

        this.body3 = new AdvancedModelRenderer(this);
        this.body3.setRotationPoint(0.0F, 0.0F, 6.0F);
        this.body2.addChild(body3);
        this.body3.cubeList.add(new ModelBox(body3, 26, 21, -0.5F, -1.01F, 0.0F, 1, 3, 4, 0.0F, false));
        this.body3.cubeList.add(new ModelBox(body3, 18, 21, 0.0F, -2.51F, 0.0F, 0, 6, 4, 0.0F, false));

        this.body4 = new AdvancedModelRenderer(this);
        this.body4.setRotationPoint(0.0F, 0.0F, 4.0F);
        this.body3.addChild(body4);
        this.body4.cubeList.add(new ModelBox(body4, 26, 1, -0.5F, -1.01F, 0.0F, 1, 3, 4, 0.0F, false));
        this.body4.cubeList.add(new ModelBox(body4, 10, 21, 0.0F, -2.51F, 0.0F, 0, 6, 4, 0.0F, false));

        this.body5 = new AdvancedModelRenderer(this);
        this.body5.setRotationPoint(0.0F, 0.0F, 4.0F);
        this.body4.addChild(body5);
        this.body5.cubeList.add(new ModelBox(body5, 0, 0, -0.5F, -0.51F, 0.0F, 1, 2, 3, 0.0F, false));
        this.body5.cubeList.add(new ModelBox(body5, 0, 17, 0.0F, -2.01F, 0.0F, 0, 5, 5, 0.0F, false));
        updateDefaultPose();
    }
    ...
    public void renderStaticWall(float f) {
        ...
        this.head.offsetZ = 0.46F;
        this.head.render(0.01F);
        this.resetToDefaultPose();
    }
    public void renderStaticFloor(float f) {
        this.setRotateAngle(head, -0.5F, 0.3F, 0.0F);
