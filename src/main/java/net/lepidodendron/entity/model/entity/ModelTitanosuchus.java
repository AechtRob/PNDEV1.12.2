...
public class ModelTitanosuchus extends AdvancedModelBaseExtended {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraTitanosuchus Titanosuchus = (EntityPrehistoricFloraTitanosuchus) e;
        float masterSpeed = Titanosuchus.getTravelSpeed();
        ...
        //if (Titanosuchus.getAnimation() == Titanosuchus.LAY_ANIMATION) {
        ...
        if (f3 == 0.0F || !Titanosuchus.getIsMoving()) { //Not moving
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraTitanosuchus e = (EntityPrehistoricFloraTitanosuchus) entity;
