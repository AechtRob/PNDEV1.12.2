...
public class ModelRebellatrix extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(Body1stsegment, 0.0F, 0.1F, 0.0F);
        this.setRotateAngle(Body2ndsegment, 0.0F, 0.1F, 0.0F);
