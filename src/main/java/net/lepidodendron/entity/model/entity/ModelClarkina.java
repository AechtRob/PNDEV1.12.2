...
public class ModelClarkina extends ModelBasePalaeopedia {
    ...
    public ModelClarkina() {
        ...
        this.eyeR.cubeList.add(new ModelBox(eyeR, 0, 45, -1.76F, -0.75F, -0.75F, 0, 1, 1, 0.0F, true));
        ...
        this.eyeL.cubeList.add(new ModelBox(eyeL, 0, 45, 1.76F, -0.75F, -0.75F, 0, 1, 1, 0.0F, false));
        ...
        this.mouth.cubeList.add(new ModelBox(mouth, 0, 38, -1.5F, 0.0F, -1.75F, 3, 1, 4, 0.01F, false));
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(body4, -0.05F, 0.3F, 0.0F);
        this.setRotateAngle(body5, -0.05F, 0.3F, 0.0F);
        this.setRotateAngle(body6, -0.1F, 0.3F, 0.0F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        AdvancedModelRenderer[] fishTail = {this.body, this.body2, this.body3, this.body4, this.body5, this.body6, this.tail1, this.tail2, this.tail4};
        float speed = 0.5F;
        if (!e.isInWater()) {
            speed = 0.8F;
        }
