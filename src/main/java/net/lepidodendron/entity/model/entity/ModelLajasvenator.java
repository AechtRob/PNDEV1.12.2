...
import net.lepidodendron.entity.EntityPrehistoricFloraLajasvenator;
import net.lepidodendron.entity.model.ModelBasePalaeopedia;
import net.minecraft.client.model.ModelBox;
import net.minecraft.entity.Entity;
import net.minecraft.entity.EntityLivingBase;

public class ModelLajasvenator extends ModelBasePalaeopedia {
    ...
    public ModelLajasvenator() {
        this.textureWidth = 70;
        this.textureHeight = 70;

        this.hips = new AdvancedModelRenderer(this);
        this.hips.setRotationPoint(0.0F, 10.5F, 2.5F);
        this.setRotateAngle(hips, -0.1309F, 0.0F, 0.0F);
        this.hips.cubeList.add(new ModelBox(hips, 0, 16, -2.5F, -2.5F, -4.0F, 5, 7, 8, 0.0F, false));

        this.leftLeg1 = new AdvancedModelRenderer(this);
        this.leftLeg1.setRotationPoint(2.25F, 0.0F, 0.0F);
        this.hips.addChild(leftLeg1);
        this.setRotateAngle(leftLeg1, -0.2182F, 0.0F, 0.0F);
        this.leftLeg1.cubeList.add(new ModelBox(leftLeg1, 19, 44, -1.5F, -2.0F, -2.0F, 3, 8, 4, 0.0F, false));

        this.leftLeg2 = new AdvancedModelRenderer(this);
        this.leftLeg2.setRotationPoint(0.0F, 5.25F, -0.5F);
        this.leftLeg1.addChild(leftLeg2);
        this.setRotateAngle(leftLeg2, 0.829F, 0.0F, 0.0F);
        this.leftLeg2.cubeList.add(new ModelBox(leftLeg2, 52, 0, -1.0F, -0.75F, -1.5F, 2, 8, 2, 0.0F, false));
        this.leftLeg2.cubeList.add(new ModelBox(leftLeg2, 34, 53, -1.0F, -0.75F, 0.0F, 2, 8, 1, -0.01F, false));

        this.leftLeg3 = new AdvancedModelRenderer(this);
        this.leftLeg3.setRotationPoint(0.0F, 6.75F, -0.25F);
        this.leftLeg2.addChild(leftLeg3);
        this.setRotateAngle(leftLeg3, -0.9599F, 0.0F, 0.0F);
        this.leftLeg3.cubeList.add(new ModelBox(leftLeg3, 61, 5, -1.0F, -0.5F, -0.25F, 2, 3, 1, -0.02F, false));
        this.leftLeg3.cubeList.add(new ModelBox(leftLeg3, 9, 61, -1.0F, -0.5F, -0.75F, 2, 3, 1, -0.01F, false));

        this.leftFoot = new AdvancedModelRenderer(this);
        this.leftFoot.setRotationPoint(0.0F, 2.25F, 0.0F);
        this.leftLeg3.addChild(leftFoot);
        this.setRotateAngle(leftFoot, 0.48F, 0.0F, 0.0F);
        this.leftFoot.cubeList.add(new ModelBox(leftFoot, 0, 54, -1.5F, -0.25F, -1.5F, 3, 1, 2, 0.0F, false));

        this.leftToes = new AdvancedModelRenderer(this);
        this.leftToes.setRotationPoint(0.0F, 0.25F, -1.25F);
        this.leftFoot.addChild(leftToes);
        this.leftToes.cubeList.add(new ModelBox(leftToes, 11, 57, -1.5F, -0.5F, -1.75F, 3, 1, 2, -0.01F, false));

        this.rightLeg1 = new AdvancedModelRenderer(this);
        this.rightLeg1.setRotationPoint(-2.25F, 0.0F, 0.0F);
        this.hips.addChild(rightLeg1);
        this.setRotateAngle(rightLeg1, -0.2182F, 0.0F, 0.0F);
        this.rightLeg1.cubeList.add(new ModelBox(rightLeg1, 19, 44, -1.5F, -2.0F, -2.0F, 3, 8, 4, 0.0F, true));

        this.rightLeg2 = new AdvancedModelRenderer(this);
        this.rightLeg2.setRotationPoint(0.0F, 5.25F, -0.5F);
        this.rightLeg1.addChild(rightLeg2);
        this.setRotateAngle(rightLeg2, 0.829F, 0.0F, 0.0F);
        this.rightLeg2.cubeList.add(new ModelBox(rightLeg2, 52, 0, -1.0F, -0.75F, -1.5F, 2, 8, 2, 0.0F, true));
        this.rightLeg2.cubeList.add(new ModelBox(rightLeg2, 34, 53, -1.0F, -0.75F, 0.0F, 2, 8, 1, -0.01F, true));

        this.rightLeg3 = new AdvancedModelRenderer(this);
        this.rightLeg3.setRotationPoint(0.0F, 6.75F, -0.25F);
        this.rightLeg2.addChild(rightLeg3);
        this.setRotateAngle(rightLeg3, -0.9599F, 0.0F, 0.0F);
        this.rightLeg3.cubeList.add(new ModelBox(rightLeg3, 61, 5, -1.0F, -0.5F, -0.25F, 2, 3, 1, -0.02F, true));
        this.rightLeg3.cubeList.add(new ModelBox(rightLeg3, 9, 61, -1.0F, -0.5F, -0.75F, 2, 3, 1, -0.01F, true));

        this.rightFoot = new AdvancedModelRenderer(this);
        this.rightFoot.setRotationPoint(0.0F, 2.25F, 0.0F);
        this.rightLeg3.addChild(rightFoot);
        this.setRotateAngle(rightFoot, 0.48F, 0.0F, 0.0F);
        this.rightFoot.cubeList.add(new ModelBox(rightFoot, 0, 54, -1.5F, -0.25F, -1.5F, 3, 1, 2, 0.0F, true));

        this.rightToes = new AdvancedModelRenderer(this);
        this.rightToes.setRotationPoint(0.0F, 0.25F, -1.25F);
        this.rightFoot.addChild(rightToes);
        this.rightToes.cubeList.add(new ModelBox(rightToes, 11, 57, -1.5F, -0.5F, -1.75F, 3, 1, 2, -0.01F, true));

        this.tail1 = new AdvancedModelRenderer(this);
        this.tail1.setRotationPoint(0.0F, -0.75F, 3.5F);
        this.hips.addChild(tail1);
        this.setRotateAngle(tail1, 0.0436F, 0.0F, 0.0F);
        this.tail1.cubeList.add(new ModelBox(tail1, 27, 16, -1.5F, -1.5F, -0.5F, 3, 5, 9, 0.0F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.0F, 8.0F);
        this.tail1.addChild(tail2);
        this.setRotateAngle(tail2, 0.1309F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 27, 31, -1.0F, -1.25F, -0.5F, 2, 3, 9, 0.0F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, -0.1F, 8.0F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, -0.1745F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 0, 32, -0.5F, -1.0F, -0.5F, 1, 2, 9, 0.0F, false));

        this.tail4 = new AdvancedModelRenderer(this);
        this.tail4.setRotationPoint(0.0F, 0.0F, 8.0F);
        this.tail3.addChild(tail4);
        this.setRotateAngle(tail4, -0.2182F, 0.0F, 0.0F);
        this.tail4.cubeList.add(new ModelBox(tail4, 0, 44, -0.5F, -0.75F, 0.0F, 1, 1, 8, -0.01F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, -0.75F, -3.0F);
        this.hips.addChild(body);
        this.setRotateAngle(body, 0.1571F, 0.0F, 0.0F);
        this.body.cubeList.add(new ModelBox(body, 0, 0, -3.5F, -1.95F, -7.0F, 7, 8, 7, 0.0F, false));

        this.chest = new AdvancedModelRenderer(this);
        this.chest.setRotationPoint(0.0F, 0.0F, -6.5F);
        this.body.addChild(chest);
        this.setRotateAngle(chest, 0.0873F, 0.0F, 0.0F);
        this.chest.cubeList.add(new ModelBox(chest, 29, 0, -2.5F, -1.75F, -4.75F, 5, 7, 6, 0.0F, false));

        this.leftArm1 = new AdvancedModelRenderer(this);
        this.leftArm1.setRotationPoint(2.5F, 2.75F, -3.25F);
        this.chest.addChild(leftArm1);
        this.setRotateAngle(leftArm1, 0.6067F, 0.5062F, 0.0036F);
        this.leftArm1.cubeList.add(new ModelBox(leftArm1, 59, 53, -0.25F, -1.0F, -1.0F, 1, 4, 2, 0.0F, false));
        this.leftArm1.cubeList.add(new ModelBox(leftArm1, 41, 60, -0.75F, -1.0F, -1.0F, 1, 4, 2, -0.01F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(0.0F, 1.0F, 1.0F);
        this.leftArm1.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.3491F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 43, 32, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(0.0F, -1.0F, 0.75F);
        this.leftArm1.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.3491F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 43, 30, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, false));

        this.leftArm2 = new AdvancedModelRenderer(this);
        this.leftArm2.setRotationPoint(0.5F, 2.5F, 0.0F);
        this.leftArm1.addChild(leftArm2);
        this.setRotateAngle(leftArm2, -0.7854F, 0.0F, 0.0F);
        this.leftArm2.cubeList.add(new ModelBox(leftArm2, 21, 37, -1.0F, -0.5F, -0.25F, 1, 3, 1, 0.0F, false));
        this.leftArm2.cubeList.add(new ModelBox(leftArm2, 62, 45, -1.0F, -0.5F, -0.75F, 1, 3, 1, -0.01F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.5F, 1.5F, 0.75F);
        this.leftArm2.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.3491F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 43, 36, 0.0F, 0.0F, -0.25F, 0, 1, 1, 0.0F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-0.5F, -0.5F, 0.75F);
        this.leftArm2.addChild(cube_r4);
        this.setRotateAngle(cube_r4, -0.3491F, 0.0F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 43, 34, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, false));

        this.leftArm3 = new AdvancedModelRenderer(this);
        this.leftArm3.setRotationPoint(0.0F, 2.5F, 0.0F);
        this.leftArm2.addChild(leftArm3);
        this.setRotateAngle(leftArm3, 0.0F, 0.0F, 0.1745F);
        this.leftArm3.cubeList.add(new ModelBox(leftArm3, 59, 60, -1.0F, 0.0F, -1.0F, 1, 3, 2, 0.01F, false));

        this.rightArm1 = new AdvancedModelRenderer(this);
        this.rightArm1.setRotationPoint(-2.5F, 2.75F, -3.25F);
        this.chest.addChild(rightArm1);
        this.setRotateAngle(rightArm1, 0.6067F, -0.5062F, -0.0036F);
        this.rightArm1.cubeList.add(new ModelBox(rightArm1, 59, 53, -0.75F, -1.0F, -1.0F, 1, 4, 2, 0.0F, true));
        this.rightArm1.cubeList.add(new ModelBox(rightArm1, 41, 60, -0.25F, -1.0F, -1.0F, 1, 4, 2, -0.01F, true));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 43, 32, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(0.0F, -1.0F, 0.75F);
        this.rightArm1.addChild(cube_r6);
        this.setRotateAngle(cube_r6, -0.3491F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 43, 30, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, true));

        this.rightArm2 = new AdvancedModelRenderer(this);
        this.rightArm2.setRotationPoint(-0.5F, 2.5F, 0.0F);
        this.rightArm1.addChild(rightArm2);
        this.setRotateAngle(rightArm2, -0.7854F, 0.0F, 0.0F);
        this.rightArm2.cubeList.add(new ModelBox(rightArm2, 21, 37, 0.0F, -0.5F, -0.25F, 1, 3, 1, 0.0F, true));
        this.rightArm2.cubeList.add(new ModelBox(rightArm2, 62, 45, 0.0F, -0.5F, -0.75F, 1, 3, 1, -0.01F, true));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(0.5F, 1.5F, 0.75F);
        this.rightArm2.addChild(cube_r7);
        this.setRotateAngle(cube_r7, -0.3491F, 0.0F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 43, 36, 0.0F, 0.0F, -0.25F, 0, 1, 1, 0.0F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.5F, -0.5F, 0.75F);
        this.rightArm2.addChild(cube_r8);
        this.setRotateAngle(cube_r8, -0.3491F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 43, 34, 0.0F, 0.0F, 0.0F, 0, 1, 1, 0.0F, true));

        this.rightArm3 = new AdvancedModelRenderer(this);
        this.rightArm3.setRotationPoint(0.0F, 2.5F, 0.0F);
        this.rightArm2.addChild(rightArm3);
        this.setRotateAngle(rightArm3, 0.0F, 0.0F, -0.1745F);
        this.rightArm3.cubeList.add(new ModelBox(rightArm3, 59, 60, 0.0F, 0.0F, -1.0F, 1, 3, 2, 0.01F, true));

        this.neck1 = new AdvancedModelRenderer(this);
        this.neck1.setRotationPoint(0.0F, 0.0F, -3.5F);
        this.chest.addChild(neck1);
        this.setRotateAngle(neck1, -0.5236F, 0.0F, 0.0F);
        this.neck1.cubeList.add(new ModelBox(neck1, 34, 44, -1.5F, -1.75F, -3.0F, 3, 4, 4, 0.0F, false));
        this.neck1.cubeList.add(new ModelBox(neck1, 50, 31, -1.5F, 1.75F, -3.0F, 3, 1, 4, -0.01F, false));

        this.neck2 = new AdvancedModelRenderer(this);
        this.neck2.setRotationPoint(0.0F, 0.25F, -2.5F);
        this.neck1.addChild(neck2);
        this.setRotateAngle(neck2, -0.1745F, 0.0F, 0.0F);
        this.neck2.cubeList.add(new ModelBox(neck2, 49, 44, -1.0F, -2.0F, -3.5F, 2, 4, 4, -0.01F, false));

        this.neck3 = new AdvancedModelRenderer(this);
        this.neck3.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.neck2.addChild(neck3);
        this.setRotateAngle(neck3, 0.48F, 0.0F, 0.0F);
        this.neck3.cubeList.add(new ModelBox(neck3, 41, 53, -1.0F, -2.0F, -1.5F, 2, 4, 2, -0.02F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(-0.5F, -2.0F, -1.5F);
        this.neck3.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.5672F, 0.0F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 21, 32, 0.0F, 0.0F, -1.0F, 1, 3, 1, 0.0F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 0.0F, -1.5F);
        this.neck3.addChild(head);
        this.setRotateAngle(head, 0.2182F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 50, 53, -1.0F, -1.75F, -1.5F, 2, 3, 2, 0.01F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-0.5F, -1.1563F, -3.1452F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.288F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 62, 41, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(-0.5F, -0.202F, -4.9028F);
        this.head.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.4974F, 0.0F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 23, 62, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.01F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(-0.5F, 1.1747F, -6.3535F);
        this.head.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.7592F, 0.0F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 16, 62, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(-0.75F, -0.1408F, -4.8265F);
        this.head.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.5042F, -0.0015F, -0.246F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 52, 11, 0.0F, 0.0F, 0.0F, 1, 2, 4, -0.15F, true));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(0.5F, 1.25F, -1.5F);
        this.head.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.192F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 50, 37, -1.25F, -2.0F, -3.0F, 1, 2, 4, 0.0F, true));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 31, 60, -1.2F, -0.75F, -2.25F, 0, 1, 1, 0.0F, true));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 31, 57, -0.95F, -0.75F, -4.0F, 0, 1, 1, 0.0F, true));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 31, 60, 0.2F, -0.75F, -2.25F, 0, 1, 1, 0.0F, false));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 31, 57, -0.05F, -0.75F, -4.0F, 0, 1, 1, 0.0F, false));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 61, 37, -1.0F, -1.0F, -4.75F, 1, 1, 2, 0.01F, false));
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 50, 37, -0.75F, -2.0F, -3.0F, 1, 2, 4, 0.0F, false));

        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(0.75F, -0.1408F, -4.8265F);
        this.head.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.5042F, 0.0015F, 0.246F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 52, 11, -1.0F, 0.0F, 0.0F, 1, 2, 4, -0.15F, false));

        this.eyes = new AdvancedModelRenderer(this);
        this.eyes.setRotationPoint(-0.5F, 1.25F, -3.5F);
        this.head.addChild(eyes);
        this.eyes.cubeList.add(new ModelBox(eyes, 11, 54, -0.5F, -2.25F, 2.0F, 2, 1, 1, 0.02F, false));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(-0.5F, 0.9F, 0.5F);
        this.head.addChild(jaw);
        this.setRotateAngle(jaw, 0.1745F, 0.0F, 0.0F);
        this.jaw.cubeList.add(new ModelBox(jaw, 22, 57, -0.5F, -0.15F, -2.0F, 2, 2, 2, 0.0F, false));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(0.25F, -0.15F, -3.0F);
        this.jaw.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 1.0908F, 0.0F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 61, 0, -0.5F, 0.0F, 0.0F, 1, 2, 2, -0.02F, true));
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 61, 0, 0.0F, 0.0F, 0.0F, 1, 2, 2, -0.02F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(1.0F, 0.7204F, -4.9908F);
        this.jaw.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.0873F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 63, -0.95F, -1.25F, -1.75F, 0, 1, 1, 0.0F, true));
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 62, 50, -1.2F, -1.25F, 0.0F, 0, 1, 1, 0.0F, true));
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 63, -0.05F, -1.25F, -1.75F, 0, 1, 1, 0.0F, false));
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 62, 50, 0.2F, -1.25F, 0.0F, 0, 1, 1, 0.0F, false));
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 58, -1.0F, -1.0F, -1.85F, 1, 1, 3, 0.0F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(1.0F, -0.15F, -2.0F);
        this.jaw.addChild(cube_r18);
        this.setRotateAngle(cube_r18, -0.0436F, 0.0F, 0.0F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 52, 25, -1.25F, 0.0F, -3.0F, 1, 1, 4, -0.01F, true));
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 52, 25, -0.75F, 0.0F, -3.0F, 1, 1, 4, -0.01F, false));

        this.cube_r19 = new AdvancedModelRenderer(this);
        this.cube_r19.setRotationPoint(1.0F, 0.7182F, -4.7908F);
        this.jaw.addChild(cube_r19);
        this.setRotateAngle(cube_r19, -0.3491F, 0.0F, 0.0F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 50, 59, -1.25F, -1.0F, 0.0F, 1, 1, 3, -0.02F, true));
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 50, 59, -0.75F, -1.0F, 0.0F, 1, 1, 3, -0.02F, false));

        this.throat = new AdvancedModelRenderer(this);
        this.throat.setRotationPoint(0.0F, 3.0545F, -1.7653F);
        this.neck3.addChild(throat);
        this.setRotateAngle(throat, -0.0131F, 0.0F, 0.0F);


        this.cube_r20 = new AdvancedModelRenderer(this);
        this.cube_r20.setRotationPoint(0.0F, -0.4295F, -1.2347F);
        this.throat.addChild(cube_r20);
        this.setRotateAngle(cube_r20, 0.1309F, 0.0F, 0.0F);
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 52, 18, -0.5F, -1.3F, 1.05F, 1, 2, 4, 0.0F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraLajasvenator EntityMegalosaurus = (EntityPrehistoricFloraLajasvenator) e;
//        this.hips.offsetZ = -0.5F;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraLajasvenator ee = (EntityPrehistoricFloraLajasvenator) entitylivingbaseIn;
    ...
    public void animAttack(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraLajasvenator entity = (EntityPrehistoricFloraLajasvenator) entitylivingbaseIn;
        int animCycle = 15;
        ...
        if (tickAnim >= 0 && tickAnim < 4) {
            ...
            xx = -17.25 + (((tickAnim - 4) / 6) * (12.75-(-17.25)));
            yy = 0 + (((tickAnim - 4) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 4) / 6) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 15) {
            xx = 12.75 + (((tickAnim - 10) / 5) * (0-(12.75)));
            yy = 0 + (((tickAnim - 10) / 5) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 5) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 4) {
            ...
            xx = 0 + (((tickAnim - 4) / 6) * (0-(0)));
            yy = 0 + (((tickAnim - 4) / 6) * (-0.425-(0)));
            zz = 0 + (((tickAnim - 4) / 6) * (0.875-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 15) {
            xx = 0 + (((tickAnim - 10) / 5) * (0-(0)));
            yy = -0.425 + (((tickAnim - 10) / 5) * (0-(-0.425)));
            zz = 0.875 + (((tickAnim - 10) / 5) * (0-(0.875)));
        }
        else {
            xx = 0;
            yy = 0;
    ...
    public void animNest(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 9) {
            ...
            yy = 0 + (((tickAnim - 30) / 8) * (-0.525-(0)));
            zz = 0 + (((tickAnim - 30) / 8) * (0-(0)));
        }
        else if (tickAnim >= 38 && tickAnim < 50) {
            xx = 0 + (((tickAnim - 38) / 12) * (0-(0)));
            yy = -0.525 + (((tickAnim - 38) / 12) * (0-(-0.525)));
            zz = 0 + (((tickAnim - 38) / 12) * (0-(0)));
        }
        else {
            xx = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 9) {
            ...
            xx = 72 + (((tickAnim - 23) / 7) * (37.25-(72)));
            yy = 0 + (((tickAnim - 23) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 23) / 7) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 38) {
            xx = 37.25 + (((tickAnim - 30) / 8) * (5.47201-(37.25)));
            yy = 0 + (((tickAnim - 30) / 8) * (0.53563-(0)));
            zz = 0 + (((tickAnim - 30) / 8) * (0.10827-(0)));
        }
        else if (tickAnim >= 38 && tickAnim < 50) {
            xx = 5.47201 + (((tickAnim - 38) / 12) * (0-(5.47201)));
        ...
        if (tickAnim >= 0 && tickAnim < 9) {
            ...
            xx = 0 + (((tickAnim - 9) / 14) * (0-(0)));
            yy = -0.4 + (((tickAnim - 9) / 14) * (0-(-0.4)));
            zz = -0.475 + (((tickAnim - 9) / 14) * (0-(-0.475)));
        }
        else if (tickAnim >= 23 && tickAnim < 38) {
    ...
    public void animLay(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            ...
            zz = 0 + (((tickAnim - 0) / 18) * (1.975-(0)));
        }
        else if (tickAnim >= 18 && tickAnim < 28) {
            xx = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            yy = -5.9 + (((tickAnim - 18) / 10) * (-5.9-(-5.9)));
            zz = 1.975 + (((tickAnim - 18) / 10) * (1.975-(1.975)));
        }
        else if (tickAnim >= 28 && tickAnim < 50) {
            xx = 0 + (((tickAnim - 28) / 22) * (0-(0)));
            yy = -5.9 + (((tickAnim - 28) / 22) * (0-(-5.9)));
            zz = 1.975 + (((tickAnim - 28) / 22) * (0-(1.975)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 0) / 18) * (-84-(0)));
            yy = 0 + (((tickAnim - 0) / 18) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 18) * (0-(0)));
        }
        else if (tickAnim >= 18 && tickAnim < 28) {
            xx = -84 + (((tickAnim - 18) / 10) * (-84-(-84)));
            yy = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 10) * (0-(0)));
        }
        else if (tickAnim >= 28 && tickAnim < 50) {
            xx = -84 + (((tickAnim - 28) / 22) * (0-(-84)));
            yy = 0 + (((tickAnim - 28) / 22) * (0-(0)));
            zz = 0 + (((tickAnim - 28) / 22) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 0) / 18) * (62.5-(0)));
            yy = 0 + (((tickAnim - 0) / 18) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 18) * (0-(0)));
        }
        else if (tickAnim >= 18 && tickAnim < 28) {
            xx = 62.5 + (((tickAnim - 18) / 10) * (62.5-(62.5)));
            yy = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 10) * (0-(0)));
        }
        else if (tickAnim >= 28 && tickAnim < 50) {
            xx = 62.5 + (((tickAnim - 28) / 22) * (0-(62.5)));
            yy = 0 + (((tickAnim - 28) / 22) * (0-(0)));
            zz = 0 + (((tickAnim - 28) / 22) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 9) {
            ...
            zz = 0 + (((tickAnim - 0) / 9) * (-0.095-(0)));
        }
        else if (tickAnim >= 9 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 9) / 9) * (0-(0)));
            yy = 0.275 + (((tickAnim - 9) / 9) * (0-(0.275)));
            zz = -0.095 + (((tickAnim - 9) / 9) * (0.35-(-0.095)));
        }
        else if (tickAnim >= 18 && tickAnim < 28) {
            xx = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            yy = 0 + (((tickAnim - 18) / 10) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 0) / 18) * (0-(0)));
            yy = 0 + (((tickAnim - 0) / 18) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 18) * (35.25-(0)));
        }
        else if (tickAnim >= 18 && tickAnim < 28) {
            xx = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            yy = 0 + (((tickAnim - 18) / 10) * (0-(0)));
            zz = 35.25 + (((tickAnim - 18) / 10) * (35.25-(35.25)));
        }
        else if (tickAnim >= 28 && tickAnim < 50) {
            xx = 0 + (((tickAnim - 28) / 22) * (0-(0)));
            yy = 0 + (((tickAnim - 28) / 22) * (0-(0)));
            zz = 35.25 + (((tickAnim - 28) / 22) * (0-(35.25)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 18 && tickAnim < 23) {
            ...
            yy = 0 + (((tickAnim - 18) / 5) * (1.25-(0)));
            zz = 0 + (((tickAnim - 18) / 5) * (0-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 28) {
            xx = 0 + (((tickAnim - 23) / 5) * (0-(0)));
            yy = 1.25 + (((tickAnim - 23) / 5) * (0-(1.25)));
    ...
    public void animNoise(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            xx = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*350/0.5)) + (((tickAnim - 0) / 30) * (15.9+Math.sin((Math.PI/180)*(((double)tickAnim/20)*350/0.5))*4-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*350/0.5)))));
            yy = 0 + (((tickAnim - 0) / 30) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 30) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 45) {
            xx = 15.9+Math.sin((Math.PI/180)*(((double)tickAnim/20)*350/0.5))*4 + (((tickAnim - 30) / 15) * (0-(15.9+Math.sin((Math.PI/180)*(((double)tickAnim/20)*350/0.5))*4)));
            yy = 0 + (((tickAnim - 30) / 15) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 15) * (0-(0)));
        }
        else {
    ...
    public void animRelax(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 140) {
            ...
            yy = 0 + (((tickAnim - 140) / 20) * (1.25-(0)));
            zz = 0 + (((tickAnim - 140) / 20) * (0-(0)));
        }
        else if (tickAnim >= 160 && tickAnim < 180) {
            xx = 0 + (((tickAnim - 160) / 20) * (0-(0)));
            yy = 1.25 + (((tickAnim - 160) / 20) * (0-(1.25)));
            zz = 0 + (((tickAnim - 160) / 20) * (0-(0)));
        }
        else if (tickAnim >= 180 && tickAnim < 260) {
            xx = 0 + (((tickAnim - 180) / 80) * (0-(0)));
            yy = 0 + (((tickAnim - 180) / 80) * (0-(0)));
            zz = 0 + (((tickAnim - 180) / 80) * (0-(0)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 140) {
            xx = 1 + (((tickAnim - 0) / 140) * (1-(1)));
            yy = 1 + (((tickAnim - 0) / 140) * (1-(1)));
            zz = 1 + (((tickAnim - 0) / 140) * (1-(1)));
        }
        else if (tickAnim >= 140 && tickAnim < 160) {
            ...
            xx = 1 + (((tickAnim - 180) / 80) * (1-(1)));
            yy = 1 + (((tickAnim - 180) / 80) * (1-(1)));
            zz = 1 + (((tickAnim - 180) / 80) * (1-(1)));
        }
        else {
            xx = 1;
            yy = 1;
        ...
        if (tickAnim >= 0 && tickAnim < 40) {
            xx = 0 + (((tickAnim - 0) / 40) * (8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2-(0)));
            yy = 0 + (((tickAnim - 0) / 40) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 40) * (0-(0)));
        }
        else if (tickAnim >= 40 && tickAnim < 230) {
            xx = 8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2 + (((tickAnim - 40) / 190) * (8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2-(8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2)));
            yy = 0 + (((tickAnim - 40) / 190) * (0-(0)));
            zz = 0 + (((tickAnim - 40) / 190) * (0-(0)));
        }
        else if (tickAnim >= 230 && tickAnim < 260) {
            xx = 8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2 + (((tickAnim - 230) / 30) * (0-(8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*150/0.3))*2)));
            yy = 0 + (((tickAnim - 230) / 30) * (0-(0)));
            zz = 0 + (((tickAnim - 230) / 30) * (0-(0)));
        }
        else {
    ...
    public void animYawn(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 23) {
            ...
            xx = 0 + (((tickAnim - 23) / 28) * (0-(0)));
            yy = 1.25 + (((tickAnim - 23) / 28) * (1.25-(1.25)));
            zz = 0 + (((tickAnim - 23) / 28) * (0-(0)));
        }
        else if (tickAnim >= 51 && tickAnim < 65) {
            xx = 0 + (((tickAnim - 51) / 14) * (0-(0)));
            yy = 1.25 + (((tickAnim - 51) / 14) * (0-(1.25)));
            zz = 0 + (((tickAnim - 51) / 14) * (0-(0)));
        }
        else {
            xx = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 23) {
            ...
            yy = 1 + (((tickAnim - 0) / 23) * (0.075-(1)));
            zz = 1 + (((tickAnim - 0) / 23) * (1-(1)));
        }
        else if (tickAnim >= 23 && tickAnim < 51) {
            xx = 1 + (((tickAnim - 23) / 28) * (1-(1)));
            yy = 0.075 + (((tickAnim - 23) / 28) * (0.075-(0.075)));
            zz = 1 + (((tickAnim - 23) / 28) * (1-(1)));
        }
        else if (tickAnim >= 51 && tickAnim < 65) {
            xx = 1 + (((tickAnim - 51) / 14) * (1-(1)));
            yy = 0.075 + (((tickAnim - 51) / 14) * (1-(0.075)));
    ...
    public void animRunning(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 7) {
            xx = -28.63834 + (((tickAnim - 0) / 7) * (30.5-(-28.63834)));
            yy = -10.15834 + (((tickAnim - 0) / 7) * (0-(-10.15834)));
            zz = -1.11182 + (((tickAnim - 0) / 7) * (0-(-1.11182)));
        }
            ...
            xx = 120.2518+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-250 + (((tickAnim - 10) / 3) * (-28.63834-(120.2518+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-250)));
            yy = -3.21282 + (((tickAnim - 10) / 3) * (-10.15834-(-3.21282)));
            zz = 1.95681 + (((tickAnim - 10) / 3) * (-1.11182-(1.95681)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 7) {
            xx = 10.62556 + (((tickAnim - 0) / 7) * (33.25-(10.62556)));
            yy = 5.40142 + (((tickAnim - 0) / 7) * (0-(5.40142)));
            zz = 7.95691 + (((tickAnim - 0) / 7) * (0-(7.95691)));
        }
            ...
            xx = 153.5176+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-290 + (((tickAnim - 9) / 4) * (10.62556-(153.5176+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-290)));
            yy = 0.087 + (((tickAnim - 9) / 4) * (5.40142-(0.087)));
            zz = -0.02507 + (((tickAnim - 9) / 4) * (7.95691-(-0.02507)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 7) {
            ...
            yy = 0.325 + (((tickAnim - 9) / 4) * (0.275-(0.325)));
            zz = -0.175 + (((tickAnim - 9) / 4) * (0.225-(-0.175)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            xx = 4.56761 + (((tickAnim - 0) / 3) * (-18.89112-(4.56761)));
            yy = 1.91335 + (((tickAnim - 0) / 3) * (4.42545-(1.91335)));
            zz = -1.0589 + (((tickAnim - 0) / 3) * (-5.67439-(-1.0589)));
        }
            ...
            xx = 73.05031 + (((tickAnim - 12) / 1) * (4.56761-(73.05031)));
            yy = 3.53898 + (((tickAnim - 12) / 1) * (1.91335-(3.53898)));
            zz = -1.12935 + (((tickAnim - 12) / 1) * (-1.0589-(-1.12935)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 1) {
            ...
            yy = 0 + (((tickAnim - 0) / 1) * (0.7-(0)));
            zz = 0 + (((tickAnim - 0) / 1) * (0-(0)));
        }
        else if (tickAnim >= 1 && tickAnim < 3) {
            xx = 0 + (((tickAnim - 1) / 2) * (0-(0)));
            yy = 0.7 + (((tickAnim - 1) / 2) * (-0.6-(0.7)));
            zz = 0 + (((tickAnim - 1) / 2) * (0-(0)));
        }
        else if (tickAnim >= 3 && tickAnim < 9) {
            xx = 0 + (((tickAnim - 3) / 6) * (0-(0)));
            yy = -0.6 + (((tickAnim - 3) / 6) * (0-(-0.6)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 0 + (((tickAnim - 3) / 4) * (11.79007-(0)));
            yy = 0 + (((tickAnim - 3) / 4) * (-2.01904-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0.78095-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 9) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 0 + (((tickAnim - 7) / 2) * (0-(0)));
            yy = 0.05 + (((tickAnim - 7) / 2) * (0-(0.05)));
            zz = 0.15 + (((tickAnim - 7) / 2) * (0-(0.15)));
        }
        else if (tickAnim >= 9 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 9) / 4) * (0-(0)));
            yy = 0 + (((tickAnim - 9) / 4) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 40.4768+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-200 + (((tickAnim - 3) / 4) * (-28.63834-(40.4768+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-200)));
            yy = 3.21282 + (((tickAnim - 3) / 4) * (10.15834-(3.21282)));
            zz = -1.95681 + (((tickAnim - 3) / 4) * (1.11182-(-1.95681)));
        }
        else if (tickAnim >= 7 && tickAnim < 13) {
            xx = -28.63834 + (((tickAnim - 7) / 6) * (30.5-(-28.63834)));
            yy = 10.15834 + (((tickAnim - 7) / 6) * (0-(10.15834)));
            zz = 1.11182 + (((tickAnim - 7) / 6) * (0-(1.11182)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -20.5324+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50-20))*-230 + (((tickAnim - 3) / 4) * (10.62556-(-20.5324+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50-20))*-230)));
            yy = -0.087 + (((tickAnim - 3) / 4) * (-5.40142-(-0.087)));
            zz = 0.02507 + (((tickAnim - 3) / 4) * (-7.95691-(0.02507)));
        }
        else if (tickAnim >= 7 && tickAnim < 13) {
            xx = 10.62556 + (((tickAnim - 7) / 6) * (33.25-(10.62556)));
            yy = -5.40142 + (((tickAnim - 7) / 6) * (0-(-5.40142)));
            zz = -7.95691 + (((tickAnim - 7) / 6) * (0-(-7.95691)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            yy = 0 + (((tickAnim - 5) / 2) * (-0.4-(0)));
            zz = 0 + (((tickAnim - 5) / 2) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 9) {
            xx = 0 + (((tickAnim - 7) / 2) * (0-(0)));
            yy = -0.4 + (((tickAnim - 7) / 2) * (-0.375-(-0.4)));
            zz = 0 + (((tickAnim - 7) / 2) * (-0.075-(0)));
        }
        else if (tickAnim >= 9 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 9) / 4) * (0-(0)));
            yy = -0.375 + (((tickAnim - 9) / 4) * (0-(-0.375)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            xx = 56 + (((tickAnim - 0) / 3) * (73.05031-(56)));
            ...
            xx = 73.05031 + (((tickAnim - 5) / 2) * (4.60511-(73.05031)));
            yy = -3.53898 + (((tickAnim - 5) / 2) * (0.98375-(-3.53898)));
            zz = 1.12935 + (((tickAnim - 5) / 2) * (0.4243-(1.12935)));
        }
        else if (tickAnim >= 7 && tickAnim < 8) {
            xx = 4.60511 + (((tickAnim - 7) / 1) * (-11.3508-(4.60511)));
            yy = 0.98375 + (((tickAnim - 7) / 1) * (-0.859-(0.98375)));
            zz = 0.4243 + (((tickAnim - 7) / 1) * (3.8922-(0.4243)));
        }
        else if (tickAnim >= 8 && tickAnim < 10) {
            xx = -11.3508 + (((tickAnim - 8) / 2) * (26.06251-(-11.3508)));
            yy = -0.859 + (((tickAnim - 8) / 2) * (-2.63083-(-0.859)));
            zz = 3.8922 + (((tickAnim - 8) / 2) * (2.80265-(3.8922)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 26.06251 + (((tickAnim - 10) / 3) * (56-(26.06251)));
            yy = -2.63083 + (((tickAnim - 10) / 3) * (0-(-2.63083)));
            zz = 2.80265 + (((tickAnim - 10) / 3) * (0-(2.80265)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 7) {
            ...
            yy = 0 + (((tickAnim - 7) / 1) * (0.78-(0)));
            zz = 0 + (((tickAnim - 7) / 1) * (0.04-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 8) {
            xx = 0 + (((tickAnim - 8) / 0) * (0-(0)));
            yy = 0.78 + (((tickAnim - 8) / 0) * (0.455-(0.78)));
            zz = 0.04 + (((tickAnim - 8) / 0) * (0.07-(0.04)));
        }
        else if (tickAnim >= 8 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 8) / 5) * (0-(0)));
            yy = 0.455 + (((tickAnim - 8) / 5) * (0-(0.455)));
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 16) {
            xx = -20.33207 + (((tickAnim - 0) / 16) * (24.25-(-20.33207)));
            yy = -4.55664 + (((tickAnim - 0) / 16) * (0-(-4.55664)));
            zz = 1.41154 + (((tickAnim - 0) / 16) * (0-(1.41154)));
        }
            ...
            xx = 107.5635+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-140 + (((tickAnim - 24) / 6) * (-20.33207-(107.5635+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-140)));
            yy = -1.6381 + (((tickAnim - 24) / 6) * (-4.55664-(-1.6381)));
            zz = 2.14615 + (((tickAnim - 24) / 6) * (1.41154-(2.14615)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            yy = -0.425 + (((tickAnim - 0) / 8) * (-0.375-(-0.425)));
            zz = 0 + (((tickAnim - 0) / 8) * (-0.225-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 16) {
            xx = 0 + (((tickAnim - 8) / 8) * (0-(0)));
            yy = -0.375 + (((tickAnim - 8) / 8) * (0-(-0.375)));
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            xx = 3.68887 + (((tickAnim - 0) / 5) * (-4.9091-(3.68887)));
            yy = 4.46014 + (((tickAnim - 0) / 5) * (3.5253-(4.46014)));
            zz = -2.72542 + (((tickAnim - 0) / 5) * (-2.3556-(-2.72542)));
        }
        else if (tickAnim >= 5 && tickAnim < 8) {
            xx = -4.9091 + (((tickAnim - 5) / 3) * (-18.55792-(-4.9091)));
            yy = 3.5253 + (((tickAnim - 5) / 3) * (2.90214-(3.5253)));
            zz = -2.3556 + (((tickAnim - 5) / 3) * (-2.10897-(-2.3556)));
        }
        else if (tickAnim >= 8 && tickAnim < 13) {
            xx = -18.55792 + (((tickAnim - 8) / 5) * (20.25-(-18.55792)));
            yy = 2.90214 + (((tickAnim - 8) / 5) * (0-(2.90214)));
            zz = -2.10897 + (((tickAnim - 8) / 5) * (0-(-2.10897)));
        }
        else if (tickAnim >= 13 && tickAnim < 20) {
            xx = 20.25 + (((tickAnim - 13) / 7) * (71.62202-(20.25)));
            yy = 0 + (((tickAnim - 13) / 7) * (0.36483-(0)));
            zz = 0 + (((tickAnim - 13) / 7) * (-2.07405-(0)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            yy = 0.025 + (((tickAnim - 5) / 3) * (-0.225-(0.025)));
            zz = 0 + (((tickAnim - 5) / 3) * (0-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 8) / 5) * (0-(0)));
            yy = -0.225 + (((tickAnim - 8) / 5) * (0.675-(-0.225)));
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            xx = 0 + (((tickAnim - 8) / 5) * (-21.75-(0)));
            yy = 0 + (((tickAnim - 8) / 5) * (0-(0)));
            zz = 0 + (((tickAnim - 8) / 5) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 20) {
            xx = -21.75 + (((tickAnim - 13) / 7) * (33-(-21.75)));
            yy = 0 + (((tickAnim - 13) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 7) * (0-(0)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            xx = 0 + (((tickAnim - 8) / 5) * (0-(0)));
            yy = 0 + (((tickAnim - 8) / 5) * (-0.075-(0)));
            zz = 0 + (((tickAnim - 8) / 5) * (0.2-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 24) {
            xx = 0 + (((tickAnim - 13) / 11) * (0-(0)));
            yy = -0.075 + (((tickAnim - 13) / 11) * (0.075-(-0.075)));
            zz = 0.2 + (((tickAnim - 13) / 11) * (0.275-(0.2)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            xx = 23.9635+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-80 + (((tickAnim - 8) / 6) * (-20.33207-(23.9635+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*-80)));
            yy = 2.0119 + (((tickAnim - 8) / 6) * (4.55664-(2.0119)));
            zz = 2.15385 + (((tickAnim - 8) / 6) * (1.41154-(2.15385)));
        }
        else if (tickAnim >= 14 && tickAnim < 30) {
            xx = -20.33207 + (((tickAnim - 14) / 16) * (24.25-(-20.33207)));
            yy = 4.55664 + (((tickAnim - 14) / 16) * (0-(4.55664)));
            zz = 1.41154 + (((tickAnim - 14) / 16) * (0-(1.41154)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            xx = 0 + (((tickAnim - 0) / 8) * (-104.38+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*200-(0)));
            yy = 0 + (((tickAnim - 0) / 8) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 8) * (0-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 14) {
            xx = -104.38+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*200 + (((tickAnim - 8) / 6) * (6.75-(-104.38+Math.sin((Math.PI/180)*(((double)tickAnim/20)*50))*200)));
            yy = 0 + (((tickAnim - 8) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 8) / 6) * (0-(0)));
        }
        else if (tickAnim >= 14 && tickAnim < 30) {
            xx = 6.75 + (((tickAnim - 14) / 16) * (0-(6.75)));
            yy = 0 + (((tickAnim - 14) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 14) / 16) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            yy = 0 + (((tickAnim - 8) / 6) * (-0.425-(0)));
            zz = 0 + (((tickAnim - 8) / 6) * (0-(0)));
        }
        else if (tickAnim >= 14 && tickAnim < 23) {
            xx = 0 + (((tickAnim - 14) / 9) * (0-(0)));
            yy = -0.425 + (((tickAnim - 14) / 9) * (-0.375-(-0.425)));
            zz = 0 + (((tickAnim - 14) / 9) * (-0.225-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 23) / 7) * (0-(0)));
            yy = -0.375 + (((tickAnim - 23) / 7) * (0-(-0.375)));
            zz = -0.225 + (((tickAnim - 23) / 7) * (0-(-0.225)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 4) {
            xx = 40.5 + (((tickAnim - 0) / 4) * (71.66298-(40.5)));
            yy = 0 + (((tickAnim - 0) / 4) * (0.45096-(0)));
            zz = 0 + (((tickAnim - 0) / 4) * (3.67546-(0)));
        }
        else if (tickAnim >= 4 && tickAnim < 8) {
            xx = 71.66298 + (((tickAnim - 4) / 4) * (49.69009-(71.66298)));
            yy = 0.45096 + (((tickAnim - 4) / 4) * (0.82448-(0.45096)));
            zz = 3.67546 + (((tickAnim - 4) / 4) * (-1.64978-(3.67546)));
        }
        else if (tickAnim >= 8 && tickAnim < 11) {
            xx = 49.69009 + (((tickAnim - 8) / 3) * (12.6537-(49.69009)));
            yy = 0.82448 + (((tickAnim - 8) / 3) * (-2.1953-(0.82448)));
            zz = -1.64978 + (((tickAnim - 8) / 3) * (0.8503-(-1.64978)));
        }
        else if (tickAnim >= 11 && tickAnim < 14) {
            xx = 12.6537 + (((tickAnim - 11) / 3) * (8.06307-(12.6537)));
            yy = -2.1953 + (((tickAnim - 11) / 3) * (-3.44474-(-2.1953)));
            zz = 0.8503 + (((tickAnim - 11) / 3) * (-2.99608-(0.8503)));
        }
        else if (tickAnim >= 14 && tickAnim < 19) {
            xx = 8.06307 + (((tickAnim - 14) / 5) * (-4.9743-(8.06307)));
            yy = -3.44474 + (((tickAnim - 14) / 5) * (-1.0704-(-3.44474)));
            zz = -2.99608 + (((tickAnim - 14) / 5) * (-2.3705-(-2.99608)));
        }
        else if (tickAnim >= 19 && tickAnim < 23) {
            xx = -4.9743 + (((tickAnim - 19) / 4) * (-13.30792-(-4.9743)));
            yy = -1.0704 + (((tickAnim - 19) / 4) * (2.90214-(-1.0704)));
            zz = -2.3705 + (((tickAnim - 19) / 4) * (-2.10897-(-2.3705)));
        }
        else if (tickAnim >= 23 && tickAnim < 30) {
            xx = -13.30792 + (((tickAnim - 23) / 7) * (40.5-(-13.30792)));
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            yy = 0.425 + (((tickAnim - 14) / 5) * (0.025-(0.425)));
            zz = 0 + (((tickAnim - 14) / 5) * (0-(0)));
        }
        else if (tickAnim >= 19 && tickAnim < 23) {
            xx = 0 + (((tickAnim - 19) / 4) * (0-(0)));
            yy = 0.025 + (((tickAnim - 19) / 4) * (-0.225-(0.025)));
            zz = 0 + (((tickAnim - 19) / 4) * (0-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 23) / 7) * (0-(0)));
            yy = -0.225 + (((tickAnim - 23) / 7) * (0-(-0.225)));
            zz = 0 + (((tickAnim - 23) / 7) * (0-(0)));
        }
        else {
            xx = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 4) {
            ...
            xx = 33 + (((tickAnim - 4) / 7) * (-3.5-(33)));
            yy = 0 + (((tickAnim - 4) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 4) / 7) * (0-(0)));
        }
        else if (tickAnim >= 11 && tickAnim < 13) {
            xx = -3.5 + (((tickAnim - 11) / 2) * (0-(-3.5)));
            yy = 0 + (((tickAnim - 11) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 11) / 2) * (0-(0)));
        }
        ...
        this.setRotateAngle(leftArm1, leftArm1.rotateAngleX + (float) Math.toRadians(-3.4491+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*240/0.5-220))*-2), leftArm1.rotateAngleY + (float) Math.toRadians(5.1765), leftArm1.rotateAngleZ + (float) Math.toRadians(-8.9546+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*240-90))*-1.5));
        ...
        this.setRotateAngle(rightArm1, rightArm1.rotateAngleX + (float) Math.toRadians(-3.4491+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*240/0.5-220))*-2), rightArm1.rotateAngleY + (float) Math.toRadians(-5.1765), rightArm1.rotateAngleZ + (float) Math.toRadians(8.9546+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*240-90))*-1.5));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraLajasvenator e = (EntityPrehistoricFloraLajasvenator) entity;
