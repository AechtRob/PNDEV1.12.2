...
public class ModelRemigiomontanus extends ModelBasePalaeopedia {
    ...
    public ModelRemigiomontanus() {
        ...
        this.hip.cubeList.add(new ModelBox(hip, 14, 19, -1.5F, -1.575F, -3.65F, 4, 4, 6, 0.0F, false));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(0.5F, -1.575F, 1.85F);
        this.hip.addChild(tail);
        this.setRotateAngle(tail, -0.2618F, 0.0F, 0.0F);
        this.tail.cubeList.add(new ModelBox(tail, 24, 10, -1.5F, 0.0F, 0.0F, 3, 3, 6, 0.0F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.35F, 5.5F);
        this.tail.addChild(tail2);
        this.setRotateAngle(tail2, 0.1745F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 26, 21, -1.0F, 0.0F, 0.0F, 2, 2, 8, 0.0F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, 0.55F, 7.5F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, 0.0873F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 20, 0, -0.5F, 0.0F, -0.5F, 1, 1, 9, 0.0F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.5F, -0.4F, -3.0F);
        this.hip.addChild(body);
        this.body.cubeList.add(new ModelBox(body, 0, 0, -2.5F, -1.5128F, -10.0038F, 5, 5, 10, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 5, -0.025F, -10.95F, -10.0038F, 0, 10, 10, 0.0F, false));

        this.frontRightLeg = new AdvancedModelRenderer(this);
        this.frontRightLeg.setRotationPoint(-1.7F, 1.6872F, -9.0038F);
        this.body.addChild(frontRightLeg);
        this.setRotateAngle(frontRightLeg, -0.0209F, 0.4795F, -0.4308F);
        this.frontRightLeg.cubeList.add(new ModelBox(frontRightLeg, 31, 4, -3.0F, -1.0F, -1.0F, 3, 2, 2, 0.0F, false));
        ...
        this.frontRightLeg2.cubeList.add(new ModelBox(frontRightLeg2, 12, 33, -2.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false));

        this.frontRightLeg3 = new AdvancedModelRenderer(this);
        this.frontRightLeg3.setRotationPoint(-1.425F, 0.0F, -0.5F);
        this.frontRightLeg2.addChild(frontRightLeg3);
        this.frontRightLeg3.cubeList.add(new ModelBox(frontRightLeg3, 20, 0, -1.0F, -1.5F, -2.0F, 1, 3, 3, 0.0F, false));

        this.frontLeftLeg = new AdvancedModelRenderer(this);
        this.frontLeftLeg.setRotationPoint(1.7F, 1.6872F, -9.0038F);
        this.body.addChild(frontLeftLeg);
        this.setRotateAngle(frontLeftLeg, -0.0209F, -0.4795F, 0.4308F);
        this.frontLeftLeg.cubeList.add(new ModelBox(frontLeftLeg, 31, 4, 0.0F, -1.0F, -1.0F, 3, 2, 2, 0.0F, true));
        ...
        this.frontLeftLeg2.cubeList.add(new ModelBox(frontLeftLeg2, 12, 33, 0.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, true));

        this.frontLeftLeg3 = new AdvancedModelRenderer(this);
        this.frontLeftLeg3.setRotationPoint(1.425F, 0.0F, -0.5F);
        this.frontLeftLeg2.addChild(frontLeftLeg3);
        this.frontLeftLeg3.cubeList.add(new ModelBox(frontLeftLeg3, 20, 0, 0.0F, -1.5F, -2.0F, 1, 3, 3, 0.0F, true));

        this.body2 = new AdvancedModelRenderer(this);
        this.body2.setRotationPoint(0.0F, -1.0531F, -9.9914F);
        this.body.addChild(body2);
        this.body2.cubeList.add(new ModelBox(body2, 0, 0, -1.5F, -0.358F, -1.3699F, 3, 3, 2, 0.0F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 0.2774F, -0.9094F);
        this.body2.addChild(head);
        this.setRotateAngle(head, 0.1309F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 0, 5, -1.0F, -0.1274F, -3.4406F, 2, 1, 3, 0.001F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(-0.5F, -0.8024F, -1.5406F);
        this.head.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.1309F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 20, 6, -0.5F, -0.0014F, -0.7659F, 2, 1, 2, 0.0F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(-0.5F, -0.6274F, -1.4406F);
        this.head.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.7854F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 32, 19, -0.5F, -0.75F, -1.45F, 2, 1, 1, -0.001F, false));
        ...
        this.cube_r3.setRotationPoint(0.5F, -0.025F, -0.05F);
        this.jaw.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.0436F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 31, 0, -1.0F, -0.2182F, -2.8416F, 2, 1, 3, 0.0F, false));

        this.sail1 = new AdvancedModelRenderer(this);
        this.sail1.setRotationPoint(0.0F, -0.4F, 0.0F);
        this.body2.addChild(sail1);
        this.sail1.cubeList.add(new ModelBox(sail1, 28, 17, 0.0F, -4.7469F, -2.0127F, 0, 5, 2, 0.0F, false));

        this.sail2 = new AdvancedModelRenderer(this);
        this.sail2.setRotationPoint(0.0F, -1.7F, -3.025F);
        this.hip.addChild(sail2);
        this.sail2.cubeList.add(new ModelBox(sail2, 0, 18, 0.5F, -8.875F, 0.0F, 0, 10, 7, 0.0F, false));
        ...
        this.cube_r4.setRotationPoint(-1.05F, -1.1F, -0.45F);
        this.backRightLeg.addChild(cube_r4);
        this.setRotateAngle(cube_r4, -0.24F, 1.2348F, 1.1214F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 32, 31, -1.0F, -1.0F, 0.0F, 2, 3, 2, 0.0F, false));

        this.backRightLeg2 = new AdvancedModelRenderer(this);
        this.backRightLeg2.setRotationPoint(-2.475F, 0.025F, -0.075F);
        this.backRightLeg.addChild(backRightLeg2);
        this.setRotateAngle(backRightLeg2, 0.0F, 0.1789F, 0.0087F);
        this.backRightLeg2.cubeList.add(new ModelBox(backRightLeg2, 24, 31, -1.2986F, 0.1537F, -1.1793F, 2, 3, 2, 0.0F, false));

        this.backRightLeg3 = new AdvancedModelRenderer(this);
        this.backRightLeg3.setRotationPoint(-0.2986F, 3.1537F, -0.1793F);
        this.backRightLeg2.addChild(backRightLeg3);
        this.backRightLeg3.cubeList.add(new ModelBox(backRightLeg3, 14, 29, -1.5F, -0.5F, -2.5F, 3, 1, 3, 0.0F, false));
        ...
        this.cube_r5.setRotationPoint(1.05F, -1.1F, -0.45F);
        this.backLeftLeg.addChild(cube_r5);
        this.setRotateAngle(cube_r5, -0.24F, -1.2348F, -1.1214F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 32, 31, -1.0F, -1.0F, 0.0F, 2, 3, 2, 0.0F, true));

        this.backLeftLeg2 = new AdvancedModelRenderer(this);
        this.backLeftLeg2.setRotationPoint(2.475F, 0.025F, -0.075F);
        this.backLeftLeg.addChild(backLeftLeg2);
        this.setRotateAngle(backLeftLeg2, 0.0F, -0.1789F, -0.0087F);
        this.backLeftLeg2.cubeList.add(new ModelBox(backLeftLeg2, 24, 31, -0.7014F, 0.1537F, -1.1793F, 2, 3, 2, 0.0F, true));

        this.backLeftLeg3 = new AdvancedModelRenderer(this);
        this.backLeftLeg3.setRotationPoint(0.2986F, 3.1537F, -0.1793F);
        this.backLeftLeg2.addChild(backLeftLeg3);
        this.backLeftLeg3.cubeList.add(new ModelBox(backLeftLeg3, 14, 29, -1.5F, -0.5F, -2.5F, 3, 1, 3, 0.0F, true));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraRemigiomontanus EntityMegalosaurus = (EntityPrehistoricFloraRemigiomontanus) e;
    ...
    public void animEat(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraRemigiomontanus entity = (EntityPrehistoricFloraRemigiomontanus) entitylivingbaseIn;
        int animCycle = 20;
    ...
    public void animRunning(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(hip, hip.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615/0.5+20))*2), hip.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615+100))*-8), hip.rotateAngleZ + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615+100))*-5));
        ...
        this.setRotateAngle(body, body.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615/0.5))*-3), body.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615+50))*8), body.rotateAngleZ + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*615+50))*5));
        ...
        if (tickAnim >= 0 && tickAnim < 2) {
            ...
            xx = -161.75112 + (((tickAnim - 2) / 1) * (-136.74727-(-161.75112)));
            yy = 71.73114 + (((tickAnim - 2) / 1) * (77.16437-(71.73114)));
            zz = -168.45806 + (((tickAnim - 2) / 1) * (-130.88506-(-168.45806)));
        }
        else if (tickAnim >= 3 && tickAnim < 5) {
            xx = -136.74727 + (((tickAnim - 3) / 2) * (-19.30587-(-136.74727)));
            yy = 77.16437 + (((tickAnim - 3) / 2) * (38.24648-(77.16437)));
            zz = -130.88506 + (((tickAnim - 3) / 2) * (-2.87247-(-130.88506)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 2) {
            xx = 0.7 + (((tickAnim - 0) / 2) * (0.09-(0.7)));
            yy = 0 + (((tickAnim - 0) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 2) * (-0.085-(0)));
        }
        else if (tickAnim >= 2 && tickAnim < 3) {
            xx = 0.09 + (((tickAnim - 2) / 1) * (-0.16-(0.09)));
            yy = 0 + (((tickAnim - 2) / 1) * (0-(0)));
            zz = -0.085 + (((tickAnim - 2) / 1) * (0.175-(-0.085)));
        }
        else if (tickAnim >= 3 && tickAnim < 6) {
            xx = -0.16 + (((tickAnim - 3) / 3) * (0-(-0.16)));
            yy = 0 + (((tickAnim - 3) / 3) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -161.75112 + (((tickAnim - 8) / 1) * (-136.74727-(-161.75112)));
            yy = -71.73114 + (((tickAnim - 8) / 1) * (-77.16437-(-71.73114)));
            zz = 168.45806 + (((tickAnim - 8) / 1) * (130.88506-(168.45806)));
        }
        else if (tickAnim >= 9 && tickAnim < 11) {
            xx = -136.74727 + (((tickAnim - 9) / 2) * (-19.30587-(-136.74727)));
            yy = -77.16437 + (((tickAnim - 9) / 2) * (-38.24648-(-77.16437)));
            zz = 130.88506 + (((tickAnim - 9) / 2) * (2.87247-(130.88506)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 0.7 + (((tickAnim - 6) / 2) * (0.09-(0.7)));
            yy = 0 + (((tickAnim - 6) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 2) * (-0.085-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 9) {
            xx = 0.09 + (((tickAnim - 8) / 1) * (-0.16-(0.09)));
            yy = 0 + (((tickAnim - 8) / 1) * (0-(0)));
            zz = -0.085 + (((tickAnim - 8) / 1) * (0.175-(-0.085)));
        }
        else if (tickAnim >= 9 && tickAnim < 12) {
            xx = -0.16 + (((tickAnim - 9) / 3) * (0-(-0.16)));
            yy = 0 + (((tickAnim - 9) / 3) * (0-(0)));
            zz = 0.175 + (((tickAnim - 9) / 3) * (0-(0.175)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            xx = 0.1 + (((tickAnim - 0) / 3) * (0.21-(0.1)));
            yy = 0 + (((tickAnim - 0) / 3) * (0-(0)));
            zz = -0.125 + (((tickAnim - 0) / 3) * (-0.21-(-0.125)));
        }
        else if (tickAnim >= 3 && tickAnim < 5) {
            xx = 0.21 + (((tickAnim - 3) / 2) * (-0.025-(0.21)));
            yy = 0 + (((tickAnim - 3) / 2) * (0-(0)));
            zz = -0.21 + (((tickAnim - 3) / 2) * (-0.3-(-0.21)));
        }
        else if (tickAnim >= 5 && tickAnim < 6) {
            xx = -0.025 + (((tickAnim - 5) / 1) * (-0.135-(-0.025)));
            yy = 0 + (((tickAnim - 5) / 1) * (0-(0)));
            zz = -0.3 + (((tickAnim - 5) / 1) * (-0.27-(-0.3)));
        }
        else if (tickAnim >= 6 && tickAnim < 8) {
            xx = -0.135 + (((tickAnim - 6) / 2) * (-0.265-(-0.135)));
            yy = 0 + (((tickAnim - 6) / 2) * (0-(0)));
            zz = -0.27 + (((tickAnim - 6) / 2) * (-0.21-(-0.27)));
        }
        else if (tickAnim >= 8 && tickAnim < 12) {
            xx = -0.265 + (((tickAnim - 8) / 4) * (0.1-(-0.265)));
            yy = 0 + (((tickAnim - 8) / 4) * (0-(0)));
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -161.75112 + (((tickAnim - 3) / 5) * (-136.74727-(-161.75112)));
            yy = 71.73114 + (((tickAnim - 3) / 5) * (77.16437-(71.73114)));
            zz = -168.45806 + (((tickAnim - 3) / 5) * (-130.88506-(-168.45806)));
        }
        else if (tickAnim >= 8 && tickAnim < 11) {
            xx = -136.74727 + (((tickAnim - 8) / 3) * (-19.30587-(-136.74727)));
            yy = 77.16437 + (((tickAnim - 8) / 3) * (38.24648-(77.16437)));
            zz = -130.88506 + (((tickAnim - 8) / 3) * (-2.87247-(-130.88506)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            xx = 0.7 + (((tickAnim - 0) / 3) * (0.09-(0.7)));
            yy = 0 + (((tickAnim - 0) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 3) * (-0.085-(0)));
        }
        else if (tickAnim >= 3 && tickAnim < 8) {
            xx = 0.09 + (((tickAnim - 3) / 5) * (-0.16-(0.09)));
            yy = 0 + (((tickAnim - 3) / 5) * (0-(0)));
            zz = -0.085 + (((tickAnim - 3) / 5) * (0.175-(-0.085)));
        }
        else if (tickAnim >= 8 && tickAnim < 13) {
            xx = -0.16 + (((tickAnim - 8) / 5) * (0-(-0.16)));
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            xx = -161.75112 + (((tickAnim - 16) / 4) * (-136.74727-(-161.75112)));
            yy = -71.73114 + (((tickAnim - 16) / 4) * (-77.16437-(-71.73114)));
            zz = 168.45806 + (((tickAnim - 16) / 4) * (130.88506-(168.45806)));
        }
        else if (tickAnim >= 20 && tickAnim < 23) {
            xx = -136.74727 + (((tickAnim - 20) / 3) * (-19.30587-(-136.74727)));
            yy = -77.16437 + (((tickAnim - 20) / 3) * (-38.24648-(-77.16437)));
            zz = 130.88506 + (((tickAnim - 20) / 3) * (2.87247-(130.88506)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            xx = 0.7 + (((tickAnim - 13) / 3) * (0.09-(0.7)));
            yy = 0 + (((tickAnim - 13) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 3) * (-0.085-(0)));
        }
        else if (tickAnim >= 16 && tickAnim < 20) {
            xx = 0.09 + (((tickAnim - 16) / 4) * (-0.16-(0.09)));
            yy = 0 + (((tickAnim - 16) / 4) * (0-(0)));
            zz = -0.085 + (((tickAnim - 16) / 4) * (0.175-(-0.085)));
        }
        else if (tickAnim >= 20 && tickAnim < 25) {
            xx = -0.16 + (((tickAnim - 20) / 5) * (0-(-0.16)));
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            xx = 0.1 + (((tickAnim - 0) / 5) * (0.21-(0.1)));
            yy = 0 + (((tickAnim - 0) / 5) * (0-(0)));
            zz = -0.125 + (((tickAnim - 0) / 5) * (-0.21-(-0.125)));
        }
        else if (tickAnim >= 5 && tickAnim < 10) {
            xx = 0.21 + (((tickAnim - 5) / 5) * (-0.025-(0.21)));
            yy = 0 + (((tickAnim - 5) / 5) * (0-(0)));
            zz = -0.21 + (((tickAnim - 5) / 5) * (-0.3-(-0.21)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = -0.025 + (((tickAnim - 10) / 3) * (-0.135-(-0.025)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = -0.3 + (((tickAnim - 10) / 3) * (-0.27-(-0.3)));
        }
        else if (tickAnim >= 13 && tickAnim < 18) {
            xx = -0.135 + (((tickAnim - 13) / 5) * (-0.265-(-0.135)));
            yy = 0 + (((tickAnim - 13) / 5) * (0-(0)));
            zz = -0.27 + (((tickAnim - 13) / 5) * (-0.21-(-0.27)));
        }
        else if (tickAnim >= 18 && tickAnim < 25) {
            xx = -0.265 + (((tickAnim - 18) / 7) * (0.1-(-0.265)));
            yy = 0 + (((tickAnim - 18) / 7) * (0-(0)));
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraRemigiomontanus ee = (EntityPrehistoricFloraRemigiomontanus) entitylivingbaseIn;
