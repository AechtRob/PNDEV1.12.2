...
public class ModelPalaeontinidLong extends ModelBasePalaeopedia {
    ...
    public ModelPalaeontinidLong() {
        this.textureWidth = 32;
        this.textureHeight = 32;

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 22.5F, 0.0F);
        this.body.cubeList.add(new ModelBox(body, 0, 14, -2.0F, -2.0F, -3.0F, 4, 2, 4, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 14, 21, -1.0F, -1.45F, -3.5F, 2, 1, 1, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 22, -0.5F, -1.45F, -3.5F, 1, 1, 1, 0.01F, false));

        this.body2 = new AdvancedModelRenderer(this);
        this.body2.setRotationPoint(0.0F, -2.0F, 1.0F);
        this.body.addChild(body2);
        this.setRotateAngle(body2, -0.0873F, 0.0F, 0.0F);
        this.body2.cubeList.add(new ModelBox(body2, 16, 14, -1.5F, 0.0F, 0.0F, 3, 2, 3, 0.0F, false));
        this.body2.cubeList.add(new ModelBox(body2, 8, 20, -1.0F, 0.5F, 3.0F, 2, 1, 1, 0.0F, false));
        ...
        this.mouthpart.cubeList.add(new ModelBox(mouthpart, 4, 22, 0.0F, -0.1F, 0.1F, 0, 2, 1, 0.0F, false));
        ...
        this.legright.cubeList.add(new ModelBox(legright, 20, 21, -2.5F, -0.5F, 0.0F, 3, 2, 0, 0.0F, false));
        ...
        this.legleft.cubeList.add(new ModelBox(legleft, 20, 21, -0.5F, -0.5F, 0.0F, 3, 2, 0, 0.0F, true));
        ...
        this.legright2.cubeList.add(new ModelBox(legright2, 0, 20, -3.5F, -0.5F, 0.0F, 4, 2, 0, 0.0F, false));
        ...
        this.legleft2.cubeList.add(new ModelBox(legleft2, 0, 20, -0.5F, -0.5F, 0.0F, 4, 2, 0, 0.0F, true));
        ...
        this.legright3.cubeList.add(new ModelBox(legright3, 6, 23, -4.5F, -0.5F, 0.0F, 5, 3, 0, 0.0F, false));
        ...
        this.legleft3.cubeList.add(new ModelBox(legleft3, 6, 23, -0.5F, -0.5F, 0.0F, 5, 3, 0, 0.0F, true));

        this.forewingright = new AdvancedModelRenderer(this);
        this.forewingright.setRotationPoint(-2.0F, -2.0F, -2.0F);
        this.body.addChild(forewingright);
        this.setRotateAngle(forewingright, 0.0F, 0.0873F, 0.0F);
        this.forewingright.cubeList.add(new ModelBox(forewingright, 0, 0, -10.75F, -0.015F, -3.0F, 11, 0, 7, 0.0F, false));

        this.forewingleft = new AdvancedModelRenderer(this);
        this.forewingleft.setRotationPoint(2.0F, -2.0F, -2.0F);
        this.body.addChild(forewingleft);
        this.setRotateAngle(forewingleft, 0.0F, -0.0873F, 0.0F);
        this.forewingleft.cubeList.add(new ModelBox(forewingleft, 0, 0, -0.25F, -0.015F, -3.0F, 11, 0, 7, 0.0F, true));

        this.hindwingright = new AdvancedModelRenderer(this);
        this.hindwingright.setRotationPoint(-1.75F, -2.0F, 0.0F);
        this.body.addChild(hindwingright);
        this.setRotateAngle(hindwingright, 0.0F, -1.1781F, 0.0F);
        this.hindwingright.cubeList.add(new ModelBox(hindwingright, 0, 7, -0.5F, -0.005F, -0.25F, 4, 0, 7, 0.0F, false));

        this.hindwingleft = new AdvancedModelRenderer(this);
        this.hindwingleft.setRotationPoint(1.75F, -2.0F, 0.0F);
        this.body.addChild(hindwingleft);
        this.setRotateAngle(hindwingleft, 0.0F, 1.1781F, 0.0F);
        this.hindwingleft.cubeList.add(new ModelBox(hindwingleft, 0, 7, -3.5F, -0.005F, -0.25F, 4, 0, 7, 0.0F, true));
        updateDefaultPose();
    }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (ee.flyProgress != 0 && ee.getAttachmentPos() == null) {//if flying
            ...
            this.setRotateAngle(forewingleft, body.rotateAngleX-(float)Math.toRadians(-30), -body.rotateAngleY-(float)Math.toRadians(5+70), body.rotateAngleZ+(float)Math.toRadians(0));
            this.setRotateAngle(forewingright, body.rotateAngleX-(float)Math.toRadians(-30), body.rotateAngleY-(float)Math.toRadians(-5-70), body.rotateAngleZ+(float)Math.toRadians(0));
            this.setRotateAngle(hindwingleft, body.rotateAngleX-(float)Math.toRadians(2.5), body.rotateAngleY-(float)Math.toRadians(-67.5+40.5), body.rotateAngleZ+(float)Math.toRadians(20));
            this.setRotateAngle(hindwingright, body.rotateAngleX-(float)Math.toRadians(2.5), body.rotateAngleY-(float)Math.toRadians(67.5-40.5), body.rotateAngleZ+(float)Math.toRadians(-20));
        }
