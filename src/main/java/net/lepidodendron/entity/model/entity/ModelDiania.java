...
public class ModelDiania extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        this.setRotateAngle(body4, -0.3F, 0.1F, 0.0F);
        this.setRotateAngle(body5, -0.2F, 0.0F, 0.0F);
        this.setRotateAngle(back, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(back2, 0.0F, 0.1F, 0.0F);
        this.setRotateAngle(back3, 0.0F, 0.2F, 0.0F);
        this.setRotateAngle(back4, 0.0F, 0.1F, 0.0F);
        this.setRotateAngle(back5, 0.0F, 0.0F, 0.0F);
