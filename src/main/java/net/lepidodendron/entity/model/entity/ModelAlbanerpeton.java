...
public class ModelAlbanerpeton extends ModelBasePalaeopedia {
    ...
    public ModelAlbanerpeton() {
        this.textureWidth = 48;
        this.textureHeight = 48;

        this.Hips = new AdvancedModelRenderer(this);
        this.Hips.setRotationPoint(0.0F, 24.0F, 10.0F);
        this.Hips.cubeList.add(new ModelBox(Hips, 12, 27, -1.0F, -2.25F, 0.0F, 2, 2, 3, -0.01F, false));
        ...
        this.UpperLegR.cubeList.add(new ModelBox(UpperLegR, 18, 35, -2.0F, -0.5F, -0.5F, 2, 1, 1, 0.0F, false));
        ...
        this.LowerLegR.cubeList.add(new ModelBox(LowerLegR, 30, 34, -1.8F, -0.5F, -0.5F, 2, 1, 1, -0.01F, false));
        ...
        this.FootR.cubeList.add(new ModelBox(FootR, 16, 12, -2.8F, 0.0F, -1.5F, 3, 0, 3, 0.0F, false));
        ...
        this.UpperLegL.cubeList.add(new ModelBox(UpperLegL, 18, 35, 0.0F, -0.5F, -0.5F, 2, 1, 1, 0.0F, true));
        ...
        this.LowerLegL.cubeList.add(new ModelBox(LowerLegL, 30, 34, -0.2F, -0.5F, -0.5F, 2, 1, 1, -0.01F, true));
        ...
        this.FootL.cubeList.add(new ModelBox(FootL, 16, 12, -0.2F, 0.0F, -1.5F, 3, 0, 3, 0.0F, true));

        this.Tail1 = new AdvancedModelRenderer(this);
        this.Tail1.setRotationPoint(0.0F, -0.75F, 3.0F);
        this.Hips.addChild(Tail1);
        this.Tail1.cubeList.add(new ModelBox(Tail1, 0, 28, -0.5F, -0.9F, -0.5F, 1, 1, 4, 0.02F, false));
        this.Tail1.cubeList.add(new ModelBox(Tail1, 0, 36, -0.5F, -1.25F, -0.5F, 1, 1, 4, 0.01F, false));

        this.Tail2 = new AdvancedModelRenderer(this);
        this.Tail2.setRotationPoint(0.0F, 0.0F, 3.5F);
        this.Tail1.addChild(Tail2);
        this.Tail2.cubeList.add(new ModelBox(Tail2, 16, 6, -0.5F, -1.0F, -0.25F, 1, 1, 5, 0.0F, false));

        this.Tail3 = new AdvancedModelRenderer(this);
        this.Tail3.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.Tail2.addChild(Tail3);
        this.Tail3.cubeList.add(new ModelBox(Tail3, 0, 22, -0.5F, -1.0F, -0.35F, 1, 1, 5, -0.01F, false));

        this.Body = new AdvancedModelRenderer(this);
        this.Body.setRotationPoint(0.0F, -1.0F, 0.25F);
        this.Hips.addChild(Body);
        this.Body.cubeList.add(new ModelBox(Body, 14, 15, -1.5F, -1.1F, -4.0F, 3, 2, 4, -0.01F, false));
        this.Body.cubeList.add(new ModelBox(Body, 26, 26, -1.0F, -1.5F, -4.0F, 2, 1, 4, 0.0F, false));

        this.Body2 = new AdvancedModelRenderer(this);
        this.Body2.setRotationPoint(0.0F, -0.5F, -4.0F);
        this.Body.addChild(Body2);
        this.Body2.cubeList.add(new ModelBox(Body2, 0, 15, -1.75F, -0.6F, -4.5F, 2, 2, 5, 0.005F, false));
        this.Body2.cubeList.add(new ModelBox(Body2, 0, 15, -0.25F, -0.6F, -4.5F, 2, 2, 5, 0.005F, true));
        this.Body2.cubeList.add(new ModelBox(Body2, 16, 0, -1.0F, -1.25F, -4.5F, 2, 1, 5, 0.01F, false));
        ...
        this.cube_r1.setRotationPoint(1.4F, 1.4F, 0.5F);
        ...
        this.cube_r2.setRotationPoint(-1.4F, 1.4F, 0.5F);
        ...
        this.Neck.cubeList.add(new ModelBox(Neck, 28, 10, -1.5F, -0.5F, -1.75F, 3, 2, 2, 0.0F, false));
        this.Neck.cubeList.add(new ModelBox(Neck, 28, 18, -1.5F, -1.0F, -1.75F, 3, 1, 2, -0.01F, false));
        ...
        this.UpperJaw.cubeList.add(new ModelBox(UpperJaw, 28, 6, -1.0F, -1.0F, -4.25F, 2, 1, 3, 0.005F, false));
        this.UpperJaw.cubeList.add(new ModelBox(UpperJaw, 22, 27, -1.65F, -1.0F, -2.4F, 1, 1, 1, 0.01F, false));
        this.UpperJaw.cubeList.add(new ModelBox(UpperJaw, 22, 27, 0.65F, -1.0F, -2.4F, 1, 1, 1, 0.01F, true));
        this.UpperJaw.cubeList.add(new ModelBox(UpperJaw, 30, 3, -1.0F, -1.0F, -1.25F, 2, 1, 2, -0.01F, false));
        ...
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 6, 35, -1.0F, 0.0F, 0.0F, 2, 1, 1, -0.01F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(1.5F, -1.35F, -2.1F);
        this.UpperJaw.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 0.3491F, -0.2182F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 22, 29, -1.0F, -0.45F, -1.0F, 1, 1, 1, 0.0F, true));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 33, -1.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(1.65F, 0.0F, -1.4F);
        this.UpperJaw.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, -0.1309F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 10, 32, -1.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, true));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(-1.5F, -1.35F, -2.1F);
        this.UpperJaw.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, -0.3491F, 0.2182F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 22, 29, 0.0F, -0.45F, -1.0F, 1, 1, 1, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-1.65F, 0.0F, -1.4F);
        this.UpperJaw.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.1309F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 10, 32, 0.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(-1.0F, 0.0F, -4.25F);
        this.UpperJaw.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, -0.3403F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 33, 0.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(0.0F, -2.05F, -1.35F);
        this.UpperJaw.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0785F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 26, 21, -1.0F, 0.225F, -2.175F, 2, 1, 4, 0.0F, false));

        this.Jaw = new AdvancedModelRenderer(this);
        this.Jaw.setRotationPoint(0.0F, 0.75F, -0.65F);
        this.Head.addChild(Jaw);
        this.Jaw.cubeList.add(new ModelBox(Jaw, 30, 31, -1.0F, -1.0F, -1.25F, 2, 1, 2, -0.02F, false));
        this.Jaw.cubeList.add(new ModelBox(Jaw, 28, 14, -1.0F, -1.0F, -4.15F, 2, 1, 3, -0.01F, false));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(1.475F, 0.0F, -1.25F);
        this.Jaw.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, -0.0175F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 16, 32, -1.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(1.0F, 0.0F, -4.15F);
        this.Jaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0F, 0.1571F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 22, 31, -1.0F, -1.0F, 0.0F, 1, 1, 3, -0.015F, true));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(-1.475F, 0.0F, -1.25F);
        this.Jaw.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.0F, 0.0175F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 16, 32, 0.0F, -1.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(-1.0F, 0.0F, -4.15F);
        this.Jaw.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.0F, -0.1571F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 22, 31, 0.0F, -1.0F, 0.0F, 1, 1, 3, -0.015F, false));

        this.tongue = new AdvancedModelRenderer(this);
        this.tongue.setRotationPoint(0.0F, -0.5F, -1.25F);
        this.Jaw.addChild(tongue);
        this.tongue.cubeList.add(new ModelBox(tongue, 14, 21, -0.5F, -0.75F, -2.25F, 1, 1, 5, 0.0F, false));

        this.UpperArmR = new AdvancedModelRenderer(this);
        this.UpperArmR.setRotationPoint(-1.375F, 0.5F, -3.0F);
        this.Chest.addChild(UpperArmR);
        this.setRotateAngle(UpperArmR, 0.0873F, 0.7854F, -0.1309F);
        this.UpperArmR.cubeList.add(new ModelBox(UpperArmR, 12, 35, -2.0F, -0.5F, -0.5F, 2, 1, 1, 0.0F, false));
        ...
        this.LowerArmR.cubeList.add(new ModelBox(LowerArmR, 24, 35, -1.8F, -0.5F, -0.5F, 2, 1, 1, -0.01F, false));

        this.HandR = new AdvancedModelRenderer(this);
        this.HandR.setRotationPoint(-1.75F, 0.25F, 0.0F);
        this.LowerArmR.addChild(HandR);
        this.HandR.cubeList.add(new ModelBox(HandR, 30, 0, -1.8F, 0.0F, -1.5F, 2, 0, 3, 0.0F, false));

        this.UpperArmL = new AdvancedModelRenderer(this);
        this.UpperArmL.setRotationPoint(1.375F, 0.5F, -3.0F);
        this.Chest.addChild(UpperArmL);
        this.setRotateAngle(UpperArmL, 0.0873F, -0.7854F, 0.1309F);
        this.UpperArmL.cubeList.add(new ModelBox(UpperArmL, 12, 35, 0.0F, -0.5F, -0.5F, 2, 1, 1, 0.0F, true));
        ...
        this.LowerArmL.cubeList.add(new ModelBox(LowerArmL, 24, 35, -0.2F, -0.5F, -0.5F, 2, 1, 1, -0.01F, true));

        this.HandL = new AdvancedModelRenderer(this);
        this.HandL.setRotationPoint(1.75F, 0.25F, 0.0F);
        this.LowerArmL.addChild(HandL);
        this.HandL.cubeList.add(new ModelBox(HandL, 30, 0, -0.2F, 0.0F, -1.5F, 2, 0, 3, 0.0F, true));
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraAlbanerpeton ee = (EntityPrehistoricFloraAlbanerpeton) entitylivingbaseIn;
    ...
    public void animRun(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraAlbanerpeton entity = (EntityPrehistoricFloraAlbanerpeton) entitylivingbaseIn;
        int animCycle = 5;
        ...
        this.setRotateAngle(Tail3, Tail3.rotateAngleX + (float) Math.toRadians(5), Tail3.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*360/0.25-800))*40), Tail3.rotateAngleZ + (float) Math.toRadians(0));
    ...
    public void animWalk(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, boolean isStatic) {
        ...
        this.setRotateAngle(Tail1, Tail1.rotateAngleX + (float) Math.toRadians(-10), Tail1.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*90/0.25-700))*19), Tail1.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tail2, Tail2.rotateAngleX + (float) Math.toRadians(7.5), Tail2.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*90/0.25-800))*20), Tail2.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(Tail3, Tail3.rotateAngleX + (float) Math.toRadians(5), Tail3.rotateAngleY + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*90/0.25-800))*20), Tail3.rotateAngleZ + (float) Math.toRadians(0));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraAlbanerpeton e = (EntityPrehistoricFloraAlbanerpeton) entity;
