...
public class ModelRapaxavis extends ModelBasePalaeopedia {
    ...
    public ModelRapaxavis() {
        ...
        this.base.cubeList.add(new ModelBox(base, 19, 11, -1.5F, -1.35F, 0.55F, 3, 2, 6, 0.0F, false));
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 34, 31, -2.0F, -0.1F, -3.9F, 3, 2, 5, -0.01F, false));
        ...
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 38, 9, -1.0F, 1.4F, -1.875F, 3, 1, 4, 0.01F, false));
        ...
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 38, 15, -1.0F, -2.1F, -2.375F, 3, 1, 3, 0.01F, false));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 38, 0, -1.0F, -2.1F, -2.175F, 3, 4, 4, 0.0F, false));
        ...
        this.armRight1.cubeList.add(new ModelBox(armRight1, 49, 20, -0.7186F, -1.7149F, -0.9922F, 1, 2, 3, 0.01F, true));
        this.armRight1.cubeList.add(new ModelBox(armRight1, 0, 50, -0.1186F, -1.7149F, -0.9922F, 1, 2, 3, 0.0F, true));
        ...
        this.tertialsRightToHide.cubeList.add(new ModelBox(tertialsRightToHide, 34, 39, 0.7F, -7.0F, 0.0F, 1, 7, 3, 0.0F, true));
        ...
        this.armRight2.cubeList.add(new ModelBox(armRight2, 49, 26, -0.5F, -0.7352F, -0.2857F, 1, 1, 3, 0.0F, true));
        ...
        this.secondariesRightToHide.cubeList.add(new ModelBox(secondariesRightToHide, 19, 20, 0.01F, -6.0F, -4.0F, 1, 6, 6, 0.0F, true));
        ...
        this.armRight3.cubeList.add(new ModelBox(armRight3, 26, 44, 0.025F, -0.288F, -0.2588F, 0, 1, 3, 0.0F, true));
        ...
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 24, -0.32F, -3.425F, -1.4F, 0, 2, 8, 0.0F, true));
        ...
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 17, 33, -0.33F, -4.7F, -1.0F, 0, 2, 8, 0.0F, true));
        ...
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 35, -0.315F, -4.2F, -0.3F, 0, 2, 7, 0.0F, true));
        ...
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 34, 20, -0.35F, -4.2F, 0.0F, 0, 3, 7, 0.0F, true));
        ...
        this.armLeft1.cubeList.add(new ModelBox(armLeft1, 49, 20, -0.2814F, -1.7149F, -0.9922F, 1, 2, 3, 0.01F, false));
        this.armLeft1.cubeList.add(new ModelBox(armLeft1, 0, 50, -0.8814F, -1.7149F, -0.9922F, 1, 2, 3, 0.0F, false));
        ...
        this.tertialsLeftToHide.cubeList.add(new ModelBox(tertialsLeftToHide, 34, 39, -1.7F, -7.0F, 0.0F, 1, 7, 3, 0.0F, false));
        ...
        this.armLeft2.cubeList.add(new ModelBox(armLeft2, 49, 26, -0.5F, -0.7352F, -0.2857F, 1, 1, 3, 0.0F, false));
        ...
        this.secondariesLeftToHide.cubeList.add(new ModelBox(secondariesLeftToHide, 19, 20, -1.01F, -6.0F, -4.0F, 1, 6, 6, 0.0F, false));
        ...
        this.armLeft3.cubeList.add(new ModelBox(armLeft3, 26, 44, -0.025F, -0.288F, -0.2588F, 0, 1, 3, 0.0F, false));
        ...
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 24, 0.32F, -3.425F, -1.4F, 0, 2, 8, 0.0F, false));
        ...
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 17, 33, 0.33F, -4.7F, -1.0F, 0, 2, 8, 0.0F, false));
        ...
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 35, 0.315F, -4.2F, -0.3F, 0, 2, 7, 0.0F, false));
        ...
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 34, 20, 0.35F, -4.2F, 0.0F, 0, 3, 7, 0.0F, false));
        ...
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 0, 45, -1.0F, 1.4272F, -3.5085F, 2, 1, 3, -0.01F, false));
        ...
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 43, 39, -1.0F, -0.8F, -3.8F, 2, 2, 3, -0.02F, false));
        ...
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 54, 42, 0.0F, 0.0F, 0.0F, 1, 0, 1, 0.0F, false));
        ...
        this.cube_r21.cubeList.add(new ModelBox(cube_r21, 43, 45, -0.9F, -0.7701F, -1.2078F, 2, 1, 3, -0.01F, false));
        ...
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 45, 50, -1.0F, -0.5F, -1.0F, 2, 1, 2, -0.03F, false));
        ...
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 27, 50, -1.1F, -0.45F, -1.2F, 2, 1, 2, -0.04F, false));
        ...
        this.setRotateAngle(cube_r24, 0.6894F, 0.0F, 0.0F);
        this.cube_r24.cubeList.add(new ModelBox(cube_r24, 51, 15, -1.0F, 0.0405F, 0.1227F, 2, 1, 2, 0.02F, false));

        this.cube_r25 = new AdvancedModelRenderer(this);
        this.cube_r25.setRotationPoint(0.0F, -0.7143F, 0.1249F);
        this.head.addChild(cube_r25);
        this.setRotateAngle(cube_r25, 0.144F, 0.0F, 0.0F);
        this.cube_r25.cubeList.add(new ModelBox(cube_r25, 53, 9, -1.0F, -0.475F, -0.5F, 2, 1, 1, 0.01F, false));

        this.cube_r26 = new AdvancedModelRenderer(this);
        this.cube_r26.setRotationPoint(0.0F, 0.414F, -0.5796F);
        this.head.addChild(cube_r26);
        this.setRotateAngle(cube_r26, 0.5236F, 0.0F, 0.0F);
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 37, 54, -1.05F, -0.903F, -0.7379F, 1, 1, 1, 0.0F, false));
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 32, 54, 0.05F, -0.903F, -0.7379F, 1, 1, 1, 0.0F, false));
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 18, 50, -1.0F, -1.0F, -1.0F, 2, 2, 2, 0.0F, false));

        this.cube_r27 = new AdvancedModelRenderer(this);
        this.cube_r27.setRotationPoint(0.0F, 2.1464F, -2.8424F);
        this.head.addChild(cube_r27);
        this.setRotateAngle(cube_r27, 0.8552F, 0.0F, 0.0F);
        this.cube_r27.cubeList.add(new ModelBox(cube_r27, 42, 54, -0.5F, -0.5F, -0.525F, 1, 1, 1, -0.02F, false));

        this.cube_r28 = new AdvancedModelRenderer(this);
        this.cube_r28.setRotationPoint(-0.5F, 0.414F, -0.5796F);
        this.head.addChild(cube_r28);
        this.setRotateAngle(cube_r28, 0.7854F, 0.0F, 0.0F);
        this.cube_r28.cubeList.add(new ModelBox(cube_r28, 53, 0, 0.0F, -1.0F, -2.425F, 1, 1, 2, -0.01F, false));
        this.cube_r28.cubeList.add(new ModelBox(cube_r28, 53, 12, 0.0F, -1.025F, -3.4F, 1, 1, 1, 0.01F, false));
        ...
        this.cube_r29.setRotationPoint(0.5F, 1.9069F, -3.2452F);
        this.jaw.addChild(cube_r29);
        this.setRotateAngle(cube_r29, 0.8203F, 0.0F, 0.0F);
        this.cube_r29.cubeList.add(new ModelBox(cube_r29, 54, 39, -0.5F, -0.25F, 0.5F, 1, 1, 1, -0.03F, false));

        this.cube_r30 = new AdvancedModelRenderer(this);
        this.cube_r30.setRotationPoint(0.0F, -0.2F, -0.2F);
        this.jaw.addChild(cube_r30);
        this.setRotateAngle(cube_r30, 0.6458F, 0.0F, 0.0F);
        this.cube_r30.cubeList.add(new ModelBox(cube_r30, 51, 35, 0.0F, -0.65F, -2.4F, 1, 1, 2, -0.02F, false));
        ...
        this.cube_r31.setRotationPoint(0.0F, -1.2F, 0.175F);
        this.throat.addChild(cube_r31);
        this.setRotateAngle(cube_r31, -0.4363F, 0.0F, 0.0F);
        this.cube_r31.cubeList.add(new ModelBox(cube_r31, 36, 50, -1.0F, 0.2395F, 0.1147F, 2, 1, 2, -0.05F, false));
        ...
        this.cube_r32.setRotationPoint(0.0F, -3.3F, -0.15F);
        this.legRight1.addChild(cube_r32);
        this.setRotateAngle(cube_r32, 0.5236F, 0.0F, 0.0F);
        this.cube_r32.cubeList.add(new ModelBox(cube_r32, 9, 50, -0.3F, 2.45F, -4.1F, 1, 1, 3, -0.01F, true));

        this.legRight2 = new AdvancedModelRenderer(this);
        this.legRight2.setRotationPoint(0.2F, 1.45F, -1.55F);
        this.legRight1.addChild(legRight2);
        this.legRight2.cubeList.add(new ModelBox(legRight2, 53, 4, -0.5F, -0.5F, -0.9F, 1, 3, 1, 0.0F, true));
        ...
        this.legRight3.cubeList.add(new ModelBox(legRight3, 27, 54, -0.5F, 0.0F, -0.9F, 1, 2, 1, -0.01F, true));
        ...
        this.legRight4.cubeList.add(new ModelBox(legRight4, 15, 44, 0.2F, -0.25F, -2.65F, 1, 1, 4, -0.01F, true));
        this.legRight4.cubeList.add(new ModelBox(legRight4, 51, 31, -0.8F, -0.25F, -1.65F, 1, 1, 2, -0.01F, true));
        ...
        this.cube_r33.setRotationPoint(0.0F, -3.3F, -0.15F);
        this.legLeft1.addChild(cube_r33);
        this.setRotateAngle(cube_r33, 0.5236F, 0.0F, 0.0F);
        this.cube_r33.cubeList.add(new ModelBox(cube_r33, 9, 50, -0.7F, 2.45F, -4.1F, 1, 1, 3, -0.01F, false));

        this.legLeft2 = new AdvancedModelRenderer(this);
        this.legLeft2.setRotationPoint(-0.2F, 1.45F, -1.55F);
        this.legLeft1.addChild(legLeft2);
        this.legLeft2.cubeList.add(new ModelBox(legLeft2, 53, 4, -0.5F, -0.5F, -0.9F, 1, 3, 1, 0.0F, false));
        ...
        this.legLeft3.cubeList.add(new ModelBox(legLeft3, 27, 54, -0.5F, 0.0F, -0.9F, 1, 2, 1, -0.01F, false));
        ...
        this.legLeft4.cubeList.add(new ModelBox(legLeft4, 15, 44, -1.2F, -0.25F, -2.65F, 1, 1, 4, -0.01F, false));
        this.legLeft4.cubeList.add(new ModelBox(legLeft4, 51, 31, -0.2F, -0.25F, -1.65F, 1, 1, 2, -0.01F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraRapaxavis ee = (EntityPrehistoricFloraRapaxavis) e;
...
//        this.feathers4.setScale(1,1,1);
        EntityPrehistoricFloraRapaxavis ee = (EntityPrehistoricFloraRapaxavis) entitylivingbaseIn;
    ...
    public void animEat(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraRapaxavis entity = (EntityPrehistoricFloraRapaxavis) entitylivingbaseIn;
        int animCycle = 20;
    ...
    public void animNest(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
     ...
     if (tickAnim >= 0 && tickAnim < 8) {
        ...
        this.tertialsRightToHide.setScale((float)1,(float)0.2,(float)1);


        this.secondariesRightToHide.setScale((float)1,(float)0,(float)1);


        this.tertialsLeftToHide.setScale((float)1,(float)0.2,(float)1);
    ...
    public void animNoise(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
     ...
     if (tickAnim >= 0 && tickAnim < 12) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 1.25 + (((tickAnim - 3) / 4) * (17-(1.25)));
            yy = 0 + (((tickAnim - 3) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = 17 + (((tickAnim - 7) / 3) * (1.25-(17)));
            yy = 0 + (((tickAnim - 7) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 7) / 3) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 1.25 + (((tickAnim - 10) / 3) * (17-(1.25)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = 17 + (((tickAnim - 13) / 4) * (14.75-(17)));
            yy = 0 + (((tickAnim - 13) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 4) * (0-(0)));
        }
        else if (tickAnim >= 17 && tickAnim < 33) {
            xx = 14.75 + (((tickAnim - 17) / 16) * (-3.25-(14.75)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -6 + (((tickAnim - 3) / 4) * (-3.75-(-6)));
            yy = 0 + (((tickAnim - 3) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = -3.75 + (((tickAnim - 7) / 3) * (-6-(-3.75)));
            yy = 0 + (((tickAnim - 7) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 7) / 3) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = -6 + (((tickAnim - 10) / 3) * (-3.75-(-6)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = -3.75 + (((tickAnim - 13) / 4) * (-6-(-3.75)));
            yy = 0 + (((tickAnim - 13) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 4) * (0-(0)));
        }
        else if (tickAnim >= 17 && tickAnim < 33) {
            xx = -6 + (((tickAnim - 17) / 16) * (-6-(-6)));
            yy = 0 + (((tickAnim - 17) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 17) / 16) * (0-(0)));
        }
        else if (tickAnim >= 33 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 2 + (((tickAnim - 3) / 4) * (-16.25-(2)));
            yy = 0 + (((tickAnim - 3) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = -16.25 + (((tickAnim - 7) / 3) * (2-(-16.25)));
            yy = 0 + (((tickAnim - 7) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 7) / 3) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 2 + (((tickAnim - 10) / 3) * (-16.25-(2)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = -16.25 + (((tickAnim - 13) / 4) * (2-(-16.25)));
            yy = 0 + (((tickAnim - 13) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 4) * (0-(0)));
        }
        else if (tickAnim >= 17 && tickAnim < 33) {
            xx = 2 + (((tickAnim - 17) / 16) * (-5.5-(2)));
            yy = 0 + (((tickAnim - 17) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 17) / 16) * (0-(0)));
        }
        else if (tickAnim >= 33 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            xx = 0 + (((tickAnim - 0) / 3) * (38.75-(0)));
            yy = 0 + (((tickAnim - 0) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 3) * (0-(0)));
        }
        else if (tickAnim >= 3 && tickAnim < 7) {
            xx = 38.75 + (((tickAnim - 3) / 4) * (0-(38.75)));
            yy = 0 + (((tickAnim - 3) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = 0 + (((tickAnim - 7) / 3) * (37.5-(0)));
            yy = 0 + (((tickAnim - 7) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 7) / 3) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 37.5 + (((tickAnim - 10) / 3) * (0-(37.5)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = 0 + (((tickAnim - 13) / 4) * (37.5-(0)));
            yy = 0 + (((tickAnim - 13) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 4) * (0-(0)));
        }
        else if (tickAnim >= 17 && tickAnim < 23) {
            xx = 37.5 + (((tickAnim - 17) / 6) * (0-(37.5)));
            yy = 0 + (((tickAnim - 17) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 17) / 6) * (0-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 33) {
            xx = 0 + (((tickAnim - 23) / 10) * (38.75-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 28 + (((tickAnim - 3) / 4) * (43.25-(28)));
            yy = 0 + (((tickAnim - 3) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 4) * (0-(0)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = 43.25 + (((tickAnim - 7) / 3) * (28-(43.25)));
            yy = 0 + (((tickAnim - 7) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 7) / 3) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 28 + (((tickAnim - 10) / 3) * (43.25-(28)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = 43.25 + (((tickAnim - 13) / 4) * (28-(43.25)));
            yy = 0 + (((tickAnim - 13) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 4) * (0-(0)));
        }
        else if (tickAnim >= 17 && tickAnim < 33) {
            xx = 28 + (((tickAnim - 17) / 16) * (28-(28)));
            yy = 0 + (((tickAnim - 17) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 17) / 16) * (0-(0)));
        }
        else if (tickAnim >= 33 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            yy = 1 + (((tickAnim - 0) / 3) * (2.0475-(1)));
            zz = 1 + (((tickAnim - 0) / 3) * (1-(1)));
        }
        else if (tickAnim >= 3 && tickAnim < 7) {
            xx = 1 + (((tickAnim - 3) / 4) * (1-(1)));
            yy = 2.0475 + (((tickAnim - 3) / 4) * (2.0475-(2.0475)));
            zz = 1 + (((tickAnim - 3) / 4) * (1-(1)));
        }
        else if (tickAnim >= 7 && tickAnim < 10) {
            xx = 1 + (((tickAnim - 7) / 3) * (1-(1)));
            yy = 2.0475 + (((tickAnim - 7) / 3) * (2.0475-(2.0475)));
            zz = 1 + (((tickAnim - 7) / 3) * (1-(1)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 1 + (((tickAnim - 10) / 3) * (1-(1)));
            yy = 2.0475 + (((tickAnim - 10) / 3) * (2.0475-(2.0475)));
            zz = 1 + (((tickAnim - 10) / 3) * (1-(1)));
        }
        else if (tickAnim >= 13 && tickAnim < 17) {
            xx = 1 + (((tickAnim - 13) / 4) * (1-(1)));
            yy = 2.0475 + (((tickAnim - 13) / 4) * (2.0475-(2.0475)));
            zz = 1 + (((tickAnim - 13) / 4) * (1-(1)));
        }
        else if (tickAnim >= 17 && tickAnim < 33) {
            xx = 1 + (((tickAnim - 17) / 16) * (1-(1)));
            yy = 2.0475 + (((tickAnim - 17) / 16) * (2.0475-(2.0475)));
            zz = 1 + (((tickAnim - 17) / 16) * (1-(1)));
        }
        else if (tickAnim >= 33 && tickAnim < 35) {
    ...
    public void animLaunching(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.base.rotationPointY = this.base.rotationPointY - (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*1080-100))*0.5);
    ...
    public void animGliding(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5 + (((tickAnim - 0) / 26) * (8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5-(-0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 27) {
            xx = 8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5 + (((tickAnim - 26) / 1) * (46.975+Math.sin((Math.PI/180)*(((double)tickAnim/20)*100))*-50-(8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5)));
            yy = 0 + (((tickAnim - 26) / 1) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 1) * (0-(0)));
        }
        else if (tickAnim >= 27 && tickAnim < 34) {
            xx = 46.975+Math.sin((Math.PI/180)*(((double)tickAnim/20)*100))*-50 + (((tickAnim - 27) / 7) * (8.35+Math.sin((Math.PI/180)*(((double)tickAnim/20)*10))*50-(46.975+Math.sin((Math.PI/180)*(((double)tickAnim/20)*100))*-50)));
            ...
            xx = 14.25+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5 + (((tickAnim - 35) / 15) * (-0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5-(14.25+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-5)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            ...
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-100))*1 + (((tickAnim - 0) / 26) * (2.125+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-100))*1-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-100))*1)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5)));
        }
        else if (tickAnim >= 26 && tickAnim < 27) {
            xx = 0 + (((tickAnim - 26) / 1) * (0-(0)));
            yy = 2.125+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-100))*1 + (((tickAnim - 26) / 1) * (0.575+Math.sin((Math.PI/180)*(((double)tickAnim/20)*80-100))*5-(2.125+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-100))*1)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5 + (((tickAnim - 26) / 1) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5)));
        }
        else if (tickAnim >= 27 && tickAnim < 34) {
            xx = 0 + (((tickAnim - 27) / 7) * (0-(0)));
            yy = 0.575+Math.sin((Math.PI/180)*(((double)tickAnim/20)*80-100))*5 + (((tickAnim - 27) / 7) * (2.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*80-100))*-5-(0.575+Math.sin((Math.PI/180)*(((double)tickAnim/20)*80-100))*5)));
            zz = 0 + (((tickAnim - 27) / 7) * (0-(0)));
        }
        else if (tickAnim >= 34 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -90.3264781502+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10 + (((tickAnim - 0) / 26) * (-90.3264781502+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10-(-90.3264781502+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10)));
            yy = -0.160928972+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*20 + (((tickAnim - 0) / 26) * (-0.160928972+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*20-(-0.160928972+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*20)));
            zz = 82.2463529651+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*35 + (((tickAnim - 0) / 26) * (82.2463529651+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*35-(82.2463529651+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*35)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = -90.3264781502+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10 + (((tickAnim - 26) / 3) * (0-(-90.3264781502+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10)));
            yy = -0.160928972+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*20 + (((tickAnim - 26) / 3) * (0-(-0.160928972+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*20)));
            zz = 82.2463529651+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*35 + (((tickAnim - 26) / 3) * (0-(82.2463529651+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*35)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*-0.5)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 134+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*-5 + (((tickAnim - 0) / 26) * (134+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*-5-(134+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*-5)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*15 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*15-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*15)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*25)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 134+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*-5 + (((tickAnim - 26) / 3) * (0-(134+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*-5)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*15 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*15)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-220))*25)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -121+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-250))*20 + (((tickAnim - 0) / 26) * (-121+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-250))*20-(-121+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-250))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = -121+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-250))*20 + (((tickAnim - 26) / 3) * (0-(-121+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-250))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 2+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-260))*20 + (((tickAnim - 0) / 26) * (2+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-260))*20-(2+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-260))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 2+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-260))*20 + (((tickAnim - 26) / 3) * (0-(2+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-260))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 10.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*20 + (((tickAnim - 0) / 26) * (10.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*20-(10.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 10.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*20 + (((tickAnim - 26) / 3) * (0-(10.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 24+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (24+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(24+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 24+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(24+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 48.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (48.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(48.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 48.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(48.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
            yy = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-200))*25)));
            zz = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20 + (((tickAnim - 26) / 3) * (0-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-320))*20)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 67.75 + (((tickAnim - 0) / 26) * (67.75-(67.75)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 67.75 + (((tickAnim - 26) / 3) * (0-(67.75)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 79.5 + (((tickAnim - 0) / 26) * (79.5-(79.5)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 79.5 + (((tickAnim - 26) / 3) * (-6.75-(79.5)));
            yy = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 3) * (0-(0)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = -6.75 + (((tickAnim - 29) / 3) * (-6.75-(-6.75)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        }
        else if (tickAnim >= 32 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-190))*-8 + (((tickAnim - 0) / 26) * (0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-190))*-8-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-190))*-8)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-190))*-8 + (((tickAnim - 26) / 3) * (14.25-(0+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-190))*-8)));
            yy = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 3) * (0-(0)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 14.25 + (((tickAnim - 29) / 3) * (-1-(14.25)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        }
        else if (tickAnim >= 32 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            yy = -0.425 + (((tickAnim - 0) / 26) * (-0.425-(-0.425)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 35) {
            xx = 0 + (((tickAnim - 26) / 9) * (0-(0)));
            yy = -0.425 + (((tickAnim - 26) / 9) * (-0.425-(-0.425)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-230))*8 + (((tickAnim - 0) / 26) * (8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-230))*8-(8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-230))*8)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-230))*8 + (((tickAnim - 26) / 3) * (17.5-(8.5+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-230))*8)));
            yy = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 3) * (0-(0)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 17.5 + (((tickAnim - 29) / 3) * (17.5-(17.5)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        }
        else if (tickAnim >= 32 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -24.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-10 + (((tickAnim - 0) / 26) * (-24.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-10-(-24.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-10)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = -24.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-10 + (((tickAnim - 26) / 3) * (-37.5-(-24.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-10)));
            yy = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 3) * (0-(0)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = -37.5 + (((tickAnim - 29) / 3) * (-36.75-(-37.5)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        }
        else if (tickAnim >= 32 && tickAnim < 35) {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 26.75 + (((tickAnim - 0) / 26) * (26.75-(26.75)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            yy = 0.2 + (((tickAnim - 0) / 26) * (0.2-(0.2)));
            zz = 0.5 + (((tickAnim - 0) / 26) * (0.5-(0.5)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -13.75 + (((tickAnim - 0) / 26) * (-13.75-(-13.75)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -23.25 + (((tickAnim - 0) / 26) * (-23.25-(-23.25)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 1 + (((tickAnim - 0) / 26) * (1-(1)));
            yy = 1 + (((tickAnim - 0) / 26) * (1-(1)));
            zz = 1 + (((tickAnim - 0) / 26) * (1-(1)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = 1 + (((tickAnim - 26) / 3) * (1-(1)));
            yy = 1 + (((tickAnim - 26) / 3) * (0.2625-(1)));
            zz = 1 + (((tickAnim - 26) / 3) * (1-(1)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 1 + (((tickAnim - 29) / 3) * (1-(1)));
            yy = 0.2625 + (((tickAnim - 29) / 3) * (0.2625-(0.2625)));
        ...
        if (tickAnim >= 26 && tickAnim < 29) {
            xx = 1 + (((tickAnim - 26) / 3) * (1-(1)));
            yy = 1 + (((tickAnim - 26) / 3) * (0-(1)));
            zz = 1 + (((tickAnim - 26) / 3) * (1-(1)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 1 + (((tickAnim - 29) / 3) * (1-(1)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = 22.25 + (((tickAnim - 0) / 26) * (22.25-(22.25)));
            yy = 0 + (((tickAnim - 0) / 26) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 26) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            xx = -88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10 + (((tickAnim - 0) / 26) * (-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10-(-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10)));
            yy = 0.1609+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*-20 + (((tickAnim - 0) / 26) * (0.1609+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*-20-(0.1609+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*-20)));
            zz = -82.2464+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-35 + (((tickAnim - 0) / 26) * (-82.2464+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-35-(-82.2464+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-35)));
        }
        else if (tickAnim >= 26 && tickAnim < 29) {
            xx = -88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10 + (((tickAnim - 26) / 3) * (0-(-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10)));
            yy = 0.1609+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*-20 + (((tickAnim - 26) / 3) * (0-(0.1609+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-50))*-20)));
            zz = -82.2464+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-35 + (((tickAnim - 26) / 3) * (0-(-82.2464+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-280))*-35)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            ...
            xx = 0 + (((tickAnim - 32) / 3) * (-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10-(0)));
            ...
            xx = -88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10 + (((tickAnim - 35) / 18) * (-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10-(-88.0765+Math.sin((Math.PI/180)*(((double)tickAnim/20)*1080-150))*10)));
        ...
        if (tickAnim >= 0 && tickAnim < 26) {
            ...
            xx = 79.5 + (((tickAnim - 26) / 3) * (-11.5-(79.5)));
            yy = 0 + (((tickAnim - 26) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 26) / 3) * (0-(0)));
        }
        else if (tickAnim >= 29 && tickAnim < 32) {
            xx = -11.5 + (((tickAnim - 29) / 3) * (-11.5-(-11.5)));
            yy = 0 + (((tickAnim - 29) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 3) * (0-(0)));
        }
        else if (tickAnim >= 32 && tickAnim < 35) {
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(base, base.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-50))*0.5), base.rotateAngleY + (float) Math.toRadians(0), base.rotateAngleZ + (float) Math.toRadians(0));
        this.base.rotationPointX = this.base.rotationPointX + (float)(0);
        this.base.rotationPointY = this.base.rotationPointY - (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-100))*0.3);
        this.base.rotationPointZ = this.base.rotationPointZ + (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-50))*0.159);


        this.setRotateAngle(chest, chest.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-150))*1), chest.rotateAngleY + (float) Math.toRadians(0), chest.rotateAngleZ + (float) Math.toRadians(0));
        this.chest.rotationPointX = this.chest.rotationPointX + (float)(0);
        this.chest.rotationPointY = this.chest.rotationPointY - (float)(0);
        this.chest.rotationPointZ = this.chest.rotationPointZ + (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-150))*0.2);


        this.setRotateAngle(armRight1, armRight1.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-150))*-2), armRight1.rotateAngleY + (float) Math.toRadians(0), armRight1.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(neck1, neck1.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-200))*2), neck1.rotateAngleY + (float) Math.toRadians(0), neck1.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(neck2, neck2.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-250))*1), neck2.rotateAngleY + (float) Math.toRadians(0), neck2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(head, head.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-400))*2), head.rotateAngleY + (float) Math.toRadians(0), head.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(throat, throat.rotateAngleX + (float) Math.toRadians(5.25+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-400))*-2), throat.rotateAngleY + (float) Math.toRadians(0), throat.rotateAngleZ + (float) Math.toRadians(0));



        if (tickAnim >= 0 && tickAnim < 6) {
            xx = 32.5 + (((tickAnim - 0) / 6) * (-24.25-(32.5)));
            yy = 0 + (((tickAnim - 0) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 6) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 13) {
            xx = -24.25 + (((tickAnim - 6) / 7) * (32.5-(-24.25)));
        ...
        if (tickAnim >= 0 && tickAnim < 2) {
            ...
            xx = 31.88 + (((tickAnim - 2) / 4) * (0-(31.88)));
            yy = 0 + (((tickAnim - 2) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 2) / 4) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 6) / 7) * (11.25-(0)));
            yy = 0 + (((tickAnim - 6) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 7) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -51.75 + (((tickAnim - 3) / 1) * (-51.75-(-51.75)));
            yy = 0 + (((tickAnim - 3) / 1) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 1) * (0-(0)));
        }
        else if (tickAnim >= 4 && tickAnim < 6) {
            xx = -51.75 + (((tickAnim - 4) / 2) * (24-(-51.75)));
            yy = 0 + (((tickAnim - 4) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 4) / 2) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 9) {
            xx = 24 + (((tickAnim - 6) / 3) * (0.25-(24)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            yy = -0.6 + (((tickAnim - 3) / 1) * (-0.6-(-0.6)));
            zz = -0.175 + (((tickAnim - 3) / 1) * (-0.175-(-0.175)));
        }
        else if (tickAnim >= 4 && tickAnim < 6) {
            xx = 0 + (((tickAnim - 4) / 2) * (0-(0)));
            yy = -0.6 + (((tickAnim - 4) / 2) * (0-(-0.6)));
        ...
        if (tickAnim >= 0 && tickAnim < 2) {
            ...
            xx = 27 + (((tickAnim - 2) / 2) * (44.75-(27)));
            yy = 0 + (((tickAnim - 2) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 2) / 2) * (0-(0)));
        }
        else if (tickAnim >= 4 && tickAnim < 6) {
            xx = 44.75 + (((tickAnim - 4) / 2) * (0-(44.75)));
            yy = 0 + (((tickAnim - 4) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 4) / 2) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 6) / 7) * (-22-(0)));
            yy = 0 + (((tickAnim - 6) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 7) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            xx = -24.25 + (((tickAnim - 0) / 6) * (32.5-(-24.25)));
            yy = 0 + (((tickAnim - 0) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 6) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 13) {
            xx = 32.5 + (((tickAnim - 6) / 7) * (-24.25-(32.5)));
            yy = 0 + (((tickAnim - 6) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 7) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = 11.25 + (((tickAnim - 6) / 2) * (31.88-(11.25)));
            yy = 0 + (((tickAnim - 6) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 2) * (0-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 13) {
            xx = 31.88 + (((tickAnim - 8) / 5) * (0-(31.88)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -3.25 + (((tickAnim - 3) / 3) * (0-(-3.25)));
            yy = 0 + (((tickAnim - 3) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 3) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 9) {
            xx = 0 + (((tickAnim - 6) / 3) * (-51.75-(0)));
            yy = 0 + (((tickAnim - 6) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 3) * (0-(0)));
        }
        else if (tickAnim >= 9 && tickAnim < 10) {
            xx = -51.75 + (((tickAnim - 9) / 1) * (-51.75-(-51.75)));
            yy = 0 + (((tickAnim - 9) / 1) * (0-(0)));
            zz = 0 + (((tickAnim - 9) / 1) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = -51.75 + (((tickAnim - 10) / 3) * (24-(-51.75)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            yy = 0 + (((tickAnim - 6) / 3) * (-0.6-(0)));
            zz = 0 + (((tickAnim - 6) / 3) * (-0.175-(0)));
        }
        else if (tickAnim >= 9 && tickAnim < 10) {
            xx = 0 + (((tickAnim - 9) / 1) * (0-(0)));
            yy = -0.6 + (((tickAnim - 9) / 1) * (-0.6-(-0.6)));
            zz = -0.175 + (((tickAnim - 9) / 1) * (-0.175-(-0.175)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            yy = -0.6 + (((tickAnim - 10) / 3) * (0-(-0.6)));
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = -5.9 + (((tickAnim - 3) / 3) * (-22-(-5.9)));
            yy = 0 + (((tickAnim - 3) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 3) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 8) {
            xx = -22 + (((tickAnim - 6) / 2) * (27-(-22)));
            yy = 0 + (((tickAnim - 6) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 6) / 2) * (0-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 10) {
            xx = 27 + (((tickAnim - 8) / 2) * (44.75-(27)));
            yy = 0 + (((tickAnim - 8) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 8) / 2) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 44.75 + (((tickAnim - 10) / 3) * (0-(44.75)));
            yy = 0 + (((tickAnim - 10) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = 0 + (((tickAnim - 6) / 2) * (0-(0)));
            yy = 0 + (((tickAnim - 6) / 2) * (0.775-(0)));
            zz = 0 + (((tickAnim - 6) / 2) * (0-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 10) {
            xx = 0 + (((tickAnim - 8) / 2) * (0-(0)));
            yy = 0.775 + (((tickAnim - 8) / 2) * (0-(0.775)));
            zz = 0 + (((tickAnim - 8) / 2) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 10) / 3) * (0-(0)));
        ...
        this.setRotateAngle(armLeft1, armLeft1.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*575/0.5-150))*-2), armLeft1.rotateAngleY + (float) Math.toRadians(0), armLeft1.rotateAngleZ + (float) Math.toRadians(0));
