...
public class ModelApatosaurus extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        this.setRotateAngle(hip, 1.5F, 0.0F, 0.0F);
        this.setRotateAngle(body, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.05F, 0.0F, -0.2F);
        this.setRotateAngle(neck1, -0.18F, 0.0F, -0.2F);
        this.setRotateAngle(neck2, -0.18F, 0.0F, -0.3F);
        this.setRotateAngle(neck3, -0.1F, 0.0F, -0.1F);
        this.setRotateAngle(neck4, 0.08F, 0.0F, -0.1F);
        this.setRotateAngle(neck5, 0.1F, 0.0F, -0.2F);
        this.setRotateAngle(neck6, 0.1F, 0.0F, -0.3F);
        this.setRotateAngle(head, 0.3F, 0.0F, -0.3F);
        this.setRotateAngle(tail1, -0.27F, 0.1F, 0.2F);
        this.setRotateAngle(tail2, 0.1F, 0.0F, 0.2F);
        this.setRotateAngle(tail3, 0.0F, 0.0F, 0.5F);
        this.setRotateAngle(tail4, 0.0F, 0.0F, 0.5F);
        this.setRotateAngle(tail5, 0.05F, 0.0F, 0.4F);
        this.setRotateAngle(tail6, 0.05F, 0.0F, 0.4F);
        this.setRotateAngle(tail7, 0.1F, 0.0F, 0.3F);
        this.setRotateAngle(tail8, 0.1F, 0.0F, 0.3F);
        this.setRotateAngle(tail9, 0.2F, 0.0F, 0.5F);
        this.setRotateAngle(tail10, 0.3F, 0.0F, 0.5F);
        this.setRotateAngle(tail11, 0.4F, 0.0F, 0.5F);
        this.setRotateAngle(tail12, 0.5F, 0.0F, 0.5F);
        this.setRotateAngle(leftArm, 0.3F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm2, -0.35F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm3, 0.1F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm, -0.2F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm2, -0.2F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm3, 0.3F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg, 0.35F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg2, 0.18F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg3, -0.1F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg4, -0.1F, 0.0F, 0.0F);
        this.setRotateAngle(rightLeg, -0.15F, 0.0F, 0.0F);
        ...
        this.hip.offsetZ = 0.2F;
        this.hip.offsetY = -0.61F;
...
//        }
    ...
    public void animEat(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            ...
            xx = -22.5 + (((tickAnim - 18) / 45) * (-22.5-(-22.5)));
            yy = 0 + (((tickAnim - 18) / 45) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 45) * (0-(0)));
        }
        else if (tickAnim >= 63 && tickAnim < 86) {
            xx = -22.5 + (((tickAnim - 63) / 23) * (0-(-22.5)));
            yy = 0 + (((tickAnim - 63) / 23) * (0-(0)));
            zz = 0 + (((tickAnim - 63) / 23) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            ...
            xx = 12 + (((tickAnim - 18) / 45) * (12-(12)));
            yy = 0 + (((tickAnim - 18) / 45) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 45) * (0-(0)));
        }
        else if (tickAnim >= 63 && tickAnim < 86) {
            xx = 12 + (((tickAnim - 63) / 23) * (0-(12)));
            yy = 0 + (((tickAnim - 63) / 23) * (0-(0)));
            zz = 0 + (((tickAnim - 63) / 23) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 27 && tickAnim < 43) {
            xx = 0 + (((tickAnim - 27) / 16) * (16.6-(0)));
        ...
        if (tickAnim >= 39 && tickAnim < 48) {
            ...
            xx = 15 + (((tickAnim - 59) / 20) * (-5.94-(15)));
            yy = 0 + (((tickAnim - 59) / 20) * (0-(0)));
            zz = 0 + (((tickAnim - 59) / 20) * (0-(0)));
        }
        else if (tickAnim >= 79 && tickAnim < 90) {
            xx = -5.94 + (((tickAnim - 79) / 11) * (0-(-5.94)));
            yy = 0 + (((tickAnim - 79) / 11) * (0-(0)));
            zz = 0 + (((tickAnim - 79) / 11) * (0-(0)));
        }
        else {
        ...
        else if (tickAnim >= 59 && tickAnim < 78) {
            xx = 2 + (((tickAnim - 59) / 19) * (-15.06-(2)));
            yy = 0 + (((tickAnim - 59) / 19) * (0-(0)));
            zz = 0 + (((tickAnim - 59) / 19) * (0-(0)));
        }
        else if (tickAnim >= 78 && tickAnim < 90) {
            xx = -15.06 + (((tickAnim - 78) / 12) * (0-(-15.06)));
        ...
        if (tickAnim >= 44 && tickAnim < 56) {
            ...
            xx = -8 + (((tickAnim - 59) / 19) * (1.71-(-8)));
            yy = 0 + (((tickAnim - 59) / 19) * (0-(0)));
            zz = 0 + (((tickAnim - 59) / 19) * (0-(0)));
        }
        else if (tickAnim >= 78 && tickAnim < 89) {
            xx = 1.71 + (((tickAnim - 78) / 11) * (-1-(1.71)));
            yy = 0 + (((tickAnim - 78) / 11) * (0-(0)));
        ...
        else if (tickAnim >= 53 && tickAnim < 76) {
            xx = -9 + (((tickAnim - 53) / 23) * (-24-(-9)));
            yy = 0 + (((tickAnim - 53) / 23) * (0-(0)));
            zz = 0 + (((tickAnim - 53) / 23) * (0-(0)));
        }
        else if (tickAnim >= 76 && tickAnim < 90) {
            xx = -24 + (((tickAnim - 76) / 14) * (0-(-24)));
    ...
    public void animNoise(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            ...
            xx = -15 + (((tickAnim - 13) / 7) * (-5-(-15)));
            yy = 0 + (((tickAnim - 13) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 7) * (0-(0)));
        }
        else if (tickAnim >= 20 && tickAnim < 30) {
            xx = -5 + (((tickAnim - 20) / 10) * (3-(-5)));
            yy = 0 + (((tickAnim - 20) / 10) * (0-(0)));
            zz = 0 + (((tickAnim - 20) / 10) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 40) {
            xx = 3 + (((tickAnim - 30) / 10) * (0-(3)));
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = 18 + (((tickAnim - 10) / 5) * (19.00006-(18)));
            yy = 0 + (((tickAnim - 10) / 5) * (0.0136-(0)));
            zz = 0 + (((tickAnim - 10) / 5) * (-0.00817-(0)));
        }
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = -6 + (((tickAnim - 10) / 5) * (1.99977-(-6)));
            yy = 0 + (((tickAnim - 10) / 5) * (-0.02983-(0)));
            zz = 0 + (((tickAnim - 10) / 5) * (0.04679-(0)));
        }
        else if (tickAnim >= 15 && tickAnim < 20) {
            ...
            xx = 25 + (((tickAnim - 20) / 3) * (23-(25)));
            yy = 0 + (((tickAnim - 20) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 20) / 3) * (0-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 31) {
            xx = 23 + (((tickAnim - 23) / 8) * (-10-(23)));
            yy = 0 + (((tickAnim - 23) / 8) * (0-(0)));
            zz = 0 + (((tickAnim - 23) / 8) * (0-(0)));
        }
        else if (tickAnim >= 31 && tickAnim < 34) {
            xx = -10 + (((tickAnim - 31) / 3) * (-13-(-10)));
            yy = 0 + (((tickAnim - 31) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 31) / 3) * (0-(0)));
        }
        else if (tickAnim >= 34 && tickAnim < 40) {
            xx = -13 + (((tickAnim - 34) / 6) * (3-(-13)));
            yy = 0 + (((tickAnim - 34) / 6) * (0-(0)));
            zz = 0 + (((tickAnim - 34) / 6) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = -3 + (((tickAnim - 20) / 3) * (8-(-3)));
            yy = 0 + (((tickAnim - 20) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 20) / 3) * (0-(0)));
        }
        else if (tickAnim >= 23 && tickAnim < 31) {
            xx = 8 + (((tickAnim - 23) / 8) * (3-(8)));
            yy = 0 + (((tickAnim - 23) / 8) * (0-(0)));
            zz = 0 + (((tickAnim - 23) / 8) * (0-(0)));
        }
        else if (tickAnim >= 31 && tickAnim < 36) {
            xx = 3 + (((tickAnim - 31) / 5) * (24-(3)));
            yy = 0 + (((tickAnim - 31) / 5) * (0-(0)));
            zz = 0 + (((tickAnim - 31) / 5) * (0-(0)));
        }
        else if (tickAnim >= 36 && tickAnim < 40) {
            xx = 24 + (((tickAnim - 36) / 4) * (2-(24)));
            yy = 0 + (((tickAnim - 36) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 36) / 4) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            yy = 2.25 + (((tickAnim - 19) / 10) * (3.25-(2.25)));
            zz = 2.5 + (((tickAnim - 19) / 10) * (3.5-(2.5)));
        }
        else if (tickAnim >= 29 && tickAnim < 33) {
            xx = 0 + (((tickAnim - 29) / 4) * (0-(0)));
            yy = 3.25 + (((tickAnim - 29) / 4) * (4.5-(3.25)));
            zz = 3.5 + (((tickAnim - 29) / 4) * (4-(3.5)));
        }
        else if (tickAnim >= 33 && tickAnim < 36) {
            xx = 0 + (((tickAnim - 33) / 3) * (0-(0)));
            yy = 4.5 + (((tickAnim - 33) / 3) * (2.75-(4.5)));
            zz = 4 + (((tickAnim - 33) / 3) * (0-(4)));
        }
        else if (tickAnim >= 36 && tickAnim < 40) {
            xx = 0 + (((tickAnim - 36) / 4) * (0-(0)));
            yy = 2.75 + (((tickAnim - 36) / 4) * (1.4-(2.75)));
            zz = 0 + (((tickAnim - 36) / 4) * (0-(0)));
        }
        else {
            xx = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            xx = -4.00137 + (((tickAnim - 19) / 10) * (-10.00389-(-4.00137)));
            yy = -0.0712 + (((tickAnim - 19) / 10) * (0.1703-(-0.0712)));
            zz = -0.1562 + (((tickAnim - 19) / 10) * (-0.1901-(-0.1562)));
        }
        else if (tickAnim >= 29 && tickAnim < 33) {
            xx = -10.00389 + (((tickAnim - 29) / 4) * (-27-(-10.00389)));
            yy = 0.1703 + (((tickAnim - 29) / 4) * (0-(0.1703)));
            zz = -0.1901 + (((tickAnim - 29) / 4) * (0-(-0.1901)));
        }
        else if (tickAnim >= 33 && tickAnim < 36) {
            xx = -27 + (((tickAnim - 33) / 3) * (-33-(-27)));
            yy = 0 + (((tickAnim - 33) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 33) / 3) * (0-(0)));
        }
        else if (tickAnim >= 36 && tickAnim < 40) {
            xx = -33 + (((tickAnim - 36) / 4) * (-8-(-33)));
            yy = 0 + (((tickAnim - 36) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 36) / 4) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            xx = -9.99865 + (((tickAnim - 19) / 10) * (-16.5-(-9.99865)));
            yy = 0.0202 + (((tickAnim - 19) / 10) * (0-(0.0202)));
            zz = 0.1532 + (((tickAnim - 19) / 10) * (0-(0.1532)));
        }
        else if (tickAnim >= 29 && tickAnim < 33) {
            xx = -16.5 + (((tickAnim - 29) / 4) * (-1-(-16.5)));
            yy = 0 + (((tickAnim - 29) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 29) / 4) * (0-(0)));
        }
        else if (tickAnim >= 33 && tickAnim < 36) {
            xx = -1 + (((tickAnim - 33) / 3) * (14-(-1)));
            yy = 0 + (((tickAnim - 33) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 33) / 3) * (0-(0)));
        }
        else if (tickAnim >= 36 && tickAnim < 40) {
            xx = 14 + (((tickAnim - 36) / 4) * (11-(14)));
            yy = 0 + (((tickAnim - 36) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 36) / 4) * (0-(0)));
        }
        else {
