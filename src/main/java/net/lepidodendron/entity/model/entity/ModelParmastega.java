...
public class ModelParmastega extends AdvancedModelBaseExtended {
    ...
    public void renderStatic(float f) {
        ...
        this.Body.rotateAngleY = (float) Math.toRadians(11);
        this.Parmastega.rotateAngleY = (float) Math.toRadians(-15);
        this.Body2.rotateAngleY = (float) Math.toRadians(20);
        this.Tail.rotateAngleY = (float) Math.toRadians(20);
        this.Tail2.rotateAngleY = (float) Math.toRadians(10);
