...
public class ModelSanctacaris extends AdvancedModelBase {
    ...
    public ModelSanctacaris() {
        ...
        this.cube_r3.setRotationPoint(3.5F, 1.5F, 2.0F);
        this.Body.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.0F, 0.2618F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 10, 9, 0.0F, 0.0F, -2.0F, 2, 0, 7, 0.0F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-3.5F, 1.5F, 2.0F);
        this.Body.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 0.0F, -0.2618F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 10, 9, -2.0F, 0.0F, -2.0F, 2, 0, 7, 0.0F, false));
        ...
        this.cube_r5.setRotationPoint(2.5F, 0.75F, 1.0F);
        this.Body2.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.0F, 0.2618F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 8, 17, 0.0F, 0.0F, -1.0F, 2, 0, 6, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-2.5F, 0.75F, 1.0F);
        this.Body2.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, 0.0F, -0.2618F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 8, 17, -2.0F, 0.0F, -1.0F, 2, 0, 6, 0.0F, false));
        ...
        this.legR13.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, 0.0F, -0.8727F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 9, 26, -2.35F, -0.725F, 0.0F, 4, 1, 0, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR13.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 18, 24, -3.75F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legL13.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, 0.0F, 0.8727F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 9, 26, -1.65F, -0.725F, 0.0F, 4, 1, 0, 0.0F, true));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legL13.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 18, 24, -0.25F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legL14.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, 0.0F, 0.8727F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 9, 26, -1.65F, -0.725F, 0.0F, 4, 1, 0, 0.0F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legL14.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 18, 24, -0.5F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legL15.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 18, 24, -0.75F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legL16.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 18, 24, -1.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legR14.addChild(cube_r17);
        this.setRotateAngle(cube_r17, 0.0F, 0.0F, -0.8727F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 9, 26, -2.35F, -0.725F, 0.0F, 4, 1, 0, 0.0F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR14.addChild(cube_r18);
        this.setRotateAngle(cube_r18, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 18, 24, -3.5F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legR15.addChild(cube_r19);
        this.setRotateAngle(cube_r19, 0.0F, 0.0F, -0.8727F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 9, 26, -2.35F, -0.725F, 0.0F, 4, 1, 0, 0.0F, false));

        this.cube_r20 = new AdvancedModelRenderer(this);
        this.cube_r20.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR15.addChild(cube_r20);
        this.setRotateAngle(cube_r20, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 18, 24, -3.25F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legR16.addChild(cube_r22);
        this.setRotateAngle(cube_r22, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 18, 24, -3.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legR7.addChild(cube_r23);
        this.setRotateAngle(cube_r23, 0.0F, 0.0F, -0.8727F);
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 9, 26, -2.25F, -0.725F, 0.025F, 4, 1, 0, 0.0F, false));

        this.cube_r24 = new AdvancedModelRenderer(this);
        this.cube_r24.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR7.addChild(cube_r24);
        this.setRotateAngle(cube_r24, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r24.cubeList.add(new ModelBox(cube_r24, 18, 24, -4.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legR8.addChild(cube_r25);
        this.setRotateAngle(cube_r25, 0.0F, 0.0F, -0.8727F);
        this.cube_r25.cubeList.add(new ModelBox(cube_r25, 9, 26, -2.25F, -0.725F, 0.0F, 4, 1, 0, 0.0F, false));

        this.cube_r26 = new AdvancedModelRenderer(this);
        this.cube_r26.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR8.addChild(cube_r26);
        this.setRotateAngle(cube_r26, 0.3054F, 0.1745F, -0.3927F);
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 18, 24, -4.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, false));
        ...
        this.legR9.addChild(cube_r27);
        this.setRotateAngle(cube_r27, 0.0F, 0.0F, -0.8727F);
        this.cube_r27.cubeList.add(new ModelBox(cube_r27, 9, 26, -2.25F, -0.725F, 0.0F, 4, 1, 0, 0.0F, false));

        this.cube_r28 = new AdvancedModelRenderer(this);
        this.cube_r28.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legR9.addChild(cube_r28);
        ...
        this.legL7.addChild(cube_r35);
        this.setRotateAngle(cube_r35, 0.0F, 0.0F, 0.8727F);
        this.cube_r35.cubeList.add(new ModelBox(cube_r35, 9, 26, -1.75F, -0.725F, 0.025F, 4, 1, 0, 0.0F, true));

        this.cube_r36 = new AdvancedModelRenderer(this);
        this.cube_r36.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legL7.addChild(cube_r36);
        this.setRotateAngle(cube_r36, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r36.cubeList.add(new ModelBox(cube_r36, 18, 24, 0.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legL8.addChild(cube_r37);
        this.setRotateAngle(cube_r37, 0.0F, 0.0F, 0.8727F);
        this.cube_r37.cubeList.add(new ModelBox(cube_r37, 9, 26, -1.75F, -0.725F, 0.0F, 4, 1, 0, 0.0F, true));

        this.cube_r38 = new AdvancedModelRenderer(this);
        this.cube_r38.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legL8.addChild(cube_r38);
        this.setRotateAngle(cube_r38, 0.3054F, -0.1745F, 0.3927F);
        this.cube_r38.cubeList.add(new ModelBox(cube_r38, 18, 24, 0.0F, -0.725F, -0.75F, 4, 0, 2, 0.0F, true));
        ...
        this.legL9.addChild(cube_r39);
        this.setRotateAngle(cube_r39, 0.0F, 0.0F, 0.8727F);
        this.cube_r39.cubeList.add(new ModelBox(cube_r39, 9, 26, -1.75F, -0.725F, 0.0F, 4, 1, 0, 0.0F, true));

        this.cube_r40 = new AdvancedModelRenderer(this);
        this.cube_r40.setRotationPoint(0.0F, 0.75F, 0.0F);
        this.legL9.addChild(cube_r40);
        ...
        this.legR6.addChild(cube_r47);
        this.setRotateAngle(cube_r47, 0.0F, 0.0F, -0.9163F);
        this.cube_r47.cubeList.add(new ModelBox(cube_r47, 0, 6, -2.25F, -0.475F, 0.0F, 3, 1, 0, 0.0F, false));

        this.cube_r48 = new AdvancedModelRenderer(this);
        this.cube_r48.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.legR6.addChild(cube_r48);
        this.setRotateAngle(cube_r48, 0.0F, -0.6981F, -0.0873F);
        this.cube_r48.cubeList.add(new ModelBox(cube_r48, 0, 26, -4.0F, -0.225F, -0.75F, 4, 0, 1, 0.0F, false));
        ...
        this.legL6.addChild(cube_r49);
        this.setRotateAngle(cube_r49, 0.0F, 0.0F, 0.9163F);
        this.cube_r49.cubeList.add(new ModelBox(cube_r49, 0, 6, -0.75F, -0.475F, 0.0F, 3, 1, 0, 0.0F, true));

        this.cube_r50 = new AdvancedModelRenderer(this);
        this.cube_r50.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.legL6.addChild(cube_r50);
        this.setRotateAngle(cube_r50, 0.0F, 0.6981F, 0.0873F);
        this.cube_r50.cubeList.add(new ModelBox(cube_r50, 0, 26, 0.0F, -0.225F, -0.75F, 4, 0, 1, 0.0F, true));
        ...
        this.legR5.addChild(cube_r51);
        this.setRotateAngle(cube_r51, -0.1309F, 0.1745F, 0.0F);
        this.cube_r51.cubeList.add(new ModelBox(cube_r51, 0, 0, -0.5F, -0.225F, -4.75F, 1, 0, 5, 0.0F, false));
        ...
        this.legL5.addChild(cube_r52);
        this.setRotateAngle(cube_r52, -0.1309F, -0.1745F, 0.0F);
        this.cube_r52.cubeList.add(new ModelBox(cube_r52, 0, 0, -0.5F, -0.225F, -4.75F, 1, 0, 5, 0.0F, true));
        ...
        this.legR4.addChild(cube_r53);
        this.setRotateAngle(cube_r53, -0.1309F, 0.1745F, 0.0F);
        this.cube_r53.cubeList.add(new ModelBox(cube_r53, 0, 9, -0.5F, -0.225F, -4.25F, 1, 0, 5, 0.0F, false));
        ...
        this.legL4.addChild(cube_r54);
        this.setRotateAngle(cube_r54, -0.1309F, -0.1745F, 0.0F);
        this.cube_r54.cubeList.add(new ModelBox(cube_r54, 0, 9, -0.5F, -0.225F, -4.25F, 1, 0, 5, 0.0F, true));
        ...
        this.legR3.addChild(cube_r55);
        this.setRotateAngle(cube_r55, -0.1309F, 0.1745F, 0.0F);
        this.cube_r55.cubeList.add(new ModelBox(cube_r55, 0, 17, -0.5F, -0.225F, -3.75F, 1, 0, 4, 0.0F, false));
        ...
        this.legL3.addChild(cube_r56);
        this.setRotateAngle(cube_r56, -0.1309F, -0.1745F, 0.0F);
        this.cube_r56.cubeList.add(new ModelBox(cube_r56, 0, 17, -0.5F, -0.225F, -3.75F, 1, 0, 4, 0.0F, true));
        ...
        this.legR2.addChild(cube_r57);
        this.setRotateAngle(cube_r57, -0.1745F, 0.1745F, 0.0F);
        this.cube_r57.cubeList.add(new ModelBox(cube_r57, 17, 9, -0.5F, -0.225F, -3.5F, 1, 0, 4, 0.0F, false));
        ...
        this.legL2.addChild(cube_r58);
        this.setRotateAngle(cube_r58, -0.1745F, -0.1745F, 0.0F);
        this.cube_r58.cubeList.add(new ModelBox(cube_r58, 17, 9, -0.5F, -0.225F, -3.5F, 1, 0, 4, 0.0F, true));
        ...
        this.legR.addChild(cube_r59);
        this.setRotateAngle(cube_r59, -0.1745F, 0.1745F, 0.0F);
        this.cube_r59.cubeList.add(new ModelBox(cube_r59, 0, 0, -0.5F, -0.225F, -2.75F, 1, 0, 3, 0.0F, false));
        ...
        this.legL.addChild(cube_r60);
        this.setRotateAngle(cube_r60, -0.1745F, -0.1745F, 0.0F);
        this.cube_r60.cubeList.add(new ModelBox(cube_r60, 0, 0, -0.5F, -0.225F, -2.75F, 1, 0, 3, 0.0F, true));
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(Body, 0.0F, -0.0611F, 0.0F);
        this.setRotateAngle(Body2, 0.0F, 0.0611F, 0.0F);
        this.setRotateAngle(legR, 0.0F, 0.4363F, 0.0F);
        this.setRotateAngle(legR2, -0.6109F, 0.4363F, 0.0F);
        this.setRotateAngle(legR3, -0.6109F, -0.4363F, 0.0F);
        this.setRotateAngle(legR4, 0.0F, -0.4363F, 0.0F);
        this.setRotateAngle(legR5, 0.0F, -0.0611F, 0.0F);
        this.setRotateAngle(legR6, 0.0F, 0.0F, 0.3491F);
        this.setRotateAngle(legR7, 0.0F, -0.0436F, 0.3491F);
        this.setRotateAngle(legR8, 0.0F, 0.0436F, -0.3491F);
        this.setRotateAngle(legR9, 0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(legR10, 0.0F, 0.0F, -0.3491F);
        this.setRotateAngle(legR11, 0.0F, 0.0611F, 0.0F);
        this.setRotateAngle(legR12, 0.5236F, 0.0F, 0.0F);
        this.setRotateAngle(legR13, 0.192F, 0.0F, 0.0F);
        this.setRotateAngle(legR14, -0.2618F, 0.0F, 0.0F);
        this.setRotateAngle(legR15, -0.0436F, 0.0F, 0.0F);
        this.setRotateAngle(legR16, -0.1047F, 0.0F, 0.0F);
        this.setRotateAngle(legL, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(legL2, 0.6109F, -0.4363F, 0.0F);
        this.setRotateAngle(legL3, 0.6109F, 0.4363F, 0.0F);
        this.setRotateAngle(legL4, 0.0F, 0.5236F, 0.0F);
        this.setRotateAngle(legL5, 0.0F, -0.5236F, 0.0F);
        this.setRotateAngle(legL6, 1.1781F, 0.0F, -0.4363F);
        this.setRotateAngle(legL7, -0.48F, 0.5236F, 0.1745F);
        this.setRotateAngle(legL8, 1.4835F, -0.2182F, -0.2182F);
        this.setRotateAngle(legL9, 0.2618F, 0.0F, 0.4363F);
        this.setRotateAngle(legL10, -1.2654F, -0.5236F, -0.1745F);
        this.setRotateAngle(legL11, 0.9492F, 0.2458F, 0.1666F);
        this.setRotateAngle(legL12, -0.0928F, 0.3477F, -0.0317F);
        this.setRotateAngle(legL13, -1.0873F, 0.116F, -0.9865F);
        this.setRotateAngle(legL14, 1.4835F, -0.5672F, 0.0F);
        this.setRotateAngle(legL15, -0.279F, -0.012F, 0.5253F);
        this.setRotateAngle(legL16, -0.4538F, 0.0F, -0.5672F);
        this.setRotateAngle(jawR, -0.8727F, 0.0F, 1.0472F);
        this.setRotateAngle(jawR2, 2.0944F, 0.5672F, 0.0F);
        this.setRotateAngle(jawR3, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(jawR4, -0.2316F, -0.2368F, 0.1128F);
        this.setRotateAngle(jawR5, 0.0005F, 0.0865F, 0.0114F);
        this.setRotateAngle(jawL, 0.0478F, 0.2148F, 0.0385F);
        this.setRotateAngle(jawL2, 0.1772F, 0.1719F, 0.0306F);
        this.setRotateAngle(jawL3, 0.218F, 0.001F, -0.0094F);
        this.setRotateAngle(jawL4, -0.1752F, -0.0859F, 0.0152F);
        this.setRotateAngle(jawL5, -0.0894F, 0.2173F, -0.0193F);
