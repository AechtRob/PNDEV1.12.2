...
public class ModelHangingfly extends ModelBasePalaeopedia {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraHangingfly ee = (EntityPrehistoricFloraHangingfly) entitylivingbaseIn;
    ...
    public void animFlying(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraHangingfly entity = (EntityPrehistoricFloraHangingfly) entitylivingbaseIn;
        int animCycle = 38;
