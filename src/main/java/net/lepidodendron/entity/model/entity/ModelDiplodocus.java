...
public class ModelDiplodocus extends AdvancedModelBaseExtended {
    ...
    public void renderStaticBook(float f) {
        ...
        this.setRotateAngle(neck2, -0.25F, -0.01F, -0.01F);
        this.setRotateAngle(neck3, -0.25F, -0.05F, -0.05F);
        this.setRotateAngle(neck4, 0.05F, -0.15F, -0.15F);
        this.setRotateAngle(neck5, 0.35F, -0.2F, -0.2F);
        this.setRotateAngle(neck6, 0.7F, -0.2F, -0.2F);
        this.setRotateAngle(head, 0.6F, -0.3F, -0.2F);
        this.setRotateAngle(tail1, -0.15F, 0.15F, 0.1F);
        this.setRotateAngle(tail2, 0.2F, 0.15F, 0.1F);
        this.setRotateAngle(tail3, 0.3F, 0.25F, 0.1F);
        this.setRotateAngle(tail4, 0.15F, 0.35F, 0.0F);
        this.setRotateAngle(tail5, 0.0F, 0.45F, 0.0F);
        this.setRotateAngle(tail6, 0.0F, 0.45F, 0.0F);
        this.setRotateAngle(tail7, 0.0F, 0.45F, 0.0F);
        this.setRotateAngle(tail8, -0.01F, 0.4F, 0.0F);
        this.setRotateAngle(tail9, 0.0F, 0.5F, 0.0F);
        this.setRotateAngle(tail10, 0.0F, 0.5F, 0.0F);
        this.setRotateAngle(tail11, 0.0F, 0.3F, 0.0F);
        this.setRotateAngle(tail12, 0.0F, 0.3F, 0.0F);
        this.setRotateAngle(leftArm, 0.7F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm2, -0.5F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm3, 0.3F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm, 0.4F, 0.0F, 0.0F);
