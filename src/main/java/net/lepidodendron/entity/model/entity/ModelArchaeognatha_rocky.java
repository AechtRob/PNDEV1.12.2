...
public class ModelArchaeognatha_rocky extends ModelBasePalaeopedia {
    ...
    public ModelArchaeognatha_rocky() {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraArchaeognatha_rocky ee = (EntityPrehistoricFloraArchaeognatha_rocky) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraArchaeognatha_rocky ee = (EntityPrehistoricFloraArchaeognatha_rocky) entitylivingbaseIn;
    ...
    public void animJump(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraArchaeognatha_rocky entity = (EntityPrehistoricFloraArchaeognatha_rocky) entitylivingbaseIn;
        int animCycle = 15;
