...
public class ModelShirerpeton extends ModelBasePalaeopedia {
    ...
    public ModelShirerpeton() {
        this.textureWidth = 40;
        this.textureHeight = 40;

        this.root = new AdvancedModelRenderer(this);
        this.root.setRotationPoint(0.0F, 21.45F, 1.95F);
        this.root.cubeList.add(new ModelBox(root, 20, 15, -1.0F, 1.05F, -0.95F, 2, 1, 3, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(0.0F, 1.7F, 0.05F);
        this.root.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.0873F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 11, -1.0F, -2.0F, -1.0F, 2, 2, 3, -0.01F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 0.3F, 0.05F);
        ...
        this.chest.cubeList.add(new ModelBox(chest, 0, 21, -0.5F, 0.5F, -2.5F, 1, 1, 3, 0.0F, false));
        this.chest.cubeList.add(new ModelBox(chest, 20, 19, -1.35F, -0.5F, -2.525F, 1, 2, 3, -0.01F, false));
        this.chest.cubeList.add(new ModelBox(chest, 20, 19, 0.35F, -0.5F, -2.525F, 1, 2, 3, -0.01F, true));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(-0.5F, 0.15F, -0.5F);
        this.chest.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0873F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 24, 24, 0.0F, -1.0F, -2.0F, 1, 1, 3, 0.0F, false));
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 8, 25, 0.84F, -1.0F, -2.0F, 1, 1, 3, -0.01F, true));
        ...
        this.rightArm.cubeList.add(new ModelBox(rightArm, 8, 29, -1.75F, -0.5F, -0.5F, 2, 1, 1, 0.01F, false));

        this.rightArm2 = new AdvancedModelRenderer(this);
        this.rightArm2.setRotationPoint(-1.75F, 0.0F, 0.0F);
        this.rightArm.addChild(rightArm2);
        this.setRotateAngle(rightArm2, 0.1309F, -0.7418F, -0.48F);
        this.rightArm2.cubeList.add(new ModelBox(rightArm2, 24, 30, -0.725F, -0.5F, -0.5F, 1, 1, 1, 0.0F, false));
        this.rightArm2.cubeList.add(new ModelBox(rightArm2, 28, 30, -1.05F, -0.5F, -0.5F, 1, 1, 1, -0.01F, false));

        this.rightArm3 = new AdvancedModelRenderer(this);
        this.rightArm3.setRotationPoint(-0.95F, -0.25F, 0.0F);
        this.rightArm2.addChild(rightArm3);
        this.setRotateAngle(rightArm3, 0.4974F, -0.9163F, 0.4102F);
        this.rightArm3.cubeList.add(new ModelBox(rightArm3, 14, 5, -0.925F, 0.0F, -0.5F, 1, 0, 1, 0.0F, false));

        this.leftArm = new AdvancedModelRenderer(this);
        this.leftArm.setRotationPoint(1.0F, 0.65F, -1.75F);
        this.chest.addChild(leftArm);
        this.setRotateAngle(leftArm, 0.0F, -0.6545F, 0.5236F);
        this.leftArm.cubeList.add(new ModelBox(leftArm, 8, 29, -0.25F, -0.5F, -0.5F, 2, 1, 1, 0.01F, true));

        this.leftArm2 = new AdvancedModelRenderer(this);
        this.leftArm2.setRotationPoint(1.75F, 0.0F, 0.0F);
        this.leftArm.addChild(leftArm2);
        this.setRotateAngle(leftArm2, 0.1309F, 0.7418F, 0.48F);
        this.leftArm2.cubeList.add(new ModelBox(leftArm2, 24, 30, -0.275F, -0.5F, -0.5F, 1, 1, 1, 0.0F, true));
        this.leftArm2.cubeList.add(new ModelBox(leftArm2, 28, 30, 0.05F, -0.5F, -0.5F, 1, 1, 1, -0.01F, true));

        this.leftArm3 = new AdvancedModelRenderer(this);
        this.leftArm3.setRotationPoint(0.95F, -0.25F, 0.0F);
        this.leftArm2.addChild(leftArm3);
        this.setRotateAngle(leftArm3, 0.4974F, 0.9163F, -0.4102F);
        this.leftArm3.cubeList.add(new ModelBox(leftArm3, 14, 5, -0.075F, 0.0F, -0.5F, 1, 0, 1, 0.0F, true));

        this.neck = new AdvancedModelRenderer(this);
        this.neck.setRotationPoint(0.0F, -0.15F, -2.475F);
        this.chest.addChild(neck);
        this.setRotateAngle(neck, -0.1745F, 0.0F, 0.0F);
        this.neck.cubeList.add(new ModelBox(neck, 24, 0, -1.0F, -0.625F, -1.275F, 2, 2, 2, 0.0F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 0.15F, -0.55F);
        this.neck.addChild(head);
        this.setRotateAngle(head, 0.1745F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 8, 21, -0.5F, -0.51F, -2.975F, 1, 1, 3, 0.0F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(0.5F, 0.5F, -2.975F);
        this.head.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.6545F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 30, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(1.075F, 0.5F, -2.15F);
        this.head.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 0.1309F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 4, 30, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.01F, true));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(1.175F, 0.5F, -1.15F);
        this.head.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, -0.3054F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 30, 4, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-1.075F, 0.5F, -2.15F);
        this.head.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, -0.1309F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 4, 30, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.01F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(-0.5F, 0.5F, -2.975F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, -0.6545F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 30, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.25F, -0.825F, -2.025F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0436F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 28, 21, -0.5F, 0.0F, 0.0F, 1, 1, 2, 0.01F, true));
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 28, 21, -1.0F, 0.0F, 0.0F, 1, 1, 2, 0.01F, false));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.0F, -0.5F, -2.975F);
        this.head.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.3272F, 0.0F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 30, 6, -0.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-1.175F, 0.5F, -1.15F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, 0.3054F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 30, 4, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.eyeRight = new AdvancedModelRenderer(this);
        this.eyeRight.setRotationPoint(-0.075F, -0.675F, -1.725F);
        this.head.addChild(eyeRight);
        this.setRotateAngle(eyeRight, 0.0F, -0.1745F, 0.3054F);
        this.eyeRight.cubeList.add(new ModelBox(eyeRight, 30, 8, -1.0F, 0.0F, -0.5F, 1, 1, 1, 0.0F, false));

        this.eyeLeft = new AdvancedModelRenderer(this);
        this.eyeLeft.setRotationPoint(0.075F, -0.675F, -1.725F);
        this.head.addChild(eyeLeft);
        this.setRotateAngle(eyeLeft, 0.0F, 0.1745F, -0.3054F);
        this.eyeLeft.cubeList.add(new ModelBox(eyeLeft, 30, 8, 0.0F, 0.0F, -0.5F, 1, 1, 1, 0.0F, true));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(0.0F, 0.35F, -0.55F);
        this.head.addChild(jaw);
        this.setRotateAngle(jaw, -0.0873F, 0.0F, 0.0F);


        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(0.5F, 0.75F, -2.325F);
        this.jaw.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, 0.5323F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 30, 12, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(1.125F, 0.75F, -0.5F);
        this.jaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0F, -0.3054F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 30, 10, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, true));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(1.0F, 0.75F, -1.5F);
        this.jaw.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.0F, 0.1134F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 16, 21, -1.0F, -1.0F, 0.0F, 1, 1, 1, 0.01F, true));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(-1.0F, 0.75F, -1.5F);
        this.jaw.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.0F, -0.1134F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 16, 21, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.01F, false));

        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(-1.125F, 0.75F, -0.5F);
        this.jaw.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.0F, 0.3054F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 30, 10, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(-0.5F, 0.75F, -2.325F);
        this.jaw.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 0.0F, -0.5323F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 30, 12, 0.0F, -1.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(0.0F, 0.75F, -2.325F);
        this.jaw.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.0044F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 16, 24, -0.5F, -0.99F, 0.0F, 1, 1, 3, 0.0F, false));

        this.rightLeg = new AdvancedModelRenderer(this);
        this.rightLeg.setRotationPoint(-1.0F, 1.2F, 1.3F);
        this.root.addChild(rightLeg);
        this.setRotateAngle(rightLeg, 0.0F, -0.5236F, -0.2618F);
        this.rightLeg.cubeList.add(new ModelBox(rightLeg, 24, 28, -1.25F, -0.5F, -0.5F, 2, 1, 1, 0.01F, false));

        this.rightLeg2 = new AdvancedModelRenderer(this);
        this.rightLeg2.setRotationPoint(-1.25F, -0.5F, 0.0F);
        this.rightLeg.addChild(rightLeg2);
        this.setRotateAngle(rightLeg2, 0.0F, 0.0F, -0.9599F);
        this.rightLeg2.cubeList.add(new ModelBox(rightLeg2, 30, 14, -1.025F, 0.0F, -0.5F, 1, 1, 1, 0.0F, false));
        this.rightLeg2.cubeList.add(new ModelBox(rightLeg2, 30, 16, -1.525F, 0.0F, -0.5F, 1, 1, 1, -0.01F, false));
        ...
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 28, 19, -1.0F, 0.0F, -1.0F, 2, 0, 2, 0.0F, false));

        this.leftLeg = new AdvancedModelRenderer(this);
        this.leftLeg.setRotationPoint(1.0F, 1.2F, 1.3F);
        this.root.addChild(leftLeg);
        this.setRotateAngle(leftLeg, 0.0F, 0.5236F, 0.2618F);
        this.leftLeg.cubeList.add(new ModelBox(leftLeg, 24, 28, -0.75F, -0.5F, -0.5F, 2, 1, 1, 0.01F, true));

        this.leftLeg2 = new AdvancedModelRenderer(this);
        this.leftLeg2.setRotationPoint(1.25F, -0.5F, 0.0F);
        this.leftLeg.addChild(leftLeg2);
        this.setRotateAngle(leftLeg2, 0.0F, 0.0F, 0.9599F);
        this.leftLeg2.cubeList.add(new ModelBox(leftLeg2, 30, 14, 0.025F, 0.0F, -0.5F, 1, 1, 1, 0.0F, true));
        this.leftLeg2.cubeList.add(new ModelBox(leftLeg2, 30, 16, 0.525F, 0.0F, -0.5F, 1, 1, 1, -0.01F, true));
        ...
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 28, 19, -1.0F, 0.0F, -1.0F, 2, 0, 2, 0.0F, true));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(0.0F, 0.3F, 2.15F);
        this.root.addChild(tail);
        this.setRotateAngle(tail, -0.2182F, 0.0F, 0.0F);
        this.tail.cubeList.add(new ModelBox(tail, 20, 10, -0.75F, -0.24F, -0.6F, 1, 1, 4, 0.0F, false));
        this.tail.cubeList.add(new ModelBox(tail, 20, 5, -0.75F, 0.41F, -0.6F, 1, 1, 4, 0.01F, false));
        this.tail.cubeList.add(new ModelBox(tail, 20, 10, -0.25F, -0.24F, -0.6F, 1, 1, 4, 0.0F, true));
        this.tail.cubeList.add(new ModelBox(tail, 20, 5, -0.25F, 0.41F, -0.6F, 1, 1, 4, 0.01F, true));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.25F, 3.4F);
        this.tail.addChild(tail2);
        this.setRotateAngle(tail2, 0.0611F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 0, 16, -0.5F, -0.35F, -0.75F, 1, 1, 4, -0.02F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 10, 16, -0.5F, -0.1F, -0.75F, 1, 1, 4, -0.01F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, 0.125F, 3.175F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, 0.1309F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 16, 28, -0.5F, -0.4F, -0.175F, 1, 1, 3, 0.0F, false));
    ...
    public void renderStaticWall(float f) {
        ...
        this.setRotateAngle(neck, -0.152F, -0.2964F, 0.0539F);
        this.setRotateAngle(head, 0F, 0.0F, 0.0F);
        this.neck.offsetY = -0F;
        this.neck.offsetX = -0F;
        this.neck.offsetZ = -0.203F;
        this.neck.render(0.01F);
        resetToDefaultPose();
    }
    public void renderStaticFloor(float f) {
        this.setRotateAngle(tail3, 0.1401F, -0.3632F, -0.0501F);
        this.setRotateAngle(tail2, 0.0632F, -0.2613F, -0.0164F);
        this.setRotateAngle(tail, -0.2317F, -0.3405F, 0.0786F);
        this.setRotateAngle(root, 0.0F, -0.2705F, 0.0F);
        this.setRotateAngle(rightLeg3, 0.0873F, 0.0F, 1.1345F);
        this.setRotateAngle(rightLeg2, 0.0F, 0.0F, -0.9599F);
        this.setRotateAngle(rightLeg, 0.0F, -0.5236F, -0.2618F);
        this.setRotateAngle(rightArm3, 0.4974F, -0.9163F, 0.4102F);
        ...
        this.setRotateAngle(leftLeg3, 0.0873F, 0.0F, -1.1345F);
        this.setRotateAngle(leftLeg2, 0.0F, 0.0F, 0.9599F);
        this.setRotateAngle(leftLeg, 0.007F, -0.122F, 0.2047F);
        this.setRotateAngle(leftArm3, 0.7612F, 0.8031F, -0.1551F);
        this.setRotateAngle(leftArm2, 0.1309F, 0.7418F, 0.48F);
        this.setRotateAngle(leftArm, 0.0F, 0.0175F, 0.5236F);
        ...
        this.setRotateAngle(cube_r3, 0.0F, 0.6545F, 0.0F);
        this.setRotateAngle(cube_r2, 0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r19, -0.0567F, 0.6413F, -0.0218F);
        this.setRotateAngle(cube_r18, 0.0F, -0.6981F, 0.0F);
        this.setRotateAngle(cube_r17, -0.0044F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r16, 0.0F, -0.5323F, 0.0F);
        this.setRotateAngle(cube_r15, 0.0F, 0.3054F, 0.0F);
        ...
        this.setRotateAngle(cube_r10, 0.0F, 0.3054F, 0.0F);
        this.setRotateAngle(cube_r1, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.0F, -0.1789F, 0.0F);
        this.setRotateAngle(body, 0.0F, -0.1178F, 0.0F);
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraShirerpeton ee = (EntityPrehistoricFloraShirerpeton) entitylivingbaseIn;
    ...
    public void animRun(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraShirerpeton entity = (EntityPrehistoricFloraShirerpeton) entitylivingbaseIn;
        int animCycle = 10;
        ...
        this.setRotateAngle(tail, tail.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*720/0.5))*-1.5), tail.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*720-150))*3), tail.rotateAngleZ + (float) Math.toRadians(0));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraShirerpeton e = (EntityPrehistoricFloraShirerpeton) entity;
