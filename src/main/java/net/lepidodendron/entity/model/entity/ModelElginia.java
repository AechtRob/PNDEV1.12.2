...
public class ModelElginia extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        this.elginia.offsetY = -0.7F;
        this.elginia.offsetX = 0.2F;
        this.elginia.offsetZ = 2.0F;
        this.elginia.rotateAngleY = (float)Math.toRadians(120);
        this.elginia.rotateAngleX = (float)Math.toRadians(1);
        this.elginia.rotateAngleZ = (float)Math.toRadians(0);
        this.elginia.scaleChildren = true;
        float scaler = 1.8F;
        this.elginia.setScale(scaler, scaler, scaler);
        //Start of pose:
        this.setRotateAngle(elginia, 0.2F, 3.8F, -0.0F);
        this.setRotateAngle(lowerbody, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(backrightleg, -0.4363F, 0.0F, 0.0F);
        this.setRotateAngle(backrightleg2, 0.8727F, 0.0F, 0.0F);
        this.setRotateAngle(backrightleg3, 0.3927F, 0.0F, 0.0F);
        ...
        this.elginia.render(f);
        //Reset rotations, positions and sizing:
        this.elginia.setScale(1.0F, 1.0F, 1.0F);
        this.elginia.scaleChildren = false;
        resetToDefaultPose();
