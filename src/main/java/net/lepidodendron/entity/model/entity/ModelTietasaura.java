...
public class ModelTietasaura extends ModelBasePalaeopedia {
    ...
    public ModelTietasaura() {
        ...
        this.main.cubeList.add(new ModelBox(main, 0, 17, -2.469F, 0.4783F, -0.561F, 5, 7, 8, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(-0.469F, -0.8865F, -6.8272F);
        this.main.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.1047F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 33, 45, -1.0F, -0.7317F, 6.9617F, 3, 4, 7, -0.001F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0833F, 1.6069F, 0.6459F);
        this.main.addChild(body);
        this.body.cubeList.add(new ModelBox(body, 0, 0, -3.5F, -1.4977F, -8.1036F, 7, 8, 8, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 47, 50, -1.5F, -2.5023F, -7.3964F, 3, 4, 7, 0.0F, false));

        this.chest = new AdvancedModelRenderer(this);
        this.chest.setRotationPoint(0.0F, -0.9741F, -7.6867F);
        this.body.addChild(chest);


        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(-0.5F, -1.5282F, 0.2903F);
        this.chest.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.3491F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 17, 39, -1.0F, 0.0F, -8.0F, 3, 4, 8, -0.001F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.5F, 1.208F, -7.2272F);
        this.chest.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.1658F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 23, 9, -2.0F, 0.0F, 0.0F, 5, 5, 8, 0.0F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-0.5F, 1.208F, -7.2272F);
        this.chest.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.2182F, 0.0F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 33, -2.0F, 0.0F, 0.0F, 5, 4, 7, -0.002F, false));

        this.leftarm1 = new AdvancedModelRenderer(this);
        this.leftarm1.setRotationPoint(2.25F, 5.7265F, -6.9168F);
        this.chest.addChild(leftarm1);
        this.setRotateAngle(leftarm1, 0.0F, 0.3927F, 0.0F);


        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(-0.1913F, -0.5959F, 0.2593F);
        this.leftarm1.addChild(cube_r5);
        this.setRotateAngle(cube_r5, -0.5236F, 0.0F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 43, 23, -1.0F, -0.75F, -0.25F, 2, 2, 6, 0.0F, false));

        this.leftarm2 = new AdvancedModelRenderer(this);
        this.leftarm2.setRotationPoint(-0.6913F, 2.7217F, 4.1933F);
        this.leftarm1.addChild(leftarm2);
        this.setRotateAngle(leftarm2, 0.1745F, 0.0F, 0.0F);


        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(0.0F, 0.1021F, -0.6404F);
        this.leftarm2.addChild(cube_r6);
        this.setRotateAngle(cube_r6, -0.5236F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 0, 0.0F, -1.4F, -0.5F, 1, 4, 2, 0.0F, false));

        this.leftarm3 = new AdvancedModelRenderer(this);
        this.leftarm3.setRotationPoint(0.0F, 2.6178F, -1.4902F);
        this.leftarm2.addChild(leftarm3);


        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(1.0F, 1.4681F, -1.4503F);
        this.leftarm3.addChild(cube_r7);
        this.setRotateAngle(cube_r7, -0.49F, 0.1925F, 0.3444F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 33, -1.0F, 0.0F, -0.5F, 1, 1, 2, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.0F, 0.0824F, -0.6503F);
        this.leftarm3.addChild(cube_r8);
        this.setRotateAngle(cube_r8, -0.5236F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 0, 17, 0.0F, -0.4F, -0.5F, 1, 2, 2, 0.0F, false));

        this.rightarm1 = new AdvancedModelRenderer(this);
        this.rightarm1.setRotationPoint(-2.25F, 5.7265F, -6.9168F);
        this.chest.addChild(rightarm1);
        this.setRotateAngle(rightarm1, 0.0F, -0.3927F, 0.0F);


        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.1913F, -0.5959F, 0.2593F);
        this.rightarm1.addChild(cube_r9);
        this.setRotateAngle(cube_r9, -0.5236F, 0.0F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 43, 23, -1.0F, -0.75F, -0.25F, 2, 2, 6, 0.0F, true));

        this.rightarm2 = new AdvancedModelRenderer(this);
        this.rightarm2.setRotationPoint(0.6913F, 2.7217F, 4.1933F);
        this.rightarm1.addChild(rightarm2);
        this.setRotateAngle(rightarm2, 0.1745F, 0.0F, 0.0F);


        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(0.0F, 0.1021F, -0.6404F);
        this.rightarm2.addChild(cube_r10);
        this.setRotateAngle(cube_r10, -0.5236F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 0, -1.0F, -1.4F, -0.5F, 1, 4, 2, 0.0F, true));

        this.rightarm3 = new AdvancedModelRenderer(this);
        this.rightarm3.setRotationPoint(0.0F, 2.6178F, -1.4902F);
        this.rightarm2.addChild(rightarm3);


        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(-1.0F, 1.4681F, -1.4503F);
        this.rightarm3.addChild(cube_r11);
        this.setRotateAngle(cube_r11, -0.49F, -0.1925F, -0.3444F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 33, 0.0F, 0.0F, -0.5F, 1, 1, 2, 0.0F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(0.0F, 0.0824F, -0.6503F);
        this.rightarm3.addChild(cube_r12);
        this.setRotateAngle(cube_r12, -0.5236F, 0.0F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 17, -1.0F, -0.4F, -0.5F, 1, 2, 2, 0.0F, true));

        this.neck = new AdvancedModelRenderer(this);
        this.neck.setRotationPoint(0.0F, 3.5F, -7.25F);
        this.chest.addChild(neck);


        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, 1.4765F, -1.9168F);
        this.neck.addChild(cube_r13);
        this.setRotateAngle(cube_r13, -0.2182F, 0.0F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 54, 18, -1.5F, -4.0F, -2.0F, 3, 4, 4, 0.01F, false));
        ...
        this.cube_r14.setRotationPoint(1.0F, -3.7427F, -2.9031F);
        this.neck2.addChild(cube_r14);
        this.setRotateAngle(cube_r14, -0.5672F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 33, 57, -2.0F, 0.0F, 0.0F, 2, 3, 6, 0.0F, false));

        this.neck3 = new AdvancedModelRenderer(this);
        this.neck3.setRotationPoint(0.0F, -3.4347F, -3.0928F);
        this.neck2.addChild(neck3);


        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(1.0F, -0.65F, -0.75F);
        this.neck3.addChild(cube_r15);
        this.setRotateAngle(cube_r15, -0.3491F, 0.0F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 23, 0, -2.0F, 0.0F, -1.0F, 2, 3, 2, -0.002F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.5F, -0.8F, -1.55F);
        this.neck3.addChild(head);
        this.setRotateAngle(head, 0.0F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 50, 14, -1.5F, 0.6798F, -4.4914F, 2, 1, 2, -0.002F, false));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(-0.5F, -0.192F, -0.1397F);
        this.head.addChild(cube_r16);
        this.setRotateAngle(cube_r16, -0.0436F, 0.0F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 38, 23, -1.0F, 0.0F, -3.0F, 2, 2, 3, 0.0F, false));
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 61, 51, -0.75F, 0.0F, -3.0F, 2, 2, 3, -0.002F, false));
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 61, 51, -1.25F, 0.0F, -3.0F, 2, 2, 3, -0.002F, true));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(-0.5F, 1.6938F, -2.475F);
        this.head.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.3491F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 26, 55, -1.0F, -1.0F, 0.0F, 2, 1, 2, 0.0F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(-0.5F, 1.6938F, -2.45F);
        this.head.addChild(cube_r18);
        this.setRotateAngle(cube_r18, -0.3491F, 0.0F, 0.0F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 42, 12, -0.75F, -1.0F, 0.0F, 2, 1, 2, -0.004F, false));
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 42, 12, -1.25F, -1.0F, 0.0F, 2, 1, 2, -0.004F, true));

        this.cube_r19 = new AdvancedModelRenderer(this);
        this.cube_r19.setRotationPoint(-0.5F, -0.2793F, -3.1378F);
        this.head.addChild(cube_r19);
        this.setRotateAngle(cube_r19, 0.48F, 0.0F, 0.0F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 57, 0, -1.0F, 0.0F, -2.0F, 2, 1, 2, -0.004F, false));

        this.cube_r20 = new AdvancedModelRenderer(this);
        this.cube_r20.setRotationPoint(-0.5F, 0.4861F, -3.9855F);
        this.head.addChild(cube_r20);
        this.setRotateAngle(cube_r20, 0.9599F, 0.0F, 0.0F);
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 0, 22, -0.5F, -0.6512F, -1.6391F, 1, 1, 1, -0.003F, false));

        this.cube_r21 = new AdvancedModelRenderer(this);
        this.cube_r21.setRotationPoint(-0.5F, -0.1642F, 0.9486F);
        this.head.addChild(cube_r21);
        this.setRotateAngle(cube_r21, 0.0436F, 0.0F, 0.0F);
        this.cube_r21.cubeList.add(new ModelBox(cube_r21, 19, 21, 0.775F, 0.925F, -4.35F, 0, 1, 2, 0.0F, false));
        this.cube_r21.cubeList.add(new ModelBox(cube_r21, 19, 21, -0.775F, 0.925F, -4.35F, 0, 1, 2, 0.0F, true));

        this.eye = new AdvancedModelRenderer(this);
        this.eye.setRotationPoint(0.5F, 0.6356F, -1.7745F);
        this.head.addChild(eye);


        this.cube_r22 = new AdvancedModelRenderer(this);
        this.cube_r22.setRotationPoint(-1.0F, 0.0F, 0.0F);
        this.eye.addChild(cube_r22);
        this.setRotateAngle(cube_r22, 0.0F, 0.0F, 0.0F);
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 37, 29, -1.275F, -0.425F, -0.875F, 1, 1, 1, 0.0F, true));
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 37, 29, 0.275F, -0.425F, -0.875F, 1, 1, 1, 0.0F, false));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(-0.5F, 1.9097F, -1.033F);
        this.head.addChild(jaw);
        this.jaw.cubeList.add(new ModelBox(jaw, 30, 3, -1.0F, -0.3F, -3.45F, 2, 1, 4, -0.01F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 45, 0.75F, -0.55F, -2.075F, 0, 1, 2, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 45, -0.75F, -0.55F, -2.075F, 0, 1, 2, 0.0F, true));

        this.cube_r23 = new AdvancedModelRenderer(this);
        this.cube_r23.setRotationPoint(-0.075F, 0.7F, 1.0F);
        this.jaw.addChild(cube_r23);
        this.setRotateAngle(cube_r23, 0.0F, 0.0F, 0.0F);
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 48, 43, 1.025F, -2.275F, -3.1F, 0, 2, 2, 0.0F, true));
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 48, 43, -0.875F, -2.275F, -3.1F, 0, 2, 2, 0.0F, true));
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 32, 37, -0.9F, -2.275F, -3.1F, 0, 2, 2, 0.0F, true));
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 32, 37, 1.05F, -2.275F, -3.1F, 0, 2, 2, 0.0F, false));

        this.cube_r24 = new AdvancedModelRenderer(this);
        this.cube_r24.setRotationPoint(0.0F, 0.675F, -3.4F);
        this.jaw.addChild(cube_r24);
        this.setRotateAngle(cube_r24, -0.5672F, 0.0F, 0.0F);
        this.cube_r24.cubeList.add(new ModelBox(cube_r24, 1, 37, -0.5F, -0.9797F, -0.971F, 1, 1, 1, -0.011F, false));

        this.leftleg1 = new AdvancedModelRenderer(this);
        this.leftleg1.setRotationPoint(2.031F, 1.9182F, 0.3156F);
        this.main.addChild(leftleg1);


        this.cube_r25 = new AdvancedModelRenderer(this);
        this.cube_r25.setRotationPoint(0.0F, 2.0296F, -1.3941F);
        this.leftleg1.addChild(cube_r25);
        this.setRotateAngle(cube_r25, -1.8326F, 0.0F, 0.0F);
        this.cube_r25.cubeList.add(new ModelBox(cube_r25, 19, 25, -1.0F, -4.25F, -3.25F, 4, 5, 8, 0.0F, false));

        this.leftleg2 = new AdvancedModelRenderer(this);
        this.leftleg2.setRotationPoint(0.5F, 6.8519F, -1.4571F);
        this.leftleg1.addChild(leftleg2);


        this.cube_r26 = new AdvancedModelRenderer(this);
        this.cube_r26.setRotationPoint(-0.5F, -0.1783F, 0.1091F);
        this.leftleg2.addChild(cube_r26);
        this.setRotateAngle(cube_r26, -1.0036F, 0.0F, 0.0F);
        this.cube_r26.cubeList.add(new ModelBox(cube_r26, 42, 0, -0.5F, -1.4475F, -1.2854F, 3, 3, 8, 0.0F, false));
        ...
        this.leftleg3.addChild(cube_r27);
        this.setRotateAngle(cube_r27, -1.5708F, 0.0F, 0.0F);
        this.cube_r27.cubeList.add(new ModelBox(cube_r27, 59, 6, -0.5F, -1.0F, 0.0F, 2, 2, 6, 0.0F, false));
        ...
        this.leftleg4.addChild(cube_r28);
        this.setRotateAngle(cube_r28, -1.5708F, 0.0F, 0.0F);
        this.cube_r28.cubeList.add(new ModelBox(cube_r28, 39, 0, -1.0F, 0.0F, -0.5F, 3, 4, 1, 0.0F, false));

        this.rightleg1 = new AdvancedModelRenderer(this);
        this.rightleg1.setRotationPoint(-1.969F, 1.9182F, 0.3156F);
        this.main.addChild(rightleg1);


        this.cube_r29 = new AdvancedModelRenderer(this);
        this.cube_r29.setRotationPoint(0.0F, 2.0296F, -1.3941F);
        this.rightleg1.addChild(cube_r29);
        this.setRotateAngle(cube_r29, -1.8326F, 0.0F, 0.0F);
        this.cube_r29.cubeList.add(new ModelBox(cube_r29, 19, 25, -3.0F, -4.25F, -3.25F, 4, 5, 8, 0.0F, true));

        this.rightleg2 = new AdvancedModelRenderer(this);
        this.rightleg2.setRotationPoint(-0.5F, 6.8519F, -1.4571F);
        ...
        this.cube_r30.cubeList.add(new ModelBox(cube_r30, 42, 0, -2.5F, -1.4475F, -1.2854F, 3, 3, 8, 0.0F, true));
        ...
        this.cube_r31.cubeList.add(new ModelBox(cube_r31, 59, 6, -1.5F, -1.0F, 0.0F, 2, 2, 6, 0.0F, true));
        ...
        this.rightleg4.addChild(cube_r32);
        this.setRotateAngle(cube_r32, -1.5708F, 0.0F, 0.0F);
        this.cube_r32.cubeList.add(new ModelBox(cube_r32, 39, 0, -2.0F, 0.0F, -0.5F, 3, 4, 1, 0.0F, true));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(0.031F, 1.7231F, 7.0167F);
        ...
        this.cube_r33.cubeList.add(new ModelBox(cube_r33, 14, 52, -0.5F, -6.0884F, 12.1353F, 2, 4, 7, 0.0F, false));

        this.cube_r34 = new AdvancedModelRenderer(this);
        this.cube_r34.setRotationPoint(0.0F, -0.9537F, 0.3007F);
        this.tail.addChild(cube_r34);
        this.setRotateAngle(cube_r34, -0.3927F, 0.0F, 0.0F);
        this.cube_r34.cubeList.add(new ModelBox(cube_r34, 37, 32, -2.0F, 0.0F, 0.0F, 4, 5, 7, 0.0F, false));
        ...
        this.cube_r35.setRotationPoint(0.0F, -1.4935F, -0.6191F);
        this.tail2.addChild(cube_r35);
        this.setRotateAngle(cube_r35, -0.48F, 0.0F, 0.0F);
        this.cube_r35.cubeList.add(new ModelBox(cube_r35, 0, 45, -1.5F, 0.0F, 1.0F, 3, 4, 7, 0.0F, false));
        ...
        this.cube_r36.cubeList.add(new ModelBox(cube_r36, 53, 27, -1.0F, 0.0F, 3.0F, 2, 3, 7, 0.0F, false));
        ...
        this.cube_r37.cubeList.add(new ModelBox(cube_r37, 0, 57, -1.0F, 0.0F, 0.0F, 2, 2, 7, -0.002F, false));
        ...
        this.cube_r38.cubeList.add(new ModelBox(cube_r38, 53, 38, -0.5F, 0.0F, -0.25F, 1, 1, 7, 0.0F, false));
    ...
    public void renderStaticWall(float f) {resetToDefaultPose();}
    public void renderStaticFloor(float f) {resetToDefaultPose();}
    ...
    public void renderStaticBook(float f) {
        ...
        this.setRotateAngle(rightarm1, 0.2F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg1, -0.4F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg2, 0.7F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg3, -0.1F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraTietasaura entityTietasaura = (EntityPrehistoricFloraTietasaura) e;
        ...
        entityTietasaura.tailBuffer.applyChainSwingBuffer(Tail);

        if (entityTietasaura.getAnimation() == entityTietasaura.LAY_ANIMATION) {
            this.chainSwing(Neck, 0.5F, 0.10F, 0.5, f2, 0.8F);
            this.chainWave(Neck, 0.5F * 2, -0.02F, 0.5F, f2, 0.8F);
        } else {
            if (!entityTietasaura.isReallyInWater()) {

                if (f3 == 0.0F || !entityTietasaura.getIsMoving()) {
                    if (entityTietasaura.getAnimation() != entityTietasaura.EAT_ANIMATION
                            && entityTietasaura.getAnimation() != entityTietasaura.DRINK_ANIMATION) {
                ...
                if (entityTietasaura.getIsFast()) { //Running
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraTietasaura ee = (EntityPrehistoricFloraTietasaura) entitylivingbaseIn;
    ...
    public void animGraze(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraTietasaura entity = (EntityPrehistoricFloraTietasaura) entitylivingbaseIn;
        int animCycle = 175;
    ...
    public void animRunning(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 1) {
            ...
            zz = 0.175 + (((tickAnim - 6) / 2) * (-0.36-(0.175)));
        }
        else if (tickAnim >= 8 && tickAnim < 12) {
            xx = 0 + (((tickAnim - 8) / 4) * (0-(0)));
            yy = 1.115 + (((tickAnim - 8) / 4) * (0.84-(1.115)));
            zz = -0.36 + (((tickAnim - 8) / 4) * (-0.145-(-0.36)));
        }
        else if (tickAnim >= 12 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 12) / 1) * (0-(0)));
            yy = 0.84 + (((tickAnim - 12) / 1) * (0.05-(0.84)));
            zz = -0.145 + (((tickAnim - 12) / 1) * (0.75-(-0.145)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 4) {
            ...
            zz = -0.3 + (((tickAnim - 0) / 4) * (-0.285-(-0.3)));
        }
        else if (tickAnim >= 4 && tickAnim < 6) {
            xx = 0 + (((tickAnim - 4) / 2) * (0-(0)));
            yy = 0.86 + (((tickAnim - 4) / 2) * (0.05-(0.86)));
            zz = -0.285 + (((tickAnim - 4) / 2) * (0.75-(-0.285)));
        }
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            xx = 17.45 + (((tickAnim - 6) / 10) * (90.25-(17.45)));
        ...
        if (tickAnim >= 0 && tickAnim < 6) {
            ...
            yy = 0.6 + (((tickAnim - 6) / 10) * (0.525-(0.6)));
            zz = 0.6 + (((tickAnim - 6) / 10) * (0.275-(0.6)));
        }
        else if (tickAnim >= 16 && tickAnim < 23) {
            xx = 0 + (((tickAnim - 16) / 7) * (0-(0)));
            yy = 0.525 + (((tickAnim - 16) / 7) * (0.46-(0.525)));
            zz = 0.275 + (((tickAnim - 16) / 7) * (-0.105-(0.275)));
        }
        else if (tickAnim >= 23 && tickAnim < 25) {
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            xx = 40 + (((tickAnim - 14) / 7) * (5.12-(40)));
            yy = 0 + (((tickAnim - 14) / 7) * (0-(0)));
            zz = 0 + (((tickAnim - 14) / 7) * (0-(0)));
        }
        else if (tickAnim >= 21 && tickAnim < 25) {
            xx = 5.12 + (((tickAnim - 21) / 4) * (19.25-(5.12)));
        ...
        if (tickAnim >= 0 && tickAnim < 5) {
            ...
            yy = 0.525 + (((tickAnim - 5) / 3) * (0.72-(0.525)));
            zz = -0.3 + (((tickAnim - 5) / 3) * (-0.27-(-0.3)));
        }
        else if (tickAnim >= 8 && tickAnim < 11) {
            xx = 0 + (((tickAnim - 8) / 3) * (0-(0)));
            yy = 0.72 + (((tickAnim - 8) / 3) * (0.86-(0.72)));
            zz = -0.27 + (((tickAnim - 8) / 3) * (-0.18-(-0.27)));
        }
        else if (tickAnim >= 11 && tickAnim < 14) {
            xx = 0 + (((tickAnim - 11) / 3) * (0-(0)));
            yy = 0.86 + (((tickAnim - 11) / 3) * (-0.25-(0.86)));
            zz = -0.18 + (((tickAnim - 11) / 3) * (0.75-(-0.18)));
        }
        ...
        EntityPrehistoricFloraTietasaura e = (EntityPrehistoricFloraTietasaura) entity;
