...
public class ModelPoraspis extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(body3, -0.1F, 0.1F, 0.00F);
        this.setRotateAngle(body4, -0.1F, 0.1F, 0.00F);
