...
public class ModelIchthyovenator extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        this.setRotateAngle(body, 0.1876F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r1, -0.6981F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r10, 0.2182F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r11, -0.0436F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(cube_r8, -0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, 0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(head, -0.0131F, 0.0F, 0.0F);
        this.setRotateAngle(hips, -0.288F, 0.0F, 0.0F);
        this.setRotateAngle(jaw, -0.0044F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm1, 1.0288F, 0.3864F, -0.0718F);
        this.setRotateAngle(leftArm2, -1.0825F, 0.1778F, 0.0937F);
        this.setRotateAngle(leftFingers, 0.0F, 0.0F, 0.7374F);
        this.setRotateAngle(leftFoot, 0.24F, 0.0F, 0.0F);
        this.setRotateAngle(leftHand, 0.0F, 0.0F, 0.6021F);
        this.setRotateAngle(leftJaw1, 0.0F, 0.0F, -0.0175F);
        this.setRotateAngle(leftLeg1, -0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg2, 1.8631F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg3, -1.6406F, 0.0F, 0.0F);
        this.setRotateAngle(leftMasseter, -0.4363F, 0.0F, 0.0F);
        this.setRotateAngle(leftThumb1, -0.48F, 0.0F, 0.1745F);
        this.setRotateAngle(leftThumb2, 0.0F, 0.0F, 0.48F);
        this.setRotateAngle(neck1, -0.4882F, -0.0536F, -0.0256F);
        this.setRotateAngle(neck2, -0.2791F, -0.0384F, -0.0072F);
        this.setRotateAngle(neck3, 0.3057F, -0.0416F, -0.0131F);
        this.setRotateAngle(neck4, 0.3882F, -0.0171F, 0.0072F);
        this.setRotateAngle(neck5, 0.349F, -0.022F, -0.0034F);
        this.setRotateAngle(rightArm1, 1.1248F, -0.3864F, 0.0718F);
        this.setRotateAngle(rightArm2, -1.0908F, 0.0F, 0.0F);
        this.setRotateAngle(rightFingers, 0.0F, 0.0F, -0.3491F);
        this.setRotateAngle(rightFoot, 1.597F, 0.0F, 0.0F);
        this.setRotateAngle(rightHand, 0.0F, 0.0F, -0.4102F);
        this.setRotateAngle(rightJaw1, 0.0F, 0.0F, 0.0175F);
        this.setRotateAngle(rightLeg1, -0.5411F, 0.0F, 0.0F);
        this.setRotateAngle(rightLeg2, 0.925F, 0.0F, 0.0F);
        this.setRotateAngle(rightLeg3, -1.7017F, 0.0F, 0.0F);
        this.setRotateAngle(rightMasseter, -0.4363F, 0.0F, 0.0F);
        this.setRotateAngle(rightThumb1, -0.48F, 0.0F, -0.1745F);
        this.setRotateAngle(rightThumb2, 0.0F, 0.0F, -0.48F);
        this.setRotateAngle(tail1, -0.2925F, -0.0292F, 0.0088F);
        this.setRotateAngle(tail2, 0.1135F, -0.0303F, -0.0035F);
        this.setRotateAngle(tail3, 0.1314F, 0.0865F, 0.0114F);
        this.setRotateAngle(tail4, 0.1488F, 0.0777F, 0.0116F);
        this.setRotateAngle(tail5, 0.1359F, 0.0951F, 0.013F);
        this.setRotateAngle(tail6, -0.0898F, 0.0514F, 0.0348F);
        this.setRotateAngle(throat, -0.1512F, 0.0031F, 0.07F);
        this.setRotateAngle(throat2, 0.167F, 0.0728F, -0.0525F);
