...
public class ModelLusovenator extends ModelBasePalaeopedia {
    ...
    public void renderStaticWall(float f) {
        this.setRotateAngle(throatpouch, -0.8727F, 0.0F, 0.0F);
        this.setRotateAngle(throat2, -0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(throat, -0.6109F, 0.0F, 0.0F);
        this.setRotateAngle(tail6, -0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(tail5, -0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(tail4, -0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(tail3, -0.0873F, 0.0F, 0.0F);
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(throat2, -0.3491F, 0.0F, 0.0F);
        this.setRotateAngle(throat, -0.3914F, 0.0334F, 0.0807F);
        this.setRotateAngle(tail6, -0.3503F, 0.082F, -0.0299F);
        this.setRotateAngle(tail5, -0.3079F, 0.1248F, -0.0396F);
        this.setRotateAngle(tail4, -0.132F, 0.1298F, -0.0172F);
        this.setRotateAngle(tail3, -0.0886F, -0.1739F, 0.0154F);
        this.setRotateAngle(tail2, 0.0438F, -0.0872F, -0.0038F);
        this.setRotateAngle(tail, 0.131F, -0.0433F, -0.0057F);
        ...
        this.setRotateAngle(rightarm2, -0.8727F, 0.0F, 0.0F);
        this.setRotateAngle(rightarm, 0.1252F, -0.1201F, 0.3258F);
        this.setRotateAngle(neck4, 0.3927F, 0.0F, 0.0F);
        this.setRotateAngle(neck3, 0.2618F, 0.0F, 0.0F);
        this.setRotateAngle(neck2, -0.1744F, -0.0076F, -0.043F);
        ...
        this.setRotateAngle(leftfoot, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(leftarm2, -0.8727F, 0.0F, 0.0F);
        this.setRotateAngle(leftarm, 0.1252F, 0.1201F, -0.3258F);
        this.setRotateAngle(JAWPART, -0.0436F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(HEADPART10, 0.7854F, 0.0F, 0.0F);
        this.setRotateAngle(HEADPART, 0.1833F, 0.0F, 0.0F);
        this.setRotateAngle(head, 0.0871F, 0.0057F, -0.0433F);
        this.setRotateAngle(cube_r9, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r8, 0.1309F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r7, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r6, -0.3054F, 0.0F, 0.0F);
