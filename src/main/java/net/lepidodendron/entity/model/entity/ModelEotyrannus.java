...
public class ModelEotyrannus extends ModelBasePalaeopedia {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(throat, 0.3229F, 0.0F, 0.0F);
        this.setRotateAngle(tail5, -0.0873F, 0.0F, 0.0F);
        this.setRotateAngle(tail4, 0.1858F, 0.2833F, -0.0127F);
        this.setRotateAngle(tail3, 0.1325F, 0.1557F, 0.0207F);
        this.setRotateAngle(tail2, 0.0277F, 0.2076F, -0.0277F);
        this.setRotateAngle(tail1, 0.1401F, 0.0821F, 0.0116F);
        this.setRotateAngle(rightleg4, -0.0305F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg3, -0.5367F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg2, 0.6545F, 0.0F, 0.0F);
        this.setRotateAngle(rightleg, 0.6217F, 0.197F, 0.1415F);
        this.setRotateAngle(rightarm3, 0.088F, -0.1304F, -0.2296F);
        this.setRotateAngle(rightarm2, -0.4975F, -0.1808F, 0.0973F);
        this.setRotateAngle(rightarm, 0.1859F, -1.3113F, 1.2884F);
        this.setRotateAngle(neck3, 0.1314F, -0.1303F, -0.114F);
        this.setRotateAngle(neck2, -0.1492F, -0.1321F, -0.213F);
        this.setRotateAngle(neck1, -0.0784F, -0.059F, -0.0829F);
        this.setRotateAngle(leftleg4, 0.432F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg3, -0.8247F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg2, 0.7287F, 0.0F, 0.0F);
        this.setRotateAngle(leftleg, 0.3479F, -0.1269F, -0.115F);
        this.setRotateAngle(leftarm3, 0.088F, -0.1261F, 0.2071F);
        this.setRotateAngle(leftarm2, -0.511F, -0.284F, 0.1558F);
        this.setRotateAngle(leftarm, 0.2095F, 0.869F, -1.267F);
        this.setRotateAngle(jaw, 0.384F, 0.0F, 0.0F);
        this.setRotateAngle(hips, -0.6878F, 0.2719F, 0.0329F);
        ...
        this.setRotateAngle(cube_r10, -0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r1, -0.0436F, 0.0F, 0.0F);
        this.setRotateAngle(chest, 0.0F, -0.0524F, -0.0742F);
        this.setRotateAngle(body, -0.004F, -0.0653F, -0.0566F);
