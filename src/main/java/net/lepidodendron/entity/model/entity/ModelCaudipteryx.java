...
public class ModelCaudipteryx extends ModelBasePalaeopedia {
    ...
    public void renderStaticWall(float f) {
        ...
        this.setRotateAngle(neck4, -0F, -0F, -0F);
        this.setRotateAngle(neck3, 0F, -0F, -0F);
    ...
    public void renderStaticFloor(float f) {
        this.setRotateAngle(throat, 0.3705F, -0.1425F, -0.0551F);
        this.setRotateAngle(tail3, -0.1963F, 0.0F, 0.0F);
        this.setRotateAngle(tail2, 0.1231F, -0.1256F, -0.0155F);
        this.setRotateAngle(tail1, -0.0829F, -0.0305F, 0.0F);
        this.setRotateAngle(root, -0.048F, -0.4014F, 0.0F);
        this.setRotateAngle(rightLeg3, -0.4451F, 0.0F, 0.0F);
        this.setRotateAngle(rightLeg2, 0.288F, 0.0F, 0.0F);
        this.setRotateAngle(rightLeg1, 0.3054F, 0.0F, 0.0F);
        this.setRotateAngle(rightFoot, 0.0262F, 0.0F, 0.0F);
        this.setRotateAngle(rightArm1, 0.0F, -0.1745F, 0.1309F);
        this.setRotateAngle(neck4, -0.1489F, -0.0783F, -0.2085F);
        this.setRotateAngle(neck3, 0.1263F, -0.0072F, -0.0441F);
        this.setRotateAngle(neck2, 0.1356F, -0.004F, -0.1527F);
        this.setRotateAngle(neck1, 0.0F, 0.0F, -0.0873F);
        this.setRotateAngle(leftLeg3, -0.4145F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg2, 0.0654F, 0.0F, 0.0F);
        this.setRotateAngle(leftLeg1, 0.1745F, 0.0F, 0.0F);
        this.setRotateAngle(leftFoot, 0.3142F, 0.0F, 0.0F);
        this.setRotateAngle(leftArm1, 0.0885F, 0.2633F, -0.1938F);
        this.setRotateAngle(jaw, -0.4102F, 0.0F, 0.0F);
        this.setRotateAngle(head, -0.0785F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r9, -0.1047F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r8, -0.1047F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(cube_r10, -0.8203F, 0.0F, 0.0F);
        this.setRotateAngle(cube_r1, -0.1484F, 0.0F, 0.0F);
        this.setRotateAngle(chest, -0.0391F, -0.0641F, -0.0716F);
