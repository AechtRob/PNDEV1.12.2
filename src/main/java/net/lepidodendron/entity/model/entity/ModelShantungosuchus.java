...
public class ModelShantungosuchus extends ModelBasePalaeopedia {
    ...
    public ModelShantungosuchus() {
        ...
        this.main.cubeList.add(new ModelBox(main, 15, 26, -1.5F, -8.2F, 6.0F, 3, 3, 3, 0.0F, false));
        this.main.cubeList.add(new ModelBox(main, 29, 37, -0.5F, -8.45F, 6.0F, 1, 1, 3, 0.003F, false));

        this.backLeftLeg = new AdvancedModelRenderer(this);
        this.backLeftLeg.setRotationPoint(1.5F, -6.8526F, 7.5059F);
        this.main.addChild(backLeftLeg);
        this.setRotateAngle(backLeftLeg, -0.2182F, 0.0F, 0.0F);
        this.backLeftLeg.cubeList.add(new ModelBox(backLeftLeg, 11, 33, -0.5F, -0.5F, -1.0F, 2, 4, 2, 0.002F, false));

        this.backLeftLeg2 = new AdvancedModelRenderer(this);
        this.backLeftLeg2.setRotationPoint(1.0F, 3.25F, -1.0F);
        this.backLeftLeg.addChild(backLeftLeg2);
        this.setRotateAngle(backLeftLeg2, 0.6109F, 0.0F, 0.0F);
        this.backLeftLeg2.cubeList.add(new ModelBox(backLeftLeg2, 38, 37, -1.5F, 0.0F, 0.0F, 2, 4, 1, 0.0F, false));
        this.backLeftLeg2.cubeList.add(new ModelBox(backLeftLeg2, 0, 42, -1.5F, 0.0F, 0.6F, 2, 4, 1, -0.001F, false));

        this.backLeftLeg3 = new AdvancedModelRenderer(this);
        this.backLeftLeg3.setRotationPoint(0.0F, 3.5F, 1.0F);
        this.backLeftLeg2.addChild(backLeftLeg3);
        this.setRotateAngle(backLeftLeg3, -0.3927F, 0.0F, 0.0F);
        this.backLeftLeg3.cubeList.add(new ModelBox(backLeftLeg3, 21, 14, -2.0F, 0.0F, -2.0F, 3, 1, 2, 0.0F, false));

        this.backLeftLeg4 = new AdvancedModelRenderer(this);
        this.backLeftLeg4.setRotationPoint(0.0F, 1.0F, -2.0F);
        this.backLeftLeg3.addChild(backLeftLeg4);
        this.backLeftLeg4.cubeList.add(new ModelBox(backLeftLeg4, 41, 29, -2.0F, -1.0F, -1.0F, 3, 1, 1, 0.0F, false));

        this.backRightLeg = new AdvancedModelRenderer(this);
        this.backRightLeg.setRotationPoint(-1.5F, -6.8526F, 7.5059F);
        this.main.addChild(backRightLeg);
        this.setRotateAngle(backRightLeg, -0.2182F, 0.0F, 0.0F);
        this.backRightLeg.cubeList.add(new ModelBox(backRightLeg, 11, 33, -1.5F, -0.5F, -1.0F, 2, 4, 2, 0.002F, true));

        this.backRightLeg2 = new AdvancedModelRenderer(this);
        this.backRightLeg2.setRotationPoint(-1.0F, 3.25F, -1.0F);
        this.backRightLeg.addChild(backRightLeg2);
        this.setRotateAngle(backRightLeg2, 0.6109F, 0.0F, 0.0F);
        this.backRightLeg2.cubeList.add(new ModelBox(backRightLeg2, 38, 37, -0.5F, 0.0F, 0.0F, 2, 4, 1, 0.0F, true));
        this.backRightLeg2.cubeList.add(new ModelBox(backRightLeg2, 0, 42, -0.5F, 0.0F, 0.6F, 2, 4, 1, -0.001F, true));

        this.backRightLeg3 = new AdvancedModelRenderer(this);
        this.backRightLeg3.setRotationPoint(0.0F, 3.5F, 1.0F);
        this.backRightLeg2.addChild(backRightLeg3);
        this.setRotateAngle(backRightLeg3, -0.3927F, 0.0F, 0.0F);
        this.backRightLeg3.cubeList.add(new ModelBox(backRightLeg3, 21, 14, -1.0F, 0.0F, -2.0F, 3, 1, 2, 0.0F, true));

        this.backRightLeg4 = new AdvancedModelRenderer(this);
        this.backRightLeg4.setRotationPoint(0.0F, 1.0F, -2.0F);
        this.backRightLeg3.addChild(backRightLeg4);
        this.backRightLeg4.cubeList.add(new ModelBox(backRightLeg4, 41, 29, -1.0F, -1.0F, -1.0F, 3, 1, 1, 0.0F, true));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, -8.0004F, 6.2337F);
        this.main.addChild(body);
        this.setRotateAngle(body, 0.0873F, 0.0F, 0.0F);
        this.body.cubeList.add(new ModelBox(body, 0, 0, -2.0F, -0.35F, -6.0F, 4, 3, 6, 0.01F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 18, -1.0F, -0.5F, -6.0F, 2, 1, 6, 0.003F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 10, -2.0F, 2.15F, -6.0F, 4, 1, 6, -0.005F, false));

        this.body2 = new AdvancedModelRenderer(this);
        this.body2.setRotationPoint(0.0F, 0.25F, -5.25F);
        this.body.addChild(body2);
        this.body2.cubeList.add(new ModelBox(body2, 0, 26, -2.0F, -0.35F, -3.0F, 4, 3, 3, -0.01F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(-1.0F, -0.1F, 0.0F);
        this.body2.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.0436F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 33, 0.0F, -0.625F, -3.0F, 2, 1, 3, 0.0F, false));

        this.frontLeftLeg = new AdvancedModelRenderer(this);
        this.frontLeftLeg.setRotationPoint(1.9F, 1.625F, -2.05F);
        this.body2.addChild(frontLeftLeg);
        this.setRotateAngle(frontLeftLeg, 0.3491F, 0.0F, 0.0F);
        this.frontLeftLeg.cubeList.add(new ModelBox(frontLeftLeg, 7, 44, -0.5F, -0.25F, -0.5F, 1, 3, 1, 0.001F, false));
        this.frontLeftLeg.cubeList.add(new ModelBox(frontLeftLeg, 12, 44, -0.5F, -0.25F, 0.0F, 1, 3, 1, -0.003F, false));

        this.frontLeftLeg2 = new AdvancedModelRenderer(this);
        this.frontLeftLeg2.setRotationPoint(0.0F, 2.1311F, -0.0683F);
        this.frontLeftLeg.addChild(frontLeftLeg2);
        this.setRotateAngle(frontLeftLeg2, -0.48F, 0.0F, 0.0F);
        this.frontLeftLeg2.cubeList.add(new ModelBox(frontLeftLeg2, 39, 43, -0.5F, -0.4846F, -0.1468F, 1, 3, 1, -0.01F, false));

        this.frontLeftLeg3 = new AdvancedModelRenderer(this);
        this.frontLeftLeg3.setRotationPoint(0.0F, 2.3206F, 0.4907F);
        this.frontLeftLeg2.addChild(frontLeftLeg3);
        this.setRotateAngle(frontLeftLeg3, -0.2182F, 0.0F, 0.0F);
        this.frontLeftLeg3.cubeList.add(new ModelBox(frontLeftLeg3, 43, 22, -0.5F, -0.0551F, -0.6375F, 1, 1, 1, 0.0F, false));

        this.frontLeftLeg4 = new AdvancedModelRenderer(this);
        this.frontLeftLeg4.setRotationPoint(0.0F, 0.25F, -0.25F);
        this.frontLeftLeg3.addChild(frontLeftLeg4);
        this.setRotateAngle(frontLeftLeg4, 0.2618F, 0.0F, 0.0F);
        this.frontLeftLeg4.cubeList.add(new ModelBox(frontLeftLeg4, 9, 40, -1.0F, 0.0F, -1.7F, 2, 1, 2, 0.003F, false));

        this.frontRightLeg = new AdvancedModelRenderer(this);
        this.frontRightLeg.setRotationPoint(-1.9F, 1.625F, -2.05F);
        this.body2.addChild(frontRightLeg);
        this.setRotateAngle(frontRightLeg, 0.3491F, 0.0F, 0.0F);
        this.frontRightLeg.cubeList.add(new ModelBox(frontRightLeg, 7, 44, -0.5F, -0.25F, -0.5F, 1, 3, 1, 0.001F, true));
        this.frontRightLeg.cubeList.add(new ModelBox(frontRightLeg, 12, 44, -0.5F, -0.25F, 0.0F, 1, 3, 1, -0.003F, true));

        this.frontRightLeg2 = new AdvancedModelRenderer(this);
        this.frontRightLeg2.setRotationPoint(0.0F, 2.1311F, -0.0683F);
        this.frontRightLeg.addChild(frontRightLeg2);
        this.setRotateAngle(frontRightLeg2, -0.48F, 0.0F, 0.0F);
        this.frontRightLeg2.cubeList.add(new ModelBox(frontRightLeg2, 39, 43, -0.5F, -0.4846F, -0.1468F, 1, 3, 1, -0.01F, true));

        this.frontRightLeg3 = new AdvancedModelRenderer(this);
        this.frontRightLeg3.setRotationPoint(0.0F, 2.3206F, 0.4907F);
        this.frontRightLeg2.addChild(frontRightLeg3);
        this.setRotateAngle(frontRightLeg3, -0.2182F, 0.0F, 0.0F);
        this.frontRightLeg3.cubeList.add(new ModelBox(frontRightLeg3, 43, 22, -0.5F, -0.0551F, -0.6375F, 1, 1, 1, 0.0F, true));

        this.frontRightLeg4 = new AdvancedModelRenderer(this);
        this.frontRightLeg4.setRotationPoint(0.0F, 0.25F, -0.25F);
        this.frontRightLeg3.addChild(frontRightLeg4);
        this.setRotateAngle(frontRightLeg4, 0.2618F, 0.0F, 0.0F);
        this.frontRightLeg4.cubeList.add(new ModelBox(frontRightLeg4, 9, 40, -1.0F, 0.0F, -1.7F, 2, 1, 2, 0.003F, true));

        this.body3 = new AdvancedModelRenderer(this);
        this.body3.setRotationPoint(0.0F, -0.25F, -2.5F);
        this.body2.addChild(body3);
        this.setRotateAngle(body3, 0.0873F, 0.0F, 0.0F);
        this.body3.cubeList.add(new ModelBox(body3, 32, 20, -1.5F, 0.0F, -2.0F, 3, 2, 2, -0.001F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(-0.5F, 2.775F, 0.0F);
        this.body3.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.2182F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 38, -0.5F, -0.9F, -2.075F, 2, 1, 2, -0.001F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.5F, 0.25F, -1.5F);
        this.body3.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0436F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 32, 43, 0.0F, -0.55F, -0.5F, 1, 1, 2, -0.003F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, -0.05F, -1.75F);
        this.body3.addChild(head);
        this.head.cubeList.add(new ModelBox(head, 41, 25, -1.0F, -0.225F, -2.0F, 2, 1, 2, 0.0F, false));
        this.head.cubeList.add(new ModelBox(head, 36, 5, -0.5F, 0.3976F, -4.3063F, 1, 1, 3, 0.002F, false));
        this.head.cubeList.add(new ModelBox(head, 20, 33, -1.5F, 0.3976F, -1.6563F, 3, 1, 2, 0.003F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.5F, 0.8976F, -1.6563F);
        this.head.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, -0.6545F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 43, 14, 0.0F, -0.5F, -2.0F, 1, 1, 2, -0.005F, true));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(1.5F, 0.8976F, -1.6563F);
        this.head.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.6545F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 43, 14, -1.0F, -0.5F, -2.0F, 1, 1, 2, 0.0F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-0.4F, 0.9976F, -3.3063F);
        this.head.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0436F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 45, 0, 0.0F, -0.5F, -0.975F, 0, 1, 2, 0.0F, true));
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 45, 0, 0.8F, -0.5F, -0.975F, 0, 1, 2, 0.0F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(-0.4F, 0.9856F, -3.0316F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.6109F, 0.0F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 45, 39, -0.05F, -0.5F, -0.725F, 0, 1, 1, 0.0F, true));
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 45, 39, 0.85F, -0.5F, -0.725F, 0, 1, 1, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.5F, 0.0F, -2.0F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.4363F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 45, 7, -1.0F, -0.175F, -1.4F, 1, 1, 1, -0.003F, false));
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 45, 4, -1.0F, -0.175F, -0.9F, 1, 1, 1, 0.0F, false));

        this.eye = new AdvancedModelRenderer(this);
        this.eye.setRotationPoint(0.6F, 0.275F, -1.525F);
        this.head.addChild(eye);
        this.setRotateAngle(eye, 0.1309F, 0.0F, -0.1309F);


        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.075F, -0.05F, 0.0F);
        this.eye.addChild(cube_r9);
        this.setRotateAngle(cube_r9, -0.0872F, -0.0038F, -0.0435F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 45, 10, -0.575F, -0.5F, -0.525F, 1, 1, 1, 0.0F, false));

        this.eye2 = new AdvancedModelRenderer(this);
        this.eye2.setRotationPoint(-0.6F, 0.275F, -1.525F);
        this.head.addChild(eye2);
        this.setRotateAngle(eye2, 0.1309F, 0.0F, 0.1309F);


        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-0.075F, -0.05F, 0.0F);
        this.eye2.addChild(cube_r10);
        this.setRotateAngle(cube_r10, -0.0872F, 0.0038F, 0.0435F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 45, 10, -0.425F, -0.5F, -0.525F, 1, 1, 1, 0.0F, true));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(0.0F, 1.425F, -0.5F);
        this.head.addChild(jaw);
        this.setRotateAngle(jaw, -0.0873F, 0.0F, 0.0F);
        this.jaw.cubeList.add(new ModelBox(jaw, 22, 37, -0.5F, -0.3524F, -1.8313F, 1, 1, 1, -0.01F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 31, 33, -1.5F, -0.3524F, -1.1563F, 3, 1, 2, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 17, 47, 1.125F, -0.9774F, -1.1563F, 0, 1, 1, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 17, 47, -1.125F, -0.9774F, -1.1563F, 0, 1, 1, 0.0F, true));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(-0.5F, 0.6476F, -0.8563F);
        this.jaw.addChild(cube_r11);
        this.setRotateAngle(cube_r11, -0.1745F, 0.0F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 36, 10, -0.5F, -0.8F, -0.3F, 2, 1, 2, -0.002F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(-0.4F, -0.0522F, -3.2385F);
        this.jaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, -0.2007F, 0.0F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 45, 36, 0.0F, -0.5F, -0.425F, 0, 1, 1, 0.0F, true));
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 45, 36, 0.8F, -0.5F, -0.425F, 0, 1, 1, 0.0F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, 0.6476F, -0.7563F);
        this.jaw.addChild(cube_r13);
        this.setRotateAngle(cube_r13, -0.0698F, 0.0F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 20, 37, -0.5F, -0.85F, -3.075F, 1, 1, 3, 0.0F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(-1.5F, -0.8524F, -1.1563F);
        this.jaw.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.0F, -0.6545F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 43, 18, 0.0F, 0.5F, -2.0F, 1, 1, 2, -0.005F, true));

        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(1.5F, -0.8524F, -1.1563F);
        this.jaw.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.0F, 0.6545F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 43, 18, -1.0F, 0.5F, -2.0F, 1, 1, 2, -0.008F, false));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(-0.5F, -8.0265F, 8.6914F);
        this.main.addChild(tail);
        this.setRotateAngle(tail, -0.3491F, 0.0F, 0.0F);
        this.tail.cubeList.add(new ModelBox(tail, 17, 18, -0.5F, 0.0F, 0.0F, 2, 2, 5, 0.001F, false));

        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(0.5F, 0.075F, 0.0F);
        this.tail.addChild(cube_r16);
        this.setRotateAngle(cube_r16, -0.0698F, 0.0F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 28, 26, -0.5F, -0.5F, 0.0F, 1, 1, 5, 0.0F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.0106F, 4.5687F);
        this.tail.addChild(tail2);
        this.setRotateAngle(tail2, -0.3491F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 21, 0, -0.5F, 0.0F, 0.0F, 2, 1, 5, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 25, 42, 0.9F, -0.15F, 2.0F, 0, 1, 3, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 25, 42, 0.1F, -0.15F, 2.0F, 0, 1, 3, 0.0F, true));
        this.tail2.cubeList.add(new ModelBox(tail2, 21, 7, -0.5F, 0.5F, 0.0F, 2, 1, 5, -0.001F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(0.5F, -0.225F, 0.375F);
        this.tail2.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.0262F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 42, 32, -0.5F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, 0.25F, 4.5F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, 0.1309F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 32, 14, 0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F, false));
        this.tail3.cubeList.add(new ModelBox(tail3, 45, 44, 0.8F, -0.2F, 1.5F, 0, 1, 1, 0.0F, false));
        this.tail3.cubeList.add(new ModelBox(tail3, 45, 44, 0.2F, -0.2F, 1.5F, 0, 1, 1, 0.0F, true));

        this.tail4 = new AdvancedModelRenderer(this);
        this.tail4.setRotationPoint(0.0F, 0.5F, 3.75F);
        this.tail3.addChild(tail4);
        this.setRotateAngle(tail4, 0.3927F, 0.0F, 0.0F);
        this.tail4.cubeList.add(new ModelBox(tail4, 36, 0, 0.0F, -0.5F, 0.0F, 1, 1, 3, -0.001F, false));
        this.tail4.cubeList.add(new ModelBox(tail4, 18, 42, 0.65F, -0.65F, -0.025F, 0, 1, 3, 0.0F, false));
        this.tail4.cubeList.add(new ModelBox(tail4, 18, 42, 0.35F, -0.65F, -0.025F, 0, 1, 3, 0.0F, true));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraShantungosuchus proteros = (EntityPrehistoricFloraShantungosuchus) e;
    ...
    public void animNest(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraShantungosuchus entity = (EntityPrehistoricFloraShantungosuchus) entitylivingbaseIn;
        int animCycle = 50;
    ...
    public void animLay(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            ...
            xx = -42.5 + (((tickAnim - 18) / 16) * (-42.5-(-42.5)));
            yy = 0 + (((tickAnim - 18) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 16) * (0-(0)));
        }
        else if (tickAnim >= 34 && tickAnim < 50) {
            xx = -42.5 + (((tickAnim - 34) / 16) * (0-(-42.5)));
            yy = 0 + (((tickAnim - 34) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 34) / 16) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 0) / 18) * (44.75-(0)));
            yy = 0 + (((tickAnim - 0) / 18) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 18) * (0-(0)));
        }
        else if (tickAnim >= 18 && tickAnim < 34) {
            xx = 44.75 + (((tickAnim - 18) / 16) * (44.75-(44.75)));
            yy = 0 + (((tickAnim - 18) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 18) / 16) * (0-(0)));
        }
        else if (tickAnim >= 34 && tickAnim < 50) {
            xx = 44.75 + (((tickAnim - 34) / 16) * (0-(44.75)));
            yy = 0 + (((tickAnim - 34) / 16) * (0-(0)));
            zz = 0 + (((tickAnim - 34) / 16) * (0-(0)));
        }
        else {
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraShantungosuchus e = (EntityPrehistoricFloraShantungosuchus) entity;
