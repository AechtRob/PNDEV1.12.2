...
public class ModelRedfieldius extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        this.redfieldius.offsetY = -2.0F;
        this.redfieldius.offsetX = -0.4F;
        this.redfieldius.offsetZ = 2.0F;
        this.redfieldius.rotateAngleY = (float)Math.toRadians(120);
        this.redfieldius.rotateAngleX = (float)Math.toRadians(0);
        this.redfieldius.rotateAngleZ = (float)Math.toRadians(0);
        this.redfieldius.scaleChildren = true;
        float scaler = 3.0F;
        this.redfieldius.setScale(scaler, scaler, scaler);
        //Start of pose:
        this.setRotateAngle(redfieldius, 0.6F, 3.8F, -0.2F);
        //End of pose, now render the model:
        this.redfieldius.render(f);
        //Reset rotations, positions and sizing:
        this.redfieldius.setScale(1.0F, 1.0F, 1.0F);
        this.redfieldius.scaleChildren = false;
        resetToDefaultPose();
