...
public class ModelDysaloTaxi extends AdvancedModelBaseExtended {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(Chest, (float)Math.toRadians(10.5), 0.0F, 0.0F);
        this.setRotateAngle(ArmL, (float)Math.toRadians(45.5), 0.0F, 0.0F);
        this.setRotateAngle(ArmR, (float)Math.toRadians(45.5), 0.0F, 0.0F);
        this.setRotateAngle(LegL, -(float)Math.toRadians(67), 0.0F, 0.0F);
        this.setRotateAngle(LegR, -(float)Math.toRadians(67), 0.0F, 0.0F);
        this.setRotateAngle(KneeL, -(float)Math.toRadians(-90.5), 0.0F, 0.0F);
        ...
        this.setRotateAngle(TarsalsL, -(float)Math.toRadians(87.5), 0.0F, 0.0F);
        this.setRotateAngle(FootR, -(float)Math.toRadians(-95.5), 0.0F, 0.0F);
        this.setRotateAngle(FootL, -(float)Math.toRadians(-95.5), 0.0F, 0.0F);
        this.setRotateAngle(Neck1, (float)Math.toRadians(-11.2431), -(float)Math.toRadians(27.0478), (float)Math.toRadians(-5.1652));
        this.setRotateAngle(Neck2, -(float)Math.toRadians(7.7614), -(float)Math.toRadians(14.8687), -(float)Math.toRadians(2.0031));
        this.setRotateAngle(Neck4, (float)Math.toRadians(7.5), 0.0F, 0.0F);
        this.setRotateAngle(Head, (float)Math.toRadians(-1.0485), -(float)Math.toRadians(17.4972), (float)Math.toRadians(-0.3153));
        this.setRotateAngle(Tail1, -(float)Math.toRadians(-22.7207), -(float)Math.toRadians(-9.6559), -(float)Math.toRadians(2.613));
        this.setRotateAngle(Tail2, -(float)Math.toRadians(-5.2413), -(float)Math.toRadians(-17.4313), -(float)Math.toRadians(1.5741));
        this.setRotateAngle(Tail3, -(float)Math.toRadians(-5.1208), -(float)Math.toRadians(-12.4517), -(float)Math.toRadians(1.1069));
        this.setRotateAngle(Tail4, -(float)Math.toRadians(-5.4096), -(float)Math.toRadians(-22.4097), -(float)Math.toRadians(2.0675));
        this.setRotateAngle(Tail5, -(float)Math.toRadians(2.5881), -(float)Math.toRadians(-14.9854), -(float)Math.toRadians(-0.6696));
        this.Dryosaurus.offsetY = 0.06F;
