...
public class ModelIcarosaurus extends ModelBasePalaeopedia {
    ...
    public ModelIcarosaurus() {
        this.textureWidth = 55;
        this.textureHeight = 55;

        this.root = new AdvancedModelRenderer(this);
        this.root.setRotationPoint(0.0F, 22.1866F, 0.8275F);
        this.setRotateAngle(root, -0.0873F, 0.0F, 0.0F);
        this.root.cubeList.add(new ModelBox(root, 19, 21, -1.5F, -1.2585F, -0.4072F, 3, 2, 4, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(0.0F, 1.4415F, -3.4072F);
        this.root.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.1309F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 26, -1.5F, -0.4F, 3.0F, 3, 1, 4, -0.01F, false));

        this.rightLeg = new AdvancedModelRenderer(this);
        this.rightLeg.setRotationPoint(-0.6F, 0.7612F, 1.4458F);
        this.root.addChild(rightLeg);
        this.setRotateAngle(rightLeg, 0.0761F, 0.4703F, -0.1307F);
        this.rightLeg.cubeList.add(new ModelBox(rightLeg, 13, 42, -4.25F, -1.0F, -1.0F, 5, 1, 2, 0.01F, true));

        this.rightLeg2 = new AdvancedModelRenderer(this);
        this.rightLeg2.setRotationPoint(-3.7966F, -0.6366F, 0.0903F);
        this.rightLeg.addChild(rightLeg2);
        this.setRotateAngle(rightLeg2, -0.0029F, 0.7449F, -0.0438F);


        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(-0.1835F, 0.7311F, 0.2171F);
        this.rightLeg2.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.0349F, 0.2182F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 46, -3.7543F, -0.9755F, -0.7528F, 4, 1, 1, 0.0F, true));

        this.rightFoot = new AdvancedModelRenderer(this);
        this.rightFoot.setRotationPoint(-3.8829F, -0.011F, 0.9352F);
        this.rightLeg2.addChild(rightFoot);
        this.setRotateAngle(rightFoot, -0.1805F, -0.7134F, 0.2353F);


        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.5179F, 0.1684F, -0.3687F);
        this.rightFoot.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.0218F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 19, 16, -4.2038F, -0.097F, -1.8835F, 5, 0, 4, 0.0F, true));

        this.leftLeg = new AdvancedModelRenderer(this);
        this.leftLeg.setRotationPoint(0.6F, 0.7612F, 1.4458F);
        this.root.addChild(leftLeg);
        this.setRotateAngle(leftLeg, 0.0761F, -0.4703F, 0.1307F);
        this.leftLeg.cubeList.add(new ModelBox(leftLeg, 13, 42, -0.75F, -1.0F, -1.0F, 5, 1, 2, 0.01F, false));

        this.leftLeg2 = new AdvancedModelRenderer(this);
        this.leftLeg2.setRotationPoint(3.7966F, -0.6366F, 0.0903F);
        this.leftLeg.addChild(leftLeg2);
        this.setRotateAngle(leftLeg2, -0.0029F, -0.7449F, 0.0438F);


        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(0.1835F, 0.7311F, 0.2171F);
        this.leftLeg2.addChild(cube_r4);
        this.setRotateAngle(cube_r4, -0.0349F, -0.2182F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 46, -0.2457F, -0.9755F, -0.7528F, 4, 1, 1, 0.0F, false));

        this.leftFoot = new AdvancedModelRenderer(this);
        this.leftFoot.setRotationPoint(3.8829F, -0.011F, 0.9352F);
        this.leftLeg2.addChild(leftFoot);
        this.setRotateAngle(leftFoot, -0.1805F, 0.7134F, -0.2353F);


        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(0.5179F, 0.1684F, -0.3687F);
        this.leftFoot.addChild(cube_r5);
        this.setRotateAngle(cube_r5, -0.0218F, 0.0F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 19, 16, -0.7962F, -0.097F, -1.8835F, 5, 0, 4, 0.0F, false));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(0.0F, -0.1585F, 3.5928F);
        this.root.addChild(tail);
        this.tail.cubeList.add(new ModelBox(tail, 15, 28, -1.0F, -1.0F, -1.0F, 2, 2, 4, 0.0F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, -0.0946F, 2.9766F);
        this.tail.addChild(tail2);
        this.setRotateAngle(tail2, 0.0087F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 39, 12, -0.25F, -0.25F, -0.5F, 1, 1, 5, -0.01F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 28, 28, -0.75F, -0.2491F, -0.525F, 1, 1, 5, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 39, 35, -0.775F, -0.75F, -0.5F, 1, 1, 5, -0.01F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 41, 28, -0.25F, -0.75F, -0.5F, 1, 1, 5, 0.0F, false));

        this.tail3 = new AdvancedModelRenderer(this);
        this.tail3.setRotationPoint(-0.0214F, -0.1626F, 4.2913F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, 0.0131F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 0, 32, -0.4786F, -0.5F, 0.0F, 1, 1, 5, 0.01F, false));

        this.tail4 = new AdvancedModelRenderer(this);
        this.tail4.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.tail3.addChild(tail4);
        this.setRotateAngle(tail4, 0.0349F, 0.0F, 0.0F);
        this.tail4.cubeList.add(new ModelBox(tail4, 34, 21, -0.4786F, -0.5F, 0.0F, 1, 1, 5, 0.0F, false));

        this.tail5 = new AdvancedModelRenderer(this);
        this.tail5.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.tail4.addChild(tail5);
        this.tail5.cubeList.add(new ModelBox(tail5, 13, 35, -0.4786F, -0.5F, 0.0F, 1, 1, 5, 0.01F, false));

        this.tail6 = new AdvancedModelRenderer(this);
        this.tail6.setRotationPoint(0.0F, 0.0F, 5.0F);
        this.tail5.addChild(tail6);
        this.setRotateAngle(tail6, 0.0087F, 0.0F, 0.0F);
        this.tail6.cubeList.add(new ModelBox(tail6, 26, 35, -0.4786F, -0.5F, 0.0F, 1, 1, 5, 0.0F, false));

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, -1.1585F, -0.1572F);
        this.root.addChild(body);
        this.setRotateAngle(body, 0.0873F, 0.0F, 0.0F);
        this.body.cubeList.add(new ModelBox(body, 0, 16, -1.5F, -0.1582F, -5.8741F, 3, 3, 6, 0.01F, false));

        this.chest = new AdvancedModelRenderer(this);
        this.chest.setRotationPoint(0.0F, 1.3418F, -5.3741F);
        this.body.addChild(chest);
        this.chest.cubeList.add(new ModelBox(chest, 0, 39, -1.5F, -1.5F, -3.0F, 3, 3, 3, 0.0F, false));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 43, 6, -12.0F, -2.0737F, 0.649F, 2, 2, 2, -0.003F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, -0.1791F, -1.2347F);
        this.neck.addChild(head);
        this.setRotateAngle(head, 0.1309F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 41, 42, -0.5F, 0.6423F, -3.5355F, 1, 1, 4, 0.01F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(-0.7406F, 0.4252F, -2.5099F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, -0.3052F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 29, 46, 0.0F, 0.2304F, -0.9996F, 1, 1, 3, 0.003F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-1.3418F, 0.3134F, -0.6047F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.0434F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 46, 49, 0.0F, 0.3304F, 0.0004F, 1, 1, 1, 0.0F, true));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.7406F, 0.4252F, -2.5099F);
        this.head.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, 0.3052F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 29, 46, -1.0F, 0.2304F, -0.9996F, 1, 1, 3, 0.003F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(1.3418F, 0.3134F, -0.6047F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, -0.0434F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 46, 49, -1.0F, 0.3304F, 0.0004F, 1, 1, 1, 0.0F, false));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(0.0F, 0.333F, -1.1645F);
        this.head.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0393F, 0.0F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 7, 51, -1.0F, -0.575F, 0.175F, 2, 1, 1, 0.0F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(0.0F, -0.1614F, -1.7088F);
        this.head.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0873F, 0.0F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 24, 51, -0.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, 0.1806F, -2.6485F);
        this.head.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.3491F, 0.0F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 19, 51, -0.5F, 0.0F, 0.0F, 1, 1, 1, 0.003F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(0.0F, 0.6423F, -3.5355F);
        this.head.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.48F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 14, 51, -0.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

        this.eyeRight = new AdvancedModelRenderer(this);
        this.eyeRight.setRotationPoint(-0.75F, 0.261F, -1.1174F);
        ...
        this.setRotateAngle(cube_r15, 0.0412F, -0.3052F, -0.0124F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 29, 51, -0.45F, -0.25F, -0.8F, 1, 1, 1, 0.0F, true));

        this.eyeLeft = new AdvancedModelRenderer(this);
        this.eyeLeft.setRotationPoint(0.75F, 0.261F, -1.1174F);
        ...
        this.setRotateAngle(cube_r16, 0.0412F, 0.3052F, 0.0124F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 29, 51, -0.55F, -0.25F, -0.8F, 1, 1, 1, 0.0F, false));

        this.jaw = new AdvancedModelRenderer(this);
        this.jaw.setRotationPoint(0.0F, 1.6759F, 0.2589F);
        this.head.addChild(jaw);
        this.jaw.cubeList.add(new ModelBox(jaw, 43, 0, -0.5F, -0.5F, -3.775F, 1, 1, 4, 0.0F, false));
        this.jaw.cubeList.add(new ModelBox(jaw, 0, 49, -1.0F, -1.45F, -1.275F, 2, 1, 1, -0.01F, false));

        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(-1.3417F, 0.5046F, -0.8858F);
        this.jaw.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -0.0096F, -0.305F, 0.032F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 20, 46, 0.0F, -1.0F, -3.0F, 1, 1, 3, 0.0F, true));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(-1.3416F, 0.4928F, -0.8882F);
        this.jaw.addChild(cube_r18);
        this.setRotateAngle(cube_r18, 0.0045F, 0.0433F, 0.0125F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 39, 49, 0.0F, -1.0F, 0.0F, 1, 1, 1, -0.003F, true));

        this.cube_r19 = new AdvancedModelRenderer(this);
        this.cube_r19.setRotationPoint(1.3417F, 0.5046F, -0.8858F);
        this.jaw.addChild(cube_r19);
        this.setRotateAngle(cube_r19, -0.0096F, 0.305F, -0.032F);
        this.cube_r19.cubeList.add(new ModelBox(cube_r19, 20, 46, -1.0F, -1.0F, -3.0F, 1, 1, 3, 0.0F, false));

        this.cube_r20 = new AdvancedModelRenderer(this);
        this.cube_r20.setRotationPoint(1.3416F, 0.4928F, -0.8882F);
        this.jaw.addChild(cube_r20);
        this.setRotateAngle(cube_r20, 0.0045F, -0.0433F, -0.0125F);
        this.cube_r20.cubeList.add(new ModelBox(cube_r20, 39, 49, -1.0F, -1.0F, 0.0F, 1, 1, 1, -0.003F, false));

        this.neckpouch = new AdvancedModelRenderer(this);
        this.neckpouch.setRotationPoint(0.0F, 0.3571F, -1.8347F);
        this.jaw.addChild(neckpouch);
        this.setRotateAngle(neckpouch, -0.2443F, 0.0F, 0.0F);


        this.cube_r21 = new AdvancedModelRenderer(this);
        this.cube_r21.setRotationPoint(-0.5F, 0.1553F, 0.0149F);
        this.neckpouch.addChild(cube_r21);
        this.setRotateAngle(cube_r21, -0.1134F, 0.0F, 0.0F);
        this.cube_r21.cubeList.add(new ModelBox(cube_r21, 11, 46, 0.0F, -1.0751F, -0.0221F, 1, 1, 3, 0.006F, false));

        this.leftArm = new AdvancedModelRenderer(this);
        this.leftArm.setRotationPoint(1.1795F, 0.1974F, -2.1188F);
        this.chest.addChild(leftArm);
        this.setRotateAngle(leftArm, -0.056F, -0.2331F, 0.256F);
        this.leftArm.cubeList.add(new ModelBox(leftArm, 47, 19, -0.2444F, -0.606F, -0.7888F, 3, 1, 1, 0.01F, false));
        this.leftArm.cubeList.add(new ModelBox(leftArm, 47, 22, -0.2444F, -0.606F, -0.3888F, 3, 1, 1, 0.0F, false));

        this.leftArm2 = new AdvancedModelRenderer(this);
        this.leftArm2.setRotationPoint(2.3731F, -0.0506F, 0.2144F);
        this.leftArm.addChild(leftArm2);
        this.setRotateAngle(leftArm2, 0.9498F, 1.3824F, 0.9653F);
        this.leftArm2.cubeList.add(new ModelBox(leftArm2, 47, 25, -0.25F, -0.5F, -0.5F, 3, 1, 1, -0.01F, false));

        this.leftHand = new AdvancedModelRenderer(this);
        this.leftHand.setRotationPoint(2.738F, 0.1784F, -0.0186F);
        this.leftArm2.addChild(leftHand);
        this.setRotateAngle(leftHand, 0.2763F, 0.4223F, -0.0866F);
        this.leftHand.cubeList.add(new ModelBox(leftHand, 28, 42, -1.0483F, 0.0496F, -1.4917F, 3, 0, 3, 0.0F, false));

        this.rightArm = new AdvancedModelRenderer(this);
        this.rightArm.setRotationPoint(-1.1795F, 0.1974F, -2.1188F);
        this.chest.addChild(rightArm);
        this.setRotateAngle(rightArm, -0.056F, 0.2331F, -0.256F);
        this.rightArm.cubeList.add(new ModelBox(rightArm, 47, 19, -2.7556F, -0.606F, -0.7888F, 3, 1, 1, 0.01F, true));
        this.rightArm.cubeList.add(new ModelBox(rightArm, 47, 22, -2.7556F, -0.606F, -0.3888F, 3, 1, 1, 0.0F, true));
        ...
        this.rightArm2.cubeList.add(new ModelBox(rightArm2, 47, 25, -2.75F, -0.5F, -0.5F, 3, 1, 1, -0.01F, true));
        ...
        this.rightHand.cubeList.add(new ModelBox(rightHand, 28, 42, -1.9517F, 0.0496F, -1.4917F, 3, 0, 3, 0.0F, true));

        this.rightWing = new AdvancedModelRenderer(this);
        this.rightWing.setRotationPoint(-1.5F, 0.5418F, -6.7741F);
        this.body.addChild(rightWing);
        this.setRotateAngle(rightWing, 0.0F, 1.261F, 0.0F);
        this.rightWing.cubeList.add(new ModelBox(rightWing, 0, 0, -18.025F, 0.0F, 0.0F, 18, 0, 3, 0.0F, true));

        this.rightWing2 = new AdvancedModelRenderer(this);
        this.rightWing2.setRotationPoint(-8.55F, 0.1F, 2.925F);
        this.rightWing.addChild(rightWing2);
        this.setRotateAngle(rightWing2, 3.098F, 0.0F, 0.0F);
        this.rightWing2.cubeList.add(new ModelBox(rightWing2, 0, 4, -9.475F, -0.0663F, 0.0F, 18, 0, 3, 0.0F, true));

        this.rightWing3 = new AdvancedModelRenderer(this);
        this.rightWing3.setRotationPoint(1.375F, -0.1F, 1.775F);
        this.rightWing2.addChild(rightWing3);
        this.setRotateAngle(rightWing3, 3.1286F, -0.1536F, 0.0014F);
        this.rightWing3.cubeList.add(new ModelBox(rightWing3, 0, 8, -10.8252F, 0.0537F, 0.059F, 18, 0, 3, 0.0F, true));

        this.rightWing4 = new AdvancedModelRenderer(this);
        this.rightWing4.setRotationPoint(0.0998F, 0.0737F, 2.209F);
        this.rightWing3.addChild(rightWing4);
        this.setRotateAngle(rightWing4, 3.1329F, 0.0305F, -0.0006F);


        this.cube_r22 = new AdvancedModelRenderer(this);
        this.cube_r22.setRotationPoint(0.7091F, 0.0012F, -0.4187F);
        this.rightWing4.addChild(cube_r22);
        this.setRotateAngle(cube_r22, 0.0F, 0.0044F, 0.0F);
        this.cube_r22.cubeList.add(new ModelBox(cube_r22, 0, 12, -9.4218F, -0.0012F, -0.5835F, 16, 0, 3, 0.0F, true));

        this.leftWing = new AdvancedModelRenderer(this);
        this.leftWing.setRotationPoint(1.5F, 0.5418F, -6.7741F);
        this.body.addChild(leftWing);
        this.setRotateAngle(leftWing, 0.0F, -1.261F, 0.0F);
        this.leftWing.cubeList.add(new ModelBox(leftWing, 0, 0, 0.025F, 0.0F, 0.0F, 18, 0, 3, 0.0F, false));

        this.leftWing2 = new AdvancedModelRenderer(this);
        this.leftWing2.setRotationPoint(8.55F, 0.1F, 2.925F);
        this.leftWing.addChild(leftWing2);
        this.setRotateAngle(leftWing2, 3.098F, 0.0F, 0.0F);
        this.leftWing2.cubeList.add(new ModelBox(leftWing2, 0, 4, -8.525F, -0.0663F, 0.0F, 18, 0, 3, 0.0F, false));

        this.leftWing3 = new AdvancedModelRenderer(this);
        this.leftWing3.setRotationPoint(-1.375F, -0.1F, 1.775F);
        this.leftWing2.addChild(leftWing3);
        this.setRotateAngle(leftWing3, 3.1286F, 0.1536F, -0.0014F);
        this.leftWing3.cubeList.add(new ModelBox(leftWing3, 0, 8, -7.1748F, 0.0537F, 0.059F, 18, 0, 3, 0.0F, false));

        this.leftWing4 = new AdvancedModelRenderer(this);
        this.leftWing4.setRotationPoint(-0.0998F, 0.0737F, 2.209F);
        this.leftWing3.addChild(leftWing4);
        this.setRotateAngle(leftWing4, 3.1329F, -0.0305F, 0.0006F);


        this.cube_r23 = new AdvancedModelRenderer(this);
        this.cube_r23.setRotationPoint(-0.7091F, 0.0012F, -0.4187F);
        this.leftWing4.addChild(cube_r23);
        this.setRotateAngle(cube_r23, 0.0F, -0.0044F, 0.0F);
        this.cube_r23.cubeList.add(new ModelBox(cube_r23, 0, 12, -6.5782F, -0.0012F, -0.5835F, 16, 0, 3, 0.0F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraIcarosaurus ee = (EntityPrehistoricFloraIcarosaurus) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraIcarosaurus ee = (EntityPrehistoricFloraIcarosaurus) entitylivingbaseIn;
    ...
    public void animEat(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        EntityPrehistoricFloraIcarosaurus entity = (EntityPrehistoricFloraIcarosaurus) entitylivingbaseIn;
        int animCycle = 20;
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            xx = 0 + (((tickAnim - 8) / 2) * (6.5-(0)));
            yy = 0 + (((tickAnim - 8) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 8) / 2) * (0-(0)));
        }
        else if (tickAnim >= 10 && tickAnim < 12) {
            xx = 6.5 + (((tickAnim - 10) / 2) * (12.25-(6.5)));
            yy = 0 + (((tickAnim - 10) / 2) * (0-(0)));
            zz = 0 + (((tickAnim - 10) / 2) * (0-(0)));
        }
        else if (tickAnim >= 12 && tickAnim < 13) {
            xx = 12.25 + (((tickAnim - 12) / 1) * (17.42-(12.25)));
            yy = 0 + (((tickAnim - 12) / 1) * (0-(0)));
            zz = 0 + (((tickAnim - 12) / 1) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 14) {
            xx = 17.42 + (((tickAnim - 13) / 1) * (-9.25-(17.42)));
            yy = 0 + (((tickAnim - 13) / 1) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 1) * (0-(0)));
        }
        else if (tickAnim >= 14 && tickAnim < 17) {
            xx = -9.25 + (((tickAnim - 14) / 3) * (0-(-9.25)));
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            zz = 1 + (((tickAnim - 8) / 2) * (1.2-(1)));
        }
        else if (tickAnim >= 10 && tickAnim < 13) {
            xx = 1 + (((tickAnim - 10) / 3) * (1-(1)));
            yy = 1 + (((tickAnim - 10) / 3) * (1-(1)));
            zz = 1.2 + (((tickAnim - 10) / 3) * (1.2-(1.2)));
        }
        else if (tickAnim >= 13 && tickAnim < 14) {
            xx = 1 + (((tickAnim - 13) / 1) * (1-(1)));
            yy = 1 + (((tickAnim - 13) / 1) * (1-(1)));
            zz = 1.2 + (((tickAnim - 13) / 1) * (0.7-(1.2)));
        }
        else if (tickAnim >= 14 && tickAnim < 17) {
            xx = 1 + (((tickAnim - 14) / 3) * (1-(1)));
            yy = 1 + (((tickAnim - 14) / 3) * (1-(1)));
            zz = 0.7 + (((tickAnim - 14) / 3) * (1.2-(0.7)));
        }
        else if (tickAnim >= 17 && tickAnim < 20) {
            xx = 1 + (((tickAnim - 17) / 3) * (1-(1)));
            yy = 1 + (((tickAnim - 17) / 3) * (1-(1)));
            zz = 1.2 + (((tickAnim - 17) / 3) * (1-(1.2)));
        }
        else {
            xx = 1;
            yy = 1;
        ...
        this.neckpouch.setScale((float)xx, (float)yy, (float)zz);
        ...
        if (tickAnim >= 0 && tickAnim < 2) {
            ...
            xx = 32.75 + (((tickAnim - 3) / 3) * (38.25-(32.75)));
            yy = 0 + (((tickAnim - 3) / 3) * (0-(0)));
            zz = 0 + (((tickAnim - 3) / 3) * (0-(0)));
        }
        else if (tickAnim >= 6 && tickAnim < 8) {
            xx = 38.25 + (((tickAnim - 6) / 2) * (5.02508-(38.25)));
    ...
    public void animGliding(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.setRotateAngle(neckpouch, neckpouch.rotateAngleX + (float) Math.toRadians(7.5), neckpouch.rotateAngleY + (float) Math.toRadians(0), neckpouch.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(rightWing, rightWing.rotateAngleX + (float) Math.toRadians(1.49322), rightWing.rotateAngleY + (float) Math.toRadians(-71.50213), rightWing.rotateAngleZ + (float) Math.toRadians(0.1633));
        this.rightWing.rotationPointX = this.rightWing.rotationPointX + (float)(0.225);
        this.rightWing.rotationPointY = this.rightWing.rotationPointY - (float)(0);
        this.rightWing.rotationPointZ = this.rightWing.rotationPointZ + (float)(-0.175);


        this.setRotateAngle(rightWing2, rightWing2.rotateAngleX + (float) Math.toRadians(180), rightWing2.rotateAngleY + (float) Math.toRadians(0), rightWing2.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(rightWing3, rightWing3.rotateAngleX + (float) Math.toRadians(181.16336), rightWing3.rotateAngleY + (float) Math.toRadians(13.74875), rightWing3.rotateAngleZ + (float) Math.toRadians(-0.38281));
        this.rightWing3.rotationPointX = this.rightWing3.rotationPointX + (float)(0.05);
        this.rightWing3.rotationPointY = this.rightWing3.rotationPointY - (float)(0.05);
        this.rightWing3.rotationPointZ = this.rightWing3.rotationPointZ + (float)(0.275);


        this.setRotateAngle(rightWing4, rightWing4.rotateAngleX + (float) Math.toRadians(181.48657), rightWing4.rotateAngleY + (float) Math.toRadians(7.74881), rightWing4.rotateAngleZ + (float) Math.toRadians(-0.13669));
        this.rightWing4.rotationPointX = this.rightWing4.rotationPointX + (float)(0);
        this.rightWing4.rotationPointY = this.rightWing4.rotationPointY - (float)(0);
        this.rightWing4.rotationPointZ = this.rightWing4.rotationPointZ + (float)(0);


        this.setRotateAngle(leftWing, leftWing.rotateAngleX + (float) Math.toRadians(1.49322), leftWing.rotateAngleY + (float) Math.toRadians(71.50213), leftWing.rotateAngleZ + (float) Math.toRadians(-0.1633));
        this.leftWing.rotationPointX = this.leftWing.rotationPointX + (float)(-0.225);
        this.leftWing.rotationPointY = this.leftWing.rotationPointY - (float)(0);
        this.leftWing.rotationPointZ = this.leftWing.rotationPointZ + (float)(-0.175);


        this.setRotateAngle(leftWing2, leftWing2.rotateAngleX + (float) Math.toRadians(180), leftWing2.rotateAngleY + (float) Math.toRadians(0), leftWing2.rotateAngleZ + (float) Math.toRadians(0));
        ...
        this.setRotateAngle(leftWing3, leftWing3.rotateAngleX + (float) Math.toRadians(181.185), leftWing3.rotateAngleY + (float) Math.toRadians(-13.74689), leftWing3.rotateAngleZ + (float) Math.toRadians(0.13188));
        this.leftWing3.rotationPointX = this.leftWing3.rotationPointX + (float)(0.05);
        this.leftWing3.rotationPointY = this.leftWing3.rotationPointY - (float)(0.05);
        this.leftWing3.rotationPointZ = this.leftWing3.rotationPointZ + (float)(0.275);


        this.setRotateAngle(leftWing4, leftWing4.rotateAngleX + (float) Math.toRadians(181.48657), leftWing4.rotateAngleY + (float) Math.toRadians(-7.74881), leftWing4.rotateAngleZ + (float) Math.toRadians(0.13669));
        this.leftWing4.rotationPointX = this.leftWing4.rotationPointX + (float)(0);
        this.leftWing4.rotationPointY = this.leftWing4.rotationPointY - (float)(0);
        this.leftWing4.rotationPointZ = this.leftWing4.rotationPointZ + (float)(0);
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.setRotateAngle(tail, tail.rotateAngleX + (float) Math.toRadians(-8.25-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*480/0.5-50))*1), tail.rotateAngleY + (float) Math.toRadians(-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*480))*7), tail.rotateAngleZ + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*480))*-4));


        this.setRotateAngle(tail2, tail2.rotateAngleX + (float) Math.toRadians(5), tail2.rotateAngleY + (float) Math.toRadians(-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*480+80))*7), tail2.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(tail3, tail3.rotateAngleX + (float) Math.toRadians(5.25), tail3.rotateAngleY + (float) Math.toRadians(-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*480+100))*-7), tail3.rotateAngleZ + (float) Math.toRadians(0));
