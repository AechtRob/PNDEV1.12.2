...
public class ModelBanffia extends ModelBasePalaeopedia {
    ...
    public void renderStaticBook(float f) {
        ...
        this.setRotateAngle(body3, 0.0F, 0.0F, 0.3F);
        this.setRotateAngle(body4, 0.0F, 0.0F, 0.3F);
        this.setRotateAngle(body5, 0.0F, 0.2F, 0.3F);
        this.setRotateAngle(body6, 0.0F, 0.0F, 0.2F);
        this.setRotateAngle(body7, 0.0F, 0.0F, 0.2F);
