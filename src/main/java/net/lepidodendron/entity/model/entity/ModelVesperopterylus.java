...
public class ModelVesperopterylus extends ModelBasePalaeopedia {
    ...
    public ModelVesperopterylus() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.main = new AdvancedModelRenderer(this);
        this.main.setRotationPoint(0.0F, 16.25F, -2.5F);
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 47, 42, -1.05F, -0.5F, -1.375F, 1, 1, 3, 0.01F, false));
        ...
        this.back.setRotationPoint(0.5F, 1.0F, 1.5F);
        this.main.addChild(back);
        this.back.cubeList.add(new ModelBox(back, 38, 38, -2.5F, -2.5F, 0.0F, 4, 5, 2, 0.0F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.5F, -0.75F, 2.5F);
        this.back.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.2182F, 0.0F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 13, 42, -1.5F, -1.0F, -1.5F, 3, 3, 3, 0.0F, false));

        this.leftleg = new AdvancedModelRenderer(this);
        this.leftleg.setRotationPoint(1.2875F, 0.5F, 2.65F);
        this.back.addChild(leftleg);
        ...
        this.rightleg.setRotationPoint(-2.2875F, 0.5F, 2.65F);
        this.back.addChild(rightleg);
        ...
        this.tail.setRotationPoint(-0.5F, -0.65F, 4.8F);
        this.back.addChild(tail);
        ...
        this.tail2.cubeList.add(new ModelBox(tail2, 23, 52, -0.5F, -0.5F, 0.0F, 1, 1, 3, 0.0F, false));
        ...
        this.head.cubeList.add(new ModelBox(head, 47, 48, 0.525F, 1.8F, -5.575F, 0, 1, 3, 0.0F, false));
        ...
        this.head.cubeList.add(new ModelBox(head, 47, 48, -1.525F, 1.8F, -5.575F, 0, 1, 3, 0.0F, true));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 49, 51, -0.975F, -2.0F, -1.725F, 0, 2, 2, 0.0F, true));
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 49, 51, 0.975F, -2.0F, -1.725F, 0, 2, 2, 0.0F, false));
