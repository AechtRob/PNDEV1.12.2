...
public class ModelParadoxides extends AdvancedModelBase {
    ...
    public ModelParadoxides() {
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 16, 0, -5.3F, -0.75F, -7.75F, 1, 0, 12, 0.0F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.head.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 0.0436F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 16, 0, 4.3F, -0.75F, -7.75F, 1, 0, 12, 0.0F, false));
        ...
        this.body4.cubeList.add(new ModelBox(body4, 10, 23, -1.01F, -0.74F, 0.0F, 2, 1, 2, 0.0F, false));
        this.body4.cubeList.add(new ModelBox(body4, 0, 22, -1.99F, -0.6F, -0.01F, 4, 1, 2, 0.0F, false));
        ...
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 2, -0.85F, -0.49F, 2.05F, 1, 0, 2, 0.0F, false));
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 2, -1.6F, -0.5F, 1.55F, 1, 0, 2, 0.0F, false));
        ...
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 0, 0.85F, -0.5F, 1.55F, 1, 0, 2, 0.0F, false));
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 0, -0.15F, -0.49F, 2.05F, 1, 0, 2, 0.0F, false));
        ...
        this.legL6.cubeList.add(new ModelBox(legL6, 20, 20, 0.0F, 0.01F, -0.5F, 4, 0, 1, 0.0F, false));
        ...
        this.legR6.cubeList.add(new ModelBox(legR6, 9, 22, -4.0F, 0.01F, -0.5F, 4, 0, 1, 0.0F, false));

        this.body5 = new AdvancedModelRenderer(this);
        this.body5.setRotationPoint(0.0F, 0.0F, 2.0F);
        this.body4.addChild(body5);
        this.body5.cubeList.add(new ModelBox(body5, 10, 23, -1.0F, -0.75F, 0.0F, 2, 1, 2, 0.0F, false));
        this.body5.cubeList.add(new ModelBox(body5, 0, 22, -2.0F, -0.5F, -0.01F, 4, 1, 2, 0.0F, false));
        ...
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 2, -0.85F, -0.49F, 1.3F, 1, 0, 2, 0.0F, false));
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 0, 2, -1.6F, -0.5F, 1.05F, 1, 0, 2, 0.0F, false));
        ...
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 0, 0.6F, -0.5F, 1.05F, 1, 0, 2, 0.0F, false));
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 0, -0.15F, -0.49F, 1.3F, 1, 0, 2, 0.0F, false));

        this.legR7 = new AdvancedModelRenderer(this);
        this.legR7.setRotationPoint(-0.25F, 0.5F, 1.0F);
        ...
        this.legL7.setRotationPoint(0.25F, 0.5F, 1.0F);
        ...
        this.body6.cubeList.add(new ModelBox(body6, 16, 22, -1.0F, -0.5F, 0.0F, 2, 1, 2, 0.0F, false));
        this.body6.cubeList.add(new ModelBox(body6, 0, 17, -1.5F, 0.0F, 0.0F, 3, 0, 5, 0.0F, false));
        ...
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 0, 2, -0.1F, -0.48F, 2.05F, 1, 0, 2, 0.0F, false));
        ...
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 2, -0.6F, -0.49F, 1.05F, 1, 0, 2, 0.0F, false));
        ...
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 0, 0, -0.9F, -0.48F, 2.05F, 1, 0, 2, 0.0F, false));
        ...
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 0, -0.4F, -0.49F, 1.05F, 1, 0, 2, 0.0F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (isAtBottom) {
            ...
            this.flap(legL7, 0.5F, -0.5F, false, 1.0F, -0.5F, f2, 0.3F);
            this.flap(legR7, 0.5F, 0.5F, false, 1.0F, 0.5F, f2, 0.3F);
            this.flap(legL8, 0.5F, -0.5F, false, 0.0F, -0.5F, f2, 0.3F);
            this.flap(legR8, 0.5F, 0.5F, false, 0.0F, 0.5F, f2, 0.3F);
            ...
            this.flap(legL7, 0.2F, -0.5F, false, 1.0F, -0.5F, f2, 0.3F);
            this.flap(legR7, 0.2F, 0.5F, false, 1.0F, 0.5F, f2, 0.3F);
            this.flap(legL8, 0.2F, -0.5F, false, 0.0F, -0.5F, f2, 0.3F);
            this.flap(legR8, 0.2F, 0.5F, false, 0.0F, 0.5F, f2, 0.3F);
        ...
        if (f3 != 0.0F) {
            this.swing(tailL, 0.6F, -0.4F, false, 0, 0.4F, f2, 0.6F);
            this.swing(tailR, 0.6F, 0.4F, false, 0, -0.4F, f2, 0.6F);
        }
    }
}
