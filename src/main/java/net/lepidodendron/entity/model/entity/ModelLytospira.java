...
public class ModelLytospira extends ModelBasePalaeopedia {
    ...
    public ModelLytospira() {
        this.textureWidth = 25;
        this.textureHeight = 25;

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 23.0F, -2.5F);
        this.body.cubeList.add(new ModelBox(body, 0, 4, -1.5F, 0.0F, -2.0F, 3, 1, 4, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 16, 11, -1.0F, 0.0F, -3.0F, 2, 1, 1, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 9, 12, -1.0F, -0.75F, -1.45F, 2, 1, 3, 0.0F, false));

        this.tail = new AdvancedModelRenderer(this);
        this.tail.setRotationPoint(1.0F, 1.0F, 2.5F);
        this.body.addChild(tail);
        this.tail.cubeList.add(new ModelBox(tail, 10, 16, -2.0F, -0.99F, -0.5F, 2, 1, 1, 0.0F, false));
        ...
        this.shell.cubeList.add(new ModelBox(shell, 10, 0, -1.0F, -1.9062F, -0.1858F, 2, 2, 4, 0.04F, false));
        this.shell.cubeList.add(new ModelBox(shell, 0, 0, 1.6F, -0.9062F, 1.7142F, 5, 0, 4, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(3.9378F, -1.4062F, 7.1742F);
        this.shell.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.0F, 2.1817F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 15, 0.0F, 0.0F, 0.0F, 1, 1, 3, -0.01F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(4.1378F, -1.4062F, 7.4492F);
        this.shell.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 2.1817F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 5, 16, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(1.1492F, -0.9062F, 7.1878F);
        this.shell.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 1.4835F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 11, 6, 0.0F, -1.0F, 0.0F, 2, 2, 3, -0.04F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.0F, -0.9062F, 3.8142F);
        this.shell.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 0.5672F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 9, 0.0F, -1.0F, 0.0F, 2, 2, 4, -0.01F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
       ...
       // this.snail.offsetY = 0.83F;
        ...
        EntityPrehistoricFloraLytospira ee = (EntityPrehistoricFloraLytospira) e;
