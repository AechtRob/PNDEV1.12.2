...
public class ModelTurboscinetes extends AdvancedModelBase {
    ...
    public void renderStaticWall(float f) {
        ...
        this.Turboscinetes.offsetY = -0.13F;
        this.Turboscinetes.offsetX = -0.06F;
        this.Turboscinetes.render(0.01F);
        resetToDefaultPose();
    }
    public void renderStaticFloor(float f) {
        this.setRotateAngle(Turboscinetes, 0.7418F, (float) Math.toRadians(90), 0.0F);
        ...
        //this.body.offsetX = -0.09F;
        this.Turboscinetes.offsetY = -0.13F;
        this.Turboscinetes.offsetZ = -0.04F;
        this.Turboscinetes.offsetX = -0.06F;
        this.Turboscinetes.render(0.01F);
        resetToDefaultPose();
    }
