...
public class ModelFurca extends ModelBasePalaeopedia {
    ...
    public ModelFurca() {
        ...
        this.body.cubeList.add(new ModelBox(body, 21, 33, -3.5F, -4.4F, -9.75F, 7, 1, 1, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, -3, 48, -4.5F, -4.15F, -11.25F, 9, 0, 3, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 13, -0.5F, -3.85F, -6.0F, 1, 1, 7, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(1.0F, -4.25F, -5.75F);
        this.body.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.0F, 0.2618F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 21, 40, -0.35F, -0.15F, -0.5F, 1, 1, 5, 0.0F, true));
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 35, 43, -0.85F, 0.2F, -0.5F, 3, 0, 6, 0.0F, true));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(1.5F, -4.5F, -8.75F);
        this.body.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, -0.3491F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 21, 37, 0.0F, 0.1F, 0.0F, 2, 1, 1, 0.0F, true));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(1.5F, -4.5F, -8.75F);
        this.body.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, -1.0472F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 28, 37, 1.5F, 0.11F, -1.25F, 4, 1, 1, 0.0F, true));
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 21, 47, 0.5F, 0.36F, -2.25F, 6, 0, 3, 0.0F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.5F, -4.5F, -8.75F);
        this.body.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 1.0472F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 21, 47, -6.5F, 0.36F, -2.25F, 6, 0, 3, 0.0F, false));
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 28, 37, -5.5F, 0.11F, -1.25F, 4, 1, 1, 0.0F, false));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(-1.5F, -4.5F, -8.75F);
        this.body.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.3491F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 21, 37, -2.0F, 0.1F, 0.0F, 2, 1, 1, 0.0F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-1.0F, -4.25F, -5.75F);
        this.body.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, -0.2618F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 35, 43, -2.15F, 0.2F, -0.5F, 3, 0, 6, 0.0F, false));
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 21, 40, -0.65F, -0.15F, -0.5F, 1, 1, 5, 0.0F, false));
