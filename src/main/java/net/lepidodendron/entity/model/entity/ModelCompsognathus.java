...
public class ModelCompsognathus extends AdvancedModelBaseExtended {
    ...
    public void renderStaticBook(float f) {
        this.Compsognathus.offsetY = -1F;
        this.Compsognathus.offsetX = 0.2F;
        this.Compsognathus.rotateAngleY = (float)Math.toRadians(180);
        this.Compsognathus.rotateAngleX = (float)Math.toRadians(5);
        this.Compsognathus.rotateAngleZ = (float)Math.toRadians(-5);
