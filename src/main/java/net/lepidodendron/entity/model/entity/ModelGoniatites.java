...
public class ModelGoniatites extends ModelBasePalaeopedia {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraAmmonite_Goniatites prot = (EntityPrehistoricFloraAmmonite_Goniatites) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraAmmonite_Goniatites ee = (EntityPrehistoricFloraAmmonite_Goniatites) entitylivingbaseIn;
            //Swimming pose:
        ...
        if ((!ee.isReallySwimming()) && (ee.getAnimation() != ee.UNSWIM_ANIMATION)) {
            ...
            this.Root.rotateAngleX = (float) Math.toRadians(25);
            ...
            this.setRotateAngle(Shell8, 0.7418F, 0.0F, 0.0F);
            this.setRotateAngle(Shell9, 0.7418F, 0.0F, 0.0F);
            this.setRotateAngle(Siphon, 0.829F, 0.0F, 0.0F);
            this.setRotateAngle(Tentacle10a, -0.131F, 0.0433F, -0.0057F);
            this.setRotateAngle(Tentacle10b, 0.0218F, 0.0F, 0.0F);
            this.setRotateAngle(Tentacle10c, 0.048F, -0.0261F, -0.0013F);
            this.setRotateAngle(Tentacle15c, 0.048F, 0.0262F, -0.0013F);
            this.setRotateAngle(Tentacle1a, 0.2706F, -0.0252F, -0.007F);
            this.setRotateAngle(Tentacle1b, -0.1135F, 0.0173F, -0.002F);
            this.setRotateAngle(Tentacle1c, -0.1224F, -0.0379F, -0.0102F);
            this.setRotateAngle(Tentacle2a, 0.1266F, 0.0567F, -1.0227F);
            this.setRotateAngle(Tentacle2b, -0.0306F, -0.0218F, -0.0007F);
            this.setRotateAngle(Tentacle2c, -0.0393F, 0.0174F, -0.0007F);
            this.setRotateAngle(Tentacle3a, 0.096F, -0.2967F, 0.0F);
            this.setRotateAngle(Tentacle3b, -0.0175F, 0.1702F, 0.0F);
            this.setRotateAngle(Tentacle3c, 0.0218F, 0.0524F, 0.0F);
            this.setRotateAngle(Tentacle4a, -0.0864F, -0.0996F, 1.1482F);
            this.setRotateAngle(Tentacle4b, -0.0611F, -0.0131F, 0.0F);
            this.setRotateAngle(Tentacle4c, 0.1004F, -0.0347F, 0.0035F);
            this.setRotateAngle(Tentacle5a, -0.1309F, -0.0649F, 0.0086F);
            this.setRotateAngle(Tentacle5b, 0.0218F, -0.0131F, -0.0003F);
            this.setRotateAngle(Tentacle6a, 0.2706F, -0.0252F, -0.007F);
            this.setRotateAngle(Tentacle6b, -0.1135F, 0.0173F, -0.002F);
            this.setRotateAngle(Tentacle6c, -0.1224F, 0.0379F, -0.0102F);
            this.setRotateAngle(Tentacle7a, 0.1266F, -0.0567F, 1.0227F);
            this.setRotateAngle(Tentacle7b, -0.0306F, 0.0218F, -0.0007F);
            this.setRotateAngle(Tentacle7c, -0.0393F, 0.0174F, -0.0007F);
            this.setRotateAngle(Tentacle8a, 0.096F, 0.2967F, 0.0F);
            this.setRotateAngle(Tentacle8b, -0.0175F, -0.1702F, 0.0F);
            this.setRotateAngle(Tentacle8c, 0.0218F, -0.0524F, 0.0F);
            this.setRotateAngle(Tentacle9a, -0.0864F, 0.0996F, -1.1482F);
            this.setRotateAngle(Tentacle9b, 0.0611F, 0.0131F, 0.0F);
            this.setRotateAngle(Tentacle9c, 0.1004F, -0.0347F, -0.0035F);
            //Swimming
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, boolean isMoving) {
        EntityPrehistoricFloraAmmonite_Goniatites entity = (EntityPrehistoricFloraAmmonite_Goniatites) entitylivingbaseIn;
        int animCycle = 30;
        ...
        this.Root.rotationPointY = this.Root.rotationPointY - (float)(0.45+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*240/0.5-100))*0.1);
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            ...
            yy = 0 + (((tickAnim - 0) / 8) * (34.03038-(0)));
            zz = 0 + (((tickAnim - 0) / 8) * (-20.15458-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 16) {
            xx = -62.57336 + (((tickAnim - 8) / 8) * (-86.16148-(-62.57336)));
            yy = 34.03038 + (((tickAnim - 8) / 8) * (35.65594-(34.03038)));
    ...
    public void animSwimming(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        double yy = 0;
        double zz = 0;
        this.setRotateAngle(Root, Root.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-50))*-4), Root.rotateAngleY + (float) Math.toRadians(0), Root.rotateAngleZ + (float) Math.toRadians(0));
        this.Root.rotationPointX = this.Root.rotationPointX + (float)(0);
        this.Root.rotationPointY = this.Root.rotationPointY - (float)(0);
        this.Root.rotationPointZ = this.Root.rotationPointZ + (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*2);


        this.setRotateAngle(Mantle1, Mantle1.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*1), Mantle1.rotateAngleY + (float) Math.toRadians(0), Mantle1.rotateAngleZ + (float) Math.toRadians(0));
        this.Mantle1.rotationPointX = this.Mantle1.rotationPointX + (float)(0);
        this.Mantle1.rotationPointY = this.Mantle1.rotationPointY - (float)(0);
        this.Mantle1.rotationPointZ = this.Mantle1.rotationPointZ + (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*0.4);



        if (tickAnim >= 0 && tickAnim < 7) {
            xx = 0 + (((tickAnim - 0) / 7) * (0-(0)));
            yy = 0.275 + (((tickAnim - 0) / 7) * (0.8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1-(0.275)));
            zz = 0.2 + (((tickAnim - 0) / 7) * (0.725+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1-(0.2)));
        }
        else if (tickAnim >= 7 && tickAnim < 18) {
            xx = 0 + (((tickAnim - 7) / 11) * (0-(0)));
            yy = 0.8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1 + (((tickAnim - 7) / 11) * (-0.33-(0.8+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1)));
            zz = 0.725+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1 + (((tickAnim - 7) / 11) * (-0.095-(0.725+Math.sin((Math.PI/180)*(((double)tickAnim/20)*120-50))*-1)));
        }
        else if (tickAnim >= 18 && tickAnim < 23) {
            xx = 0 + (((tickAnim - 18) / 5) * (0-(0)));
            yy = -0.33 + (((tickAnim - 18) / 5) * (0.275-(-0.33)));
            zz = -0.095 + (((tickAnim - 18) / 5) * (0.2-(-0.095)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 8) {
            xx = 7.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10 + (((tickAnim - 0) / 8) * (19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10-(7.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10)));
            yy = 0 + (((tickAnim - 0) / 8) * (2.11658-(0)));
            zz = 0 + (((tickAnim - 0) / 8) * (0.76333-(0)));
        }
        else if (tickAnim >= 8 && tickAnim < 23) {
            xx = 19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10 + (((tickAnim - 8) / 15) * (7.75+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10-(19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10)));
            yy = 2.11658 + (((tickAnim - 8) / 15) * (0-(2.11658)));
            zz = 0.76333 + (((tickAnim - 8) / 15) * (0-(0.76333)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        this.setRotateAngle(Tentacle1b, Tentacle1b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*-30), Tentacle1b.rotateAngleY + (float) Math.toRadians(0), Tentacle1b.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle1c, Tentacle1c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*-40), Tentacle1c.rotateAngleY + (float) Math.toRadians(0), Tentacle1c.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle2a, Tentacle2a.rotateAngleX + (float) Math.toRadians(14.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*-10), Tentacle2a.rotateAngleY + (float) Math.toRadians(0), Tentacle2a.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle2b, Tentacle2b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*-30), Tentacle2b.rotateAngleY + (float) Math.toRadians(0), Tentacle2b.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle2c, Tentacle2c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*-40), Tentacle2c.rotateAngleY + (float) Math.toRadians(0), Tentacle2c.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle3a, Tentacle3a.rotateAngleX + (float) Math.toRadians(0), Tentacle3a.rotateAngleY + (float) Math.toRadians(-11+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+30))*10), Tentacle3a.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle3b, Tentacle3b.rotateAngleX + (float) Math.toRadians(0), Tentacle3b.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*30), Tentacle3b.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle3c, Tentacle3c.rotateAngleX + (float) Math.toRadians(0), Tentacle3c.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*40), Tentacle3c.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle4a, Tentacle4a.rotateAngleX + (float) Math.toRadians(-14.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*10), Tentacle4a.rotateAngleY + (float) Math.toRadians(0), Tentacle4a.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle4b, Tentacle4b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*30), Tentacle4b.rotateAngleY + (float) Math.toRadians(0), Tentacle4b.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle4c, Tentacle4c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*40), Tentacle4c.rotateAngleY + (float) Math.toRadians(0), Tentacle4c.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle5a, Tentacle5a.rotateAngleX + (float) Math.toRadians(-7.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*10), Tentacle5a.rotateAngleY + (float) Math.toRadians(0), Tentacle5a.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle5b, Tentacle5b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*30), Tentacle5b.rotateAngleY + (float) Math.toRadians(0), Tentacle5b.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(Tentacle15c, Tentacle15c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*40), Tentacle15c.rotateAngleY + (float) Math.toRadians(0), Tentacle15c.rotateAngleZ + (float) Math.toRadians(0));



        if (tickAnim >= 0 && tickAnim < 8) {
            xx = 7.7448+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10 + (((tickAnim - 0) / 8) * (19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10-(7.7448+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10)));
            yy = 2.11658 + (((tickAnim - 0) / 8) * (2.11658-(2.11658)));
            zz = 0.76333 + (((tickAnim - 0) / 8) * (0.76333-(0.76333)));
        }
        else if (tickAnim >= 8 && tickAnim < 23) {
            xx = 19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10 + (((tickAnim - 8) / 15) * (7.7448+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10-(19.3222+Math.sin((Math.PI/180)*(((double)tickAnim/20)*320+20))*-10)));
            yy = 2.11658 + (((tickAnim - 8) / 15) * (2.11658-(2.11658)));
            zz = 0.76333 + (((tickAnim - 8) / 15) * (0.76333-(0.76333)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        this.setRotateAngle(Tentacle6a, Tentacle6a.rotateAngleX + (float) Math.toRadians(xx), Tentacle6a.rotateAngleY + (float) Math.toRadians(yy), Tentacle6a.rotateAngleZ + (float) Math.toRadians(zz));
        this.setRotateAngle(Tentacle6b, Tentacle6b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*-30), Tentacle6b.rotateAngleY + (float) Math.toRadians(0), Tentacle6b.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle6c, Tentacle6c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*-40), Tentacle6c.rotateAngleY + (float) Math.toRadians(0), Tentacle6c.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle7a, Tentacle7a.rotateAngleX + (float) Math.toRadians(14.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*-10), Tentacle7a.rotateAngleY + (float) Math.toRadians(0), Tentacle7a.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle7b, Tentacle7b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*-30), Tentacle7b.rotateAngleY + (float) Math.toRadians(0), Tentacle7b.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle7c, Tentacle7c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*-40), Tentacle7c.rotateAngleY + (float) Math.toRadians(0), Tentacle7c.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle8a, Tentacle8a.rotateAngleX + (float) Math.toRadians(0), Tentacle8a.rotateAngleY + (float) Math.toRadians(11+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+30))*-10), Tentacle8a.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle8b, Tentacle8b.rotateAngleX + (float) Math.toRadians(0), Tentacle8b.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*-30), Tentacle8b.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle8c, Tentacle8c.rotateAngleX + (float) Math.toRadians(0), Tentacle8c.rotateAngleY + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*-40), Tentacle8c.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle9a, Tentacle9a.rotateAngleX + (float) Math.toRadians(-14.5+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*10), Tentacle9a.rotateAngleY + (float) Math.toRadians(0), Tentacle9a.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle9b, Tentacle9b.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*30), Tentacle9b.rotateAngleY + (float) Math.toRadians(0), Tentacle9b.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle9c, Tentacle9c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*40), Tentacle9c.rotateAngleY + (float) Math.toRadians(0), Tentacle9c.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle10a, Tentacle10a.rotateAngleX + (float) Math.toRadians(-7.75+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320+20))*10), Tentacle10a.rotateAngleY + (float) Math.toRadians(0), Tentacle10a.rotateAngleZ + (float) Math.toRadians(0));
        this.setRotateAngle(Tentacle10b, Tentacle10b.rotateAngleX + (float) Math.toRadians(Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*30), Tentacle10b.rotateAngleY + (float) Math.toRadians(0.49988), Tentacle10b.rotateAngleZ + (float) Math.toRadians(0.01091));
        this.setRotateAngle(Tentacle10c, Tentacle10c.rotateAngleX + (float) Math.toRadians(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320-90))*40), Tentacle10c.rotateAngleY + (float) Math.toRadians(0), Tentacle10c.rotateAngleZ + (float) Math.toRadians(0));
        this.Shell1.rotationPointX = this.Shell1.rotationPointX + (float)(0);
        this.Shell1.rotationPointY = this.Shell1.rotationPointY - (float)(0);
        this.Shell1.rotationPointZ = this.Shell1.rotationPointZ + (float)(0+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*320))*0.2);
    ...
    public void animAttack(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, double animTick) {
        ...
        double zz = 0;
         if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (5.275+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90-20))*2-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = 5.275+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90-20))*2 + (((tickAnim - 13) / 17) * (13.5-(5.275+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90-20))*2)));
            yy = 0 + (((tickAnim - 13) / 17) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 17) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = 13.5 + (((tickAnim - 30) / 25) * (13.875+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*0.5-(13.5)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 66) {
            xx = 13.875+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*0.5 + (((tickAnim - 55) / 11) * (3.25+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*-5-(13.875+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*0.5)));
            yy = 0 + (((tickAnim - 55) / 11) * (0-(0)));
            zz = 0 + (((tickAnim - 55) / 11) * (0-(0)));
        }
        else if (tickAnim >= 66 && tickAnim < 75) {
            xx = 3.25+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*-5 + (((tickAnim - 66) / 9) * (0-(3.25+Math.sin((Math.PI/180)*(((double)tickAnim/20)*90))*-5)));
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            ...
            yy = 0 + (((tickAnim - 0) / 13) * (1.95-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 13) / 17) * (0-(0)));
            yy = 1.95 + (((tickAnim - 13) / 17) * (3.075-(1.95)));
            zz = 0 + (((tickAnim - 13) / 17) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            yy = 3.075 + (((tickAnim - 30) / 25) * (3.075-(3.075)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = 0 + (((tickAnim - 55) / 20) * (0-(0)));
            yy = 3.075 + (((tickAnim - 55) / 20) * (0-(3.075)));
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (-24-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (0-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = -24 + (((tickAnim - 13) / 17) * (-18.25-(-24)));
            yy = 0 + (((tickAnim - 13) / 17) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 17) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = -18.25 + (((tickAnim - 30) / 25) * (-18.25-(-18.25)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -18.25 + (((tickAnim - 55) / 20) * (0-(-18.25)));
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (-15.4863-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (21.73994-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (17.61108-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = -15.4863 + (((tickAnim - 13) / 17) * (-9.9863-(-15.4863)));
            yy = 21.73994 + (((tickAnim - 13) / 17) * (21.73994-(21.73994)));
            zz = 17.61108 + (((tickAnim - 13) / 17) * (17.61108-(17.61108)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = -9.9863 + (((tickAnim - 30) / 25) * (-9.9863-(-9.9863)));
            yy = 21.73994 + (((tickAnim - 30) / 25) * (21.73994-(21.73994)));
            zz = 17.61108 + (((tickAnim - 30) / 25) * (17.61108-(17.61108)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -9.9863 + (((tickAnim - 55) / 20) * (0-(-9.9863)));
            yy = 21.73994 + (((tickAnim - 55) / 20) * (0-(21.73994)));
            zz = 17.61108 + (((tickAnim - 55) / 20) * (0-(17.61108)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (25.88062-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (21.58256-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (-11.57963-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = 25.88062 + (((tickAnim - 13) / 17) * (31.537-(25.88062)));
            yy = 21.58256 + (((tickAnim - 13) / 17) * (16.81466-(21.58256)));
            zz = -11.57963 + (((tickAnim - 13) / 17) * (-23.47441-(-11.57963)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = 31.537 + (((tickAnim - 30) / 25) * (31.537-(31.537)));
            yy = 16.81466 + (((tickAnim - 30) / 25) * (16.81466-(16.81466)));
            zz = -23.47441 + (((tickAnim - 30) / 25) * (-23.47441-(-23.47441)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = 31.537 + (((tickAnim - 55) / 20) * (0-(31.537)));
            yy = 16.81466 + (((tickAnim - 55) / 20) * (0-(16.81466)));
            zz = -23.47441 + (((tickAnim - 55) / 20) * (0-(-23.47441)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            ...
            xx = -20.25 + (((tickAnim - 30) / 25) * (-20.25-(-20.25)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -20.25 + (((tickAnim - 55) / 20) * (0-(-20.25)));
            yy = 0 + (((tickAnim - 55) / 20) * (0-(0)));
            zz = 0 + (((tickAnim - 55) / 20) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 0) / 30) * (-18.56175-(0)));
            yy = 0 + (((tickAnim - 0) / 30) * (-11.74116-(0)));
            zz = 0 + (((tickAnim - 0) / 30) * (-0.49383-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 35) {
            xx = -18.56175 + (((tickAnim - 30) / 5) * (0.25-(-18.56175)));
            yy = -11.74116 + (((tickAnim - 30) / 5) * (0-(-11.74116)));
            zz = -0.49383 + (((tickAnim - 30) / 5) * (0-(-0.49383)));
        }
        else if (tickAnim >= 35 && tickAnim < 39) {
            xx = 0.25 + (((tickAnim - 35) / 4) * (-16.25-(0.25)));
            yy = 0 + (((tickAnim - 35) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 35) / 4) * (0-(0)));
        }
        else if (tickAnim >= 39 && tickAnim < 43) {
            xx = -16.25 + (((tickAnim - 39) / 4) * (-16.25-(-16.25)));
            yy = 0 + (((tickAnim - 39) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 39) / 4) * (0-(0)));
        }
        else if (tickAnim >= 43 && tickAnim < 55) {
            xx = -16.25 + (((tickAnim - 43) / 12) * (-18.56175-(-16.25)));
            yy = 0 + (((tickAnim - 43) / 12) * (-11.74116-(0)));
            zz = 0 + (((tickAnim - 43) / 12) * (-0.49383-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -18.56175 + (((tickAnim - 55) / 20) * (0-(-18.56175)));
            yy = -11.74116 + (((tickAnim - 55) / 20) * (0-(-11.74116)));
            zz = -0.49383 + (((tickAnim - 55) / 20) * (0-(-0.49383)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 30 && tickAnim < 35) {
            xx = 0 + (((tickAnim - 30) / 5) * (110.25-(0)));
            yy = 0 + (((tickAnim - 30) / 5) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 5) * (0-(0)));
        }
        else if (tickAnim >= 35 && tickAnim < 39) {
            xx = 110.25 + (((tickAnim - 35) / 4) * (0-(110.25)));
            yy = 0 + (((tickAnim - 35) / 4) * (0-(0)));
            zz = 0 + (((tickAnim - 35) / 4) * (0-(0)));
        }
        else if (tickAnim >= 39 && tickAnim < 43) {
        ...
        if (tickAnim >= 30 && tickAnim < 35) {
            xx = 0 + (((tickAnim - 30) / 5) * (106.07521-(0)));
            yy = 0 + (((tickAnim - 30) / 5) * (18.74559-(0)));
            zz = 0 + (((tickAnim - 30) / 5) * (50.96658-(0)));
        }
        else if (tickAnim >= 35 && tickAnim < 39) {
            xx = 106.07521 + (((tickAnim - 35) / 4) * (0-(106.07521)));
            yy = 18.74559 + (((tickAnim - 35) / 4) * (0-(18.74559)));
            zz = 50.96658 + (((tickAnim - 35) / 4) * (0-(50.96658)));
        }
        else if (tickAnim >= 39 && tickAnim < 43) {
            xx = 0 + (((tickAnim - 39) / 4) * (0-(0)));
            yy = 0 + (((tickAnim - 39) / 4) * (0-(0)));
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            ...
            xx = -7.5 + (((tickAnim - 30) / 25) * (-7.5-(-7.5)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -7.5 + (((tickAnim - 55) / 20) * (0-(-7.5)));
            yy = 0 + (((tickAnim - 55) / 20) * (0-(0)));
            zz = 0 + (((tickAnim - 55) / 20) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            ...
            xx = -37.25 + (((tickAnim - 13) / 17) * (-24-(-37.25)));
            yy = 0 + (((tickAnim - 13) / 17) * (0-(0)));
            zz = 0 + (((tickAnim - 13) / 17) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = -24 + (((tickAnim - 30) / 25) * (-24-(-24)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -24 + (((tickAnim - 55) / 20) * (0-(-24)));
            yy = 0 + (((tickAnim - 55) / 20) * (0-(0)));
            zz = 0 + (((tickAnim - 55) / 20) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (-7.75636-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (-27.85303-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (-25.90207-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = -7.75636 + (((tickAnim - 13) / 17) * (-1.75636-(-7.75636)));
            yy = -27.85303 + (((tickAnim - 13) / 17) * (-27.85303-(-27.85303)));
            zz = -25.90207 + (((tickAnim - 13) / 17) * (-25.90207-(-25.90207)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = -1.75636 + (((tickAnim - 30) / 25) * (-1.75636-(-1.75636)));
            yy = -27.85303 + (((tickAnim - 30) / 25) * (-27.85303-(-27.85303)));
            zz = -25.90207 + (((tickAnim - 30) / 25) * (-25.90207-(-25.90207)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -1.75636 + (((tickAnim - 55) / 20) * (0-(-1.75636)));
            yy = -27.85303 + (((tickAnim - 55) / 20) * (0-(-27.85303)));
            zz = -25.90207 + (((tickAnim - 55) / 20) * (0-(-25.90207)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 13) {
            xx = 0 + (((tickAnim - 0) / 13) * (27.51582-(0)));
            yy = 0 + (((tickAnim - 0) / 13) * (-15.71782-(0)));
            zz = 0 + (((tickAnim - 0) / 13) * (5.96183-(0)));
        }
        else if (tickAnim >= 13 && tickAnim < 30) {
            xx = 27.51582 + (((tickAnim - 13) / 17) * (35.59029-(27.51582)));
            yy = -15.71782 + (((tickAnim - 13) / 17) * (-11.00703-(-15.71782)));
            zz = 5.96183 + (((tickAnim - 13) / 17) * (20.29412-(5.96183)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = 35.59029 + (((tickAnim - 30) / 25) * (35.59029-(35.59029)));
            yy = -11.00703 + (((tickAnim - 30) / 25) * (-11.00703-(-11.00703)));
            zz = 20.29412 + (((tickAnim - 30) / 25) * (20.29412-(20.29412)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = 35.59029 + (((tickAnim - 55) / 20) * (0-(35.59029)));
            yy = -11.00703 + (((tickAnim - 55) / 20) * (0-(-11.00703)));
            zz = 20.29412 + (((tickAnim - 55) / 20) * (0-(20.29412)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 0) / 30) * (-17.25-(0)));
            yy = 0 + (((tickAnim - 0) / 30) * (0-(0)));
            zz = 0 + (((tickAnim - 0) / 30) * (0-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 55) {
            xx = -17.25 + (((tickAnim - 30) / 25) * (-17.25-(-17.25)));
            yy = 0 + (((tickAnim - 30) / 25) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 25) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -17.25 + (((tickAnim - 55) / 20) * (0-(-17.25)));
            yy = 0 + (((tickAnim - 55) / 20) * (0-(0)));
            zz = 0 + (((tickAnim - 55) / 20) * (0-(0)));
        }
        else {
        ...
        if (tickAnim >= 0 && tickAnim < 30) {
            xx = 0 + (((tickAnim - 0) / 30) * (-21.0241-(0)));
            yy = 0 + (((tickAnim - 0) / 30) * (9.68371-(0)));
            zz = 0 + (((tickAnim - 0) / 30) * (-16.27021-(0)));
        }
        else if (tickAnim >= 30 && tickAnim < 43) {
            xx = -21.0241 + (((tickAnim - 30) / 13) * (-0.5-(-21.0241)));
            yy = 9.68371 + (((tickAnim - 30) / 13) * (0-(9.68371)));
            zz = -16.27021 + (((tickAnim - 30) / 13) * (0-(-16.27021)));
        }
        else if (tickAnim >= 43 && tickAnim < 55) {
            xx = -0.5 + (((tickAnim - 43) / 12) * (-21.0241-(-0.5)));
            yy = 0 + (((tickAnim - 43) / 12) * (9.68371-(0)));
            zz = 0 + (((tickAnim - 43) / 12) * (-16.27021-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = -21.0241 + (((tickAnim - 55) / 20) * (0-(-21.0241)));
            yy = 9.68371 + (((tickAnim - 55) / 20) * (0-(9.68371)));
            zz = -16.27021 + (((tickAnim - 55) / 20) * (0-(-16.27021)));
        }
        else {
            xx = 0;
            yy = 0;
        ...
        if (tickAnim >= 30 && tickAnim < 43) {
            xx = 0 + (((tickAnim - 30) / 13) * (127.75-(0)));
            yy = 0 + (((tickAnim - 30) / 13) * (0-(0)));
            zz = 0 + (((tickAnim - 30) / 13) * (0-(0)));
        }
        else if (tickAnim >= 43 && tickAnim < 55) {
            xx = 127.75 + (((tickAnim - 43) / 12) * (0-(127.75)));
            yy = 0 + (((tickAnim - 43) / 12) * (0-(0)));
            zz = 0 + (((tickAnim - 43) / 12) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
        ...
        if (tickAnim >= 30 && tickAnim < 43) {
            xx = 0 + (((tickAnim - 30) / 13) * (56.5-(0)));
            yy = 0 + (((tickAnim - 30) / 13) * (-52.5-(0)));
            zz = 0 + (((tickAnim - 30) / 13) * (0-(0)));
        }
        else if (tickAnim >= 43 && tickAnim < 55) {
            xx = 56.5 + (((tickAnim - 43) / 12) * (0-(56.5)));
            yy = -52.5 + (((tickAnim - 43) / 12) * (0-(-52.5)));
            zz = 0 + (((tickAnim - 43) / 12) * (0-(0)));
        }
        else if (tickAnim >= 55 && tickAnim < 75) {
            xx = 0 + (((tickAnim - 55) / 20) * (0-(0)));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraAmmonite_Goniatites e = (EntityPrehistoricFloraAmmonite_Goniatites) entity;
        ...
        animator.rotate(cube_r1, ((0.0F)-(0.0F)), ((0.1745F)-(0.1745F)),((0.0F)-(0.0F)));
        animator.rotate(cube_r2, ((0.0F)-(0.0F)), ((-0.1745F)-(-0.1745F)),((0.0F)-(0.0F)));
        animator.rotate(Mantle1, ((-0.4363F)-(-0.4363F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Mantle2, ((0.6109F)-(0.6109F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Root, ((0.0F)-(0.48F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell1, ((-0.9163F)-(-0.9163F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell2, ((0.8727F)-(0.8727F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell3, ((0.6545F)-(0.6545F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell4, ((0.7854F)-(0.7854F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell5, ((0.7854F)-(0.7854F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell6, ((0.829F)-(0.829F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell7, ((0.6981F)-(0.6981F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell8, ((0.7418F)-(0.7418F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Shell9, ((0.7418F)-(0.7418F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Siphon, ((0.829F)-(0.3054F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        animator.rotate(Tentacle10a, ((-0.131F)-(0.3646F)), ((0.0433F)-(0.2865F)),((-0.0057F)-(0.1074F)));
        animator.rotate(Tentacle10b, ((0.0218F)-(-0.4363F)), ((0.0F)-(-0.3491F)),((0.0F)-(0.0F)));
        animator.rotate(Tentacle10c, ((0.048F)-(-0.4498F)), ((-0.0261F)-(-0.2368F)),((-0.0013F)-(0.1128F)));
        animator.rotate(Tentacle15c, ((0.048F)-(-0.4498F)), ((0.0262F)-(0.2368F)),((-0.0013F)-(-0.1128F)));
        animator.rotate(Tentacle1a, ((0.2706F)-(2.0445F)), ((-0.0252F)-(0.0803F)),((-0.007F)-(-0.1551F)));
        animator.rotate(Tentacle1b, ((-0.1135F)-(0.4851F)), ((0.0173F)-(-0.4891F)),((-0.002F)-(-0.195F)));
        animator.rotate(Tentacle1c, ((-0.1224F)-(0.2618F)), ((-0.0379F)-(-0.2618F)),((-0.0102F)-(0.0F)));
        animator.rotate(Tentacle2a, ((0.1266F)-(1.8371F)), ((0.0567F)-(0.192F)),((-1.0227F)-(-0.8117F)));
        animator.rotate(Tentacle2b, ((-0.0306F)-(0.4051F)), ((-0.0218F)-(-0.2415F)),((-0.0007F)-(-0.1022F)));
        animator.rotate(Tentacle2c, ((-0.0393F)-(0.3491F)), ((0.0174F)-(-0.4363F)),((-0.0007F)-(0.0F)));
        animator.rotate(Tentacle3a, ((0.096F)-(0.6441F)), ((-0.2967F)-(-0.8287F)),((0.0F)-(-0.2838F)));
        animator.rotate(Tentacle3b, ((-0.0175F)-(-0.2618F)), ((0.1702F)-(-0.5236F)),((0.0F)-(0.0F)));
        animator.rotate(Tentacle3c, ((0.0218F)-(-0.3124F)), ((0.0524F)-(-0.2079F)),((0.0F)-(0.0666F)));
        animator.rotate(Tentacle4a, ((-0.0864F)-(-0.0579F)), ((-0.0996F)-(-0.683F)),((1.1482F)-(0.6792F)));
        animator.rotate(Tentacle4b, ((-0.0611F)-(-0.1107F)), ((-0.0131F)-(0.3736F)),((0.0F)-(-0.1239F)));
        animator.rotate(Tentacle4c, ((0.1004F)-(-0.588F)), ((-0.0347F)-(0.4478F)),((0.0035F)-(-0.281F)));
        animator.rotate(Tentacle5a, ((-0.1309F)-(0.3646F)), ((-0.0649F)-(-0.2865F)),((0.0086F)-(-0.1074F)));
        animator.rotate(Tentacle5b, ((0.0218F)-(-0.4363F)), ((-0.0131F)-(0.3491F)),((-0.0003F)-(0.0F)));
        animator.rotate(Tentacle6a, ((0.2706F)-(2.0445F)), ((-0.0252F)-(-0.0803F)),((-0.007F)-(0.1551F)));
        animator.rotate(Tentacle6b, ((-0.1135F)-(0.4851F)), ((0.0173F)-(0.4891F)),((-0.002F)-(0.195F)));
        animator.rotate(Tentacle6c, ((-0.1224F)-(0.2618F)), ((0.0379F)-(0.2618F)),((-0.0102F)-(0.0F)));
        animator.rotate(Tentacle7a, ((0.1266F)-(1.8371F)), ((-0.0567F)-(-0.192F)),((1.0227F)-(0.8117F)));
        animator.rotate(Tentacle7b, ((-0.0306F)-(0.4051F)), ((0.0218F)-(0.2415F)),((-0.0007F)-(0.1022F)));
        animator.rotate(Tentacle7c, ((-0.0393F)-(0.3491F)), ((0.0174F)-(0.4363F)),((-0.0007F)-(0.0F)));
        animator.rotate(Tentacle8a, ((0.096F)-(0.6441F)), ((0.2967F)-(0.8287F)),((0.0F)-(0.2838F)));
        animator.rotate(Tentacle8b, ((-0.0175F)-(-0.2618F)), ((-0.1702F)-(0.5236F)),((0.0F)-(0.0F)));
        animator.rotate(Tentacle8c, ((0.0218F)-(-0.3124F)), ((-0.0524F)-(0.2079F)),((0.0F)-(-0.0666F)));
        animator.rotate(Tentacle9a, ((-0.0864F)-(-0.0579F)), ((0.0996F)-(0.683F)),((-1.1482F)-(-0.6792F)));
        animator.rotate(Tentacle9b, ((0.0611F)-(-0.1107F)), ((0.0131F)-(-0.3736F)),((0.0F)-(0.1239F)));
        animator.rotate(Tentacle9c, ((0.1004F)-(-0.588F)), ((-0.0347F)-(-0.4478F)),((-0.0035F)-(0.281F)));
