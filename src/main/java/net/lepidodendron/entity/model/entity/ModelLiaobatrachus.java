...
public class ModelLiaobatrachus extends ModelBasePalaeopedia {
    ...
    public ModelLiaobatrachus() {
        ...
        this.hips.cubeList.add(new ModelBox(hips, 18, 13, -2.5F, -2.0F, 0.05F, 5, 2, 3, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(0.5F, 0.0F, 5.0F);
        this.hips.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.1658F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 22, 0, -2.0F, -1.25F, -4.5F, 3, 1, 4, -0.01F, false));
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 18, 21, -2.0F, -1.75F, -4.5F, 3, 1, 4, 0.0F, false));
        ...
        this.neck.cubeList.add(new ModelBox(neck, 22, 5, -2.5F, -0.35F, -1.45F, 5, 2, 2, 0.0F, false));
        this.neck.cubeList.add(new ModelBox(neck, 22, 9, -2.5F, 1.4F, -1.45F, 5, 1, 2, -0.01F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.0F, 0.45F, -1.5F);
        this.neck.addChild(head);
        this.setRotateAngle(head, 0.0873F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 0, 23, -1.0F, -0.5F, -3.2F, 2, 1, 4, 0.01F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(1.0F, 0.5F, -3.2F);
        this.head.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 0.6981F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 0, 34, -1.975F, -1.0F, 0.0F, 2, 1, 2, 0.0F, true));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(1.275F, 0.5F, -2.275F);
        this.head.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.2182F, 0.0F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 34, 12, -1.125F, -1.0F, 0.8F, 2, 1, 2, -0.01F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.0F, 0.5F, -3.2F);
        this.head.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, -0.6981F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 34, -0.025F, -1.0F, 0.0F, 2, 1, 2, 0.0F, false));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(-1.275F, 0.5F, -2.275F);
        this.head.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, -0.2182F, 0.0F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 34, 12, -0.875F, -1.0F, 0.8F, 2, 1, 2, -0.01F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(0.0F, -0.7F, -2.225F);
        this.head.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.1745F, 0.0F, 0.0F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 34, 15, -1.0F, 0.0F, -1.0F, 2, 1, 2, 0.0F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(0.0F, -0.85F, -1.325F);
        this.head.addChild(cube_r7);
        this.setRotateAngle(cube_r7, -0.0436F, 0.0F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 32, 23, -1.5F, -0.025F, 0.0F, 3, 1, 2, 0.0F, false));

        this.righteye = new AdvancedModelRenderer(this);
        this.righteye.setRotationPoint(-0.7F, -0.9F, -1.2F);
        this.head.addChild(righteye);
        this.setRotateAngle(righteye, 0.0F, 0.0F, 0.1745F);


        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-0.55F, -0.05F, -0.5F);
        this.righteye.addChild(cube_r8);
        this.setRotateAngle(cube_r8, -0.0436F, -0.3491F, 0.2182F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 8, 34, -0.275F, -0.05F, -0.25F, 1, 1, 1, 0.0F, false));

        this.lefteye = new AdvancedModelRenderer(this);
        this.lefteye.setRotationPoint(0.7F, -0.9F, -1.2F);
        this.head.addChild(lefteye);
        this.setRotateAngle(lefteye, 0.0F, 0.0F, -0.1745F);


        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.55F, -0.05F, -0.5F);
        this.lefteye.addChild(cube_r9);
        this.setRotateAngle(cube_r9, -0.0436F, 0.3491F, -0.2182F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 8, 34, -0.725F, -0.05F, -0.25F, 1, 1, 1, 0.0F, true));

        this.lowerjaw = new AdvancedModelRenderer(this);
        this.lowerjaw.setRotationPoint(0.0F, 0.45F, 0.0F);
        this.head.addChild(lowerjaw);
        this.setRotateAngle(lowerjaw, -0.0873F, 0.0F, 0.0F);
        this.lowerjaw.cubeList.add(new ModelBox(lowerjaw, 12, 26, -1.0F, -0.2F, -3.15F, 2, 1, 4, 0.01F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(1.225F, 0.8F, -2.225F);
        this.lowerjaw.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, 0.2182F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 30, 35, -1.125F, -1.0F, 0.8F, 2, 1, 2, -0.01F, true));

        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(1.0F, 0.8F, -3.15F);
        this.lowerjaw.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, 0.6632F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 22, 35, -1.975F, -1.0F, 0.0F, 2, 1, 2, 0.0F, true));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(-1.225F, 0.8F, -2.225F);
        this.lowerjaw.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0F, -0.2182F, 0.0F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 30, 35, -0.875F, -1.0F, 0.8F, 2, 1, 2, -0.01F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(-1.0F, 0.8F, -3.15F);
        this.lowerjaw.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.0F, -0.6632F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 22, 35, -0.025F, -1.0F, 0.0F, 2, 1, 2, 0.0F, false));

        this.tongue = new AdvancedModelRenderer(this);
        this.tongue.setRotationPoint(0.0F, 0.05F, 0.05F);
        this.lowerjaw.addChild(tongue);
        this.tongue.cubeList.add(new ModelBox(tongue, 12, 23, -0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F, false));

        this.throat = new AdvancedModelRenderer(this);
        this.throat.setRotationPoint(0.0F, 0.875F, -2.325F);
        this.lowerjaw.addChild(throat);
        this.setRotateAngle(throat, -0.2269F, 0.0F, 0.0F);
        this.throat.cubeList.add(new ModelBox(throat, 24, 26, -1.5F, -1.025F, -0.25F, 3, 1, 3, -0.01F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(-0.5F, -0.025F, 2.75F);
        this.throat.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.5585F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 12, 33, -1.0F, -2.0F, 0.0F, 3, 2, 2, 0.0F, false));

        this.rightarm = new AdvancedModelRenderer(this);
        this.rightarm.setRotationPoint(-1.5F, 1.15F, -4.7F);
        this.body.addChild(rightarm);
        this.setRotateAngle(rightarm, -0.1484F, 0.4363F, -0.4538F);
        this.rightarm.cubeList.add(new ModelBox(rightarm, 22, 33, -3.0F, -0.5F, -0.75F, 4, 1, 1, 0.0F, false));
        this.rightarm.cubeList.add(new ModelBox(rightarm, 32, 33, -3.0F, -0.5F, -1.25F, 4, 1, 1, 0.01F, false));

        this.rightarm2 = new AdvancedModelRenderer(this);
        this.rightarm2.setRotationPoint(-3.0F, 0.0F, -0.5F);
        this.rightarm.addChild(rightarm2);
        this.setRotateAngle(rightarm2, 0.0436F, -1.6581F, 0.2618F);
        this.rightarm2.cubeList.add(new ModelBox(rightarm2, 36, 6, -2.75F, -0.5F, -0.6F, 3, 1, 1, 0.0F, false));
        this.rightarm2.cubeList.add(new ModelBox(rightarm2, 36, 4, -2.75F, -0.5F, -0.25F, 3, 1, 1, -0.01F, false));

        this.rightarm3 = new AdvancedModelRenderer(this);
        this.rightarm3.setRotationPoint(-2.5F, 0.2F, 0.3F);
        this.rightarm2.addChild(rightarm3);
        this.setRotateAngle(rightarm3, 0.1222F, -0.3927F, -0.0131F);
        this.rightarm3.cubeList.add(new ModelBox(rightarm3, 24, 30, -2.5F, 0.025F, -1.6F, 3, 0, 3, 0.0F, false));
        this.rightarm3.cubeList.add(new ModelBox(rightarm3, 0, 28, -2.5F, 0.045F, -1.6F, 3, 0, 3, 0.0F, false));

        this.leftarm = new AdvancedModelRenderer(this);
        this.leftarm.setRotationPoint(1.5F, 1.15F, -4.7F);
        this.body.addChild(leftarm);
        this.setRotateAngle(leftarm, -0.1484F, -0.4363F, 0.4538F);
        this.leftarm.cubeList.add(new ModelBox(leftarm, 22, 33, -1.0F, -0.5F, -0.75F, 4, 1, 1, 0.0F, true));
        this.leftarm.cubeList.add(new ModelBox(leftarm, 32, 33, -1.0F, -0.5F, -1.25F, 4, 1, 1, 0.01F, true));

        this.leftarm2 = new AdvancedModelRenderer(this);
        this.leftarm2.setRotationPoint(3.0F, 0.0F, -0.5F);
        this.leftarm.addChild(leftarm2);
        this.setRotateAngle(leftarm2, 0.0436F, 1.6581F, -0.2618F);
        this.leftarm2.cubeList.add(new ModelBox(leftarm2, 36, 6, -0.25F, -0.5F, -0.6F, 3, 1, 1, 0.0F, true));
        this.leftarm2.cubeList.add(new ModelBox(leftarm2, 36, 4, -0.25F, -0.5F, -0.25F, 3, 1, 1, -0.01F, true));

        this.leftarm3 = new AdvancedModelRenderer(this);
        this.leftarm3.setRotationPoint(2.5F, 0.2F, 0.3F);
        this.leftarm2.addChild(leftarm3);
        this.setRotateAngle(leftarm3, 0.1222F, 0.3927F, 0.0131F);
        this.leftarm3.cubeList.add(new ModelBox(leftarm3, 24, 30, -0.5F, 0.025F, -1.6F, 3, 0, 3, 0.0F, true));
        this.leftarm3.cubeList.add(new ModelBox(leftarm3, 0, 28, -0.5F, 0.045F, -1.6F, 3, 0, 3, 0.0F, true));
        ...
        this.rightleg.setRotationPoint(-1.5F, -0.5F, 3.6F);
        this.hips.addChild(rightleg);
        this.setRotateAngle(rightleg, 0.0F, -0.6109F, -0.2007F);
        this.rightleg.cubeList.add(new ModelBox(rightleg, 0, 31, -3.25F, -1.0F, -1.25F, 4, 1, 2, 0.01F, false));

        this.rightleg2 = new AdvancedModelRenderer(this);
        this.rightleg2.setRotationPoint(-3.1F, 0.05F, 0.1F);
        this.rightleg.addChild(rightleg2);
        this.setRotateAngle(rightleg2, 0.0F, 2.5307F, 0.0F);
        this.rightleg2.cubeList.add(new ModelBox(rightleg2, 32, 21, -4.5F, -1.0F, 0.0F, 5, 1, 1, -0.01F, false));
        this.rightleg2.cubeList.add(new ModelBox(rightleg2, 12, 31, -4.5F, -1.0F, -0.75F, 5, 1, 1, 0.0F, false));

        this.rightleg3 = new AdvancedModelRenderer(this);
        this.rightleg3.setRotationPoint(-4.5F, -0.475F, 0.15F);
        this.rightleg2.addChild(rightleg3);
        this.setRotateAngle(rightleg3, 0.0F, -2.5307F, 0.0698F);
        this.rightleg3.cubeList.add(new ModelBox(rightleg3, 36, 2, -2.9825F, -0.4677F, -0.2521F, 3, 1, 1, -0.02F, false));
        this.rightleg3.cubeList.add(new ModelBox(rightleg3, 36, 0, -2.9825F, -0.4677F, -0.7521F, 3, 1, 1, -0.01F, false));

        this.rightleg4 = new AdvancedModelRenderer(this);
        this.rightleg4.setRotationPoint(-2.9825F, 0.2823F, 0.2479F);
        this.rightleg3.addChild(rightleg4);
        this.setRotateAngle(rightleg4, 0.2531F, -0.7854F, -0.0436F);
        this.rightleg4.cubeList.add(new ModelBox(rightleg4, 18, 18, -5.0F, 0.0F, -1.5F, 6, 0, 3, 0.0F, false));
        this.rightleg4.cubeList.add(new ModelBox(rightleg4, 0, 20, -5.0F, 0.025F, -1.5F, 6, 0, 3, 0.0F, false));

        this.leftleg = new AdvancedModelRenderer(this);
        this.leftleg.setRotationPoint(1.5F, -0.5F, 3.6F);
        this.hips.addChild(leftleg);
        this.setRotateAngle(leftleg, 0.0F, 0.6109F, 0.2007F);
        this.leftleg.cubeList.add(new ModelBox(leftleg, 0, 31, -0.75F, -1.0F, -1.25F, 4, 1, 2, 0.01F, true));

        this.leftleg2 = new AdvancedModelRenderer(this);
        this.leftleg2.setRotationPoint(3.1F, 0.05F, 0.1F);
        this.leftleg.addChild(leftleg2);
        this.setRotateAngle(leftleg2, 0.0F, -2.5307F, 0.0F);
        this.leftleg2.cubeList.add(new ModelBox(leftleg2, 32, 21, -0.5F, -1.0F, 0.0F, 5, 1, 1, -0.01F, true));
        this.leftleg2.cubeList.add(new ModelBox(leftleg2, 12, 31, -0.5F, -1.0F, -0.75F, 5, 1, 1, 0.0F, true));

        this.leftleg3 = new AdvancedModelRenderer(this);
        this.leftleg3.setRotationPoint(4.5F, -0.475F, 0.15F);
        this.leftleg2.addChild(leftleg3);
        this.setRotateAngle(leftleg3, 0.0F, 2.5307F, -0.0698F);
        this.leftleg3.cubeList.add(new ModelBox(leftleg3, 36, 2, -0.0175F, -0.4677F, -0.2521F, 3, 1, 1, -0.02F, true));
        this.leftleg3.cubeList.add(new ModelBox(leftleg3, 36, 0, -0.0175F, -0.4677F, -0.7521F, 3, 1, 1, -0.01F, true));

        this.leftleg4 = new AdvancedModelRenderer(this);
        this.leftleg4.setRotationPoint(2.9825F, 0.2823F, 0.2479F);
        this.leftleg3.addChild(leftleg4);
        this.setRotateAngle(leftleg4, 0.2531F, 0.7854F, 0.0436F);
        this.leftleg4.cubeList.add(new ModelBox(leftleg4, 18, 18, -1.0F, 0.0F, -1.5F, 6, 0, 3, 0.0F, true));
        this.leftleg4.cubeList.add(new ModelBox(leftleg4, 0, 20, -1.0F, 0.025F, -1.5F, 6, 0, 3, 0.0F, true));
        updateDefaultPose();
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraLiaobatrachus entitySilesaurus = (EntityPrehistoricFloraLiaobatrachus) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraLiaobatrachus ee = (EntityPrehistoricFloraLiaobatrachus) entitylivingbaseIn;
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraLiaobatrachus entity = (EntityPrehistoricFloraLiaobatrachus) entitylivingbaseIn;
        int animCycle = 40;
        ...
        if (tickAnim >= 0 && tickAnim < 3) {
            ...
            xx = 11.25 + (((tickAnim - 20) / 5) * (0-(11.25)));
            yy = 0 + (((tickAnim - 20) / 5) * (0-(0)));
            ...
            xx = -3.28435 + (((tickAnim - 30) / 5) * (-11.63659-(-3.28435)));
            yy = 7.37384 + (((tickAnim - 30) / 5) * (30.43901-(7.37384)));
            zz = -7.6171 + (((tickAnim - 30) / 5) * (1.37857-(-7.6171)));
        }
        else if (tickAnim >= 35 && tickAnim < 40) {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraLiaobatrachus e = (EntityPrehistoricFloraLiaobatrachus) entity;
