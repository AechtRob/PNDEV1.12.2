...
public class ModelMegactenopetalus extends AdvancedModelBase {
    ...
    public ModelMegactenopetalus() {
        ...
        this.root.setRotationPoint(0.0F, 13.0F, 0.0F);
        ...
        this.Analfin.setRotationPoint(0.0F, -0.2F, 5.5F);
        this.Tailunderside.addChild(Analfin);
        this.setRotateAngle(Analfin, 0.0424F, 0.0F, 0.0F);
        this.Analfin.cubeList.add(new ModelBox(Analfin, 49, 0, 0.0F, 0.0F, -4.0F, 0, 6, 9, 0.0F, false));
