...
public class ModelClevosaurus extends AdvancedModelBase {
    ...
    public ModelClevosaurus() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 19.5136F, 0.2787F);
        this.body.cubeList.add(new ModelBox(body, 0, 39, -2.5F, -1.4636F, -8.0287F, 5, 5, 2, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(0.0F, -1.4636F, -8.0287F);
        ...
        this.bodyfront.setRotationPoint(0.0F, 1.5364F, -6.0287F);
        ...
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 26, 43, -1.5F, -1.775F, -5.1F, 3, 2, 4, -0.01F, false));
        ...
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 25, 17, -1.0F, 1.2F, 5.0F, 2, 2, 1, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(0.0F, -1.75F, 0.0F);
        this.upperjaw.addChild(cube_r8);
        this.setRotateAngle(cube_r8, -0.0873F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 32, 38, -2.0F, -1.5F, -0.5F, 4, 1, 4, 0.0F, false));
        ...
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 16, 17, -1.5F, -2.25F, 2.75F, 3, 1, 3, 0.0F, false));
        ...
        this.tail.setRotationPoint(0.0F, -0.4636F, -8.0287F);
        ...
        this.hindlegL.setRotationPoint(-2.0F, 1.0364F, -6.0287F);
        ...
        this.hindlegR.setRotationPoint(2.0F, 1.0364F, -6.0287F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (f3 == 0.0F || !entityClevosaurus.getIsMoving()) { //Not moving
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraClevosaurus e = (EntityPrehistoricFloraClevosaurus) entity;
