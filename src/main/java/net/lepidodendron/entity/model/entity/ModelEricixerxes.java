...
public class ModelEricixerxes extends ModelBasePalaeopedia {
    ...
    public ModelEricixerxes() {
        this.textureWidth = 32;
        this.textureHeight = 32;

        this.body = new AdvancedModelRenderer(this);
        this.body.setRotationPoint(0.0F, 23.5F, 0.0F);
        this.body.cubeList.add(new ModelBox(body, 16, 6, -1.0F, -0.35F, -8.0F, 2, 0, 2, 0.0F, false));

        this.antennaL = new AdvancedModelRenderer(this);
        this.antennaL.setRotationPoint(0.5F, -0.3F, -8.0F);
        this.body.addChild(antennaL);
        this.antennaL.cubeList.add(new ModelBox(antennaL, 9, 15, 0.0F, 0.0F, -2.0F, 2, 0, 2, 0.0F, false));

        this.antennaR = new AdvancedModelRenderer(this);
        this.antennaR.setRotationPoint(-0.5F, -0.3F, -8.0F);
        this.body.addChild(antennaR);
        this.antennaR.cubeList.add(new ModelBox(antennaR, 5, 15, -2.0F, 0.0F, -2.0F, 2, 0, 2, 0.0F, false));
        ...
        this.legL.cubeList.add(new ModelBox(legL, 20, 1, 0.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));

        this.legR = new AdvancedModelRenderer(this);
        this.legR.setRotationPoint(-0.25F, 0.05F, 0.5F);
        this.body2.addChild(legR);
        this.setRotateAngle(legR, 0.0F, 0.0F, -0.48F);
        this.legR.cubeList.add(new ModelBox(legR, 4, 20, -2.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));
        ...
        this.body2_shell.cubeList.add(new ModelBox(body2_shell, 16, 4, -1.0F, 0.0F, 0.0F, 2, 0, 2, 0.0F, false));

        this.cube_r1 = new AdvancedModelRenderer(this);
        this.cube_r1.setRotationPoint(-1.5F, 0.0F, 3.0F);
        this.body2_shell.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.0F, -0.3491F, -0.1309F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 7, 18, -0.85F, 0.05F, -3.0F, 1, 0, 2, 0.0F, false));

        this.cube_r2 = new AdvancedModelRenderer(this);
        this.cube_r2.setRotationPoint(1.5F, 0.0F, 3.0F);
        this.body2_shell.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0F, 0.3491F, 0.1309F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 9, 18, -0.15F, 0.05F, -3.0F, 1, 0, 2, 0.0F, false));
        ...
        this.legL2.cubeList.add(new ModelBox(legL2, 0, 20, 0.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));

        this.legR2 = new AdvancedModelRenderer(this);
        this.legR2.setRotationPoint(-0.25F, 0.15F, -0.15F);
        this.body3.addChild(legR2);
        this.setRotateAngle(legR2, 0.0F, 0.0F, -0.48F);
        this.legR2.cubeList.add(new ModelBox(legR2, 20, 0, -2.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));
        ...
        this.body3_shell.cubeList.add(new ModelBox(body3_shell, 8, 13, -1.5F, -0.1F, 0.0F, 3, 0, 2, 0.0F, false));
        ...
        this.cube_r3.setRotationPoint(1.5F, -0.375F, 2.75F);
        this.body4.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.7854F, 0.2618F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 13, 13, 0.6F, 0.075F, -0.85F, 1, 0, 3, 0.0F, false));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.5F, -0.375F, 2.75F);
        this.body4.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, -0.7854F, -0.2618F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 0, 14, -1.6F, 0.075F, -0.85F, 1, 0, 3, 0.0F, false));

        this.legR3 = new AdvancedModelRenderer(this);
        this.legR3.setRotationPoint(-0.25F, -0.1F, 0.25F);
        this.body4.addChild(legR3);
        this.setRotateAngle(legR3, 0.0F, 0.0F, -0.48F);
        this.legR3.cubeList.add(new ModelBox(legR3, 0, 19, -2.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));

        this.legR4 = new AdvancedModelRenderer(this);
        this.legR4.setRotationPoint(-0.25F, -0.1F, 1.5F);
        this.body4.addChild(legR4);
        this.setRotateAngle(legR4, 0.0F, 0.0F, -0.3054F);
        this.legR4.cubeList.add(new ModelBox(legR4, 0, 18, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL3 = new AdvancedModelRenderer(this);
        this.legL3.setRotationPoint(0.25F, -0.1F, 0.25F);
        this.body4.addChild(legL3);
        this.setRotateAngle(legL3, 0.0F, 0.0F, 0.48F);
        this.legL3.cubeList.add(new ModelBox(legL3, 16, 19, 0.0F, 0.0F, 0.0F, 2, 0, 1, 0.0F, false));

        this.legL4 = new AdvancedModelRenderer(this);
        this.legL4.setRotationPoint(0.25F, -0.1F, 1.5F);
        this.body4.addChild(legL4);
        this.setRotateAngle(legL4, 0.0F, 0.0F, 0.3054F);
        this.legL4.cubeList.add(new ModelBox(legL4, 17, 15, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));
        ...
        this.setRotateAngle(cube_r5, 0.0F, -0.8727F, -0.0873F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 13, 6, -1.35F, -0.05F, -1.25F, 1, 0, 3, 0.0F, false));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(1.5F, 0.0F, 1.0F);
        this.body4_shell.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, 0.8727F, 0.0873F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 2, 14, 0.35F, -0.05F, -1.25F, 1, 0, 3, 0.0F, false));
        ...
        this.cube_r7.setRotationPoint(-1.5F, -0.35F, 2.25F);
        this.body5.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, -0.6109F, -0.2618F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 12, 2, -1.7974F, 0.043F, -0.9775F, 1, 0, 4, 0.0F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(1.5F, -0.35F, 2.25F);
        this.body5.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.6109F, 0.2618F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 8, 3, 0.7974F, 0.043F, -0.9775F, 1, 0, 4, 0.0F, false));

        this.legR5 = new AdvancedModelRenderer(this);
        this.legR5.setRotationPoint(-0.25F, -0.1F, 0.5F);
        this.body5.addChild(legR5);
        this.setRotateAngle(legR5, 0.0F, 0.0F, -0.3054F);
        this.legR5.cubeList.add(new ModelBox(legR5, 17, 13, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legR6 = new AdvancedModelRenderer(this);
        this.legR6.setRotationPoint(-0.25F, -0.1F, 1.75F);
        this.body5.addChild(legR6);
        this.setRotateAngle(legR6, 0.0F, 0.0F, -0.3054F);
        this.legR6.cubeList.add(new ModelBox(legR6, 17, 12, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL5 = new AdvancedModelRenderer(this);
        this.legL5.setRotationPoint(0.25F, -0.1F, 0.5F);
        this.body5.addChild(legL5);
        this.setRotateAngle(legL5, 0.0F, 0.0F, 0.3054F);
        this.legL5.cubeList.add(new ModelBox(legL5, 17, 14, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL6 = new AdvancedModelRenderer(this);
        this.legL6.setRotationPoint(0.25F, -0.1F, 1.75F);
        this.body5.addChild(legL6);
        this.setRotateAngle(legL6, 0.0F, 0.0F, 0.3054F);
        this.legL6.cubeList.add(new ModelBox(legL6, 12, 17, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.body5_shell = new AdvancedModelRenderer(this);
        this.body5_shell.setRotationPoint(0.0F, -0.175F, -0.5F);
        this.body5.addChild(body5_shell);
        this.setRotateAngle(body5_shell, 0.0873F, 0.0F, 0.0F);
        this.body5_shell.cubeList.add(new ModelBox(body5_shell, 0, 8, -2.5F, 0.1F, 1.0F, 5, 0, 2, 0.0F, false));
        this.body5_shell.cubeList.add(new ModelBox(body5_shell, 13, 10, -2.0F, 0.1F, 0.0F, 4, 0, 1, 0.0F, false));
        ...
        this.cube_r9.setRotationPoint(-1.5F, -0.45F, 1.25F);
        this.body6.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, -0.4363F, -0.1745F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 10, 6, -1.5278F, 0.1468F, -0.9774F, 1, 0, 4, 0.0F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(1.5F, -0.45F, 1.25F);
        this.body6.addChild(cube_r10);
        this.setRotateAngle(cube_r10, 0.0F, 0.4363F, 0.1745F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 10, 2, 0.5278F, 0.1468F, -0.9774F, 1, 0, 4, 0.0F, false));

        this.legR7 = new AdvancedModelRenderer(this);
        this.legR7.setRotationPoint(-0.25F, -0.1F, 0.75F);
        this.body6.addChild(legR7);
        this.setRotateAngle(legR7, 0.0F, 0.0F, -0.3054F);
        this.legR7.cubeList.add(new ModelBox(legR7, 0, 17, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legR8 = new AdvancedModelRenderer(this);
        this.legR8.setRotationPoint(-0.25F, -0.1F, 2.0F);
        this.body6.addChild(legR8);
        this.setRotateAngle(legR8, 0.0F, 0.0F, -0.3054F);
        this.legR8.cubeList.add(new ModelBox(legR8, 14, 16, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL7 = new AdvancedModelRenderer(this);
        this.legL7.setRotationPoint(0.25F, -0.1F, 0.75F);
        this.body6.addChild(legL7);
        this.setRotateAngle(legL7, 0.0F, 0.0F, 0.3054F);
        this.legL7.cubeList.add(new ModelBox(legL7, 17, 11, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL8 = new AdvancedModelRenderer(this);
        this.legL8.setRotationPoint(0.25F, -0.1F, 2.0F);
        this.body6.addChild(legL8);
        this.setRotateAngle(legL8, 0.0F, 0.0F, 0.3054F);
        this.legL8.cubeList.add(new ModelBox(legL8, 17, 8, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));
        ...
        this.body7.setRotationPoint(0.0F, 0.1F, 2.0F);
        this.body6.addChild(body7);


        this.cube_r11 = new AdvancedModelRenderer(this);
        this.cube_r11.setRotationPoint(-1.5F, 0.075F, 0.75F);
        this.body7.addChild(cube_r11);
        this.setRotateAngle(cube_r11, 0.0F, -0.3491F, -0.0873F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 11, 18, -0.9F, -0.3F, -0.25F, 1, 0, 2, 0.0F, false));

        this.cube_r12 = new AdvancedModelRenderer(this);
        this.cube_r12.setRotationPoint(1.5F, 0.075F, 0.75F);
        this.body7.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.0F, 0.3491F, 0.0873F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 13, 18, -0.1F, -0.3F, -0.25F, 1, 0, 2, 0.0F, false));

        this.legR9 = new AdvancedModelRenderer(this);
        this.legR9.setRotationPoint(-0.25F, -0.2F, 1.25F);
        this.body7.addChild(legR9);
        this.setRotateAngle(legR9, 0.0F, 0.0F, -0.3054F);
        this.legR9.cubeList.add(new ModelBox(legR9, 15, 9, -3.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.legL9 = new AdvancedModelRenderer(this);
        this.legL9.setRotationPoint(0.25F, -0.2F, 1.25F);
        this.body7.addChild(legL9);
        this.setRotateAngle(legL9, 0.0F, 0.0F, 0.3054F);
        this.legL9.cubeList.add(new ModelBox(legL9, 6, 17, 0.0F, 0.0F, 0.0F, 3, 0, 1, 0.0F, false));

        this.body7_shell = new AdvancedModelRenderer(this);
        this.body7_shell.setRotationPoint(0.0F, -0.35F, -1.75F);
        this.body7.addChild(body7_shell);
        this.setRotateAngle(body7_shell, -0.0436F, 0.0F, 0.0F);
        this.body7_shell.cubeList.add(new ModelBox(body7_shell, 0, 12, -2.0F, 0.0F, 1.0F, 4, 0, 2, 0.0F, false));

        this.body8 = new AdvancedModelRenderer(this);
        this.body8.setRotationPoint(0.0F, -0.2F, 1.25F);
        this.body7.addChild(body8);
        this.body8.cubeList.add(new ModelBox(body8, 0, 6, -2.5F, 0.0F, -0.75F, 5, 0, 2, 0.0F, false));
        ...
        this.body9.cubeList.add(new ModelBox(body9, 8, 11, -2.0F, 0.0F, 0.0F, 4, 0, 2, 0.0F, false));

        this.body10 = new AdvancedModelRenderer(this);
        this.body10.setRotationPoint(0.0F, 0.05F, 1.65F);
        this.body9.addChild(body10);
        this.body10.cubeList.add(new ModelBox(body10, 11, 0, -2.0F, 0.0F, 0.0F, 4, 0, 2, 0.0F, false));

        this.body11 = new AdvancedModelRenderer(this);
        this.body11.setRotationPoint(0.0F, 0.05F, 1.65F);
        this.body10.addChild(body11);
        this.body11.cubeList.add(new ModelBox(body11, 0, 10, -2.0F, 0.0F, 0.0F, 4, 0, 2, 0.0F, false));

        this.body12 = new AdvancedModelRenderer(this);
        this.body12.setRotationPoint(0.0F, 0.05F, 1.5F);
        this.body11.addChild(body12);
        this.body12.cubeList.add(new ModelBox(body12, 16, 2, -1.0F, 0.0F, 0.0F, 2, 0, 2, 0.0F, false));

        this.cube_r13 = new AdvancedModelRenderer(this);
        this.cube_r13.setRotationPoint(1.0F, 0.5F, 2.0F);
        this.body12.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.0F, 0.5236F, 0.0F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 17, 17, -0.85F, -0.475F, -0.25F, 1, 0, 2, 0.0F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(-1.0F, 0.5F, 2.0F);
        this.body12.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.0F, -0.5236F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 5, 18, -0.15F, -0.475F, -0.25F, 1, 0, 2, 0.0F, false));

        this.body13 = new AdvancedModelRenderer(this);
        this.body13.setRotationPoint(0.0F, 0.05F, 1.5F);
        this.body12.addChild(body13);
        this.body13.cubeList.add(new ModelBox(body13, 8, 7, -0.5F, 0.0F, 0.0F, 1, 0, 4, 0.0F, false));
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraEricixerxes Ericixerxes = (EntityPrehistoricFloraEricixerxes) e;
        if (f3 == 0.0F || !Ericixerxes.getIsMoving()) { //Not moving
            return;
        }
