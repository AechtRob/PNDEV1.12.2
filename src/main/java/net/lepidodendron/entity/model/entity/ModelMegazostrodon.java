...
public class ModelMegazostrodon extends AdvancedModelBaseExtended {
    ...
    public void renderStaticFloor(float f) {
        ...
        this.setRotateAngle(Bodymiddle, 0.4F, 0.0F, 0.0F);
        this.setRotateAngle(Bodyfront, 0.1F, 0.0F, 0.0F);
        this.setRotateAngle(Neck, -0.3F, 0.0F, 0.0F);
        this.setRotateAngle(Head, -0.2F, 0.0F, 0.2F);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        EntityPrehistoricFloraMegazostrodon Megazostrodon = (EntityPrehistoricFloraMegazostrodon) e;
        float masterSpeed = Megazostrodon.getTravelSpeed();
        ...
        if (Megazostrodon.getAnimation() == Megazostrodon.LAY_ANIMATION) {
            //this.swing(Neck, 0.5F, 0.10F, false, 0.5F,-0.05F, f2, 0.8F);
            //this.walk(Neck, 0.5F * 2, -0.02F, false, 0.5F,0.01F, f2, 0.8F);
            return;
        }

        if ((f3 == 0.0F || !Megazostrodon.getIsMoving())) { //Not moving
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraMegazostrodon e = (EntityPrehistoricFloraMegazostrodon) entity;
