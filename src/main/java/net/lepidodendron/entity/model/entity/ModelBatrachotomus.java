...
public class ModelBatrachotomus extends AdvancedModelBaseExtended {
    ...
    public ModelBatrachotomus() {
        ...
        this.Hips.cubeList.add(new ModelBox(Hips, 37, 16, -4.0F, -2.0F, -7.0F, 8, 11, 10, 0.0F, false));
        this.Hips.cubeList.add(new ModelBox(Hips, 50, 40, -2.5F, -2.5F, -6.0F, 5, 1, 9, -0.01F, false));
        ...
        this.Body.cubeList.add(new ModelBox(Body, 47, 0, -3.5F, -2.5F, -11.0F, 7, 1, 13, 0.0F, false));

        this.Chest = new AdvancedModelRendererExtended(this);
        this.Chest.setRotationPoint(0.0F, 0.0F, -9.0F);
        this.Body.addChild(Chest);
        this.setRotateAngle(Chest, 0.1309F, 0.0F, 0.0F);
        this.Chest.cubeList.add(new ModelBox(Chest, 55, 51, -4.0F, -2.0F, -8.0F, 8, 10, 8, 0.0F, false));
        this.Chest.cubeList.add(new ModelBox(Chest, 64, 15, -2.5F, -2.5F, -8.0F, 5, 1, 8, -0.01F, false));

        this.Neck = new AdvancedModelRendererExtended(this);
        this.Neck.setRotationPoint(0.0F, 0.0F, -7.0F);
        this.Chest.addChild(Neck);
        this.setRotateAngle(Neck, 0.0436F, 0.0F, 0.0F);
        this.Neck.cubeList.add(new ModelBox(Neck, 34, 0, -2.5F, -2.0F, -5.0F, 5, 7, 5, -0.01F, false));
        this.Neck.cubeList.add(new ModelBox(Neck, 87, 65, -1.5F, -2.5F, -5.0F, 3, 1, 5, -0.02F, false));

        this.Neck2 = new AdvancedModelRendererExtended(this);
        this.Neck2.setRotationPoint(0.0F, 0.0F, -4.0F);
        this.Neck.addChild(Neck2);
        this.setRotateAngle(Neck2, -0.0873F, 0.0F, 0.0F);
        this.Neck2.cubeList.add(new ModelBox(Neck2, 0, 83, -2.0F, -1.98F, -5.0F, 4, 7, 5, 0.0F, false));
        this.Neck2.cubeList.add(new ModelBox(Neck2, 91, 18, -1.0F, -2.5F, -5.0F, 2, 1, 5, -0.03F, false));

        this.Head = new AdvancedModelRendererExtended(this);
        this.Head.setRotationPoint(0.0F, 1.0F, -5.0F);
        this.Neck2.addChild(Head);
        this.setRotateAngle(Head, -0.0436F, 0.0F, 0.0F);
        this.Head.cubeList.add(new ModelBox(Head, 62, 70, -2.5F, -3.0F, -3.0F, 5, 4, 4, 0.0F, false));
        ...
        this.Lips.cubeList.add(new ModelBox(Lips, 92, 36, -1.5F, 0.0F, -4.0F, 3, 3, 4, 0.0F, false));
        ...
        this.Lips2.cubeList.add(new ModelBox(Lips2, 14, 91, -1.0F, -2.0F, -5.0F, 2, 2, 5, 0.0F, false));
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 33, -1.5F, 0.3F, 0.2F, 3, 1, 3, -0.01F, false));

        this.cube_r2 = new AdvancedModelRendererExtended(this);
        this.cube_r2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Teeth.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.0698F, 0.0F, 0.0F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 41, 93, -1.0F, -0.4F, -5.2F, 2, 1, 5, -0.01F, false));
        ...
        this.Forehead.cubeList.add(new ModelBox(Forehead, 0, 49, -1.0F, 0.01F, -7.99F, 2, 2, 4, -0.01F, false));
        this.Forehead.cubeList.add(new ModelBox(Forehead, 0, 9, -1.0F, 0.01F, -8.3F, 2, 2, 1, -0.02F, false));
        this.Forehead.cubeList.add(new ModelBox(Forehead, 0, 26, -1.0F, 0.0F, -4.09F, 2, 2, 4, -0.01F, false));
        this.Forehead.cubeList.add(new ModelBox(Forehead, 26, 33, -1.0F, 0.0F, -0.9F, 2, 2, 1, -0.02F, false));

        this.Jaw = new AdvancedModelRendererExtended(this);
        this.Jaw.setRotationPoint(0.0F, 1.0F, 1.0F);
        this.Head.addChild(Jaw);
        this.setRotateAngle(Jaw, -0.1047F, 0.0F, 0.0F);
        this.Jaw.cubeList.add(new ModelBox(Jaw, 46, 85, -2.5F, 0.0F, -4.0F, 5, 3, 4, -0.01F, false));
        ...
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 40, 74, -1.5F, -0.03F, -3.5F, 3, 1, 4, -0.03F, false));

        this.cube_r4 = new AdvancedModelRendererExtended(this);
        this.cube_r4.setRotationPoint(1.0F, 0.0F, -11.0F);
        this.Jaw.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0436F, 0.0F, 0.0F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 26, 26, -0.25F, 0.0F, -0.2F, 0, 1, 5, 0.0F, false));
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 42, 59, -1.75F, 0.0F, -0.2F, 0, 1, 5, 0.0F, false));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 88, 55, -1.5F, -4.0F, 0.0F, 3, 4, 4, 0.0F, false));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 91, 0, -1.5F, -2.06F, -3.65F, 3, 2, 4, -0.02F, false));
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 87, 72, -1.0F, -2.06F, -8.61F, 2, 2, 5, -0.02F, false));
        ...
        this.ThroatPouch.cubeList.add(new ModelBox(ThroatPouch, 83, 10, -2.0F, -2.0F, -5.0F, 4, 2, 5, -0.01F, false));
        ...
        this.UpperArmR.cubeList.add(new ModelBox(UpperArmR, 83, 84, -0.5F, -1.5F, -2.0F, 3, 7, 4, 0.0F, false));
        ...
        this.LowerArmR.cubeList.add(new ModelBox(LowerArmR, 68, 84, 0.5F, 0.0F, -4.0F, 3, 9, 4, -0.01F, false));

        this.HandR = new AdvancedModelRendererExtended(this);
        this.HandR.setRotationPoint(1.0F, 9.0F, -2.0F);
        this.LowerArmR.addChild(HandR);
        this.HandR.cubeList.add(new ModelBox(HandR, 83, 25, -1.0F, -1.0F, -3.5F, 4, 2, 5, 0.0F, false));
        ...
        this.UpperArmL.cubeList.add(new ModelBox(UpperArmL, 83, 84, -2.5F, -1.5F, -2.0F, 3, 7, 4, 0.0F, true));
        ...
        this.LowerArmL.cubeList.add(new ModelBox(LowerArmL, 68, 84, -3.5F, 0.0F, -4.0F, 3, 9, 4, -0.01F, true));

        this.HandL = new AdvancedModelRendererExtended(this);
        this.HandL.setRotationPoint(-1.0F, 9.0F, -2.0F);
        this.LowerArmL.addChild(HandL);
        this.HandL.cubeList.add(new ModelBox(HandL, 83, 25, -3.0F, -1.0F, -3.5F, 4, 2, 5, 0.0F, true));

        this.Tail = new AdvancedModelRendererExtended(this);
        this.Tail.setRotationPoint(0.0F, 0.0F, 2.0F);
        this.Hips.addChild(Tail);
        this.Tail.cubeList.add(new ModelBox(Tail, 0, 26, -3.0F, -1.99F, 0.0F, 6, 9, 13, 0.0F, false));
        this.Tail.cubeList.add(new ModelBox(Tail, 62, 26, -2.0F, -2.5F, 0.99F, 4, 1, 12, -0.02F, false));

        this.Tail2 = new AdvancedModelRendererExtended(this);
        this.Tail2.setRotationPoint(0.0F, 0.5F, 12.0F);
        this.Tail.addChild(Tail2);
        this.setRotateAngle(Tail2, -0.0401F, 0.0F, 0.0F);
        this.Tail2.cubeList.add(new ModelBox(Tail2, 26, 38, -2.5F, -2.0F, 0.0F, 5, 7, 13, 0.0F, false));
        this.Tail2.cubeList.add(new ModelBox(Tail2, 22, 59, -1.5F, -2.5F, -0.01F, 3, 1, 13, -0.01F, false));

        this.Tail3 = new AdvancedModelRendererExtended(this);
        this.Tail3.setRotationPoint(0.0F, 0.5F, 12.0F);
        this.Tail2.addChild(Tail3);
        this.setRotateAngle(Tail3, -0.0436F, 0.0F, 0.0F);
        this.Tail3.cubeList.add(new ModelBox(Tail3, 0, 49, -2.0F, -2.0F, 0.0F, 4, 5, 13, 0.0F, false));

        this.cube_r7 = new AdvancedModelRendererExtended(this);
        this.cube_r7.setRotationPoint(0.0F, -2.5F, 0.0F);
        this.Tail3.addChild(cube_r7);
        this.setRotateAngle(cube_r7, -0.0358F, 0.0F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 68, -1.0F, 0.0F, 0.0F, 2, 1, 13, -0.01F, false));

        this.Tail4 = new AdvancedModelRendererExtended(this);
        this.Tail4.setRotationPoint(0.0F, 0.0F, 12.0F);
        this.Tail3.addChild(Tail4);
        this.setRotateAngle(Tail4, -0.0436F, 0.0F, 0.0F);
        this.Tail4.cubeList.add(new ModelBox(Tail4, 45, 70, -1.5F, -1.5F, 0.0F, 3, 4, 10, 0.0F, false));

        this.Tail5 = new AdvancedModelRendererExtended(this);
        this.Tail5.setRotationPoint(0.0F, 0.0F, 9.5F);
        this.Tail4.addChild(Tail5);
        this.setRotateAngle(Tail5, -0.0436F, 0.0F, 0.0F);
        this.Tail5.cubeList.add(new ModelBox(Tail5, 72, 70, -1.0F, -1.0F, 0.0F, 2, 3, 10, 0.0F, false));

        this.UpperLegR = new AdvancedModelRendererExtended(this);
        this.UpperLegR.setRotationPoint(-4.0F, 3.0F, 0.5F);
        this.Hips.addChild(UpperLegR);
        this.setRotateAngle(UpperLegR, -0.3491F, 0.0F, 0.0F);
        this.UpperLegR.cubeList.add(new ModelBox(UpperLegR, 25, 79, -3.0F, -2.0F, -3.5F, 4, 10, 6, 0.0F, false));
        ...
        this.LowerLegR.cubeList.add(new ModelBox(LowerLegR, 80, 40, -1.5F, 0.0F, 0.0F, 3, 9, 5, 0.0F, false));
        ...
        this.ToesR.cubeList.add(new ModelBox(ToesR, 77, 2, -2.0F, -1.0F, -4.0F, 4, 2, 5, 0.0F, false));

        this.bone2 = new AdvancedModelRendererExtended(this);
        this.bone2.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.ToesR.addChild(bone2);
        this.bone2.cubeList.add(new ModelBox(bone2, 56, 95, -2.0F, -1.0F, -3.0F, 4, 2, 3, 0.002F, false));

        this.UpperLegL = new AdvancedModelRendererExtended(this);
        this.UpperLegL.setRotationPoint(4.0F, 3.0F, 0.5F);
        this.Hips.addChild(UpperLegL);
        this.setRotateAngle(UpperLegL, -0.3491F, 0.0F, 0.0F);
        this.UpperLegL.cubeList.add(new ModelBox(UpperLegL, 25, 79, -1.0F, -2.0F, -3.5F, 4, 10, 6, 0.0F, true));
        ...
        this.LowerLegL.cubeList.add(new ModelBox(LowerLegL, 80, 40, -1.5F, 0.0F, 0.0F, 3, 9, 5, 0.0F, true));
        ...
        this.ToesL.cubeList.add(new ModelBox(ToesL, 77, 2, -2.0F, -1.0F, -4.0F, 4, 2, 5, 0.0F, true));

        this.bone = new AdvancedModelRendererExtended(this);
        this.bone.setRotationPoint(0.0F, 0.0F, -3.0F);
        this.ToesL.addChild(bone);
        this.bone.cubeList.add(new ModelBox(bone, 56, 95, -2.0F, -1.0F, -3.0F, 4, 2, 3, 0.002F, true));
