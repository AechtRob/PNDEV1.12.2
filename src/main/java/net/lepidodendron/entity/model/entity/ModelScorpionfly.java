...
public class ModelScorpionfly extends ModelBasePalaeopedia {
    ...
    public ModelScorpionfly() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.scorpionfly = new AdvancedModelRenderer(this);
        this.scorpionfly.setRotationPoint(0.0F, 19.7F, -3.0F);


        this.thorax = new AdvancedModelRenderer(this);
        this.thorax.setRotationPoint(0.0F, -0.9F, 1.2F);
        this.scorpionfly.addChild(thorax);
        this.thorax.cubeList.add(new ModelBox(thorax, 0, 10, -1.0F, 0.0F, -2.0F, 2, 2, 2, 0.01F, false));
        ...
        this.leftForewing.cubeList.add(new ModelBox(leftForewing, 0, 0, -0.2364F, 0.025F, -0.1087F, 12, 0, 4, 0.0F, false));
        ...
        this.leftHindwing.cubeList.add(new ModelBox(leftHindwing, 0, 5, -0.0502F, 0.1F, -0.0344F, 11, 0, 4, 0.0F, false));
        ...
        this.rightForewing.cubeList.add(new ModelBox(rightForewing, 0, 0, -11.7636F, 0.035F, -0.1087F, 12, 0, 4, 0.0F, true));
        ...
        this.rightHindwing.cubeList.add(new ModelBox(rightHindwing, 0, 5, -10.9498F, 0.099F, -0.0344F, 11, 0, 4, 0.0F, true));
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 21, 23, 4.5F, 0.6F, -0.2F, 0, 4, 6, 0.0F, false));
        ...
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 20, 10, -8.128F, -2.6F, 1.5996F, 0, 4, 6, 0.0F, false));
        ...
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 0, 10, 2.884F, 0.5F, -4.8794F, 0, 4, 9, 0.0F, false));
        ...
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 21, 23, -4.5F, 0.6F, -0.2F, 0, 4, 6, 0.0F, true));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 20, 10, 8.128F, -2.6F, 1.5996F, 0, 4, 6, 0.0F, true));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 10, -2.884F, 0.5F, -4.8794F, 0, 4, 9, 0.0F, true));
        ...
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 27, 10, 0.5F, -0.4F, -0.7F, 1, 1, 2, 0.0F, false));

        this.head = new AdvancedModelRenderer(this);
        this.head.setRotationPoint(0.1789F, -0.3208F, -1.0559F);
        this.neck.addChild(head);
        this.setRotateAngle(head, -0.3054F, 0.0F, 0.0F);
        this.head.cubeList.add(new ModelBox(head, 10, 16, -0.6789F, -0.2373F, -0.7233F, 1, 1, 1, 0.02F, false));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-0.7789F, 0.9595F, -2.2006F);
        this.head.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.5236F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 18, 10, -1.5387F, -1.1968F, 1.4258F, 1, 1, 1, -0.05F, true));

        this.cube_r9 = new AdvancedModelRenderer(this);
        this.cube_r9.setRotationPoint(0.4211F, 0.9595F, -2.2006F);
        this.head.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, -0.5236F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 18, 10, 0.5387F, -1.1968F, 1.4258F, 1, 1, 1, -0.05F, false));

        this.cube_r10 = new AdvancedModelRenderer(this);
        this.cube_r10.setRotationPoint(-0.1789F, 1.7595F, -2.1006F);
        this.head.addChild(cube_r10);
        this.setRotateAngle(cube_r10, -0.0873F, 0.0F, 0.0F);
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 0, 0.0F, -1.3578F, 1.2095F, 0, 2, 1, 0.0F, false));
        ...
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 12, 17, 0.0F, -3.3487F, -6.8017F, 0, 4, 7, 0.0F, false));
        ...
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 12, 17, 0.0F, -3.3487F, -6.8017F, 0, 4, 7, 0.0F, true));

        this.abdomen1 = new AdvancedModelRenderer(this);
        this.abdomen1.setRotationPoint(0.0F, -0.8647F, 1.2136F);
        ...
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 10, 10, -1.0F, -1.0F, -1.5F, 2, 2, 3, 0.0F, false));

        this.abdomen2 = new AdvancedModelRenderer(this);
        this.abdomen2.setRotationPoint(0.0F, 1.6F, 2.3F);
        this.abdomen1.addChild(abdomen2);
        this.abdomen2.cubeList.add(new ModelBox(abdomen2, 27, 5, -1.0F, -0.2976F, 0.0064F, 2, 1, 2, -0.02F, false));

        this.cube_r14 = new AdvancedModelRenderer(this);
        this.cube_r14.setRotationPoint(0.0F, -0.0806F, 1.2565F);
        this.abdomen2.addChild(cube_r14);
        this.setRotateAngle(cube_r14, -0.4363F, 0.0F, 0.0F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 15, -1.0F, -0.6F, -1.1F, 2, 1, 2, -0.01F, false));

        this.abdomen3 = new AdvancedModelRenderer(this);
        this.abdomen3.setRotationPoint(0.0F, 0.5674F, 2.004F);
        this.abdomen2.addChild(abdomen3);


        this.cube_r15 = new AdvancedModelRenderer(this);
        this.cube_r15.setRotationPoint(0.0F, -0.4009F, 0.9131F);
        this.abdomen3.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.1309F, 0.0F, 0.0F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 28, 21, -0.5F, -0.6F, -1.0F, 1, 1, 2, -0.01F, false));

        this.abdomen4 = new AdvancedModelRenderer(this);
        this.abdomen4.setRotationPoint(0.0F, -0.8674F, 1.696F);
        this.abdomen3.addChild(abdomen4);
        this.setRotateAngle(abdomen4, 0.1745F, 0.0F, 0.0F);


        this.cube_r16 = new AdvancedModelRenderer(this);
        this.cube_r16.setRotationPoint(0.0F, -1.3853F, -0.0636F);
        this.abdomen4.addChild(cube_r16);
        this.setRotateAngle(cube_r16, 0.3054F, 0.0F, 0.0F);
        this.cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 24, 0.0F, -2.95F, -1.5F, 0, 5, 4, 0.0F, false));

        this.abdomen5 = new AdvancedModelRenderer(this);
        this.abdomen5.setRotationPoint(0.0F, -2.6945F, -0.7809F);
        this.abdomen4.addChild(abdomen5);


        this.cube_r17 = new AdvancedModelRenderer(this);
        this.cube_r17.setRotationPoint(0.0F, 1.7541F, 0.2879F);
        this.abdomen5.addChild(cube_r17);
        this.setRotateAngle(cube_r17, -1.8326F, 0.0F, 0.0F);
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 5, -0.3F, -0.5F, -0.6F, 0, 1, 1, 0.0F, true));
        this.cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 5, 0.3F, -0.5F, -0.6F, 0, 1, 1, 0.0F, false));

        this.cube_r18 = new AdvancedModelRenderer(this);
        this.cube_r18.setRotationPoint(0.0F, 1.1989F, -0.2334F);
        this.abdomen5.addChild(cube_r18);
        this.setRotateAngle(cube_r18, -1.2217F, 0.0F, 0.0F);
        this.cube_r18.cubeList.add(new ModelBox(cube_r18, 5, 24, -0.5F, -0.7F, -1.2F, 1, 1, 2, -0.01F, false));
        updateDefaultPose();
    }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        EntityPrehistoricFloraScorpionfly ee = (EntityPrehistoricFloraScorpionfly) entitylivingbaseIn;
    ...
    public void animFlying(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityPrehistoricFloraScorpionfly entity = (EntityPrehistoricFloraScorpionfly) entitylivingbaseIn;
        int animCycle = 19;
        ...
        this.setRotateAngle(abdomen3, abdomen3.rotateAngleX + (float) Math.toRadians(-10+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*375*2-60*3))*2), abdomen3.rotateAngleY + (float) Math.toRadians(-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*375-60*2))*2), abdomen3.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(abdomen4, abdomen4.rotateAngleX + (float) Math.toRadians(-90+Math.sin((Math.PI/180)*((((double)tickAnim/20D))*375*2-60*4))*5), abdomen4.rotateAngleY + (float) Math.toRadians(-Math.sin((Math.PI/180)*((((double)tickAnim/20D))*375-60*3))*5), abdomen4.rotateAngleZ + (float) Math.toRadians(0));


        this.setRotateAngle(abdomen5, abdomen5.rotateAngleX + (float) Math.toRadians(-40), abdomen5.rotateAngleY + (float) Math.toRadians(0), abdomen5.rotateAngleZ + (float) Math.toRadians(0));
