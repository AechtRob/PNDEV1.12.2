...
public class ModelAustriadactylus extends AdvancedModelBaseExtended {
    ...
    public AdvancedModelRendererExtended upperwing1;
    public AdvancedModelRendererExtended upperwing2;
    ...
    public AdvancedModelRendererExtended tailthing1;
    ...
    public AdvancedModelRendererExtended wing1;
    public AdvancedModelRendererExtended wingfingerbase1;
    public AdvancedModelRendererExtended wingfinger1;
    public AdvancedModelRendererExtended hand1;
    public AdvancedModelRendererExtended wing1_1;
    public AdvancedModelRendererExtended wingfingerbase1_1;
    public AdvancedModelRendererExtended wingfinger1_1;
    public AdvancedModelRendererExtended hand1_1;
    ...
    public ModelAustriadactylus() {
        ...
        this.wingfinger1 = new AdvancedModelRendererExtended(this, 56, 90);
        this.wingfinger1.setRotationPoint(0.1F, 0.0F, 11.0F);
        this.wingfinger1.addBox(-0.5F, -9.0F, 0.0F, 1, 9, 18, 0.0F);
        this.setRotateAngle(wingfinger1, 1.2292353921796064F, 0.0F, 0.0F);
        this.leg2 = new AdvancedModelRendererExtended(this, 0, 36);
        this.leg2.setRotationPoint(0.3F, 5.7F, -0.4F);
        this.leg2.addBox(-0.5F, 0.0F, -1.0F, 1, 9, 2, 0.0F);
        this.setRotateAngle(leg2, 0.7285004297824331F, 0.0F, 0.36425021489121656F);
        ...
        this.wingfinger1_1 = new AdvancedModelRendererExtended(this, 0, 100);
        this.wingfinger1_1.setRotationPoint(-0.1F, 0.0F, 11.0F);
        this.wingfinger1_1.addBox(-0.5F, -9.0F, 0.0F, 1, 9, 18, 0.0F);
        this.setRotateAngle(wingfinger1_1, 1.2292353921796064F, 0.0F, 0.0F);
        ...
        this.upperwing1 = new AdvancedModelRendererExtended(this, 33, 56);
        this.upperwing1.setRotationPoint(-1.4F, -1.6F, -2.3F);
        this.upperwing1.addBox(-9.0F, -1.0F, 0.0F, 9, 2, 13, 0.0F);
        this.setRotateAngle(upperwing1, -0.045553093477052F, 0.0F, -0.5462880558742251F);
        this.tail3 = new AdvancedModelRendererExtended(this, 4, 28);
        ...
        this.tail2 = new AdvancedModelRendererExtended(this, 34, 21);
        this.tail2.setRotationPoint(0.0F, -0.5F, 5.8F);
        ...
        this.tail4 = new AdvancedModelRendererExtended(this, 10, 17);
        ...
        this.feet1 = new AdvancedModelRendererExtended(this, 0, 17);
        this.feet1.setRotationPoint(0.0F, 8.7F, 0.0F);
        this.feet1.addBox(-1.0F, -0.5F, -6.0F, 2, 1, 7, 0.0F);
        this.setRotateAngle(feet1, -0.4553564018453205F, 0.0F, -0.091106186954104F);
        this.wingfingerbase1 = new AdvancedModelRendererExtended(this, 49, 86);
        this.wingfingerbase1.setRotationPoint(-0.1F, 11.0F, 0.3F);
        this.wingfingerbase1.addBox(-0.5F, -10.0F, 0.0F, 1, 10, 11, 0.0F);
        this.setRotateAngle(wingfingerbase1, 0.0F, 0.0F, -0.091106186954104F);
        this.upperleg1 = new AdvancedModelRendererExtended(this, 0, 26);
        this.upperleg1.setRotationPoint(-1.7F, -0.1F, 4.1F);
        this.upperleg1.addBox(-1.0F, 0.0F, -1.5F, 2, 7, 3, 0.0F);
        this.setRotateAngle(upperleg1, -0.045553093477052F, 0.0F, 0.4553564018453205F);
        this.jaw1 = new AdvancedModelRendererExtended(this, 20, 46);
        this.jaw1.setRotationPoint(0.0F, 1.5F, -0.9F);
        ...
        this.feet2 = new AdvancedModelRendererExtended(this, 0, 17);
        this.feet2.setRotationPoint(0.0F, 8.7F, 0.0F);
        this.feet2.addBox(-1.0F, -0.5F, -6.0F, 2, 1, 7, 0.0F);
        this.setRotateAngle(feet2, -0.4553564018453205F, 0.0F, 0.091106186954104F);
        ...
        this.tail5 = new AdvancedModelRendererExtended(this, 22, 15);
        ...
        this.tailthing1 = new AdvancedModelRendererExtended(this, 49, 15);
        this.tailthing1.setRotationPoint(0.0F, 0.0F, 8.9F);
        this.tailthing1.addBox(0.0F, -2.5F, 0.0F, 0, 5, 6, 0.0F);
        ...
        this.wing1 = new AdvancedModelRendererExtended(this, 33, 72);
        this.wing1.setRotationPoint(-8.8F, 0.0F, 0.3F);
        this.wing1.addBox(-0.5F, 0.0F, 0.0F, 1, 11, 12, 0.0F);
        this.setRotateAngle(wing1, 0.0F, 0.0F, 0.6373942428283291F);
        this.upperleg2 = new AdvancedModelRendererExtended(this, 84, 26);
        this.upperleg2.setRotationPoint(1.7F, -0.1F, 4.1F);
        this.upperleg2.addBox(-1.0F, 0.0F, -1.5F, 2, 7, 3, 0.0F);
        this.setRotateAngle(upperleg2, -0.045553093477052F, 0.0F, -0.4553564018453205F);
        this.wingfingerbase1_1 = new AdvancedModelRendererExtended(this, 21, 96);
        this.wingfingerbase1_1.setRotationPoint(-0.1F, 11.0F, 0.3F);
        this.wingfingerbase1_1.addBox(-0.5F, -10.0F, 0.0F, 1, 10, 11, 0.0F);
        this.setRotateAngle(wingfingerbase1_1, 0.0F, 0.0F, 0.091106186954104F);
        this.hand1 = new AdvancedModelRendererExtended(this, 29, 79);
        this.hand1.setRotationPoint(-0.1F, 0.2F, 0.0F);
        this.hand1.addBox(-1.5F, -0.5F, 0.0F, 3, 1, 3, 0.0F);
        this.setRotateAngle(hand1, 0.18203784098300857F, -0.18203784098300857F, -0.045553093477052F);
        ...
        this.wing1_1 = new AdvancedModelRendererExtended(this, 1, 76);
        this.wing1_1.setRotationPoint(8.8F, 0.0F, 0.3F);
        this.wing1_1.addBox(-0.5F, 0.0F, 0.0F, 1, 11, 12, 0.0F);
        this.setRotateAngle(wing1_1, 0.0F, 0.0F, -0.6373942428283291F);
        this.upperwing2 = new AdvancedModelRendererExtended(this, 0, 60);
        this.upperwing2.setRotationPoint(1.4F, -1.6F, -2.3F);
        this.upperwing2.addBox(0.0F, -1.0F, 0.0F, 9, 2, 13, 0.0F);
        this.setRotateAngle(upperwing2, -0.045553093477052F, 0.0F, 0.5462880558742251F);
        this.hand1_1 = new AdvancedModelRendererExtended(this, 29, 79);
        this.hand1_1.setRotationPoint(-0.1F, 0.2F, 0.0F);
        this.hand1_1.addBox(-1.5F, -0.5F, 0.0F, 3, 1, 3, 0.0F);
        this.setRotateAngle(hand1_1, 0.18203784098300857F, 0.18203784098300857F, 0.045553093477052F);
        this.leg1 = new AdvancedModelRendererExtended(this, 84, 36);
        this.leg1.setRotationPoint(-0.3F, 5.7F, -0.4F);
        this.leg1.addBox(-0.5F, 0.0F, -1.0F, 1, 9, 2, 0.0F);
        this.setRotateAngle(leg1, 0.7285004297824331F, 0.0F, -0.36425021489121656F);
        ...
        this.head1 = new AdvancedModelRendererExtended(this, 21, 35);
        this.head1.setRotationPoint(0.0F, -0.8F, -5.3F);
        this.head1.addBox(-2.0F, -1.5F, -4.0F, 4, 3, 4, 0.0F);
        this.setRotateAngle(head1, 0.9560913642424937F, 0.0F, 0.0F);
        ...
        this.upperleg1.addChild(this.legwing11);
        this.head2.addChild(this.head4);
        this.chest.addChild(this.neck1);
        this.wingfingerbase1.addChild(this.wingfinger1);
        this.upperleg2.addChild(this.leg2);
        this.head5.addChild(this.crest2);
        this.jaw1.addChild(this.jaw2);
        this.wingfingerbase1_1.addChild(this.wingfinger1_1);
        this.leg1.addChild(this.legwing12);
        this.chest.addChild(this.upperwing1);
        ...
        this.wing1.addChild(this.wingfingerbase1);
        this.body.addChild(this.upperleg1);
        ...
        this.tail5.addChild(this.tailthing1);
        this.head2.addChild(this.crest1);
        this.jaw2.addChild(this.underhead1);
        this.upperwing1.addChild(this.wing1);
        this.body.addChild(this.upperleg2);
        this.wing1_1.addChild(this.wingfingerbase1_1);
        this.wingfingerbase1.addChild(this.hand1);
        this.head2.addChild(this.teeth2);
        this.head3.addChild(this.head5);
        this.upperwing2.addChild(this.wing1_1);
        this.chest.addChild(this.upperwing2);
        this.wingfingerbase1_1.addChild(this.hand1_1);
        this.upperleg1.addChild(this.leg1);
        this.leg2.addChild(this.legwing12_1);
        this.neck2.addChild(this.head1);
        this.jaw2.addChild(this.jaw3);
        this.upperleg2.addChild(this.legwing11_1);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (flier.isReallyFlying() || flier.getAnimation() == flier.UNFLY_ANIMATION) { //flight pose
            this.setRotateAngle(upperwing2, 0.0F, 0.0F, -0.045553093477052F);
            this.setRotateAngle(upperleg2, 0.8651597102135892F, 0.0F, -1.6390387005478748F);
            this.setRotateAngle(legwing12, -0.136659280431156F, 0.31869712141416456F, 0.0F);
            this.setRotateAngle(teeth2, 0.091106186954104F, 0.0F, 0.0F);
            this.setRotateAngle(leg1, 0.7285004297824331F, 0.0F, 0.0F);
            this.setRotateAngle(chest, 0.0F, 0.0F, -0.011519173063162576F);
            this.setRotateAngle(wing1, 0.0F, 0.0F, 1.6845917940249266F);
            ...
            this.setRotateAngle(teeth1, -0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(body, -0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(feet1, 1.0016444577195458F, 0.0F, 0.0F);
            this.setRotateAngle(jaw3, -0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(gums1, -0.4553564018453205F, 0.0F, 0.0F);
            this.setRotateAngle(head4, 0.22759093446006054F, 0.0F, 0.0F);
            this.setRotateAngle(crest1, -0.18203784098300857F, 0.0F, 0.0F);
            this.setRotateAngle(wingfingerbase1, -1.4570008595648662F, 0.0F, -0.18203784098300857F);
            this.setRotateAngle(tail2, 0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(wingfingerbase1_1, -1.4570008595648662F, 0.0F, 0.18203784098300857F);
            this.setRotateAngle(wingfinger1, 0.091106186954104F, 0.136659280431156F, 0.0F);
            this.setRotateAngle(crest2, -0.31869712141416456F, 0.0F, 0.0F);
            this.setRotateAngle(underneck1, 0.091106186954104F, 0.0F, 0.0F);
            this.setRotateAngle(upperleg1, 0.8651597102135892F, 0.0F, 1.6390387005478748F);
            this.setRotateAngle(tail3, 0.091106186954104F, 0.0F, 0.0F);
            this.setRotateAngle(upperwing1, 0.0F, 0.0F, 0.091106186954104F);
            this.setRotateAngle(feet2, 1.0016444577195458F, 0.0F, 0.0F);
            this.setRotateAngle(leg2, 0.7285004297824331F, 0.0F, 0.0F);
            this.setRotateAngle(tail4, 0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(tail5, 0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(wing1_1, 0.0F, 0.0F, -1.6845917940249266F);
            this.setRotateAngle(neck2, -0.31869712141416456F, 0.0F, 0.0F);
            this.setRotateAngle(head3, -0.045553093477052F, 0.0F, 0.0F);
            this.setRotateAngle(head5, 0.27314402793711257F, 0.0F, 0.0F);
            this.setRotateAngle(neck1, 0.18203784098300857F, 0.0F, -0.0F);
            this.setRotateAngle(wingfinger1_1, 0.091106186954104F, -0.136659280431156F, 0.0F);
        } else {
            resetToDefaultPose();
        }

        AdvancedModelRenderer[] wingLeft = {this.upperwing2, this.wing1_1, this.wingfingerbase1_1};
        AdvancedModelRenderer[] wingRight = {this.upperwing1, this.wing1, this.wingfingerbase1};

        AdvancedModelRenderer[] legLeft = {this.upperleg2, this.leg2, this.feet2};
        AdvancedModelRenderer[] legRight = {this.upperleg1, this.leg1, this.feet1};

        AdvancedModelRenderer[] tailFull = {this.tail2, this.tail3, this.tail4, this.tail5, this.tailthing1};

        float speed = 0.50F;
        float fixedY = 1.04F; //The standard offset to centre the mob
        ...
        if (flier.isReallyFlying()) {
            ...
            this.swing(wingfinger1, speed, 0.2F, false, 2.0F, 0.12F, f2, 1F);
            this.swing(wingfinger1_1, speed, -0.2F, false, 2.0F, -0.12F, f2, 1F);

            this.swing(upperwing2, speed, 0.05F, false, 2.0F, 0.025F, f2, 1F);
            this.swing(upperwing1, speed, -0.05F, false, 2.0F, -0.025F, f2, 1F);
            ...
            //Rotate the body:
            BlockPos pos = flier.getPosition();
            BlockPos target = flier.getFlyTarget();
            if (target == null) {
                target = pos;
            }
            float n = (float) (Math.pow((target.getX() - pos.getX()),2) + Math.pow((target.getY() - pos.getY()),2) + Math.pow((target.getZ() - pos.getZ()),2));
            float hyp = (float) Math.sqrt(n);
            float angle = (float) Math.asin((target.getY() - pos.getY()) / hyp);
            this.chest.rotateAngleX = angle;
            ...
            //body walking:
            this.flap(upperwing2, speed, -0.2F, true, 4, 0.15F, f2, 1F);
            this.flap(upperwing1, speed, 0.2F, true, 7, -0.15F, f2, 1F);

            this.walk(chest, speed, -0.2F, true, 6.5F, -0.1F, f2, 1F);
            this.walk(body, speed, -0.2F, true, 6.5F, -0.1F, f2, 1F);
            this.walk(tail2, speed, 0.4F, true, 6.5F, 0.2F, f2, 1F);
            this.walk(neck1, speed, 0.4F, true, 6.5F, 0.2F, f2, 1F);

            this.walk(upperwing1, speed, -0.1F, true, 6.5F, 0.05F, f2, 1F);
            this.walk(upperwing2, speed, -0.1F, true, 6.5F, 0.05F, f2, 1F);

            //this.flap(upperleg2, speed, 0.1F, false, 5.5F, -0.05F, f2, 1F);
            //this.flap(upperleg1, speed, -0.1F, false, 5.5F, 0.05F, f2, 1F);

            this.swing(body, speed, -0.1F, true, 6.5F, -0.05F, f2, 1F);

            this.walk(upperwing2, speed, 0.40F, true, 5, 0.30F, f2, 1F);
            this.walk(upperwing1, speed, 0.40F, true, 8, 0.30F, f2, 1F);

            this.walk(upperleg2, speed, 0.20F, true, 6.5F, -0.08F, f2, 1F);
            this.walk(upperleg1, speed, 0.20F, true, 6.5F, -0.08F, f2, 1F);

            this.walk(wing1_1, speed, 0.25F, true, 6, 0F, f2, 1F);
            this.walk(wing1, speed, 0.25F, true, 9, 0F, f2, 1F);

            this.walk(leg2, speed, 0.15F, true, 7.5F, 0F, f2, 1F);
            this.walk(leg1, speed, 0.15F, true, 7.5F, 0F, f2, 1F);

            this.flap(wing1_1, speed, 0.10F, true, 0, 0.05F, f2, 1F);
            this.flap(wing1, speed, -0.10F, true, 3, -0.05F, f2, 1F);

            //this.flap(leg2, speed, -0.10F, false, 1.5F, -0.05F, f2, 1F);
            //this.flap(leg1, speed, 0.10F, false, 1.5F, 0.05F, f2, 1F);

            this.walk(hand1_1, speed, 0.30F, true, 2, -0.10F, f2, 1F);
            this.walk(hand1, speed, 0.30F, true, 5, -0.10F, f2, 1F);

            this.walk(feet2, speed, 0.25F, true, 3.5F, -0.08F, f2, 1F);
            this.walk(feet1, speed, 0.25F, true, 3.5F, -0.08F, f2, 1F);
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        animator.rotate(chest, 0.182037840983008F, 0F, -0.0115191730631625F);
        animator.rotate(feet1, 1.45700085956486F, 0F, 0.091106186954104F);
        animator.rotate(feet2, 1.45700085956486F, 0F, -0.091106186954104F);
        animator.rotate(gums1, -0.091106186954104F, 0F, 0F);
        animator.rotate(hand1, -0.182037840983008F, 0.182037840983008F, 0.045553093477052F);
        animator.rotate(hand1_1, -0.182037840983008F, -0.182037840983008F, -0.045553093477052F);
        animator.rotate(head1, -0.728500429782433F, 0F, 0F);
        animator.rotate(leg1, 0F, 0F, 0.364250214891216F);
        animator.rotate(leg2, 0F, 0F, -0.364250214891216F);
        ...
        animator.rotate(upperleg1, 0.910712803690641F, 0F, 1.18368229870255F);
        animator.rotate(upperleg2, 0.910712803690641F, 0F, -1.18368229870255F);
        animator.rotate(upperwing1, 0.045553093477052F, 0F, 0.637394242828329F);
        animator.rotate(upperwing2, 0.045553093477052F, 0F, -0.591841149351277F);
        animator.rotate(wing1, 0F, 0F, 1.04719755119659F);
        animator.rotate(wing1_1, 0F, 0F, -1.04719755119659F);
        animator.rotate(wingfinger1, -1.1381292052255F, 0.136659280431156F, 0F);
        animator.rotate(wingfinger1_1, -1.1381292052255F, -0.136659280431156F, 0F);
        animator.rotate(wingfingerbase1, -1.45700085956486F, 0F, -0.090931654028904F);
        animator.rotate(wingfingerbase1_1, -1.45700085956486F, 0F, 0.090931654028904F);
