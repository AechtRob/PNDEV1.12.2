...
public class ModelHaliskia extends ModelBasePalaeopedia {
    ...
    public ModelHaliskia() {
        ...
        cube_r1.setRotationPoint(-0.5F, 1.7393F, 4.2284F);
        tail.addChild(cube_r1);
        setRotateAngle(cube_r1, -0.2443F, 0.0F, 0.0F);
        cube_r1.cubeList.add(new ModelBox(cube_r1, 63, 49, -1.0F, 0.3439F, -4.5009F, 3, 1, 2, -0.001F, false));

        cube_r2 = new AdvancedModelRenderer(this);
        cube_r2.setRotationPoint(-0.5F, 1.1393F, 4.3784F);
        tail.addChild(cube_r2);
        setRotateAngle(cube_r2, -0.2443F, 0.0F, 0.0F);
        cube_r2.cubeList.add(new ModelBox(cube_r2, 51, 36, -1.0F, -0.6561F, -4.5009F, 3, 2, 2, 0.0F, false));
        ...
        cube_r3.setRotationPoint(0.5F, 0.2F, 4.25F);
        tail1.addChild(cube_r3);
        setRotateAngle(cube_r3, -0.1047F, 0.0F, 0.0F);
        cube_r3.cubeList.add(new ModelBox(cube_r3, 20, 55, -1.0F, -0.1564F, -4.6539F, 1, 1, 3, 0.0F, false));
        ...
        rightleg1.cubeList.add(new ModelBox(rightleg1, 20, 64, -0.7834F, -0.2193F, -0.7468F, 2, 5, 2, 0.0F, false));
        ...
        rightleg2.cubeList.add(new ModelBox(rightleg2, 60, 64, -0.6567F, -0.2147F, -0.2048F, 1, 7, 2, 0.0F, false));
        ...
        rightfoot.cubeList.add(new ModelBox(rightfoot, 58, 19, -1.0203F, -0.4862F, -3.6551F, 2, 1, 4, 0.0F, false));
        ...
        rightlegwing1.cubeList.add(new ModelBox(rightlegwing1, 0, 66, 0.0F, -3.0127F, -0.1001F, 0, 6, 2, 0.0F, false));
        ...
        rightlegwing2.cubeList.add(new ModelBox(rightlegwing2, 65, 0, -0.5F, -2.3638F, -0.0093F, 1, 5, 2, 0.0F, false));
        ...
        leftleg1.cubeList.add(new ModelBox(leftleg1, 20, 64, -1.2166F, -0.2193F, -0.7468F, 2, 5, 2, 0.0F, true));
        ...
        leftleg2.cubeList.add(new ModelBox(leftleg2, 60, 64, -0.3433F, -0.2147F, -0.2048F, 1, 7, 2, 0.0F, true));
        ...
        leftfoot.cubeList.add(new ModelBox(leftfoot, 58, 19, -0.9797F, -0.4862F, -3.6551F, 2, 1, 4, 0.0F, true));
        ...
        leftlegwing1.cubeList.add(new ModelBox(leftlegwing1, 0, 66, 0.0F, -3.0127F, -0.1001F, 0, 6, 2, 0.0F, true));
        ...
        leftlegwing2.cubeList.add(new ModelBox(leftlegwing2, 65, 0, -0.5F, -2.3638F, -0.0093F, 1, 5, 2, 0.0F, true));
        ...
        cube_r4.setRotationPoint(-0.5F, -0.8912F, -5.3624F);
        chest.addChild(cube_r4);
        setRotateAngle(cube_r4, -0.4363F, 0.0F, 0.0F);
        cube_r4.cubeList.add(new ModelBox(cube_r4, 19, 32, -2.0F, -2.0F, -1.0F, 5, 2, 6, -0.001F, false));

        cube_r5 = new AdvancedModelRenderer(this);
        cube_r5.setRotationPoint(-0.5F, 2.6088F, -6.2124F);
        chest.addChild(cube_r5);
        setRotateAngle(cube_r5, -0.1309F, 0.0F, 0.0F);
        cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 23, -2.0F, -4.0F, -1.0F, 5, 4, 7, 0.0F, false));
        ...
        leftwing1.cubeList.add(new ModelBox(leftwing1, 41, 47, 0.0F, -0.25F, -0.5F, 7, 2, 2, 0.0F, true));
        ...
        leftwing1membrane.cubeList.add(new ModelBox(leftwing1membrane, 25, 17, -4.25F, -0.25F, 0.0F, 8, 1, 6, 0.0F, true));
        ...
        leftwing1planemembrane.cubeList.add(new ModelBox(leftwing1planemembrane, 36, 36, -2.0F, -0.635F, 6.0F, 4, 0, 6, 0.0F, true));
        ...
        leftwing2.cubeList.add(new ModelBox(leftwing2, 38, 43, -0.1F, -0.25F, -0.75F, 9, 1, 2, 0.0F, true));
        ...
        leftwing2membrane.cubeList.add(new ModelBox(leftwing2membrane, 25, 25, -0.1F, -0.25F, 1.25F, 9, 1, 5, 0.0F, true));
        ...
        leftwing2planemembrane.cubeList.add(new ModelBox(leftwing2planemembrane, 30, 11, -4.6F, -1.425F, 5.0F, 9, 0, 5, 0.0F, true));
        ...
        leftwing3.cubeList.add(new ModelBox(leftwing3, 49, 27, 0.0F, -0.15F, -0.45F, 7, 1, 1, 0.0F, true));
        ...
        leftwing3membrane.cubeList.add(new ModelBox(leftwing3membrane, 36, 1, 0.0F, -0.15F, 0.5F, 7, 1, 5, 0.0F, true));
        ...
        leftwing3planemembrane.cubeList.add(new ModelBox(leftwing3planemembrane, 15, 41, -3.5F, -0.45F, 0.5F, 7, 0, 4, 0.0F, true));
        ...
        leftwing4.cubeList.add(new ModelBox(leftwing4, 30, 8, 0.0F, -0.15F, -0.45F, 12, 1, 1, 0.0F, true));
        ...
        leftwing4membrane.cubeList.add(new ModelBox(leftwing4membrane, 0, 6, 0.0F, -0.15F, 0.5F, 12, 1, 5, 0.0F, true));
        ...
        leftwing4planemembrane.cubeList.add(new ModelBox(leftwing4planemembrane, 36, 32, -5.0F, -0.2F, 0.0F, 10, 0, 3, 0.0F, true));
        ...
        lefthand.cubeList.add(new ModelBox(lefthand, 67, 58, 0.0F, 0.0F, -1.0F, 2, 1, 2, 0.0F, true));
        ...
        leftwing5.cubeList.add(new ModelBox(leftwing5, 0, 46, 0.0F, -0.15F, -0.45F, 10, 1, 1, 0.0F, true));
        ...
        leftwing5membrane.cubeList.add(new ModelBox(leftwing5membrane, -1, 16, 0.0F, -0.15F, 0.5F, 10, 1, 5, 0.0F, true));
        ...
        leftwing6.cubeList.add(new ModelBox(leftwing6, 0, 13, -0.1F, -0.15F, -0.45F, 16, 1, 1, 0.0F, true));
        ...
        leftwing6membrane.cubeList.add(new ModelBox(leftwing6membrane, -1, -1, -0.1F, -0.15F, 0.45F, 16, 1, 4, 0.0F, true));
        ...
        cube_r6.setRotationPoint(0.0F, -0.7F, 0.6F);
        shoulder.addChild(cube_r6);
        setRotateAngle(cube_r6, 0.6589F, 0.0F, 0.0F);
        cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 35, -2.0F, -2.0F, -4.0F, 4, 4, 5, -0.1F, false));
        ...
        cube_r7.setRotationPoint(-0.5F, 0.425F, -4.275F);
        neck.addChild(cube_r7);
        setRotateAngle(cube_r7, 0.9032F, 0.0F, 0.0F);
        cube_r7.cubeList.add(new ModelBox(cube_r7, 62, 10, -1.0F, 0.2429F, -1.5313F, 3, 4, 2, -0.002F, false));

        cube_r8 = new AdvancedModelRenderer(this);
        cube_r8.setRotationPoint(-0.5F, -1.175F, -4.2F);
        neck.addChild(cube_r8);
        setRotateAngle(cube_r8, -0.672F, 0.0F, 0.0F);
        cube_r8.cubeList.add(new ModelBox(cube_r8, 25, 56, -1.0F, -2.2F, -0.2F, 3, 3, 4, 0.0F, false));
        ...
        cube_r9.setRotationPoint(0.425F, 5.3F, -9.4F);
        head.addChild(cube_r9);
        setRotateAngle(cube_r9, 0.3316F, 0.0F, 0.0F);
        cube_r9.cubeList.add(new ModelBox(cube_r9, 67, 69, -1.25F, 0.0527F, 3.8344F, 1, 1, 2, -0.1F, true));
        cube_r9.cubeList.add(new ModelBox(cube_r9, 67, 69, -0.6F, 0.0527F, 3.8344F, 1, 1, 2, -0.1F, false));

        cube_r10 = new AdvancedModelRenderer(this);
        cube_r10.setRotationPoint(0.425F, 5.3F, -9.4F);
        head.addChild(cube_r10);
        setRotateAngle(cube_r10, 0.2618F, 0.0F, 0.0F);
        cube_r10.cubeList.add(new ModelBox(cube_r10, 9, 63, -1.25F, -0.1973F, 0.0094F, 1, 1, 4, -0.1F, true));
        cube_r10.cubeList.add(new ModelBox(cube_r10, 9, 63, -0.6F, -0.1973F, 0.0094F, 1, 1, 4, -0.1F, false));

        cube_r11 = new AdvancedModelRenderer(this);
        cube_r11.setRotationPoint(0.425F, 5.3F, -9.4F);
        head.addChild(cube_r11);
        setRotateAngle(cube_r11, 0.1745F, 0.0F, 0.0F);
        cube_r11.cubeList.add(new ModelBox(cube_r11, 53, 11, -1.25F, -0.1973F, -5.7906F, 1, 1, 6, -0.1F, true));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 53, 11, -0.6F, -0.1973F, -5.7906F, 1, 1, 6, -0.1F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 49, 19, -1.225F, -0.9473F, -6.0156F, 1, 1, 6, 0.002F, false));
        cube_r11.cubeList.add(new ModelBox(cube_r11, 41, 52, -0.625F, -0.9473F, -6.0156F, 1, 1, 6, 0.0F, false));

        cube_r12 = new AdvancedModelRenderer(this);
        cube_r12.setRotationPoint(-0.5F, 1.075F, 1.85F);
        head.addChild(cube_r12);
        setRotateAngle(cube_r12, -0.0349F, 0.0F, 0.0F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 60, -1.0F, -0.024F, -2.9976F, 3, 2, 3, -0.001F, false));

        cube_r13 = new AdvancedModelRenderer(this);
        cube_r13.setRotationPoint(0.2F, 4.3F, -5.5F);
        head.addChild(cube_r13);
        setRotateAngle(cube_r13, 0.3316F, 0.0F, 0.0F);
        cube_r13.cubeList.add(new ModelBox(cube_r13, 66, 53, -1.0F, -0.9907F, -0.0415F, 1, 1, 3, 0.001F, false));
        cube_r13.cubeList.add(new ModelBox(cube_r13, 67, 17, -0.4F, -0.9907F, -0.0415F, 1, 1, 3, 0.0F, false));

        cube_r14 = new AdvancedModelRenderer(this);
        cube_r14.setRotationPoint(0.2F, 5.1F, -8.4F);
        head.addChild(cube_r14);
        setRotateAngle(cube_r14, 0.2618F, 0.0F, 0.0F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 18, 23, -1.0F, -1.0129F, -1.0333F, 1, 1, 4, -0.003F, false));
        cube_r14.cubeList.add(new ModelBox(cube_r14, 26, 46, -0.4F, -1.0129F, -1.0333F, 1, 1, 4, 0.003F, false));

        cube_r15 = new AdvancedModelRenderer(this);
        cube_r15.setRotationPoint(0.2F, 1.1F, -4.9F);
        head.addChild(cube_r15);
        setRotateAngle(cube_r15, 0.4538F, 0.0F, 0.0F);
        cube_r15.cubeList.add(new ModelBox(cube_r15, 17, 46, -1.0F, 0.048F, -4.9325F, 1, 2, 6, 0.0F, false));
        cube_r15.cubeList.add(new ModelBox(cube_r15, 32, 47, -0.4F, 0.048F, -4.9325F, 1, 2, 6, -0.003F, false));

        cube_r16 = new AdvancedModelRenderer(this);
        cube_r16.setRotationPoint(-0.5F, 2.9F, -11.5F);
        head.addChild(cube_r16);
        setRotateAngle(cube_r16, -0.192F, 0.0F, 0.0F);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 65, 36, 0.0F, -0.0193F, 0.0001F, 1, 1, 3, 0.0F, false));

        cube_r17 = new AdvancedModelRenderer(this);
        cube_r17.setRotationPoint(-0.5F, 3.1F, -12.5F);
        head.addChild(cube_r17);
        setRotateAngle(cube_r17, 0.2094F, 0.0F, 0.0F);
        cube_r17.cubeList.add(new ModelBox(cube_r17, 26, 16, 0.0F, -0.0071F, 0.0198F, 1, 1, 1, -0.003F, false));

        cube_r18 = new AdvancedModelRenderer(this);
        cube_r18.setRotationPoint(-0.5F, 3.7F, -13.1F);
        head.addChild(cube_r18);
        setRotateAngle(cube_r18, 0.7679F, 0.0F, 0.0F);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 11, 49, 0.0F, -0.0219F, -0.1318F, 1, 1, 1, 0.0F, false));

        cube_r19 = new AdvancedModelRenderer(this);
        cube_r19.setRotationPoint(-0.5F, 5.4F, -15.5F);
        head.addChild(cube_r19);
        setRotateAngle(cube_r19, 0.6283F, 0.0F, 0.0F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 67, 64, 0.0F, 0.0135F, 0.0091F, 1, 1, 3, -0.003F, false));

        cube_r20 = new AdvancedModelRenderer(this);
        cube_r20.setRotationPoint(-0.5F, 3.4F, -9.3F);
        head.addChild(cube_r20);
        setRotateAngle(cube_r20, 0.192F, 0.0F, 0.0F);
        cube_r20.cubeList.add(new ModelBox(cube_r20, 57, 36, 0.0F, 0.0096F, -4.3696F, 1, 1, 5, 0.003F, false));

        cube_r21 = new AdvancedModelRenderer(this);
        cube_r21.setRotationPoint(0.0F, 1.0F, -2.1F);
        head.addChild(cube_r21);
        setRotateAngle(cube_r21, 0.3316F, 0.0F, 0.0F);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 63, 43, -1.0F, 0.0195F, -2.0132F, 2, 2, 3, 0.003F, false));

        cube_r22 = new AdvancedModelRenderer(this);
        cube_r22.setRotationPoint(0.0F, -0.1F, -3.2F);
        head.addChild(cube_r22);
        setRotateAngle(cube_r22, 0.6283F, 0.0F, 0.0F);
        cube_r22.cubeList.add(new ModelBox(cube_r22, 29, 64, -1.0F, 0.0195F, -2.0132F, 2, 2, 3, 0.005F, false));

        cube_r23 = new AdvancedModelRenderer(this);
        cube_r23.setRotationPoint(-0.25F, -0.5F, -1.65F);
        head.addChild(cube_r23);
        setRotateAngle(cube_r23, -0.3491F, 0.0F, 0.0F);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 33, 46, 0.9F, -0.1057F, 0.439F, 1, 1, 1, 0.0F, false));
        cube_r23.cubeList.add(new ModelBox(cube_r23, 33, 46, -1.4F, -0.1057F, 0.439F, 1, 1, 1, 0.0F, true));

        cube_r24 = new AdvancedModelRenderer(this);
        cube_r24.setRotationPoint(-0.5F, 0.75F, 0.35F);
        head.addChild(cube_r24);
        setRotateAngle(cube_r24, 0.6283F, 0.0F, 0.0F);
        cube_r24.cubeList.add(new ModelBox(cube_r24, 0, 49, -1.0F, -2.8557F, -2.961F, 3, 4, 4, 0.001F, false));
        ...
        cube_r25 = new AdvancedModelRenderer(this);
        cube_r25.setRotationPoint(0.05F, 0.8F, -2.125F);
        jaw.addChild(cube_r25);
        setRotateAngle(cube_r25, 0.3316F, 0.0F, 0.0F);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 5, 69, -0.9F, -2.479F, -5.5044F, 1, 1, 2, -0.1F, true));
        cube_r25.cubeList.add(new ModelBox(cube_r25, 5, 69, -0.2F, -2.479F, -5.5044F, 1, 1, 2, -0.1F, false));
        cube_r25.cubeList.add(new ModelBox(cube_r25, 12, 69, -0.95F, -1.754F, -5.2794F, 1, 1, 2, -0.1F, false));
        cube_r25.cubeList.add(new ModelBox(cube_r25, 69, 23, -0.15F, -1.754F, -5.2794F, 1, 1, 2, -0.1F, false));

        cube_r26 = new AdvancedModelRenderer(this);
        cube_r26.setRotationPoint(0.05F, 2.15F, -3.6F);
        jaw.addChild(cube_r26);
        setRotateAngle(cube_r26, 0.2618F, 0.0F, 0.0F);
        cube_r26.cubeList.add(new ModelBox(cube_r26, 60, 58, -0.9F, -3.0221F, -7.6398F, 1, 1, 4, -0.1F, true));
        cube_r26.cubeList.add(new ModelBox(cube_r26, 60, 58, -0.2F, -3.0221F, -7.6398F, 1, 1, 4, -0.1F, false));
        cube_r26.cubeList.add(new ModelBox(cube_r26, 62, 26, -0.95F, -2.3221F, -7.3398F, 1, 1, 4, -0.1F, false));
        cube_r26.cubeList.add(new ModelBox(cube_r26, 49, 62, -0.15F, -2.3221F, -7.3398F, 1, 1, 4, -0.1F, false));

        cube_r27 = new AdvancedModelRenderer(this);
        cube_r27.setRotationPoint(-0.05F, 2.15F, -6.875F);
        jaw.addChild(cube_r27);
        setRotateAngle(cube_r27, 0.1745F, 0.0F, 0.0F);
        cube_r27.cubeList.add(new ModelBox(cube_r27, 54, 47, -0.8F, -1.799F, -10.3562F, 1, 1, 6, -0.1F, true));
        cube_r27.cubeList.add(new ModelBox(cube_r27, 54, 47, -0.1F, -1.799F, -10.3562F, 1, 1, 6, -0.1F, false));

        cube_r28 = new AdvancedModelRenderer(this);
        cube_r28.setRotationPoint(-0.5F, 1.0F, 0.975F);
        jaw.addChild(cube_r28);
        setRotateAngle(cube_r28, -0.0349F, 0.0F, 0.0F);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 40, 60, -1.0F, -2.3594F, -4.7327F, 3, 2, 3, -0.01F, false));

        cube_r29 = new AdvancedModelRenderer(this);
        cube_r29.setRotationPoint(0.0F, 0.225F, -0.075F);
        jaw.addChild(cube_r29);
        setRotateAngle(cube_r29, 0.3316F, 0.0F, 0.0F);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 70, 6, -1.1F, -1.8732F, -6.056F, 1, 1, 2, -0.09F, false));
        cube_r29.cubeList.add(new ModelBox(cube_r29, 49, 68, -0.9F, -1.8732F, -6.056F, 2, 1, 2, -0.1F, false));

        cube_r30 = new AdvancedModelRenderer(this);
        cube_r30.setRotationPoint(0.0F, 2.875F, -6.175F);
        jaw.addChild(cube_r30);
        setRotateAngle(cube_r30, 0.2574F, 0.0F, 0.0F);
        cube_r30.cubeList.add(new ModelBox(cube_r30, 0, 6, -0.9F, -2.3413F, -5.3505F, 1, 1, 1, -0.1F, false));
        cube_r30.cubeList.add(new ModelBox(cube_r30, 0, 16, -0.1F, -2.3413F, -5.3505F, 1, 1, 1, -0.1F, false));

        cube_r31 = new AdvancedModelRenderer(this);
        cube_r31.setRotationPoint(0.0F, 3.15F, -6.875F);
        jaw.addChild(cube_r31);
        setRotateAngle(cube_r31, 0.1745F, 0.0F, 0.0F);
        cube_r31.cubeList.add(new ModelBox(cube_r31, 51, 55, -0.9F, -2.049F, -9.4562F, 1, 1, 5, -0.1F, false));
        cube_r31.cubeList.add(new ModelBox(cube_r31, 0, 35, -0.9F, -2.049F, -10.2562F, 1, 1, 1, -0.1F, false));
        cube_r31.cubeList.add(new ModelBox(cube_r31, 57, 3, -0.1F, -2.049F, -9.4562F, 1, 1, 5, -0.1F, false));
        cube_r31.cubeList.add(new ModelBox(cube_r31, 14, 35, -0.1F, -2.049F, -10.2562F, 1, 1, 1, -0.1F, false));

        cube_r32 = new AdvancedModelRenderer(this);
        cube_r32.setRotationPoint(0.5F, 4.55F, -11.35F);
        jaw.addChild(cube_r32);
        setRotateAngle(cube_r32, 0.4887F, 0.0F, 0.0F);
        cube_r32.cubeList.add(new ModelBox(cube_r32, 48, 17, -1.0F, -2.9881F, -2.5329F, 1, 1, 2, -0.1F, false));

        cube_r33 = new AdvancedModelRenderer(this);
        cube_r33.setRotationPoint(0.5F, 4.6F, -11.475F);
        jaw.addChild(cube_r33);
        setRotateAngle(cube_r33, 0.3447F, 0.0F, 0.0F);
        cube_r33.cubeList.add(new ModelBox(cube_r33, 16, 49, -1.0F, -2.6275F, -3.4138F, 1, 1, 1, -0.11F, false));

        cube_r34 = new AdvancedModelRenderer(this);
        cube_r34.setRotationPoint(0.5F, 4.35F, -12.775F);
        jaw.addChild(cube_r34);
        setRotateAngle(cube_r34, -0.2138F, 0.0F, 0.0F);
        cube_r34.cubeList.add(new ModelBox(cube_r34, 27, 70, -1.0F, -0.6058F, -4.3018F, 1, 1, 2, -0.1F, false));

        cube_r35 = new AdvancedModelRenderer(this);
        cube_r35.setRotationPoint(0.0F, 0.25F, -0.1F);
        jaw.addChild(cube_r35);
        setRotateAngle(cube_r35, 0.3316F, 0.0F, 0.0F);
        cube_r35.cubeList.add(new ModelBox(cube_r35, 63, 32, -1.5F, -1.8732F, -5.056F, 3, 1, 2, -0.1F, false));
        ...
        cube_r36 = new AdvancedModelRenderer(this);
        cube_r36.setRotationPoint(0.0F, 1.175F, 3.05F);
        throat1.addChild(cube_r36);
        setRotateAngle(cube_r36, -1.0821F, 0.0F, 0.0F);
        cube_r36.cubeList.add(new ModelBox(cube_r36, 40, 66, -1.0F, 1.0529F, -3.1776F, 2, 2, 2, -0.1F, false));
        ...
        cube_r37 = new AdvancedModelRenderer(this);
        cube_r37.setRotationPoint(0.0F, 1.25F, 3.3F);
        throat2.addChild(cube_r37);
        setRotateAngle(cube_r37, -0.3403F, 0.0F, 0.0F);
        cube_r37.cubeList.add(new ModelBox(cube_r37, 10, 55, -1.0F, -1.0777F, -3.7405F, 2, 2, 5, -0.15F, false));
        ...
        rightwing1.cubeList.add(new ModelBox(rightwing1, 41, 47, -7.0F, -0.25F, -0.5F, 7, 2, 2, 0.0F, false));
        ...
        rightwing1membrane.cubeList.add(new ModelBox(rightwing1membrane, 25, 17, -3.75F, -0.25F, 0.0F, 8, 1, 6, 0.0F, false));
        ...
        rightwing1planemembrane.cubeList.add(new ModelBox(rightwing1planemembrane, 36, 36, -2.0F, -0.635F, 6.0F, 4, 0, 6, 0.0F, false));
        ...
        rightwing2.cubeList.add(new ModelBox(rightwing2, 38, 43, -8.9F, -0.25F, -0.75F, 9, 1, 2, 0.0F, false));
        ...
        rightwing2membrane.cubeList.add(new ModelBox(rightwing2membrane, 25, 25, -8.9F, -0.25F, 1.25F, 9, 1, 5, 0.0F, false));
        ...
        rightwing2planemembrane.cubeList.add(new ModelBox(rightwing2planemembrane, 30, 11, -4.4F, -1.425F, 4.85F, 9, 0, 5, 0.0F, false));
        ...
        rightwing3.cubeList.add(new ModelBox(rightwing3, 49, 27, -7.0F, -0.15F, -0.45F, 7, 1, 1, 0.0F, false));
        ...
        rightwing3membrane.cubeList.add(new ModelBox(rightwing3membrane, 36, 1, -7.0F, -0.15F, 0.5F, 7, 1, 5, 0.0F, false));
        ...
        rightwing3planemembrane.cubeList.add(new ModelBox(rightwing3planemembrane, 15, 41, -3.5F, -0.45F, 0.5F, 7, 0, 4, 0.0F, false));
        ...
        rightwing4.cubeList.add(new ModelBox(rightwing4, 30, 8, -12.0F, -0.15F, -0.45F, 12, 1, 1, 0.0F, false));
        ...
        rightwing4membrane.cubeList.add(new ModelBox(rightwing4membrane, 0, 6, -12.0F, -0.15F, 0.5F, 12, 1, 5, 0.0F, false));
        ...
        rightwing4planemembrane.cubeList.add(new ModelBox(rightwing4planemembrane, 36, 32, -5.0F, -0.2F, 0.0F, 10, 0, 3, 0.0F, false));
        ...
        righthand.cubeList.add(new ModelBox(righthand, 67, 58, -2.0F, 0.0F, -1.0F, 2, 1, 2, 0.0F, false));
        ...
        rightwing5.cubeList.add(new ModelBox(rightwing5, 0, 46, -10.0F, -0.15F, -0.45F, 10, 1, 1, 0.0F, false));
        ...
        rightwing5membrane.cubeList.add(new ModelBox(rightwing5membrane, -1, 16, -9.0F, -0.175F, 0.5F, 10, 1, 5, 0.0F, false));
        ...
        rightwing6.cubeList.add(new ModelBox(rightwing6, 0, 13, -15.9F, -0.15F, -0.45F, 16, 1, 1, 0.0F, false));
        ...
        rightwing6membrane.cubeList.add(new ModelBox(rightwing6membrane, -1, -1, -15.9F, -0.15F, 0.45F, 16, 1, 4, 0.0F, false));
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        animator.move(hips, ((0.0F)-(0.0F)), ((-3.825F)-(-3.75F)),((7.075F)-(7.075F)));
        animator.move(leftwing1planemembrane, ((1.75F)-(1.75F)), ((0.275F)-(0.275F)),((0.0F)-(6.0F)));
        animator.move(leftwing2planemembrane, ((4.5F)-(4.5F)), ((0.55F)-(0.4F)),((1.225F)-(1.225F)));
        animator.move(leftwing3planemembrane, ((3.5F)-(3.5F)), ((0.4F)-(0.4F)),((5.0F)-(1.0F)));
        animator.move(rightwing1planemembrane, ((-1.75F)-(-1.75F)), ((0.275F)-(0.275F)),((0.0F)-(6.0F)));
        animator.move(rightwing2planemembrane, ((-4.5F)-(-4.5F)), ((0.55F)-(0.4F)),((1.225F)-(1.225F)));
        animator.move(rightwing3planemembrane, ((-3.5F)-(-3.5F)), ((0.4F)-(0.4F)),((5.0F)-(1.0F)));
        animator.move(rightwing5membrane, ((-1.0F)-(0.0F)), ((0.0F)-(0.0F)),((0.0F)-(0.0F)));
        ...
        animator.rotate(leftwing2planemembrane, ((-0.1658F)-(0.0175F)), ((-0.0016F)-(-0.0016F)),((-0.013F)-(-0.013F)));
        ...
        animator.rotate(rightwing2planemembrane, ((-0.1658F)-(0.0175F)), ((0.0016F)-(0.0016F)),((0.013F)-(0.013F)));
