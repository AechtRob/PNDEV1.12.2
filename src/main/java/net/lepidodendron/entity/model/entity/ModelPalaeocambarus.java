...
public class ModelPalaeocambarus extends ModelBasePalaeopedia {
    ...
    public ModelPalaeocambarus() {
        this.textureWidth = 36;
        this.textureHeight = 36;

        this.bone = new AdvancedModelRenderer(this);
        this.bone.setRotationPoint(0.0F, 25.05F, 0.0F);
        this.bone.cubeList.add(new ModelBox(bone, 0, 11, -2.0F, -5.5F, -7.0F, 4, 2, 5, 0.02F, false));
        this.bone.cubeList.add(new ModelBox(bone, 16, 27, -0.5F, -5.5F, -8.0F, 1, 0, 1, 0.0F, false));

        this.eyeR = new AdvancedModelRenderer(this);
        this.eyeR.setRotationPoint(-0.75F, -4.5F, -6.9F);
        this.bone.addChild(eyeR);
        this.setRotateAngle(eyeR, 0.0F, 0.2182F, 0.0F);
        this.eyeR.cubeList.add(new ModelBox(eyeR, 6, 26, -0.85F, -1.0F, -1.0F, 1, 1, 1, 0.0F, false));

        this.eyeL = new AdvancedModelRenderer(this);
        this.eyeL.setRotationPoint(0.75F, -4.5F, -6.9F);
        this.bone.addChild(eyeL);
        this.setRotateAngle(eyeL, 0.0F, -0.2182F, 0.0F);
        this.eyeL.cubeList.add(new ModelBox(eyeL, 6, 26, -0.15F, -1.0F, -1.0F, 1, 1, 1, 0.0F, true));
        ...
        this.antennaR.cubeList.add(new ModelBox(antennaR, 0, 0, 0.0F, -2.5F, -8.0F, 0, 3, 8, 0.0F, false));
        ...
        this.antennaL.cubeList.add(new ModelBox(antennaL, 0, 0, 0.0F, -2.5F, -8.0F, 0, 3, 8, 0.0F, true));

        this.antennaR2 = new AdvancedModelRenderer(this);
        this.antennaR2.setRotationPoint(-0.025F, -4.75F, -7.0F);
        this.bone.addChild(antennaR2);
        this.setRotateAngle(antennaR2, 0.1745F, 0.1309F, 0.0F);
        this.antennaR2.cubeList.add(new ModelBox(antennaR2, 20, 18, 0.0F, -0.5F, -4.0F, 0, 1, 4, 0.0F, false));

        this.antennaL2 = new AdvancedModelRenderer(this);
        this.antennaL2.setRotationPoint(0.025F, -4.75F, -7.0F);
        this.bone.addChild(antennaL2);
        this.setRotateAngle(antennaL2, 0.1745F, -0.1309F, 0.0F);
        this.antennaL2.cubeList.add(new ModelBox(antennaL2, 20, 18, 0.0F, -0.5F, -4.0F, 0, 1, 4, 0.0F, true));

        this.armR = new AdvancedModelRenderer(this);
        this.armR.setRotationPoint(-1.75F, -3.5F, -5.5F);
        ...
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 26, 25, -0.65F, -0.5F, -1.0F, 1, 1, 2, -0.01F, false));

        this.armR2 = new AdvancedModelRenderer(this);
        this.armR2.setRotationPoint(-0.15F, 0.0F, -1.3F);
        this.armR.addChild(armR2);
        this.setRotateAngle(armR2, 0.0F, -0.2618F, 0.0F);
        this.armR2.cubeList.add(new ModelBox(armR2, 26, 23, -0.75F, -0.5F, -1.0F, 1, 1, 1, 0.0F, false));
        ...
        this.armR3.cubeList.add(new ModelBox(armR3, 26, 6, -0.75F, -0.5F, -1.0F, 1, 1, 2, 0.02F, false));
        this.armR3.cubeList.add(new ModelBox(armR3, 26, 9, -0.25F, -0.5F, -1.0F, 1, 1, 2, 0.01F, false));
        this.armR3.cubeList.add(new ModelBox(armR3, 10, 21, -0.8F, -0.5F, -3.5F, 1, 1, 3, 0.01F, false));

        this.clawR = new AdvancedModelRenderer(this);
        this.clawR.setRotationPoint(0.35F, 0.0F, -2.0F);
        this.armR3.addChild(clawR);
        this.setRotateAngle(clawR, 0.0F, -0.3927F, 0.0F);
        this.clawR.cubeList.add(new ModelBox(clawR, 18, 23, -0.25F, -0.5F, -1.5F, 1, 1, 3, -0.01F, false));

        this.armL = new AdvancedModelRenderer(this);
        this.armL.setRotationPoint(1.75F, -3.5F, -5.5F);
        ...
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 26, 25, -0.35F, -0.5F, -1.0F, 1, 1, 2, -0.01F, true));

        this.armL2 = new AdvancedModelRenderer(this);
        this.armL2.setRotationPoint(0.15F, 0.0F, -1.3F);
        this.armL.addChild(armL2);
        this.setRotateAngle(armL2, 0.0F, 0.2618F, 0.0F);
        this.armL2.cubeList.add(new ModelBox(armL2, 26, 23, -0.25F, -0.5F, -1.0F, 1, 1, 1, 0.0F, true));
        ...
        this.armL3.cubeList.add(new ModelBox(armL3, 26, 6, -0.25F, -0.5F, -1.0F, 1, 1, 2, 0.02F, true));
        this.armL3.cubeList.add(new ModelBox(armL3, 26, 9, -0.75F, -0.5F, -1.0F, 1, 1, 2, 0.01F, true));
        this.armL3.cubeList.add(new ModelBox(armL3, 10, 21, -0.2F, -0.5F, -3.5F, 1, 1, 3, 0.01F, true));

        this.clawL = new AdvancedModelRenderer(this);
        this.clawL.setRotationPoint(-0.35F, 0.0F, -2.0F);
        this.armL3.addChild(clawL);
        this.setRotateAngle(clawL, 0.0F, 0.3927F, 0.0F);
        this.clawL.cubeList.add(new ModelBox(clawL, 18, 23, -0.75F, -0.5F, -1.5F, 1, 1, 3, -0.01F, true));

        this.legR = new AdvancedModelRenderer(this);
        this.legR.setRotationPoint(-1.5F, -3.25F, -3.75F);
        this.bone.addChild(legR);
        this.setRotateAngle(legR, 0.0F, 1.1781F, 0.0F);
        this.legR.cubeList.add(new ModelBox(legR, 16, 0, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, false));

        this.legL = new AdvancedModelRenderer(this);
        this.legL.setRotationPoint(1.5F, -3.25F, -3.75F);
        this.bone.addChild(legL);
        this.setRotateAngle(legL, 0.0F, -1.1781F, 0.0F);
        this.legL.cubeList.add(new ModelBox(legL, 16, 0, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, true));

        this.legfrontR = new AdvancedModelRenderer(this);
        this.legfrontR.setRotationPoint(-1.0F, -3.5F, -5.75F);
        this.bone.addChild(legfrontR);
        this.setRotateAngle(legfrontR, 0.2182F, 0.3491F, 0.0F);
        this.legfrontR.cubeList.add(new ModelBox(legfrontR, 0, 26, 0.0F, -0.95F, -3.25F, 0, 2, 3, 0.0F, false));

        this.legfrontL = new AdvancedModelRenderer(this);
        this.legfrontL.setRotationPoint(1.0F, -3.5F, -5.75F);
        this.bone.addChild(legfrontL);
        this.setRotateAngle(legfrontL, 0.2182F, -0.3491F, 0.0F);
        this.legfrontL.cubeList.add(new ModelBox(legfrontL, 0, 26, 0.0F, -0.95F, -3.25F, 0, 2, 3, 0.0F, true));

        this.legR2 = new AdvancedModelRenderer(this);
        this.legR2.setRotationPoint(-1.5F, -3.25F, -3.4F);
        this.bone.addChild(legR2);
        this.setRotateAngle(legR2, 0.0F, 1.4399F, 0.0F);
        this.legR2.cubeList.add(new ModelBox(legR2, 0, 18, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, false));

        this.legL2 = new AdvancedModelRenderer(this);
        this.legL2.setRotationPoint(1.5F, -3.25F, -3.4F);
        this.bone.addChild(legL2);
        this.setRotateAngle(legL2, 0.0F, -1.4399F, 0.0F);
        this.legL2.cubeList.add(new ModelBox(legL2, 0, 18, 0.0F, -0.75F, -5.0F, 0, 3, 5, 0.0F, true));

        this.legR3 = new AdvancedModelRenderer(this);
        this.legR3.setRotationPoint(-1.5F, -3.25F, -3.1F);
        this.bone.addChild(legR3);
        this.setRotateAngle(legR3, 0.0F, 1.8326F, 0.0F);
        this.legR3.cubeList.add(new ModelBox(legR3, 18, 8, 0.0F, -0.75F, -4.0F, 0, 3, 4, 0.0F, false));

        this.legL3 = new AdvancedModelRenderer(this);
        this.legL3.setRotationPoint(1.5F, -3.25F, -3.1F);
        this.bone.addChild(legL3);
        this.setRotateAngle(legL3, 0.0F, -1.8326F, 0.0F);
        this.legL3.cubeList.add(new ModelBox(legL3, 18, 8, 0.0F, -0.75F, -4.0F, 0, 3, 4, 0.0F, true));

        this.legR4 = new AdvancedModelRenderer(this);
        this.legR4.setRotationPoint(-1.5F, -3.25F, -2.7F);
        this.bone.addChild(legR4);
        this.setRotateAngle(legR4, 0.0F, 2.2253F, 0.0F);
        this.legR4.cubeList.add(new ModelBox(legR4, 10, 25, 0.0F, -0.75F, -3.0F, 0, 3, 3, 0.0F, false));

        this.legL4 = new AdvancedModelRenderer(this);
        this.legL4.setRotationPoint(1.5F, -3.25F, -2.7F);
        this.bone.addChild(legL4);
        this.setRotateAngle(legL4, 0.0F, -2.2253F, 0.0F);
        this.legL4.cubeList.add(new ModelBox(legL4, 10, 25, 0.0F, -0.75F, -3.0F, 0, 3, 3, 0.0F, true));
        ...
        this.pleopodR.setRotationPoint(-0.5F, 0.5F, 0.25F);
        this.body1.addChild(pleopodR);
        this.setRotateAngle(pleopodR, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR.cubeList.add(new ModelBox(pleopodR, 16, 8, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL = new AdvancedModelRenderer(this);
        this.pleopodL.setRotationPoint(0.5F, 0.5F, 0.25F);
        this.body1.addChild(pleopodL);
        this.setRotateAngle(pleopodL, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL.cubeList.add(new ModelBox(pleopodL, 16, 8, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.pleopodR2 = new AdvancedModelRenderer(this);
        this.pleopodR2.setRotationPoint(-0.5F, 0.5F, 1.0F);
        this.body1.addChild(pleopodR2);
        this.setRotateAngle(pleopodR2, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR2.cubeList.add(new ModelBox(pleopodR2, 18, 21, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL2 = new AdvancedModelRenderer(this);
        this.pleopodL2.setRotationPoint(0.5F, 0.5F, 1.0F);
        this.body1.addChild(pleopodL2);
        this.setRotateAngle(pleopodL2, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL2.cubeList.add(new ModelBox(pleopodL2, 18, 21, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.body2 = new AdvancedModelRenderer(this);
        this.body2.setRotationPoint(0.0F, -0.25F, -0.5F);
        this.body1.addChild(body2);
        this.setRotateAngle(body2, -0.0436F, 0.0F, 0.0F);
        this.body2.cubeList.add(new ModelBox(body2, 10, 18, -1.5F, -0.25F, 0.0F, 3, 1, 2, 0.0F, false));

        this.cube_r3 = new AdvancedModelRenderer(this);
        this.cube_r3.setRotationPoint(1.5F, 0.7F, 0.95F);
        this.body2.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.0F, 0.8727F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 30, 31, -0.25F, 0.0F, -1.0F, 1, 0, 2, 0.0F, true));

        this.cube_r4 = new AdvancedModelRenderer(this);
        this.cube_r4.setRotationPoint(-1.5F, 0.7F, 0.95F);
        this.body2.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0F, 0.0F, -0.8727F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 30, 31, -0.75F, 0.0F, -1.0F, 1, 0, 2, 0.0F, false));

        this.pleopodR3 = new AdvancedModelRenderer(this);
        this.pleopodR3.setRotationPoint(-0.5F, 0.75F, 2.35F);
        this.body2.addChild(pleopodR3);
        this.setRotateAngle(pleopodR3, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR3.cubeList.add(new ModelBox(pleopodR3, 16, 25, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL3 = new AdvancedModelRenderer(this);
        this.pleopodL3.setRotationPoint(0.5F, 0.75F, 2.35F);
        this.body2.addChild(pleopodL3);
        this.setRotateAngle(pleopodL3, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL3.cubeList.add(new ModelBox(pleopodL3, 16, 25, -0.5F, -0.75F, 0.0F, 1, 2, 0, 0.0F, true));

        this.pleopodR4 = new AdvancedModelRenderer(this);
        this.pleopodR4.setRotationPoint(-0.5F, 0.75F, 3.2F);
        this.body2.addChild(pleopodR4);
        this.setRotateAngle(pleopodR4, 0.0F, 0.3491F, 0.2182F);
        this.pleopodR4.cubeList.add(new ModelBox(pleopodR4, 24, 27, -0.5F, -0.65F, 0.0F, 1, 2, 0, 0.0F, false));

        this.pleopodL4 = new AdvancedModelRenderer(this);
        this.pleopodL4.setRotationPoint(0.5F, 0.75F, 3.2F);
        this.body2.addChild(pleopodL4);
        this.setRotateAngle(pleopodL4, 0.0F, -0.3491F, -0.2182F);
        this.pleopodL4.cubeList.add(new ModelBox(pleopodL4, 24, 27, -0.5F, -0.65F, 0.0F, 1, 2, 0, 0.0F, true));

        this.body3 = new AdvancedModelRenderer(this);
        this.body3.setRotationPoint(0.0F, -0.2F, 2.25F);
        this.body2.addChild(body3);
        this.setRotateAngle(body3, -0.1309F, 0.0F, 0.0F);
        this.body3.cubeList.add(new ModelBox(body3, 18, 15, -1.5F, 0.0F, -0.25F, 3, 1, 2, -0.01F, false));

        this.cube_r5 = new AdvancedModelRenderer(this);
        this.cube_r5.setRotationPoint(1.5F, 0.9F, 0.7F);
        this.body3.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.0F, 0.8727F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 30, 31, -0.25F, 0.0F, -1.0F, 1, 0, 2, 0.0F, true));

        this.cube_r6 = new AdvancedModelRenderer(this);
        this.cube_r6.setRotationPoint(-1.5F, 0.9F, 0.7F);
        this.body3.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, 0.0F, -0.8727F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 30, 31, -0.75F, 0.0F, -1.0F, 1, 0, 2, 0.0F, false));

        this.body4 = new AdvancedModelRenderer(this);
        this.body4.setRotationPoint(0.0F, 0.1F, 1.75F);
        this.body3.addChild(body4);
        this.setRotateAngle(body4, -0.2182F, 0.0F, 0.0F);
        this.body4.cubeList.add(new ModelBox(body4, 26, 4, -1.5F, 0.0F, -0.25F, 3, 1, 1, -0.02F, false));

        this.cube_r7 = new AdvancedModelRenderer(this);
        this.cube_r7.setRotationPoint(1.5F, 0.8F, 0.95F);
        this.body4.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, 0.0F, 0.8727F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 31, 31, -0.5F, 0.0F, -1.0F, 1, 0, 1, 0.0F, true));

        this.cube_r8 = new AdvancedModelRenderer(this);
        this.cube_r8.setRotationPoint(-1.5F, 0.8F, 0.95F);
        this.body4.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, 0.0F, -0.8727F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 31, 31, -0.5F, 0.0F, -1.0F, 1, 0, 1, 0.0F, false));

        this.body6 = new AdvancedModelRenderer(this);
        this.body6.setRotationPoint(0.0F, 0.0F, 0.65F);
        this.body4.addChild(body6);
        this.setRotateAngle(body6, -0.2618F, 0.0F, 0.0F);
        this.body6.cubeList.add(new ModelBox(body6, 26, 12, -1.0F, 0.0F, 0.0F, 2, 1, 1, -0.02F, false));

        this.tail2 = new AdvancedModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, 0.0F, 1.0F);
        this.body6.addChild(tail2);
        this.setRotateAngle(tail2, -0.1745F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 26, 14, -0.99F, 0.25F, 0.0F, 2, 0, 1, 0.0F, false));
        this.tail2.cubeList.add(new ModelBox(tail2, 20, 27, -0.49F, 0.25F, 1.0F, 1, 0, 1, 0.0F, false));

        this.tailfanR = new AdvancedModelRenderer(this);
        this.tailfanR.setRotationPoint(-0.25F, 0.25F, 0.0F);
        this.tail2.addChild(tailfanR);
        this.setRotateAngle(tailfanR, -0.1309F, -0.48F, -0.0436F);
        this.tailfanR.cubeList.add(new ModelBox(tailfanR, 26, 0, -1.01F, 0.0F, -0.1F, 2, 0, 2, 0.0F, false));

        this.tailfanL = new AdvancedModelRenderer(this);
        this.tailfanL.setRotationPoint(0.25F, 0.25F, 0.0F);
        this.tail2.addChild(tailfanL);
        this.setRotateAngle(tailfanL, -0.1309F, 0.4363F, 0.0436F);
        this.tailfanL.cubeList.add(new ModelBox(tailfanL, 26, 0, -0.99F, 0.0F, -0.1F, 2, 0, 2, 0.0F, true));
        ...
        this.tailfanR2.cubeList.add(new ModelBox(tailfanR2, 26, 2, -1.01F, 0.0F, 0.0F, 2, 0, 2, 0.0F, false));
        ...
        this.tailfanL2.cubeList.add(new ModelBox(tailfanL2, 26, 2, -0.99F, 0.0F, 0.0F, 2, 0, 2, 0.0F, true));
    ...
    public void renderStaticBook(float f) {
        ...
        this.bone.offsetX = -1.45F;
        this.bone.rotateAngleY = (float)Math.toRadians(235);
        this.bone.rotateAngleX = (float)Math.toRadians(38);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
       ...
       // this.body.offsetY = 0.4F;
        ...
        EntityPrehistoricFloraPalaeocambarus slimon = (EntityPrehistoricFloraPalaeocambarus) e;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.resetToDefaultPose();
        EntityPrehistoricFloraPalaeocambarus ee = (EntityPrehistoricFloraPalaeocambarus) entitylivingbaseIn;
        //Swimming pose:
    ...
    public void animWalking(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime, boolean isStatic) {
        EntityPrehistoricFloraPalaeocambarus entity = (EntityPrehistoricFloraPalaeocambarus) entitylivingbaseIn;
        int animCycle = 40;
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        EntityPrehistoricFloraPalaeocambarus e = (EntityPrehistoricFloraPalaeocambarus) entity;
