...
public class ModelFlowerIlicium extends AdvancedModelBase {
    ...
    public ModelFlowerIlicium() {
        ...
        this.setRotateAngle(petalA2, 0.0F, -1.0472F, 0.0F);
        ...
        this.setRotateAngle(petalA3, 0.0F, -2.0944F, 0.0F);
        ...
        this.setRotateAngle(petalA4, 0.0F, 3.1416F, 0.0F);
        ...
        this.setRotateAngle(petalA5, 0.0F, 2.0944F, 0.0F);
        ...
        this.setRotateAngle(petalA6, 0.0F, 1.0472F, 0.0F);
        ...
        this.setRotateAngle(petalB, 0.0F, 0.5236F, 0.0F);
        ...
        this.setRotateAngle(petalB2, 0.0F, 1.5708F, 0.0F);
        ...
        this.setRotateAngle(petalB3, 0.0F, 2.618F, 0.0F);
        ...
        this.setRotateAngle(petalB4, 0.0F, -2.618F, 0.0F);
        ...
        this.setRotateAngle(petalB5, 0.0F, -1.5708F, 0.0F);
        ...
        this.setRotateAngle(petalB6, 0.0F, -0.5236F, 0.0F);
