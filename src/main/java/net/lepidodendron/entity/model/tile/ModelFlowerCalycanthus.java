...
public class ModelFlowerCalycanthus extends AdvancedModelBase {
    ...
    public ModelFlowerCalycanthus() {
        ...
        this.setRotateAngle(petalbone2, 1.2217F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(petal7, 0.0F, -0.6981F, 0.0F);
        ...
        this.setRotateAngle(petal8, 0.0F, -1.7453F, 0.0F);
        ...
        this.setRotateAngle(petal9, 0.0F, -2.7925F, 0.0F);
        ...
        this.setRotateAngle(petal10, 0.0F, 2.4435F, 0.0F);
        ...
        this.setRotateAngle(petal11, 0.0F, 1.3963F, 0.0F);
        ...
        this.setRotateAngle(petal12, 0.0F, 0.3491F, 0.0F);
