...
public class ModelFlowerMagnolia extends AdvancedModelBase {
    ...
    public ModelFlowerMagnolia() {
        ...
        this.setRotateAngle(cube_r4, 0.0F, 0.0F, -1.0472F);
        ...
        this.setRotateAngle(cube_r5, 0.0F, 0.0F, -1.0472F);
        ...
        this.setRotateAngle(cube_r6, 0.0F, 0.0F, -1.0472F);
        ...
        this.setRotateAngle(cube_r7, 0.0F, 0.0F, -1.0472F);
