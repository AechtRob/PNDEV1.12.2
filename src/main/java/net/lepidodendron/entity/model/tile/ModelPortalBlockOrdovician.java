...
public class ModelPortalBlockOrdovician extends AdvancedModelBase {
    ...
    public void renderTentacle(int animationTick, float f, double partialTicks, int offset, float f2, float timeOffset) {
        ...
        AdvancedModelRenderer[] tentacleAll = {this.tentacles1, this.tentaclea2, this.tentaclea3, this.tentaclea4};
    ...
    public void renderTentacleVar(int animationTick, float f, double partialTicks, int offset, float f2, float timeOffset) {
        ...
        AdvancedModelRenderer[] tentacleAll = {this.tentacleb1, this.tentacleb2, this.tentacleb3, this.tentacleb4};
