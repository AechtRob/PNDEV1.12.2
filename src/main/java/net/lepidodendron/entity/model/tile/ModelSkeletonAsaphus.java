...
public class ModelSkeletonAsaphus extends AdvancedModelBase {
    ...
    public ModelSkeletonAsaphus() {
        ...
        this.body.cubeList.add(new ModelBox(body, 0, 24, -6.0F, 0.0F, -9.0F, 9, 1, 7, -0.01F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, -3.0F, 0.0F, 0.0F, 9, 1, 7, -0.01F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, -4.0F, 0.0F, -7.0F, 9, 1, 7, 0.01F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, 1.0F, 0.0F, -7.0F, 5, 1, 4, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, -1.0F, 0.0F, 7.0F, 5, 1, 2, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, -4.0F, 0.0F, -11.0F, 5, 1, 2, 0.0F, false));
        this.body.cubeList.add(new ModelBox(body, 0, 24, -5.0F, 0.0F, -3.0F, 9, 1, 7, 0.0F, false));
