...
public class EntityPrehistoricFloraCallawayia extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraCallawayia(World world) {
		super(world);
		setSize(0.53F, 0.5F);
		minWidth = 0.15F;
		maxWidth = 0.53F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraCallawayia(this.world);
	}
...
//		this.targetTasks.addTask(2, new HuntSmallerThanMeAIAgeable(this, EntityLiving.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CALLAWAYIA_LOOT_YOUNG;
		}
		return LepidodendronMod.CALLAWAYIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CALLAWAYIA;
	}
