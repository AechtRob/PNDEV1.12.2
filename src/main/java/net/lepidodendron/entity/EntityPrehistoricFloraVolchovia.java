...
public class EntityPrehistoricFloraVolchovia extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraVolchovia(World world) {
		super(world, 60);
		setSize(0.2F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.VOLCHOVIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VOLCHOVIA;
	}
}