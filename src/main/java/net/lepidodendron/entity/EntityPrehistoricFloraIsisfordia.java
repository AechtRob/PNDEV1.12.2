...
public class EntityPrehistoricFloraIsisfordia extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraIsisfordia(World world) {
		super(world);
		setSize(0.6F, 0.6F);
		minWidth = 0.1F;
		maxWidth = 0.6F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraIsisfordia(this.world);
	}
