...
import net.lepidodendron.entity.render.entity.RenderSasayamagnomus;
...
public class EntityPrehistoricFloraSasayamagnomus extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSasayamagnomus(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraSasayamagnomus> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraSasayamagnomus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraSasayamagnomus currentYinlong : Yinlong) {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SASAYAMAGNOMUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SASAYAMAGNOMUS_LOOT;
	}
    @Nullable
    @Override
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_SASAYAMAGNOMUS;
    }
	//Rendering taxidermy:
	//--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderSasayamagnomus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelSasayamagnomus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderSasayamagnomus.getScaler();
    }
