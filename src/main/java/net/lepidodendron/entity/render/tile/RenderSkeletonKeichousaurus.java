...
import net.lepidodendron.block.BlockSkeletonKeichousaurus;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonKeichousaurus;
...
public class RenderSkeletonKeichousaurus extends TileEntitySpecialRenderer<BlockSkeletonKeichousaurus.TileEntitySkeletonKeichousaurus> {
    ...
    public RenderSkeletonKeichousaurus() {
        this.modelSkeleton = new ModelSkeletonKeichousaurus();
    }

    @Override
    public void render(BlockSkeletonKeichousaurus.TileEntitySkeletonKeichousaurus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonKeichousaurus modelSkeleton = this.modelSkeleton;
        double scale = RenderKeichousaurus.getScaler() * RenderDisplayWallMount.scaler;
