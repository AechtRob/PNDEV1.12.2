...
public class RenderEggsRoachoidForest extends TileEntitySpecialRenderer<BlockInsectEggsRoachoidForest.TileEntityCustom> {
    ...
    public RenderEggsRoachoidForest() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsRoachoidForest.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsRoachoidForest.block) {
