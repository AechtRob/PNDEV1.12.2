...
public class RenderEggsArchoblattina extends TileEntitySpecialRenderer<BlockInsectEggsArchoblattina.TileEntityCustom> {
    ...
    @Override
    public void render(BlockInsectEggsArchoblattina.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsArchoblattina.block) {
