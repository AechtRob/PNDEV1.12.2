...
import net.lepidodendron.block.BlockSkeletonYorgia;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonYorgia;
...
public class RenderSkeletonYorgia extends TileEntitySpecialRenderer<BlockSkeletonYorgia.TileEntitySkeletonYorgia> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/yorgia_stage1.png");
    private final ModelSkeletonYorgia modelSkeleton;

    public RenderSkeletonYorgia() {
        this.modelSkeleton = new ModelSkeletonYorgia();
    }

    @Override
    public void render(BlockSkeletonYorgia.TileEntitySkeletonYorgia entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonYorgia modelSkeleton = this.modelSkeleton;
        double scale = RenderYorgia.getScaler() * RenderDisplayWallMount.scaler;
