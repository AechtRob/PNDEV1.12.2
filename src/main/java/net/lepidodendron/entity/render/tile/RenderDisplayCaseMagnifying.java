                    ...
                    if (te instanceof BlockDisplayCaseMagnifying.TileEntityDisplayCase) {
                        ...
                        if (itemstack.getItem() instanceof ItemGlassCaseDisplayItem) {
                            ...
                            if (classEntity != null) {
                                ...
                                Method method = Functions.testAndGetMethod(classEntity, "offsetCaseMagnified", params);
                                if (method != null) {
                                    try {
                                ...
                                method = Functions.testAndGetMethod(classEntity, "getScalerMagnified", params);
                                if (method != null) {
                                    try {
