...
import net.lepidodendron.block.BlockSkeletonMixopterus;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonMixopterus;
...
public class RenderSkeletonMixopterus extends TileEntitySpecialRenderer<BlockSkeletonMixopterus.TileEntitySkeletonMixopterus> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/mixopterus_stage1.png");
    private final ModelSkeletonMixopterus modelSkeleton;

    public RenderSkeletonMixopterus() {
        this.modelSkeleton = new ModelSkeletonMixopterus();
    }

    @Override
    public void render(BlockSkeletonMixopterus.TileEntitySkeletonMixopterus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonMixopterus modelSkeleton = this.modelSkeleton;
        double scale = RenderMixopterus.getScaler() * RenderDisplayWallMount.scaler;
