...
import net.lepidodendron.block.BlockSkeletonLimulid;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonLimulid;
...
public class RenderSkeletonLimulid extends TileEntitySpecialRenderer<BlockSkeletonLimulid.TileEntitySkeletonLimulid> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/limulid_stage1.png");
    private final ModelSkeletonLimulid modelSkeleton;

    public RenderSkeletonLimulid() {
        this.modelSkeleton = new ModelSkeletonLimulid();
    }



    @Override
    public void render(BlockSkeletonLimulid.TileEntitySkeletonLimulid entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonLimulid modelSkeleton = this.modelSkeleton;
        double scale = RenderLimulid.getScaler() * RenderDisplayWallMount.scaler;
