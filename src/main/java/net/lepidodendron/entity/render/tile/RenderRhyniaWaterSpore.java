...
public class RenderRhyniaWaterSpore extends TileEntitySpecialRenderer<BlockRhyniaWaterSpore.TileEntityRhyniaWaterSpore> {
    ...
    public RenderRhyniaWaterSpore() {
        this.halfBlock = new ModelHalfBlock();
    }

    @Override
    public void render(BlockRhyniaWaterSpore.TileEntityRhyniaWaterSpore entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (entity != null && entity.hasWorld() && world.getBlockState(pos).getBlock() == BlockRhyniaWaterSpore.block) {
