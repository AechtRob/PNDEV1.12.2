...
public class RenderEggsArthropleura extends TileEntitySpecialRenderer<BlockInsectEggsArthropleura.TileEntityCustom> {
    ...
    public RenderEggsArthropleura() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsArthropleura.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsArthropleura.block) {
