...
public class RenderEggsPneumodesmus extends TileEntitySpecialRenderer<BlockInsectEggsPneumodesmus.TileEntityCustom> {
    ...
    public RenderEggsPneumodesmus() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsPneumodesmus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsPneumodesmus.block) {
