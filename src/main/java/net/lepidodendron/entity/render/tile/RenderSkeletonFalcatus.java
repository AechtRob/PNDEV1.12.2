...
import net.lepidodendron.block.BlockSkeletonFalcatus;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonFalcatus;
...
public class RenderSkeletonFalcatus extends TileEntitySpecialRenderer<BlockSkeletonFalcatus.TileEntitySkeletonFalcatus> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/falcatus_stage1.png");
    private final ModelSkeletonFalcatus modelSkeleton;

    public RenderSkeletonFalcatus() {
        this.modelSkeleton = new ModelSkeletonFalcatus();
    }

    @Override
    public void render(BlockSkeletonFalcatus.TileEntitySkeletonFalcatus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonFalcatus modelSkeleton = this.modelSkeleton;
        double scale = RenderFalcatus.getScaler() * RenderDisplayWallMount.scaler;
