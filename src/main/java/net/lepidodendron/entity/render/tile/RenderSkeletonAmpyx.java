...
import net.lepidodendron.block.BlockSkeletonAmpyx;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonAmpyx;
...
public class RenderSkeletonAmpyx extends TileEntitySpecialRenderer<BlockSkeletonAmpyx.TileEntitySkeletonAmpyx> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/ampyx_stage1.png");
    private final ModelSkeletonAmpyx modelSkeleton;

    public RenderSkeletonAmpyx() {
        this.modelSkeleton = new ModelSkeletonAmpyx();
    }

    @Override
    public void render(BlockSkeletonAmpyx.TileEntitySkeletonAmpyx entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonAmpyx modelSkeleton = this.modelSkeleton;
        double scale = RenderAmpyx.getScaler() * RenderDisplayWallMount.scaler;
