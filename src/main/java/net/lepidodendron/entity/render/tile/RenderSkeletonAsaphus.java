...
import net.lepidodendron.block.BlockSkeletonAsaphus;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonAsaphus;
...
public class RenderSkeletonAsaphus extends TileEntitySpecialRenderer<BlockSkeletonAsaphus.TileEntitySkeletonAsaphus> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/asaphus_stage1.png");
    private final ModelSkeletonAsaphus modelSkeleton;

    public RenderSkeletonAsaphus() {
        this.modelSkeleton = new ModelSkeletonAsaphus();
    }

    @Override
    public void render(BlockSkeletonAsaphus.TileEntitySkeletonAsaphus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonAsaphus modelSkeleton = this.modelSkeleton;
        double scale = RenderAsaphus.getScaler() * RenderDisplayWallMount.scaler;
