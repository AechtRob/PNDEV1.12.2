...
import net.lepidodendron.block.BlockSkeletonArthropleura;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonArthropleura;
...
public class RenderSkeletonArthropleura extends TileEntitySpecialRenderer<BlockSkeletonArthropleura.TileEntitySkeletonArthropleura> {
    ...
    public RenderSkeletonArthropleura() {
        this.modelSkeleton = new ModelSkeletonArthropleura();
    }

    @Override
    public void render(BlockSkeletonArthropleura.TileEntitySkeletonArthropleura entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonArthropleura modelSkeleton = this.modelSkeleton;
        double scale = RenderArthropleura.getScaler() * RenderDisplayWallMount.scaler;
