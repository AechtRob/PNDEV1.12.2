...
import net.lepidodendron.block.BlockSkeletonAkmonistion;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonAkmonistion;
...
public class RenderSkeletonAkmonistion extends TileEntitySpecialRenderer<BlockSkeletonAkmonistion.TileEntitySkeletonAkmonistion> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/akmonistion_stage1.png");
    private final ModelSkeletonAkmonistion modelSkeleton;

    public RenderSkeletonAkmonistion() {
        this.modelSkeleton = new ModelSkeletonAkmonistion();
    }

    @Override
    public void render(BlockSkeletonAkmonistion.TileEntitySkeletonAkmonistion entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
