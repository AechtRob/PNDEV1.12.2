...
import net.lepidodendron.block.BlockSkeletonMeganeura;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonMeganeura;
...
public class RenderSkeletonMeganeura extends TileEntitySpecialRenderer<BlockSkeletonMeganeura.TileEntitySkeletonMeganeura> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/meganeura_stage1.png");
    private final ModelSkeletonMeganeura modelSkeleton;

    public RenderSkeletonMeganeura() {
        this.modelSkeleton = new ModelSkeletonMeganeura();
    }

    @Override
    public void render(BlockSkeletonMeganeura.TileEntitySkeletonMeganeura entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
