...
import net.lepidodendron.block.BlockSkeletonCoccosteus;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonCoccosteus;
...
public class RenderSkeletonCoccosteus extends TileEntitySpecialRenderer<BlockSkeletonCoccosteus.TileEntitySkeletonCoccosteus> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/coccosteus_stage1.png");
    private final ModelSkeletonCoccosteus modelSkeleton;

    public RenderSkeletonCoccosteus() {
        this.modelSkeleton = new ModelSkeletonCoccosteus();
    }

    @Override
    public void render(BlockSkeletonCoccosteus.TileEntitySkeletonCoccosteus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonCoccosteus modelSkeleton = this.modelSkeleton;
        double scale = RenderCoccosteus.getScaler() * RenderDisplayWallMount.scaler;
