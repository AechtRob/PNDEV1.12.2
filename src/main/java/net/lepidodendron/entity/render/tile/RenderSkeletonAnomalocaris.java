...
import net.lepidodendron.block.BlockSkeletonAnomalocaris;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonAnomalocaris;
...
public class RenderSkeletonAnomalocaris extends TileEntitySpecialRenderer<BlockSkeletonAnomalocaris.TileEntitySkeletonAnomalocaris> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/anomalocaris_stage1.png");
    private final ModelSkeletonAnomalocaris modelSkeleton;

    public RenderSkeletonAnomalocaris() {
        this.modelSkeleton = new ModelSkeletonAnomalocaris();
    }

    @Override
    public void render(BlockSkeletonAnomalocaris.TileEntitySkeletonAnomalocaris entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
