...
public class RenderDisplays extends TileEntitySpecialRenderer<BlockDisplayWallMount.TileEntityDisplayWallMount> {
    ...
    public static final ResourceLocation TEXTURE_ARIZONASAURUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/arizonasaurus.png");
    ...
    public static final ResourceLocation TEXTURE_ANTEOSAURUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/anteosaurus.png");
    ...
    public static final ResourceLocation TEXTURE_BATRACHOTOMUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/batrachotomus.png");
    ...
    public static final ResourceLocation TEXTURE_CARYOSYNTRIPS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/caryosyntrips.png");
 ...
 public static final ResourceLocation TEXTURE_CERATODUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/ceratodus.png");
    public static final ModelCephalaspis modelCephalaspis = new ModelCephalaspis();
    public static final ResourceLocation TEXTURE_CEPHALASPIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/cephalaspis.png");
    public static final ModelChinlea modelChinlea = new ModelChinlea();
    public static final ResourceLocation TEXTURE_CHINLEA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/chinlea.png");
    ...
    public static final ResourceLocation TEXTURE_CRASSIGYRINUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/crassigyrinus.png");
    ...
    public static final ResourceLocation TEXTURE_CYAMODUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/cyamodus.png");
    ...
    public static final ResourceLocation TEXTURE_DAKOSAURUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/dakosaurus.png");
    ...
    public static final ResourceLocation TEXTURE_HARPACANTHUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/harpacanthus.png");
   ...
   public static final ResourceLocation TEXTURE_HETEROSTEUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/heterosteus.png");
    public static final ModelHaikouichthys modelHaikouichthys = new ModelHaikouichthys();
    public static final ResourceLocation TEXTURE_HAIKOUICHTYS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/haikouichthys.png");
   public static final ResourceLocation TEXTURE_INOSTRANCEVIA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/inostrancevia.png");
    ...
    public static final ResourceLocation TEXTURE_LUNASPIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/lungmenshanaspis.png");
    ...
    public static final ResourceLocation TEXTURE_MEGATEUTHIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/megateuthis.png");
   ...
   public static final ModelMastodonsaurus modelMastodonsaurus = new ModelMastodonsaurus();
    public static final ResourceLocation TEXTURE_MASTODONSAURUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/mastodonsaurus.png");
    ...
    public static final ResourceLocation TEXTURE_OPABINIA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/opabinia.png");
    ...
    public static final ResourceLocation TEXTURE_OPHIOPSIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/ophiopsis.png");
    ...
    public static final ResourceLocation TEXTURE_PROTEROCTOPUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/proteroctopus.png");
    public static final ModelProterosuchus modelProterosuchus = new ModelProterosuchus();
    public static final ResourceLocation TEXTURE_PROTEROSUCHUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/proterosuchus.png");
    public static final ModelPseudotherium modelPseudotherium = new ModelPseudotherium();
    public static final ResourceLocation TEXTURE_PSEUDOTHERIUM = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/pseudotherium.png");
    ...
    public static final ResourceLocation TEXTURE_POLYBRANCHIASPIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/polybranchiaspis.png");
    public static final ModelPurlovia modelPurlovia = new ModelPurlovia();
    public static final ResourceLocation TEXTURE_PURLOVIA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/purlovia.png");
    public static final ResourceLocation TEXTURE_PHLEBOLEPIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/phlebolepis.png");
    ...
    public static final ResourceLocation TEXTURE_PHLEGETHONTIA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/phlegethontia.png");
    ...
    public static final ResourceLocation TEXTURE_RHOMALEOSAURUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/rhomaleosaurus.png");
    ...
    public static final ResourceLocation TEXTURE_RHIZODUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/rhizodus.png");
    ...
    public static final ResourceLocation TEXTURE_SIBYRHYNCHUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/sibyrhynchus.png");
    ...
    public static final ResourceLocation TEXTURE_SQUALORAJA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/squaloraja.png");
    public static final ModelSuminia modelSuminia = new ModelSuminia();
    public static final ResourceLocation TEXTURE_SUMINIA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/suminia.png");
    ...
    public static final ResourceLocation TEXTURE_THANAHITA = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/thanahita.png");
    ...
    public static final ResourceLocation TEXTURE_SANCTACARIS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/sanctacaris.png");
    ...
    public static final ResourceLocation TEXTURE_JAMOYTIUS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/jamoytius.png");
