...
public class RenderAncientMoss extends TileEntitySpecialRenderer<BlockAncientMoss.TileEntityCustom> {
    ...
    private static final ResourceLocation TEXTURE_ITALOPHLEBIA_EGGS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/titanoptera_eggs.png");
