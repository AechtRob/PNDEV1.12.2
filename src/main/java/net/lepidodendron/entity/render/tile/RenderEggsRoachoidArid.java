...
public class RenderEggsRoachoidArid extends TileEntitySpecialRenderer<BlockInsectEggsRoachoidArid.TileEntityCustom> {
    ...
    public RenderEggsRoachoidArid() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsRoachoidArid.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsRoachoidArid.block) {
