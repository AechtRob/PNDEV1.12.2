...
public class RenderEggsGerarus extends TileEntitySpecialRenderer<BlockInsectEggsGerarus.TileEntityCustom> {

    private final ModelInsectEggs insect_eggs;
    private static final ResourceLocation TEXTURE_ROACHOID_EGGS = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/gerarus_eggs.png");
    public static final PropertyDirection FACING = BlockDirectional.FACING;

    public RenderEggsGerarus() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsGerarus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsGerarus.block) {
