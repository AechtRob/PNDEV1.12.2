...
import net.lepidodendron.block.BlockSkeletonMegarachne;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonMegarachne;
...
public class RenderSkeletonMegarachne extends TileEntitySpecialRenderer<BlockSkeletonMegarachne.TileEntitySkeletonMegarachne> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/megarachne_stage1.png");
    private final ModelSkeletonMegarachne modelSkeleton;

    public RenderSkeletonMegarachne() {
        this.modelSkeleton = new ModelSkeletonMegarachne();
    }

    @Override
    public void render(BlockSkeletonMegarachne.TileEntitySkeletonMegarachne entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonMegarachne modelSkeleton = this.modelSkeleton;
        double scale = RenderMegarachne.getScaler() * RenderDisplayWallMount.scaler;
