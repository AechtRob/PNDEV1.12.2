...
import net.lepidodendron.block.BlockSkeletonWalliserops;
import net.lepidodendron.block.base.BlockSkeletonBase;
import net.lepidodendron.entity.model.tile.ModelSkeletonWalliserops;
...
public class RenderSkeletonWalliserops extends TileEntitySpecialRenderer<BlockSkeletonWalliserops.TileEntitySkeletonWalliserops> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(LepidodendronMod.MODID + ":textures/skeletons/walliserops_stage1.png");
    private final ModelSkeletonWalliserops modelSkeleton;

    public RenderSkeletonWalliserops() {
        this.modelSkeleton = new ModelSkeletonWalliserops();
    }

    @Override
    public void render(BlockSkeletonWalliserops.TileEntitySkeletonWalliserops entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
