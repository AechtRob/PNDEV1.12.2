...
public class RenderEggsPalaeontinid extends TileEntitySpecialRenderer<BlockInsectEggsPalaeontinid.TileEntityCustom> {
    ...
    public RenderEggsPalaeontinid() {
        this.insect_eggs = new ModelInsectEggs();
    }

    @Override
    public void render(BlockInsectEggsPalaeontinid.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld() && entity.getWorld().getBlockState(entity.getPos()).getBlock() == BlockInsectEggsPalaeontinid.block) {
