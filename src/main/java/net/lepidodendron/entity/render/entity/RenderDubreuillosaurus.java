...
public class RenderDubreuillosaurus extends RenderLiving<EntityPrehistoricFloraDubreuillosaurus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraDubreuillosaurus entity, double x, double y, double z, float entityYaw, float partialTicks) {
