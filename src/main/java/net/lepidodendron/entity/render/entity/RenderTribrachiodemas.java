...
public class RenderTribrachiodemas extends RenderLivingBaseWithBook<EntityPrehistoricFloraTribrachiodemas> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/tribrachiodemas.png");
