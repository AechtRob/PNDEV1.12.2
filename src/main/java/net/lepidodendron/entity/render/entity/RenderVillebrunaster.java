...
public class RenderVillebrunaster extends RenderLivingBaseWithBook<EntityPrehistoricFloraVillebrunaster> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/villebrunaster.png");
