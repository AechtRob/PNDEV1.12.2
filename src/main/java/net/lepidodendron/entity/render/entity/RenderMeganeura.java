...
public class RenderMeganeura extends RenderLivingBaseWithBook<EntityPrehistoricFloraMeganeura> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraMeganeura entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerMeganeuraWing.TEXTURE);
                GlStateManager.pushMatrix();
