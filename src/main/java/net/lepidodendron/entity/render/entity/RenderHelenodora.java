...
public class RenderHelenodora extends RenderLivingBaseWithBook<EntityPrehistoricFloraHelenodora> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/helenodora.png");
