...
public class RenderOsteolepis extends RenderLivingBaseWithBook<EntityPrehistoricFloraOsteolepis> {
    ...
    @Override
    protected void preRenderCallback(EntityPrehistoricFloraOsteolepis entity, float f) {
