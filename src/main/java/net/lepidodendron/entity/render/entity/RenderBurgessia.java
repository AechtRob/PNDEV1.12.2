...
public class RenderBurgessia extends RenderLiving<EntityPrehistoricFloraBurgessia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraBurgessia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelBurgessiaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
