...
public class RenderEglonaspis extends RenderLivingBaseWithBook<EntityPrehistoricFloraEglonaspis> {
    ...
    public static float getScaler() {return 0.92F; }
    ...
    @Override
    protected void preRenderCallback(EntityPrehistoricFloraEglonaspis entity, float f) {
