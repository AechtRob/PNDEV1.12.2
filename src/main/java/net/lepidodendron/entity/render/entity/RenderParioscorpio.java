...
public class RenderParioscorpio extends RenderLiving<EntityPrehistoricFloraParioscorpio> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraParioscorpio entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelParioscorpioBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
