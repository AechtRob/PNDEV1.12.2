...
public class RenderProtozygoptera extends RenderLivingBaseWithBook<EntityPrehistoricFloraProtozygoptera> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraProtozygoptera entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerProtozygopteraWing.TEXTURE);
                GlStateManager.pushMatrix();
