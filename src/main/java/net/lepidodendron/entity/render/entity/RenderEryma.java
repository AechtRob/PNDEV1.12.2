...
public class RenderEryma extends RenderLiving<EntityPrehistoricFloraEryma> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraEryma entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelErymaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
