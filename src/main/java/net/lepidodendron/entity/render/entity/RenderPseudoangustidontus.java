...
public class RenderPseudoangustidontus extends RenderLiving<EntityPrehistoricFloraPseudoangustidontus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraPseudoangustidontus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelPseudoangustidontusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
