...
public class RenderItalophlebia extends RenderLivingBaseWithBook<EntityPrehistoricFloraItalophlebia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraItalophlebia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerItalophlebiaWing.TEXTURE);
                GlStateManager.pushMatrix();
