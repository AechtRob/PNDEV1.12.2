...
public class RenderGogonasus extends RenderLivingBaseWithBook<EntityPrehistoricFloraGogonasus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/gogonasus.png");
