...
public class RenderBowengriphus extends RenderLiving<EntityPrehistoricFloraBowengriphus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraBowengriphus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelBowengriphusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
