...
public class RenderArchaeopteryx extends RenderLiving<EntityPrehistoricFloraArchaeopteryx> {
    ...
    public RenderArchaeopteryx(RenderManager mgr) {
        super(mgr, new ModelArchaeopteryx(), 0.0f);
    }

    @Override
    public void doRender(EntityPrehistoricFloraArchaeopteryx entity, double x, double y, double z, float entityYaw, float partialTicks) {
