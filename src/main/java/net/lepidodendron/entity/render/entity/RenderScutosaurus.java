...
public class RenderScutosaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraScutosaurus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/scutosaurus.png");
