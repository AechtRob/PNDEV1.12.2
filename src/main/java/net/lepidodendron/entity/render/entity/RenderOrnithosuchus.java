...
public class RenderOrnithosuchus extends RenderLivingBaseWithBook<EntityPrehistoricFloraOrnithosuchus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/ornithosuchus.png");
