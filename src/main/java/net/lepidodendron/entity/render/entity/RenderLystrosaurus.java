...
public class RenderLystrosaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraLystrosaurus> {
    ...
    public RenderLystrosaurus(RenderManager mgr) {
        super(mgr, new ModelLystrosaurus(), RenderDisplays.modelLystrosaurus, 0.45f);
    }
