...
public class RenderPapilionichthys extends RenderLiving<EntityPrehistoricFloraPapilionichthys> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/papilionichthys.png");
    public static float getScaler() {
        return 0.7F * 0.395F;
    }
    public RenderPapilionichthys(RenderManager mgr) {
        super(mgr, new ModelPapilionichthys(), 0.0f);
    }
