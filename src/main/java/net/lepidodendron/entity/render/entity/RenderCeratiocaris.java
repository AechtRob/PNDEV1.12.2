...
public class RenderCeratiocaris extends RenderLiving<EntityPrehistoricFloraCeratiocaris> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/ceratiocaris.png");
    public static float getScaler() {
        return 0.7F * 0.3F;
    }
    public RenderCeratiocaris(RenderManager mgr) {
        super(mgr, new ModelCeratiocaris(), 0.0f);
    }
