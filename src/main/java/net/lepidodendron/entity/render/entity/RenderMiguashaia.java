...
public class RenderMiguashaia extends RenderLiving<EntityPrehistoricFloraMiguashaia> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/miguashaia.png");
    public static float getScaler() {
        return 0.7F * 0.4F;
    }
    public RenderMiguashaia(RenderManager mgr) {
        super(mgr, new ModelMiguashaia(), 0.0f);
    }
