...
public class RenderNesonektris extends RenderLiving<EntityPrehistoricFloraNesonektris> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraNesonektris entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelNesonektrisBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
