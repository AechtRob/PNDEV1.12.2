...
public class RenderCyanorus extends RenderLivingBaseWithBook<EntityPrehistoricFloraCyanorus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraCyanorus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerCyanorusBody.TEXTURE);
                GlStateManager.pushMatrix();
