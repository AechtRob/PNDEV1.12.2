...
public class RenderOrnitholestes extends RenderLiving<EntityPrehistoricFloraOrnitholestes> {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityPrehistoricFloraOrnitholestes entity) {
        return RenderOrnitholestes.TEXTURE;
    }

    @Override
    public void doRender(EntityPrehistoricFloraOrnitholestes entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Override
    protected void applyRotations(EntityPrehistoricFloraOrnitholestes entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
        super.applyRotations(entityLiving, ageInTicks, rotationYaw, partialTicks);
    }

    @Override
    protected void preRenderCallback(EntityPrehistoricFloraOrnitholestes entity, float f) {
