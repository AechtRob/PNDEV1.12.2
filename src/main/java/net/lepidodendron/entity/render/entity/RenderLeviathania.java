...
public class RenderLeviathania extends RenderLiving<EntityPrehistoricFloraLeviathania> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/leviathania.png");
    public static float getScaler() {
        return 0.9F;
    }
    public RenderLeviathania(RenderManager mgr) {
        super(mgr, new ModelLeviathania(), 0.0f);
    }
