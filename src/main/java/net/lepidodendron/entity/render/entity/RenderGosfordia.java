...
public class RenderGosfordia extends RenderLiving<EntityPrehistoricFloraGosfordia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraGosfordia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelGosfordiaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
