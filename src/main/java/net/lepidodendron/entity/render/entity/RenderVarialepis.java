...
public class RenderVarialepis extends RenderLivingBaseWithBook<EntityPrehistoricFloraVarialepis> {
    ...
    public RenderVarialepis(RenderManager mgr) {
        super(mgr, new ModelVarialepis(), RenderDisplays.modelVarialepis, 0.0f);
    }
