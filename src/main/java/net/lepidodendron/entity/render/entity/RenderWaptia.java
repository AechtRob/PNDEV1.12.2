...
public class RenderWaptia extends RenderLiving<EntityPrehistoricFloraWaptia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraWaptia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelWaptiaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
