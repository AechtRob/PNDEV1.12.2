...
public class RenderBrachiosaurus extends RenderLiving<EntityPrehistoricFloraBrachiosaurus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraBrachiosaurus entity, double x, double y, double z, float entityYaw, float partialTicks) {
