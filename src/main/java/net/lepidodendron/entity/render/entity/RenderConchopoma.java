...
public class RenderConchopoma extends RenderLiving<EntityPrehistoricFloraConchopoma> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraConchopoma entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelConchopomaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
