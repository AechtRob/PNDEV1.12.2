...
public class RenderOphthalmothule extends RenderLiving<EntityPrehistoricFloraOphthalmothule> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/ophthalmothule.png");
