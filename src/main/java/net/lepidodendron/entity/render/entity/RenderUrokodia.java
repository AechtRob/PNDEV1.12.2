...
public class RenderUrokodia extends RenderLiving<EntityPrehistoricFloraUrokodia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraUrokodia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelUrokodiaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
