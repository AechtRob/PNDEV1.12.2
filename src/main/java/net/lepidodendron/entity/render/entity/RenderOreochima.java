...
public class RenderOreochima extends RenderLivingBaseWithBook<EntityPrehistoricFloraOreochima> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/oreochima.png");
