...
public class RenderMeganeurites extends RenderLivingBaseWithBook<EntityPrehistoricFloraMeganeurites> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraMeganeurites entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerMeganeuritesWing.TEXTURE);
                GlStateManager.pushMatrix();
