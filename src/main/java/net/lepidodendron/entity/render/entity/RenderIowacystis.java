...
public class RenderIowacystis extends RenderLivingBaseWithBook<EntityPrehistoricFloraIowacystis> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/iowacystis.png");
