...
public class RenderDipteronotus extends RenderLiving<EntityPrehistoricFloraDipteronotus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraDipteronotus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelDipteronotusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
