...
public class RenderDebeerius extends RenderLiving<EntityPrehistoricFloraDebeerius> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraDebeerius entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelDebeeriusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
