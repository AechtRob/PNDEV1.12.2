...
public class RenderConcavicaris extends RenderLivingBaseWithBook<EntityPrehistoricFloraConcavicaris> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/concavicaris.png");
