...
public class RenderTetragraptus extends RenderLivingBaseWithBook<EntityPrehistoricFloraTetragraptus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/tetragraptus.png");
