...
public class RenderDiplodocus extends RenderLiving<EntityPrehistoricFloraDiplodocus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraDiplodocus entity, double x, double y, double z, float entityYaw, float partialTicks) {
