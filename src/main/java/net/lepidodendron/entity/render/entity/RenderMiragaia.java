...
public class RenderMiragaia extends RenderLivingBaseWithBook<EntityPrehistoricFloraMiragaia> {
    ...
    public RenderMiragaia(RenderManager mgr) {
        super(mgr, new ModelMiragaia(), RenderDisplays.modelMiragaia, 0.3f);
    }
