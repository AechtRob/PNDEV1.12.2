...
public class RenderScheenstia extends RenderLiving<EntityPrehistoricFloraScheenstia> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/scheenstia.png");
