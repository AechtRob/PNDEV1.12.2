...
public class RenderFlagellopantopus extends RenderLiving<EntityPrehistoricFloraFlagellopantopus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraFlagellopantopus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelFlagellopantopusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
