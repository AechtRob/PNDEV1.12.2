...
public class RenderMoschops extends RenderLivingBaseWithBook<EntityPrehistoricFloraMoschops> {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityPrehistoricFloraMoschops entity) {
        return RenderMoschops.TEXTURE;
    }

    @Override
    protected void applyRotations(EntityPrehistoricFloraMoschops entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
