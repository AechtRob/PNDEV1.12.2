...
public class RenderNamurotypus extends RenderLivingBaseWithBook<EntityPrehistoricFloraNamurotypus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraNamurotypus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerNamurotypusWing.TEXTURE);
                GlStateManager.pushMatrix();
