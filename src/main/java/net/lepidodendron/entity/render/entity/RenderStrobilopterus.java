...
public class RenderStrobilopterus extends RenderLiving<EntityPrehistoricFloraStrobilopterus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraStrobilopterus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelStrobilopterusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
