...
public class RenderClarkeiteuthis extends RenderLivingBaseWithBook<EntityPrehistoricFloraClarkeiteuthis> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/clarkeiteuthis.png");
