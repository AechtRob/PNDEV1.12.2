...
public class RenderHurdia extends RenderLiving<EntityPrehistoricFloraHurdia> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/hurdia.png");
