...
public class RenderParameteoraspis extends RenderLiving<EntityPrehistoricFloraParameteoraspis> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/parameteoraspis.png");
