...
public class RenderJellyfish1 extends RenderLivingBaseWithBook<EntityPrehistoricFloraJellyfish1> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/jellyfish_1.png");
