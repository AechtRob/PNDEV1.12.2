...
public class RenderWarneticaris extends RenderLivingBaseWithBook<EntityPrehistoricFloraWarneticaris> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/warneticaris.png");
