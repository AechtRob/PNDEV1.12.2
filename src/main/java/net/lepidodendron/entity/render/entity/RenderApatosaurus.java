...
public class RenderApatosaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraApatosaurus> {
    ...
    public RenderApatosaurus(RenderManager mgr) {
        super(mgr, new ModelApatosaurus(), RenderDisplays.modelApatosaurusBook, 0.3f);
    }
