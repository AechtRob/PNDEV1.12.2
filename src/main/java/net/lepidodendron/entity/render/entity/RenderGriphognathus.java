...
public class RenderGriphognathus extends RenderLivingBaseWithBook<EntityPrehistoricFloraGriphognathus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/griphognathus.png");
