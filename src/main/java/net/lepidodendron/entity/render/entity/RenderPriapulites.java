...
public class RenderPriapulites extends RenderLivingBaseWithBook<EntityPrehistoricFloraPriapulites> {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityPrehistoricFloraPriapulites entity) {
        return RenderPriapulites.TEXTURE;
    }
    @Override
    protected void applyRotations(EntityPrehistoricFloraPriapulites entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
    ...
    protected void preRenderCallback(EntityPrehistoricFloraPriapulites entity, float f) {
