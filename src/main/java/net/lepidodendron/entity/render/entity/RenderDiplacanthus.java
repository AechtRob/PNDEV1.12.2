...
public class RenderDiplacanthus extends RenderLiving<EntityPrehistoricFloraDiplacanthus> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/diplacanthus.png");
    public static float getScaler() {
        return 0.7F * 0.4F;
    }
    public RenderDiplacanthus(RenderManager mgr) {
        super(mgr, new ModelDiplacanthus(), 0.0f);
    }
