...
public class RenderHeterodontosaurus extends RenderLiving<EntityPrehistoricFloraHeterodontosaurus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraHeterodontosaurus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
