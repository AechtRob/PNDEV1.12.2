...
public class RenderCumnoria extends RenderLiving<EntityPrehistoricFloraCumnoria> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraCumnoria entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
        ...
        if (clazz.getName().equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
            ...
            RenderDisplays.modelCumnoria.renderStaticBook(this.prepareScale(entity, partialTicks));
            if (flag)
            {
