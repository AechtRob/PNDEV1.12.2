...
public class RenderWodnika extends RenderLiving<EntityPrehistoricFloraWodnika> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraWodnika entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelWodnikaBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
