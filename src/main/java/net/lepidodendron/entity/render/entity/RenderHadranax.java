...
public class RenderHadranax extends RenderLiving<EntityPrehistoricFloraHadranax> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraHadranax entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelHadranaxBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
