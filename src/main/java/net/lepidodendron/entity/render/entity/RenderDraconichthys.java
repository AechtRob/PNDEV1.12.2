...
public class RenderDraconichthys extends RenderLivingBaseWithBook<EntityPrehistoricFloraDraconichthys> {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityPrehistoricFloraDraconichthys entity) {
        return RenderDraconichthys.TEXTURE;
    }

    @Override
    protected void applyRotations(EntityPrehistoricFloraDraconichthys entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
        super.applyRotations(entityLiving, ageInTicks, rotationYaw, partialTicks);
    }
    @Override
    protected void preRenderCallback(EntityPrehistoricFloraDraconichthys entity, float f) {
