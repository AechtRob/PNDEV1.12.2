...
public class RenderGlacialisaurus extends RenderLiving<EntityPrehistoricFloraGlacialisaurus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraGlacialisaurus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
        ...
        if (clazz.getName().equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
            ...
            RenderDisplays.modelGlacialisaurusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
            if (flag)
            {
