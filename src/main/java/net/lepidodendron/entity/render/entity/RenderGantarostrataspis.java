...
public class RenderGantarostrataspis extends RenderLivingBaseWithBook<EntityPrehistoricFloraGantarostrataspis> {
    ...
    @Override
    protected void preRenderCallback(EntityPrehistoricFloraGantarostrataspis entity, float f) {
