...
public class RenderLiaosteus extends RenderLiving<EntityPrehistoricFloraLiaosteus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraLiaosteus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelLiaosteusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
