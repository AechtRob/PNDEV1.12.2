...
public class RenderThulaspis extends RenderLiving<EntityPrehistoricFloraThulaspis> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraThulaspis entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelThulaspisBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
