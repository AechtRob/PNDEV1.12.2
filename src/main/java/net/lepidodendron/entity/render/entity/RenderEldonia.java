...
public class RenderEldonia extends RenderLivingBaseWithBook<EntityPrehistoricFloraEldonia> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraEldonia entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                //Layer1:
                this.bindTexture(LayerEldoniaCap.TEXTURE);
                GlStateManager.pushMatrix();
