...
public class RenderHydropessum extends RenderLiving<EntityPrehistoricFloraHydropessum> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraHydropessum entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelHydropessumBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
