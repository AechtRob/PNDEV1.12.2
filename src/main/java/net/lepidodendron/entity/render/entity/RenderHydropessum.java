...
public class RenderHydropessum extends RenderLivingBaseWithBook<EntityPrehistoricFloraHydropessum> {
    ...
    public RenderHydropessum(RenderManager mgr) {
        super(mgr, new ModelHydropessum(), RenderDisplays.modelHydropessumBook, 0.0f);
    }
