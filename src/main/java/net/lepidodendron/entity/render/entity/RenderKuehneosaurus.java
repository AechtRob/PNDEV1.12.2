...
import net.lepidodendron.entity.model.entity.ModelKuehneosaurus;
...
public class RenderKuehneosaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraKuehneosaurus> {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityPrehistoricFloraKuehneosaurus entity) {
        return RenderKuehneosaurus.TEXTURE;
    }

    @Override
    protected void preRenderCallback(EntityPrehistoricFloraKuehneosaurus entity, float f) {
    ...
    @Override
    protected void applyRotations(EntityPrehistoricFloraKuehneosaurus entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
