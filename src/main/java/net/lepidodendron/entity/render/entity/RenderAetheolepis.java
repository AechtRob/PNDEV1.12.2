...
public class RenderAetheolepis extends RenderLiving<EntityPrehistoricFloraAetheolepis> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/aetheolepis.png");
