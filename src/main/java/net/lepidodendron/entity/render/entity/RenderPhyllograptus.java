...
public class RenderPhyllograptus extends RenderLiving<EntityPrehistoricFloraPhyllograptus> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraPhyllograptus entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelPhyllograptusBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag) {
