...
public class RenderCometicercus extends RenderLiving<EntityPrehistoricFloraCometicercus> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/cometicercus.png");
    public static float getScaler() {
        return 0.7F * 0.25F;
    }
    public RenderCometicercus(RenderManager mgr) {
        super(mgr, new ModelCometicercus(), 0.0f);
    }
