...
public class RenderSargodon extends RenderLiving<EntityPrehistoricFloraSargodon> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraSargodon entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelSargodonBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
