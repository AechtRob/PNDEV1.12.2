...
public class RenderMobulavermis extends RenderLiving<EntityPrehistoricFloraMobulavermis> {
    ...
    @Override
    public void doRender(EntityPrehistoricFloraMobulavermis entity, double x, double y, double z, float entityYaw, float partialTicks) {
        try {
            ...
            if (callerClass.equalsIgnoreCase("vazkii.patchouli.client.book.page.PageEntity")) {
                ...
                RenderDisplays.modelMobulavermisBook.renderStaticBook(this.prepareScale(entity, partialTicks));
                if (flag)
                {
