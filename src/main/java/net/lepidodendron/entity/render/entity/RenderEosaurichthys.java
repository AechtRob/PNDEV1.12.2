...
public class RenderEosaurichthys extends RenderLivingBaseWithBook<EntityPrehistoricFloraEosaurichthys> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eosaurichthys.png");
