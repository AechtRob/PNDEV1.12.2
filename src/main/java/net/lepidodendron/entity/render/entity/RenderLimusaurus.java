...
public class RenderLimusaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraLimusaurus> {
    ...
    public RenderLimusaurus(RenderManager mgr) {
        super(mgr, new ModelLimusaurus(), RenderDisplays.modelLimusaurus, 0.3f);
    }
