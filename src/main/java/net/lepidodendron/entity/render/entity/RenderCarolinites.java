...
public class RenderCarolinites extends RenderLiving<EntityPrehistoricFloraCarolinites> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/carolinites.png");
