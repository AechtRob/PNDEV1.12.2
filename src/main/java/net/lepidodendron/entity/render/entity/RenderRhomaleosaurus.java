...
public class RenderRhomaleosaurus extends RenderLivingBaseWithBook<EntityPrehistoricFloraRhomaleosaurus> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/rhomaleosaurus.png");
