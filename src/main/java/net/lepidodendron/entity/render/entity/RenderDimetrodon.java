...
public class RenderDimetrodon extends RenderLivingBaseWithBook<EntityPrehistoricFloraDimetrodon> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/dimetrodon.png");
