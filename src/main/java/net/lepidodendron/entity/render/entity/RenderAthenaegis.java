...
public class RenderAthenaegis extends RenderLivingBaseWithBook<EntityPrehistoricFloraAthenaegis> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/athenaegis.png");
