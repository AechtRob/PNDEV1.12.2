...
import net.lepidodendron.entity.render.entity.RenderLuskhan;
...
public class EntityPrehistoricFloraLuskhan extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.LUSKHAN_LOOT_YOUNG;
		}
		return LepidodendronMod.LUSKHAN_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraLuskhan(this.world);
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LUSKHAN;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderLuskhan.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelLuskhan;}
	public static float getScaler(@Nullable String variant) {return RenderLuskhan.getScaler();}
