...
import net.lepidodendron.entity.render.entity.RenderElaphrosaurus;
...
public class EntityPrehistoricFloraElaphrosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
...
//		}
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase && this.hasAlarm()) {
			...
			for (EntityPrehistoricFloraElaphrosaurus currentElaphrosaurus : Elaphrosaurus) {
				currentElaphrosaurus.setAnimation(NO_ANIMATION);
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelElaphrosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderElaphrosaurus.getScaler();
	}
