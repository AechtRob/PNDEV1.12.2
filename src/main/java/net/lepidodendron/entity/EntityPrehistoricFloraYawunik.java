...
import net.lepidodendron.item.entities.ItemBucketYawunik;
...
public class EntityPrehistoricFloraYawunik extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraYawunik(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketYawunik.block, (int) (1));
