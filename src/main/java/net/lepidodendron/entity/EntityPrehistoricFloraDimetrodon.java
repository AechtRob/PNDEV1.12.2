...
public class EntityPrehistoricFloraDimetrodon extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraDimetrodon(World world) {
		...
		STAND_ANIMATION = Animation.create(36);
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getRoarSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:dimetrodon_roar"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DIMETRODON;
	}
