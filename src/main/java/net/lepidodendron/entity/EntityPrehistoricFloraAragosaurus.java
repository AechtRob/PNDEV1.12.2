...
import net.lepidodendron.entity.render.entity.RenderAragosaurus;
...
public class EntityPrehistoricFloraAragosaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraAragosaurus(World world) {
		super(world);
		setSize(1.8F, 2.7F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARAGOSAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.ARAGOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ARAGOSAURUS_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderAragosaurus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelAragosaurus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderAragosaurus.getScaler();
    }
