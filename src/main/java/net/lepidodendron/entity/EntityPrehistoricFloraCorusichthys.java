...
public class EntityPrehistoricFloraCorusichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraCorusichthys(World world) {
		super(world);
		setSize(0.15F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CORUSICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CORUSICHTHYS;
	}
