...
public class EntityPrehistoricFloraGigantspinosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraGigantspinosaurus(World world) {
		super(world);
		setSize(1.8F, 1.5F);
		minWidth = 0.3F;
		maxWidth = 1.8F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.GIGANTSPINOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.GIGANTSPINOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GIGANTSPINOSAURUS;
	}
}