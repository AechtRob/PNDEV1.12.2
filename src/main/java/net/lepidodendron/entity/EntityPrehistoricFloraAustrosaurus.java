...
public class EntityPrehistoricFloraAustrosaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraAustrosaurus(World world) {
		super(world);
		setSize(3.0F, 5F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AUSTROSAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.AUSTROSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.AUSTROSAURUS_LOOT;
	}
