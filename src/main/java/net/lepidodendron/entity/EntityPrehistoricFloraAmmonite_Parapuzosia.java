...
public class EntityPrehistoricFloraAmmonite_Parapuzosia extends EntityPrehistoricFloraNautiloidBase implements ITrappableWater, IAdvancementGranter {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AMMONITE_PARAPUZOSIA;
	}
