...
public class EntityPrehistoricFloraAkmonistion extends EntityPrehistoricFloraAgeableFishBase {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(1, new HuntForDietEntityPrehistoricFloraAgeableBaseAI(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, ((this.height + this.width) / 2F) * 0.1F, ((this.height + this.width) / 2F) * 0.8F));
