...
import net.lepidodendron.entity.render.entity.RenderKronosaurus;
...
public class EntityPrehistoricFloraKronosaurus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraKronosaurus(World world) {
		super(world);
		setSize(2.7F, 1.2F);
		minWidth = 0.2F;
		maxWidth = 2.7F;
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.KRONOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.KRONOSAURUS_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraKronosaurus(this.world);
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KRONOSAURUS;
	}
    ...
    public static double lowerfrontlineoffset(@Nullable String variant) {return 0.4;}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderKronosaurus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelKronosaurus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderKronosaurus.getScaler();
    }
