...
public class EntityPrehistoricFloraProtozygoptera extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderProtozygoptera.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplayTransparent(@Nullable String variant) {
		return LayerProtozygopteraWing.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelProtozygoptera;}
