...
import net.lepidodendron.item.entities.ItemBucketJianshanopodia;
...
public class EntityPrehistoricFloraJianshanopodia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraJianshanopodia.class, DataSerializers.VARINT);
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.JIANSHANOPODIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketJianshanopodia.block, (int) (1));
