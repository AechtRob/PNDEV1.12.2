...
public class EntityPrehistoricFloraAnderella extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAnderella(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAnderella.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAnderella;}
	public static float getScaler(@Nullable String variant) {return RenderAnderella.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANDERELLA;
	}
}