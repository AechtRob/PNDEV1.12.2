...
public class EntityPrehistoricFloraMillerosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMillerosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraMillerosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMillerosteus(this.world);
	}
	...
	public void onLivingUpdate() {
		...
		if (this.getAnimation() == ATTACK_ANIMATION && this.getAnimationTick() == 2 && this.getAttackTarget() != null) {
			launchAttack();
		}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MILLEROSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MILLEROSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraMillerosteus EntityBase = EntityPrehistoricFloraMillerosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraMillerosteus.this);
		}
