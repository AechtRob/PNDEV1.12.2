...
public class EntityPrehistoricFloraMosura extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMosura(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MOSURA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MOSURA;
	}
}