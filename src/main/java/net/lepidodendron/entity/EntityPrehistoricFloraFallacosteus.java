...
public class EntityPrehistoricFloraFallacosteus extends EntityPrehistoricFloraAgeableFishBase {
	...
	public EntityPrehistoricFloraFallacosteus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.3F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraFallacosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.FALLACOSTEUS_LOOT;
	}
	...
	public static double lowerfrontverticallinedepth() {return 1;}
	...
	public static ResourceLocation textureDisplay() {
		return RenderDisplays.TEXTURE_FALLACOSTEUS;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay() {
		return RenderDisplays.modelFallacosteus;
	}
