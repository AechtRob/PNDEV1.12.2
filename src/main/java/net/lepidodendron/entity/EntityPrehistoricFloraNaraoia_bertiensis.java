...
import net.lepidodendron.entity.render.entity.RenderNaraoia_bertiensis;
...
public class EntityPrehistoricFloraNaraoia_bertiensis extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNaraoia_bertiensis(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NARAOIA_BERTIENSIS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NARAOIA_BERTIENSIS;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderNaraoia_bertiensis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelNaraoia_bertiensis;}
	public static float getScaler(@Nullable String variant) {return RenderNaraoia_bertiensis.getScaler();}
