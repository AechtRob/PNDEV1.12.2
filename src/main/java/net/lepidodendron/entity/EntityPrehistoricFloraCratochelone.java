...
public class EntityPrehistoricFloraCratochelone extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraCratochelone(World world) {
		super(world);
		setSize(0.7F, 0.5F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRATOCHELONE;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CRATOCHELONE_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
