...
public class EntityPrehistoricFloraEoconfuciusornis extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, ITrappableLand {
	...
	private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraEoconfuciusornis.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraEoconfuciusornis(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.3F;
		maxWidth = 0.3F;
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraEoconfuciusornis.Type.byId(rand.nextInt(EntityPrehistoricFloraEoconfuciusornis.Type.values().length) + 1));
		return livingdata;
	}
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraEoconfuciusornis)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_eoconfuciusornis_" + this.getPNType().getName() + ".name");
		}
	}
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraEoconfuciusornis.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraEoconfuciusornis.Type getTypeFromString(String nameIn)
		{
	...
	public void setPNType(EntityPrehistoricFloraEoconfuciusornis.Type type)
	{
		this.dataManager.set(GENDER, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraEoconfuciusornis.Type getPNType()
	{
		return EntityPrehistoricFloraEoconfuciusornis.Type.byId(((Integer)this.dataManager.get(GENDER)).intValue());
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		{
			this.setPNType(EntityPrehistoricFloraEoconfuciusornis.Type.getTypeFromString(compound.getString("PNType")));
		}
	}
	...
	public boolean findGrappleTarget() {
		...
		List<EntityPrehistoricFloraEoconfuciusornis> Confuciusornis = world.getEntitiesWithinAABB(EntityPrehistoricFloraEoconfuciusornis.class, new AxisAlignedBB(this.getPosition().add(-6, -4, -6), this.getPosition().add(6, 4, 6)));
		for (EntityPrehistoricFloraEoconfuciusornis currentConfuciusornis : Confuciusornis) {
