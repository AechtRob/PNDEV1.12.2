...
public class EntityPrehistoricFloraProsalirus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, IWaterSurfaceEggsAmphibian {
	...
	public EntityPrehistoricFloraProsalirus(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.12F;
		maxWidth = 0.15F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AmphibianWander(this, NO_ANIMATION, 0.01, 20));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PROSALIRUS_LOOT;
	}
...
//	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROSALIRUS;
	}
