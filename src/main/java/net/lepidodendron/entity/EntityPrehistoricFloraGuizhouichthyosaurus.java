...
import net.lepidodendron.entity.render.entity.RenderGuizhouichthyosaurus;
...
public class EntityPrehistoricFloraGuizhouichthyosaurus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGuizhouichthyosaurus(World world) {
		super(world);
		setSize(2.7F, 1.2F);
		minWidth = 0.2F;
		maxWidth = 2.7F;
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.GUIZHOUICHTHYOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.GUIZHOUICHTHYOSAURUS_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGuizhouichthyosaurus(this.world);
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GUIZHOUICHTHYOSAURUS;
	}
}
