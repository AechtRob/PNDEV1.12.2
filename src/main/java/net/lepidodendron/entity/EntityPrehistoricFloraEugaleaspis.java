...
public class EntityPrehistoricFloraEugaleaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraEugaleaspis(World world) {
		super(world);
		setSize(0.2F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EUGALEASPIS_LOOT;
	}
	...
	public static float getScaler(@Nullable String variant) {
		return RenderEugaleaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EUGALEASPIS;
	}
}