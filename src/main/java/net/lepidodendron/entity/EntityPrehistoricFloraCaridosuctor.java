...
import net.lepidodendron.entity.render.entity.RenderCaridosuctor;
...
public class EntityPrehistoricFloraCaridosuctor extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraCaridosuctor(World world) {
		super(world);
		setSize(0.22F, 0.19F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CARIDOSUCTOR_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderCaridosuctor.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelCaridosuctor;}
	public static float getScaler(@Nullable String variant) {return RenderCaridosuctor.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CARIDOSUCTOR;
	}
