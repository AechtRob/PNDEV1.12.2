...
public class EntityPrehistoricFloraRoachoidAridInsect extends EntityPrehistoricFloraArchoblattinaInsect implements IAdvancementGranter, ITrappableAir {
	...
	public ItemStack getDroppedEggItemStack() {
		...
		variantNBT.setString("creature", "lepidodendron:prehistoric_flora_roachoid_arid");
...
//	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ROACHOID_ARID_JAR_LOOT;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRoachoidArid.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelRoachoid;}
	public static float getScaler(@Nullable String variant) {
		return RenderRoachoidArid.getScaler();
	}
