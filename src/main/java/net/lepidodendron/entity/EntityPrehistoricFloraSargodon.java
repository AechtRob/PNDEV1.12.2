...
public class EntityPrehistoricFloraSargodon extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraSargodon(World world) {
		super(world);
		setSize(0.7F, 0.8F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.FISHFOOD, DietString.SHELLFISH);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SARGODON_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSargodon;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSargodon.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SARGODON;
	}
}
