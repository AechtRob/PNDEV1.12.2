...
public class EntityPrehistoricFloraPalaeodictyoptera_Lycocercus extends EntityPrehistoricFloraInsectFlyingBase {
	...
	public EntityPrehistoricFloraPalaeodictyoptera_Lycocercus(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		experienceValue = 0;
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.PALAEODICTYOPTERA_LYCOCERCUS_LOOT_JAR;
