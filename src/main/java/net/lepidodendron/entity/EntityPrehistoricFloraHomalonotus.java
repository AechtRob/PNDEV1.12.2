...
public class EntityPrehistoricFloraHomalonotus extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraHomalonotus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HOMALONOTUS;
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HOMALONOTUS_LOOT;
	}
