...
public class EntityPrehistoricFloraRhinopycnodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraRhinopycnodus(World world) {
		super(world);
		setSize(0.4F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RHINOPYCNODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RHINOPYCNODUS;
	}
