...
import net.lepidodendron.entity.render.entity.RenderNematoptychius;
...
public class EntityPrehistoricFloraNematoptychius extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraNematoptychius(World world) {
		super(world);
		setSize(0.5F, 0.4F);
		minWidth = 0.1F;
		maxWidth = 0.5F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NEMATOPTYCHIUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderNematoptychius.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelNematoptychius;}
	public static float getScaler(@Nullable String variant) {return RenderNematoptychius.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.028F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NEMATOPTYCHIUS;
	}
