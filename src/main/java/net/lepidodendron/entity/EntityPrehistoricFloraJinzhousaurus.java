...
public class EntityPrehistoricFloraJinzhousaurus extends EntityPrehistoricFloraBiQuadLandBase implements IScreamer, IAdvancementGranter, IBluffer, ITrappableLand {
	...
	public EntityPrehistoricFloraJinzhousaurus(World world) {
		super(world);
		setSize(1F, 1.75F);
		minWidth = 0.20F;
		maxWidth = 1F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			this.setBipedal();
			List<EntityPrehistoricFloraJinzhousaurus> Jinzhousaurus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraJinzhousaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraJinzhousaurus currentJinzhousaurus : Jinzhousaurus) {
				currentJinzhousaurus.setAnimation(NO_ANIMATION);
				currentJinzhousaurus.setRevengeTarget(ee);
				currentJinzhousaurus.setAlarmTarget(ee);
				currentJinzhousaurus.setBipedal();
				currentJinzhousaurus.alarmCooldown = rand.nextInt(20);
			}
		}
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, STAND_ANIMATION, TOBI_ANIMATION, TOQUAD_ANIMATION};
	}
...
//	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mantellisaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:mantellisaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:mantellisaurus_death"));
	}

	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mantellisaurus_alarm"));
	}
	...
	public void onLivingUpdate() {
		...
		if ((!this.world.isRemote) && this.getAnimation() == ROAR_ANIMATION && this.getWarnTarget() != null
			...
			List<EntityPrehistoricFloraJinzhousaurus> Camptosaurus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraJinzhousaurus.class, new AxisAlignedBB(this.getPosition().add(-12, -6, -12), this.getPosition().add(12, 6, 12)));
			for (EntityPrehistoricFloraJinzhousaurus currentCamptosaurus : Camptosaurus) {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.JINZHOUSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.JINZHOUSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JINZHOUSAURUS;
	}
