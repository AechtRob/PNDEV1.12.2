...
import net.lepidodendron.item.entities.ItemBucketScaumenacia;
...
public class EntityPrehistoricFloraScaumenacia extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketScaumenacia.block, (int) (1));
