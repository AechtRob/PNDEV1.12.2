...
public class EntityPrehistoricFloraScaumenacia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraScaumenacia(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCAUMENACIA;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SCAUMENACIA_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelScaumenacia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderScaumenacia.getScaler();
	}
}