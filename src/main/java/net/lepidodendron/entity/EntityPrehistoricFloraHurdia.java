...
public class EntityPrehistoricFloraHurdia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraHurdia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HURDIA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHurdia;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HURDIA;
	}
}