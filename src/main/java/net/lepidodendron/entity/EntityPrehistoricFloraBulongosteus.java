...
public class EntityPrehistoricFloraBulongosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBulongosteus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.3F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBulongosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BULONGOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BULONGOSTEUS;
	}
