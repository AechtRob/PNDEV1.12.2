...
public class EntityPrehistoricFloraTicinosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTicinosuchus(World world) {
		super(world);
		setSize(0.6F, 0.65F);
		minWidth = 0.15F;
		maxWidth = 0.6F;
		...
		STAND_ANIMATION = Animation.create(180);
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TICINOSUCHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.TICINOSUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TICINOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
