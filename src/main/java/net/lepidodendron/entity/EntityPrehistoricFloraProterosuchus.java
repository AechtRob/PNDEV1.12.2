...
public class EntityPrehistoricFloraProterosuchus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraProterosuchus(World world) {
		super(world);
		setSize(0.76F, 0.65F);
		minWidth = 0.18F;
		maxWidth = 0.86F;
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PROTEROSUCHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PROTEROSUCHUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelProterosuchus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderProterosuchus.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROTEROSUCHUS;
	}
}