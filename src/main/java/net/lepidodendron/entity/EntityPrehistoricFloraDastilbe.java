...
import net.lepidodendron.entity.render.entity.RenderDastilbe;
import net.lepidodendron.entity.render.entity.RenderRhacolepis;
...
public class EntityPrehistoricFloraDastilbe extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDastilbe(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DASTILBE_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderDastilbe.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelDastilbe;}
	public static float getScaler(@Nullable String variant) {return RenderDastilbe.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DASTILBE;
	}
}
