...
import net.lepidodendron.item.entities.ItemBucketVarialepis;
...
public class EntityPrehistoricFloraVarialepis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketVarialepis.block, (int) (1));
