...
public class EntityPrehistoricFloraVarialepis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraVarialepis(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VARIALEPIS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.VARIALEPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelVarialepis;}
	public static float getScaler(@Nullable String variant) {return RenderVarialepis.getScaler();}
