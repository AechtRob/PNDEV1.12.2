...
import net.lepidodendron.item.entities.ItemBucketHungioides;
...
public class EntityPrehistoricFloraHungioides extends EntityPrehistoricFloraTrilobiteSwimBase {
	...
	public EntityPrehistoricFloraHungioides(World world) {
		super(world);
		setSize(0.55F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HUNGIOIDES_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHungioides.block, (int) (1));
