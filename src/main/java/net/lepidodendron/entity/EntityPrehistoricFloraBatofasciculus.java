...
import net.lepidodendron.item.entities.ItemBucketBatofasciculus;
...
public class EntityPrehistoricFloraBatofasciculus extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketBatofasciculus.block, (int) (1));
