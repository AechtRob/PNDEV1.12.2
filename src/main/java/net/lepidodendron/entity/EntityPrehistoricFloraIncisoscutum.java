...
public class EntityPrehistoricFloraIncisoscutum extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraIncisoscutum(World world) {
		super(world);
		setSize(0.3F, 0.2F);
		minWidth = 0.2F;
		maxWidth = 0.3F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraIncisoscutum(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.INCISOSCUTUM_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_INCISOSCUTUM;
	}
