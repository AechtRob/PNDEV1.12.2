...
import net.lepidodendron.item.entities.ItemEuspira;
import net.lepidodendron.item.entities.ItemTurritella;
...
public class EntityPrehistoricFloraTurritella extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraTurritella(World world) {
		super(world, 26);
		setSize(0.2F, 0.2F);
	}
	...
	public static String getPeriod() {return "Jurassic - Early Cretaceous - Late Cretaceous - Paleogene  - Neogene - Pleistocene [ - Recent]";}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemTurritella.block, (int) (1)));
