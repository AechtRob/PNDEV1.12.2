...
public class EntityPrehistoricFloraPachyrhizodus_marathonensis extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraPachyrhizodus_marathonensis(World world) {
		super(world);
		setSize(0.6F, 0.4F);
		minWidth = 0.1F;
		maxWidth = 0.6F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PACHYRHIZODUS_MARATHONENSIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PACHYRHIZODUS_MARATHONENSIS;
	}
