...
public class EntityPrehistoricFloraEromangateuthis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraEromangateuthis(World world) {
		super(world);
		setSize(1.5F, 0.6F);
		minWidth = 0.2F;
		maxWidth = 1.5F;
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EROMANGATEUTHIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EROMANGATEUTHIS;
	}
