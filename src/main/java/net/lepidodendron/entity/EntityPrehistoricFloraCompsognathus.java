...
public class EntityPrehistoricFloraCompsognathus extends EntityPrehistoricFloraLandBase implements IScreamer {
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraCompsognathus> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraCompsognathus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraCompsognathus currentYinlong : Yinlong) {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(7, new LandWanderHerd(this, 1.00D, this.getNavigator().getPathSearchRange()*0.666F, 5));
