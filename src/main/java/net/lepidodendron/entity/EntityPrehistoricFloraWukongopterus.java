...
public class EntityPrehistoricFloraWukongopterus extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IScreamerFlier, IGuano, ITrappableLand {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(8, new AgeableClimbingFlyingWalkingFlyHigh(this, true));
		tasks.addTask(9, new LandClimbingFlyingWalkingBaseWanderFlightNearGroundAI(this, true, false));
...
//	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelWukongopterus;
	}
