...
import net.lepidodendron.entity.render.entity.RenderXinjiangtitan;
...
public class EntityPrehistoricFloraXinjiangtitan extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraXinjiangtitan(World world) {
		super(world);
		setSize(1.8F, 2.7F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_XINJIANGTITAN;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.XINJIANGTITAN_LOOT_YOUNG;
		}
		return LepidodendronMod.XINJIANGTITAN_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderXinjiangtitan.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelXinjiangtitan;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderXinjiangtitan.getScaler();
    }
