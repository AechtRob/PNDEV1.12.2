...
import net.lepidodendron.item.entities.ItemBucketJellyfish6;
...
public class EntityPrehistoricFloraJellyfish6 extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish6.block, (int) (1));
