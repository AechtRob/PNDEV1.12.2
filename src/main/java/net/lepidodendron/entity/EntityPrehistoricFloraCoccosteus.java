...
import net.lepidodendron.item.entities.ItemBucketCoccosteus;
...
public class EntityPrehistoricFloraCoccosteus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCoccosteus.block, (int) (1));
