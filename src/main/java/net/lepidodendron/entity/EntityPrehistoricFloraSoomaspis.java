...
public class EntityPrehistoricFloraSoomaspis extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSoomaspis(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SOOMASPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSoomaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSoomaspis;}
	public static float getScaler(@Nullable String variant) {return RenderSoomaspis.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SOOMASPIS;
	}
}