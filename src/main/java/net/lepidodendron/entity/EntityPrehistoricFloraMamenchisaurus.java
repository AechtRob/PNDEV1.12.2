...
public class EntityPrehistoricFloraMamenchisaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(10, new EntityWatchClosestAI(this, EntityLivingBase.class, 8.0F, false, false));
