...
public class EntityPrehistoricFloraPelecanimimus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, GRAZE_ANIMATION, SCRATCH_LEFT_ANIMATION};
	}
	...
	public float getAISpeedLand() {
		float speedBase = 0.47F;
		if (this.getTicks() < 0) {
			return 0.0F; //Is laying eggs
		}
		if (this.getAnimation() == GRAZE_ANIMATION || this.getAnimation() == MAKE_NEST_ANIMATION|| this.getAnimation() == SCRATCH_LEFT_ANIMATION) {
			return 0.0F;
		}
		if (this.getIsFast()) {
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.PLANTS, DietString.FISH);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:pelecanimimus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:pelecanimimus_death"));
	}
...
//TODO make override so noise cant play at the same time as idles
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PELECANIMIMUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PELECANIMIMUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PELECANIMIMUS;
	}
}