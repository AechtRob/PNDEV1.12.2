...
public class EntityPrehistoricFloraDaihuoides extends EntityPrehistoricFloraEoandromeda implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraDaihuoides(World world) {
        super(world);
        setSize(0.35F, 0.15F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_DAIHUOIDES;
    }
