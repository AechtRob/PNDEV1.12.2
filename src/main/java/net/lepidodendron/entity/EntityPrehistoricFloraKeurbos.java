...
public class EntityPrehistoricFloraKeurbos extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKeurbos(World world) {
		super(world);
		setSize(0.25F, 0.25F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KEURBOS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KEURBOS;
	}
