...
public class EntityPrehistoricFloraCordubia extends EntityPrehistoricFloraEoandromeda implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraCordubia(World world) {
        super(world);
        setSize(0.5F, 0.15F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_CORDUBIA;
    }
