...
import net.lepidodendron.item.entities.ItemBucketParadoxides;
...
public class EntityPrehistoricFloraParadoxides extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketParadoxides.block, (int) (1));
