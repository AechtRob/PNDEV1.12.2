...
public class EntityPrehistoricFloraIkechosaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraIkechosaurus(this.world);
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_IKECHOSAURUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.IKECHOSAURUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
