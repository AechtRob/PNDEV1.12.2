...
public class EntityPrehistoricFloraEukaia extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraEukaia(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraEukaia.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraEukaia(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EUKAIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EUKAIA;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraEukaia EntityBase = EntityPrehistoricFloraEukaia.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraEukaia.this);
		}
