...
import net.lepidodendron.item.entities.ItemBucketMarrella;
...
public class EntityPrehistoricFloraMarrella extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraMarrella(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MARRELLA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketMarrella.block, (int) (1));
