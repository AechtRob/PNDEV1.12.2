...
public class EntityPrehistoricFloraGemuendenaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGemuendenaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraGemuendenaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGemuendenaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GEMUENDENASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GEMUENDENASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraGemuendenaspis EntityBase = EntityPrehistoricFloraGemuendenaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraGemuendenaspis.this);
		}
