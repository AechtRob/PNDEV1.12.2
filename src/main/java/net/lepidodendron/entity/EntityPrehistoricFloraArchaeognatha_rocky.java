...
public class EntityPrehistoricFloraArchaeognatha_rocky extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ARCHAEOGNATHA_ROCKY_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCHAEOGNATHA_ROCKY;
	}
