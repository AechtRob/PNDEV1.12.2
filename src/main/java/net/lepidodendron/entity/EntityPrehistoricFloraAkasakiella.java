...
import net.lepidodendron.entity.render.entity.RenderAkasakiella;
...
public class EntityPrehistoricFloraAkasakiella extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAkasakiella(World world) {
		super(world, 26);
		setSize(0.2F, 0.185F);
	}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemAkasakiella.block, (int) (1)));
