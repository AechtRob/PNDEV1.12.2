...
public class EntityPrehistoricFloraAsilisaurus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAsilisaurus(World world) {
		super(world);
		setSize(0.68F, 0.8F);
		minWidth = 0.12F;
		maxWidth = 0.68F;
		...
		ALERT_ANIMATION = Animation.create(77);
	...
	public float getAISpeedLand() {
		...
		if (this.getAnimation() == DRINK_ANIMATION || this.getAnimation() == MAKE_NEST_ANIMATION || this.getAnimation() == ALERT_ANIMATION) {
			return 0.0F;
		}
		if (this.getIsFast()) {
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, ALERT_ANIMATION, MAKE_NEST_ANIMATION};
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:silesaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:silesaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:silesaurus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ASILISAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ASILISAURUS;
	}
}