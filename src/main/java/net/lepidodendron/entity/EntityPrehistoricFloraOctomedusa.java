...
public class EntityPrehistoricFloraOctomedusa extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraOctomedusa(World world) {
        super(world);
        setSize(0.3F, 0.2F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_OCTOMEDUSA;
    }
