...
public class EntityPrehistoricFloraMeganeurites extends EntityPrehistoricFloraMeganeuropsis implements ITrappableAir {
	...
	public Animation ATTACK_ANIMATION;
		...
		public EntityPrehistoricFloraMeganeurites(World world) {
		super(world);
		setSize(0.15F, 0.30F);
	...
	public IBlockState getEggBlockState() {
		return BlockInsectEggsMeganeurites.block.getDefaultState();
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.MEGANEURITES_LOOT_JAR;
	...
	public static float getScaler(@Nullable String variant) {
		return RenderMeganeurites.getScaler();
	}
	@SideOnly(Side.CLIENT)
	...
	public static ResourceLocation textureDisplayTransparent(@Nullable String variant) {
		return LayerMeganeuritesWing.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
