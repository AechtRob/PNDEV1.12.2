...
public class EntityPrehistoricFloraPalaeocarcharias extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPalaeocarcharias(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraPalaeocarcharias.SwimmingMoveHelperBase();
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PALAEOCARCHARIAS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PALAEOCARCHARIAS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraPalaeocarcharias EntityBase = EntityPrehistoricFloraPalaeocarcharias.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraPalaeocarcharias.this);
		}
