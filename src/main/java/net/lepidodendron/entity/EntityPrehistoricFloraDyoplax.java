...
public class EntityPrehistoricFloraDyoplax extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDyoplax(World world) {
		super(world);
		setSize(0.3F, 0.2F);
		minWidth = 0.15F;
		maxWidth = 0.3F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DYOPLAX_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DYOPLAX;
	}
	//Rendering taxidermy:
	//--------------------
