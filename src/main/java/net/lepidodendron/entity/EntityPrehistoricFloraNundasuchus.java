...
public class EntityPrehistoricFloraNundasuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNundasuchus(World world) {
		super(world);
		setSize(0.6F, 0.65F);
		minWidth = 0.15F;
		maxWidth = 0.6F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NUNDASUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NUNDASUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
