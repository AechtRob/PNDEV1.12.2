...
public class EntityPrehistoricFloraWaptia extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWaptia(World world) {
		super(world);
		setSize(0.2F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WAPTIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WAPTIA;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelWaptia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderWaptia.getScaler();
	}
