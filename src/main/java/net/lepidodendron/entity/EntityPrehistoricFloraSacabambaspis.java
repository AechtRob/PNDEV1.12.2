...
public class EntityPrehistoricFloraSacabambaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSacabambaspis(World world) {
		super(world);
		setSize(0.6F, 0.5F);
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSacabambaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSacabambaspis;}
	public static float getScaler(@Nullable String variant) {return RenderSacabambaspis.getScaler();}
	@Override
