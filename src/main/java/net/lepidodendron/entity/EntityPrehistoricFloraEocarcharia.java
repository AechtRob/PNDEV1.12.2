...
public class EntityPrehistoricFloraEocarcharia extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraEocarcharia(World world) {
		super(world);
		setSize(2.5F, 3F);
		minWidth = 0.20F;
		maxWidth = 2.5F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.EOCARCHARIA_LOOT_YOUNG;
		}
		return LepidodendronMod.EOCARCHARIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EOCARCHARIA;
	}
