...
public class EntityPrehistoricFloraRebellatrix extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraRebellatrix(World world) {
		super(world);
		setSize(0.92F, 0.625F);
		minWidth = 0.1F;
		maxWidth = 0.92F;
		maxHeight = 0.625F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraRebellatrix(this.world);
	}
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntityVillager.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(ArrayUtils.addAll(DietString.FISHFOOD, DietString.FISH), DietString.MEAT);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_REBELLATRIX;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.REBELLATRIX_LOOT_YOUNG;
		}
		return LepidodendronMod.REBELLATRIX_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.55;}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelRebellatrix;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderRebellatrix.getScaler();
	}
}
