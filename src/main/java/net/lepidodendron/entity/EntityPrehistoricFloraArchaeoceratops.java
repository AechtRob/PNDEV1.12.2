...
public class EntityPrehistoricFloraArchaeoceratops extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraArchaeoceratops(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
		...
		STAND_ANIMATION = Animation.create(102);
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraArchaeoceratops> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraArchaeoceratops.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraArchaeoceratops currentYinlong : Yinlong) {
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:alpsub_idle"));
	}
	...
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:chaoyangsauridaes_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARCHAEOCERATOPS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCHAEOCERATOPS;
	}
}