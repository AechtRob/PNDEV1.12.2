...
public class EntityPrehistoricFloraMiguashaia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMiguashaia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderMiguashaia.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MIGUASHAIA;
	}
}