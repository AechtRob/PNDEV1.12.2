...
import net.lepidodendron.entity.render.entity.RenderHelodus;
...
public class EntityPrehistoricFloraHelodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraHelodus(World world) {
		super(world);
		setSize(0.4F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HELODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HELODUS;
	}
