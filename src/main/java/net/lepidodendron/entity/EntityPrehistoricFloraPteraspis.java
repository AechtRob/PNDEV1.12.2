...
public class EntityPrehistoricFloraPteraspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPteraspis(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelPteraspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderPteraspis.getScaler();
	}
}