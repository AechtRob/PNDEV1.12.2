...
public class EntityPrehistoricFloraTitanopteraMesotitan extends EntityPrehistoricFloraArchoblattinaInsect {
	...
	public EntityPrehistoricFloraTitanopteraMesotitan(World world) {
		super(world);
		setSize(0.3F, 0.21F);
		experienceValue = 0;
	...
	@Nullable
	protected ResourceLocation getLootTable() { return LepidodendronMod.TITANOPTERA_MESOTITAN_LOOT;}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.TITANOPTERA_MESOTITAN_LOOT_JAR;
