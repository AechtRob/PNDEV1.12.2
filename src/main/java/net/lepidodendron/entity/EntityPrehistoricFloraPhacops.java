...
import net.lepidodendron.entity.render.entity.RenderHydropessum;
import net.lepidodendron.entity.render.entity.RenderPhacops;
...
public class EntityPrehistoricFloraPhacops extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPhacops(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHACOPS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelPhacops;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderPhacops.getScaler();
	}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHACOPS;
	}
}