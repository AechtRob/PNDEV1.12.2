...
public class EntityPrehistoricFloraMuensterella extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsMuensterella.block, (int) (1));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MUENSTERELLA;
	}
}
