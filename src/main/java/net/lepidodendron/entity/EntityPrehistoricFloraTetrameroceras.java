...
public class EntityPrehistoricFloraTetrameroceras extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Boolean> SWIMMINGPN = EntityDataManager.createKey(EntityPrehistoricFloraTetrameroceras.class, DataSerializers.BOOLEAN);
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TETRAMEROCERAS;
	}
