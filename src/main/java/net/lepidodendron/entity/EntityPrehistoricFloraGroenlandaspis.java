...
public class EntityPrehistoricFloraGroenlandaspis extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GROENLANDASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGroenlandaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGroenlandaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GROENLANDASPIS;
	}
