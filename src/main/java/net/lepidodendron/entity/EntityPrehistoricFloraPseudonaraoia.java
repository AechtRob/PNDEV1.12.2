...
import net.lepidodendron.entity.render.entity.RenderPseudonaraoia;
...
public class EntityPrehistoricFloraPseudonaraoia extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPseudonaraoia(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PSEUDONARAOIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPseudonaraoia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPseudonaraoia;}
	public static float getScaler(@Nullable String variant) {return RenderPseudonaraoia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PSEUDONARAOIA;
	}
}