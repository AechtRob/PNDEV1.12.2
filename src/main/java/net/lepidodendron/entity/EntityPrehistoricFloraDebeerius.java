...
public class EntityPrehistoricFloraDebeerius extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraDebeerius(World world) {
		super(world);
		setSize(0.4F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DEBEERIUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDebeerius;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderDebeerius.getScaler();
	}
	public static float widthSupport(@Nullable String variant) {return 0.035F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DEBEERIUS;
	}
