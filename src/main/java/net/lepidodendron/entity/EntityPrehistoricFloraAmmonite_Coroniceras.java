...
public class EntityPrehistoricFloraAmmonite_Coroniceras extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsCoroniceras.block, (int) (1));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AMMONITE_CORONICERAS;
