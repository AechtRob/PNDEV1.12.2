...
public class EntityPrehistoricFloraCaudipteryx extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderCaudipteryx.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelCaudipteryx;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderCaudipteryx.getScaler();
    }
