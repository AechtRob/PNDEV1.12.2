...
public class EntityPrehistoricFloraPalaeopalaemon extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	private static final DataParameter<Boolean> SWIMMINGPN = EntityDataManager.createKey(EntityPrehistoricFloraPalaeopalaemon.class, DataSerializers.BOOLEAN);
	//Needs to be here because it is not loaded in time to be accessed by the client if it's on the parent class!

	public EntityPrehistoricFloraPalaeopalaemon(World world) {
		super(world);
		setSize(0.4F, 0.2F);
		minWidth = 0.2F;
		maxWidth = 0.2F;
...
public static String getHabitat() {
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, SWIM_ANIMATION, UNSWIM_ANIMATION};
	}
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntityPrehistoricFloraTrilobiteSwimBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_PALAEOPALAEMON;
    }
}