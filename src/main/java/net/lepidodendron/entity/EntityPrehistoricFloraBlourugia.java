...
import net.lepidodendron.item.entities.ItemBucketBlourugia;
...
public class EntityPrehistoricFloraBlourugia extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketBlourugia.block, (int) (1));
