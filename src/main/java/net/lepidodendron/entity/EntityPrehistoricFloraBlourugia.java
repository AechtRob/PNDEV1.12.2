...
public class EntityPrehistoricFloraBlourugia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBlourugia(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BLOURUGIA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBlourugia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBlourugia.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BLOURUGIA;
	}
