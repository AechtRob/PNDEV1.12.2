...
public class EntityPrehistoricFloraMontsecosuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraMontsecosuchus(World world) {
		super(world);
		setSize(0.6F, 0.6F);
		minWidth = 0.1F;
		maxWidth = 0.6F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMontsecosuchus(this.world);
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MONTSECOSUCHUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MONTSECOSUCHUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
