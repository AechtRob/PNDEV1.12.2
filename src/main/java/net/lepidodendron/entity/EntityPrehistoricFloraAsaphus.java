...
import net.lepidodendron.item.entities.ItemBucketAsaphus;
...
public class EntityPrehistoricFloraAsaphus extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraAsaphus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ASAPHUS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAsaphus.block, (int) (1));
