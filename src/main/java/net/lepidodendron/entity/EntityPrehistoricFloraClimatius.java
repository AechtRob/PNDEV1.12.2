...
public class EntityPrehistoricFloraClimatius extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelClimatius;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderClimatius.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CLIMATIUS;
	}
}
