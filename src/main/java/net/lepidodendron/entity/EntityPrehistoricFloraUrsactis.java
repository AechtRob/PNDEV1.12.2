...
import net.lepidodendron.entity.render.entity.RenderUrsactis;
...
public class EntityPrehistoricFloraUrsactis extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelUrsactis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderUrsactis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_URSACTIS;
	}
}