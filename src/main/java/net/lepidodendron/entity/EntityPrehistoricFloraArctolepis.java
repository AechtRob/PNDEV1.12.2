...
public class EntityPrehistoricFloraArctolepis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraArctolepis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraArctolepis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraArctolepis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARCTOLEPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCTOLEPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraArctolepis EntityBase = EntityPrehistoricFloraArctolepis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraArctolepis.this);
		}
