...
public class EntityPrehistoricFloraJuracimbrophlebia extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraJuracimbrophlebia(World world) {
		super(world);
		setSize(0.15F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JURACIMBROPHLEBIA;
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.JURACIMBROPHLEBIA_LOOT;
	...
	public static double offsetCaseMagnified(@Nullable String variant) { return 0.70; }
	...
	public static float getScaler(@Nullable String variant) {
		return RenderJuracimbrophlebia.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderJuracimbrophlebia.getScaler() * 3.0F;
	}
