...
import net.lepidodendron.item.entities.ItemBucketClydagnathus;
...
public class EntityPrehistoricFloraClydagnathus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketClydagnathus.block, (int) (1));
