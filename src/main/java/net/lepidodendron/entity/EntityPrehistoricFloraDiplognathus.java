...
public class EntityPrehistoricFloraDiplognathus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDiplognathus(World world) {
		super(world);
		setSize(0.8F, 0.6F);
		minWidth = 0.2F;
		maxWidth = 0.8F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDiplognathus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DIPLOGNATHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DIPLOGNATHUS;
	}
}
