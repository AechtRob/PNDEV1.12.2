...
public class EntityPrehistoricFloraHualianceratops extends EntityPrehistoricFloraLandBase implements IScreamer {
	...
	public EntityPrehistoricFloraHualianceratops(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.HUALIANCERATOPS_LOOT_YOUNG;
		}
		return LepidodendronMod.HUALIANCERATOPS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHualianceratops;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHualianceratops.getScaler();
	}
