...
public class EntityPrehistoricFloraHualianceratops extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HUALIANCERATOPS;
	}
}