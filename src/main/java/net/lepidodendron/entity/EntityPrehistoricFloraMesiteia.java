...
public class EntityPrehistoricFloraMesiteia extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMesiteia(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraMesiteia.SwimmingMoveHelperBase();
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MESITEIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MESITEIA;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraMesiteia EntityBase = EntityPrehistoricFloraMesiteia.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraMesiteia.this);
		}
