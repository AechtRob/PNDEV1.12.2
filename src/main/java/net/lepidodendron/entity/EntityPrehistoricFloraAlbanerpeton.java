...
import net.lepidodendron.entity.render.entity.RenderAlbanerpeton;
...
public class EntityPrehistoricFloraAlbanerpeton extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraAlbanerpeton(World world) {
		super(world);
	...
	protected void initEntityAI() {
		...
		tasks.addTask(7, new EntityWatchClosestAI(this, EntityPlayer.class, 6.0F, true));
		tasks.addTask(8, new EntityWatchClosestAI(this, EntityPrehistoricFloraAgeableBase.class, 8.0F, true));
		tasks.addTask(9, new EntityLookIdleAI(this, true));
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntityPrehistoricFloraInsectFlyingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALBANERPETON_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALBANERPETON;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAlbanerpeton.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAlbanerpeton;}
	public static float getScaler(@Nullable String variant) {return RenderAlbanerpeton.getScaler();}
