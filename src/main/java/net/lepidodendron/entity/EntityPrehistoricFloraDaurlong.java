...
public class EntityPrehistoricFloraDaurlong extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDaurlong(World world) {
		super(world);
		setSize(0.5F, 0.4F);
		minWidth = 0.20F;
		maxWidth = 0.5F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraDaurlong> Daurlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraDaurlong.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraDaurlong currentDaurlong : Daurlong) {
				currentDaurlong.setAnimation(NO_ANIMATION);
				currentDaurlong.setRevengeTarget(ee);
				currentDaurlong.setAlarmTarget(ee);
				currentDaurlong.alarmCooldown = rand.nextInt(20);
			}
		}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mei_idle"));
	...
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:mei_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:mei_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DAURLONG_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DAURLONG;
	}
