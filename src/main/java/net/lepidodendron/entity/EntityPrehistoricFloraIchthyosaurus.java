...
public class EntityPrehistoricFloraIchthyosaurus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraIchthyosaurus(World world) {
		super(world);
		setSize(1.2F, 0.95F);
		minWidth = 0.15F;
		maxWidth = 1.2F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraIchthyosaurus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.ICHTHYOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ICHTHYOSAURUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelIchthyosaurus;
	}
