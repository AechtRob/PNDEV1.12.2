...
public class EntityPrehistoricFloraPseudoangustidontus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPseudoangustidontus(World world) {
		super(world);
		setSize(0.7F, 0.5F);
		minWidth = 0.2F;
		maxWidth = 0.7F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PSEUDOANGUSTIDONTUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PSEUDOANGUSTIDONTUS;
	}
}
