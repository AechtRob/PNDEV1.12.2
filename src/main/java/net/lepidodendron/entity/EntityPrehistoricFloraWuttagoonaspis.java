...
public class EntityPrehistoricFloraWuttagoonaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Integer> BURYTICK = EntityDataManager.createKey(EntityPrehistoricFloraWuttagoonaspis.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BURIED = EntityDataManager.createKey(EntityPrehistoricFloraWuttagoonaspis.class, DataSerializers.BOOLEAN);

	private static final DataParameter<Integer> BURYCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraWuttagoonaspis.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIMCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraWuttagoonaspis.class, DataSerializers.VARINT);
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WUTTAGOONASPIS;
	}
}
