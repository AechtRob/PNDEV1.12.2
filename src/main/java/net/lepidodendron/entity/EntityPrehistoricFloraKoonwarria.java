...
import net.lepidodendron.entity.render.entity.RenderKoonwarria;
...
public class EntityPrehistoricFloraKoonwarria extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKoonwarria(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KOONWARRIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderKoonwarria.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelKoonwarria;}
	public static float getScaler(@Nullable String variant) {return RenderKoonwarria.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KOONWARRIA;
	}
}
