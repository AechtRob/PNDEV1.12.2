...
import net.lepidodendron.item.entities.ItemBucketDrepanaspis;
...
public class EntityPrehistoricFloraDrepanaspis extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraDrepanaspis(World world) {
		super(world);
		setSize(0.6F, 0.5F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DREPANASPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketDrepanaspis.block, (int) (1));
