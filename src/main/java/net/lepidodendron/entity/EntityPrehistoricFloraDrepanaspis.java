...
public class EntityPrehistoricFloraDrepanaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDrepanaspis;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DREPANASPIS;
	}
