...
import net.lepidodendron.entity.render.entity.RenderWestrichus;
...
public class EntityPrehistoricFloraWestrichus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraWestrichus(World world) {
		super(world);
		setSize(0.5F, 0.25F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WESTRICHUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderWestrichus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelWestrichus;}
	public static float getScaler(@Nullable String variant) {return RenderWestrichus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WESTRICHUS;
	}
