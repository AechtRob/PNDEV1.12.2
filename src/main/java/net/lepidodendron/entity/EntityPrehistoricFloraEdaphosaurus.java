...
public class EntityPrehistoricFloraEdaphosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EDAPHOSAURUS;
	}
}