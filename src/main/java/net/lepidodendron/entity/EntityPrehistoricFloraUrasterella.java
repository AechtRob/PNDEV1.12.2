...
public class EntityPrehistoricFloraUrasterella extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraUrasterella(World world) {
		super(world, 60);
		setSize(0.2F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.URASTERELLA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_URASTERELLA;
	}
}