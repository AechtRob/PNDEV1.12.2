...
public class EntityPrehistoricFloraFalcarius extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, IWarnOnlyButHit, ITrappableLand {
	...
	public EntityPrehistoricFloraFalcarius(World world) {
		super(world);
		setSize(0.95F, 0.95F);
		minWidth = 0.20F;
		maxWidth = 0.95F;
	...
	@Override
	public int getRoarLength() { return 60; } //Warn/threat
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getRoarSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:falcarius_roar"));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:falcarius_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:falcarius_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:falcarius_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.FALCARIUS_LOOT_YOUNG;
		}
		return LepidodendronMod.FALCARIUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_FALCARIUS;
	}
	//Rendering taxidermy:
	//--------------------
