...
public class EntityPrehistoricFloraBrochoadmones extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBrochoadmones(World world) {
		super(world);
		setSize(0.28F, 0.23F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BROCHOADMONES_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBrochoadmones;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBrochoadmones.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BROCHOADMONES;
	}
