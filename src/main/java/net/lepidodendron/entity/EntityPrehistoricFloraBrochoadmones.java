...
import net.lepidodendron.item.entities.ItemBucketBrochoadmones;
...
public class EntityPrehistoricFloraBrochoadmones extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketBrochoadmones.block, (int) (1));
