...
import net.lepidodendron.entity.render.entity.RenderHaplolepis;
...
public class EntityPrehistoricFloraHaplolepis extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraHaplolepis(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HAPLOLEPIS_LOOT;
	}
	...
	public static double lowerbacklineoffsetperpendiular(@Nullable String variant) {return -0.01;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderHaplolepis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelHaplolepis;}
	public static float getScaler(@Nullable String variant) {return RenderHaplolepis.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.02F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HAPLOLEPIS;
	}
}
