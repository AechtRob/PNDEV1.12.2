...
public class EntityPrehistoricFloraPlatysomus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PLATYSOMUS;}
	@Nullable
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPlatysomus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPlatysomus;}
	public static float getScaler(@Nullable String variant) {return RenderPlatysomus.getScaler();}
}
