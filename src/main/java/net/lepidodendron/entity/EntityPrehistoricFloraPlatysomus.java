...
import net.lepidodendron.item.entities.ItemBucketPlatysomus;
...
public class EntityPrehistoricFloraPlatysomus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPlatysomus.block, (int) (1));
