...
import net.lepidodendron.entity.render.entity.RenderCretalamna;
...
public class EntityPrehistoricFloraCretalamna extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraCretalamna(World world) {
		super(world);
		setSize(1F, 1F);
		minWidth = 0.1F;
		maxWidth = 1F;
	...
	public static String getPeriod() {return "Early Cretaceous - Late Cretaceous - Paleogene";}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.CRETALAMNA_LOOT_YOUNG;
		}
		return LepidodendronMod.CRETALAMNA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRETALAMNA;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderCretalamna.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelCretalamna;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderCretalamna.getScaler();
    }
}
