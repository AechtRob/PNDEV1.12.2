...
public class EntityPrehistoricFloraTriopus extends EntityPrehistoricFloraEurypteridBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraTriopus(World world) {
		super(world);
		setSize(0.25F, 0.25F);
		minWidth = 0.25F;
		maxWidth = 0.25F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TRIOPUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTriopus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTriopus;}
	public static float getScaler(@Nullable String variant) {return RenderTriopus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIOPUS;
	}
}