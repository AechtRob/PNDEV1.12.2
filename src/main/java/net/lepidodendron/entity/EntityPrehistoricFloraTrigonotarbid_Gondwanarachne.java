...
public class EntityPrehistoricFloraTrigonotarbid_Gondwanarachne extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIGONOTARBID_GONDWANARACHNE;
	}
}