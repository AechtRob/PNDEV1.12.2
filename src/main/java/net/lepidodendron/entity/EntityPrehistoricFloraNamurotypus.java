...
public class EntityPrehistoricFloraNamurotypus extends EntityPrehistoricFloraMeganeuropsis implements IAdvancementGranter, ITrappableAir {
	...
	public Animation ATTACK_ANIMATION;
		...
		public EntityPrehistoricFloraNamurotypus(World world) {
		super(world);
		setSize(0.15F, 0.30F);
	...
	public String getEntityId(Entity entity) {
		return "lepidodendron:prehistoric_flora_namurotypus_nymph";
	}
