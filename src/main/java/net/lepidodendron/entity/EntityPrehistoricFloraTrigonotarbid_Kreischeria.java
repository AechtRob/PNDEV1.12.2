...
public class EntityPrehistoricFloraTrigonotarbid_Kreischeria extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTrigonotarbid_Kreischeria.TEXTURE;}
	@SideOnly(Side.CLIENT)
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderTrigonotarbid_Kreischeria.getScaler() * 5.0F;
	}
