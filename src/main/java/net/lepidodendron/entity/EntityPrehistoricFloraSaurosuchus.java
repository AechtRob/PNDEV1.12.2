...
public class EntityPrehistoricFloraSaurosuchus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraSaurosuchus(World world) {
		super(world);
		setSize(0.85F, 1.82F);
		minWidth = 0.12F;
		maxWidth = 0.85F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SAUROSUCHUS_LOOT_YOUNG;
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SAUROSUCHUS;
