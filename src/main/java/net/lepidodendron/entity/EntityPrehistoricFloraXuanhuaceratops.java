...
public class EntityPrehistoricFloraXuanhuaceratops extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public EntityPrehistoricFloraXuanhuaceratops(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelXuanhuaceratops;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderXuanhuaceratops.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_XUANHUACERATOPS;
	}
}