...
public class EntityPrehistoricFloraCongopycnodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraCongopycnodus(World world) {
		super(world);
		setSize(0.2F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CONGOPYCNODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CONGOPYCNODUS;
	}
}
