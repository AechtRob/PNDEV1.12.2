...
public class EntityPrehistoricFloraSurcaudalus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraSurcaudalus(World world) {
		super(world);
		setSize(0.4F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SURCAUDALUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSurcaudalus;}
	public static float getScaler(@Nullable String variant) {
		return RenderSurcaudalus.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SURCAUDALUS;
	}
