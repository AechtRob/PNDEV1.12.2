...
public class EntityPrehistoricFloraIniopteryx extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelIniopteryx;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_INIOPTERYX;
	}
