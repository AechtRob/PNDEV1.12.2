...
import net.lepidodendron.entity.render.entity.RenderCamanchia;
...
public class EntityPrehistoricFloraCamanchia extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraCamanchia(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CAMANCHIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderCamanchia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelCamanchia;}
	public static float getScaler(@Nullable String variant) {return RenderCamanchia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAMANCHIA;
	}
}