...
import net.lepidodendron.entity.render.entity.RenderLiaoceratops;
...
public class EntityPrehistoricFloraLiaoceratops extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraLiaoceratops(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraLiaoceratops> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraLiaoceratops.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraLiaoceratops currentYinlong : Yinlong) {
	...
	public int getDrinkLength() {
		return 154;  //grazes, does not drink
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.LIAOCERATOPS_LOOT_YOUNG;
		}
		return LepidodendronMod.LIAOCERATOPS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LIAOCERATOPS;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderLiaoceratops.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelLiaoceratops;}
	public static float getScaler(@Nullable String variant) {return RenderLiaoceratops.getScaler();}
