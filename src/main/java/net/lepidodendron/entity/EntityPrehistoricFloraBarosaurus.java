...
public class EntityPrehistoricFloraBarosaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraBarosaurus(World world) {
		super(world);
		setSize(2.95F, 4.5F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BAROSAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.BAROSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.BAROSAURUS_LOOT;
	}
