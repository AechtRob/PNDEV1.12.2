...
import net.lepidodendron.item.entities.ItemBucketNectocaris;
...
public class EntityPrehistoricFloraNectocaris extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketNectocaris.block, (int) (1));
