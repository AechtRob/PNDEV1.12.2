...
import net.lepidodendron.item.entities.ItemBucketProfallotaspis;
...
public class EntityPrehistoricFloraProfallotaspis extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketProfallotaspis.block, (int) (1));
