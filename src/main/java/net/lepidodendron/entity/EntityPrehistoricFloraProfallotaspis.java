...
public class EntityPrehistoricFloraProfallotaspis extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraProfallotaspis(World world) {
		super(world);
		setSize(0.25F, 0.23F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROFALLOTASPIS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PROFALLOTASPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderProfallotaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelProfallotaspis;}
	public static float getScaler(@Nullable String variant) {return RenderProfallotaspis.getScaler();}
}