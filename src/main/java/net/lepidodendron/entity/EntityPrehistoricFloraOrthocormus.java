...
import net.lepidodendron.entity.render.entity.RenderOrthocormus;
...
public class EntityPrehistoricFloraOrthocormus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraOrthocormus(World world) {
		super(world);
		setSize(0.5F, 0.5F);
		minWidth = 0.1F;
		maxWidth = 0.8F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.NAUTILOID, DietString.FISH);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ORTHOCORMUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOrthocormus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderOrthocormus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ORTHOCORMUS;
	}
}
