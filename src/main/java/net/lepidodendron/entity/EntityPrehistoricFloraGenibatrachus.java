...
public class EntityPrehistoricFloraGenibatrachus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, IWaterSurfaceEggsAmphibian {
	...
	public EntityPrehistoricFloraGenibatrachus(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.12F;
		maxWidth = 0.15F;
	...
	{
		this.motionY = (double)this.getJumpUpwardsMotion()*0.45f; //edit this to be a diff value
		this.isAirBorne = true;
	}

	@Override
	public String getEntityId(Entity entity) {
		return "lepidodendron:prehistoric_flora_tadpole@genibatrachus";
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GENIBATRACHUS_LOOT;
	}
...
//	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GENIBATRACHUS;
	}
