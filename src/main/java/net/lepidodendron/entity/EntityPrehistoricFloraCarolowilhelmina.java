...
public class EntityPrehistoricFloraCarolowilhelmina extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraCarolowilhelmina(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAROLOWILHELMINA;
	}
}
