...
import net.lepidodendron.item.entities.ItemBucketCarolowilhelmina;
...
public class EntityPrehistoricFloraCarolowilhelmina extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCarolowilhelmina.block, (int) (1));
