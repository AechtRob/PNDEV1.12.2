...
public class EntityPrehistoricFloraEnseosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraEnseosteus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.3F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraEnseosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ENSEOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ENSEOSTEUS;
	}
