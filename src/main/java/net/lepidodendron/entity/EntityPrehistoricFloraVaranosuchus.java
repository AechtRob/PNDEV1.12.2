...
public class EntityPrehistoricFloraVaranosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraVaranosuchus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.15F;
		maxWidth = 0.2F;
    ...
    protected ResourceLocation getLootTable() {
        if (!this.isPFAdult()) {
            return LepidodendronMod.VARANOSUCHUS_LOOT_YOUNG;
        }
        return LepidodendronMod.VARANOSUCHUS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VARANOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
