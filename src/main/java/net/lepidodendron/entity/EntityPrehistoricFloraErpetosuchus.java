...
public class EntityPrehistoricFloraErpetosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraErpetosuchus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.15F;
		maxWidth = 0.2F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ERPETOSUCHUS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ERPETOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
