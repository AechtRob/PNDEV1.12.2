...
import net.lepidodendron.item.entities.ItemBucketJellyfish_Palaeo2;
...
public class EntityPrehistoricFloraJellyfish_Palaeo2 extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish_Palaeo2.block, (int) (1));
