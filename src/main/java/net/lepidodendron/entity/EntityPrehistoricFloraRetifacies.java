...
import net.lepidodendron.item.entities.ItemBucketRetifacies;
...
public class EntityPrehistoricFloraRetifacies extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraRetifacies(World world) {
		super(world);
		setSize(0.25F, 0.23F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RETIFACIES_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketRetifacies.block, (int) (1));
