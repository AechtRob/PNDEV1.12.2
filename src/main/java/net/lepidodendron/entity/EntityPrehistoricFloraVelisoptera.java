...
import net.lepidodendron.entity.render.entity.RenderVelisoptera;
...
//	}
	...
	public static double offsetCaseMagnified(@Nullable String variant) { return 0.92; }
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderVelisoptera.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelVelisoptera;}
	public static float getScaler(@Nullable String variant) {
		return RenderVelisoptera.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderVelisoptera.getScaler() * 2.5F;
	}
