...
import net.lepidodendron.item.entities.ItemBucketPhantaspis;
...
public class EntityPrehistoricFloraPhantaspis extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraPhantaspis(World world) {
		super(world);
		setSize(0.3F, 0.15F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHANTASPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPhantaspis.block, (int) (1));
