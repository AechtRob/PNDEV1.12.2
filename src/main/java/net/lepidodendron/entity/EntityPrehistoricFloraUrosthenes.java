...
import net.lepidodendron.item.entities.ItemBucketUrosthenes;
...
public class EntityPrehistoricFloraUrosthenes extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketUrosthenes.block, (int) (1));
