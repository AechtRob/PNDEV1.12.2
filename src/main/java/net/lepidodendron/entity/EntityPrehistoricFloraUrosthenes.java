...
public class EntityPrehistoricFloraUrosthenes extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.UROSTHENES_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelUrosthenes;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderUrosthenes.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_UROSTHENES;
	}
}
