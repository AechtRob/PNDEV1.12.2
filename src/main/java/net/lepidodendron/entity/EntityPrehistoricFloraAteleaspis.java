...
import net.lepidodendron.item.entities.ItemBucketAteleaspis;
...
public class EntityPrehistoricFloraAteleaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAteleaspis.block, (int) (1));
