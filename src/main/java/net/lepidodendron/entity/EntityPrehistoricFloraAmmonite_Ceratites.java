...
public class EntityPrehistoricFloraAmmonite_Ceratites extends EntityPrehistoricFloraNautiloidBase {
	...
	public void onEntityUpdate() {
		...
		if (!world.isRemote && this.isPFAdult() && this.getCanBreed() && LepidodendronConfig.doMultiplyMobs) {
			if (Math.random() > 0.5) {
				ItemStack itemstack = new ItemStack(ItemNautiloidEggsCeratites.block, (int) (1));
