...
public class EntityPrehistoricFloraAmplectobelua extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	protected float getAISpeedFish() {
		if (this.getIsFast()) {return 0.16F;}
		return 0.126f;
	}
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AMPLECTOBELUA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAmplectobelua;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAmplectobelua.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AMPLECTOBELUA;
	}
}
