...
import net.lepidodendron.item.entities.ItemBucketAmplectobelua;
...
public class EntityPrehistoricFloraAmplectobelua extends EntityPrehistoricFloraAgeableFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAmplectobelua.block, (int) (1));
