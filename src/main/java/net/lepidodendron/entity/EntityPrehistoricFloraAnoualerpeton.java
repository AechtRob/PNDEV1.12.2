...
import net.lepidodendron.entity.render.entity.RenderAnoualerpeton;
...
public class EntityPrehistoricFloraAnoualerpeton extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraAnoualerpeton(World world) {
		super(world);
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntityPrehistoricFloraInsectFlyingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	@Override
	public boolean getCanSpawnHere() {return this.posY < (double) this.world.getSeaLevel() && this.isInWater();}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ANOUALERPETON_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderAnoualerpeton.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelAnoualerpeton;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderAnoualerpeton.getScaler();
    }
}