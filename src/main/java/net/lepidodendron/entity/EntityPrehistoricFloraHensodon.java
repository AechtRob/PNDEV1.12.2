...
public class EntityPrehistoricFloraHensodon extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraHensodon.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraHensodon(World world) {
		super(world);
		setSize(0.2F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraHensodon)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_hensodon_" + this.getPNType().getName() + ".name");
		}
	}
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraHensodon.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraHensodon.Type getTypeFromString(String nameIn)
		{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraHensodon.Type.byId(rand.nextInt(EntityPrehistoricFloraHensodon.Type.values().length) + 1));
		return livingdata;
	}

	public void setPNType(EntityPrehistoricFloraHensodon.Type type)
	{
		this.dataManager.set(GENDER, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraHensodon.Type getPNType()
	{
		return EntityPrehistoricFloraHensodon.Type.byId(((Integer)this.dataManager.get(GENDER)).intValue());
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		{
			this.setPNType(EntityPrehistoricFloraHensodon.Type.getTypeFromString(compound.getString("PNType")));
		}
	}
	...
	protected ResourceLocation getLootTable() {
		switch (this.getPNType()) {
			case MALE:
			default:
				return LepidodendronMod.HENSODON_LOOT;

			case FEMALE:
				return LepidodendronMod.HENSODON_LOOT_F;
		}
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HENSODON;
	}
