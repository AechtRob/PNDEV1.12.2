...
import net.lepidodendron.item.entities.ItemEggsHerrerasaurus;
...
public class EntityPrehistoricFloraHerrerasaurus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_herrerasaurus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsHerrerasaurus.block, 1);
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:herrerasaurus_roar"));
	}
