...
public class EntityPrehistoricFloraTurfanosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTurfanosuchus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.15F;
		maxWidth = 0.3F;
		...
		STAND_ANIMATION = Animation.create(57);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TURFANOSUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TURFANOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
