...
public class EntityPrehistoricFloraArizonasaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraArizonasaurus(World world) {
		super(world);
		setSize(0.85F, 0.65F);
		minWidth = 0.15F;
		maxWidth = 0.85F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.ARIZONASAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ARIZONASAURUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARIZONASAURUS;
	}
}