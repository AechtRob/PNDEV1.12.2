...
import net.lepidodendron.item.entities.ItemEggsCotylorhynchus;
...
public class EntityPrehistoricFloraCotylorhynchus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_cotylorhynchus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsCotylorhynchus.block, 1);
	}
