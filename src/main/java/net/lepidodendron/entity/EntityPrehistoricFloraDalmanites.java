...
import net.lepidodendron.item.entities.ItemBucketDalmanites;
...
public class EntityPrehistoricFloraDalmanites extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraDalmanites(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DALMANITES_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketDalmanites.block, (int) (1));
