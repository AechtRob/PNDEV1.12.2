...
public class EntityPrehistoricFloraEffigia extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:effigia_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:effigia_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:effigia_death"));
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_EFFIGIA;}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.EFFIGIA_LOOT_YOUNG;
		}
		return LepidodendronMod.EFFIGIA_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelEffigia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderEffigia.getScaler();
	}
}