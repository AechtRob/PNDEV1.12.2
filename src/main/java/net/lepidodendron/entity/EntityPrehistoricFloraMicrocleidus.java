...
public class EntityPrehistoricFloraMicrocleidus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraMicrocleidus(World world) {
		super(world);
		setSize(1.5F, 0.8F);
		minWidth = 0.1F;
		maxWidth = 1.5F;
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.MICROCLEIDUS_LOOT_YOUNG;
		}
		return LepidodendronMod.MICROCLEIDUS_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMicrocleidus(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MICROCLEIDUS;
	}
}
