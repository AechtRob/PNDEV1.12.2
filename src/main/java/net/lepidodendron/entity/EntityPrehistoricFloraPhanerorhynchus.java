...
import net.lepidodendron.entity.render.entity.RenderPhanerorhynchus;
...
public class EntityPrehistoricFloraPhanerorhynchus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPhanerorhynchus(World world) {
		super(world);
		setSize(0.22F, 0.19F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHANERORHYNCHUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPhanerorhynchus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPhanerorhynchus;}
	public static float getScaler(@Nullable String variant) {return RenderPhanerorhynchus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHANERORHYNCHUS;
	}
