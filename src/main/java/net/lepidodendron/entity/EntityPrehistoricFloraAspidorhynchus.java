...
public class EntityPrehistoricFloraAspidorhynchus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraAspidorhynchus(World world) {
		super(world);
		setSize(0.45F, 0.45F);
		minWidth = 0.1F;
		maxWidth = 0.45F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ASPIDORHYNCHUS;
	}
