...
public class EntityPrehistoricFloraChaoyangsaurus extends EntityPrehistoricFloraLandBase implements IScreamer {
	...
	public EntityPrehistoricFloraChaoyangsaurus(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CHAOYANGSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CHAOYANGSAURUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelChaoyangsaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderChaoyangsaurus.getScaler();
	}
