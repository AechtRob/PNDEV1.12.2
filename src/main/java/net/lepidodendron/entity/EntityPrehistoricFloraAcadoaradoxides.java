...
import net.lepidodendron.item.entities.ItemBucketAcadoaradoxides;
...
public class EntityPrehistoricFloraAcadoaradoxides extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAcadoaradoxides.block, (int) (1));
