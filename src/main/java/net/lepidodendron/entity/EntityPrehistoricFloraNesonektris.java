...
public class EntityPrehistoricFloraNesonektris extends EntityPrehistoricFloraFishBase  implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNesonektris(World world) {
		super(world);
		setSize(0.15F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NESONEKTRIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelNesonektris;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderNesonektris.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NESONEKTRIS;
	}
}