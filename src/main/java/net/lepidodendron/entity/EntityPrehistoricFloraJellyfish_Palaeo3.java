...
import net.lepidodendron.item.entities.ItemBucketJellyfish_Palaeo3;
...
public class EntityPrehistoricFloraJellyfish_Palaeo3 extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish_Palaeo3.block, (int) (1));
