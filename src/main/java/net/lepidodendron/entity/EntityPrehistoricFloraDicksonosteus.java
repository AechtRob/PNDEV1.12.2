...
public class EntityPrehistoricFloraDicksonosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDicksonosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraDicksonosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDicksonosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DICKSONOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DICKSONOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraDicksonosteus EntityBase = EntityPrehistoricFloraDicksonosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraDicksonosteus.this);
		}
