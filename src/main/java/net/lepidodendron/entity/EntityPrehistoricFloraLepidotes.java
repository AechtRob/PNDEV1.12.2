...
public class EntityPrehistoricFloraLepidotes extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraLepidotes(World world) {
		super(world);
		setSize(0.5F, 0.5F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LEPIDOTES_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LEPIDOTES;
	}
}
