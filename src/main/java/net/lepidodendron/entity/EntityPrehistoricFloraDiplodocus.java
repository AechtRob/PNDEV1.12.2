...
public class EntityPrehistoricFloraDiplodocus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DIPLODOCUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.DIPLODOCUS_LOOT_YOUNG;
		}
		return LepidodendronMod.DIPLODOCUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDiplodocus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderDiplodocus.getScaler();
	}
