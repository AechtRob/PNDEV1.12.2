...
import net.lepidodendron.entity.render.entity.RenderMalawisuchus;
...
public class EntityPrehistoricFloraMalawisuchus extends EntityPrehistoricFloraDiictodon implements ITrappableLand, IAdvancementGranter {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderMalawisuchus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelMalawisuchus;}
	public static float getScaler(@Nullable String variant) {return RenderMalawisuchus.getScaler();}
