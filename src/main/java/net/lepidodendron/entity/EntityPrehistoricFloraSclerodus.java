...
public class EntityPrehistoricFloraSclerodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSclerodus(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCLERODUS;
