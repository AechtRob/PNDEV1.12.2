...
public class EntityPrehistoricFloraBirkenia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBirkenia(World world) {
		super(world);
		setSize(0.28F, 0.23F);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBirkenia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBirkenia.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BIRKENIA;
	}
