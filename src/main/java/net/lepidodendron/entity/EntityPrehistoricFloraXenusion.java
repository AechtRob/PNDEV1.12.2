...
import net.lepidodendron.item.entities.ItemBucketXenusion;
...
public class EntityPrehistoricFloraXenusion extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraXenusion.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraXenusion(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.XENUSION_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketXenusion.block, (int) (1));
