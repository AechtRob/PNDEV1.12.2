...
import net.lepidodendron.item.entities.ItemBucketPalaeodictyopteraNymphPerm;
...
public class EntityPrehistoricFloraPalaeodictyopteraNymphPerm extends EntityPrehistoricFloraEurypteridBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraPalaeodictyopteraNymphPerm(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		experienceValue = 0;
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPalaeodictyopteraNymphPerm.block, (int) (1));
