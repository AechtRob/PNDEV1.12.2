...
public class EntityPrehistoricFloraMelosaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraMelosaurus(World world) {
		super(world);
		setSize(0.9F, 0.6F);
		minWidth = 0.1F;
		maxWidth = 0.9F;
	...
	public int WaterDist() {
		int i = (int) LepidodendronConfig.waterMelosaurus;
		if (i > 16) {i = 16;}
		if (i < 1) {i = 1;}
		return i;
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AmphibianWander(this, NO_ANIMATION, 0.65, 20));
...
//		//this.targetTasks.addTask(3, new HuntAI(this, EntityPrehistoricFloraSwimmingAmphibianBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.MELOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.MELOSAURUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMelosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderMelosaurus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MELOSAURUS;
	}
