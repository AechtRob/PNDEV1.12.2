...
public class EntityPrehistoricFloraGymnotrachelus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGymnotrachelus(this.world);
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AgeableFishWander(this, NO_ANIMATION, 1, 5, true));
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GYMNOTRACHELUS_LOOT;
	}
	...
	public static float getScaler(@Nullable String variant) {return RenderGymnotrachelus.getScaler();}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GYMNOTRACHELUS;
	}
}
