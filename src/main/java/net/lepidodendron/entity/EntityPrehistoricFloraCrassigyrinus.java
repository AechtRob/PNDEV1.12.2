...
public class EntityPrehistoricFloraCrassigyrinus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRASSIGYRINUS;
	}
}