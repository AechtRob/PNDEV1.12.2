...
import net.lepidodendron.entity.render.entity.RenderAnthracoceras;
...
public class EntityPrehistoricFloraAnthracoceras extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAnthracoceras(World world) {
		super(world);
		setSize(0.3F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ANTHRACOCERAS_LOOT;
	}

	//Rendering taxidermy:
	//--------------------
	public static double offsetWall(@Nullable String variant) {return 0.165;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAnthracoceras.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAnthracoceras;}
	public static float getScaler(@Nullable String variant) {return RenderAnthracoceras.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANTHRACOCERAS;
	}
}