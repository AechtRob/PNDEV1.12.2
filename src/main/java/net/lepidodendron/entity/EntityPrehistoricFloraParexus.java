...
import net.lepidodendron.item.entities.ItemBucketParexus;
...
public class EntityPrehistoricFloraParexus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketParexus.block, (int) (1));
