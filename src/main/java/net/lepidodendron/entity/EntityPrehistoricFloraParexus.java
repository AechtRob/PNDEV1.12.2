...
public class EntityPrehistoricFloraParexus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PAREXUS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAREXUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderParexus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelParexus;}
	public static float getScaler(@Nullable String variant) {return RenderParexus.getScaler();}
