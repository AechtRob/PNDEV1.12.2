...
public class EntityPrehistoricFloraPhylloceras extends EntityPrehistoricFloraNautiloidBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraPhylloceras(World world) {
		super(world);
		setSize(0.3F, 0.25F);
		minWidth = 0.07F;
		maxWidth = 0.3F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PHYLLOCERAS_LOOT_YOUNG;
		}
		return LepidodendronMod.PHYLLOCERAS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHYLLOCERAS;
	}
