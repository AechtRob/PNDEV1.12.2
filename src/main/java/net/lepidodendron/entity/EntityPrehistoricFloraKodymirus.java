...
import net.lepidodendron.item.entities.ItemBucketKodymirus;
...
public class EntityPrehistoricFloraKodymirus extends EntityPrehistoricFloraEurypteridBase {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KODYMIRUS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketKodymirus.block, (int) (1));
