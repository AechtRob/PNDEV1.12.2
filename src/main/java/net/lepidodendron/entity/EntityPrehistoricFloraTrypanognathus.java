...
public class EntityPrehistoricFloraTrypanognathus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter {
	private static final DataParameter<Integer> BOTTOM_COOLDOWN = EntityDataManager.createKey(EntityPrehistoricFloraTrypanognathus.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIM_COOLDOWN = EntityDataManager.createKey(EntityPrehistoricFloraTrypanognathus.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BOTTOM_FLAG = EntityDataManager.createKey(EntityPrehistoricFloraTrypanognathus.class, DataSerializers.BOOLEAN);

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraTrypanognathus(World world) {
		super(world);
		setSize(0.3F, 0.18F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
	...
	public int WaterDist() {
		int i = (int) LepidodendronConfig.waterTrypanognathus;
		if (i > 16) {i = 16;}
		if (i < 1) {i = 1;}
		return i;
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TRYPANOGNATHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.TRYPANOGNATHUS_LOOT;
		...
		public CustomTrigger getModTrigger() {
			return ModTriggers.CLICK_TRYPANOGNATHUS;
		}
	}