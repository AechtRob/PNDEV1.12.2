...
public class EntityPrehistoricFloraKradimus extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKradimus(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KRADIMUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KRADIMUS;
	}
}
