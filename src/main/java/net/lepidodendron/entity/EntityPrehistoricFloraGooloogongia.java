...
public class EntityPrehistoricFloraGooloogongia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GOOLOOGONGIA;
	}
	...
	public static double upperfrontverticallinedepth(@Nullable String variant) {return 1.4;}
	...
	public static float getScaler(@Nullable String variant) {return RenderGooloogongia.getScaler();}
}