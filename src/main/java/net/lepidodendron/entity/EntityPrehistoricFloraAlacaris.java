...
import net.lepidodendron.item.entities.ItemBucketAlacaris;
...
public class EntityPrehistoricFloraAlacaris extends EntityPrehistoricFloraTrilobiteSwimBase {
	...
	public EntityPrehistoricFloraAlacaris(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALACARIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAlacaris.block, (int) (1));
