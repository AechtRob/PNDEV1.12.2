...
public class EntityPrehistoricFloraLajasvenator extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraLajasvenator(World world) {
		super(world);
		setSize(0.9F, 1.4F);
		minWidth = 0.20F;
		maxWidth = 0.9F;
		...
		RELAX_ANIMATION = Animation.create(260);
		STAND_ANIMATION = Animation.create(65);
	...
	public boolean isAnimationDirectionLocked(Animation animation) {
		return animation == RELAX_ANIMATION || animation == ROAR_ANIMATION || animation == STAND_ANIMATION
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, RELAX_ANIMATION};
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LAJASVENATOR;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
        if (!this.isPFAdult()) {
            return LepidodendronMod.LAJASVENATOR_LOOT_YOUNG;
        }
		return LepidodendronMod.LAJASVENATOR_LOOT;
