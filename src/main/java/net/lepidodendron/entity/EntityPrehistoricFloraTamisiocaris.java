...
public class EntityPrehistoricFloraTamisiocaris extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraTamisiocaris(World world) {
		super(world);
		setSize(0.4F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TAMISIOCARIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTamisiocaris;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTamisiocaris.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAMISIOCARIS;
	}
}
