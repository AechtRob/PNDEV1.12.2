...
public class EntityPrehistoricFloraCobelodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelCobelodus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderCobelodus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_COBELODUS;
	}
