...
public class EntityPrehistoricFloraThaumactena extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraThaumactena(World world) {
        super(world);
        setSize(0.1F, 0.3F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_THAUMACTENA;
    }
