...
public class EntityPrehistoricFloraPikaia extends EntityPrehistoricFloraFishBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraPikaia(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PIKAIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPikaia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPikaia;}
	public static float getScaler(@Nullable String variant) {return RenderPikaia.getScaler();}
