...
import net.lepidodendron.item.entities.ItemBucketPikaia;
...
public class EntityPrehistoricFloraPikaia extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPikaia.block, (int) (1));
