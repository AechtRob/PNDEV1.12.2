...
import net.lepidodendron.item.entities.ItemBucketHelmetia;
...
public class EntityPrehistoricFloraHelmetia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraHelmetia(World world) {
		super(world);
		setSize(0.2F, 0.18F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HELMETIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHelmetia.block, (int) (1));
