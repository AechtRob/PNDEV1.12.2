...
public class EntityPrehistoricFloraOmnidens extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntityVillager.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemEggsOmnidens.block, (int) (1));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OMNIDENS;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOmnidens;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderOmnidens.getScaler();
	}
}