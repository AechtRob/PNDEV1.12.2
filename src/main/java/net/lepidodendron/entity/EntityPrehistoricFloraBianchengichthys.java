...
public class EntityPrehistoricFloraBianchengichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BIANCHENGICHTHYS_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderBianchengichthys.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelBianchengichthys;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderBianchengichthys.getScaler();
    }

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BIANCHENGICHTHYS;
	}
}