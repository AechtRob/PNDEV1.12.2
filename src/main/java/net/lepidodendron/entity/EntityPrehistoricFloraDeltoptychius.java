...
public class EntityPrehistoricFloraDeltoptychius extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDeltoptychius(this.world);
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntityPrehistoricFloraTrilobiteSwimBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.DELTOPTYCHIUS_LOOT_YOUNG;
		}
		return LepidodendronMod.DELTOPTYCHIUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DELTOPTYCHIUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraDeltoptychius EntityBase = EntityPrehistoricFloraDeltoptychius.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraDeltoptychius.this);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDeltoptychius;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderDeltoptychius.getScaler();
	}
}