...
public class EntityPrehistoricFloraCasineria extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntityPrehistoricFloraInsectFlyingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CASINERIA;
	}
}