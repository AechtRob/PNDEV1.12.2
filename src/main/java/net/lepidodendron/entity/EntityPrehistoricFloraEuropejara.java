...
public class EntityPrehistoricFloraEuropejara extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, IScreamerFlier, ITrappableLand {
	...
	public EntityPrehistoricFloraEuropejara(World world) {
		super(world);
		setSize(0.85F, 0.5F);
		minWidth = 0.10F;
		maxWidth = 0.85F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EUROPEJARA;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.EUROPEJARA_LOOT_YOUNG;
		}
		return LepidodendronMod.EUROPEJARA_LOOT;
	}
