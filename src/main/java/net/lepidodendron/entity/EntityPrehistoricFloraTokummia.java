...
import net.lepidodendron.item.entities.ItemBucketTokummia;
...
public class EntityPrehistoricFloraTokummia extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraTokummia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketTokummia.block, (int) (1));
