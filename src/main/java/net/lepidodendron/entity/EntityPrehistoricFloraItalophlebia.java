...
import net.lepidodendron.entity.render.entity.LayerItalophlebiaWing;
...
public class EntityPrehistoricFloraItalophlebia extends EntityPrehistoricFloraInsectFlyingBase implements IAdvancementGranter, ITrappableAir {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderItalophlebia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplayTransparent(@Nullable String variant) {
		return LayerItalophlebiaWing.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelItalophlebia;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ITALOPHLEBIA;
	}
}