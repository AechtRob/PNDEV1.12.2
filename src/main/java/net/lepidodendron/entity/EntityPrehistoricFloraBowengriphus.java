...
import net.lepidodendron.entity.render.entity.RenderBowengriphus;
import net.lepidodendron.entity.render.entity.RenderSenekichthys;
...
public class EntityPrehistoricFloraBowengriphus extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBowengriphus(World world) {
		super(world, 26);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BOWENGRIPHUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBowengriphus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBowengriphus.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BOWENGRIPHUS;
	}
}