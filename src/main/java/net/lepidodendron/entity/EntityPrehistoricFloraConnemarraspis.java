...
public class EntityPrehistoricFloraConnemarraspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraConnemarraspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraConnemarraspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraConnemarraspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CONNEMARRASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CONNEMARRASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraConnemarraspis EntityBase = EntityPrehistoricFloraConnemarraspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraConnemarraspis.this);
		}
