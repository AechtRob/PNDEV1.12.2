...
import net.lepidodendron.item.entities.ItemBucketEoredlichia;
...
public class EntityPrehistoricFloraEoredlichia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraEoredlichia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EOREDLICHIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEoredlichia.block, (int) (1));
