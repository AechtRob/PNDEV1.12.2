...
public class EntityPrehistoricFloraOpolanka extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.OPOLANKA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OPOLANKA;
	}
}