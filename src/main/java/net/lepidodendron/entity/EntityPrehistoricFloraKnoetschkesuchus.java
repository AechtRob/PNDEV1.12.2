...
public class EntityPrehistoricFloraKnoetschkesuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKnoetschkesuchus(World world) {
		super(world);
		setSize(0.6F, 0.32F);
		minWidth = 0.18F;
		maxWidth = 0.6F;
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderKnoetschkesuchus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelKnoetschkesuchus;}
	public static float getScaler(@Nullable String variant) {return RenderKnoetschkesuchus.getScaler();}
