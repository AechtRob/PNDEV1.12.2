...
import net.lepidodendron.item.entities.ItemBucketJellyfish_Precambrian;
...
public class EntityPrehistoricFloraJellyfish_Precambrian extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish_Precambrian.block, (int) (1));
