...
public class EntityPrehistoricFloraJellyfish_Precambrian extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraJellyfish_Precambrian(World world) {
        super(world);
        setSize(0.5F, 0.3F);
    }
    ...
    public static String getPeriod() {return "Ordovician - Silurian - Devonian - Carboniferous - Permian";}
    ...
    protected void collideWithEntity(Entity entityIn) {
        ...
        if (entityIn instanceof EntityLivingBase && !(entityIn instanceof EntityPrehistoricFloraJellyfishBase)
            ...
            entityIn.attackEntityFrom(DamageSource.CACTUS, (float) 1);
        }
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_ANCIENT_JELLY;
    }
}