...
public class EntityPrehistoricFloraBruntonichthys extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBruntonichthys(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraBruntonichthys.SwimmingMoveHelperBase();
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBruntonichthys(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BRUNTONICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BRUNTONICHTHYS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBruntonichthys EntityBase = EntityPrehistoricFloraBruntonichthys.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBruntonichthys.this);
		}
