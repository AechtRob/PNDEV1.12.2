...
public class EntityPrehistoricFloraAntarctopelta extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraAntarctopelta(World world) {
		super(world);
		setSize(0.9F, 0.7F);
		minWidth = 0.3F;
		maxWidth = 0.9F;
...
//	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:antarctopelta_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:antarctopelta_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:antarctopelta_death"));
	}
	...
	@Nullable
	protected ResourceLocation getLootTable() {return LepidodendronMod.ANTARCTOPELTA_LOOT;}


	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANTARCTOPELTA;
	}
