...
import net.lepidodendron.item.entities.ItemBucketEusthenopteron;
...
public class EntityPrehistoricFloraEusthenopteron extends EntityPrehistoricFloraAgeableFishBase {
	...
	protected float getAISpeedFish() {
		float AIspeed = 0.1752f;
		if (this.getIsFast()) {
			AIspeed = AIspeed * 1.45F;
		}
		return AIspeed;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEusthenopteron.block, (int) (1));
