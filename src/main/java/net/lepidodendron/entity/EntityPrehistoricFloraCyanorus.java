...
public class EntityPrehistoricFloraCyanorus extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CYANORUS;
	}
}