...
import net.lepidodendron.item.entities.ItemBucketDaedalichthys;
...
public class EntityPrehistoricFloraDaedalichthys extends EntityPrehistoricFloraFishBase {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DAEDALICHTHYS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketDaedalichthys.block, (int) (1));
