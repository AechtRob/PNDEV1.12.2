...
public class EntityPrehistoricFloraAlbertonia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAlbertonia(World world) {
		super(world);
		setSize(0.4F, 0.275F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALBERTONIA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAlbertonia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAlbertonia.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALBERTONIA;
	}
