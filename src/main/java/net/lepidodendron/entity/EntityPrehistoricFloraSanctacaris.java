...
public class EntityPrehistoricFloraSanctacaris extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSanctacaris(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSanctacaris;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSanctacaris.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SANCTACARIS;
	}
}