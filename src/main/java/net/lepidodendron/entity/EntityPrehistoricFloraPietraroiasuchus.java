...
public class EntityPrehistoricFloraPietraroiasuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraPietraroiasuchus(World world) {
		super(world);
		setSize(0.3F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraPietraroiasuchus(this.world);
	}
