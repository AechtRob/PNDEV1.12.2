...
public class EntityPrehistoricFloraGracilisuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGracilisuchus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.15F;
		maxWidth = 0.3F;
		...
		STAND_ANIMATION = Animation.create(300);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GRACILISUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GRACILISUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
