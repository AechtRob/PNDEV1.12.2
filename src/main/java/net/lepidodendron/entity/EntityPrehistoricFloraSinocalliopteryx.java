...
public class EntityPrehistoricFloraSinocalliopteryx extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSinocalliopteryx(World world) {
		super(world);
		setSize(0.5F, 0.4F);
		minWidth = 0.20F;
		maxWidth = 0.5F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraSinocalliopteryx> Sinocalliopteryx = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraSinocalliopteryx.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraSinocalliopteryx currentSinocalliopteryx : Sinocalliopteryx) {
				currentSinocalliopteryx.setAnimation(NO_ANIMATION);
				currentSinocalliopteryx.setRevengeTarget(ee);
				currentSinocalliopteryx.setAlarmTarget(ee);
				currentSinocalliopteryx.alarmCooldown = rand.nextInt(20);
			}
		}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:coelophysis_alarm"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SINOCALLIOPTERYX_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SINOCALLIOPTERYX;
	}
