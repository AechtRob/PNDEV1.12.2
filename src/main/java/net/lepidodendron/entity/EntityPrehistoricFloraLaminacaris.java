...
import net.lepidodendron.item.entities.ItemBucketLaminacaris;
...
public class EntityPrehistoricFloraLaminacaris extends EntityPrehistoricFloraAgeableFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketLaminacaris.block, (int) (1));
