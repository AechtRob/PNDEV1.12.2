...
public class EntityPrehistoricFloraLaminacaris extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected float getAISpeedFish() {
		//return 0;
		if (this.getIsFast()) {return 0.17F;}
		return 0.101f;
	}
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public void onLivingUpdate() {
		...
		if (this.getAnimation() == ATTACK_ANIMATION && this.getAnimationTick() == 27) {
			launchAttack();
		}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LAMINACARIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLaminacaris;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderLaminacaris.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LAMINACARIS;
	}
