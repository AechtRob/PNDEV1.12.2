...
import net.lepidodendron.entity.render.entity.RenderLusovenator;
...
public class EntityPrehistoricFloraLusovenator extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraLusovenator(World world) {
		super(world);
		setSize(1.75F, 2.3F);
		minWidth = 0.20F;
		maxWidth = 1.75F;
		...
		STAND_ANIMATION = Animation.create(200);
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getRoarSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:lusovenator_roar"));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:lusovenator_idle"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.LUSOVENATOR_LOOT_YOUNG;
		}
		return LepidodendronMod.LUSOVENATOR_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LUSOVENATOR;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLusovenator;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderLusovenator.getScaler();
	}
