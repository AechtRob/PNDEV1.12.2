...
import net.lepidodendron.entity.render.entity.RenderAnthracosaurus;
...
//		this.targetTasks.addTask(3, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAmphibianBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.1));
	...
	public static double upperfrontlineoffset(@Nullable String variant) {return 0.09;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAnthracosaurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAnthracosaurus;}
	public static float getScaler(@Nullable String variant) {return RenderAnthracosaurus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.045F;}
