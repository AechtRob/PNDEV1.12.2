...
public class EntityPrehistoricFloraSpinolestes extends EntityPrehistoricFloraMorganucodon implements ITrappableLand, IAdvancementGranter {
	public Animation STAND_ANIMATION;
	public Animation ALERT_ANIMATION;
	private int standCooldown;

	public EntityPrehistoricFloraSpinolestes(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.12F;
		maxWidth = 0.3F;
		...
		ALERT_ANIMATION = Animation.create(35);
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SPINOLESTES;
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SPINOLESTES_LOOT;
	}
