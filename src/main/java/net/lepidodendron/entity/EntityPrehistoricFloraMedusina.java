...
public class EntityPrehistoricFloraMedusina extends EntityPrehistoricFloraEoandromeda implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraMedusina(World world) {
        super(world);
        setSize(0.185F, 0.1F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_MEDUSINA;
    }
