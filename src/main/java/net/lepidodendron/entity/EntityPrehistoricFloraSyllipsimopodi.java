...
public class EntityPrehistoricFloraSyllipsimopodi extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsSyllipsimopodi.block, (int) (1));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SYLLIPSIMOPODI_LOOT_YOUNG;
		}
		return LepidodendronMod.SYLLIPSIMOPODI_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SYLLIPSIMOPODI;
	}
}
