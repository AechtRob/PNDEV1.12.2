...
public class EntityPrehistoricFloraPlacolepis extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPlacolepis(World world) {
		super(world);
		setSize(0.4F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
    ...
    public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
        return new EntityPrehistoricFloraPlacolepis(this.world);
    }
	@Override
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PLACOLEPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLACOLEPIS;
	}
