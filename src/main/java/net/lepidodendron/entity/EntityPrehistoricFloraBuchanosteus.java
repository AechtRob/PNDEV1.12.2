...
public class EntityPrehistoricFloraBuchanosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBuchanosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraBuchanosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBuchanosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BUCHANOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BUCHANOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBuchanosteus EntityBase = EntityPrehistoricFloraBuchanosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBuchanosteus.this);
		}
