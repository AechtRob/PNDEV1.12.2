...
public class EntityPrehistoricFloraDunyu extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraDunyu(World world) {
		super(world);
		setSize(0.2F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DUNYU_LOOT;
	}
	...
	public static float getScaler(@Nullable String variant) {
		return RenderDunyu.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DUNYU;
	}
}