...
import net.lepidodendron.entity.render.entity.LayerDamselflyWing;
import net.lepidodendron.entity.render.entity.RenderDamselfly;
...
//	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderDamselfly.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplayTransparent(@Nullable String variant) {return LayerDamselflyWing.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelDamselfly;}
	public static float getScaler(@Nullable String variant) {
		return RenderDamselfly.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderDamselfly.getScaler() * 3.0F;
	}
