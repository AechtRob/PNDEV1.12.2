...
public class EntityPrehistoricFloraPoposaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_POPOSAURUS;
	}
}