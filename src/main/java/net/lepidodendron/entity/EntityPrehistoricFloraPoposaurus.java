...
public class EntityPrehistoricFloraPoposaurus extends EntityPrehistoricFloraLandBase {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(2, new EatMeatItemsAI(this));
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:poposaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:poposaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:poposaurus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.POPOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.POPOSAURUS_LOOT;
	}
	...
	public static ResourceLocation textureDisplay() {
		return RenderDisplays.TEXTURE_POPOSAURUS;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay() {
		return RenderDisplays.modelPoposaurus;
	}
	public static float getScaler() {
		return RenderPoposaurus.getScaler();
	}
}