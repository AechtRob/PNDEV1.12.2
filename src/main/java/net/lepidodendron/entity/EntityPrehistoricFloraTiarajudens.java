...
public class EntityPrehistoricFloraTiarajudens extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TIARAJUDENS;
	}
}