...
import net.lepidodendron.entity.render.entity.RenderApateon;
...
public class EntityPrehistoricFloraApateon extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraApateon(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.1F;
		maxWidth = 0.15F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.APATEON_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_APATEON;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelApateon;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderApateon.getScaler();
	}
