...
public class EntityPrehistoricFloraSymphysops extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSymphysops(World world) {
		super(world);
		setSize(0.25F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SYMPHYSOPS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SYMPHYSOPS;
	}
}
