...
import net.lepidodendron.entity.render.entity.RenderShenzhousaurus;
...
public class EntityPrehistoricFloraShenzhousaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public EntityPrehistoricFloraShenzhousaurus(World world) {
		super(world);
		setSize(0.5F, 0.9F);
		minWidth = 0.18F;
		maxWidth = 0.5F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraShenzhousaurus> Shenzhousaurus = Functions.getEntitiesWithinAABBPN(this.world, EntityPrehistoricFloraShenzhousaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)), EntitySelectors.NOT_SPECTATING);
			for (EntityPrehistoricFloraShenzhousaurus currentShenzhousaurus : Shenzhousaurus) {
				currentShenzhousaurus.setAnimation(NO_ANIMATION);
				currentShenzhousaurus.setRevengeTarget(ee);
				currentShenzhousaurus.setAlarmTarget(ee);
				currentShenzhousaurus.alarmCooldown = rand.nextInt(20);
			}
		}
	...
	@Override
	public int getGrazeLength() {return 150; }
...
//TODO make override so noise cant play at the same time as idles
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SHENZHOUSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SHENZHOUSAURUS;
	}
    //Rendering taxidermy:
    //--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderShenzhousaurus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelShenzhousaurus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderShenzhousaurus.getScaler();
    }
}