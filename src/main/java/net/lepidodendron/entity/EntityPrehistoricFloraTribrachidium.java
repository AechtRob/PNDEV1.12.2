...
public class EntityPrehistoricFloraTribrachidium extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTribrachidium(World world) {
		super(world, 0);
		setSize(0.2F, 0.15F);
	}
