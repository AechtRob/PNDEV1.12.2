...
public class EntityPrehistoricFloraPalaeodictyoptera_Delitzschala extends EntityPrehistoricFloraInsectFlyingBase {
	...
	public EntityPrehistoricFloraPalaeodictyoptera_Delitzschala(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		experienceValue = 0;
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.PALAEODICTYOPTERA_DELITZSCHALA_LOOT_JAR;
