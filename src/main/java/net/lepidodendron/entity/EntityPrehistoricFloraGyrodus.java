...
public class EntityPrehistoricFloraGyrodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraGyrodus(World world) {
		super(world);
		setSize(0.9F, 0.9F);
		minWidth = 0.1F;
		maxWidth = 0.9F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GYRODUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGyrodus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGyrodus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GYRODUS;
	}
}
