...
public class EntityPrehistoricFloraCratoavis extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, ITrappableLand {
	...
	public net.minecraft.util.SoundEvent getAmbientSound() {
		return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
			.getObject(new ResourceLocation("lepidodendron:cratoavis_idle"));
	}

	@Override
	public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
		return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
			.getObject(new ResourceLocation("lepidodendron:cratoavis_hurt"));
	}

	@Override
	public net.minecraft.util.SoundEvent getDeathSound() {
		return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
			.getObject(new ResourceLocation("lepidodendron:cratoavis_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CRATOAVIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRATOAVIS;
	}
