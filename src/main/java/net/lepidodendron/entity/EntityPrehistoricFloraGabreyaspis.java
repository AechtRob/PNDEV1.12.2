...
public class EntityPrehistoricFloraGabreyaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraGabreyaspis(World world) {
		super(world);
		setSize(0.4F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GABREYASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGabreyaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGabreyaspis.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GABREYASPIS;
	}
