...
import net.lepidodendron.item.entities.ItemBucketGabreyaspis;
...
public class EntityPrehistoricFloraGabreyaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketGabreyaspis.block, (int) (1));
