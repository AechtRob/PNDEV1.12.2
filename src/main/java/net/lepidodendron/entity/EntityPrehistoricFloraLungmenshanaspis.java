...
public class EntityPrehistoricFloraLungmenshanaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LUNGMENSHANASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLungmenshanaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderLungmenshanaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LUNGMENSHANASPIS;
	}
}