...
import net.lepidodendron.item.entities.ItemBucketLungmenshanaspis;
...
public class EntityPrehistoricFloraLungmenshanaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketLungmenshanaspis.block, (int) (1));
