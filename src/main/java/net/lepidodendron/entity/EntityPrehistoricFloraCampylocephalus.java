...
public class EntityPrehistoricFloraCampylocephalus extends EntityPrehistoricFloraWalkingAmphibianBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraCampylocephalus(World world) {
		super(world);
		setSize(1F, 0.99F);
		minWidth = 0.1F;
		maxWidth = 1.0F;
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.CAMPYLOCEPHALUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CAMPYLOCEPHALUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAMPYLOCEPHALUS;
	}
}
