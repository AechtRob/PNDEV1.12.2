...
import net.lepidodendron.entity.render.entity.RenderLeptostyrax;
...
public class EntityPrehistoricFloraLeptostyrax extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraLeptostyrax(World world) {
		super(world);
		setSize(1F, 1F);
		minWidth = 0.1F;
		maxWidth = 1F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.LEPTOSTYRAX_LOOT_YOUNG;
		}
		return LepidodendronMod.LEPTOSTYRAX_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LEPTOSTYRAX;
	}
