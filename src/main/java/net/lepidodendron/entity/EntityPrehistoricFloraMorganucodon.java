...
public class EntityPrehistoricFloraMorganucodon extends EntityPrehistoricFloraDiictodon implements ITrappableLand {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.MORGANUCODON_LOOT_YOUNG;
		}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderMorganucodon.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelMorganucodon;}
	public static float getScaler(@Nullable String variant) {return RenderMorganucodon.getScaler();}
