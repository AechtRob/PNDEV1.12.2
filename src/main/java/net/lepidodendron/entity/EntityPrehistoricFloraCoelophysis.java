...
public class EntityPrehistoricFloraCoelophysis extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraCoelophysis(World world) {
		super(world);
		setSize(0.65F, 1.05F);
		minWidth = 0.12F;
		maxWidth = 0.65F;
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.MEAT, DietString.ROTTEN);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_COELOPHYSIS;
	}
}