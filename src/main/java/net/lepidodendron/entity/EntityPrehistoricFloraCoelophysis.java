...
import net.lepidodendron.item.entities.ItemEggsCoelophysis;
...
public class EntityPrehistoricFloraCoelophysis extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_coelophysis";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsCoelophysis.block, 1);
	}
