...
public class EntityPrehistoricFloraOgyginus extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraOgyginus(World world) {
		super(world);
		setSize(0.55F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.OGYGINUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OGYGINUS;
	}
}