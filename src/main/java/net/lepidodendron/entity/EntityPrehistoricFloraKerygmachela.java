...
public class EntityPrehistoricFloraKerygmachela extends EntityPrehistoricFloraEurypteridBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KERYGMACHELA;
	}
}