...
public class EntityPrehistoricFloraSigmapycnodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSigmapycnodus(World world) {
		super(world);
		setSize(0.5F, 0.4F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SIGMAPYCNODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SIGMAPYCNODUS;
	}
