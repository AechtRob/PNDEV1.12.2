...
public class EntityPrehistoricFloraAleosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAleosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraAleosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAleosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALEOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALEOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraAleosteus EntityBase = EntityPrehistoricFloraAleosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraAleosteus.this);
		}
