...
public class EntityPrehistoricFloraCowralepis extends EntityPrehistoricFloraAgeableFishBase {
	...
	public static double lowerfrontlineoffset() {return 0.2;}
	...
	public static ResourceLocation textureDisplay() {
		return RenderDisplays.TEXTURE_COWRALEPIS;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay() {
		return RenderDisplays.modelCowralepis;
	}
	public static float getScaler() {return RenderCowralepis.getScaler();}
}