...
public class EntityPrehistoricFloraCeratosaurus extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraCeratosaurus(World world) {
		super(world);
		setSize(1.75F, 2.2F);
		minWidth = 0.20F;
		maxWidth = 1.75F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CERATOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CERATOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CERATOSAURUS;
	}
}