...
import net.lepidodendron.entity.render.entity.RenderHadronector;
...
public class EntityPrehistoricFloraHadronector extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHadronector;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHadronector.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HADRONECTOR;
	}
}
