...
public class EntityPrehistoricFloraBarwickosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBarwickosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraBarwickosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBarwickosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BARWICKOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BARWICKOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBarwickosteus EntityBase = EntityPrehistoricFloraBarwickosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBarwickosteus.this);
		}
