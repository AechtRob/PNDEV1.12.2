...
public class EntityPrehistoricFloraAmphicentrum extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAmphicentrum(World world) {
		super(world);
		setSize(0.3F, 0.25F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AMPHICENTRUM_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAmphicentrum.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAmphicentrum;}
	public static float getScaler(@Nullable String variant) {return RenderAmphicentrum.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AMPHICENTRUM;
	}
