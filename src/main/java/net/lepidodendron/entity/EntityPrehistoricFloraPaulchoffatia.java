...
import net.lepidodendron.entity.render.entity.RenderPaulchoffatia;
...
public class EntityPrehistoricFloraPaulchoffatia extends EntityPrehistoricFloraDiictodon implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPaulchoffatia(World world) {
		super(world);
		setSize(0.2F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
		...
		STAND_ANIMATION = Animation.create(69);
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PAULCHOFFATIA;
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraPaulchoffatia(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAULCHOFFATIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPaulchoffatia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPaulchoffatia;}
	public static float getScaler(@Nullable String variant) {return RenderPaulchoffatia.getScaler();}
