...
public class EntityPrehistoricFloraWalterosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWalterosteus(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.5F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraWalterosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WALTEROSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WALTEROSTEUS;
	}
	//Rendering taxidermy:
	//--------------------
