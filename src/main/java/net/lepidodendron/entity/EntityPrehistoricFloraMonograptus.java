...
public class EntityPrehistoricFloraMonograptus extends EntityPrehistoricFloraJellyfishBase implements IAdvancementGranter, ITrappableWater {
    ...
    public EntityPrehistoricFloraMonograptus(World world) {
        super(world);
        setSize(0.3F, 0.4F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_MONOGRAPTUS;
    }
}