...
public class EntityPrehistoricFloraDolganosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Integer> BURYTICK = EntityDataManager.createKey(EntityPrehistoricFloraDolganosteus.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BURIED = EntityDataManager.createKey(EntityPrehistoricFloraDolganosteus.class, DataSerializers.BOOLEAN);

	private static final DataParameter<Integer> BURYCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraDolganosteus.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIMCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraDolganosteus.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraDolganosteus(World world) {
		super(world);
		setSize(0.25F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.25F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDolganosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DOLGANOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DOLGANOSTEUS;
	}
}
