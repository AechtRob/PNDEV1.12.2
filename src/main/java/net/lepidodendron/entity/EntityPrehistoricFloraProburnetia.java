...
import net.lepidodendron.item.entities.ItemEggsProburnetia;
...
public class EntityPrehistoricFloraProburnetia extends EntityPrehistoricFloraLandBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraProburnetia(World world) {
		super(world);
		//setSize(0.6F, 0.35F);
		experienceValue = 0;
	...
	public String tagEgg() {
		return "eggs_proburnetia";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsProburnetia.block, 1);
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:proburnetia_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:proburnetia_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:proburnetia_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PROBURNETIA_LOOT_YOUNG;
		}
		return LepidodendronMod.PROBURNETIA_LOOT;
	}
