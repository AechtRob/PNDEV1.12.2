...
public class EntityPrehistoricFloraProburnetia extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROBURNETIA;
	}
}