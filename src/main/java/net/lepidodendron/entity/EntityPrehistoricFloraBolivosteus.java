...
public class EntityPrehistoricFloraBolivosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Integer> BURYTICK = EntityDataManager.createKey(EntityPrehistoricFloraBolivosteus.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BURIED = EntityDataManager.createKey(EntityPrehistoricFloraBolivosteus.class, DataSerializers.BOOLEAN);

	private static final DataParameter<Integer> BURYCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraBolivosteus.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIMCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraBolivosteus.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraBolivosteus(World world) {
		super(world);
		setSize(0.25F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.25F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBolivosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BOLIVOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BOLIVOSTEUS;
	}
}
