...
public class EntityPrehistoricFloraYiQi extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, ITrappableLand {
	...
	public float getAISpeedLand() {
		if (this.getAnimation() == LAY_ANIMATION || this.getAnimation() == MAKE_NEST_ANIMATION || this.getAnimation() == STAND_ANIMATION) {
			return 0.0F;
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelYiQi;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderYiQi.getScaler();
	}
