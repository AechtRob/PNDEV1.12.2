...
import net.lepidodendron.entity.render.entity.RenderYutyrannus;
...
public class EntityPrehistoricFloraYutyrannus extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraYutyrannus(World world) {
		super(world);
		setSize(2.5F, 3.5F);
		minWidth = 0.20F;
		maxWidth = 1.8F;
		...
		STAND_ANIMATION = Animation.create(160);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, MAKE_NEST_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, NOISE_ANIMATION, STAND_ANIMATION, HURT_ANIMATION};
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getRoarSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:yutyrannus_roar"));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:yutyrannus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:yutyrannus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:yutyrannus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.YUTYRANNUS_LOOT_YOUNG;
		}
		return LepidodendronMod.YUTYRANNUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_YUTYRANNUS;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelYutyrannus;}
	public static float getScaler(@Nullable String variant) {return RenderYutyrannus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.07F;}
