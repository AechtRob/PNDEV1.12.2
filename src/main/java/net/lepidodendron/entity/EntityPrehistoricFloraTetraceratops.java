...
import net.lepidodendron.item.entities.ItemEggsTetraceratops;
...
public class EntityPrehistoricFloraTetraceratops extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_tetraceratops";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsTetraceratops.block, 1);
	}
