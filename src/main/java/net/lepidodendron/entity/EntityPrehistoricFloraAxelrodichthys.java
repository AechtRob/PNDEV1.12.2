...
public class EntityPrehistoricFloraAxelrodichthys extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAxelrodichthys(World world) {
		super(world);
		setSize(1.5F, 0.95F);
		minWidth = 0.2F;
		maxWidth = 1.5F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAxelrodichthys(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AXELRODICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AXELRODICHTHYS;
	}
}