...
import net.lepidodendron.entity.render.entity.RenderObruchevodus;
...
public class EntityPrehistoricFloraObruchevodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraObruchevodus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.OBRUCHEVODUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderObruchevodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelObruchevodus;}
	public static float getScaler(@Nullable String variant) {return RenderObruchevodus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OBRUCHEVODUS;
	}
