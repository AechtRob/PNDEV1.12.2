...
public class EntityPrehistoricFloraMurrindalaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMurrindalaspis(World world) {
		super(world);
		if (world != null) {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMurrindalaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MURRINDALASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MURRINDALASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraMurrindalaspis EntityBase = EntityPrehistoricFloraMurrindalaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraMurrindalaspis.this);
		}
