...
import net.lepidodendron.entity.render.entity.RenderHagenoselache;
...
public class EntityPrehistoricFloraHagenoselache extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraHagenoselache(World world) {
		super(world);
		setSize(0.3F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HAGENOSELACHE_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderHagenoselache.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelHagenoselache;}
	public static float getScaler(@Nullable String variant) {return RenderHagenoselache.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HAGENOSELACHE;
	}
