...
public class EntityPrehistoricFloraCaviramus extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, ITrappableLand {

	public EntityPrehistoricFloraCaviramus(World world) {
		super(world);
		setSize(0.62F, 0.72F);
		minWidth = 0.12F;
		maxWidth = 0.62F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase && this.hasAlarm()) {
			...
			List<EntityPrehistoricFloraCaviramus> caviramus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraCaviramus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraCaviramus currentCaviramus : caviramus) {
				currentCaviramus.setRevengeTarget(ee);
				//currentCaelestiventus.screamAlarmCooldown = rand.nextInt(20);
				currentCaviramus.setFlying();
			}
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAVIRAMUS;
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:caviramus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:caviramus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:caviramus_death"));
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(7, new AgeableClimbingFlyingWalkingFlyHigh(this, true));
		tasks.addTask(8, new LandClimbingFlyingWalkingBaseWanderFlightNearGroundAI(this, true, false));
