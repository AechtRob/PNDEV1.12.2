...
import net.lepidodendron.item.entities.ItemBucketVetulicola;
...
public class EntityPrehistoricFloraVetulicola extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraVetulicola(World world) {
		super(world);
		setSize(0.25F, 0.2F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.VETULICOLA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketVetulicola.block, (int) (1));
