...
import net.lepidodendron.item.entities.ItemBucketSaurichthysMarine;
...
public class EntityPrehistoricFloraSaurichthysMarine extends EntityPrehistoricFloraAgeableFishBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraSaurichthysMarine(World world) {
		super(world);
		setSize(0.5F, 0.4F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SAURICHTHYS_MARINE_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketSaurichthysMarine.block, (int) (1));
