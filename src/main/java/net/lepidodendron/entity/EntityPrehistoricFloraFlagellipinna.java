...
public class EntityPrehistoricFloraFlagellipinna extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraFlagellipinna(World world) {
		super(world);
		setSize(0.4F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.FLAGELLIPINNA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_FLAGELLIPINNA;
	}
