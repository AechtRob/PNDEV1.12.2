...
import net.lepidodendron.entity.render.entity.RenderAlbalophosaurus;
...
public class EntityPrehistoricFloraAlbalophosaurus extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAlbalophosaurus(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraAlbalophosaurus> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraAlbalophosaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraAlbalophosaurus currentYinlong : Yinlong) {
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, MAKE_NEST_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, STAND_ANIMATION};
	}
	...
	public int getDrinkLength() {
		return 182;  //grazes, does not drink
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.ALBALOPHOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ALBALOPHOSAURUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAlbalophosaurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAlbalophosaurus;}
	public static float getScaler(@Nullable String variant) {return RenderAlbalophosaurus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALBALOPHOSAURUS;
	}
}