...
import net.lepidodendron.item.entities.ItemBucketDiania;
...
public class EntityPrehistoricFloraDiania extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraDiania.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraDiania(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DIANIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketDiania.block, (int) (1));
