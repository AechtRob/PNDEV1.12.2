...
public class EntityPrehistoricFloraEuchambersia extends EntityPrehistoricFloraDiictodon implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EUCHAMBERSIA;
	}
