...
public class EntityPrehistoricFloraRiojasuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RIOJASUCHUS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RIOJASUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
