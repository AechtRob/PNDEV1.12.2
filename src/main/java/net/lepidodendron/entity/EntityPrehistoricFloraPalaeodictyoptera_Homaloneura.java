...
public class EntityPrehistoricFloraPalaeodictyoptera_Homaloneura extends EntityPrehistoricFloraInsectFlyingBase {
	...
	public EntityPrehistoricFloraPalaeodictyoptera_Homaloneura(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
