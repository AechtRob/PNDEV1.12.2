...
import net.lepidodendron.item.entities.ItemBucketAiniktozoon;
...
public class EntityPrehistoricFloraAiniktozoon extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAiniktozoon.block, (int) (1));
