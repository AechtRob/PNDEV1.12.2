...
public class EntityPrehistoricFloraTitanopteraGigatitan extends EntityPrehistoricFloraArchoblattinaInsect {
	...
	public EntityPrehistoricFloraTitanopteraGigatitan(World world) {
		super(world);
		setSize(0.3F, 0.21F);
	}
