...
public class EntityPrehistoricFloraParapeytoia extends EntityPrehistoricFloraEurypteridBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraParapeytoia(World world) {
		super(world);
		setSize(0.25F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.25F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARAPEYTOIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARAPEYTOIA;
	}
}