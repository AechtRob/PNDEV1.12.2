...
public class EntityPrehistoricFloraStenoprotome extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraStenoprotome(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.STENOPROTOME_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_STENOPROTOME;
	}
