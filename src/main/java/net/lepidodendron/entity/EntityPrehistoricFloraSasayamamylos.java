...
import net.lepidodendron.entity.render.entity.RenderSasayamamylos;
...
public class EntityPrehistoricFloraSasayamamylos extends EntityPrehistoricFloraDiictodon implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSasayamamylos(World world) {
		super(world);
		setSize(0.2F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SASAYAMAMYLOS;
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraSasayamamylos(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SASAYAMAMYLOS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSasayamamylos.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSasayamamylos;}
	public static float getScaler(@Nullable String variant) {return RenderSasayamamylos.getScaler();}
