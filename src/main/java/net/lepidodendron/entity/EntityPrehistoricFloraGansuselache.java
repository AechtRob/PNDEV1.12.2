...
import net.lepidodendron.entity.render.entity.RenderGansuselache;
...
public class EntityPrehistoricFloraGansuselache extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	private static final DataParameter<Integer> GANSUSELACHE_TYPE = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraGansuselache.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraGansuselache(World world) {
		super(world);
		setSize(0.2F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(GANSUSELACHE_TYPE, 0);
	}
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraGansuselache)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraGansuselache.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraGansuselache.Type getTypeFromString(String nameIn)
		{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraGansuselache.Type.byId(rand.nextInt(EntityPrehistoricFloraGansuselache.Type.values().length) + 1));
		return livingdata;
	}

	public void setPNType(EntityPrehistoricFloraGansuselache.Type type)
	{
		this.dataManager.set(GANSUSELACHE_TYPE, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraGansuselache.Type getPNType()
	{
		return EntityPrehistoricFloraGansuselache.Type.byId(((Integer)this.dataManager.get(GANSUSELACHE_TYPE)).intValue());
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		{
			this.setPNType(EntityPrehistoricFloraGansuselache.Type.getTypeFromString(compound.getString("PNType")));
		}
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	//Rendering taxidermy:
	//--------------------
	public static double offsetWall(@Nullable String variant) {return -0.08;}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGansuselache;
	}
	public static float getScaler(@Nullable String variant) {
		if (variant.equalsIgnoreCase("female")) {
			return RenderGansuselache.getScaler() * 0.8F;
		}
		return RenderGansuselache.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GANSUSELACHE;
	}
