...
public class EntityPrehistoricFloraSecodontosaurus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSecodontosaurus(World world) {
		super(world);
		setSize(0.6F, 0.4F);
		minWidth = 0.15F;
		maxWidth = 0.6F;
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:secodontosaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:secodontosaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:secodontosaurus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SECODONTOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SECODONTOSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SECODONTOSAURUS;
	}
	//Rendering taxidermy:
	//--------------------
...
//		return RenderDisplays.modelArizonasaurus;
//	}
//	public static float getScaler(@Nullable String variant) {
//		return RenderArizonasaurus.getScaler();
//	}
}