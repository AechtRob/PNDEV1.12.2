...
public class EntityPrehistoricFloraAnjiaspis extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAnjiaspis(World world) {
		super(world);
		setSize(0.3F, 0.20F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ANJIASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANJIASPIS;
	}
}