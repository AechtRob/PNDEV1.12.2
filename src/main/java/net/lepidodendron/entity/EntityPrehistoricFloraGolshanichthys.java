...
public class EntityPrehistoricFloraGolshanichthys extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGolshanichthys(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraGolshanichthys.SwimmingMoveHelperBase();
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGolshanichthys(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GOLSHANICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GOLSHANICHTHYS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraGolshanichthys EntityBase = EntityPrehistoricFloraGolshanichthys.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraGolshanichthys.this);
		}
