...
public class EntityPrehistoricFloraPlacerias extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public static float getScaler(@Nullable String variant) {
		return RenderPlacerias.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLACERIAS;
	}
}