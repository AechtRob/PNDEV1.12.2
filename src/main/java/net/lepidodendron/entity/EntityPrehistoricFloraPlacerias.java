...
import net.lepidodendron.item.entities.ItemEggsPlacerias;
...
public class EntityPrehistoricFloraPlacerias extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_placerias";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsPlacerias.block, 1);
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:placerias_roar"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:placerias_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:placerias_death"));
	}

	public SoundEvent getAmbientAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:placerias_idle"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PLACERIAS_LOOT_YOUNG;
		}
		return LepidodendronMod.PLACERIAS_LOOT;
	}
