...
public class EntityPrehistoricFloraMaclurina extends EntityPrehistoricFloraWaterGastropodBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MACLURINA;
	}
}