...
public class EntityPrehistoricFloraTemnoxa extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTemnoxa(World world) {
		super(world, 40);
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TEMNOXA;
	}
}