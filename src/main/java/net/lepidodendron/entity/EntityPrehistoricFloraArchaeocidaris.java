...
public class EntityPrehistoricFloraArchaeocidaris extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCHAEOCIDARIS;
	}
}