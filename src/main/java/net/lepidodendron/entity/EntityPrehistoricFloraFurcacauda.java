...
public class EntityPrehistoricFloraFurcacauda extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelFurcacauda;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_FURCACAUDA;
	}
