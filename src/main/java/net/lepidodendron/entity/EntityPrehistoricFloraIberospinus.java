...
import net.lepidodendron.entity.render.entity.RenderIberospinus;
...
public class EntityPrehistoricFloraIberospinus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraIberospinus(World world) {
		super(world);
		setSize(0.95F, 2.4F);
		minWidth = 0.20F;
		maxWidth = 0.95F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:irritator_idle"));
	}

	@Override
	public SoundEvent getRoarSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:irritator_roar"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:irritator_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:irritator_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.IBEROSPINUS_LOOT_YOUNG;
		}
		return LepidodendronMod.IBEROSPINUS_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderIberospinus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelIberospinus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderIberospinus.getScaler();
    }
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_IBEROSPINUS;
	}
	//Rendering taxidermy:
	//--------------------
