...
public class EntityPrehistoricFloraOsteolepis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOsteolepis;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OSTEOLEPIS;
	}
