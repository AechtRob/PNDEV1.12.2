...
import net.lepidodendron.item.entities.ItemBucketAlbertonia;
import net.lepidodendron.item.entities.ItemBucketOsteolepis;
...
public class EntityPrehistoricFloraOsteolepis extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraOsteolepis(World world) {
		super(world);
		setSize(0.3F, 0.275F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.OSTEOLEPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketOsteolepis.block, (int) (1));
