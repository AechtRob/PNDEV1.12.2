...
public class EntityPrehistoricFloraEntelognathus extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderEntelognathus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ENTELOGNATHUS;
	}
