...
import net.lepidodendron.entity.render.entity.RenderScrebinodus;
...
public class EntityPrehistoricFloraScrebinodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraScrebinodus(World world) {
		super(world);
		setSize(0.5F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.5F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SCREBINODUS_LOOT;
	}
	...
	public static double lowerbacklineoffset(@Nullable String variant) {return 0.15;}
	public static double lowerbacklineoffsetperpendiular(@Nullable String variant) {return 0.25;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderScrebinodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelScrebinodus;}
	public static float getScaler(@Nullable String variant) {return RenderScrebinodus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCREBINODUS;
	}
