...
import net.lepidodendron.entity.render.entity.RenderOrestiacanthus;
...
public class EntityPrehistoricFloraOrestiacanthus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	private static final DataParameter<Integer> ORESTIACANTHUS_TYPE = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraOrestiacanthus.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraOrestiacanthus(World world) {
		super(world);
		setSize(0.2F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(ORESTIACANTHUS_TYPE, 0);
	}
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraOrestiacanthus)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_orestiacanthus_" + this.getPNType().getName() + ".name");
		}
	}
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraOrestiacanthus.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraOrestiacanthus.Type getTypeFromString(String nameIn)
		{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraOrestiacanthus.Type.byId(rand.nextInt(EntityPrehistoricFloraOrestiacanthus.Type.values().length) + 1));
		return livingdata;
	}

	public void setPNType(EntityPrehistoricFloraOrestiacanthus.Type type)
	{
		this.dataManager.set(ORESTIACANTHUS_TYPE, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraOrestiacanthus.Type getPNType()
	{
		return EntityPrehistoricFloraOrestiacanthus.Type.byId(((Integer)this.dataManager.get(ORESTIACANTHUS_TYPE)).intValue());
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		{
			this.setPNType(EntityPrehistoricFloraOrestiacanthus.Type.getTypeFromString(compound.getString("PNType")));
		}
	}
	...
	protected ResourceLocation getLootTable() {
		switch (this.getPNType()) {
			case MALE:
			default:
				return LepidodendronMod.ORESTIACANTHUS_LOOT;

			case FEMALE:
				return LepidodendronMod.ORESTIACANTHUS_LOOT_F;
		}
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOrestiacanthus;
	}
	public static float getScaler(@Nullable String variant) {
		if (variant.equalsIgnoreCase("female")) {
			return RenderOrestiacanthus.getScaler() * 0.8F;
		}
		return RenderOrestiacanthus.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ORESTIACANTHUS;
	}
