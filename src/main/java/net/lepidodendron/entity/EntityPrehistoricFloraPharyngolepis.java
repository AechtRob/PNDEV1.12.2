...
public class EntityPrehistoricFloraPharyngolepis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PHARYNGOLEPIS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHARYNGOLEPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPharyngolepis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPharyngolepis;}
	public static float getScaler(@Nullable String variant) {return RenderPharyngolepis.getScaler();}
}