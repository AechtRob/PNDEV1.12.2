...
import net.lepidodendron.item.entities.ItemBucketPharyngolepis;
...
public class EntityPrehistoricFloraPharyngolepis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPharyngolepis.block, (int) (1));
