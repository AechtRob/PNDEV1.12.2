...
public class EntityPrehistoricFloraSqualoraja extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraSqualoraja)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SQUALORAJA;
	}
