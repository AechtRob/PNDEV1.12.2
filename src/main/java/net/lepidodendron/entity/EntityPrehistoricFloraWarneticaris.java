...
public class EntityPrehistoricFloraWarneticaris extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static float getScaler(@Nullable String variant) {return RenderWarneticaris.getScaler();}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WARNETICARIS;
