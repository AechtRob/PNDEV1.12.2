...
public class EntityPrehistoricFloraHaldanodon extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HALDANODON;
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(6, new LandWanderHerd(this, 1.00D, Math.max(1F, this.width) * this.getNavigator().getPathSearchRange() * 0.75F));
		tasks.addTask(7, new AmphibianWanderNotBound(this, NO_ANIMATION, 0.1, 90, 4));
		tasks.addTask(8, new EntityWatchClosestAI(this, EntityPlayer.class, 6.0F));
		tasks.addTask(9, new EntityWatchClosestAI(this, EntityPrehistoricFloraFishBase.class, 8.0F));
