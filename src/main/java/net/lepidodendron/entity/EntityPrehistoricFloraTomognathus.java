...
import net.lepidodendron.entity.render.entity.RenderTomognathus;
...
public class EntityPrehistoricFloraTomognathus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTomognathus(World world) {
		super(world);
		setSize(0.8F, 0.5F);
		minWidth = 0.1F;
		maxWidth = 0.8F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TOMOGNATHUS_LOOT;
	}
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 0.48;}
	...
	public static double lowerfrontlineoffsetperpendiular(@Nullable String variant) {return -0.1;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTomognathus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTomognathus;}
	public static float getScaler(@Nullable String variant) {return RenderTomognathus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TOMOGNATHUS;
	}
