...
import net.lepidodendron.item.entities.ItemBucketMcnamaraspis;
...
public class EntityPrehistoricFloraMcnamaraspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketMcnamaraspis.block, (int) (1));
