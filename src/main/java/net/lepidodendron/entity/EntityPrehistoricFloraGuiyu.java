...
public class EntityPrehistoricFloraGuiyu extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraGuiyu(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GUIYU_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GUIYU;
	}
}
