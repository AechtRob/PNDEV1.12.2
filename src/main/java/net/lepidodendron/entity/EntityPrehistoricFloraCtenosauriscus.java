...
import net.lepidodendron.entity.render.entity.RenderCtenosauriscus;
...
public class EntityPrehistoricFloraCtenosauriscus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraCtenosauriscus(World world) {
		super(world);
		setSize(0.85F, 0.9F);
		minWidth = 0.15F;
		maxWidth = 0.85F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CTENOSAURISCUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CTENOSAURISCUS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CTENOSAURISCUS;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelCtenosauriscus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderCtenosauriscus.getScaler();
    }
}