...
public class EntityPrehistoricFloraPhyllograptus extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_PHYLLOGRAPTUS;
    }
}