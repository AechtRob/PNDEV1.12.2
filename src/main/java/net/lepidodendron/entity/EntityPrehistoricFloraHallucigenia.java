...
public class EntityPrehistoricFloraHallucigenia extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HALLUCIGENIA;
	}
}