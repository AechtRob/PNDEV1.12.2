...
import net.lepidodendron.item.entities.ItemBucketHallucigenia;
...
public class EntityPrehistoricFloraHallucigenia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraHallucigenia.class, DataSerializers.VARINT);
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HALLUCIGENIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHallucigenia.block, (int) (1));
