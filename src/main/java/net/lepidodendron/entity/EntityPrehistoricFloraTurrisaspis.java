...
import net.lepidodendron.item.entities.ItemBucketTurrisaspis;
...
public class EntityPrehistoricFloraTurrisaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketTurrisaspis.block, (int) (1));
