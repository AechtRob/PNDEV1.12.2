...
public class EntityPrehistoricFloraSarcosuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraSarcosuchus(World world) {
		super(world);
		setSize(2.2F, 0.99F);
		minWidth = 0.1F;
		maxWidth = 2.2F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SARCOSUCHUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SARCOSUCHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SARCOSUCHUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
