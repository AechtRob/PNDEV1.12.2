...
import net.lepidodendron.item.entities.ItemEggsLisowicia;
...
public class EntityPrehistoricFloraLisowicia extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_lisowicia";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsLisowicia.block, 1);
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(6, new LandWanderAvoidWaterAI(this, 1.0D, 80));
