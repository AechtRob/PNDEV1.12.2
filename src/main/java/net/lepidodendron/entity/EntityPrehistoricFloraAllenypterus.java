...
import net.lepidodendron.item.entities.ItemBucketAllenypterus;
...
public class EntityPrehistoricFloraAllenypterus extends EntityPrehistoricFloraFishBase {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALLENYPTERUS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketAllenypterus.block, (int) (1));
