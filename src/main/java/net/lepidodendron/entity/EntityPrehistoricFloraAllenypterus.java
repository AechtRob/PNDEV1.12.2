...
public class EntityPrehistoricFloraAllenypterus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAllenypterus;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALLENYPTERUS;
	}
