...
public class EntityPrehistoricFloraElrhazosaurus extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraElrhazosaurus(World world) {
		super(world);
		setSize(0.375F, 0.6F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraElrhazosaurus> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraElrhazosaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraElrhazosaurus currentYinlong : Yinlong) {
	...
	public boolean findGrappleTarget() {
		...
		List<EntityPrehistoricFloraElrhazosaurus> Aquilops = world.getEntitiesWithinAABB(EntityPrehistoricFloraElrhazosaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
		for (EntityPrehistoricFloraElrhazosaurus currentAquilops : Aquilops) {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ELRHAZOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ELRHAZOSAURUS;
	}
}