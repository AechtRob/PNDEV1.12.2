...
public class EntityPrehistoricFloraInostrancevia extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraInostrancevia(World world) {
		...
		RELAX_ANIMATION = Animation.create(400);
		SNIFF_ANIMATION = Animation.create(60);
		YAWN_ANIMATION = Animation.create(70);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, NOISE_ANIMATION, SNIFF_ANIMATION, YAWN_ANIMATION, RELAX_ANIMATION};
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:inostrancevia_idle"));
	}

	public SoundEvent getRoarSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:inostrancevia_roar"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:inostrancevia_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:inostrancevia_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.INOSTRANCEVIA_LOOT_YOUNG;
		}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderInostrancevia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelInostrancevia;}
	public static float getScaler(@Nullable String variant) {return RenderInostrancevia.getScaler();}
	@Override
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_INOSTRANCEVIA;
	}
}