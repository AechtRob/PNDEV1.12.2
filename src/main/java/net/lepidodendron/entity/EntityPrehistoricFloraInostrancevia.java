...
import net.lepidodendron.item.entities.ItemEggsInostrancevia;
...
public class EntityPrehistoricFloraInostrancevia extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_inostrancevia";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsInostrancevia.block, 1);
	}
