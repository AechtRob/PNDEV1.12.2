...
public class EntityPrehistoricFloraAusktribosphenos extends EntityPrehistoricFloraDiictodon implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraAusktribosphenos(World world) {
		super(world);
		setSize(0.2F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AUSKTRIBOSPHENOS;
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AUSKTRIBOSPHENOS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAusktribosphenos.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAusktribosphenos;}
	public static float getScaler(@Nullable String variant) {return RenderAusktribosphenos.getScaler();}
