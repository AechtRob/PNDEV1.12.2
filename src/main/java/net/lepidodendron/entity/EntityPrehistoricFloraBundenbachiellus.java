...
public class EntityPrehistoricFloraBundenbachiellus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBundenbachiellus(World world) {
		super(world);
		setSize(0.25F, 0.15F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BUNDENBACHIELLUS;
	}
