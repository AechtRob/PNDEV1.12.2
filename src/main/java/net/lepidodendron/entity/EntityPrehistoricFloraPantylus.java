...
public class EntityPrehistoricFloraPantylus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraPantylus(World world) {
		super(world);
		setSize(0.35F, 0.20F);
		minWidth = 0.1F;
		maxWidth = 0.35F;
	...
	protected float getAISpeedSwimmingAmphibian() {
		...
		return Math.min(2.0F, (this.getAgeScale() * 2F)) * calcSpeed;
	}
	...
	public int WaterDist() {
		int i = (int) LepidodendronConfig.waterPantylus;
		if (i > 16) {i = 16;}
		if (i < 1) {i = 1;}
		return i;
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntityPrehistoricFloraLandClimbingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:pantylus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:pantylus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:pantylus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.PANTYLUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PANTYLUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PANTYLUS;
	}
}