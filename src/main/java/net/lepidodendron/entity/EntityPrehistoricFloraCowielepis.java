...
import net.lepidodendron.entity.render.entity.RenderCowielepis;
...
public class EntityPrehistoricFloraCowielepis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelCowielepis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderCowielepis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_COWIELEPIS;
	}
}
