...
import net.lepidodendron.entity.render.entity.RenderAetheretmon;
import net.lepidodendron.entity.render.entity.RenderAnderella;
...
public class EntityPrehistoricFloraAetheretmon extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAetheretmon(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAetheretmon.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAetheretmon;}
	public static float getScaler(@Nullable String variant) {return RenderAetheretmon.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.018F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AETHERETMON;
	}
}
