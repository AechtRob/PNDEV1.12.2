...
public class EntityPrehistoricFloraWilliamsaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWilliamsaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraWilliamsaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraWilliamsaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WILLIAMSASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WILLIAMSASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraWilliamsaspis EntityBase = EntityPrehistoricFloraWilliamsaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraWilliamsaspis.this);
		}
