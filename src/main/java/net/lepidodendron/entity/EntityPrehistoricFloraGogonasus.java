...
public class EntityPrehistoricFloraGogonasus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 0.23;}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGogonasus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGogonasus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GOGONASUS;
	}
}