...
public class EntityPrehistoricFloraAndiva extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAndiva(World world) {
		super(world, 40);
		setSize(0.2375F, 0.0875F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANDIVA;
	}
}