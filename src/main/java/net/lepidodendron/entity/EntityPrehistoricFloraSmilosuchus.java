...
public class EntityPrehistoricFloraSmilosuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableLand, ITrappableWater {
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SMILOSUCHUS;
	}
	@Nullable
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSmilosuchus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSmilosuchus.getScaler();
	}
}