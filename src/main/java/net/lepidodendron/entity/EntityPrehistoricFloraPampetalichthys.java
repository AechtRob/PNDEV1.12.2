...
public class EntityPrehistoricFloraPampetalichthys extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPampetalichthys(World world) {
		super(world);
		setSize(0.15F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.15F;
    ...
    public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
        return new EntityPrehistoricFloraPampetalichthys(this.world);
    }
	@Override
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAMPETALICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PAMPETALICHTHYS;
	}
