...
import net.lepidodendron.entity.render.entity.RenderTribodus;
...
public class EntityPrehistoricFloraTribodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTribodus(World world) {
		super(world);
		setSize(0.3F, 0.4F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TRIBODUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTribodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTribodus;}
	public static float getScaler(@Nullable String variant) {return RenderTribodus.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIBODUS;
	}
