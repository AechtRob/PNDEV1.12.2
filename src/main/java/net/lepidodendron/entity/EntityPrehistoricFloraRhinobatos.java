...
public class EntityPrehistoricFloraRhinobatos extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraRhinobatos(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraRhinobatos.SwimmingMoveHelperBase();
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RHINOBATOS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RHINOBATOS_LOOT;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraRhinobatos EntityBase = EntityPrehistoricFloraRhinobatos.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraRhinobatos.this);
		}
