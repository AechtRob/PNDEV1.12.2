...
public class EntityPrehistoricFloraMacromesodon extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraMacromesodon(World world) {
		super(world);
		setSize(0.5F, 0.5F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MACROMESODON_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMacromesodon;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderMacromesodon.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MACROMESODON;
	}
}
