...
import net.lepidodendron.item.entities.ItemBucketElrathia;
...
public class EntityPrehistoricFloraElrathia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ELRATHIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketElrathia.block, (int) (1));
