...
public class EntityPrehistoricFloraScheenstia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraScheenstia(World world) {
		super(world);
		setSize(0.5F, 0.5F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SCHEENSTIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCHEENSTIA;
	}
}
