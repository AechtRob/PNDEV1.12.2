...
import net.lepidodendron.entity.render.entity.RenderAustralichthys;
...
public class EntityPrehistoricFloraAustralichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAustralichthys(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AUSTRALICHTHYS_LOOT;
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.32;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAustralichthys.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAustralichthys;}
	public static float getScaler(@Nullable String variant) {return RenderAustralichthys.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.015F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AUSTRALICHTHYS;
	}
}
