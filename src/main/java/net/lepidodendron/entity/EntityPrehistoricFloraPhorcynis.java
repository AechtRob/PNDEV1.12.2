...
public class EntityPrehistoricFloraPhorcynis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater {
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_phorcynis_" + this.getPNType().getName() + ".name");
		}
	}
	...
	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraPhorcynis EntityBase = EntityPrehistoricFloraPhorcynis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraPhorcynis.this);
		}
