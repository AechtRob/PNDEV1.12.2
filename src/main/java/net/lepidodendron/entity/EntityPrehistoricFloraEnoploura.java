...
public class EntityPrehistoricFloraEnoploura extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraEnoploura(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemEchinodermEggsEnoploura.block, 1);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ENOPLOURA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ENOPLOURA;
	}
}
