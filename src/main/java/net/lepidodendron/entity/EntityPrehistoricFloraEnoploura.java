...
import net.lepidodendron.item.entities.ItemBucketEnoploura;
...
public class EntityPrehistoricFloraEnoploura extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEnoploura.block, (int) (1));
