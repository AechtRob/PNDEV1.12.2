...
public class EntityPrehistoricFloraBerthasaura extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraBerthasaura> Limusaurus = Functions.getEntitiesWithinAABBPN(this.world, EntityPrehistoricFloraBerthasaura.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)), EntitySelectors.NOT_SPECTATING);
			for (EntityPrehistoricFloraBerthasaura currentLimusaurus : Limusaurus) {
	...
	public boolean findGrappleTarget() {
		...
		List<EntityPrehistoricFloraBerthasaura> Limusaurus = Functions.getEntitiesWithinAABBPN(world, EntityPrehistoricFloraBerthasaura.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)), EntitySelectors.NOT_SPECTATING);
		for (EntityPrehistoricFloraBerthasaura currentLimusaurus : Limusaurus) {
