...
import net.lepidodendron.entity.render.entity.RenderHovasaurus;
...
public class EntityPrehistoricFloraHovasaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraHovasaurus(World world) {
		super(world);
		setSize(0.4F, 0.35F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(5, new AmphibianWander(this, NO_ANIMATION, 0.93, 80));
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntitySquid.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.HOVASAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.HOVASAURUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHovasaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHovasaurus.getScaler();
	}
