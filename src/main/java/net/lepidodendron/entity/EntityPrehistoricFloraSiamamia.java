...
public class EntityPrehistoricFloraSiamamia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSiamamia(World world) {
		super(world);
		setSize(0.4F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SIAMAMIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SIAMAMIA;
	}
