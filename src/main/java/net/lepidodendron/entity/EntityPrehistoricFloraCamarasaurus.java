...
public class EntityPrehistoricFloraCamarasaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter {
	private static final DataParameter<Boolean> JUVENILE = EntityDataManager.createKey(EntityPrehistoricFloraCamarasaurus.class, DataSerializers.BOOLEAN);
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:camarasaurus_roar"));
	}

	public SoundEvent getAmbientAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:camarasaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:camarasaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:camarasaurus_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAMARASAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CAMARASAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CAMARASAURUS_LOOT;
	}
