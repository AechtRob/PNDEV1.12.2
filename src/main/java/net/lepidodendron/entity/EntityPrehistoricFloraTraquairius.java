...
import net.lepidodendron.item.entities.ItemBucketTraquairius;
...
public class EntityPrehistoricFloraTraquairius extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketTraquairius.block, (int) (1));
