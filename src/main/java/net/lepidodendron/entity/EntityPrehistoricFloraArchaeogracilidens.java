...
import net.lepidodendron.entity.render.entity.RenderArchaeogracilidens;
...
public class EntityPrehistoricFloraArchaeogracilidens extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraArchaeogracilidens(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraArchaeogracilidens.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraArchaeogracilidens(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARCHAEOGRACILIDENS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCHAEOGRACILIDENS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraArchaeogracilidens EntityBase = EntityPrehistoricFloraArchaeogracilidens.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraArchaeogracilidens.this);
		}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderArchaeogracilidens.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelArchaeogracilidens;}
	public static float getScaler(@Nullable String variant) {return RenderArchaeogracilidens.getScaler();}
