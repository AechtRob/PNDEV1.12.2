...
import net.lepidodendron.entity.render.entity.RenderAdalatherium;
...
public class EntityPrehistoricFloraAdalatherium extends EntityPrehistoricFloraDiictodon implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAdalatherium(World world) {
		super(world);
		setSize(0.2F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ADALATHERIUM;
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAdalatherium(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ADALATHERIUM_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAdalatherium.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAdalatherium;}
	public static float getScaler(@Nullable String variant) {return RenderAdalatherium.getScaler();}
