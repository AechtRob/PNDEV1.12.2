...
public class EntityPrehistoricFloraYonghesuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraYonghesuchus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.15F;
		maxWidth = 0.3F;
		...
		STAND_ANIMATION = Animation.create(100);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.YONGHESUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_YONGHESUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
