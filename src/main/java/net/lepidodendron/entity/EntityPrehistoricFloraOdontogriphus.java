...
public class EntityPrehistoricFloraOdontogriphus extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraOdontogriphus(World world) {
		super(world, 26);
		setSize(0.3F, 0.2F);
	}
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.ALGAE, DietString.MICROBIAL);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ODONTOGRIPHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ODONTOGRIPHUS;
	}
}