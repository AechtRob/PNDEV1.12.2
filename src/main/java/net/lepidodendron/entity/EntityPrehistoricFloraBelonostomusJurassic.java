...
public class EntityPrehistoricFloraBelonostomusJurassic extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public static float getScaler(@Nullable String variant) {
		return RenderBelonostomusJurassic.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BELONOSTOMUS_JURASSIC;
	}
}
