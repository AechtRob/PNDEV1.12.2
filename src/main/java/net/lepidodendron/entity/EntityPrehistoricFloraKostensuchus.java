...
public class EntityPrehistoricFloraKostensuchus extends EntityPrehistoricFloraLandCarnivoreBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKostensuchus(World world) {
		super(world);
		setSize(0.95F, 1.3F);
		minWidth = 0.12F;
		maxWidth = 0.95F;
		...
		NOISE_ANIMATION = Animation.create(53);
		BASK_ANIMATION = Animation.create(600);
		YAWN_ANIMATION = Animation.create(78);
		ALERT_ANIMATION = Animation.create(154);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, NOISE_ANIMATION, YAWN_ANIMATION, BASK_ANIMATION, ALERT_ANIMATION};
	}

	@Override
	public boolean isAnimationDirectionLocked(Animation animation) {
		return animation == ROAR_ANIMATION //warning a player
			|| animation == BASK_ANIMATION
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KOSTENSUCHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KOSTENSUCHUS;
	}
}