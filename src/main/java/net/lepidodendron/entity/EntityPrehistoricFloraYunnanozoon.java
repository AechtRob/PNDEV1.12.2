...
import net.lepidodendron.item.entities.ItemBucketYunnanozoon;
...
public class EntityPrehistoricFloraYunnanozoon extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraYunnanozoon(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.YUNNANOZOON_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketYunnanozoon.block, (int) (1));
