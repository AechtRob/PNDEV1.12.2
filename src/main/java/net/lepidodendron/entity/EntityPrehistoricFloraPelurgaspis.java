...
import net.lepidodendron.item.entities.ItemBucketPelurgaspis;
...
public class EntityPrehistoricFloraPelurgaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPelurgaspis.block, (int) (1));
