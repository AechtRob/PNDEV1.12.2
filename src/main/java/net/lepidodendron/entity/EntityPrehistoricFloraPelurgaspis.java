...
public class EntityPrehistoricFloraPelurgaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	private static final DataParameter<Integer> BURYTICK = EntityDataManager.createKey(EntityPrehistoricFloraPelurgaspis.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BURIED = EntityDataManager.createKey(EntityPrehistoricFloraPelurgaspis.class, DataSerializers.BOOLEAN);

	private static final DataParameter<Integer> BURYCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraPelurgaspis.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIMCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraPelurgaspis.class, DataSerializers.VARINT);
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PELURGASPIS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PELURGASPIS_LOOT;
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.35;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPelurgaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPelurgaspis;}
	public static float getScaler(@Nullable String variant) {return RenderPelurgaspis.getScaler();}
}
