...
public class EntityPrehistoricFloraMeganeuropsisNymph extends EntityPrehistoricFloraEurypteridBase implements IAdvancementGranter, ITrappableWater {
	...
	{
		ResourceLocation name = EntityList.getKey(EntityPrehistoricFloraMeganeuropsis.class);
	...
	public void onEntityUpdate()
	{
		...
		if (this.getAgeScale() >= 0.99)
		{
			if (!(world.isRemote)) {
				...
				entity = ItemMonsterPlacer.spawnCreature(this.getEntityWorld(), EntityList.getKey(EntityPrehistoricFloraMeganeuropsis.class), (double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D);
