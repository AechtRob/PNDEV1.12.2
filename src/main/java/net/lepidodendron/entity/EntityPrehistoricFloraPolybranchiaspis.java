...
public class EntityPrehistoricFloraPolybranchiaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPolybranchiaspis(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.POLYBRANCHIASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelPolybranchiaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderPolybranchiaspis.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_POLYBRANCHIASPIS;
	}
}