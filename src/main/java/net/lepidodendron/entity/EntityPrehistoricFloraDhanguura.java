...
public class EntityPrehistoricFloraDhanguura extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDhanguura(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraDhanguura.SwimmingMoveHelperBase();
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDhanguura(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DHANGUURA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DHANGUURA;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraDhanguura EntityBase = EntityPrehistoricFloraDhanguura.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraDhanguura.this);
		}
