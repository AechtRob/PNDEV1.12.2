...
public class EntityPrehistoricFloraMecistotrachelos extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraMecistotrachelos(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.3F;
		maxWidth = 0.3F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MECISTOTRACHELOS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MECISTOTRACHELOS;
	}
}