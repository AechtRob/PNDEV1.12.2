...
import net.lepidodendron.item.entities.ItemBucketEricixerxes;
...
public class EntityPrehistoricFloraEricixerxes extends EntityPrehistoricFloraSwimmingAmphibianBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraEricixerxes(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	public int WaterDist() {
		int i = (int) LepidodendronConfig.waterEricixerxes;
		if (i > 16) {i = 16;}
		if (i < 1) {i = 1;}
		return i;
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ERICIXERXES_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEricixerxes.block, (int) (1));
