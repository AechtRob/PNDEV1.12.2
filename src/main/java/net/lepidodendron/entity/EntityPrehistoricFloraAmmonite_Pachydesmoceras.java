...
public class EntityPrehistoricFloraAmmonite_Pachydesmoceras extends EntityPrehistoricFloraNautiloidBase {
	...
	public void onEntityUpdate() {
		...
		if (!world.isRemote && this.isPFAdult() && this.getCanBreed() && LepidodendronConfig.doMultiplyMobs) {
			if (Math.random() > 0.5) {
				ItemStack itemstack = new ItemStack(ItemNautiloidEggsPachydesmoceras.block, (int) (1));
