...
public class EntityPrehistoricFloraLiaobatrachus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, IWaterSurfaceEggsAmphibian {
	...
	public EntityPrehistoricFloraLiaobatrachus(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.12F;
		maxWidth = 0.15F;
	...
	public String getEntityId(Entity entity) {
		return "lepidodendron:prehistoric_flora_tadpole@liaobatrachus";
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LIAOBATRACHUS_LOOT;
	}
...
//	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LIAOBATRACHUS;
	}
