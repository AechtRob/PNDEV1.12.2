...
public class EntityPrehistoricFloraEchinochimaera extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ECHINOCHIMAERA;
	}
