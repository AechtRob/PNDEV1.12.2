...
public class EntityPrehistoricFloraBurgessomedusa extends EntityPrehistoricFloraEoandromeda implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraBurgessomedusa(World world) {
        super(world);
        setSize(0.3F, 0.3F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_BURGESSOMEDUSA;
    }
