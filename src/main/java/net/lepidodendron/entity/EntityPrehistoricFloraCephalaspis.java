...
import net.lepidodendron.item.entities.ItemBucketCephalaspis;
...
public class EntityPrehistoricFloraCephalaspis extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraCephalaspis(World world) {
		super(world);
		setSize(0.6F, 0.5F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CEPHALASPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCephalaspis.block, (int) (1));
