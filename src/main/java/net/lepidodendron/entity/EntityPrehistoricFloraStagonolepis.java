...
public class EntityPrehistoricFloraStagonolepis extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_STAGONOLEPIS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.STAGONOLEPIS_LOOT_YOUNG;
		}
		return LepidodendronMod.STAGONOLEPIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelStagonolepis;}
	public static float getScaler(@Nullable String variant) {
		return RenderStagonolepis.getScaler();
	}
}