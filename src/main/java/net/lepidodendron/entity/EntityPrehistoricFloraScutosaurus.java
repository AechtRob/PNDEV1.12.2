...
import net.lepidodendron.item.entities.ItemEggsScutosaurus;
...
public class EntityPrehistoricFloraScutosaurus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_scutosaurus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsScutosaurus.block, 1);
	}
