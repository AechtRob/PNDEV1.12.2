...
public class EntityPrehistoricFloraGorgonichthys extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGorgonichthys(World world) {
		super(world);
		setSize(0.00F, 0.99F);
		minWidth = 0.2F;
		maxWidth = 0.99F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGorgonichthys(this.world);
	}
...
//	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GORGONICHTHYS;
	}
