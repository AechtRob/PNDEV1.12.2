...
import net.lepidodendron.entity.render.entity.RenderTeinolophos;
...
public class EntityPrehistoricFloraTeinolophos extends EntityPrehistoricFloraHaldanodon implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraTeinolophos(World world) {
		super(world);
		setSize(0.7F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.7F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TEINOLOPHOS;
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(8, new AmphibianWanderNotBound(this, NO_ANIMATION, 0.1, 90, 8));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TEINOLOPHOS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTeinolophos;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTeinolophos.getScaler();
	}
