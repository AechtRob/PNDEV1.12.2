...
public class EntityPrehistoricFloraCriocephalosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(8, new LandWanderHerd(this, 1.00D, Math.max(1F, this.width) * this.getNavigator().getPathSearchRange() * 0.75F, 25));
		tasks.addTask(9, new GrappleAI(this, 1.0D, false, this.getAttackLength(), this.getGrappleAnimation(), 0.75));
