...
public class EntityPrehistoricFloraErasipteroidesNymph extends EntityPrehistoricFloraEurypteridBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraErasipteroidesNymph(World world) {
		super(world);
		setSize(0.6F, 0.4F);
		minWidth = 0.085F;
		maxWidth = 0.6F;
	...
	{
		ResourceLocation name = EntityList.getKey(EntityPrehistoricFloraErasipteroides.class);
	...
	public void onEntityUpdate()
	{
		...
		if (this.getAgeScale() >= 0.99)
		{
			if (!(world.isRemote)) {
				...
				entity = ItemMonsterPlacer.spawnCreature(this.getEntityWorld(), EntityList.getKey(EntityPrehistoricFloraErasipteroides.class), (double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D);
