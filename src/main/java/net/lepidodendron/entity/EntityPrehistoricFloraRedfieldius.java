...
public class EntityPrehistoricFloraRedfieldius extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraRedfieldius(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.REDFIELDIUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelRedfieldius;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderRedfieldius.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_REDFIELDIUS;
	}
}
