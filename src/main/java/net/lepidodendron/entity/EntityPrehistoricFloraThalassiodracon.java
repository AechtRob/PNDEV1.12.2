...
import net.lepidodendron.entity.render.entity.RenderThalassiodracon;
...
public class EntityPrehistoricFloraThalassiodracon extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelThalassiodracon;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderThalassiodracon.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THALASSIODRACON;
	}
}
