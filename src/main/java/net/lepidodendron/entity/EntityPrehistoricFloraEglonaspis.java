...
import net.lepidodendron.item.entities.ItemBucketEglonaspis;
...
public class EntityPrehistoricFloraEglonaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEglonaspis.block, (int) (1));
