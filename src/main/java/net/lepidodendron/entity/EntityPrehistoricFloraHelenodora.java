...
public class EntityPrehistoricFloraHelenodora extends EntityPrehistoricFloraLandSlitheringBase implements IAdvancementGranter, ITrappableAir {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HELENODORA;
	}
}