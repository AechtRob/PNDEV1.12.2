...
public class EntityPrehistoricFloraTrigonotarbid_Cryptomartus extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTrigonotarbid_Cryptomartus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTrigonotarbid_Cryptomartus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIGONOTARBID_CRYPTOMARTUS;
	}
}