...
public class EntityPrehistoricFloraEichstaettisaurus extends EntityPrehistoricFloraLandClimbingBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraEichstaettisaurus(World world) {
		super(world);
		setSize(0.30F, 0.25F);
		minWidth = 0.10F;
		maxWidth = 0.30F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(5, new LandWanderAvoidWaterClimbingAI(this, 1.0D, 5));
	...
	public void applyEntityCollision(Entity entityIn) {
		...
		if (!(entityIn instanceof EntityPrehistoricFloraEichstaettisaurus)) {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EICHSTAETTISAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EICHSTAETTISAURUS;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderEichstaettisaurus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelEichstaettisaurus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderEichstaettisaurus.getScaler();
    }
