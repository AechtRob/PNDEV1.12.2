...
public class EntityPrehistoricFloraArctinurus extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraArctinurus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARCTINURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARCTINURUS;
	}
}