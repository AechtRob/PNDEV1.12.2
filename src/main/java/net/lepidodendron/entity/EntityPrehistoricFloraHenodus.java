...
public class EntityPrehistoricFloraHenodus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {
	...
	//Rendering taxidermy:
	//--------------------
	public static double offsetPlinth() { return 0.72; }
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHenodus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHenodus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HENODUS;
	}
}