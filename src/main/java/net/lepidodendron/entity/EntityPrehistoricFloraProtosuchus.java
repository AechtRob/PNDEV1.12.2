...
public class EntityPrehistoricFloraProtosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraProtosuchus(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		minWidth = 0.15F;
		maxWidth = 0.5F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PROTOSUCHUS_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROTOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
