...
public class EntityPrehistoricFloraGlacialisaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
...
//TODO make override so noise cant play at the same time as idles
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGlacialisaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGlacialisaurus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GLACIALISAURUS;
	}
}