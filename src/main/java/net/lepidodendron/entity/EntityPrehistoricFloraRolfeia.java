...
import net.lepidodendron.entity.render.entity.RenderRolfeia;
...
public class EntityPrehistoricFloraRolfeia extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraRolfeia(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRolfeia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelRolfeia;}
	public static float getScaler(@Nullable String variant) {return RenderRolfeia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ROLFEIA;
	}
}