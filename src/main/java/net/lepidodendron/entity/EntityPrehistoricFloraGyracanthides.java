...
public class EntityPrehistoricFloraGyracanthides extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraGyracanthides(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GYRACANTHIDES_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGyracanthides;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGyracanthides.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GYRACANTHIDES;
	}
