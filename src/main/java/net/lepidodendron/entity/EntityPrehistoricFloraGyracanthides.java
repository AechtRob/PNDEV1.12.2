...
import net.lepidodendron.item.entities.ItemBucketGyracanthides;
...
public class EntityPrehistoricFloraGyracanthides extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketGyracanthides.block, (int) (1));
