...
public class EntityPrehistoricFloraValdosaurus extends EntityPrehistoricFloraLandBase implements IScreamer, IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraValdosaurus(World world) {
		super(world);
		setSize(0.7F, 1.3F);
		minWidth = 0.12F;
		maxWidth = 0.7F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VALDOSAURUS;
	}
	...
	public void onLivingUpdate() {
		...
		if (this.getAnimation() == NO_ANIMATION && this.rand.nextInt(1000) == 0) {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.VALDOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.VALDOSAURUS_LOOT;
	}
