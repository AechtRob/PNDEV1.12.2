...
public class EntityPrehistoricFloraNotobatrachus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, IWaterSurfaceEggsAmphibian {
	...
	public EntityPrehistoricFloraNotobatrachus(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.12F;
		maxWidth = 0.15F;
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:notobatrachus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:notobatrachus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:notobatrachus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NOTOBATRACHUS_LOOT;
	}
...
//	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NOTOBATRACHUS;
	}
