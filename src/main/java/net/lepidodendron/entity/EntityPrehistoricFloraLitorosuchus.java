...
public class EntityPrehistoricFloraLitorosuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraLitorosuchus(World world) {
		super(world);
		setSize(0.8F, 0.85F);
		minWidth = 0.1F;
		maxWidth = 0.5F;
		...
		STAND_ANIMATION = Animation.create(20);
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LITOROSUCHUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LITOROSUCHUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
