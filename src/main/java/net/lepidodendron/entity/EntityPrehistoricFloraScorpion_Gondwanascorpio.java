...
public class EntityPrehistoricFloraScorpion_Gondwanascorpio extends EntityPrehistoricFloraScorpion implements IAdvancementGranter, ITrappableAir {
	...
	public static float getScaler(@Nullable String variant) {
		return RenderScorpion_Gondwanascorpio.getScaler();
	}
	@SideOnly(Side.CLIENT)
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCORPION_GONDWANASCORPIO;
	}
	//-------------------
