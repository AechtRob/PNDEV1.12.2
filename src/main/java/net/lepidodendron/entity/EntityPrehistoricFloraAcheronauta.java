...
public class EntityPrehistoricFloraAcheronauta extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAcheronauta(World world) {
		super(world);
		setSize(0.25F, 0.25F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ACHERONAUTA_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ACHERONAUTA;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAcheronauta;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAcheronauta.getScaler();
	}
