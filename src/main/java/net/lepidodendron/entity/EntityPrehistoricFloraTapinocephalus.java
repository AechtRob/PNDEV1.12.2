...
public class EntityPrehistoricFloraTapinocephalus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAPINOCEPHALUS;
	}
}