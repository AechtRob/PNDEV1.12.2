...
public class EntityPrehistoricFloraChotecops extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraChotecops(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CHOTECOPS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CHOTECOPS;
	}
}