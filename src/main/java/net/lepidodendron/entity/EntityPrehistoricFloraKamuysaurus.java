...
public class EntityPrehistoricFloraKamuysaurus extends EntityPrehistoricFloraBiQuadLandBase implements IScreamer, IAdvancementGranter, IBluffer, ITrappableLand {
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			this.setBipedal();
			List<EntityPrehistoricFloraKamuysaurus> Kamuysaurus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraKamuysaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraKamuysaurus currentKamuysaurus : Kamuysaurus) {
...
//	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:kamuysaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:kamuysaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:kamuysaurus_death"));
	}
	...
	public void onLivingUpdate() {
		...
		if ((!this.world.isRemote) && this.getAnimation() == ROAR_ANIMATION && this.getWarnTarget() != null
			...
			List<EntityPrehistoricFloraKamuysaurus> Camptosaurus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraKamuysaurus.class, new AxisAlignedBB(this.getPosition().add(-12, -6, -12), this.getPosition().add(12, 6, 12)));
			for (EntityPrehistoricFloraKamuysaurus currentCamptosaurus : Camptosaurus) {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.KAMUYSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.KAMUYSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KAMUYSAURUS;
	}
