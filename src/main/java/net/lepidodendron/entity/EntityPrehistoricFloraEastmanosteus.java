...
public class EntityPrehistoricFloraEastmanosteus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraEastmanosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.EASTMANOSTEUS_LOOT_YOUNG;
		}
		return LepidodendronMod.EASTMANOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EASTMANOSTEUS;
	}
}
