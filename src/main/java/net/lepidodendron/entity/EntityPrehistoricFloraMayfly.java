...
import net.lepidodendron.entity.render.entity.RenderMayfly;
...
//	}
	...
	public static double offsetCaseMagnified(@Nullable String variant) { return 0.54; }
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderMayfly.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelMayfly;}
	public static float getScaler(@Nullable String variant) {
		return RenderMayfly.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderMayfly.getScaler() * 3.2F;
	}
