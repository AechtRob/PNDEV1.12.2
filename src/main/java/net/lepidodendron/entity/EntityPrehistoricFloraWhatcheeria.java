...
public class EntityPrehistoricFloraWhatcheeria extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WHATCHEERIA;
	}
}