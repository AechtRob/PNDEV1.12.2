...
public class EntityPrehistoricFloraTanaocrossus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTanaocrossus(World world) {
		super(world);
		setSize(0.22F, 0.19F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TANAOCROSSUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TANAOCROSSUS;
	}
