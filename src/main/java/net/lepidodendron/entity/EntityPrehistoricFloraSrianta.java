...
import net.lepidodendron.entity.render.entity.RenderSrianta;
...
public class EntityPrehistoricFloraSrianta extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSrianta(World world) {
		super(world);
		setSize(0.2F, 0.275F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SRIANTA_LOOT;
	}
	...
	public static double lowerfrontlineoffset(@Nullable String variant) {return -0.00;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSrianta.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSrianta;}
	public static float getScaler(@Nullable String variant) {return RenderSrianta.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SRIANTA;
	}
