...
public class EntityPrehistoricFloraPanderodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PANDERODUS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PANDERODUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPanderodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPanderodus;}
	public static float getScaler(@Nullable String variant) {return RenderPanderodus.getScaler();}
