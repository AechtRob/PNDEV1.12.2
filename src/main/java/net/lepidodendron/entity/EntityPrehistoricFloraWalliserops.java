...
import net.lepidodendron.item.entities.ItemBucketWalliserops;
...
public class EntityPrehistoricFloraWalliserops extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraWalliserops(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WALLISEROPS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketWalliserops.block, (int) (1));
