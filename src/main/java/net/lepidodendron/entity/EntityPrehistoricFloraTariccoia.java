...
import net.lepidodendron.entity.render.entity.RenderTariccoia;
...
public class EntityPrehistoricFloraTariccoia extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTariccoia(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TARICCOIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTariccoia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTariccoia;}
	public static float getScaler(@Nullable String variant) {return RenderTariccoia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TARICCOIA;
	}
}