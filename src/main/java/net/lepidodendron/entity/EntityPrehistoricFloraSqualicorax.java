...
public class EntityPrehistoricFloraSqualicorax extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraSqualicorax(World world) {
		super(world);
		setSize(1F, 1F);
		minWidth = 0.1F;
		maxWidth = 1F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.SQUALICORAX_LOOT_YOUNG;
		}
		return LepidodendronMod.SQUALICORAX_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SQUALICORAX;
	}
}
