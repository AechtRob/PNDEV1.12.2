...
public class EntityPrehistoricFloraHypsilophodon extends EntityPrehistoricFloraLandBase implements IScreamer, INervous, IAdvancementGranter, ITrappableLand {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(10, new LandWanderHerd(this, 1.00D, Math.max(1F, this.width) * this.getNavigator().getPathSearchRange() * 0.75F));
		tasks.addTask(11, new LandWanderAvoidWaterAI(this, 1.0D, 60));
		tasks.addTask(12, new EntityWatchClosestAI(this, EntityPlayer.class, 6.0F));
		tasks.addTask(13, new EntityWatchClosestAI(this, EntityPrehistoricFloraAgeableBase.class, 8.0F));
