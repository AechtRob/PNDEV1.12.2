...
public class EntityPrehistoricFloraBertratis extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraBertratis(World world) {
        super(world);
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_BERTRATIS;
    }
