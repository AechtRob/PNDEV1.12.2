...
public class EntityPrehistoricFloraNoripterus extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, IScreamerFlier, ITrappableLand {
	...
	public EntityPrehistoricFloraNoripterus(World world) {
		super(world);
		setSize(0.85F, 0.5F);
		minWidth = 0.10F;
		maxWidth = 0.85F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase && this.hasAlarm() && !this.world.isRemote) {
			...
			List<EntityPrehistoricFloraNoripterus> noripterus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraNoripterus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraNoripterus currentNoripterus : noripterus) {
				currentNoripterus.setAnimation(NO_ANIMATION);
				currentNoripterus.setAlarmTarget(ee);
				currentNoripterus.setRevengeTarget(ee);
				currentNoripterus.screamAlarmCooldown = rand.nextInt(20);
				currentNoripterus.setFlying();
			}
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NORIPTERUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NORIPTERUS_LOOT;
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:noripterus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:noripterus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:noripterus_death"));
	}

	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:noripterus_alarm"));
	}

	public SoundEvent getDisplaySound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:noripterus_display"));
	}
