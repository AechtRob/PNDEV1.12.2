...
public class EntityPrehistoricFloraPalaeodictyoptera_Sinodunbaria extends EntityPrehistoricFloraInsectFlyingBase {
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.PALAEODICTYOPTERA_SINODUNBARIA_LOOT_JAR;
