...
public class EntityPrehistoricFloraMenaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraMenaspis(World world) {
		super(world);
		setSize(0.35F, 0.3F);
	}
	...
	public static float getScaler(@Nullable String variant) {return RenderMenaspis.getScaler();}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MENASPIS;
	}
}
