...
import net.lepidodendron.item.entities.ItemBucketMenaspis;
...
public class EntityPrehistoricFloraMenaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketMenaspis.block, (int) (1));
