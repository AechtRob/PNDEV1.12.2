...
import net.lepidodendron.item.entities.ItemBucketLunaspis;
...
public class EntityPrehistoricFloraLunaspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketLunaspis.block, (int) (1));
