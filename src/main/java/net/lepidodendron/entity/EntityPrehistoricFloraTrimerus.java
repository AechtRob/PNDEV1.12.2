...
import net.lepidodendron.item.entities.ItemBucketTrimerus;
...
public class EntityPrehistoricFloraTrimerus extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketTrimerus.block, (int) (1));
