...
public class EntityPrehistoricFloraAmmonite_Dactylioceras extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Boolean> SWIMMINGPN = EntityDataManager.createKey(EntityPrehistoricFloraAmmonite_Dactylioceras.class, DataSerializers.BOOLEAN);
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AMMONITE_DACTYLIOCERAS;
	}
