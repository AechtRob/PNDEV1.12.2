...
public class EntityPrehistoricFloraAmmonite_Dactylioceras extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsDactylioceras.block, (int) (1));
	}
