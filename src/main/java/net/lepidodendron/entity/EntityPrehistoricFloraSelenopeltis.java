...
public class EntityPrehistoricFloraSelenopeltis extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSelenopeltis(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SELENOPELTIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSelenopeltis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSelenopeltis;}
	public static float getScaler(@Nullable String variant) {return RenderSelenopeltis.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SELENOPELTIS;
	}
}