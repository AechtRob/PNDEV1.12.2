...
public class EntityPrehistoricFloraKeretsa extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKeretsa(World world) {
		super(world, 40);
		setSize(0.1425F, 0.0525F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KERETSA;
	}
}