...
import net.lepidodendron.item.entities.ItemBucketJanassa;
...
public class EntityPrehistoricFloraJanassa extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketJanassa.block, (int) (1));
