...
public class EntityPrehistoricFloraJanassa extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraJanassa(World world) {
		super(world);
		setSize(0.7F, 0.5F);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelJanassa;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderJanassa.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JANASSA;
	}
