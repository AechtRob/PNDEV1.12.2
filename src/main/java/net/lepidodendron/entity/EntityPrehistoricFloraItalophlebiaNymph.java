...
public class EntityPrehistoricFloraItalophlebiaNymph extends EntityPrehistoricFloraEurypteridBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraItalophlebiaNymph(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.05F;
		maxWidth = 0.2F;
	...
	public void onEntityUpdate()
	{
		...
		if (this.getAgeScale() >= 0.99)
		{
			if (!(world.isRemote)) {
				...
				entity = ItemMonsterPlacer.spawnCreature(this.getEntityWorld(), EntityList.getKey(EntityPrehistoricFloraItalophlebia.class), (double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D);
