...
public class EntityPrehistoricFloraAragochersis extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAragochersis(World world) {
		super(world);
		setSize(0.6F, 0.45F);
		minWidth = 0.2F;
		maxWidth = 0.6F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARAGOCHERSIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARAGOCHERSIS;
	}
}