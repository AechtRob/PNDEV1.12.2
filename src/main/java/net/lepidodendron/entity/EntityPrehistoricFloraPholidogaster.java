...
import net.lepidodendron.entity.render.entity.RenderPholidogaster;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.PHOLIDOGASTER_LOOT_YOUNG;
		}
		return LepidodendronMod.PHOLIDOGASTER_LOOT;
	}
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 0.17;}
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.1;}
	public static double lowerfrontlineoffset(@Nullable String variant) {return -0.055;}
	public static double lowerfrontlineoffsetperpendiular(@Nullable String variant) {return 0.25;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPholidogaster.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPholidogaster;}
	public static float getScaler(@Nullable String variant) {return RenderPholidogaster.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHOLIDOGASTER;
	}
