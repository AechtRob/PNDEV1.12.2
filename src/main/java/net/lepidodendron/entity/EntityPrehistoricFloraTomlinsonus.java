...
public class EntityPrehistoricFloraTomlinsonus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTomlinsonus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TOMLINSONUS_LOOT;
	}
	...
	public static double upperbackverticallinedepth(@Nullable String variant) {return 0.4F;}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTomlinsonus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTomlinsonus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TOMLINSONUS;
	}
}