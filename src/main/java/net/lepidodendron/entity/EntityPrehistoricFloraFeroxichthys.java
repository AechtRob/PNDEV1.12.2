...
import net.lepidodendron.item.entities.ItemBucketFeroxichthys;
...
public class EntityPrehistoricFloraFeroxichthys extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketFeroxichthys.block, (int) (1));
