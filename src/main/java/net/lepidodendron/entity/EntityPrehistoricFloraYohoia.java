...
import net.lepidodendron.item.entities.ItemBucketYohoia;
...
public class EntityPrehistoricFloraYohoia extends EntityPrehistoricFloraTrilobiteSwimBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketYohoia.block, (int) (1));
