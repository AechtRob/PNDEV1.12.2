...
public class EntityPrehistoricFloraYohoia extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter {
	...
	public EntityPrehistoricFloraYohoia(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_YOHOIA;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.YOHOIA_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderYohoia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelYohoia;}
	public static float getScaler(@Nullable String variant) {return RenderYohoia.getScaler();}
