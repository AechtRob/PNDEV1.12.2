...
public class EntityPrehistoricFloraOmeisaurus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraOmeisaurus(World world) {
		super(world);
		setSize(3.0F, 4.5F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:omeisaurus_idle"));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:omeisaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:omeisaurus_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OMEISAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.OMEISAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.OMEISAURUS_LOOT;
	}
