...
public class EntityPrehistoricFloraGigamachilis extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraGigamachilis(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
