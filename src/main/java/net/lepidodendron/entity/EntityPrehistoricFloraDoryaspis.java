...
public class EntityPrehistoricFloraDoryaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDoryaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderDoryaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DORYASPIS;
	}
