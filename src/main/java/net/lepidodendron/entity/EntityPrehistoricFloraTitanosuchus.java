...
import net.lepidodendron.item.entities.ItemEggsTitanosuchus;
...
public class EntityPrehistoricFloraTitanosuchus extends EntityPrehistoricFloraLandBase {
	...
	public EntityPrehistoricFloraTitanosuchus(World world) {
		super(world);
		//setSize(0.6F, 0.35F);
		experienceValue = 0;
	...
	public String tagEgg() {
		return "eggs_titanosuchus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsTitanosuchus.block, 1);
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:titanosuchus_roar"));
	}

	public SoundEvent getAmbientAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:titanosuchus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:titanosuchus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:titanosuchus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TITANOSUCHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.TITANOSUCHUS_LOOT;
	}
