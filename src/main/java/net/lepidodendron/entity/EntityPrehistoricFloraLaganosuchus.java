...
public class EntityPrehistoricFloraLaganosuchus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraLaganosuchus(World world) {
		super(world);
		setSize(0.7F, 0.5F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
		...
		BASK_ANIMATION = Animation.create(560);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, MAKE_NEST_ANIMATION, BASK_ANIMATION};
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraLaganosuchus(this.world);
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LAGANOSUCHUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LAGANOSUCHUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
