...
import net.lepidodendron.entity.render.entity.RenderTambatitanis;
...
public class EntityPrehistoricFloraTambatitanis extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraTambatitanis(World world) {
		super(world);
		setSize(1.8F, 2.7F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAMBATITANIS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TAMBATITANIS_LOOT_YOUNG;
		}
		return LepidodendronMod.TAMBATITANIS_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderTambatitanis.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelTambatitanis;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderTambatitanis.getScaler();
    }
