...
import net.lepidodendron.item.entities.ItemBucketOrthrozanclus;
...
public class EntityPrehistoricFloraOrthrozanclus extends EntityPrehistoricFloraSlitheringWaterBase {
	...
	public EntityPrehistoricFloraOrthrozanclus(World world) {
		super(world, 20);
		setSize(0.12F, 0.12F);
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketOrthrozanclus.block, (int) (1));
