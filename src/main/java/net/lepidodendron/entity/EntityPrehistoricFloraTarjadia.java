...
public class EntityPrehistoricFloraTarjadia extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTarjadia(World world) {
		super(world);
		setSize(0.85F, 0.8F);
		minWidth = 0.15F;
		maxWidth = 0.85F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TARJADIA_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TARJADIA;
	}
	//Rendering taxidermy:
	//--------------------
