...
import net.lepidodendron.entity.render.entity.RenderCladocyclus;
import net.lepidodendron.entity.render.entity.RenderWenzichthys;
...
public class EntityPrehistoricFloraWenzichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWenzichthys(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WENZICHTHYS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderWenzichthys.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelWenzichthys;}
	public static float getScaler(@Nullable String variant) {return RenderWenzichthys.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WENZICHTHYS;
	}
}
