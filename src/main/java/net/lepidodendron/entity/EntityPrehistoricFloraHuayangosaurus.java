...
public class EntityPrehistoricFloraHuayangosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraHuayangosaurus(World world) {
		super(world);
		setSize(1.8F, 1.5F);
		minWidth = 0.3F;
		maxWidth = 1.8F;
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(ArrayUtils.addAll(DietString.PLANTS, DietString.FRUIT), DietString.FRUIT);
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.HUAYANGOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.HUAYANGOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HUAYANGOSAURUS;
	}
}