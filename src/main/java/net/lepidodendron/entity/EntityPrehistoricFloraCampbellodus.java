...
public class EntityPrehistoricFloraCampbellodus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelCampbellodus;}
	public static float getScaler(@Nullable String variant) {
		return RenderCampbellodus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CAMPBELLODUS;
	}
}
