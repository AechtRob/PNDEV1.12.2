...
import net.lepidodendron.item.entities.ItemBucketCampbellodus;
...
public class EntityPrehistoricFloraCampbellodus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCampbellodus.block, (int) (1));
