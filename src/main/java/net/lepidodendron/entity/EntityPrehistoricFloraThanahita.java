...
public class EntityPrehistoricFloraThanahita extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraThanahita.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraThanahita(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.THANAHITA_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelThanahita;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderThanahita.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THANAHITA;
	}
}