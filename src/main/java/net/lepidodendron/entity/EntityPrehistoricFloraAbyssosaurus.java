...
public class EntityPrehistoricFloraAbyssosaurus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraAbyssosaurus(World world) {
		super(world);
		setSize(2F, 0.9F);
		minWidth = 0.1F;
		maxWidth = 2F;
		maxHeight = 0.9F;
		maxHealthAgeable = 55.00;
	...
	public AxisAlignedBB getRenderBoundingBox() {
		if (LepidodendronConfig.renderBigMobsProperly && (this.maxWidth * this.getAgeScale()) > 1F) {
			return this.getEntityBoundingBox().grow(5.0, 5.00, 5.0);
		}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.ABYSSOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ABYSSOSAURUS_LOOT;
	}

	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAbyssosaurus(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ABYSSOSAURUS;
	}
}
