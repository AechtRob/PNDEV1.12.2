...
public class EntityPrehistoricFloraRostropycnodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraRostropycnodus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ROSTROPYCNODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ROSTROPYCNODUS;
	}
