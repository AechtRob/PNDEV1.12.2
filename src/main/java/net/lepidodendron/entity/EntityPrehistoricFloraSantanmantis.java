...
public class EntityPrehistoricFloraSantanmantis extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSantanmantis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSantanmantis;}
	public static float getScaler(@Nullable String variant) {
		return RenderSantanmantis.getScaler();
	}
