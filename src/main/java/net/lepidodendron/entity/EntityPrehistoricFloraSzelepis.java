...
public class EntityPrehistoricFloraSzelepis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSzelepis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraSzelepis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraSzelepis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SZELEPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SZELEPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraSzelepis EntityBase = EntityPrehistoricFloraSzelepis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraSzelepis.this);
		}
