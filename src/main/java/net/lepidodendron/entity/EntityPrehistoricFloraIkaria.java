...
public class EntityPrehistoricFloraIkaria extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraIkaria(World world) {
		super(world, 40);
		setSize(0.65F, 0.25F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_IKARIA;
	}
}