...
public class EntityPrehistoricFloraPapilionichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraPapilionichthys(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAPILIONICHTHYS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelPapilionichthys;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderPapilionichthys.getScaler();
	}
}