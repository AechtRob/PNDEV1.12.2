...
import net.lepidodendron.entity.render.entity.RenderNaraoia_spinosa;
...
public class EntityPrehistoricFloraNaraoia_spinosa extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNaraoia_spinosa(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NARAOIA_SPINOSA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NARAOIA_SPINOSA;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderNaraoia_spinosa.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelNaraoia_spinosa;}
	public static float getScaler(@Nullable String variant) {return RenderNaraoia_spinosa.getScaler();}
