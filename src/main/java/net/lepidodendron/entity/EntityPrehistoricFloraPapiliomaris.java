...
public class EntityPrehistoricFloraPapiliomaris extends EntityPrehistoricFloraFishBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraPapiliomaris(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAPILIOMARIS_LOOT;
	}
}