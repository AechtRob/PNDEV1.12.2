...
public class EntityPrehistoricFloraParacestracion extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraParacestracion(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraParacestracion.SwimmingMoveHelperBase();
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARACESTRACION_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARACESTRACION;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraParacestracion EntityBase = EntityPrehistoricFloraParacestracion.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraParacestracion.this);
		}
	...
	public static double lowerfrontlineoffset(@Nullable String variant) {return -0.04;}
