...
public class EntityPrehistoricFloraAetosauroides extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	private static final DataParameter<Integer> AETOSAUROIDES_TYPE = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraAetosauroides.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraAetosauroides(World world) {
		super(world);
		setSize(0.82F, 1.05F);
		minWidth = 0.18F;
		maxWidth = 0.82F;
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(AETOSAUROIDES_TYPE, 0);
	}
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraAetosauroides)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraAetosauroides.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraAetosauroides.Type getTypeFromString(String nameIn)
		{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraAetosauroides.Type.byId(rand.nextInt(EntityPrehistoricFloraAetosauroides.Type.values().length) + 1));
		return livingdata;
	}

	public void setPNType(EntityPrehistoricFloraAetosauroides.Type type)
	{
		this.dataManager.set(AETOSAUROIDES_TYPE, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraAetosauroides.Type getPNType()
	{
		return EntityPrehistoricFloraAetosauroides.Type.byId(((Integer)this.dataManager.get(AETOSAUROIDES_TYPE)).intValue());
	}
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		{
			this.setPNType(EntityPrehistoricFloraAetosauroides.Type.getTypeFromString(compound.getString("PNType")));
		}
	}
	...
	protected ResourceLocation getLootTable() {
		switch (this.getPNType()) {
			case MALE:
			default:
				return LepidodendronMod.AETOSAUROIDES_LOOT;

			case FEMALE:
				return LepidodendronMod.AETOSAUROIDES_LOOT_F;
		}
	}
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.PLANTS, DietString.MEAT);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AETOSAUROIDES;
	}
