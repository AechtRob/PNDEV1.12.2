...
import net.lepidodendron.item.entities.ItemCoelostylina;
...
public class EntityPrehistoricFloraCoelostylina extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraCoelostylina(World world) {
		super(world, 26);
		setSize(0.2F, 0.185F);
	}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemCoelostylina.block, (int) (1)));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_COELOSTYLINA;
	}
