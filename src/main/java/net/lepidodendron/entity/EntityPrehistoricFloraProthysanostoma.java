...
public class EntityPrehistoricFloraProthysanostoma extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraProthysanostoma(World world) {
        super(world);
        setSize(0.1F, 0.2F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_PROTHYSANOSTOMA;
    }
