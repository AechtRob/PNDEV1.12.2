...
import net.lepidodendron.entity.render.entity.RenderNicrosaurus;
...
public class EntityPrehistoricFloraNicrosaurus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNicrosaurus(World world) {
		super(world);
		setSize(0.85F, 0.7F);
		minWidth = 0.12F;
		maxWidth = 0.85F;
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.NICROSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.NICROSAURUS_LOOT;
	}
	...
	public static double lowerbacklineoffsetperpendiular(@Nullable String variant) {return 0.9;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderNicrosaurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelNicrosaurus;}
	public static float getScaler(@Nullable String variant) {return RenderNicrosaurus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.05F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NICROSAURUS;
	}
}