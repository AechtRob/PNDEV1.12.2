...
import net.lepidodendron.entity.render.entity.RenderLiaoningotitan;
...
public class EntityPrehistoricFloraLiaoningotitan extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraLiaoningotitan(World world) {
		super(world);
		setSize(1.8F, 2.7F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LIAONINGOTITAN;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.LIAONINGOTITAN_LOOT_YOUNG;
		}
		return LepidodendronMod.LIAONINGOTITAN_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderLiaoningotitan.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelLiaoningotitan;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderLiaoningotitan.getScaler();
    }
