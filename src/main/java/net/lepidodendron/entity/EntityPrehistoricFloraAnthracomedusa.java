...
import net.lepidodendron.item.entities.ItemBucketAnthracomedusa;
...
public class EntityPrehistoricFloraAnthracomedusa extends EntityPrehistoricFloraJellyfishBase {
    ...
    public EntityPrehistoricFloraAnthracomedusa(World world) {
        super(world);
        setSize(0.6F, 0.35F);
        experienceValue = 0;
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketAnthracomedusa.block, (int) (1));
