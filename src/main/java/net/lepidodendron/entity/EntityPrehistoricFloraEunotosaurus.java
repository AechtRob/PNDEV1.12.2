...
public class EntityPrehistoricFloraEunotosaurus extends EntityPrehistoricFloraDiictodon implements ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraEunotosaurus(World world) {
		super(world);
		setSize(0.4F, 0.2F);
		minWidth = 0.18F;
		maxWidth = 0.5F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(7, new LandWanderNestInBlockAI(this));
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:eunotosaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:eunotosaurus_hurt"));
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelEunotosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderEunotosaurus.getScaler();
	}
