...
import net.lepidodendron.entity.render.entity.RenderGlacialisaurus;
import net.lepidodendron.entity.render.entity.RenderLufengosaurus;
...
public class EntityPrehistoricFloraLufengosaurus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraLufengosaurus(World world) {
		super(world);
		setSize(0.9F, 1.8F);
		minWidth = 0.18F;
		maxWidth = 0.9F;
		...
		STAND_ANIMATION = Animation.create(162);
...
//TODO make override so noise cant play at the same time as idles
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.LUFENGOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.LUFENGOSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LUFENGOSAURUS;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderLufengosaurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelLufengosaurus;}
	public static float getScaler(@Nullable String variant) {
		return RenderLufengosaurus.getScaler();
	}
