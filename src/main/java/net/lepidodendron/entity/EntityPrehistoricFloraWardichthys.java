...
public class EntityPrehistoricFloraWardichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWardichthys(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
