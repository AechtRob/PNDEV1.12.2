...
import net.lepidodendron.item.entities.ItemBucketCanadia;
...
public class EntityPrehistoricFloraCanadia extends EntityPrehistoricFloraEurypteridBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCanadia.block, (int) (1));
