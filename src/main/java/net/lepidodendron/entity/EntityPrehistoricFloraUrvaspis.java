...
public class EntityPrehistoricFloraUrvaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraUrvaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraUrvaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraUrvaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.URVASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_URVASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraUrvaspis EntityBase = EntityPrehistoricFloraUrvaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraUrvaspis.this);
		}
