...
public class EntityPrehistoricFloraUktenadactylus extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, IScreamerFlier, ITrappableLand {

	private boolean screaming;
	public int screamAlarmCooldown;
	public int standCooldown;

	public EntityPrehistoricFloraUktenadactylus(World world) {
		super(world);
		setSize(0.65F, 0.85F);
		minWidth = 0.10F;
		maxWidth = 0.65F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase && this.hasAlarm() && !this.world.isRemote) {
			...
			List<EntityPrehistoricFloraUktenadactylus> anhanguera = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraUktenadactylus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraUktenadactylus currentTapejara : anhanguera) {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_UKTENADACTYLUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.UKTENADACTYLUS_LOOT_YOUNG;
		}
		return LepidodendronMod.UKTENADACTYLUS_LOOT;
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:uktenadactylus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:uktenadactylus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:uktenadactylus_death"));
	}

	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:uktenadactylus_alarm"));
	}
