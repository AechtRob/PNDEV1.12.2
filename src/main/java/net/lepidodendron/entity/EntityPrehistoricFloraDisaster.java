...
public class EntityPrehistoricFloraDisaster extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDisaster(World world) {
		super(world, 60);
		setSize(0.1F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DISASTER_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DISASTER;
	}
}