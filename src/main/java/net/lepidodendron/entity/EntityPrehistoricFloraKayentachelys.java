...
public class EntityPrehistoricFloraKayentachelys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraKayentachelys(World world) {
		super(world);
		setSize(0.4F, 0.35F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, MAKE_NEST_ANIMATION, HIDE_ANIMATION};
	}
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntitySquid.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.FISHFOOD, DietString.CRUSTACEAN);
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:turtle_idle"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KAYENTACHELYS;
	}
