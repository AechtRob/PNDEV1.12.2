...
import net.lepidodendron.entity.render.entity.RenderBeishanlong;
...
public class EntityPrehistoricFloraBeishanlong extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraBeishanlong(World world) {
		super(world);
		setSize(0.49F, 0.52F);
		minWidth = 0.05F;
		maxWidth = 0.49F;
		...
		SAND_ANIMATION = Animation.create(605);
	...
	public Animation[] getAnimations() {
		return new Animation[]{DRINK_ANIMATION, ATTACK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, MAKE_NEST_ANIMATION, SAND_ANIMATION, STAND_ANIMATION};
	}
	...
	public boolean isAnimationDirectionLocked(Animation animation) {
		return animation == STAND_ANIMATION || animation == SAND_ANIMATION
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraBeishanlong> Beishanlong = Functions.getEntitiesWithinAABBPN(this.world, EntityPrehistoricFloraBeishanlong.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)), EntitySelectors.NOT_SPECTATING);
			for (EntityPrehistoricFloraBeishanlong currentBeishanlong : Beishanlong) {
				currentBeishanlong.setAnimation(NO_ANIMATION);
				currentBeishanlong.setRevengeTarget(ee);
				currentBeishanlong.setAlarmTarget(ee);
				currentBeishanlong.alarmCooldown = rand.nextInt(20);
			}
		}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:beishanlong_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:beishanlong_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:beishanlong_death"));
	}

	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:beishanlong_alarm"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BEISHANLONG;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.BEISHANLONG_LOOT_YOUNG;
		}
		return LepidodendronMod.BEISHANLONG_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderBeishanlong.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelBeishanlong;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderBeishanlong.getScaler();
    }
