...
public class EntityPrehistoricFloraLepidaster extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraLepidaster(World world) {
		super(world, 60);
		setSize(0.3F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LEPIDASTER_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LEPIDASTER;
	}
}