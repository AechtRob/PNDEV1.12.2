...
public class EntityPrehistoricFloraJellyfish_Palaeo1 extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraJellyfish_Palaeo1(World world) {
        super(world);
        setSize(0.5F, 0.3F);
    }
