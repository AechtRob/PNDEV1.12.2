...
import net.lepidodendron.entity.render.entity.RenderFortiholcorpa;
...
public class EntityPrehistoricFloraFortiholcorpa extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir, IAdvancementGranter {
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_fortiholcorpa_" + this.getPNType().getName() + ".name");
		}
	}
...
//			}
	...
	public static double offsetCaseMagnified(@Nullable String variant) { return 0.69; }
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderFortiholcorpa.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelFortiholcorpa;}
	public static float getScaler(@Nullable String variant) {
		return RenderFortiholcorpa.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderFortiholcorpa.getScaler() * 3.0F;
	}
