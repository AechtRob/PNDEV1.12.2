...
public class EntityPrehistoricFloraBrachytrachelopan extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraBrachytrachelopan(World world) {
		super(world);
		setSize(2.25F, 2.3F);
		minWidth = 0.2F;
		maxWidth = 2.25F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BRACHYTRACHELOPAN;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.BRACHYTRACHELOPAN_LOOT_YOUNG;
		}
		return LepidodendronMod.BRACHYTRACHELOPAN_LOOT;
	}
