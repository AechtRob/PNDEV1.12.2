...
public class EntityPrehistoricFloraJellyfish4 extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraJellyfish4(World world) {
        super(world);
        setSize(0.8F, 0.5F);
    }
    ...
    public static String getPeriod() {return "Paleogene (Oligocene) - Neogene - Pleistocene [- present]";}
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_JELLYFISH4;
    }
