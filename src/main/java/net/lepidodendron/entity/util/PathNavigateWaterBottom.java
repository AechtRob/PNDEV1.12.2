...
public class PathNavigateWaterBottom extends PathNavigate
{
    private boolean shouldAvoidSun;

    public PathNavigateWaterBottom(EntityLiving entitylivingIn, World worldIn)
    {
    ...
    {
        this.nodeProcessor = new WaterBottomNodeProcessor();
