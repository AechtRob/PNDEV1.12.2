...
public class PathNavigateFlyingNoWater extends PathNavigate
{
    public PathNavigateFlyingNoWater(EntityLiving entityIn, World worldIn)
    {
    ...
    {
        this.nodeProcessor = new FlyingNodeProcessorNoWater();
