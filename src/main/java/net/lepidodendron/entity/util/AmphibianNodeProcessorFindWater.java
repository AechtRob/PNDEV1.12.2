...
public class AmphibianNodeProcessorFindWater extends NodeProcessor
{
    ...
    public PathPoint getStart()
    {
        ...
        else
        {
            ...
            for (blockpos = new BlockPos(this.entity); (((this.blockaccess.getBlockState(blockpos).getMaterial() == Material.AIR) || (this.blockaccess.getBlockState(blockpos).getMaterial() == Material.WATER)) || this.blockaccess.getBlockState(blockpos).getBlock().isPassable(this.blockaccess, blockpos)) && blockpos.getY() > 0; blockpos = blockpos.down())
            {
                ;
            }
