...
public class WaterBottomNodeProcessorNoJump extends NodeProcessor
{
    ...
    protected PathNodeType getPathNodeTypeRaw(IBlockAccess p_189553_1_, int p_189553_2_, int p_189553_3_, int p_189553_4_)
    {
        ...
        IBlockState iblockstate1 = p_189553_1_.getBlockState(blockpos.down());
        ...
        //Additional to stop them getting trapped in holes and stay on the same level:
        if (material == Material.WATER && material1 == Material.WATER)
        {
            return PathNodeType.BLOCKED;
        }
