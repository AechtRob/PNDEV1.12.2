...
public class PathNavigateAmphibianFindWater extends PathNavigate
{
    private boolean shouldAvoidSun;

    public PathNavigateAmphibianFindWater(EntityLiving entitylivingIn, World worldIn)
    {
    ...
    {
        this.nodeProcessor = new AmphibianNodeProcessorFindWater();
