...
import net.lepidodendron.item.entities.ItemBucketEllipsocephalus;
...
public class EntityPrehistoricFloraEllipsocephalus extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraEllipsocephalus(World world) {
		super(world);
		setSize(0.2F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ELLIPSOCEPHALUS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketEllipsocephalus.block, (int) (1));
