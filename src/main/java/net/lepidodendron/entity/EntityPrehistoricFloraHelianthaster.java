...
import net.lepidodendron.item.entities.ItemBucketHelianthaster;
...
public class EntityPrehistoricFloraHelianthaster extends EntityPrehistoricFloraSlitheringWaterBase {
	...
	public EntityPrehistoricFloraHelianthaster(World world) {
		super(world, 60);
		setSize(0.5F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HELIANTHASTER_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHelianthaster.block, (int) (1));
