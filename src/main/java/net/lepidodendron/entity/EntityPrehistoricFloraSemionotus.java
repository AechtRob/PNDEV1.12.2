...
import net.lepidodendron.item.entities.ItemBucketSemionotus;
...
public class EntityPrehistoricFloraSemionotus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketSemionotus.block, (int) (1));
