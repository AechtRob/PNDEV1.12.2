...
public class EntityPrehistoricFloraSemionotus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SEMIONOTUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SEMIONOTUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSemionotus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSemionotus.getScaler();
	}
