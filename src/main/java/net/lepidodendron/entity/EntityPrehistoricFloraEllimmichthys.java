...
public class EntityPrehistoricFloraEllimmichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraEllimmichthys(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ELLIMMICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ELLIMMICHTHYS;
	}
}
