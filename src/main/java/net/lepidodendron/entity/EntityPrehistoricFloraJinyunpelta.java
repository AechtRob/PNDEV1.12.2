...
public class EntityPrehistoricFloraJinyunpelta extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraJinyunpelta(World world) {
		super(world);
		setSize(0.99F, 0.99F);
		minWidth = 0.3F;
		maxWidth = 0.99F;
...
//	}
	...
	public int getDrinkLength() {
		return 375;  //grazes, does not drink
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:jinyunpelta_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:jinyunpelta_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:jinyunpelta_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.JINYUNPELTA_LOOT_YOUNG;
		}
		return LepidodendronMod.JINYUNPELTA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JINYUNPELTA;
	}
