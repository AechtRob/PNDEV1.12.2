...
public class EntityPrehistoricFloraTethybatis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraTethybatis(World world) {
		super(world);
		setSize(0.7F, 0.3F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TETHYBATIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TETHYBATIS;
	}
}
