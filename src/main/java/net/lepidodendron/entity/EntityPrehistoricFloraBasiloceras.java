...
public class EntityPrehistoricFloraBasiloceras extends EntityPrehistoricFloraNautiloidBase implements ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsBasiloceras.block, (int) (1));
	}
