...
import net.lepidodendron.item.entities.ItemEggsShringasaurus;
...
public class EntityPrehistoricFloraShringasaurus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_shringasaurus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsShringasaurus.block, 1);
	}
