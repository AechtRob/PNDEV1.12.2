...
import net.lepidodendron.item.entities.ItemBucketCheloniellon;
...
public class EntityPrehistoricFloraCheloniellon extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraCheloniellon(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CHELONIELLON_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCheloniellon.block, (int) (1));
