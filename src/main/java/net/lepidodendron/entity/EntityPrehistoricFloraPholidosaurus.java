...
public class EntityPrehistoricFloraPholidosaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraPholidosaurus(World world) {
		super(world);
		setSize(0.8F, 0.6F);
		minWidth = 0.1F;
		maxWidth = 0.8F;
		...
		STAND_ANIMATION = Animation.create(600);
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHOLIDOSAURUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PHOLIDOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PHOLIDOSAURUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
