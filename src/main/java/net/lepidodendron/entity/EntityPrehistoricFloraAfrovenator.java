...
import net.lepidodendron.entity.render.entity.RenderAfrovenator;
...
public class EntityPrehistoricFloraAfrovenator extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraAfrovenator(World world) {
		super(world);
		setSize(2.5F, 3.5F);
		minWidth = 0.20F;
		maxWidth = 1F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.AFROVENATOR_LOOT_YOUNG;
		}
		return LepidodendronMod.AFROVENATOR_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AFROVENATOR;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAfrovenator;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAfrovenator.getScaler();
	}
