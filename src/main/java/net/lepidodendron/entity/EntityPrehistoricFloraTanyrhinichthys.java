...
import net.lepidodendron.entity.render.entity.RenderShaihuludia;
...
public class EntityPrehistoricFloraTanyrhinichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraTanyrhinichthys(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TANYRHINICHTHYS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.28;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTanyrhinichthys.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTanyrhinichthys;}
	public static float getScaler(@Nullable String variant) {return RenderTanyrhinichthys.getScaler();}
