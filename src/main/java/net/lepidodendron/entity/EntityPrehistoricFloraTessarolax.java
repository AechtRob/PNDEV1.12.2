...
public class EntityPrehistoricFloraTessarolax extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTessarolax(World world) {
		super(world, 26);
		setSize(0.2F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TESSAROLAX;
	}
}