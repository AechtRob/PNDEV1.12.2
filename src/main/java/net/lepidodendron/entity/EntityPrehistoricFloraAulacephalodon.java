...
import net.lepidodendron.item.entities.ItemEggsAulacephalodon;
...
public class EntityPrehistoricFloraAulacephalodon extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_aulacephalodon";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsAulacephalodon.block, 1);
	}
