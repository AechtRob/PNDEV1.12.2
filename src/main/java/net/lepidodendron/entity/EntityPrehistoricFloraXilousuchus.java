...
import net.lepidodendron.entity.render.entity.RenderXilousuchus;
...
public class EntityPrehistoricFloraXilousuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraXilousuchus(World world) {
		super(world);
		setSize(0.6F, 0.65F);
		minWidth = 0.15F;
		maxWidth = 0.6F;
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:xilousuchus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:xilousuchus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:xilousuchus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.XILOUSUCHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.XILOUSUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_XILOUSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelXilousuchus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderXilousuchus.getScaler();
    }
}