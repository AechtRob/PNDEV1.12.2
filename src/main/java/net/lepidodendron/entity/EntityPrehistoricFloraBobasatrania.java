...
public class EntityPrehistoricFloraBobasatrania extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(1, new ShoalFishBaseAI(this, 1, true, this.getShoalDist() - 0.5F));
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBobasatrania;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBobasatrania.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BOBASATRANIA;
	}
