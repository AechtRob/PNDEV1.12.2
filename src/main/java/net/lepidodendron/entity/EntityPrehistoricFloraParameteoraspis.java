...
public class EntityPrehistoricFloraParameteoraspis extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARAMETEORASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARAMETEORASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraParameteoraspis EntityBase = EntityPrehistoricFloraParameteoraspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraParameteoraspis.this);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelParameteoraspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderParameteoraspis.getScaler();
	}
}