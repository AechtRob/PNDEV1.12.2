...
public class EntityPrehistoricFloraParameteoraspis extends EntityPrehistoricFloraAgeableFishBase {
	...
	public static ResourceLocation textureDisplay() {
		return RenderDisplays.TEXTURE_WUTTAGOONASPIS;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay() {
		return RenderDisplays.modelWuttagoonaspis;
	}
	public static float getScaler() {
		return RenderWuttagoonaspis.getScaler();
	}
}