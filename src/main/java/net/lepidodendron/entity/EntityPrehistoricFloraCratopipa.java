...
public class EntityPrehistoricFloraCratopipa extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, IWaterSurfaceEggsAmphibian {
	...
	public EntityPrehistoricFloraCratopipa(World world) {
		super(world);
		setSize(0.15F, 0.20F);
		minWidth = 0.12F;
		maxWidth = 0.15F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CRATOPIPA_LOOT;
	}
...
//	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRATOPIPA;
	}
