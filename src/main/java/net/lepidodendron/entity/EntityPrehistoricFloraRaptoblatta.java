...
import net.lepidodendron.entity.render.entity.RenderSantanmantis;
...
public class EntityPrehistoricFloraRaptoblatta extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraRaptoblatta(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.3F;
		maxWidth = 0.3F;
		...
		STAND_ANIMATION = Animation.create(123);
	}
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_raptoblatta.png");
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.RAPTOBLATTA_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RAPTOBLATTA;
	}
