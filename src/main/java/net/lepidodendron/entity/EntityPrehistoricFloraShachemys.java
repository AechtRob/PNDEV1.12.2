...
public class EntityPrehistoricFloraShachemys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraShachemys(World world) {
		super(world);
		setSize(0.4F, 0.3F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	public static String getPeriod() {
		return "Early Cretaceous - Late Cretaceous - Paleogene";
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:adocus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:adocus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:adocus_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SHACHEMYS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SHACHEMYS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
