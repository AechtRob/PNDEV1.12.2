...
public class EntityPrehistoricFloraYanosteus extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraYanosteus(World world) {
		super(world);
		setSize(0.3F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.YANOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_YANOSTEUS;
	}
}
