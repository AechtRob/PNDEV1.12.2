...
public class EntityPrehistoricFloraCratosirex extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraCratosirex(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	...
	public void onEntityUpdate() {
		...
		if ((!this.world.isRemote)  && this.getEatTarget() == null && this.getAttackTarget() == null && this.getRevengeTarget() == null
				&& this.getAnimation() == NO_ANIMATION && standCooldown == 0 && this.getAttachmentFacing() != EnumFacing.DOWN) {
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_cratosirex.png");
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.CRATOSIREX_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRATOSIREX;
	}
