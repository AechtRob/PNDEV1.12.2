...
public class EntityPrehistoricFloraBatrachotomus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BATRACHOTOMUS;
	}
