...
public class EntityPrehistoricFloraTuojiangosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TUOJIANGOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.TUOJIANGOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TUOJIANGOSAURUS;
	}
}