...
import net.lepidodendron.item.entities.ItemBucketHeterosteus;
...
public class EntityPrehistoricFloraHeterosteus extends EntityPrehistoricFloraAgeableFishBase {
		...
		if (this.getAgeScale() < 0.2) { //Only catch babies
			...
			if (!itemstack.isEmpty()) {
				if (itemstack.getItem() == Items.WATER_BUCKET) {
					...
					ItemStack itemstack1 = new ItemStack(ItemBucketHeterosteus.block, (int) (1));
