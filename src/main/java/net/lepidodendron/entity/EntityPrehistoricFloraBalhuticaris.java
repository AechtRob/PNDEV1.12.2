...
public class EntityPrehistoricFloraBalhuticaris extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBalhuticaris(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BALHUTICARIS_LOOT;
	}
	...
	public static float getScaler(@Nullable String variant) {
		return RenderBalhuticaris.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BALHUTICARIS;
	}
