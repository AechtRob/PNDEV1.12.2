...
public class EatInsectItemsAI extends EntityAIBase {
    private final EntityPrehistoricFloraAgeableBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatInsectItemsAI(EntityPrehistoricFloraAgeableBase entity) {
        super();
        this.entity = entity;
    ...
    private EntityItem getNearestItem(int range) {
        ...
        for (EntityItem currentItem : Items) {
            if (!currentItem.getItem().isEmpty()) {
                if (((OreDictionary.containsMatch(false, OreDictionary.getOres("listAllinsectraw"), currentItem.getItem()))
                    || (OreDictionary.containsMatch(false, OreDictionary.getOres("foodInsect"), currentItem.getItem())))
