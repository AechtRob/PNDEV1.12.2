...
public class EatFishFoodAIAmphibian extends EntityAIBase {
    private final EntityPrehistoricFloraAmphibianBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatFishFoodAIAmphibian(EntityPrehistoricFloraAmphibianBase entity) {
        super();
        this.entity = entity;
