...
public class EntityMateAITrilobiteSwimBase extends EntityAIBase
{
    private final EntityPrehistoricFloraTrilobiteSwimBase animal;
    private final Class <? extends EntityPrehistoricFloraTrilobiteSwimBase > mateClass;
    World world;
    private EntityPrehistoricFloraTrilobiteSwimBase targetMate;
    int spawnBabyDelay;
    double moveSpeed;

    public EntityMateAITrilobiteSwimBase(EntityPrehistoricFloraTrilobiteSwimBase animal, double speedIn)
    {
        this(animal, speedIn, animal.getClass());
    }

    public EntityMateAITrilobiteSwimBase(EntityPrehistoricFloraTrilobiteSwimBase animal, double p_i47306_2_, Class <? extends EntityPrehistoricFloraTrilobiteSwimBase > p_i47306_4_)
    {
        this.animal = animal;
    ...
    private EntityPrehistoricFloraTrilobiteSwimBase getNearbyMate()
    {
        List<EntityPrehistoricFloraTrilobiteSwimBase> list = this.world.<EntityPrehistoricFloraTrilobiteSwimBase>getEntitiesWithinAABB(this.mateClass, this.animal.getEntityBoundingBox().grow(8.0D));
        double d0 = Double.MAX_VALUE;
        EntityPrehistoricFloraTrilobiteSwimBase EntityPrehistoricFloraTrilobiteSwimBase = null;

        for (EntityPrehistoricFloraTrilobiteSwimBase EntityPrehistoricFloraTrilobiteSwimBase1 : list)
        {
            if (this.animal.canMateWith(EntityPrehistoricFloraTrilobiteSwimBase1) && this.animal.getDistanceSq(EntityPrehistoricFloraTrilobiteSwimBase1) < d0)
            {
                EntityPrehistoricFloraTrilobiteSwimBase = EntityPrehistoricFloraTrilobiteSwimBase1;
                d0 = this.animal.getDistanceSq(EntityPrehistoricFloraTrilobiteSwimBase1);
            }
        }

        return EntityPrehistoricFloraTrilobiteSwimBase;
    }
