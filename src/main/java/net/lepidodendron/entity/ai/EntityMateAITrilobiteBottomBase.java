...
public class EntityMateAITrilobiteBottomBase extends EntityAIBase
{
    ...
    public EntityMateAITrilobiteBottomBase(EntityPrehistoricFloraTrilobiteBottomBase animal, double speedIn)
    {
        this(animal, speedIn, animal.getClass());
    }

    public EntityMateAITrilobiteBottomBase(EntityPrehistoricFloraTrilobiteBottomBase animal, double p_i47306_2_, Class <? extends EntityPrehistoricFloraTrilobiteBottomBase > p_i47306_4_)
    {
        this.animal = animal;
    ...
    {
        List<EntityPrehistoricFloraTrilobiteBottomBase> list = this.world.<EntityPrehistoricFloraTrilobiteBottomBase>getEntitiesWithinAABB(this.mateClass, this.animal.getEntityBoundingBox().grow(8.0D));
        double d0 = Double.MAX_VALUE;
        EntityPrehistoricFloraTrilobiteBottomBase EntityPrehistoricFloraTrilobiteBottomBase = null;

        for (EntityPrehistoricFloraTrilobiteBottomBase EntityPrehistoricFloraTrilobiteBottomBase1 : list)
        {
            if (this.animal.canMateWith(EntityPrehistoricFloraTrilobiteBottomBase1) && this.animal.getDistanceSq(EntityPrehistoricFloraTrilobiteBottomBase1) < d0)
            {
                EntityPrehistoricFloraTrilobiteBottomBase = EntityPrehistoricFloraTrilobiteBottomBase1;
                d0 = this.animal.getDistanceSq(EntityPrehistoricFloraTrilobiteBottomBase1);
            }
        }

        return EntityPrehistoricFloraTrilobiteBottomBase;
    }
