...
public class EatItemsEntityPrehistoricFloraCrawlingFlyingInsectBaseAI extends EntityAIBase {
    private final EntityPrehistoricFloraCrawlingFlyingInsectBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatItemsEntityPrehistoricFloraCrawlingFlyingInsectBaseAI(EntityPrehistoricFloraCrawlingFlyingInsectBase entity) {
        super();
        this.entity = entity;
