...
public class EatItemsEntityPrehistoricFloraFishBaseAI extends EntityAIBase {
    private final EntityPrehistoricFloraFishBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatItemsEntityPrehistoricFloraFishBaseAI(EntityPrehistoricFloraFishBase entity) {
        super();
        this.entity = entity;
