...
public class PanicFindNestAI extends EntityAIBase
{
    ...
    protected boolean findRandomPosition()
    {
        ...
        if (this.creature.getNavigator().getPath() != null
            ...
            int xx = this.creature.getNavigator().getPath().getFinalPathPoint().x;
            int yy = this.creature.getNavigator().getPath().getFinalPathPoint().y;
            int zz = this.creature.getNavigator().getPath().getFinalPathPoint().z;
        ...
        BlockPos pos = findBlockTarget(8);
        if (pos != null) {
