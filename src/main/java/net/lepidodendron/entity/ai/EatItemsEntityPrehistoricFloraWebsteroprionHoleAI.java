...
public class EatItemsEntityPrehistoricFloraWebsteroprionHoleAI extends EntityAIBase {
    private final EntityPrehistoricFloraWebsteroprionHole entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatItemsEntityPrehistoricFloraWebsteroprionHoleAI(EntityPrehistoricFloraWebsteroprionHole entity) {
        super();
        this.entity = entity;
