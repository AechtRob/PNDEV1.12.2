...
public class EatItemsEntityPrehistoricFloraSlitheringWaterBaseAI extends EntityAIBase {
    private final EntityPrehistoricFloraSlitheringWaterBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatItemsEntityPrehistoricFloraSlitheringWaterBaseAI(EntityPrehistoricFloraSlitheringWaterBase entity) {
        super();
        this.entity = entity;
