...
public class EntityPrehistoricFloraArenipiscis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraArenipiscis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraArenipiscis.SwimmingMoveHelperBase();
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraArenipiscis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARENIPISCIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARENIPISCIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraArenipiscis EntityBase = EntityPrehistoricFloraArenipiscis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraArenipiscis.this);
		}
