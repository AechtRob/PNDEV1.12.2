...
public class EntityPrehistoricFloraLochmanolenellus extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraLochmanolenellus(World world) {
		super(world);
		setSize(0.25F, 0.23F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LOCHMANOLENELLUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LOCHMANOLENELLUS;
	}
}