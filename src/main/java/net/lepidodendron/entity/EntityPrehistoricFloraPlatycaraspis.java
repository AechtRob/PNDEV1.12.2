...
import net.lepidodendron.item.entities.ItemBucketPlatycaraspis;
...
public class EntityPrehistoricFloraPlatycaraspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPlatycaraspis.block, (int) (1));
