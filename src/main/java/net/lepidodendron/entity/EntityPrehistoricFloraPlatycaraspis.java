...
public class EntityPrehistoricFloraPlatycaraspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPlatycaraspis(World world) {
		super(world);
		setSize(0.6F, 0.5F);
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PLATYCARASPIS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PLATYCARASPIS_LOOT;
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.25;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPlatycaraspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPlatycaraspis;}
	public static float getScaler(@Nullable String variant) {return RenderPlatycaraspis.getScaler();}
}