...
import net.lepidodendron.entity.render.entity.RenderGregorius;
...
public class EntityPrehistoricFloraGregorius extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraGregorius(World world) {
		super(world);
		setSize(0.2F, 0.275F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GREGORIUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderGregorius.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelGregorius;}
	public static float getScaler(@Nullable String variant) {return RenderGregorius.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GREGORIUS;
	}
