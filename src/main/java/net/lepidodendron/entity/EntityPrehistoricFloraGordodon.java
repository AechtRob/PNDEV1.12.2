...
public class EntityPrehistoricFloraGordodon extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraGordodon(World world) {
		super(world);
		setSize(0.46F, 0.55F);
		minWidth = 0.10F;
		maxWidth = 0.46F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GORDODON_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GORDODON;
	}
}