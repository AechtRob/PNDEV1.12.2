...
public class EntityPrehistoricFloraMulgaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMulgaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraMulgaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMulgaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MULGASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MULGASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraMulgaspis EntityBase = EntityPrehistoricFloraMulgaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraMulgaspis.this);
		}
