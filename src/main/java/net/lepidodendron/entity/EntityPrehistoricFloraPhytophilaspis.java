...
import net.lepidodendron.entity.render.entity.RenderPhytophilaspis;
...
public class EntityPrehistoricFloraPhytophilaspis extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPhytophilaspis(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHYTOPHILASPIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPhytophilaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPhytophilaspis;}
	public static float getScaler(@Nullable String variant) {return RenderPhytophilaspis.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHYTOPHILASPIS;
	}
}