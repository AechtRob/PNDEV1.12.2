...
public class EntityPrehistoricFloraParvosuchus extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraParvosuchus(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.15F;
		maxWidth = 0.3F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARVOSUCHUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARVOSUCHUS;
	}
	//Rendering taxidermy:
	//--------------------
