...
public class EntityPrehistoricFloraEorhynchochelys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public net.minecraft.util.SoundEvent getAmbientSound() {
	    return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:eorhynchochelys_idle"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.EORHYNCHOCHELYS_LOOT_YOUNG;
		}
		return LepidodendronMod.EORHYNCHOCHELYS_LOOT;
	}

	//Rendering taxidermy:
	//--------------------
	public static double offsetPlinth() { return 0.62; }
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelEorhynchochelys;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderEorhynchochelys.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EORHYNCHOCHELYS;
	}
}