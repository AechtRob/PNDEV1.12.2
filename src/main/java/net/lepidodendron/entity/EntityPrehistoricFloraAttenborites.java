...
public class EntityPrehistoricFloraAttenborites extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public ItemStack getPropagule() {
        return new ItemStack(ItemUnknownBlob.block, (int) (1));
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_ATTENBORITES;
    }
}