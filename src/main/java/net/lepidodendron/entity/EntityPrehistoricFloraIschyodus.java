...
public class EntityPrehistoricFloraIschyodus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater {
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraIschyodus)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelIschyodus;
	}
	public static float getScaler(@Nullable String variant) {
		if (variant.equalsIgnoreCase("female")) {
			return RenderIschyodus.getScaler() * 1.0F;
		}
		return RenderIschyodus.getScaler();
	}
	...
	public static String getPeriod() {return "Jurassic - Early Cretaceous - Late Cretaceous - Palaeogene  - Neogene";}
	...
	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraIschyodus EntityBase = EntityPrehistoricFloraIschyodus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraIschyodus.this);
		}
