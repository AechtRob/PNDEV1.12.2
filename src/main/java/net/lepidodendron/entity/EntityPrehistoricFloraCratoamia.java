...
public class EntityPrehistoricFloraCratoamia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraCratoamia(World world) {
		super(world);
		setSize(0.4F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CRATOAMIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderCratoamia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelCratoamia;}
	public static float getScaler(@Nullable String variant) {return RenderCratoamia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CRATOAMIA;
	}
