...
public class EntityPrehistoricFloraRafaeliana extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraRafaeliana(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_rafaeliana.png");
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.RAFAELIANA_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RAFAELIANA;
	}
