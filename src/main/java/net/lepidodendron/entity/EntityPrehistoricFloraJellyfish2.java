...
import net.lepidodendron.item.entities.ItemBucketJellyfish2;
...
public class EntityPrehistoricFloraJellyfish2 extends EntityPrehistoricFloraJellyfishBase {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish2.block, (int) (1));
