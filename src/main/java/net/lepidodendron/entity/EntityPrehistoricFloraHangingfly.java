...
public class EntityPrehistoricFloraHangingfly extends EntityPrehistoricFloraInsectFlyingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraHangingfly(World world) {
		super(world);
		setSize(0.15F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HANGINGFLY;
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.HANGINGFLY_LOOT;
	...
	public static float getScaler(@Nullable String variant) {
		return RenderHangingfly.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderHangingfly.getScaler() * 3.0F;
	}
