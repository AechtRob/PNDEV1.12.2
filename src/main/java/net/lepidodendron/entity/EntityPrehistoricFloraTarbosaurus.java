...
import net.lepidodendron.entity.render.entity.RenderTarbosaurus;
...
public class EntityPrehistoricFloraTarbosaurus extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraTarbosaurus(World world) {
		super(world);
		setSize(2.5F, 3.5F);
		minWidth = 0.20F;
		maxWidth = 2.5F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TARBOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.TARBOSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TARBOSAURUS;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTarbosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTarbosaurus.getScaler();
	}
