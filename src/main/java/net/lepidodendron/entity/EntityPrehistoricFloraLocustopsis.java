...
public class EntityPrehistoricFloraLocustopsis extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraLocustopsis(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_locustopsis.png");
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.LOCUSTOPSIS_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LOCUSTOPSIS;
	}
