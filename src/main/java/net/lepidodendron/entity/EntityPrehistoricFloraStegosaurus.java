...
public class EntityPrehistoricFloraStegosaurus extends EntityPrehistoricFloraLandBase implements ITrappableLand {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(7, new LandWanderHerd(this, 1.00D, Math.max(1, this.width) * this.getNavigator().getPathSearchRange() * 0.50F));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.STEGOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.STEGOSAURUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelStegosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderStegosaurus.getScaler();
	}
