...
public class EntityPrehistoricFloraStegosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_STEGOSAURUS;
	}
}