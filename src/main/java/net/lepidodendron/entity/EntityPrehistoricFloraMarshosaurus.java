...
public class EntityPrehistoricFloraMarshosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraMarshosaurus(World world) {
		super(world);
		setSize(0.9F, 1.4F);
		minWidth = 0.20F;
		maxWidth = 0.9F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MARSHOSAURUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MARSHOSAURUS_LOOT;
	}
