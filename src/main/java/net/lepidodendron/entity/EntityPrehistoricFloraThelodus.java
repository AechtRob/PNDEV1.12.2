...
public class EntityPrehistoricFloraThelodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THELODUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.THELODUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderThelodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelThelodus;}
	public static float getScaler(@Nullable String variant) {return RenderThelodus.getScaler();}
