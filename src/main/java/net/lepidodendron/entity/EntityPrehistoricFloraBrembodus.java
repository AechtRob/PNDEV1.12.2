...
public class EntityPrehistoricFloraBrembodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BREMBODUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBrembodus;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BREMBODUS;
	}
