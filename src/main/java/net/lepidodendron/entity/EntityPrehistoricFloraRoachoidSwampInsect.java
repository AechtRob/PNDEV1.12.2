...
public class EntityPrehistoricFloraRoachoidSwampInsect extends EntityPrehistoricFloraArchoblattinaInsect implements ITrappableAir {
	...
	public ItemStack getDroppedEggItemStack() {
		...
		variantNBT.setString("creature", "lepidodendron:prehistoric_flora_roachoid_swamp");
...
//	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ROACHOID_SWAMP_JAR_LOOT;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRoachoidSwamp.TEXTURE;}
	@SideOnly(Side.CLIENT)
