...
public class EntityPrehistoricFloraTaquetochelys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraTaquetochelys(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
		...
		EAT_ANIMATION = Animation.create(25);
		STAND_ANIMATION = Animation.create(420);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, MAKE_NEST_ANIMATION, HIDE_ANIMATION, STAND_ANIMATION};
	}
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAQUETOCHELYS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TAQUETOCHELYS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
