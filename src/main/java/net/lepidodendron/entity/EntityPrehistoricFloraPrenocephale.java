...
public class EntityPrehistoricFloraPrenocephale extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPrenocephale(World world) {
		super(world);
		setSize(0.6F, 0.7F);
		minWidth = 0.12F;
		maxWidth = 0.6F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraPrenocephale> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraPrenocephale.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraPrenocephale currentYinlong : Yinlong) {
	...
	public boolean findGrappleTarget() {
		...
		List<EntityPrehistoricFloraPrenocephale> Aquilops = world.getEntitiesWithinAABB(EntityPrehistoricFloraPrenocephale.class, new AxisAlignedBB(this.getPosition().add(-10, -6, -10), this.getPosition().add(10, 6, 10)));
		for (EntityPrehistoricFloraPrenocephale currentAquilops : Aquilops) {
	...
	public int getDrinkLength() {
		return 470;  //grazes, does not drink
	}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:prenocephale_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:prenocephale_hurt"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PRENOCEPHALE_LOOT_YOUNG;
		}
		return LepidodendronMod.PRENOCEPHALE_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PRENOCEPHALE;
	}
}