...
public class EntityPrehistoricFloraDimetrodon_teutonis extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraDimetrodon_teutonis(World world) {
		super(world);
		setSize(0.46F, 0.55F);
		minWidth = 0.10F;
		maxWidth = 0.46F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DIMETRODON_TEUTONIS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DIMETRODON_TEUTONIS;
	}
}