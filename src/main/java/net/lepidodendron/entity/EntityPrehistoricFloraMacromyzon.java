...
public class EntityPrehistoricFloraMacromyzon extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMacromyzon(World world) {
		super(world);
		setSize(0.1F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MACROMYZON_LOOT;
	}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MACROMYZON;
	}
