...
public class EntityPrehistoricFloraAttercopus extends EntityPrehistoricFloraLandClimbingBase implements IAdvancementGranter, ITrappableAir {
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ATTERCOPUS_LOOT_JAR;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAttercopus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ATTERCOPUS;
	}
