...
public class EntityPrehistoricFloraPsittacosaurus_sibiricus extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPsittacosaurus_sibiricus(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public int getDrinkLength() {
		return 125;  //grazes, does not drink
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PSITTACOSAURUS_SIBIRICUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PSITTACOSAURUS_SIBIRICUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PSITTACOSAURUS_SIBIRICUS;
	}
