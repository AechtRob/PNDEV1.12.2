...
public class EntityPrehistoricFloraJamoytius extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraJamoytius(World world) {
		super(world);
		setSize(0.4F, 0.3F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JAMOYTIUS;
	}
}