...
public class EntityPrehistoricFloraWeejasperaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraWeejasperaspis(World world) {
		super(world);
		if (world != null) {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraWeejasperaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.WEEJASPERASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_WEEJASPERASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraWeejasperaspis EntityBase = EntityPrehistoricFloraWeejasperaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraWeejasperaspis.this);
		}
