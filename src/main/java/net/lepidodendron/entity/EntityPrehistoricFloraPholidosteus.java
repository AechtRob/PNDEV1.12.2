...
public class EntityPrehistoricFloraPholidosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPholidosteus(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.5F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraPholidosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PHOLIDOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PHOLIDOSTEUS;
	}
	//Rendering taxidermy:
	//--------------------
