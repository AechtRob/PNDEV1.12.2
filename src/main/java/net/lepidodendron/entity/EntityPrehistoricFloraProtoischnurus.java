...
import net.lepidodendron.entity.render.entity.RenderProtoischnurus;
...
public class EntityPrehistoricFloraProtoischnurus extends EntityPrehistoricFloraScorpion implements ITrappableAir, IAdvancementGranter {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROTOISCHNURUS;
	}
	...
	public static double offsetCaseMagnified(@Nullable String variant) { return 0.99; }
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderProtoischnurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelProtoischnurus;}
	public static float getScaler(@Nullable String variant) {
		return RenderProtoischnurus.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderProtoischnurus.getScaler() * 3.5F;
	}
