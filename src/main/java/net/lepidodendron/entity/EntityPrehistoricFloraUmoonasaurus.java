...
public class EntityPrehistoricFloraUmoonasaurus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraUmoonasaurus(World world) {
		super(world);
		setSize(0.95F, 0.8F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.UMOONASAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.UMOONASAURUS_LOOT;
	}

	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraUmoonasaurus(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_UMOONASAURUS;
	}
}
