...
public class EntityPrehistoricFloraOtwayemys extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraOtwayemys(World world) {
		super(world);
		setSize(0.6F, 0.45F);
		minWidth = 0.2F;
		maxWidth = 0.6F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.OTWAYEMYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OTWAYEMYS;
	}
}