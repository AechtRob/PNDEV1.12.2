...
public class EntityPrehistoricFloraSpathobatis extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraSpathobatis(World world) {
		super(world);
		setSize(0.7F, 0.3F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SPATHOBATIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SPATHOBATIS;
	}
}
