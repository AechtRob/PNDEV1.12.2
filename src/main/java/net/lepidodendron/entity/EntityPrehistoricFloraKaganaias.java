...
public class EntityPrehistoricFloraKaganaias extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraKaganaias(World world) {
		super(world);
		setSize(0.3F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:kaganaias_hurt"));
	}
	...
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:kaganaias_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KAGANAIAS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KAGANAIAS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
