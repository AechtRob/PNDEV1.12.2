...
public class EntityPrehistoricFloraBoothiaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBoothiaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBoothiaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BOOTHIASPIS;
	}
