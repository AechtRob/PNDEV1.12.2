...
public class EntityPrehistoricFloraBunostegos extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BUNOSTEGOS;
	}
