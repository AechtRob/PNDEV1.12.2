...
import net.lepidodendron.entity.render.entity.RenderSuchomimus;
...
public class EntityPrehistoricFloraSuchomimus extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraSuchomimus(World world) {
		super(world);
		setSize(0.95F, 2.5F);
		minWidth = 0.20F;
		maxWidth = 0.95F;
		maxHeight = 2.5F;
		maxHealthAgeable = 130;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:suchomimus_idle"));
	}

	@Override
	public SoundEvent getRoarSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:suchomimus_roar"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:suchomimus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:suchomimus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SUCHOMIMUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SUCHOMIMUS_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderSuchomimus.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelSuchomimus;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderSuchomimus.getScaler();
    }
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SUCHOMIMUS;
	}
	//Rendering taxidermy:
	//--------------------
