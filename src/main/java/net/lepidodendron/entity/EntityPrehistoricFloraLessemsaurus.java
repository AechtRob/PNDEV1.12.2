...
public class EntityPrehistoricFloraLessemsaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LESSEMSAURUS;
	}
}