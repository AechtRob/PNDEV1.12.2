...
import net.lepidodendron.item.entities.ItemStrombus;
...
public class EntityPrehistoricFloraStrombus extends EntityPrehistoricFloraSlitheringWaterBase {

	private static final DataParameter<Integer> MOVETICKS = EntityDataManager.createKey(EntityPrehistoricFloraStrombus.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> OFFSETTICKS = EntityDataManager.createKey(EntityPrehistoricFloraStrombus.class, DataSerializers.VARINT);
	...
	public EntityPrehistoricFloraStrombus(World world) {
		super(world, 26);
		setSize(0.3F, 0.2F);
	}
	...
	public static String getPeriod() {return "Jurassic - Cretaceous - Paleogene - Neogene - Pleistocene";}
	...
	protected float getAISpeedSlithering() {
		...
		if ((this.getTicks()>20) && this.isInWater()) {
			calcSpeed = 0.0F;
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(MOVETICKS, 0);
		this.dataManager.register(OFFSETTICKS, 0);
	}
	public int getMoveTicks() {
		if (this.dataManager.get(MOVETICKS) == null) {
			this.setMoveTicks(0);
			return 0;
		}
		return this.dataManager.get(MOVETICKS);
	}

	public void setMoveTicks(int tailticks) {
		this.dataManager.set(MOVETICKS, tailticks);
	}
	...
	public void writeEntityToNBT(NBTTagCompound compound)
	{
		...
		compound.setInteger("TailTicks", this.getMoveTicks());
		compound.setInteger("OffsetTicks", this.getOffsetTicks());
	}
	public void readEntityFromNBT(NBTTagCompound compound) {
		super.readEntityFromNBT(compound);
		this.setMoveTicks(compound.getInteger("TailTicks"));
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemStrombus.block, (int) (1)));
