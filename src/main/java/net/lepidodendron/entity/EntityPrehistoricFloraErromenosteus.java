...
public class EntityPrehistoricFloraErromenosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraErromenosteus(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.5F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraErromenosteus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ERROMENOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ERROMENOSTEUS;
	}
	//Rendering taxidermy:
	//--------------------
