...
import net.lepidodendron.entity.render.entity.RenderVallibonavenatrix;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderVallibonavenatrix.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelVallibonavenatrix;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderVallibonavenatrix.getScaler();
    }
