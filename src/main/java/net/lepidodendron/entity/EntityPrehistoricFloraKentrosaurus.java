...
public class EntityPrehistoricFloraKentrosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.KENTROSAURUS_LOOT_YOUNG;
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KENTROSAURUS;
	}
}