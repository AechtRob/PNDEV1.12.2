...
public class EntityPrehistoricFloraVestinautilus extends EntityPrehistoricFloraNautiloidBase implements IAdvancementGranter, ITrappableWater {
	...
	public ItemStack getPropagule() {
		return new ItemStack(ItemNautiloidEggsVestinautilus.block, (int) (1));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VESTINAUTILUS;
	}
}
