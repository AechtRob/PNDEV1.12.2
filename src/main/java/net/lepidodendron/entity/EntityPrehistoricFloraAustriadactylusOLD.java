...
public class EntityPrehistoricFloraAustriadactylusOLD extends EntityPrehistoricFloraAgeableFlyingBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraAustriadactylusOLD(World world) {
		super(world);
		setSize(0.57F, 0.7F);
		minWidth = 0.12F;
		maxWidth = 0.57F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(2, new EntityPrehistoricFloraAgeableFlyingBase.AgeableFlyingBaseWanderFly(this));
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:austriadactylus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:austriadactylus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:austriadactylus_death"));
	}
