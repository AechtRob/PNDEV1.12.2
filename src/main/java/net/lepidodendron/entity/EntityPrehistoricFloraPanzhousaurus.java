...
public class EntityPrehistoricFloraPanzhousaurus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraPanzhousaurus(World world) {
		super(world);
		setSize(0.4F, 0.35F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
	...
	protected float getAISpeedSwimmingAmphibian() {
		...
		return Math.min(1F, (this.getAgeScale())) * calcSpeed;
	}
...
//		this.targetTasks.addTask(4, new HuntAI(this, EntitySquid.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:panzhousaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:panzhousaurus_hurt"));
	}
	...
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:panzhousaurus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PANZHOUSAURUS_LOOT;
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraPanzhousaurus(this.world);
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PANZHOUSAURUS;
	}
}