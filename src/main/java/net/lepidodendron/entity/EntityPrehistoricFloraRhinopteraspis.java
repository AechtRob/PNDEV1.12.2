...
public class EntityPrehistoricFloraRhinopteraspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraRhinopteraspis(World world) {
		super(world);
		setSize(0.4F, 0.3F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RHINOPTERASPIS;
	}
}
