...
import net.lepidodendron.entity.render.entity.RenderDracoraptor;
import net.lepidodendron.entity.render.entity.RenderKnoetschkesuchus;
...
public class EntityPrehistoricFloraDracoraptor extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDracoraptor(World world) {
		super(world);
		setSize(0.9F, 0.9F);
		minWidth = 0.20F;
		maxWidth = 0.9F;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.DRACORAPTOR_LOOT_YOUNG;
		}
		return LepidodendronMod.DRACORAPTOR_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DRACORAPTOR;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderDracoraptor.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelDracoraptor;}
	public static float getScaler(@Nullable String variant) {return RenderDracoraptor.getScaler();}
