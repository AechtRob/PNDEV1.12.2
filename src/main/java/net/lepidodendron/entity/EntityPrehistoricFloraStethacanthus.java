...
public class EntityPrehistoricFloraStethacanthus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater {
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraStethacanthus)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_stethacanthus_" + this.getPNType().getName() + ".name");
		}
	}
