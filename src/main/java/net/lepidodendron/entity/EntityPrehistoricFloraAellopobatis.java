...
public class EntityPrehistoricFloraAellopobatis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraAellopobatis(World world) {
		super(world);
		setSize(0.7F, 0.3F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AgeableFishWanderBottomDweller(this, NO_ANIMATION, 3));
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.AELLOPOBATIS_LOOT;
	}
...
//	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_AELLOPOBATIS;
	}
}
