...
public class EntityPrehistoricFloraPalaeocampa extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraPalaeocampa.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraPalaeocampa(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PALAEOCAMPA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PALAEOCAMPA;
	}
}