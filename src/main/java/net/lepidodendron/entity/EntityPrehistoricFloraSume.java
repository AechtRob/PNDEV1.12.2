...
public class EntityPrehistoricFloraSume extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSume(World world) {
		super(world);
		setSize(0.1F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SUME_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SUME;
	}
