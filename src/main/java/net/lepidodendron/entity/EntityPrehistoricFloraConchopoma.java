...
public class EntityPrehistoricFloraConchopoma extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, IAdvancementGranter {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CONCHOPOMA_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelConchopoma;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderConchopoma.getScaler();
	}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CONCHOPOMA;
	}
}