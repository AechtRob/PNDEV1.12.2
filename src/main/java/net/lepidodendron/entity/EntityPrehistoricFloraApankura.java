...
public class EntityPrehistoricFloraApankura extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraApankura(World world) {
		super(world);
		setSize(0.1F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.1F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.APANKURA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_APANKURA;
	}
}