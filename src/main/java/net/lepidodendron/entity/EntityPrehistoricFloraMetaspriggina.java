...
import net.lepidodendron.item.entities.ItemBucketMetaspriggina;
...
public class EntityPrehistoricFloraMetaspriggina extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraMetaspriggina(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.METASPRIGGINA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketMetaspriggina.block, (int) (1));
