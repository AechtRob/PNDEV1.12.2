...
public class EntityPrehistoricFloraMetaspriggina extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_METASPRIGGINA;
	}
}
