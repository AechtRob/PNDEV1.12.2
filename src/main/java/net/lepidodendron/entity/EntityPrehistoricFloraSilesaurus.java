...
public class EntityPrehistoricFloraSilesaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SILESAURUS_LOOT_YOUNG;
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SILESAURUS;
	}
}