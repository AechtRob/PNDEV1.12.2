...
public class EntityPrehistoricFloraSilesaurus extends EntityPrehistoricFloraLandBase {
	...
	{
		return (
				(OreDictionary.containsMatch(false, OreDictionary.getOres("listAllinsectraw"), stack))
