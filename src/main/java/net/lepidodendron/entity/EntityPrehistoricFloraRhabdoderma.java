...
import net.lepidodendron.entity.render.entity.RenderRhabdoderma;
...
public class EntityPrehistoricFloraRhabdoderma extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraRhabdoderma(World world) {
		super(world);
		setSize(0.25F, 0.19F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RHABDODERMA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRhabdoderma.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelRhabdoderma;}
	public static float getScaler(@Nullable String variant) {return RenderRhabdoderma.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RHABDODERMA;
	}
