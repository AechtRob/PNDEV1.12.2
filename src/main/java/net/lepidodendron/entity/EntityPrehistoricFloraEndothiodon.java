...
public class EntityPrehistoricFloraEndothiodon extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:endothiodon_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:endothiodon_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:endothiodon_death"));
	}
	...
	//Rendering taxidermy:
	//--------------------
	public static double offsetWall(@Nullable String variant) {return -0.1;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ENDOTHIODON;
	}
}