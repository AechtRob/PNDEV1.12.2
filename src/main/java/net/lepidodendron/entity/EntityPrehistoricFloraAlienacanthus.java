...
public class EntityPrehistoricFloraAlienacanthus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAlienacanthus(World world) {
		super(world);
		setSize(0.8F, 0.8F);
		minWidth = 0.2F;
		maxWidth = 0.8F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAlienacanthus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALIENACANTHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALIENACANTHUS;
	}
