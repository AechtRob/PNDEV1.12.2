...
public class EntityPrehistoricFloraTrigonotarbid_Eophrynus extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTrigonotarbid_Eophrynus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.EOPHRYNUS_JAR_LOOT;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTrigonotarbid_Eophrynus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIGONOTARBID_EOPHRYNUS;
	}
}