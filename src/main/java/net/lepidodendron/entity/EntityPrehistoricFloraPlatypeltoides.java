...
public class EntityPrehistoricFloraPlatypeltoides extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPlatypeltoides(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PLATYPELTOIDES_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelPlatypeltoides;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderPlatypeltoides.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLATYPELTOIDES;
	}
}