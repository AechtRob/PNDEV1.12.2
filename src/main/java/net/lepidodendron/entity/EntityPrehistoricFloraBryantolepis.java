...
public class EntityPrehistoricFloraBryantolepis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBryantolepis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraBryantolepis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBryantolepis(this.world);
	}

	@Override
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.CORAL);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BRYANTOLEPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BRYANTOLEPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBryantolepis EntityBase = EntityPrehistoricFloraBryantolepis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBryantolepis.this);
		}
