...
public class EntityPrehistoricFloraSquatina extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraSquatina(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraSquatina.SwimmingMoveHelperBase();
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.CRUSTACEAN, DietString.FISH);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SQUATINA;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SQUATINA_LOOT;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraSquatina EntityBase = EntityPrehistoricFloraSquatina.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraSquatina.this);
		}
