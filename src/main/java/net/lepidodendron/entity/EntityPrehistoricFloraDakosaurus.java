...
public class EntityPrehistoricFloraDakosaurus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter,  ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraDakosaurus(World world) {
		super(world);
		setSize(1.5F, 0.4F);
		minWidth = 0.1F;
		maxWidth = 1.5F;
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.DAKOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.DAKOSAURUS_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDakosaurus(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DAKOSAURUS;
	}
}
