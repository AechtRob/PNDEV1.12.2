...
public class EntityPrehistoricFloraBananogmius extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBananogmius(World world) {
		super(world);
		setSize(0.8F, 0.8F);
		minWidth = 0.1F;
		maxWidth = 0.8F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BANANOGMIUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BANANOGMIUS;
	}
