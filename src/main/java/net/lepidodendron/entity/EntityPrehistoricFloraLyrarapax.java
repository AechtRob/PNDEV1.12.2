...
public class EntityPrehistoricFloraLyrarapax extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LYRARAPAX;
	}
}