...
public class EntityPrehistoricFloraEoproscopia extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;


	public EntityPrehistoricFloraEoproscopia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		minWidth = 0.3F;
		maxWidth = 0.3F;
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_eoproscopia.png");
	}
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.EOPROSCOPIA_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EOPROSCOPIA;
	}
