...
import net.lepidodendron.item.entities.ItemEggsDiadectes;
...
public class EntityPrehistoricFloraDiadectes extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_diadectes";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsDiadectes.block, 1);
	}
