...
import net.lepidodendron.entity.render.entity.RenderRhynchonkos;
...
public class EntityPrehistoricFloraRhynchonkos extends EntityPrehistoricFloraLandBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, INeedsWater {
	...
	public EntityPrehistoricFloraRhynchonkos(World world) {
		super(world);
		setSize(0.15F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.15F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(6, new LandWanderAvoidWaterButStayNearWaterAI(this, this, 1.0D));
...
//		this.targetTasks.addTask(2, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAmphibianBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RHYNCHONKOS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRhynchonkos.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelRhynchonkos;}
	public static float getScaler(@Nullable String variant) {return RenderRhynchonkos.getScaler();}
