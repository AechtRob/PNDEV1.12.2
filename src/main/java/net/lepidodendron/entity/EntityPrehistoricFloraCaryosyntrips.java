...
public class EntityPrehistoricFloraCaryosyntrips extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.SHELLFISH, DietString.FISH);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelCaryosyntrips;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderCaryosyntrips.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CARYOSYNTRIPS;
	}
}
