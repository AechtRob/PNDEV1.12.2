...
import net.lepidodendron.item.entities.ItemBucketPomatrum;
...
public class EntityPrehistoricFloraPomatrum extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraPomatrum(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.POMATRUM_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPomatrum.block, (int) (1));
