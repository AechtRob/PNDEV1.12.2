...
public class EntityPrehistoricFloraAnchiornis extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.ANCHIORNIS_LOOT_YOUNG;
		}
		return LepidodendronMod.ANCHIORNIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAnchiornis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAnchiornis.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANCHIORNIS;
	}
