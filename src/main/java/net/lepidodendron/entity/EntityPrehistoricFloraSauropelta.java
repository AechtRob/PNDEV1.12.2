...
public class EntityPrehistoricFloraSauropelta extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraSauropelta(World world) {
		super(world);
		setSize(0.9F, 0.7F);
		minWidth = 0.3F;
		maxWidth = 0.9F;
...
//	}
	...
	@Nullable
	protected ResourceLocation getLootTable() {return LepidodendronMod.SAUROPELTA_LOOT;}


	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SAUROPELTA;
	}
