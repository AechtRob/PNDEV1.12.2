...
public class EntityPrehistoricFloraKimberella extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KIMBERELLA;
	}
}