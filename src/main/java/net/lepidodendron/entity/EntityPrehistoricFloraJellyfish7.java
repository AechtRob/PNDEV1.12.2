...
public class EntityPrehistoricFloraJellyfish7 extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraJellyfish7(World world) {
        super(world);
        setSize(0.8F, 0.5F);
    }
    ...
    public static String getPeriod() {return "Late Cretaceous - Palaeogene  - Neogene - Pleistocene [- present]";}
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_JELLYFISH7;
    }
}