...
import net.lepidodendron.entity.render.entity.RenderIkechaoamia;
...
public class EntityPrehistoricFloraIkechaoamia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraIkechaoamia(World world) {
		super(world);
		setSize(0.3F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.IKECHAOAMIA_LOOT;
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.42;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderIkechaoamia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelIkechaoamia;}
	public static float getScaler(@Nullable String variant) {return RenderIkechaoamia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_IKECHAOAMIA;
	}
