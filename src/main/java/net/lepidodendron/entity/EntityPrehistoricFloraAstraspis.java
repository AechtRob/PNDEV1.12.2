...
public class EntityPrehistoricFloraAstraspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ASTRASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAstraspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAstraspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ASTRASPIS;
	}
