...
public class EntityPrehistoricFloraThalassemys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraThalassemys(World world) {
		super(world);
		setSize(0.65F, 0.4F);
		minWidth = 0.1F;
		maxWidth = 0.65F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AmphibianWander(this, NO_ANIMATION, 0.85, 20));
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:thalassemys_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:thalassemys_hurt"));
	}
	...
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:thalassemys_death"));
	}
...
//	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THALASSEMYS;
	}
}