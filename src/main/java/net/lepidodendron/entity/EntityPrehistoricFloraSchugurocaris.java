...
public class EntityPrehistoricFloraSchugurocaris extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	//Rendering taxidermy:
	//--------------------
	public static double offsetCase(@Nullable String variant) { return 0.37; }
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSchugurocaris;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSchugurocaris.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCHUGUROCARIS;
	}
}