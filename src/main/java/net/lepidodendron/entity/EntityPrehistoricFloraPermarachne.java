...
import net.lepidodendron.entity.render.entity.RenderPermarachne;
...
public class EntityPrehistoricFloraPermarachne extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPermarachne(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.PERMARACHNE_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PERMARACHNE;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPermarachne.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTrigonotarbid;}
	public static float getScaler(@Nullable String variant) {
		return RenderPermarachne.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderPermarachne.getScaler() * 5.0F;
	}
