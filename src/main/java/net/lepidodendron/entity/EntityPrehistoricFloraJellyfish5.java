...
import net.lepidodendron.item.entities.ItemBucketJellyfish5;
...
public class EntityPrehistoricFloraJellyfish5 extends EntityPrehistoricFloraJellyfishBase {
    ...
    public EntityPrehistoricFloraJellyfish5(World world) {
        super(world);
        setSize(0.8F, 0.5F);
        experienceValue = 0;
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand)
    {
        ...
        if (!itemstack.isEmpty())
        {
            if (itemstack.getItem() == Items.WATER_BUCKET)
            {
                ...
                ItemStack itemstack1 = new ItemStack(ItemBucketJellyfish5.block, (int) (1));
