...
public class EntityPrehistoricFloraNothosaurus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//		//this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.NOTHOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.NOTHOSAURUS_LOOT;
	}
	@Override
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraNothosaurus(this.world);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NOTHOSAURUS;
	}
}
