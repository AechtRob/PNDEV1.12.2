...
public class EntityPrehistoricFloraKosoraspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraKosoraspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraKosoraspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraKosoraspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KOSORASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KOSORASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraKosoraspis EntityBase = EntityPrehistoricFloraKosoraspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraKosoraspis.this);
		}
