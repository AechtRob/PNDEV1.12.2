...
public class EntityPrehistoricFloraTlalocbatos extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTlalocbatos(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraTlalocbatos.SwimmingMoveHelperBase();
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TLALOCBATOS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TLALOCBATOS_LOOT;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraTlalocbatos EntityBase = EntityPrehistoricFloraTlalocbatos.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraTlalocbatos.this);
		}
