...
public class EntityPrehistoricFloraHarranahynchus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraHarranahynchus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraHarranahynchus.SwimmingMoveHelperBase();
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HARRANAHYNCHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HARRANAHYNCHUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraHarranahynchus EntityBase = EntityPrehistoricFloraHarranahynchus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraHarranahynchus.this);
		}
