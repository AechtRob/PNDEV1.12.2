...
public class EntityPrehistoricFloraEstemmenosuchus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ESTEMMENOSUCHUS;
	}
}