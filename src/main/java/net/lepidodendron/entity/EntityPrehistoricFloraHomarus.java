...
public class EntityPrehistoricFloraHomarus extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	private static final DataParameter<Boolean> SWIMMINGPN = EntityDataManager.createKey(EntityPrehistoricFloraHomarus.class, DataSerializers.BOOLEAN);
	//Needs to be here because it is not loaded in time to be accessed by the client if it's on the parent class!

	public EntityPrehistoricFloraHomarus(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.2F;
		maxWidth = 0.2F;
...
public static String getHabitat() {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(4, new AgeableWarnEntity(this, EntityPlayer.class, 2));
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntityPrehistoricFloraTrilobiteSwimBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HOMARUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_HOMARUS;
    }
}