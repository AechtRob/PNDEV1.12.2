...
public class EntityPrehistoricFloraChangxingaspis extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CHANGXINGASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CHANGXINGASPIS;
	}
}