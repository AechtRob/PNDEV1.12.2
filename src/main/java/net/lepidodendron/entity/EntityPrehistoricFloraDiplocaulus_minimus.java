...
public class EntityPrehistoricFloraDiplocaulus_minimus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;
	public EntityPrehistoricFloraDiplocaulus_minimus(World world) {
		super(world);
		setSize(0.3F, 0.20F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DIPLOCAULUS_MINIMUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DIPLOCAULUS_MINIMUS;
	}
}