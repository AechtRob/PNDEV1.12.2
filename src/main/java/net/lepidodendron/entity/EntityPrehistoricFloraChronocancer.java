...
public class EntityPrehistoricFloraChronocancer extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CHRONOCANCER_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CHRONOCANCER;
	}
}
