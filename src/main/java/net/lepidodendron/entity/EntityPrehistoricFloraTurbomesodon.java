...
public class EntityPrehistoricFloraTurbomesodon extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTurbomesodon(World world) {
		super(world);
		setSize(0.2F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TURBOMESODON_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TURBOMESODON;
	}
