...
import net.lepidodendron.item.entities.ItemBucketDorypterus;
...
public class EntityPrehistoricFloraDorypterus extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketDorypterus.block, (int) (1));
