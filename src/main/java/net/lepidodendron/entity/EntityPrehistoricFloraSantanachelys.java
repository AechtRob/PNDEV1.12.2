...
public class EntityPrehistoricFloraSantanachelys extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater, ITrappableLand {
	...
	public EntityPrehistoricFloraSantanachelys(World world) {
		super(world);
		setSize(0.7F, 0.5F);
		minWidth = 0.1F;
		maxWidth = 0.7F;
	...
	protected void initEntityAI() {
		...
		tasks.addTask(4, new AmphibianWander(this, NO_ANIMATION, 1F, 20));
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mesodermochelys_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mesodermochelys_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:mesodermochelys_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SANTANACHELYS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SANTANACHELYS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
