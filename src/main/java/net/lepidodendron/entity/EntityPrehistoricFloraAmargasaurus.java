...
public class EntityPrehistoricFloraAmargasaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
    ...
    public EntityPrehistoricFloraAmargasaurus(World world) {
        super(world);
        setSize(1.8F, 2.7F);
        extraStepHeight = 1F;
        minWidth = 0.1F;
    ...
    public SoundEvent getHurtSound(DamageSource ds) {
        return (SoundEvent) SoundEvent.REGISTRY
                .getObject(new ResourceLocation("lepidodendron:amargasaurus_hurt"));
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_AMARGASAURUS;
    }

    @Nullable
    protected ResourceLocation getLootTable() {
        if (!this.isPFAdult()) {
            return LepidodendronMod.AMARGASAURUS_LOOT_YOUNG;
        }
        return LepidodendronMod.AMARGASAURUS_LOOT;
    }
