...
public class EntityRaft extends EntityBoat
{
    ...
    private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.<Integer>createKey(EntityRaft.class, DataSerializers.VARINT);
    ...
    private EntityRaft.Status getBoatStatus()
    {
        EntityRaft.Status EntityBoatLepidodendron$status = this.getUnderwaterStatus();
                ...
                for (int l1 = k; l1 < l; ++l1)
                {
                    for (int i2 = i1; i2 < j1; ++i2)
                    {
                        ...
                        if (iblockstate.getMaterial() == Material.WATER && d0 < (double)BlockLiquid.getLiquidHeight(iblockstate, this.world, blockpos$pooledmutableblockpos))
                        {
                            ...
                            {
                                EntityRaft.Status EntityBoatLepidodendron$status = EntityRaft.Status.UNDER_FLOWING_WATER;
                                return EntityBoatLepidodendron$status;
                            }
    ...
    public String getName() {
        ...
        {
            return I18n.translateToLocal("item.pf_" + this.getPNBoatType().getName() + "_raft_item.name");
        }
    }
    ...
    protected void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.setBoatType(EntityRaft.Type.getTypeFromString(compound.getString("Type")));
        }
    }
    ...
    public void setBoatType(EntityRaft.Type boatType)
    {
    ...
    public EntityRaft.Type getPNBoatType()
    {
        return EntityRaft.Type.byId(((Integer)this.dataManager.get(BOAT_TYPE)).intValue());
    }
