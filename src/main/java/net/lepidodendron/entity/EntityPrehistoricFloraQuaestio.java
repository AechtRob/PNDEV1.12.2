...
public class EntityPrehistoricFloraQuaestio extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraQuaestio(World world) {
		super(world, 0);
		setSize(0.2F, 0.15F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_QUAESTIO;
	}
}