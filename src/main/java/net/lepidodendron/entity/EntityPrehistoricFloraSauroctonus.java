...
public class EntityPrehistoricFloraSauroctonus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraSauroctonus(World world) {
		super(world);
		setSize(0.57F, 0.85F);
		minWidth = 0.18F;
		maxWidth = 0.57F;
	...
	protected void initEntityAI() {
		...
		//this.targetTasks.addTask(0, new HuntForDietEntityPrehistoricFloraAgeableBaseAI(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15, 3.0F));
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:sauroctonus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:sauroctonus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:sauroctonus_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SAUROCTONUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SAUROCTONUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SAUROCTONUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSauroctonus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSauroctonus.getScaler();
	}
}