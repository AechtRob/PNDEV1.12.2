...
public class EntityPrehistoricFloraMegalichthys extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMegalichthys(World world) {
		super(world);
		setSize(0.31F, 0.3F);
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMegalichthys;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderMegalichthys.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MEGALICHTHYS;
	}
}