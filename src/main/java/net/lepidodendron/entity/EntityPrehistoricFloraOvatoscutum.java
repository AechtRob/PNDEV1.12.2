...
public class EntityPrehistoricFloraOvatoscutum extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraOvatoscutum(World world) {
		super(world, 40);
		setSize(0.19F, 0.07F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OVATOSCUTUM;
	}
}