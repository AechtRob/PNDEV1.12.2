...
public class EntityPrehistoricFloraNarrominaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNarrominaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraNarrominaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraNarrominaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NARROMINASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NARROMINASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraNarrominaspis EntityBase = EntityPrehistoricFloraNarrominaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraNarrominaspis.this);
		}
