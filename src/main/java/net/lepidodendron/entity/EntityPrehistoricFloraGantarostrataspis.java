...
import net.lepidodendron.item.entities.ItemBucketGantarostrataspis;
...
public class EntityPrehistoricFloraGantarostrataspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketGantarostrataspis.block, (int) (1));
