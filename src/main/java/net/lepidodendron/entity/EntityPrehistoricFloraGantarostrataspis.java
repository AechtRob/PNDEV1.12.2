...
public class EntityPrehistoricFloraGantarostrataspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraGantarostrataspis(World world) {
		super(world);
		setSize(0.3F, 0.20F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GANTAROSTRATASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGantarostrataspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGantarostrataspis.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GANTAROSTRATASPIS;
	}
