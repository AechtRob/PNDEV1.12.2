...
public class EntityPrehistoricFloraParamylostoma extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraParamylostoma(World world) {
		super(world);
		setSize(0.5F, 0.3F);
		minWidth = 0.2F;
		maxWidth = 0.5F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraParamylostoma(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARAMYLOSTOMA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARAMYLOSTOMA;
	}
