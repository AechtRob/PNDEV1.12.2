...
public class EntityPrehistoricFloraKhoratamia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraKhoratamia(World world) {
		super(world);
		setSize(0.3F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KHORATAMIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderKhoratamia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelKhoratamia;}
	public static float getScaler(@Nullable String variant) {return RenderKhoratamia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KHORATAMIA;
	}
