...
import net.lepidodendron.entity.render.entity.RenderAnkylosphenodon;
...
public class EntityPrehistoricFloraAnkylosphenodon extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAnkylosphenodon(World world) {
		super(world);
		setSize(0.4F, 0.35F);
		minWidth = 0.1F;
		maxWidth = 0.4F;
		...
		DIG_ANIMATION = Animation.create(45);
		NOISE2_ANIMATION = Animation.create(22);
	...
	public void onUpdate() {
		...
		if (world.isRemote && !this.isAIDisabled()) {
			tailBuffer.calculateChainSwingBuffer(60, 5, 5F, this);
		}
	}
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, STAND_ANIMATION, DIG_ANIMATION, NOISE2_ANIMATION};
	}
	...
	protected float getAISpeedSwimmingAmphibian() {
		...
		if ( this.getAnimation() == MAKE_NEST_ANIMATION || this.getAnimation() == STAND_ANIMATION ||  this.getAnimation() == DIG_ANIMATION) {
			return 0.0F;
		}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(5, new AmphibianWanderNotBound(this, NO_ANIMATION, 0.65, 90));
...
//		this.targetTasks.addTask(3, new HuntAI(this, EntitySquid.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ANKYLOSPHENODON_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	public static double offsetWall(@Nullable String variant) {return -0.0625;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAnkylosphenodon.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAnkylosphenodon;}
	public static float getScaler(@Nullable String variant) {return RenderAnkylosphenodon.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANKYLOSPHENODON;
	}
}