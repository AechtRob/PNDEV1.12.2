...
public class EntityPrehistoricFloraSidneyia extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraSidneyia(World world) {
		super(world);
		setSize(0.3F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SIDNEYIA;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SIDNEYIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSidneyia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSidneyia;}
	public static float getScaler(@Nullable String variant) {return RenderSidneyia.getScaler();}
}