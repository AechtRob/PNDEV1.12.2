...
public class EntityPrehistoricFloraNotelops extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraNotelops(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.39;}
