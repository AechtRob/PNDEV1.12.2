...
public class EntityPrehistoricFloraMegalithomerus extends EntityPrehistoricFloraLandClimbingGlidingBase implements IAdvancementGranter, ITrappableLand, IScreamer, INervous {
	...
	public EntityPrehistoricFloraMegalithomerus(World world) {
		super(world);
		setSize(0.2F, 0.13F);
		minWidth = 0.2F;
		maxWidth = 0.2F;
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.MEGALITHOMERUS_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MEGALITHOMERUS;
	}
	...
	protected void collideWithEntity(Entity entityIn) {
		...
		if (this.onGround && (!this.isReallyInWater())  && this.getAnimation() != STAND_ANIMATION){
			this.setAnimation(STAND_ANIMATION);
		}
	}
