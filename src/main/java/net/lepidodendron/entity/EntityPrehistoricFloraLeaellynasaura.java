...
public class EntityPrehistoricFloraLeaellynasaura extends EntityPrehistoricFloraLandBase implements IScreamer, ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraLeaellynasaura(World world) {
		super(world);
		setSize(0.375F, 0.5F);
		minWidth = 0.12F;
		maxWidth = 0.375F;
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase) {
			...
			List<EntityPrehistoricFloraLeaellynasaura> Yinlong = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraLeaellynasaura.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraLeaellynasaura currentYinlong : Yinlong) {
	...
	public boolean findGrappleTarget() {
		...
		List<EntityPrehistoricFloraLeaellynasaura> Aquilops = world.getEntitiesWithinAABB(EntityPrehistoricFloraLeaellynasaura.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
		for (EntityPrehistoricFloraLeaellynasaura currentAquilops : Aquilops) {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LEAELLYNASAURA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LEAELLYNASAURA;
	}
}