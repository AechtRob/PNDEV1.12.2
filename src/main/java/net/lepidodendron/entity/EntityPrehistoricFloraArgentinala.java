...
import net.lepidodendron.entity.render.entity.LayerArgentinalaWing;
import net.lepidodendron.entity.render.entity.RenderArgentinala;
...
public class EntityPrehistoricFloraArgentinala extends EntityPrehistoricFloraMeganeuropsis implements ITrappableAir, IAdvancementGranter {
	...
	public String getEntityId(Entity entity) {
		return "lepidodendron:prehistoric_flora_aquaticnymph@argentinala";
	}
...
//	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderArgentinala.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplayTransparent(@Nullable String variant) {
		return LayerArgentinalaWing.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelArgentinala;}
	public static float getScaler(@Nullable String variant) {
		return RenderArgentinala.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderArgentinala.getScaler() * 5.0F;
	}
