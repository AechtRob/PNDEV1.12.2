...
public class EntityPrehistoricFloraAscendonanus extends EntityPrehistoricFloraLandBase {
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.ASCENDONANUS_JAR_LOOT;
