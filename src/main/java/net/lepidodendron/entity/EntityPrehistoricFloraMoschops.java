...
public class EntityPrehistoricFloraMoschops extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) {
		return RenderMoschops.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMoschops;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderMoschops.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MOSCHOPS;
	}
