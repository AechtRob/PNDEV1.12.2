...
import net.lepidodendron.entity.render.entity.RenderScutellosaurus;
...
public class EntityPrehistoricFloraScutellosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public EntityPrehistoricFloraScutellosaurus(World world) {
		super(world);
		setSize(0.85F, 1.85F);
		minWidth = 0.2F;
		maxWidth = 0.85F;
...
//		}
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:scutellosaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:scutellosaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:scutellosaurus_death"));
	}


	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:scutellosaurus_alarm"));
	}
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (e instanceof EntityLivingBase && this.hasAlarm()) {
			...
			List<EntityPrehistoricFloraScutellosaurus> SCUTELLOSAURUS = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraScutellosaurus.class, new AxisAlignedBB(this.getPosition().add(-8, -4, -8), this.getPosition().add(8, 4, 8)));
			for (EntityPrehistoricFloraScutellosaurus currentSCUTELLOSAURUS : SCUTELLOSAURUS) {
				currentSCUTELLOSAURUS.setAnimation(NO_ANIMATION);
				currentSCUTELLOSAURUS.setRevengeTarget(ee);
				currentSCUTELLOSAURUS.setAlarmTarget(ee);
				currentSCUTELLOSAURUS.alarmCooldown = rand.nextInt(20);
			}
		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCUTELLOSAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SCUTELLOSAURUS_LOOT;
	}
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) {
		return RenderScutellosaurus.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelScutellosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderScutellosaurus.getScaler();
	}
