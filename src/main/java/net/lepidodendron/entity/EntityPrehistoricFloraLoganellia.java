...
import net.lepidodendron.entity.render.entity.RenderLoganellia;
...
public class EntityPrehistoricFloraLoganellia extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraLoganellia(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.LOGANELLIA_LOOT;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderLoganellia.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelLoganellia;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderLoganellia.getScaler();
    }

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LOGANELLIA;
	}
}
