...
public class EntityPrehistoricFloraTapejara extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, IScreamerFlier, ITrappableLand {
	...
	public EntityPrehistoricFloraTapejara(World world) {
		super(world);
		setSize(0.85F, 0.5F);
		minWidth = 0.10F;
		maxWidth = 0.85F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAPEJARA;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TAPEJARA_LOOT_YOUNG;
		}
		return LepidodendronMod.TAPEJARA_LOOT;
	}
