...
public class EntityPrehistoricFloraLunataspis extends EntityPrehistoricFloraTrilobiteSwimBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketLunataspis.block, (int) (1));
