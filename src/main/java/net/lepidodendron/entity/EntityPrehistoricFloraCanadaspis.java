...
import net.lepidodendron.item.entities.ItemBucketCanadaspis;
...
public class EntityPrehistoricFloraCanadaspis extends EntityPrehistoricFloraTrilobiteSwimBase {
	...
	public EntityPrehistoricFloraCanadaspis(World world) {
		super(world);
		setSize(0.25F, 0.25F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.CANADASPIS_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketCanadaspis.block, (int) (1));
