...
public class EntityPrehistoricFloraMurex extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraMurex(World world) {
		super(world, 26);
		setSize(0.2F, 0.2F);
	}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemMurex.block, (int) (1)));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MUREX;
	}
}