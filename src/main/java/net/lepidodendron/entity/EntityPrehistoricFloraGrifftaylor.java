...
public class EntityPrehistoricFloraGrifftaylor extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraGrifftaylor(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraGrifftaylor.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraGrifftaylor(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.GRIFFTAYLOR_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GRIFFTAYLOR;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraGrifftaylor EntityBase = EntityPrehistoricFloraGrifftaylor.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraGrifftaylor.this);
		}
