...
public class EntityPrehistoricFloraTegopelte extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TEGOPELTE;
	}
}