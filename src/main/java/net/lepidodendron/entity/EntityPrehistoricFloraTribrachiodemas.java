...
import net.lepidodendron.entity.render.entity.RenderTribrachiodemas;
...
public class EntityPrehistoricFloraTribrachiodemas extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraTribrachiodemas(World world) {
		super(world, 26);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TRIBRACHIODEMAS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTribrachiodemas;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTribrachiodemas.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TRIBRACHIODEMAS;
	}
}