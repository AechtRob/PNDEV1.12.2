...
public class EntityPrehistoricFloraMuhichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraMuhichthys(World world) {
		super(world);
		setSize(0.2F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MUHICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MUHICHTHYS;
	}
