...
public class EntityPrehistoricFloraKichkassia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraKichkassia(World world) {
		super(world);
		setSize(0.22F, 0.19F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.KICHKASSIA_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelKichkassia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderKichkassia.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_KICHKASSIA;
	}
