...
public class EntityPrehistoricFloraHescheleria extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraHescheleria(World world) {
		super(world);
		setSize(0.4F, 0.4F);
		minWidth = 0.15F;
		maxWidth = 0.4F;
		...
		STAND_ANIMATION = Animation.create(10);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, STAND_ANIMATION};
	}
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraHescheleria(this.world);
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(3, new AgeableFishWander(this, NO_ANIMATION, 0.1, 0, true));
...
//		this.targetTasks.addTask(6, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(ArrayUtils.addAll(DietString.SHELLFISH, DietString.CRUSTACEAN), DietString.NAUTILOID);
	}
...
//	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:xinpusaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:xinpusaurus_hurt"));
	...
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:xinpusaurus_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HESCHELERIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HESCHELERIA;
	}
}
