...
import net.lepidodendron.entity.render.entity.RenderBavariscyllium;
...
public class EntityPrehistoricFloraBavariscyllium extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BAVARISCYLLIUM_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BAVARISCYLLIUM;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBavariscyllium EntityBase = EntityPrehistoricFloraBavariscyllium.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBavariscyllium.this);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelBavariscyllium;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderBavariscyllium.getScaler();
	}
