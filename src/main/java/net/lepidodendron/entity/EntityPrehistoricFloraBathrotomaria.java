...
import net.lepidodendron.item.entities.ItemAkasakiella;
import net.lepidodendron.item.entities.ItemBathrotomaria;
...
public class EntityPrehistoricFloraBathrotomaria extends EntityPrehistoricFloraSlitheringWaterBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBathrotomaria(World world) {
		super(world, 26);
		setSize(0.2F, 0.185F);
	}
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (!this.world.isRemote && !this.isDead) {
			if ("player".equals(source.getDamageType())) {
				EntityItem entityToSpawn = new EntityItem(world, this.posX, this.posY, this.posZ, new ItemStack(ItemBathrotomaria.block, (int) (1)));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BATHROTOMARIA;
	}
