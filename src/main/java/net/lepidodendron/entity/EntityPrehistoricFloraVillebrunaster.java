...
public class EntityPrehistoricFloraVillebrunaster extends EntityPrehistoricFloraSlitheringWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraVillebrunaster(World world) {
		super(world, 60);
		setSize(0.3F, 0.2F);
	}
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.CORAL, DietString.FISHFOOD);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.VILLEBRUNASTER_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VILLEBRUNASTER;
	}
}