...
import net.lepidodendron.item.entities.ItemEggsCynognathus;
...
public class EntityPrehistoricFloraCynognathus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_cynognathus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsCynognathus.block, 1);
	}
