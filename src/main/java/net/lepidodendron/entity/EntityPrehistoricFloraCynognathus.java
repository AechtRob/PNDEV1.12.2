...
public class EntityPrehistoricFloraCynognathus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraCynognathus(World world) {
		super(world);
		setSize(0.99F, 0.9F);
		minWidth = 0.18F;
		maxWidth = 0.99F;
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.CYNOGNATHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.CYNOGNATHUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelCynognathus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderCynognathus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_CYNOGNATHUS;
	}
