...
public class EntityPrehistoricFloraMagnipterygius extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraMagnipterygius(World world) {
		super(world);
		setSize(0.53F, 0.5F);
		minWidth = 0.15F;
		maxWidth = 0.53F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraMagnipterygius(this.world);
	}
...
//		this.targetTasks.addTask(2, new HuntSmallerThanMeAIAgeable(this, EntityLiving.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.MAGNIPTERYGIUS_LOOT_YOUNG;
		}
		return LepidodendronMod.MAGNIPTERYGIUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_MAGNIPTERYGIUS;
	}
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderMagnipterygius.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelMagnipterygius;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderMagnipterygius.getScaler();
    }
