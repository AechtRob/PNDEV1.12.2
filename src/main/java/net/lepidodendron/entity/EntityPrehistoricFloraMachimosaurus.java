...
import net.lepidodendron.entity.render.entity.RenderMachimosaurus;
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAgeableFishBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0));
	...
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelMachimosaurus;}
	public static float getScaler(@Nullable String variant) {return RenderMachimosaurus.getScaler();}
