...
public class EntityPrehistoricFloraArabosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraArabosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraArabosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraArabosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARABOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARABOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraArabosteus EntityBase = EntityPrehistoricFloraArabosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraArabosteus.this);
		}
