...
public class EntityPrehistoricFloraEurynotus extends EntityPrehistoricFloraFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraEurynotus(World world) {
		super(world);
		setSize(0.15F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.EURYNOTUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EURYNOTUS;
	}
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 0.3;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderEurynotus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelEurynotus;}
	public static float getScaler(@Nullable String variant) {return RenderEurynotus.getScaler();}
