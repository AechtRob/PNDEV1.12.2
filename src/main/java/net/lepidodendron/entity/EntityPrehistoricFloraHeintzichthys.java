...
public class EntityPrehistoricFloraHeintzichthys extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraHeintzichthys(World world) {
		super(world);
		setSize(0.8F, 0.5F);
		minWidth = 0.2F;
		maxWidth = 0.8F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraHeintzichthys(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HEINTZICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HEINTZICHTHYS;
	}
