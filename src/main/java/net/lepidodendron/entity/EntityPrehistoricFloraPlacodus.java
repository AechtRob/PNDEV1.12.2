...
public class EntityPrehistoricFloraPlacodus extends EntityPrehistoricFloraSwimmingAmphibianBase implements IAdvancementGranter, ITrappableWater {
	...
	public net.minecraft.util.SoundEvent getAmbientSound() {
	    return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:placodus_idle"));
	}

	@Override
	public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
	    return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:placodus_hurt"));
	}

	@Override
	public net.minecraft.util.SoundEvent getDeathSound() {
	    return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:placodus_death"));
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PLACODUS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PLACODUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PLACODUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 0.9;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPlacodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPlacodus;}
	public static float getScaler(@Nullable String variant) {return RenderPlacodus.getScaler();}
}