...
public class EntityPrehistoricFloraHaikouichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraHaikouichthys(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HAIKOUICHTHYS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHaikouichthys;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHaikouichthys.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HAIKOUICHTHYS;
	}
}
