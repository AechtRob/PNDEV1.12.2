...
import net.lepidodendron.item.entities.ItemBucketHaikouichthys;
...
public class EntityPrehistoricFloraHaikouichthys extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketHaikouichthys.block, (int) (1));
