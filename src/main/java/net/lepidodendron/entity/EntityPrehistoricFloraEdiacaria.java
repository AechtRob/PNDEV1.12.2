...
public class EntityPrehistoricFloraEdiacaria extends EntityPrehistoricFloraEoandromeda implements ITrappableWater, IAdvancementGranter {
    ...
    public static String getPeriod() {return "Neoproterozoic (Tonian - Cryogenian - Ediacaran) - Cambrian";}
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_EDIACARIA;
    }
