...
public class EntityPrehistoricFloraVachonisia extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraVachonisia(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_VACHONISIA;
	}
}