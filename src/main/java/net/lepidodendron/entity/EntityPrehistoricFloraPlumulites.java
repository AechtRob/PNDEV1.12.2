...
public class EntityPrehistoricFloraPlumulites extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraPlumulites(World world) {
		super(world);
		setSize(0.3F, 0.20F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PLUMULITES_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLUMULITES;
	}
}