...
import net.lepidodendron.item.entities.ItemBucketSiberion;
...
public class EntityPrehistoricFloraSiberion extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketSiberion.block, (int) (1));
