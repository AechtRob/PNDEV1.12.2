...
import net.lepidodendron.block.BlockEggsParhybodus;
...
public class EntityPrehistoricFloraParhybodus extends EntityPrehistoricFloraAgeableFishBase {
...
//	}
	...
	public void onEntityUpdate() {
		...
		if (!world.isRemote && spaceCheckEggs() && this.isInWater() && this.isPFAdult() && this.getCanBreed() && (LepidodendronConfig.doMultiplyMobs || this.getLaying()) && this.getTicks() > 0
				&& (BlockEggsParhybodus.block.canPlaceBlockOnSide(world, this.getPosition(), EnumFacing.UP)
				|| BlockEggsParhybodus.block.canPlaceBlockOnSide(world, this.getPosition().down(), EnumFacing.UP))
				&& (BlockEggsParhybodus.block.canPlaceBlockAt(world, this.getPosition())
				|| BlockEggsParhybodus.block.canPlaceBlockAt(world, this.getPosition().down()))
		){
			//if (Math.random() > 0.5) {
		...
		if (!world.isRemote && spaceCheckEggs() && this.isInWater() && this.isPFAdult() && this.getTicks() > -30 && this.getTicks() < 0) {
			...
			IBlockState eggs = BlockEggsParhybodus.block.getDefaultState();
			if (BlockEggsParhybodus.block.canPlaceBlockOnSide(world, this.getPosition(), EnumFacing.UP) && BlockEggsParhybodus.block.canPlaceBlockAt(world, this.getPosition())) {
				world.setBlockState(this.getPosition(), eggs);
				this.setLaying(false);
				this.playSound(SoundEvents.ENTITY_CHICKEN_EGG, 1.0F, (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
			}
			if (BlockEggsParhybodus.block.canPlaceBlockOnSide(world, this.getPosition().down(), EnumFacing.UP) && BlockEggsParhybodus.block.canPlaceBlockAt(world, this.getPosition().down())) {
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.PARHYBODUS_LOOT_YOUNG;
		}
	...
	public static ResourceLocation textureDisplay() {
		return RenderDisplays.TEXTURE_PARHYBODUS;
	}
	@SideOnly(Side.CLIENT)
