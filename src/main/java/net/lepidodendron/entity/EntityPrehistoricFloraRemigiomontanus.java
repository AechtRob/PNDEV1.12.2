...
import net.lepidodendron.item.entities.ItemEggsRemigiomontanus;
...
public class EntityPrehistoricFloraRemigiomontanus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_remigiomontanus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsRemigiomontanus.block, 1);
	}
