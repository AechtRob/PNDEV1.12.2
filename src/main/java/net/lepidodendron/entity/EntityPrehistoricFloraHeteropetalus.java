...
public class EntityPrehistoricFloraHeteropetalus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	private static final DataParameter<Integer> HETEROPETALUS_TYPE = EntityDataManager.<Integer>createKey(EntityPrehistoricFloraHeteropetalus.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraHeteropetalus(World world) {
		super(world);
		setSize(0.2F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	protected void entityInit() {
		super.entityInit();
		this.dataManager.register(HETEROPETALUS_TYPE, 0);
	}
	...
	public boolean canMateWith(EntityAnimal otherAnimal)
	{
		...
		else if (otherAnimal.getClass() != this.getClass())
		{
			...
			switch (this.breedPNVariantsMatch()) {
				...
				case -1:
					if (((EntityPrehistoricFloraHeteropetalus)otherAnimal).getPNType() == this.getPNType()) {
						return false;
					}
					break;
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_heteropetalus_" + this.getPNType().getName() + ".name");
		}
	}
	...
	public enum Type
	{
		...
		public static EntityPrehistoricFloraHeteropetalus.Type byId(int id)
		{
		...
		public static EntityPrehistoricFloraHeteropetalus.Type getTypeFromString(String nameIn)
		{
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		this.setPNType(EntityPrehistoricFloraHeteropetalus.Type.byId(rand.nextInt(EntityPrehistoricFloraHeteropetalus.Type.values().length) + 1));
		return livingdata;
	}

	public void setPNType(EntityPrehistoricFloraHeteropetalus.Type type)
	{
		this.dataManager.set(HETEROPETALUS_TYPE, Integer.valueOf(type.ordinal()));
	}

	public EntityPrehistoricFloraHeteropetalus.Type getPNType()
	{
		return EntityPrehistoricFloraHeteropetalus.Type.byId(((Integer)this.dataManager.get(HETEROPETALUS_TYPE)).intValue());
	}
	...
	protected ResourceLocation getLootTable() {
		switch (this.getPNType()) {
			case MALE:
			default:
				return LepidodendronMod.HETEROPETALUS_LOOT;

			case FEMALE:
				return LepidodendronMod.HETEROPETALUS_LOOT_F;
		}
	}
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HETEROPETALUS;
	}
