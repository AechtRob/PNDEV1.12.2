...
import net.lepidodendron.entity.render.entity.RenderLurdusaurus;
...
public class EntityPrehistoricFloraLurdusaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraLurdusaurus(World world) {
		super(world);
		setSize(0.85F, 1.85F);
		minWidth = 0.2F;
		maxWidth = 0.85F;
        ...
        ALERT_ANIMATION = Animation.create(110);
...
//		}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_LURDUSAURUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.LURDUSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.LURDUSAURUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelLurdusaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderLurdusaurus.getScaler();
	}
