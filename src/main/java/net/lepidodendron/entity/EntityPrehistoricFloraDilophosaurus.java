...
public class EntityPrehistoricFloraDilophosaurus extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
...
//		this.targetTasks.addTask(4, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	public void onEntityUpdate() {
		...
		if ((!this.world.isRemote) && this.getAnimation() == CLEAN_ANIMATION && this.getAnimationTick() == CLEAN_ANIMATION.getDuration() - 1) {
			this.standCooldown = 3000;
			this.setAnimation(NO_ANIMATION);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelDilophosaurus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderDilophosaurus.getScaler();
	}
