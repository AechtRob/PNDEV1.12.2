...
public class EntityPrehistoricFloraTullimonstrum extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TULLIMONSTRUM;
	}
	@Nullable
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTullimonstrum.TEXTURE;}
	@SideOnly(Side.CLIENT)
