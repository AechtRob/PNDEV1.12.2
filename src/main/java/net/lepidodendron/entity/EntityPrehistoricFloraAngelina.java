...
public class EntityPrehistoricFloraAngelina extends EntityPrehistoricFloraTrilobiteSwimBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraAngelina(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANGELINA;
