...
public class EntityPrehistoricFloraArandaspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARANDASPIS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelArandaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderArandaspis.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARANDASPIS;
	}
