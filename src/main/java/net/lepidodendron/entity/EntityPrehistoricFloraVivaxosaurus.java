...
import net.lepidodendron.item.entities.ItemEggsVivaxosaurus;
...
public class EntityPrehistoricFloraVivaxosaurus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_vivaxosaurus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsVivaxosaurus.block, 1);
	}
