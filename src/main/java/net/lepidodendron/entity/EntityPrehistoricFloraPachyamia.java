...
import net.lepidodendron.entity.render.entity.RenderCratoamia;
import net.lepidodendron.entity.render.entity.RenderPachyamia;
...
public class EntityPrehistoricFloraPachyamia extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PACHYAMIA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPachyamia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPachyamia;}
	public static float getScaler(@Nullable String variant) {return RenderPachyamia.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PACHYAMIA;
	}
