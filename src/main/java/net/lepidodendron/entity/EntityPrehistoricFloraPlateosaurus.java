...
public class EntityPrehistoricFloraPlateosaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraPlateosaurus(World world) {
		super(world);
		setSize(0.9F, 1.8F);
		minWidth = 0.18F;
		maxWidth = 0.9F;
		...
		ALERT_ANIMATION = Animation.create(163);
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, DRINK_ANIMATION, ROAR_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, NOISE_ANIMATION, STAND_ANIMATION, GRAZE_ANIMATION, ALERT_ANIMATION, NOISE2_ANIMATION};
	}
	...
	public float getAISpeedLand() {
		...
		if (this.getAnimation() == DRINK_ANIMATION || this.getAnimation() == MAKE_NEST_ANIMATION || this.getAnimation() == STAND_ANIMATION || this.getAnimation() == GRAZE_ANIMATION || this.getAnimation() == ALERT_ANIMATION) {
			return 0.0F;
		}
		if (this.getIsFast()) {
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:plateosaurus_roar"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:plateosaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:plateosaurus_death"));
	}

	public SoundEvent getAmbientAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:plateosaurus_idle"));
	}
...
//			}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PLATEOSAURUS;
	}
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 1.4;}
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 1.0;}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPlateosaurus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPlateosaurus;}
	public static float getScaler(@Nullable String variant) {return RenderPlateosaurus.getScaler();}
}