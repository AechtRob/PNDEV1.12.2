...
public class EntityPrehistoricFloraPalaeontinid extends EntityPrehistoricFloraInsectFlyingBase implements IAdvancementGranter, ITrappableWater {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPalaeontinid.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPalaeontinid;}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PALAEONTINID;
	}
}