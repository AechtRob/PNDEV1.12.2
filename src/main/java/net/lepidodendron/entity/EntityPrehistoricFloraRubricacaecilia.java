...
import net.lepidodendron.entity.render.entity.RenderRubricacaecilia;
...
public class EntityPrehistoricFloraRubricacaecilia extends EntityPrehistoricFloraLandBase implements ITrappableWater, ITrappableLand, IAdvancementGranter, INeedsWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraRubricacaecilia(World world) {
		super(world);
		setSize(0.15F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.15F;
...
//		this.targetTasks.addTask(2, new HuntSmallerThanMeAIAgeable(this, EntityPrehistoricFloraAmphibianBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.15));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RUBRICACAECILIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RUBRICACAECILIA;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderRubricacaecilia.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelRubricacaecilia;}
	public static float getScaler(@Nullable String variant) {return RenderRubricacaecilia.getScaler();}
