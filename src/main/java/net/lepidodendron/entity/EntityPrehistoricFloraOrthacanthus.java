...
import net.lepidodendron.entity.render.entity.RenderOrthacanthus;
...
public class EntityPrehistoricFloraOrthacanthus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraOrthacanthus(World world) {
		super(world);
		setSize(0.65F, 0.6F);
		minWidth = 0.1F;
		maxWidth = 0.65F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.ORTHACANTHUS_LOOT_YOUNG;
		}
		return LepidodendronMod.ORTHACANTHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ORTHACANTHUS;
	}
