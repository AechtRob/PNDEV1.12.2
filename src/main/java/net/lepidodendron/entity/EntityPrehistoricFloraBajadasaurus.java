...
import net.lepidodendron.entity.render.entity.RenderBajadasaurus;
...
public class EntityPrehistoricFloraBajadasaurus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
    ...
    public EntityPrehistoricFloraBajadasaurus(World world) {
        super(world);
        setSize(1.8F, 2.7F);
        extraStepHeight = 1F;
        minWidth = 0.1F;
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_BAJADASAURUS;
    }

    @Nullable
    protected ResourceLocation getLootTable() {
        if (!this.isPFAdult()) {
            return LepidodendronMod.BAJADASAURUS_LOOT_YOUNG;
        }
        return LepidodendronMod.BAJADASAURUS_LOOT;
    }

    //Rendering taxidermy:
    //--------------------
    public static double offsetWall(@Nullable String variant) { return -0.225; }
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) {  return RenderBajadasaurus.TEXTURE; }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) { return RenderDisplays.modelBajadasaurus; }
    public static float getScaler(@Nullable String variant) { return RenderBajadasaurus.getScaler(); }
