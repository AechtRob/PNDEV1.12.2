...
public class EntityPrehistoricFloraErikaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraErikaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraErikaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraErikaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ERIKASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ERIKASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraErikaspis EntityBase = EntityPrehistoricFloraErikaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraErikaspis.this);
		}
