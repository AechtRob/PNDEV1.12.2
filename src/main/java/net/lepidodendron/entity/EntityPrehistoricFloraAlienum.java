...
import net.lepidodendron.entity.render.entity.RenderAlienum;
...
public class EntityPrehistoricFloraAlienum extends EntityPrehistoricFloraFishBase  implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAlienum(World world) {
		super(world);
		setSize(0.15F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ALIENUM_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderAlienum.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelAlienum;}
	public static float getScaler(@Nullable String variant) {return RenderAlienum.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ALIENUM;
	}
}