...
public class EntityPrehistoricFloraRomundina extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraRomundina(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraRomundina.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraRomundina(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ROMUNDINA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ROMUNDINA;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraRomundina EntityBase = EntityPrehistoricFloraRomundina.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraRomundina.this);
		}
