...
import net.lepidodendron.item.entities.ItemBucketPaucipodia;
...
public class EntityPrehistoricFloraPaucipodia extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	private static final DataParameter<Integer> LOOKTICK = EntityDataManager.createKey(EntityPrehistoricFloraPaucipodia.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraPaucipodia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PAUCIPODIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPaucipodia.block, (int) (1));
