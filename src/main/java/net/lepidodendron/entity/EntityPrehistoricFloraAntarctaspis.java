...
public class EntityPrehistoricFloraAntarctaspis extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraAntarctaspis(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraAntarctaspis.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraAntarctaspis(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ANTARCTASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ANTARCTASPIS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraAntarctaspis EntityBase = EntityPrehistoricFloraAntarctaspis.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraAntarctaspis.this);
		}
