...
import net.lepidodendron.entity.render.entity.RenderProtoceratops;
...
public class EntityPrehistoricFloraProtoceratops extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraProtoceratops(World world) {
		super(world);
		setSize(0.85F, 1.85F);
		minWidth = 0.2F;
		maxWidth = 0.85F;
...
//		}
    ...
    public Animation[] getAnimations() {
        return new Animation[]{ATTACK_ANIMATION, ROAR_ANIMATION, MAKE_NEST_ANIMATION, LAY_ANIMATION, EAT_ANIMATION, STAND_ANIMATION, ALERT_ANIMATION, DRINK_ANIMATION};
    }
	@Override
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:protoceratops_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:protoceratops_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:protoceratops_death"));
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROTOCERATOPS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PROTOCERATOPS_LOOT_YOUNG;
		}
		return LepidodendronMod.PROTOCERATOPS_LOOT;
	}
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) {
		return RenderProtoceratops.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelProtoceratops;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderProtoceratops.getScaler();
	}
