...
public class EntityPrehistoricFloraTeraterpeton extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraTeraterpeton(World world) {
		super(world);
		setSize(0.9F, 0.4F);
		minWidth = 0.12F;
		maxWidth = 0.9F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TERATERPETON;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TERATERPETON_LOOT_YOUNG;
		}
		return LepidodendronMod.TERATERPETON_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTeraterpeton.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTeraterpeton;}
	public static float getScaler(@Nullable String variant) {return RenderTeraterpeton.getScaler();}
