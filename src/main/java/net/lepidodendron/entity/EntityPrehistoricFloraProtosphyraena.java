...
import net.lepidodendron.entity.render.entity.RenderProtosphyraena;
...
public class EntityPrehistoricFloraProtosphyraena extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater {
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraProtosphyraena(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PROTOSPHYRAENA_LOOT;
	}
