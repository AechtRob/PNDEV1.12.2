...
public class EntityPrehistoricFloraHolonema extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HOLONEMA_LOOT;
	}
	...
	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraHolonema EntityBase = EntityPrehistoricFloraHolonema.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraHolonema.this);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelHolonema;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderHolonema.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HOLONEMA;
	}
}