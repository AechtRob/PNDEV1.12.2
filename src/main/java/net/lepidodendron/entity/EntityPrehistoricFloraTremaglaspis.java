...
import net.lepidodendron.entity.render.entity.RenderTremaglaspis;
...
public class EntityPrehistoricFloraTremaglaspis extends EntityPrehistoricFloraTrilobiteBottomBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTremaglaspis(World world) {
		super(world);
		setSize(0.2F, 0.2F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TREMAGLASPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTremaglaspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTremaglaspis;}
	public static float getScaler(@Nullable String variant) {return RenderTremaglaspis.getScaler();}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TREMAGLASPIS;
	}
}