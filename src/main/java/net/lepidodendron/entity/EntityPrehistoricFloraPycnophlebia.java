...
public class EntityPrehistoricFloraPycnophlebia extends EntityPrehistoricFloraLeapingInsectBase implements IAdvancementGranter, ITrappableLand {
	...
	public Animation[] getAnimations() {
		return new Animation[]{ATTACK_ANIMATION, EAT_ANIMATION, STAND_ANIMATION, ROAR_ANIMATION};
	}
	...
	public ResourceLocation getEggTexture(@Nullable String variantIn) {
		return new ResourceLocation(LepidodendronMod.MODID + ":textures/entities/eggs_pycnophlebia.png");
	}
	...
	public String getName() {
		...
		{
			return I18n.translateToLocal("entity.prehistoric_flora_pycnophlebia_" + this.getPNType().getName() + ".name");
		}
	}
	...
	public static double offsetWall(@Nullable String variant) {return 0.0;}
