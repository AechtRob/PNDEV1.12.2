...
public class EntityPrehistoricFloraElginia extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {
	...
	public SoundEvent getAmbientSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:elginia_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:elginia_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:elginia_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.ELGINIA_LOOT_YOUNG;
		}
		return LepidodendronMod.ELGINIA_LOOT;
	}

	//Rendering taxidermy:
	//--------------------
	public static double offsetPlinth() { return 0.6; }
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelElginia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderElginia.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ELGINIA;
	}
}