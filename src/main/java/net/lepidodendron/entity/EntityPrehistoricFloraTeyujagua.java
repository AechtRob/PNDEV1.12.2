...
public class EntityPrehistoricFloraTeyujagua extends EntityPrehistoricFloraLandBase implements ITrappableLand, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTeyujagua(World world) {
		super(world);
		setSize(0.6F, 0.32F);
		minWidth = 0.18F;
		maxWidth = 0.6F;
...
//		this.targetTasks.addTask(5, new HuntSmallerThanMeAIAgeable(this, EntityLivingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase, 0.2));
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TEYUJAGUA_LOOT_YOUNG;
		}
		return LepidodendronMod.TEYUJAGUA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TEYUJAGUA;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTeyujagua.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTeyujagua;}
	public static float getScaler(@Nullable String variant) {return RenderTeyujagua.getScaler();}
