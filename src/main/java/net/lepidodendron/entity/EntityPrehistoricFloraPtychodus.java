...
import net.lepidodendron.entity.render.entity.RenderPtychodus;
...
public class EntityPrehistoricFloraPtychodus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraPtychodus(World world) {
		super(world);
		setSize(1.5F, 1.6F);
		minWidth = 0.1F;
		minWidth = 0.1F;
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.PTYCHODUS_LOOT_YOUNG;
		}
		return LepidodendronMod.PTYCHODUS_LOOT;
	}

	//Rendering taxidermy:
	//--------------------
	public static double offsetWall(@Nullable String variant) {return -0.45;}
	public static double upperfrontverticallinedepth(@Nullable String variant) {return 2.5;}
	public static double upperbackverticallinedepth(@Nullable String variant) {return 2.5;}
	public static double upperfrontlineoffset(@Nullable String variant) {return 0.0;}
	public static double upperfrontlineoffsetperpendiular(@Nullable String variant) {return 0.8;}
	public static double upperbacklineoffset(@Nullable String variant) {return 0.0;}
	public static double upperbacklineoffsetperpendiular(@Nullable String variant) {return -1.5;}
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 2.5;}
	public static double lowerbackverticallinedepth(@Nullable String variant) {return 2.5;}
	public static double lowerfrontlineoffset(@Nullable String variant) {return 0.0;}
	public static double lowerfrontlineoffsetperpendiular(@Nullable String variant) {return 0.8;}
	public static double lowerbacklineoffset(@Nullable String variant) {return 0.0;}
	public static double lowerbacklineoffsetperpendiular(@Nullable String variant) {return -1.5;}
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPtychodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPtychodus;}
	public static float getScaler(@Nullable String variant) {return RenderPtychodus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.12F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PTYCHODUS;
	}
}
