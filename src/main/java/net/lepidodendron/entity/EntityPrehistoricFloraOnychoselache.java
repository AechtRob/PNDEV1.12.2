...
public class EntityPrehistoricFloraOnychoselache extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraOnychoselache(World world) {
		super(world);
		setSize(0.4F, 0.2F);
		minWidth = 0.2F;
		maxWidth = 0.4F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraOnychoselache(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ONYCHOSELACHE_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderOnychoselache.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelOnychoselache;}
	public static float getScaler(@Nullable String variant) {return RenderOnychoselache.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.018F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ONYCHOSELACHE;
	}
