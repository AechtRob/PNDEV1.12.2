...
public class EntityPrehistoricFloraCoelacanthus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static String getPeriod() {return "[$(o)Devonian (?) - Carboniferous (?) - $()] Permian [$(o) - Triassic (?)$()]";}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelCoelacanthus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderCoelacanthus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_COELACANTHUS;
	}
