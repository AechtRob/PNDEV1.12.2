...
import net.lepidodendron.item.entities.ItemBucketQilinyu;
...
public class EntityPrehistoricFloraQilinyu extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketQilinyu.block, (int) (1));
