...
public class EntityPrehistoricFloraPeltobatrachus extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraPeltobatrachus(World world) {
		super(world);
		setSize(1.1F, 1.1F);
		minWidth = 0.2F;
		maxWidth = 0.7F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PELTOBATRACHUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PELTOBATRACHUS;
	}
