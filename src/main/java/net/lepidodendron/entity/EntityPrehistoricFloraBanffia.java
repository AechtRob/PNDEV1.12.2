...
import net.lepidodendron.item.entities.ItemBucketBanffia;
...
public class EntityPrehistoricFloraBanffia extends EntityPrehistoricFloraFishBase {
	...
	public EntityPrehistoricFloraBanffia(World world) {
		super(world);
		setSize(0.3F, 0.3F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BANFFIA_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketBanffia.block, (int) (1));
