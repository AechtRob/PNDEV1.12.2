...
public class EntityPrehistoricFloraPatagotitan extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraPatagotitan(World world) {
		super(world);
		setSize(3.0F, 5F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PATAGOTITAN;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.PATAGOTITAN_LOOT_YOUNG;
		}
		return LepidodendronMod.PATAGOTITAN_LOOT;
	}
