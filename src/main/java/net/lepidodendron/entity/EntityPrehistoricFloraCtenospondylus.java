...
import net.lepidodendron.item.entities.ItemEggsCtenospondylus;
...
public class EntityPrehistoricFloraCtenospondylus extends EntityPrehistoricFloraLandBase {
	...
	public String tagEgg() {
		return "eggs_ctenospondylus";
	}

	@Override
	public ItemStack eggItemStack() {
		return new ItemStack(ItemEggsCtenospondylus.block, 1);
	}
