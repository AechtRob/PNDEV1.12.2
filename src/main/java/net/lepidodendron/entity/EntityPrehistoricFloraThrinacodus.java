...
public class EntityPrehistoricFloraThrinacodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THRINACODUS;
	}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.THRINACODUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderThrinacodus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelThrinacodus;}
	public static float getScaler(@Nullable String variant) {return RenderThrinacodus.getScaler();}
