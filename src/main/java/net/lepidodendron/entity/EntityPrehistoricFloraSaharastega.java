...
public class EntityPrehistoricFloraSaharastega extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;
	public EntityPrehistoricFloraSaharastega(World world) {
		super(world);
		setSize(0.65F, 0.350F);
		minWidth = 0.1F;
		maxWidth = 0.65F;
		maxHeight = 0.350F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SAHARASTEGA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SAHARASTEGA;
	}
}