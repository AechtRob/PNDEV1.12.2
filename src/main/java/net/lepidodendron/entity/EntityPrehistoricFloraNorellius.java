...
public class EntityPrehistoricFloraNorellius extends EntityPrehistoricFloraLandClimbingBase implements ITrappableLand, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraNorellius(World world) {
		super(world);
		setSize(0.30F, 0.25F);
		minWidth = 0.10F;
		maxWidth = 0.30F;
	...
	public void applyEntityCollision(Entity entityIn) {
		...
		if (!(entityIn instanceof EntityPrehistoricFloraNorellius)) {
	...
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:norellius_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:norellius_death"));
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.NORELLIUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_NORELLIUS;
	}
	//Rendering taxidermy:
	//--------------------
    ...
    @SideOnly(Side.CLIENT)
    public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderNorellius.TEXTURE;
    }
    @SideOnly(Side.CLIENT)
    public static ModelBase modelDisplay(@Nullable String variant) {
        return RenderDisplays.modelNorellius;
    }
    public static float getScaler(@Nullable String variant) {
        return RenderNorellius.getScaler();
    }
