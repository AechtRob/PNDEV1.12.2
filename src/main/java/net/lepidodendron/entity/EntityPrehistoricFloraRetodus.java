...
public class EntityPrehistoricFloraRetodus extends EntityPrehistoricFloraSwimmingAmphibianBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraRetodus(World world) {
		super(world);
		setSize(0.8F, 0.3F);
		minWidth = 0.4F;
		maxWidth = .9F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.RETODUS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_RETODUS;
	}
}
