...
import net.lepidodendron.item.entities.ItemBucketPoraspis;
...
public class EntityPrehistoricFloraPoraspis extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketPoraspis.block, (int) (1));
