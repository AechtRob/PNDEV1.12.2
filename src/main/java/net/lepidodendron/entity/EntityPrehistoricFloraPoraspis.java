...
public class EntityPrehistoricFloraPoraspis extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPoraspis(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PORASPIS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PORASPIS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPoraspis.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPoraspis;}
	public static float getScaler(@Nullable String variant) {return RenderPoraspis.getScaler();}
