...
public class EntityPrehistoricFloraHaqelpycnodus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraHaqelpycnodus(World world) {
		super(world);
		setSize(0.25F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.HAQELPYCNODUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_HAQELPYCNODUS;
	}
