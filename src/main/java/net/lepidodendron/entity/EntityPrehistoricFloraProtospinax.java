...
import net.lepidodendron.entity.render.entity.RenderProtospinax;
...
public class EntityPrehistoricFloraProtospinax extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PROTOSPINAX_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PROTOSPINAX;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraProtospinax EntityBase = EntityPrehistoricFloraProtospinax.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraProtospinax.this);
		}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelProtospinax;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderProtospinax.getScaler();
	}
