...
public class EntityPrehistoricFloraDickosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraDickosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraDickosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraDickosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DICKOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DICKOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraDickosteus EntityBase = EntityPrehistoricFloraDickosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraDickosteus.this);
		}
