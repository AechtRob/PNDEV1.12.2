...
public class EntityPrehistoricFloraSyringocrinus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSyringocrinus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSyringocrinus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SYRINGOCRINUS;
	}
}
