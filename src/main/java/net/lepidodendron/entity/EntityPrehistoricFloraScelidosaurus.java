...
public class EntityPrehistoricFloraScelidosaurus extends EntityPrehistoricFloraBiQuadLandBase implements IAdvancementGranter, IBluffer, ITrappableLand {
	...
	public EntityPrehistoricFloraScelidosaurus(World world) {
		super(world);
		setSize(1F, 1F);
		minWidth = 0.20F;
		maxWidth = 1F;
...
//	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:scelidosaurus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:scelidosaurus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:scelidosaurus_death"));
	}
	...
	public void onLivingUpdate() {
		...
		if ((!this.world.isRemote) && this.getAnimation() == ROAR_ANIMATION && this.getWarnTarget() != null
			...
			List<EntityPrehistoricFloraScelidosaurus> Camptosaurus = this.world.getEntitiesWithinAABB(EntityPrehistoricFloraScelidosaurus.class, new AxisAlignedBB(this.getPosition().add(-12, -6, -12), this.getPosition().add(12, 6, 12)));
			for (EntityPrehistoricFloraScelidosaurus currentCamptosaurus : Camptosaurus) {
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SCELIDOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SCELIDOSAURUS_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCELIDOSAURUS;
	}
