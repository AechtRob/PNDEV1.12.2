...
public class EntityPrehistoricFloraBelantsea extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraBelantsea(World world) {
		super(world);
		setSize(0.5F, 0.3F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BELANTSEA_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderBelantsea.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelBelantsea;}
	public static float getScaler(@Nullable String variant) {return RenderBelantsea.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.04F;}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BELANTSEA;
	}
