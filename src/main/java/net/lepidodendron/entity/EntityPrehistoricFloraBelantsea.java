...
import net.lepidodendron.item.entities.ItemBucketBelantsea;
...
public class EntityPrehistoricFloraBelantsea extends EntityPrehistoricFloraFishBase {
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketBelantsea.block, (int) (1));
