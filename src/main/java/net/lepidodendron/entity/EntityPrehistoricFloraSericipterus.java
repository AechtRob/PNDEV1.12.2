...
import net.lepidodendron.entity.render.entity.RenderSericipterus;
...
public class EntityPrehistoricFloraSericipterus extends EntityPrehistoricFloraLandClimbingFlyingWalkingBase implements IAdvancementGranter, IGuano, IScreamerFlier, ITrappableLand {
	...
	public EntityPrehistoricFloraSericipterus(World world) {
		super(world);
		setSize(0.85F, 0.5F);
		minWidth = 0.10F;
		maxWidth = 0.85F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SERICIPTERUS;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SERICIPTERUS_LOOT_YOUNG;
		}
		return LepidodendronMod.SERICIPTERUS_LOOT;
	}
	...
	public SoundEvent getAmbientSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:sericipterus_idle"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:sericipterus_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return (SoundEvent) SoundEvent.REGISTRY.getObject(new ResourceLocation("lepidodendron:sericipterus_death"));
	}

	public SoundEvent getAlarmSound() {
		return (SoundEvent) SoundEvent.REGISTRY
				.getObject(new ResourceLocation("lepidodendron:sericipterus_alarm"));
	}
...
//		return "lepidodendron:prehistoric_flora_sericipterus";
//	}
	...
	public static double lowerfrontverticallinedepth(@Nullable String variant) {return 0.55;}
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderSericipterus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelSericipterus;}
	public static float getScaler(@Nullable String variant) {return RenderSericipterus.getScaler();}
	public static float widthSupport(@Nullable String variant) {return 0.055F;}
