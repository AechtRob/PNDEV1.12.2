...
import net.lepidodendron.item.entities.ItemBucketYorgia;
...
public class EntityPrehistoricFloraYorgia extends EntityPrehistoricFloraSlitheringWaterBase {
	...
	public EntityPrehistoricFloraYorgia(World world) {
		super(world, 50);
		setSize(0.4F, 0.3F);
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketYorgia.block, (int) (1));
