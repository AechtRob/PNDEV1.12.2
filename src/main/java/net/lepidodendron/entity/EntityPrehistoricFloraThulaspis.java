...
import net.lepidodendron.entity.render.entity.RenderThulaspis;
...
public class EntityPrehistoricFloraThulaspis extends EntityPrehistoricFloraTrilobiteSwimBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraThulaspis(World world) {
		super(world);
		setSize(0.2F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.THULASPIS_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelThulaspis;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderThulaspis.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_THULASPIS;
	}
}