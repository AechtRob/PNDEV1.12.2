...
public class EntityPrehistoricFloraCassinoceras extends EntityPrehistoricFloraNautiloidBase {
	...
	public void onEntityUpdate() {
		...
		if (!world.isRemote && this.isPFAdult() && this.getCanBreed() && (LepidodendronConfig.doMultiplyMobs || this.getLaying())) {
			if (Math.random() > 0.5) {
				ItemStack itemstack = new ItemStack(ItemNautiloidEggsCassinoceras.block, (int) (1));
