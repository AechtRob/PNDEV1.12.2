...
public class EntityPrehistoricFloraTrimeroceras extends EntityPrehistoricFloraNautiloidBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraTrimeroceras(World world) {
		super(world);
		setSize(0.2F, 0.4F);
		minWidth = 0.07F;
		maxWidth = 0.2F;
