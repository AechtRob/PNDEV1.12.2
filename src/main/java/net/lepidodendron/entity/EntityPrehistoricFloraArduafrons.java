...
public class EntityPrehistoricFloraArduafrons extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraArduafrons(World world) {
		super(world);
		setSize(0.5F, 0.5F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ARDUAFRONS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ARDUAFRONS;
	}
}