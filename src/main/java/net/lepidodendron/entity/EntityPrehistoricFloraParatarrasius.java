...
public class EntityPrehistoricFloraParatarrasius extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PARATARRASIUS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARATARRASIUS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderParatarrasius.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelParatarrasius;}
	public static float getScaler(@Nullable String variant) {return RenderParatarrasius.getScaler();}
