...
public class EntityPrehistoricFloraEurhinosaurus extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;

	public EntityPrehistoricFloraEurhinosaurus(World world) {
		super(world);
		setSize(1.2F, 0.99F);
		minWidth = 0.15F;
		maxWidth = 1.2F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraEurhinosaurus(this.world);
	}
...
//	}
	...
	protected ResourceLocation getLootTable() {
		 		if (!this.isPFAdult()) {
			return LepidodendronMod.EURHINOSAURUS_LOOT_YOUNG;
		}
		return LepidodendronMod.EURHINOSAURUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_EURHINOSAURUS;
	}
}
