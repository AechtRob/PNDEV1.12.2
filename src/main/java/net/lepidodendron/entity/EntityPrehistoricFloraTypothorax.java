...
public class EntityPrehistoricFloraTypothorax extends EntityPrehistoricFloraLandBase implements IAdvancementGranter, ITrappableLand {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer tailBuffer;
	private int standCooldown;
	public EntityPrehistoricFloraTypothorax(World world) {
		super(world);
		setSize(0.99F, 0.7F);
		minWidth = 0.3F;
		maxWidth = 0.99F;
...
//	}
	...
	public int getDrinkLength() {
		return 240;  //grazes, does not drink
	}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.TYPOTHORAX_LOOT_YOUNG;
		}
		return LepidodendronMod.TYPOTHORAX_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TYPOTHORAX;
	}
