...
//	}
	...
	public static ResourceLocation textureDisplay(@Nullable String variant) { return RenderAnhanguera.TEXTURE;
	}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelAnhanguera;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderAnhanguera.getScaler();
	}
