...
public class EntityPrehistoricFloraTaemasosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraTaemasosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraTaemasosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraTaemasosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TAEMASOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TAEMASOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraTaemasosteus EntityBase = EntityPrehistoricFloraTaemasosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraTaemasosteus.this);
		}
