...
public class EntityPrehistoricFloraEryon extends EntityPrehistoricFloraTrilobiteBottomBase implements IAdvancementGranter, ITrappableWater {
	...
	public String[] getFoodOreDicts() {
		return ArrayUtils.addAll(DietString.CRUSTACEAN, DietString.ROTTEN);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ERYON_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ERYON;
	}
}
