...
import net.lepidodendron.entity.render.entity.RenderTimorebestia;
...
public class EntityPrehistoricFloraTimorebestia extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraTimorebestia(World world) {
		super(world);
		setSize(0.3F, 0.25F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(2, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.TIMOREBESTIA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_TIMOREBESTIA;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelTimorebestia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderTimorebestia.getScaler();
	}
