...
import net.lepidodendron.entity.render.entity.RenderOreochima;
...
public class EntityPrehistoricFloraOreochima extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOreochima;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderOreochima.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_OREOCHIMA;
	}
}
