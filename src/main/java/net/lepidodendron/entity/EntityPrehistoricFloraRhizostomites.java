...
public class EntityPrehistoricFloraRhizostomites extends EntityPrehistoricFloraJellyfishBase implements ITrappableWater, IAdvancementGranter {
    ...
    public EntityPrehistoricFloraRhizostomites(World world) {
        super(world);
        setSize(0.2F, 0.2F);
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.CLICK_RHIZOSTOMITES;
    }
