...
public class EntityPrehistoricFloraGastonia extends EntityPrehistoricFloraLandCarnivoreBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraGastonia(World world) {
		super(world);
		setSize(1.45F, 1.5F);
		minWidth = 0.2F;
		maxWidth = 1.45F;
	...
	public SoundEvent getHurtSound(DamageSource ds) {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:gastonia_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
	    return (SoundEvent) SoundEvent.REGISTRY
	            .getObject(new ResourceLocation("lepidodendron:gastonia_death"));
	}
	...
	public boolean attackEntityFrom(DamageSource ds, float i) {
		...
		if (result && ds.getTrueSource() instanceof EntityLivingBase && this.getAnimation() != HIDE_ANIMATION && this.getHealth() < this.maxHealthAgeable*0.2F) {
			...
			EntityPrehistoricFloraGastonia.this.getNavigator().clearPath();
		}
	...
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.GASTONIA_LOOT_YOUNG;
		}
		return LepidodendronMod.GASTONIA_LOOT;
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		 return ModTriggers.CLICK_GASTONIA;
	}
