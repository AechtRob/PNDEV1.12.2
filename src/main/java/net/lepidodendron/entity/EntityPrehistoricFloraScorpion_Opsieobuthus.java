...
public class EntityPrehistoricFloraScorpion_Opsieobuthus extends EntityPrehistoricFloraScorpion implements IAdvancementGranter, ITrappableAir {
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SCORPION_OPSIEOBUTHUS;
	}
	//-------------------
