...
public class EntityPrehistoricFloraMecochirus extends EntityPrehistoricFloraTrilobiteBottomBase {
	...
	public EntityPrehistoricFloraMecochirus(World world) {
		super(world);
		setSize(0.25F, 0.15F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.MECOCHIRUS_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelMecochirus;
	}
