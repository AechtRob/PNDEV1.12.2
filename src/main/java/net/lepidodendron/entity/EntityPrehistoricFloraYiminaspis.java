...
public class EntityPrehistoricFloraYiminaspis extends EntityPrehistoricFloraSwimmingBottomWalkingWaterBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraYiminaspis(World world) {
		super(world);
		setSize(0.14F, 0.1F);
		minWidth = 0.1F;
		maxWidth = 0.14F;
    ...
    public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
        return new EntityPrehistoricFloraYiminaspis(this.world);
    }
	@Override
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.YIMINASPIS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_YIMINASPIS;
	}
