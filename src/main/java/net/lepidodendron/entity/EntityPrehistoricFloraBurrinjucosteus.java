...
public class EntityPrehistoricFloraBurrinjucosteus extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraBurrinjucosteus(World world) {
		super(world);
		if (world != null) {
			this.moveHelper = new EntityPrehistoricFloraBurrinjucosteus.SwimmingMoveHelperBase();
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraBurrinjucosteus(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.BURRINJUCOSTEUS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_BURRINJUCOSTEUS;
	}

	class SwimmingMoveHelperBase extends EntityMoveHelper {
		private final EntityPrehistoricFloraBurrinjucosteus EntityBase = EntityPrehistoricFloraBurrinjucosteus.this;

		public SwimmingMoveHelperBase() {
			super(EntityPrehistoricFloraBurrinjucosteus.this);
		}
