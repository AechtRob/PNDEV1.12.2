...
public class EntityPrehistoricFloraPalaeoniscum extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraPalaeoniscum(World world) {
		super(world);
		setSize(0.3F, 0.3F);
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PALAEONISCUM;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PALAEONISCUM_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderPalaeoniscum.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelPalaeoniscum;}
	public static float getScaler(@Nullable String variant) {return RenderPalaeoniscum.getScaler();}
}
