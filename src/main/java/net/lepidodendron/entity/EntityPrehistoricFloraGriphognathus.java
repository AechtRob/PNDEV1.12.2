...
public class EntityPrehistoricFloraGriphognathus extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelGriphognathus;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderGriphognathus.getScaler();
	}

	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_GRIPHOGNATHUS;
	}
}