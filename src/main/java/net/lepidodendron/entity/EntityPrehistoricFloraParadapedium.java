...
public class EntityPrehistoricFloraParadapedium extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraParadapedium(World world) {
		super(world);
		setSize(0.4F, 0.4F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARADAPEDIUM_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARADAPEDIUM;
	}
}
