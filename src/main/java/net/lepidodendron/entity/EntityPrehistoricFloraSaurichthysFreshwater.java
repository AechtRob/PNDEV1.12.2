...
import net.lepidodendron.item.entities.ItemBucketSaurichthysFreshwater;
...
public class EntityPrehistoricFloraSaurichthysFreshwater extends EntityPrehistoricFloraAgeableFishBase {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraSaurichthysFreshwater(World world) {
		super(world);
		setSize(0.5F, 0.4F);
		experienceValue = 0;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.SAURICHTHYS_FRESHWATER_LOOT;
	}
	...
	public boolean processInteract(EntityPlayer player, EnumHand hand)
	{
		...
		if (!itemstack.isEmpty())
		{
			if (itemstack.getItem() == Items.WATER_BUCKET)
			{
				...
				ItemStack itemstack1 = new ItemStack(ItemBucketSaurichthysFreshwater.block, (int) (1));
