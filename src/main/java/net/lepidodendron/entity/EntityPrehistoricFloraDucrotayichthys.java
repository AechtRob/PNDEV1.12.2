...
public class EntityPrehistoricFloraDucrotayichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraDucrotayichthys(World world) {
		super(world);
		setSize(0.1F, 0.1F);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.DUCROTAYICHTHYS_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_DUCROTAYICHTHYS;
	}
