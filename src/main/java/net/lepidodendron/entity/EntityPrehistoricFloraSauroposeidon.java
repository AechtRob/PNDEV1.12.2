...
public class EntityPrehistoricFloraSauroposeidon extends EntityPrehistoricFloraLandWadingBase implements IAdvancementGranter, ITrappableLand {
	...
	public EntityPrehistoricFloraSauroposeidon(World world) {
		super(world);
		setSize(3.0F, 5F);
		extraStepHeight = 1F;
		minWidth = 0.1F;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SAUROPOSEIDON;
	}

	@Nullable
	protected ResourceLocation getLootTable() {
		if (!this.isPFAdult()) {
			return LepidodendronMod.SAUROPOSEIDON_LOOT_YOUNG;
		}
		return LepidodendronMod.SAUROPOSEIDON_LOOT;
	}
