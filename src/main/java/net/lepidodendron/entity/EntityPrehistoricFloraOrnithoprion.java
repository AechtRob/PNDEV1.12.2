...
public class EntityPrehistoricFloraOrnithoprion extends EntityPrehistoricFloraAgeableFishBase implements IAdvancementGranter, ITrappableWater {

	public BlockPos currentTarget;
	@SideOnly(Side.CLIENT)
	public ChainBuffer chainBuffer;

	public EntityPrehistoricFloraOrnithoprion(World world) {
		super(world);
		setSize(0.3F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.3F;
...
//		this.targetTasks.addTask(1, new HuntAI(this, EntitySquid. class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.ORNITHOPRION_LOOT;
	}
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelOrnithoprion;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_ORNITHOPRION;
	}
