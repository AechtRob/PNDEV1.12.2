...
public class EntityPrehistoricFloraParanaichthys extends EntityPrehistoricFloraFishBase implements IAdvancementGranter, ITrappableWater {
	...
	public EntityPrehistoricFloraParanaichthys(World world) {
		super(world);
		setSize(0.3F, 0.25F);
	}
	...
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {return ModTriggers.CLICK_PARANAICHTHYS;}
	@Nullable
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARANAICHTHYS_LOOT;
	}
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderParanaichthys.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelParanaichthys;}
	public static float getScaler(@Nullable String variant) {return RenderParanaichthys.getScaler();}
