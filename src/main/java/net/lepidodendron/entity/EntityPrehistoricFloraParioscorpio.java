...
public class EntityPrehistoricFloraParioscorpio extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	public EntityPrehistoricFloraParioscorpio(World world) {
		super(world);
		setSize(0.6F, 0.25F);
		minWidth = 0.2F;
		maxWidth = 0.6F;
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.PARIOSCORPIO_LOOT;
	}
	//Rendering taxidermy:
	//--------------------
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelParioscorpio;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderParioscorpio.getScaler();
	}
	public static float widthSupport(@Nullable String variant) {return 0.038F;}
	@Nullable
	@Override
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_PARIOSCORPIO;
	}
}