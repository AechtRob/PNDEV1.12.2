...
public class EntityPrehistoricFloraIdmonarachne extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	public EntityPrehistoricFloraIdmonarachne(World world) {
		super(world);
		setSize(0.2F, 0.2F);
		minWidth = 0.1F;
		maxWidth = 0.2F;
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderIdmonarachne.TEXTURE;}
	@SideOnly(Side.CLIENT)
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
	{
		if (source == BlockGlassJar.BlockCustom.FREEZE) {
			...
			ResourceLocation resourcelocation = LepidodendronMod.IDMONARACHNE_JAR_LOOT;
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_IDMONARACHNE;
	}
}