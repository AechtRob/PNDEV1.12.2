...
public class EntityPrehistoricFloraTrigonotarbid_Palaeotarbus extends EntityPrehistoricFloraLandClimbingBase implements ITrappableAir, IAdvancementGranter {
	...
	@SideOnly(Side.CLIENT)
	public static ResourceLocation textureDisplay(@Nullable String variant) {return RenderTrigonotarbid_Palaeotarbus.TEXTURE;}
	@SideOnly(Side.CLIENT)
	public static ModelBase modelDisplay(@Nullable String variant) {return RenderDisplays.modelTrigonotarbid;}
	public static float getScaler(@Nullable String variant) {
		return RenderTrigonotarbid_Palaeotarbus.getScaler();
	}
	...
	public static float getScalerMagnified(@Nullable String variant) {
		return RenderTrigonotarbid_Palaeotarbus.getScaler() * 5.0F;
	}
