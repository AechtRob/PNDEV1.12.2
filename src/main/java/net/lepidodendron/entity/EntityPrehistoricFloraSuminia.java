...
public class EntityPrehistoricFloraSuminia extends EntityPrehistoricFloraLandClimbingBase implements IAdvancementGranter, IScreamer, ITrappableLand {
	...
	public static ModelBase modelDisplay(@Nullable String variant) {
		return RenderDisplays.modelSuminia;
	}
	public static float getScaler(@Nullable String variant) {
		return RenderSuminia.getScaler();
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_SUMINIA;
	}
}