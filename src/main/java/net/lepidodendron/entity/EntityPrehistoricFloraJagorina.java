...
public class EntityPrehistoricFloraJagorina extends EntityPrehistoricFloraAgeableFishBase implements ITrappableWater, IAdvancementGranter {
	...
	private static final DataParameter<Integer> BURYTICK = EntityDataManager.createKey(EntityPrehistoricFloraJagorina.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> BURIED = EntityDataManager.createKey(EntityPrehistoricFloraJagorina.class, DataSerializers.BOOLEAN);

	private static final DataParameter<Integer> BURYCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraJagorina.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> SWIMCOUNT = EntityDataManager.createKey(EntityPrehistoricFloraJagorina.class, DataSerializers.VARINT);

	public EntityPrehistoricFloraJagorina(World world) {
		super(world);
		setSize(0.25F, 0.15F);
		minWidth = 0.1F;
		maxWidth = 0.25F;
	...
	public EntityPrehistoricFloraAgeableBase createPFChild(EntityPrehistoricFloraAgeableBase entity) {
		return new EntityPrehistoricFloraJagorina(this.world);
	}
	...
	protected ResourceLocation getLootTable() {
		return LepidodendronMod.JAGORINA_LOOT;
	}
	...
	public CustomTrigger getModTrigger() {
		return ModTriggers.CLICK_JAGORINA;
	}
}
