...
public class LepidodendronBookSubscribers {
	...
	public void onUseBook(PlayerInteractEvent.EntityInteract event) {
		...
		if (event.getItemStack().getTagCompound() != null) {
			...
			else if (entityClicked instanceof EntityPrehistoricFloraShringasaurus) {
				if ((event.getEntityPlayer() instanceof EntityPlayerMP)) {
...
//			}
			...
			else if (entityClicked instanceof EntityPrehistoricFloraChaoyangsaurus) {
				if ((event.getEntityPlayer() instanceof EntityPlayerMP)) {
...
//			}
			...
			else if (entityClicked instanceof EntityPrehistoricFloraCenoceras) {
				if ((event.getEntityPlayer() instanceof EntityPlayerMP)) {
