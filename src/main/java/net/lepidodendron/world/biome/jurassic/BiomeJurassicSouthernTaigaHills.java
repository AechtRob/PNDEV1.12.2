...
public class BiomeJurassicSouthernTaigaHills extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Southern Taiga").setTemperature(0.225F).setRainfall(0.8F).setBaseHeight(0.1F).setHeightVariation(0.12F).setWaterColor(-5317633));
			setRegistryName("jurassic_southern_taiga_hills");
