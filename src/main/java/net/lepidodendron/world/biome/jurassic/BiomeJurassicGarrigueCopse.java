...
public class BiomeJurassicGarrigueCopse extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_garrigue_copse")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicGarrigueCopse(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Copse").setBaseHeight(0.1F).setHeightVariation(0.105F).setTemperature(0.7F).setRainfall(0.8F));
			setRegistryName("jurassic_garrigue_copse");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 36; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					LEAVES_GENERATOR.generate((BlockBush) BlockTallAraucariaSapling.block, BlockTallAraucariaLeaves.block.getDefaultState(), BlockTallAraucariaLog.block.getDefaultState().withProperty(BlockTallAraucariaLog.BlockCustom.FACING, EnumFacing.NORTH), worldIn, rand, pos.add(j, l, k), 0, 110);
				}
