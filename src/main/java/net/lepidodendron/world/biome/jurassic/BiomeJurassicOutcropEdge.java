...
public class BiomeJurassicOutcropEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_outcrops_edge")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicOutcropEdge(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Outcrops").setBaseHeight(2.3F).setHeightVariation(0.25F).setTemperature(0.4F).setRainfall(0.8F));
			setRegistryName("jurassic_outcrops_edge");
