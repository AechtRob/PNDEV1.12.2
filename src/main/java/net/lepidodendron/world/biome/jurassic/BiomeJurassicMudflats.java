...
public class BiomeJurassicMudflats extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_mudflats")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicMudflats(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("jurassic_mudflats");
