...
public class BiomeJurassicCycadThickets extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_cycad_thickets")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicCycadThickets(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Cycad Thickets").setBaseHeight(0.1F).setHeightVariation(0.105F).setTemperature(0.7F).setRainfall(0.8F));
			setRegistryName("jurassic_cycad_thickets");
		...
		protected static final WorldGenWatersideBrownstone WATERSIDE_MUD_GENERATOR = new WorldGenWatersideBrownstone();
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 12; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					STIFF_CYCAD_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
		...
		public EnumBiomeTypeJurassic getBiomeType() {
			return EnumBiomeTypeJurassic.Garrigue;
		}
