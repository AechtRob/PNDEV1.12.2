...
public class BiomeJurassicOutcrops extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_outcrops")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicOutcrops(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Jurassic Outcrops").setBaseHeight(4.95F).setHeightVariation(0.15F).setTemperature(0.4F).setRainfall(0.8F));
			setRegistryName("jurassic_outcrops");
