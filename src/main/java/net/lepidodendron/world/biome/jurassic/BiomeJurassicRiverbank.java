...
public class BiomeJurassicRiverbank extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_riverbank")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicRiverbank(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("jurassic_riverbank");
