...
public class BiomeJurassicGinkgoWoodland extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_ginkgo_woodland")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicGinkgoWoodland(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Ginkgo Woodland").setBaseHeight(0.015F).setHeightVariation(0.0025F).setTemperature(0.8F).setRainfall(0.9F));
			setRegistryName("jurassic_ginkgo_woodland");
		...
		public EnumBiomeTypeJurassic getBiomeType() {
			return EnumBiomeTypeJurassic.Ginkgo;
		}
