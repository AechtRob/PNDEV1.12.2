...
public class BiomeJurassicRiver extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_river")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicRiver(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("jurassic_river");
