...
public class BiomeJurassicSouthernTaiga extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_southern_taiga")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicSouthernTaiga(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Jurassic Southern Taiga").setTemperature(0.225F).setRainfall(0.8F).setBaseHeight(-0.068F).setHeightVariation(0.025F).setWaterColor(-5317633));
			setRegistryName("jurassic_southern_taiga");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				...
				for (int j = 0; j < i; ++j)
				{
					...
					int l = rand.nextInt(16) + 8;
					BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
					PARARAUCARIA_LOG_GENERATOR.generate(worldIn, rand, blockpos);
				}
			}
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				...
				for (int j = 0; j < i; ++j)
				{
					...
					int l = rand.nextInt(16) + 8;
					BlockPos blockpos = worldIn.getHeight(pos.add(k, 0, l));
					COLUMNARIS_LOG_GENERATOR.generate(worldIn, rand, blockpos);
				}
			}
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 64; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					PREHISTORIC_GROUND_COVER_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
