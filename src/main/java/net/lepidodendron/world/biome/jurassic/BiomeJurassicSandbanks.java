...
public class BiomeJurassicSandbanks extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_sandbanks")
	public static final BiomeGenCustom biome = null;
	public BiomeJurassicSandbanks(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			...
			setRegistryName("jurassic_sandbanks");
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 8; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					OTOZAMITES_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), worldIn.getSeaLevel() + 4, 255);
				}
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 5; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					BAIERA_GENERATOR.generate(worldIn, rand, pos.add(j, l, k), worldIn.getSeaLevel() + 4, 255);
				}
		...
		public EnumBiomeTypeJurassic getBiomeType() {
			return EnumBiomeTypeJurassic.Sandbanks;
		}
