...
public class BiomePrecambrianSea extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:precambrian_sea")
	public static final BiomeGenCustom biome = null;
	public BiomePrecambrianSea(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			...
			setRegistryName("precambrian_sea");
