...
public class BiomeOrdovicianSeaIce extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_sea_ice")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianSeaIce(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Ice Sea").setRainfall(0.5F).setBaseHeight(-0.8F).setHeightVariation(0.05F).setTemperature(-1.8F));
			setRegistryName("ordovician_sea_ice");
