...
public class BiomeDevonianSwamp extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Swamp").setRainfall(0.5F).setBaseHeight(-0.15F).setHeightVariation(0.00F).setTemperature(1.0F).setRainfall(0.5F).setWaterColor(14745518));
