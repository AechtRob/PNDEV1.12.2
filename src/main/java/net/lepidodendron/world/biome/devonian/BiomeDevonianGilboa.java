...
public class BiomeDevonianGilboa extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Wattieza Forest").setRainfall(0.7F).setBaseHeight(-0.1F).setHeightVariation(0.0F).setTemperature(0.6F).setWaterColor(14745518));
