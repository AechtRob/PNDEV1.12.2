...
public class BiomePermianOceanShore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_ocean_shore")
	public static final BiomeGenCustom biome = null;
	public BiomePermianOceanShore(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Shallow Ocean").setRainfall(0.5F).setBaseHeight(-0.50F).setHeightVariation(0.01F).setWaterColor(13038245));
			setRegistryName("permian_ocean_shore");
