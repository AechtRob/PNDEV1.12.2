...
public class BiomePermianFloodbasaltEdge extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_floodbasalt_edge")
	public static final BiomeGenCustom biome = null;
	public BiomePermianFloodbasaltEdge(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			...
			setRegistryName("permian_floodbasalt_edge");
