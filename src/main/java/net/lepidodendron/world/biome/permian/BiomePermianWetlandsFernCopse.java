...
public class BiomePermianWetlandsFernCopse extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Permian Wetlands Treefern Copse").setRainfall(0.5F).setBaseHeight(0.075F).setHeightVariation(0.1F).setTemperature(0.95F).setRainfall(0.9F).setWaterColor(3906905));
			setRegistryName("permian_wetlands_fern_copse");
		...
		protected static final WorldGenZygopteridaceae ZYGOPTERIDACEAE_TREE = new WorldGenZygopteridaceae(false);
