...
public class BiomePermianRiver extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_river")
	public static final BiomeGenCustom biome = null;
	public BiomePermianRiver(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomePermian {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Permian River").setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(1.0F).setRainfall(0.5F));
			setRegistryName("permian_river");
		...
		public EnumBiomeTypePermian getBiomeType() {
			return EnumBiomeTypePermian.River;
		}
