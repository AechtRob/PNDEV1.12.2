...
public class BiomePermianColdGlossopterisForestOcean extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:permian_cold_glossopteris_forest_ocean")
	public static final BiomeGenCustom biome = null;
	public BiomePermianColdGlossopterisForestOcean(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
