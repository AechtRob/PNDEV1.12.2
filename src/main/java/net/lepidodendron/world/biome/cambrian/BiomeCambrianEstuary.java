...
public class BiomeCambrianEstuary extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cambrian_estuary")
	public static final BiomeGenCustom biome = null;
	public BiomeCambrianEstuary(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			...
			setRegistryName("cambrian_estuary");
