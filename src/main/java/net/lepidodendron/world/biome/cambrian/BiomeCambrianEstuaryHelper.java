...
public class BiomeCambrianEstuaryHelper extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:cambrian_estuary_helper")
	public static final BiomeGenCustom biome = null;
	public BiomeCambrianEstuaryHelper(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			...
			setRegistryName("cambrian_estuary_helper");
