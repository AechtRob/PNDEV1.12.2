...
public class BiomeTriassicGondwananForest extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_gondwanan_forest")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicGondwananForest(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			setRegistryName("triassic_gondwanan_forest");
