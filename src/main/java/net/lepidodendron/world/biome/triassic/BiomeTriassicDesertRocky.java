...
public class BiomeTriassicDesertRocky extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_desert_rocky")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicDesertRocky(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Rocky Desert").setRainfall(0.0F).setBaseHeight(0.192F).setHeightVariation(0.175F).setTemperature(2.5F).setRainDisabled().setWaterColor(16767282));
			setRegistryName("triassic_desert_rocky");
