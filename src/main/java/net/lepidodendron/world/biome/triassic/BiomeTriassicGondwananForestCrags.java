...
public class BiomeTriassicGondwananForestCrags extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_gondwanan_forest_crags")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicGondwananForestCrags(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Cool Temperate Forest Crags").setTemperature(0.20F).setRainfall(0.8F).setBaseHeight(1.294F).setHeightVariation(0.55F).setWaterColor(-5317633));
			setRegistryName("triassic_gondwanan_forest_crags");
