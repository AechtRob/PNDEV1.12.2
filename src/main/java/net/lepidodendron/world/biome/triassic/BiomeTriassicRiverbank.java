...
public class BiomeTriassicRiverbank extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_riverbank")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicRiverbank(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			setRegistryName("triassic_riverbank");
		...
		protected static final WorldGenGravelPatch SILT_PATCH_GENERATOR = new WorldGenGravelPatch(BlockCoarseSiltyDirt.block, 8);
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
			{
				for (int j1 = 0; j1 < 5; ++j1)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					this.SILT_PATCH_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
			}
