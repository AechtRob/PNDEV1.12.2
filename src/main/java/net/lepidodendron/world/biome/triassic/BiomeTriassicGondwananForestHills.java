...
public class BiomeTriassicGondwananForestHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_gondwanan_forest_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicGondwananForestHills(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
