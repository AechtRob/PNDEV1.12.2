...
public class BiomeTriassicDesertPlateauCanyons extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_desert_plateau_canyons")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicDesertPlateauCanyons(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			...
			super(new BiomeProperties("Triassic Canyons").setRainfall(0.0F).setBaseHeight(2.589F).setHeightVariation(0.015F).setTemperature(2.0F).setRainDisabled().setWaterColor(16767282));
			setRegistryName("triassic_desert_plateau_canyons");
