...
public class BiomeTriassicWarmVolcanicHills extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_warm_volcanic_hills")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicWarmVolcanicHills(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
