...
public class BiomeTriassicOceanShore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_ocean_shore")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicOceanShore(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
