...
public class BiomeTriassicDesertPlateauBroken extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_desert_plateau_broken")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicDesertPlateauBroken(ElementsLepidodendronMod instance) {
		super(instance, 1589);
	}
