...
public class BiomeTriassicFloodedForestDense extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:triassic_flooded_forest_dense")
	public static final BiomeGenCustom biome = null;
	public BiomeTriassicFloodedForestDense(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeTriassic {
		public BiomeGenCustom() {
			super(new BiomeProperties("Triassic Dense Flooded Forest").setRainfall(0.5F).setBaseHeight(-0.15F).setHeightVariation(0.00F).setTemperature(2.00F).setRainfall(1.5F).setWaterColor(3906905));
			setRegistryName("triassic_flooded_forest_dense");
