...
public class EntityLists {
        ...
        switch (dimid) {
            ...
            case 10: //Late K
                return new String[]{"lepidodendron:prehistoric_flora_hexanchus:0:0:0",
                        ...
                        "lepidodendron:prehistoric_flora_australovenator:0:0:0",
                        ...
                        "lepidodendron:prehistoric_flora_ellimmichthys:0:0:0",
    ...
    public static String[] mobString(Biome biome) {
        return mobString(biome, 0);
    }

    public static String[] mobString(Biome biome, int yPos) {
...
//            }
        ...
        else if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_ocean_shore_atlantic") && yPos == 0) {
            if (LepidodendronConfig.doSpawnsPrehistoricFloraDefault) {
                MobString = ArrayUtils.addAll(MobString, SpawnerConfigsCretaceousEarly.CretaceousEarlyOceanAtlanticShallowPF);
            }
        }
        else if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_ocean_shore_atlantic_deep") && yPos == 0) {
            if (LepidodendronConfig.doSpawnsPrehistoricFloraDefault) {
                MobString = ArrayUtils.addAll(MobString, SpawnerConfigsCretaceousEarly.CretaceousEarlyOceanAtlanticDeepPF);
            }
        }
        else if ((biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_ocean_shore_atlantic_deep")
            || biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:cretaceous_early_ocean_shore_atlantic")) && yPos != 0) {
            if (yPos <= 40) {
                if (LepidodendronConfig.doSpawnsPrehistoricFloraDefault) {
                    MobString = ArrayUtils.addAll(MobString, SpawnerConfigsCretaceousEarly.CretaceousEarlyOceanAtlanticDeepPF);
                }
