    ...
    public static String[] mobStringInDimension(int dimid) {
        ...
        switch (dimid) {
            ...
            case 4:
                ...
                MobString = ArrayUtils.addAll(MobString, SpawnerConfigsDevonian.dimDevonianMobsPuddlesPF);
                MobString = ArrayUtils.addAll(MobString, SpawnerConfigsDevonian.dimDevonianMobsWaterlooPF);
                MobString = ArrayUtils.addAll(MobString, SpawnerConfigsDevonian.dimDevonianMobsLagoonsPF);
...
//                    }
        ...
        //PERMIAN:
        ...
        } else if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:permian_arid_lands")
        ...
        } else if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:permian_wetlands_fern_copse")
            ...
            } else if (biome.getRegistryName().toString().equalsIgnoreCase("lepidodendron:permian_lowlands")
