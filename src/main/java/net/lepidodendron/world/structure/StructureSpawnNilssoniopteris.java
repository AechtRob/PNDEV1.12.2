...
public class StructureSpawnNilssoniopteris extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnNilssoniopteris(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
