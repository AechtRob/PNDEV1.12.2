...
public class StructureSpawnAcrocomia extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnAcrocomia(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genAcrocomiaOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightAcrocomia;
				int minheight = LepidodendronConfigPlants.minheightAcrocomia;
