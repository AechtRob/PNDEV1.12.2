...
public class StructurePodBush2 extends ElementsLepidodendronMod.ModElement {
	public StructurePodBush2(ElementsLepidodendronMod instance) {
		super(instance, 44);
	}
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("lepidodendron", "podbush2"));
				if (template == null)
					return;
