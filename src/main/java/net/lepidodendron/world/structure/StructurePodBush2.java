...
public class StructurePodBush2 extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!LepidodendronConfigPlants.genPodocarpBush && !LepidodendronConfig.genAllPlants)
		...
		if ((!matchBiome(biome, LepidodendronConfig.genGlobalBlacklist)) && (!matchBiome(biome, LepidodendronConfigPlants.genPodocarpBlacklistBiomes))) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genPodocarpOverrideBiomes))
			biomeCriteria = true;
		...
		int GenChance = 17000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierPodocarp;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightPodocarp;
				int minheight = LepidodendronConfigPlants.minheightPodocarp;
