...
public class StructureSpawnAsteroxylon extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnAsteroxylon(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,spawnTo, BlockAsteroxylon.block.getDefaultState(), 3);
			}
		}
	}
