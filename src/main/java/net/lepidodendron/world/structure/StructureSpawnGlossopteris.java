...
public class StructureSpawnGlossopteris extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnGlossopteris(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (!LepidodendronConfigPlants.genGlossopteris && !LepidodendronConfig.genAllPlants)
