...
public class StructureSpawnDicroidiumF extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (shouldGenerateInDimension(dimID, LepidodendronConfig.dimDicroidiumFremouwensis))
			dimensionCriteria = true;
		if (!LepidodendronConfig.genDicroidiumFremouwensis && !LepidodendronConfig.genAllPlants)
		...
		if (matchBiome(biome, LepidodendronConfig.genDicroidiumFremouwensisOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;

		int GenChance = 20000;
		double GenMultiplier = LepidodendronConfig.multiplierDicroidiumFremouwensis;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfig.maxheightDicroidiumFremouwensis;
				int minheight = LepidodendronConfig.minheightDicroidiumFremouwensis;
