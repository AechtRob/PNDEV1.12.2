...
public class StructureSpawnDicroidiumF extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnDicroidiumF(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (shouldGenerateInDimension(dimID, LepidodendronConfigPlants.dimDicroidiumFremouwensis))
			dimensionCriteria = true;
		if (!LepidodendronConfigPlants.genDicroidiumFremouwensis && !LepidodendronConfig.genAllPlants)
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genDicroidiumFremouwensisOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;

		int GenChance = 20000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierDicroidiumFremouwensis;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightDicroidiumFremouwensis;
				int minheight = LepidodendronConfigPlants.minheightDicroidiumFremouwensis;
