...
public class StructurePodBush1 extends ElementsLepidodendronMod.ModElement {
	public StructurePodBush1(ElementsLepidodendronMod instance) {
		super(instance, 44);
	}
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("lepidodendron", "podbush1"));
				if (template == null)
					return;
