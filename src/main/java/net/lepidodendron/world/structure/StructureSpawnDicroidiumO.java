...
public class StructureSpawnDicroidiumO extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnDicroidiumO(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (shouldGenerateInDimension(dimID, LepidodendronConfigPlants.dimDicroidiumOdontopteroides))
			dimensionCriteria = true;
		if (!LepidodendronConfigPlants.genDicroidiumOdontopteroides && !LepidodendronConfig.genAllPlants)
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genDicroidiumOdontopteroidesOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;

		int GenChance = 20000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierDicroidiumOdontopteroides;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightDicroidiumOdontopteroides;
				int minheight = LepidodendronConfigPlants.minheightDicroidiumOdontopteroides;
