...
public class StructureSpawnPalaeostachya extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnPalaeostachya(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
