...
public class StructureSpawnHoopAraucaria extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnHoopAraucaria(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if ((!matchBiome(biome, LepidodendronConfig.genGlobalBlacklist)) && (!matchBiome(biome, LepidodendronConfigPlants.genHoopAraucariaBlacklistBiomes))) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genHoopAraucariaOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
			
		int GenChance = 11000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierHoopAraucaria;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightHoopAraucaria;
				int minheight = LepidodendronConfigPlants.minheightHoopAraucaria;
