...
public class StructureSpawnBunya extends ElementsLepidodendronMod.ModElement {
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if ((!matchBiome(biome, LepidodendronConfig.genGlobalBlacklist)) && (!matchBiome(biome, LepidodendronConfigPlants.genAraucariaBidwilliBlacklistBiomes))) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genAraucariaBidwilliOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
			
		int GenChance = 22000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierAraucariaBidwilli;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightAraucariaBidwilli;
				int minheight = LepidodendronConfigPlants.minheightAraucariaBidwilli;
