...
public class StructureSpawnMonkeyPuzzleAruacaria extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnMonkeyPuzzleAruacaria(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if ((!matchBiome(biome, LepidodendronConfig.genGlobalBlacklist)) && (!matchBiome(biome, LepidodendronConfigPlants.genMonkeyPuzzleAraucariaBlacklistBiomes))) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genMonkeyPuzzleAraucariaOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
			
		int GenChance = 12000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierMonkeyPuzzleAraucaria;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightMonkeyPuzzleAraucaria;
				int minheight = LepidodendronConfigPlants.minheightMonkeyPuzzleAraucaria;
