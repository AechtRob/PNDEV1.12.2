...
import net.lepidodendron.procedure.ProcedureWorldGenCephalotaxus;
...
public class StructureSpawnCephalotaxus extends ElementsLepidodendronMod.ModElement {
	public StructureSpawnCephalotaxus(ElementsLepidodendronMod instance) {
		super(instance, 48);
	}
	...
	public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if ((!matchBiome(biome, LepidodendronConfig.genGlobalBlacklist)) && (!matchBiome(biome, LepidodendronConfigPlants.genCephalotaxusBlacklistBiomes))) {
		...
		if (matchBiome(biome, LepidodendronConfigPlants.genCephalotaxusOverrideBiomes))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
			
		int GenChance = 11000;
		double GenMultiplier = LepidodendronConfigPlants.multiplierCephalotaxus;
		...
		if ((random.nextInt(1000000) + 1) <= GenChance) {
			...
			for (int a = 0; a < count; a++) {
				...
				int maxheight = LepidodendronConfigPlants.maxheightCephalotaxus;
				int minheight = LepidodendronConfigPlants.minheightCephalotaxus;
...

				{
					...
					ProcedureWorldGenCephalotaxus.executeProcedure($_dependencies);
				}
