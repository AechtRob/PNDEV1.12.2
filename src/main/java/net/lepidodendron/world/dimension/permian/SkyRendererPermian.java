...
import net.lepidodendron.world.biome.permian.BiomePermianFloodbasalt;
import net.lepidodendron.world.biome.permian.BiomePermianFloodbasaltEdge;
...
public class SkyRendererPermian extends IRenderHandler {
    ...
    public void renderSky(float partialTicks, WorldClient theWorld, Minecraft mc, int pass)
    {
        ...
        //if (theWorld.getBiome(pos) == BiomePermianFloodbasalt.biome || theWorld.getBiome(pos) == BiomePermianFloodbasaltEdge.biome) {
