...
public class BiomeProviderOrdovician extends BiomeProvider {
    ...
    protected BiomeProviderOrdovician() {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = Lists.newArrayList(allowedBiomes);
    }

    public BiomeProviderOrdovician(long seed, WorldType worldType, String options) {
        this();
        GenLayer[] agenlayer = GenLayerOrdovician.initializeAllBiomeGenerators(seed, worldType, options);
        agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderOrdovician(long seed, WorldInfo info) {
