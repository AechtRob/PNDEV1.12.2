...
public class WorldPrecambrian extends ElementsLepidodendronMod.ModElement {
	...
	public WorldPrecambrian(ElementsLepidodendronMod instance) {
		super(instance, 1590);
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			...
			setRegistryName("precambrian_portal");
			setLightLevel(0F);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:precambrian_biome")),
