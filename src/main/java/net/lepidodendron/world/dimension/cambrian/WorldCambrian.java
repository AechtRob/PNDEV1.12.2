...
package net.lepidodendron.world.dimension.cambrian;
...
public class WorldCambrian extends ElementsLepidodendronMod.ModElement {
	...
	public WorldCambrian(ElementsLepidodendronMod instance) {
		super(instance, 1590);
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			...
			setRegistryName("cambrian_portal");
			setLightLevel(0F);
		}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:cambrian_biome")),
