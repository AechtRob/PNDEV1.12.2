...
import net.lepidodendron.world.dimension.jurassic.GenLayerJurassic.GenLayerJurassic;
...
public class BiomeProviderJurassic extends BiomeProvider {
    public static List<Biome> allowedBiomes = Lists.newArrayList(
            ...
            Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:jurassic_redwood_forest")),
