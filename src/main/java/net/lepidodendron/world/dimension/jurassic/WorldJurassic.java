...
public class WorldJurassic extends ElementsLepidodendronMod.ModElement {
	public static int DIMID = LepidodendronConfig.dimJurassic;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("lepidodendron:jurassic_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldJurassic(ElementsLepidodendronMod instance) {
		super(instance, 1590);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Prehistoric Nature loading error! Dimension ID for the Jurassic dimension is already registered by another mod: " + DIMID);
			return;
		}
		dtype = DimensionType.register("jurassic", "_jurassic", DIMID, WorldProviderMod.class, false);
	...
	public static class WorldProviderMod extends WorldProvider {
		@Override
		public void init() {
			this.biomeProvider = new BiomeProviderJurassic(this.world.getSeed(), this.world.getWorldInfo());
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setTranslationKey("pf_jurassic_portal");
			setRegistryName("jurassic_portal");
			setLightLevel(0F);
		}
