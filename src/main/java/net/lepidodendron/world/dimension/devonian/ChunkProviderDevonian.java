    ...
    public ChunkProviderDevonian(World worldIn, long seed) {
        ...
        ravineGenerator = new MapGenRavine() {
            ...
            protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
                ...
                if (biome == BiomeDevonianForest.biome || biome == BiomeDevonianSandyBeach.biome
            ...
            if (j1 <= rand.nextInt(5)) {
                ...
                if (iblockstate2.getMaterial() == Material.AIR) {
                    ...
                    if (j == -1) {
                        ...
                        //For the Table mountains biome, make tops mossy and cracked a bit drier:
                        if (biome == BiomeDevonianHypersalineSinkholeTransition.biome || biome == BiomeDevonianMountains.biome || biome == BiomeDevonianHills.biome || biome == BiomeDevonianHypersalineSinkhole.biome
                        ) {
                            //If it's over 85 blocks then start to fill in more as stone
                            //up to 110 where it almost fully stone - sometimes cobble
                            int minHeight = 75;
                        ...
                        if (j1 >= i - 1) {
                            ...
                            if ((j1 < i - 10 && Math.random() > 0.5)) {
                                ...
                                if (Math.random() > 0.85) {
                                    ...
                                    if (Math.random() > 0.5) {
                                        if (j1 < i - 3) {
                                            if (biome != BiomeDevonianOceanDeadReef.biome && biome != BiomeDevonianOcean.biome && biome != BiomeDevonianOceanDeep.biome && biome != BiomeDevonianSandyBeach.biome && biome != BiomeDevonianForest.biome) {
                                                if (Math.random() > 0.66) {
