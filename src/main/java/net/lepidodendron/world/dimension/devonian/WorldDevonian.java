...
public class WorldDevonian extends ElementsLepidodendronMod.ModElement {
	...
	public static class WorldProviderMod extends WorldProvider {
		@Override
		public void init() {
			this.biomeProvider = new BiomeProviderDevonian(this.world.getSeed(), this.world.getWorldInfo());
		...
		public IChunkGenerator createChunkGenerator() {
			return new ChunkProviderDevonian(this.world, this.world.getSeed() - DIMID);
		}
