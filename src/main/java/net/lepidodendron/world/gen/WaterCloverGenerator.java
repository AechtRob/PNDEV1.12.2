...
public class WaterCloverGenerator extends WorldGenerator
{
	private Block WaterClover;
    private IBlockState state;

    public WaterCloverGenerator(Block WaterCloverIn)
    {
        this.setGeneratedBlock(WaterCloverIn);
    }

    public void setGeneratedBlock(Block WaterCloverIn)
    {
        this.WaterClover = WaterCloverIn;
        this.state = WaterCloverIn.getDefaultState();
    }
