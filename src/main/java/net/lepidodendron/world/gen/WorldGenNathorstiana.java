...
public class WorldGenNathorstiana extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position, int minHeight)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockNathorstiana.block.getDefaultState(), 2);
                flag = true;
            }
        }
