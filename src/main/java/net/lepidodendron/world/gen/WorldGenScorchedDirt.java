...
public class WorldGenScorchedDirt extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 128; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockScorchedEarth.block.getDefaultState(), 2);
                flag = true;
            }
        }
