...
public class WorldGenWaterSideSandyDirt extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 64; ++i)
        {
            ...
            if ((!worldIn.provider.isNether() || blockpos.getY() < 254)
                ...
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockCoarseSandyDirt.block.getDefaultState(), 2);
                flag = true;
