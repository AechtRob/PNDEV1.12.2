...
public class WorldGenSingleStaticInWaterUpwards extends WorldGenerator
{
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (canAttachToSide(staticBlock.getBlock(), worldIn, blockpos, EnumFacing.UP)) {
                if (staticBlock.getPropertyKeys().contains(FACING)) {
                    Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, staticBlock.withProperty(FACING, EnumFacing.UP), 2);
                } else {
