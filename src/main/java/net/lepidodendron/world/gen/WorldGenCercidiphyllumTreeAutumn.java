...
public class WorldGenCercidiphyllumTreeAutumn extends WorldGenAbstractTree
{

    public WorldGenCercidiphyllumTreeAutumn(boolean notify)
    {
        super(notify);
    }
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                if (position.getY() >= Functions.getAdjustedSeaLevel(worldIn, position)-4 && isSoil && position.getY() < worldIn.getHeight() - i - 1)
                {
                    ...
                    ProcedureWorldGenCercidiphyllum.executeProcedure(worldIn, position.up(BareTrunk), TreeHeight, true);
                    ...
                    for (int d = 0; d <= 3; d++) {
                        ...
                        ProcedureWorldGenCercidiphyllum.executeProcedure(worldIn, newPos.up(BareTrunkSide), TreeHeight - BareTrunkSide, true);
                    }
                    return true;
                }
                else
