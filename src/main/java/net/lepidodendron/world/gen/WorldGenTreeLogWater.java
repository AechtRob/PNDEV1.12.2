			...
			if (Math.random() > 0.8) { //Standing log
				...
				if (Math.random() > 0.5) {
					...
					if (Math.random() > 0.6) {
						...
						if (Math.random() > 0.6) {
							Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(4), this.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 4);
							//worldIn.setBlockToAir(blockpos.up(4));
							if (Math.random() > 0.6) {
								Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(5), this.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 4);
								if (Math.random() > 0.25) {
									Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(4).west(), this.block.getDefaultState().withProperty(FACING, EnumFacing.UP), 4);
									//worldIn.setBlockToAir(blockpos.up(2).east());
								}
								else if (Math.random() > 0.25) {
									Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(4).east(), this.block.getDefaultState().withProperty(FACING, EnumFacing.UP), 4);
									//worldIn.setBlockToAir(blockpos.up(2).east());
								}
								else if (Math.random() > 0.25) {
									Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(4).north(), this.block.getDefaultState().withProperty(FACING, EnumFacing.EAST), 4);
									//worldIn.setBlockToAir(blockpos.up(2).east());
								}
								else if (Math.random() > 0.25) {
									Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(4).south(), this.block.getDefaultState().withProperty(FACING, EnumFacing.EAST), 4);
									//worldIn.setBlockToAir(blockpos.up(2).east());
								}
								if (Math.random() > 0.6) {
									Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(6), this.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 4);
									//worldIn.setBlockToAir(blockpos.up(4));
									if (Math.random() > 0.6) {
										Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.up(7), this.block.getDefaultState().withProperty(FACING, EnumFacing.NORTH), 4);
										//worldIn.setBlockToAir(blockpos.up(4));
									}
								}
							}
