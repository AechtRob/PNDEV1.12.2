...
public class WorldGenTriassicLakes extends WorldGenerator
{
    private final Block block;

    public WorldGenTriassicLakes(Block blockIn)
    {
        this.block = blockIn;
    }
                    ...
                    for (int j4 = 4; j4 < 8; ++j4)
                    {
                        if (aboolean[(i2 * 16 + j3) * 8 + j4])
                        {
                                ...
                                && worldIn.getBiome(position.add(i2, j4, j3)) != BiomePermianHighlands.biome)
                            {
                                ...
                                //}
                                //else {
                                	worldIn.setBlockState(blockpos, BlockPrehistoricGroundSandRed.block.getDefaultState(), 2);
                                //}
                            }
