...
public class WorldGenSingleCoral extends WorldGenerator
{
    ...
    {
        //NB does not include TanStaghorn as this glows and so is a special type
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (canAttachToSide(BlockCoralBamboo.block, worldIn, blockpos, EnumFacing.UP)) {
                int type = rand.nextInt(15);
                IBlockState state = BlockCoralBamboo.block.getDefaultState();
                if (coralIn != null) {
                    ...
                    switch (type) {
                        case 0:
                        default:
                            state = BlockCoralBamboo.block.getDefaultState();
                            break;

                        case 1:
                            state = BlockCoralBrain.block.getDefaultState();
                            break;

                        case 2:
                            state = BlockCoralBlueCrust.block.getDefaultState();
                            break;

                        case 3:
                            state = BlockCoralBlueStaghorn.block.getDefaultState();
                            break;

                        case 4:
                            state = BlockCoralCarnation.block.getDefaultState();
                            break;

                        case 5:
                            state = BlockCoralRedTree.block.getDefaultState();
                            break;

                        case 6:
                            state = BlockCoralSoftFan.block.getDefaultState();
                            break;

                        case 7:
                            state = BlockCoralStonyBlooming.block.getDefaultState();
                            break;

                        case 8:
                            state = BlockCoralStonyFractalBranching.block.getDefaultState();
                            break;

                        case 9:
                            state = BlockCoralStonyLumpy.block.getDefaultState();
                            break;

                        case 10:
                            state = BlockCoralStonyPipeStack.block.getDefaultState();
                            break;

                        case 11:
                            state = BlockCoralStonyPuffy.block.getDefaultState();
                            break;

                        case 12:
                            state = BlockCoralStonyRoughBranching.block.getDefaultState();
                            break;

                        case 13:
                            state = BlockCoralStonySparseBranching.block.getDefaultState();
                            break;

                        case 14:
                            state = BlockCoralStonyTubular.block.getDefaultState();
                            break;
