...
public class WorldGenSandyDirtBlackNearWater extends WorldGenerator {
            ...
            if (
                ...
                if (water != 0) {
                    if (rand.nextInt(water + 1) == 0) {
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockCoarseSandyDirtBlack.block.getDefaultState(), 2);
                        flag = true;
                        return flag;
                    }
                }
