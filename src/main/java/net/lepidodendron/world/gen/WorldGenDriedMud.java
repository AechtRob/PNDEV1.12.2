...
public class WorldGenDriedMud extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position, boolean nearSea)
    {
        ...
        for (int i = 0; i < 64; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockDriedMud.block.getDefaultState(), 2);
