...
public class WorldGenRedSandyDirt extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 64; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockCoarseSandyDirtRed.block.getDefaultState(), 2);
                flag = true;
            }
        }
