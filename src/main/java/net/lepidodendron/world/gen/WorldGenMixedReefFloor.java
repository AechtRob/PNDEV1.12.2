...
public class WorldGenMixedReefFloor extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockCoral.block.getDefaultState().withProperty(BlockCoral.FACING, EnumFacing.byHorizontalIndex(rand.nextInt(4))), 2);
            flag = true;
        }
