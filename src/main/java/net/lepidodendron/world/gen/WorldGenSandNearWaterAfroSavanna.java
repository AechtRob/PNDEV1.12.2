...
public class WorldGenSandNearWaterAfroSavanna extends WorldGenerator {
            ...
            if (
                ...
                if (water != 0) {
                    if (rand.nextInt(water + 1) == 0) {
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), getSandState(worldIn), 2);
                        flag = true;
                        return flag;
                    }
                }
    ...
    public static IBlockState getSandState(World world) {
        if (world.rand.nextInt(3) == 0) {
            return BlockCoarseSiltyDirt.block.getDefaultState();
        }
        return BlockDriedMud.block.getDefaultState();
    }
}
