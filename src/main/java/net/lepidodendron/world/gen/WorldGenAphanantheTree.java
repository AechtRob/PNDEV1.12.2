...
public class WorldGenAphanantheTree extends WorldGenAbstractTree
{

    public WorldGenAphanantheTree(boolean notify)
    {
        super(notify);
    }
       ...
       // }
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                {
                    BlockAphanantheSapling.BlockCustom.growAphananthe(worldIn, position, rand);
                    return true;
                }
                else
                {
