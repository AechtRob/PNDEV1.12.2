...
public class WorldGenCercidiphyllumTree extends WorldGenAbstractTree
{

    public WorldGenCercidiphyllumTree(boolean notify)
    {
        super(notify);
    }
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                if (position.getY() >= Functions.getAdjustedSeaLevel(worldIn, position)-4 && isSoil && position.getY() < worldIn.getHeight() - i - 1)
                {
                    ...
                    ProcedureWorldGenCercidiphyllum.executeProcedure(worldIn, position.up(BareTrunk), TreeHeight, false);
                    ...
                    for (int d = 0; d <= 3; d++) {
                        ...
                        ProcedureWorldGenCercidiphyllum.executeProcedure(worldIn, newPos.up(BareTrunkSide), TreeHeight - BareTrunkSide, false);
                    }
                    return true;
                }
                else
