...
public class WorldGenGlassReefFloor extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockGlassSpongeReef.block.getDefaultState().withProperty(BlockGlassSpongeReef.FACING, EnumFacing.byHorizontalIndex(rand.nextInt(4))), 2);
            flag = true;
        }
