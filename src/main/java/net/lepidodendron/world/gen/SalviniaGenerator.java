...
public class SalviniaGenerator extends WorldGenerator
{
	private Block Salvinia;
    private IBlockState state;

    public SalviniaGenerator(Block SalviniaIn)
    {
        this.setGeneratedBlock(SalviniaIn);
    }

    public void setGeneratedBlock(Block SalviniaIn)
    {
        this.Salvinia = SalviniaIn;
        this.state = SalviniaIn.getDefaultState();
    }
