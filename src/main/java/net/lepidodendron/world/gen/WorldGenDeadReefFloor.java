...
public class WorldGenDeadReefFloor extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockCoralBleached.block.getDefaultState().withProperty(BlockCoralBleached.FACING, EnumFacing.byHorizontalIndex(rand.nextInt(4))), 2);
            flag = true;
        }
