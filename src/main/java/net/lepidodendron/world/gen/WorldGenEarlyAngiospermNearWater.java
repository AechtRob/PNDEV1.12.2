...
import net.lepidodendron.block.BlockPrehistoricGroundEarlyAngiosperm;
...
public class WorldGenEarlyAngiospermNearWater extends WorldGenerator {
            ...
            if (
                ...
                if (water != 0) {
                    if (rand.nextInt(water + 1) == 0) {
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockPrehistoricGroundEarlyAngiosperm.block.getStateFromMeta(0), 2);
                        flag = true;
                        return flag;
                    }
                }
