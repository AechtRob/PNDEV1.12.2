...
public class WorldGenMacrotaeniopteris extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockMacrotaeniopteris.block.getDefaultState(), 2);
                flag = true;
            }
        }
