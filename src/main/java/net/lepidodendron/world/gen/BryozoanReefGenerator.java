...
public class BryozoanReefGenerator extends WorldGenerator
{
	private Block reef;
    private IBlockState state;

    public BryozoanReefGenerator(Block reefIn)
    {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
		...
		int[] dimCheck = LepidodendronConfigPlants.dimBryozoanReef;
