...
public class WorldGenSingleRugoseCoral extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position, int minWaterDepth, int maxWaterDepth, int minY, int maxY, int specificVariant)
    {
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (canAttachToSide(BlockRugosa1.block, worldIn, blockpos, EnumFacing.UP)) {
                ...
                switch (type) {
                    case 0: default:
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockRugosa1.block.getDefaultState(), 2);
                        break;

                    case 1:
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockRugosa2.block.getDefaultState(), 2);
                        break;

                    case 2:
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockRugosa3.block.getDefaultState(), 2);
                        break;

                    case 3:
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockRugosa4.block.getDefaultState(), 2);
                        break;

                    case 4:
                        Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockRugosa5.block.getDefaultState(), 2);
                        break;
