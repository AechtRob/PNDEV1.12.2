...
public class WorldGenBaragwanathia extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 12; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockBaragwanathia.block.getDefaultState(), 2);
                flag = true;
            }
        }
