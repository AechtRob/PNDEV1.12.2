...
public class WorldGenHadeanLakes extends WorldGenerator
{
    private final Block block;

    public WorldGenHadeanLakes(Block blockIn)
    {
        this.block = blockIn;
    }
                        ...
                        if (aboolean[(l1 * 16 + i3) * 8 + i4])
                        {
                            ...
                            if ((this.block.getDefaultState().getMaterial() == Material.WATER && i4 < 4)
                                ...
                                if (worldIn.getBlockState(position.add(l1, i4-2, i3)).getBlockFaceShape(
                                    ...
                                    Functions.setBlockStateAndCheckForDoublePlant(worldIn,position.add(l1, i4-2, i3), BlockSandBlack.block.getDefaultState());
                                }
                            }
                        }
                    }
                                ...
                                if (this.block.getDefaultState().getMaterial() == Material.LAVA) {
                                    if (Math.random() > 0.5) {
                                        ...
                                        if (Math.random() > 0.5) {
                                            ...
                                            Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos, BlockLavaCobbleMolten.block.getDefaultState(), 2);
                                        }
                                    }
                                }
