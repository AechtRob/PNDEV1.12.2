...
public class WorldGenSpongeReefFloor extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockSpongeReef.block.getDefaultState().withProperty(BlockSpongeReef.FACING, EnumFacing.byHorizontalIndex(rand.nextInt(4))), 2);
            flag = true;
        }
