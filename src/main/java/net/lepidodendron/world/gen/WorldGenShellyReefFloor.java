...
public class WorldGenShellyReefFloor extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        {
            Functions.setBlockStateAndCheckForDoublePlant(worldIn, blockpos, BlockShelly.block.getDefaultState().withProperty(BlockShelly.FACING, EnumFacing.byHorizontalIndex(rand.nextInt(4))), 2);
            flag = true;
        }
