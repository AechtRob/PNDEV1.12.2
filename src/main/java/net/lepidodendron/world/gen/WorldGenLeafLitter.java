...
public class WorldGenLeafLitter extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 256; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockLeafLitter.block.getDefaultState(), 2);
                flag = true;
            }
        }
