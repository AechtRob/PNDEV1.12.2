...
public class WorldGenGreySandyDirt extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 64; ++i)
        {
            ...
            {
                Functions.setBlockStateAndCheckForDoublePlant(worldIn,blockpos.down(), BlockCoarseSandyDirtGrey.block.getDefaultState(), 2);
                flag = true;
            }
        }
