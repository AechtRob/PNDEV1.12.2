...
public class WorldGenSnowHigh extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        for (int i = 0; i < 32; ++i)
        {
            ...
            if (worldIn.getBlockState(blockpos).getBlock() == Blocks.SNOW_LAYER) {
                if ((!worldIn.provider.isNether() || blockpos.getY() < 254) && worldIn.canSnowAt(blockpos.up(), false) && worldIn.isAirBlock(blockpos.up())
                ...
                if ((!worldIn.provider.isNether() || blockpos.getY() < 254) && worldIn.canSnowAt(blockpos.up(), false) && worldIn.isAirBlock(blockpos)
