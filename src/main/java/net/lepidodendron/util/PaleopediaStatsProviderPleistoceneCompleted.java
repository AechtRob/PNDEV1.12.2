...
import net.lepidodendron.entity.util.IPaleopediaStatsPleistoceneCompleted;
...
public class PaleopediaStatsProviderPleistoceneCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPleistoceneCompleted.class)
    public static final Capability<IPaleopediaStatsPleistoceneCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPleistoceneCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPleistoceneCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderPleistoceneCompleted.PALEOPEDIA_STATS, null);
