...
import net.lepidodendron.entity.util.IPaleopediaStatsJurassic;
...
public class PaleopediaStatsProviderJurassic implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsJurassic.class)
    public static final Capability<IPaleopediaStatsJurassic> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsJurassic instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsJurassic stats = minecraft.player.getCapability(PaleopediaStatsProviderJurassic.PALEOPEDIA_STATS, null);
