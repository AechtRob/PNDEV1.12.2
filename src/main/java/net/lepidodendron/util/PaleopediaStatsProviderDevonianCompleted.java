...
import net.lepidodendron.entity.util.IPaleopediaStatsDevonianCompleted;
...
public class PaleopediaStatsProviderDevonianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsDevonianCompleted.class)
    public static final Capability<IPaleopediaStatsDevonianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsDevonianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsDevonianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderDevonianCompleted.PALEOPEDIA_STATS, null);
