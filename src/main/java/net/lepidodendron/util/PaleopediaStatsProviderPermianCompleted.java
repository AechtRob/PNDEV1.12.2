...
import net.lepidodendron.entity.util.IPaleopediaStatsPermianCompleted;
...
public class PaleopediaStatsProviderPermianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPermianCompleted.class)
    public static final Capability<IPaleopediaStatsPermianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPermianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPermianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderPermianCompleted.PALEOPEDIA_STATS, null);
