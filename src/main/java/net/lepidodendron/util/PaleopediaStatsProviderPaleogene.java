...
import net.lepidodendron.entity.util.IPaleopediaStatsPaleogene;
...
public class PaleopediaStatsProviderPaleogene implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPaleogene.class)
    public static final Capability<IPaleopediaStatsPaleogene> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPaleogene instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPaleogene stats = minecraft.player.getCapability(PaleopediaStatsProviderPaleogene.PALEOPEDIA_STATS, null);
