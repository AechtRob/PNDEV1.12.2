...
public class PercentageCollected {
    ...
    public static float getPercentagePerDimensionAchieved(EntityPlayer player, int dimension, boolean testComplete) {
        ...
        double lifeCollected = plantCollected + staticCollected + mobCollected;
        return (float)lifeCollected;

    }

    public static float getPercentagePerDimensionTotal(EntityPlayer player, int dimension, boolean testComplete) {
