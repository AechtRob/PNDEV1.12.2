...
import net.lepidodendron.entity.util.IPaleopediaStatsCambrianCompleted;
...
public class PaleopediaStatsProviderCambrianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCambrianCompleted.class)
    public static final Capability<IPaleopediaStatsCambrianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCambrianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCambrianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderCambrianCompleted.PALEOPEDIA_STATS, null);
