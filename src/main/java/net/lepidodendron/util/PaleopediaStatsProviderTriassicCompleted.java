...
import net.lepidodendron.entity.util.IPaleopediaStatsTriassicCompleted;
...
public class PaleopediaStatsProviderTriassicCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsTriassicCompleted.class)
    public static final Capability<IPaleopediaStatsTriassicCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsTriassicCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsTriassicCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderTriassicCompleted.PALEOPEDIA_STATS, null);
