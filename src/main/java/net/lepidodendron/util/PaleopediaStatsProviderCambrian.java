...
import net.lepidodendron.entity.util.IPaleopediaStatsCambrian;
...
public class PaleopediaStatsProviderCambrian implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCambrian.class)
    public static final Capability<IPaleopediaStatsCambrian> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCambrian instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCambrian stats = minecraft.player.getCapability(PaleopediaStatsProviderCambrian.PALEOPEDIA_STATS, null);
