...
import net.lepidodendron.entity.util.IPaleopediaStatsCretaceousEarlyCompleted;
...
public class PaleopediaStatsProviderCretaceousEarlyCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCretaceousEarlyCompleted.class)
    public static final Capability<IPaleopediaStatsCretaceousEarlyCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCretaceousEarlyCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCretaceousEarlyCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderCretaceousEarlyCompleted.PALEOPEDIA_STATS, null);
