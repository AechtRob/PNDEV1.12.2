...
import net.lepidodendron.entity.util.IPaleopediaStatsJurassicCompleted;
...
public class PaleopediaStatsProviderJurassicCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsJurassicCompleted.class)
    public static final Capability<IPaleopediaStatsJurassicCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsJurassicCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsJurassicCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderJurassicCompleted.PALEOPEDIA_STATS, null);
