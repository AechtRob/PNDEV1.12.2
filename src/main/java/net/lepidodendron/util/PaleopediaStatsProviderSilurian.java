...
import net.lepidodendron.entity.util.IPaleopediaStatsSilurian;
...
public class PaleopediaStatsProviderSilurian implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsSilurian.class)
    public static final Capability<IPaleopediaStatsSilurian> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsSilurian instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsSilurian stats = minecraft.player.getCapability(PaleopediaStatsProviderSilurian.PALEOPEDIA_STATS, null);
