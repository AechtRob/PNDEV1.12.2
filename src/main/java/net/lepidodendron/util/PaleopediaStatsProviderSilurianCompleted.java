...
import net.lepidodendron.entity.util.IPaleopediaStatsSilurianCompleted;
...
public class PaleopediaStatsProviderSilurianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsSilurianCompleted.class)
    public static final Capability<IPaleopediaStatsSilurianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsSilurianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsSilurianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderSilurianCompleted.PALEOPEDIA_STATS, null);
