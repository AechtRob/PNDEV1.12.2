...
import net.lepidodendron.entity.util.IPaleopediaStatsTriassic;
...
public class PaleopediaStatsProviderTriassic implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsTriassic.class)
    public static final Capability<IPaleopediaStatsTriassic> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsTriassic instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsTriassic stats = minecraft.player.getCapability(PaleopediaStatsProviderTriassic.PALEOPEDIA_STATS, null);
