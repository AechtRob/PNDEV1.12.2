...
import net.lepidodendron.entity.util.IPaleopediaStatsPrecambrianCompleted;
...
public class PaleopediaStatsProviderPrecambrianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPrecambrianCompleted.class)
    public static final Capability<IPaleopediaStatsPrecambrianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPrecambrianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPrecambrianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderPrecambrianCompleted.PALEOPEDIA_STATS, null);
