...
import net.lepidodendron.entity.util.IPaleopediaStatsCarboniferous;
...
public class PaleopediaStatsProviderCarboniferous implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCarboniferous.class)
    public static final Capability<IPaleopediaStatsCarboniferous> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCarboniferous instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCarboniferous stats = minecraft.player.getCapability(PaleopediaStatsProviderCarboniferous.PALEOPEDIA_STATS, null);
