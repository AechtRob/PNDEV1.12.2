...
import net.lepidodendron.entity.util.IPaleopediaStatsPermian;
...
public class PaleopediaStatsProviderPermian implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPermian.class)
    public static final Capability<IPaleopediaStatsPermian> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPermian instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPermian stats = minecraft.player.getCapability(PaleopediaStatsProviderPermian.PALEOPEDIA_STATS, null);
