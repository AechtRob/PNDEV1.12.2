...
import net.lepidodendron.entity.util.IPaleopediaStatsNeogeneCompleted;
...
public class PaleopediaStatsProviderNeogeneCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsNeogeneCompleted.class)
    public static final Capability<IPaleopediaStatsNeogeneCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsNeogeneCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsNeogeneCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderNeogeneCompleted.PALEOPEDIA_STATS, null);
