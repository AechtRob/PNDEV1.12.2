...
import net.lepidodendron.entity.util.IPaleopediaStatsCarboniferousCompleted;
...
public class PaleopediaStatsProviderCarboniferousCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCarboniferousCompleted.class)
    public static final Capability<IPaleopediaStatsCarboniferousCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCarboniferousCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCarboniferousCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderCarboniferousCompleted.PALEOPEDIA_STATS, null);
