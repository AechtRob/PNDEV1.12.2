...
public class PlantBreakMobsSea {
    ...
    public static String[] getPrecambrianPlantBreakMobs() {
        String[] resLoc = LepidodendronConfig.insectBreakMobsPrecambrian;
    ...
    public static String[] getCambrianPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsCambrian);
        return resLoc;
    }
...
//                (net.minecraftforge.fml.common.registry.EntityRegistry.getEntry(EntityPrehistoricFloraSyringocrinus.class)).getRegistryName().toString(),
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsOrdovician);
        return resLoc;
    }
    ...
    public static String[] getSilurianPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsSilurian);
        return resLoc;
    }
    ...
    public static String[] getDevonianPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsDevonian);
        return resLoc;
    }
    ...
    public static String[] getCarboniferousPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsCarboniferous);
        return resLoc;
    }
    ...
    public static String[] getPermianPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsPermian);
        return resLoc;
    }
    ...
    public static String[] getTriassicPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsTriassic);
        return resLoc;
    }
    ...
    public static String[] getJurassicPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsJurassic);
        return resLoc;
    }
    ...
    public static String[] getCretaceousPlantBreakMobs() {
        ...
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsCretaceous);
        return resLoc;
    }

    public static String[] getPaleogenePlantBreakMobs() {
        String[] resLoc = LepidodendronConfig.insectBreakMobsPaleogene;
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsPaleogene);
        return resLoc;
    }

    public static String[] getNeogenePlantBreakMobs() {
        String[] resLoc = LepidodendronConfig.insectBreakMobsNeogene;
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsNeogene);
        return resLoc;
    }

    public static String[] getPleistocenePlantBreakMobs() {
        String[] resLoc = LepidodendronConfig.insectBreakMobsPleistocene;
        resLoc = ArrayUtils.addAll(resLoc, LepidodendronConfig.insectBreakMobsPleistocene);
        return resLoc;
    }
