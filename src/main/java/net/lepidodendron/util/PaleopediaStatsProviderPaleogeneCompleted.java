...
import net.lepidodendron.entity.util.IPaleopediaStatsPaleogeneCompleted;
...
public class PaleopediaStatsProviderPaleogeneCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPaleogeneCompleted.class)
    public static final Capability<IPaleopediaStatsPaleogeneCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPaleogeneCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPaleogeneCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderPaleogeneCompleted.PALEOPEDIA_STATS, null);
