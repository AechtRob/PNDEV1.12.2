...
public class SpawnerConfigsPrecambrian {
    ...
    public static String[] dimPaleoproterozoicTrapAirPF = new String[0];
    public static String[] dimMesoproterozoicTrapAirPF = new String[0];
    public static String[] dimNeoproterozoicTrapAirPF = new String[0];
    public static String[] dimEdiacaranTrapAirPF =new String[0];
    //LandTraps:
    public static String[] dimHadeanTrapGroundPF = new String[0];
    public static String[] dimArcheanTrapGroundPF = new String[0];
    public static String[] dimPaleoproterozoicTrapGroundPF = new String[0];
    public static String[] dimMesoproterozoicTrapGroundPF = new String[0];
    public static String[] dimNeoproterozoicTrapGroundPF = new String[0];
    public static String[] dimEdiacaranTrapGroundPF = new String[0];
    //WaterTraps:
    public static String[] dimHadeanTrapWaterPF = new String[0];
    public static String[] dimArcheanTrapWaterPF = new String[0];
