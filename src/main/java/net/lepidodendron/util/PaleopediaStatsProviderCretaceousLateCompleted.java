...
import net.lepidodendron.entity.util.IPaleopediaStatsCretaceousLateCompleted;
...
public class PaleopediaStatsProviderCretaceousLateCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCretaceousLateCompleted.class)
    public static final Capability<IPaleopediaStatsCretaceousLateCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCretaceousLateCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCretaceousLateCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderCretaceousLateCompleted.PALEOPEDIA_STATS, null);
