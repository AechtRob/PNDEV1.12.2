...
import net.lepidodendron.entity.util.IPaleopediaStatsCretaceousLate;
...
public class PaleopediaStatsProviderCretaceousLate implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCretaceousLate.class)
    public static final Capability<IPaleopediaStatsCretaceousLate> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCretaceousLate instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCretaceousLate stats = minecraft.player.getCapability(PaleopediaStatsProviderCretaceousLate.PALEOPEDIA_STATS, null);
