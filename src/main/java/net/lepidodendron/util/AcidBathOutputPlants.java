...
public class AcidBathOutputPlants {
    ...
    public static String[] getCretaceousCleanedFossilsPlantsLate() {
        String[] resLoc = {
                ...
                ForgeRegistries.BLOCKS.getKey(BlockLiriodendritesSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockLygodium.block).toString(),
                ...
                ForgeRegistries.BLOCKS.getKey(BlockOsmunda.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockPhoenicopsisSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockCredneriaSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockPodocarpSapling.block).toString(),
                ForgeRegistries.ITEMS.getKey(ItemPrimevalGrassItem.block).toString(),
                ...
                ForgeRegistries.BLOCKS.getKey(BlockDasypogonSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDryophyllumSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonYellow.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonPink.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockMimetes.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockConospermum.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockBottlebrush.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockBeaupreaSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDipteris.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockPalaeoaster.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockPalaeoclusia.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockPopulusSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockSaurauiaSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockSchisandra.block).toString(),
                ForgeRegistries.ITEMS.getKey(ItemWaterPoppyItem.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockAbiesSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockGlyptostrobusSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockTsugaSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDroseraSmall.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDroseraLarge.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockTorreyaSapling.block).toString(),
                ForgeRegistries.ITEMS.getKey(ItemAzollaItem.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockCornusmas.block).toString(),
                ...
                ForgeRegistries.BLOCKS.getKey(BlockAphanantheSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDavidiaSapling.block).toString(),
    ...
    public static String[] getPaleogeneCleanedFossilsPlants() {
        String[] resLoc = {
                ...
                ForgeRegistries.BLOCKS.getKey(BlockDasypogonSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDryophyllumSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIrisDwarf.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockGrevillea.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonYellow.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonPink.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockMimetes.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockConospermum.block).toString(),
    ...
    public static String[] getNeogeneCleanedFossilsPlants() {
        String[] resLoc = {
                ...
                ForgeRegistries.BLOCKS.getKey(BlockDawnRedwoodSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDasypogonSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockHyacinth.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIrisDwarf.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonYellow.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonPink.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockMimetes.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockConospermum.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockCalochortus.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockEschscholzia.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockGrevillea.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockBottlebrush.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockBeaupreaSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDipteris.block).toString(),
    ...
    public static String[] getPleistoceneCleanedFossilsPlants() {
        String[] resLoc = {
                ...
                ForgeRegistries.BLOCKS.getKey(BlockDawnRedwoodSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockDasypogonSapling.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockOrchidBee.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockOrchidMirror.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockOrchidPyramidal.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockOrchidFen.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockHyacinth.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIrisDwarf.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonYellow.block).toString(),
                ForgeRegistries.BLOCKS.getKey(BlockIsopogonPink.block).toString(),
