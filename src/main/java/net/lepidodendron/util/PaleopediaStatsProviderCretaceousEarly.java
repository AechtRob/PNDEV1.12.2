...
import net.lepidodendron.entity.util.IPaleopediaStatsCretaceousEarly;
...
public class PaleopediaStatsProviderCretaceousEarly implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsCretaceousEarly.class)
    public static final Capability<IPaleopediaStatsCretaceousEarly> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsCretaceousEarly instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsCretaceousEarly stats = minecraft.player.getCapability(PaleopediaStatsProviderCretaceousEarly.PALEOPEDIA_STATS, null);
