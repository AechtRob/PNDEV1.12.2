...
import net.lepidodendron.entity.util.IPaleopediaStatsOrdovician;
...
public class PaleopediaStatsProviderOrdovician implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsOrdovician.class)
    public static final Capability<IPaleopediaStatsOrdovician> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsOrdovician instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsOrdovician stats = minecraft.player.getCapability(PaleopediaStatsProviderOrdovician.PALEOPEDIA_STATS, null);
