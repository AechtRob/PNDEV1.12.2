...
import net.lepidodendron.entity.util.IPaleopediaStatsPleistocene;
...
public class PaleopediaStatsProviderPleistocene implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsPleistocene.class)
    public static final Capability<IPaleopediaStatsPleistocene> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsPleistocene instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsPleistocene stats = minecraft.player.getCapability(PaleopediaStatsProviderPleistocene.PALEOPEDIA_STATS, null);
