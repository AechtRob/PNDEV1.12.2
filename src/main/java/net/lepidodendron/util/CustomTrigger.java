...
public class CustomTrigger implements ICriterionTrigger<CustomTrigger.Instance>
{
    ...
    {
        CustomTrigger.Listeners dimensiontrigger$listeners = listeners.get(playerAdvancementsIn);
    ...
    {
        CustomTrigger.Listeners dimensiontrigger$listeners = listeners.get(parPlayer.getAdvancements());
