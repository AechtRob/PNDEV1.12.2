...
import net.lepidodendron.entity.util.IPaleopediaStatsDevonian;
...
public class PaleopediaStatsProviderDevonian implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsDevonian.class)
    public static final Capability<IPaleopediaStatsDevonian> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsDevonian instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsDevonian stats = minecraft.player.getCapability(PaleopediaStatsProviderDevonian.PALEOPEDIA_STATS, null);
