...
import net.lepidodendron.entity.util.IPaleopediaStatsOrdovicianCompleted;
...
public class PaleopediaStatsProviderOrdovicianCompleted implements ICapabilitySerializable<NBTBase>
{
    @CapabilityInject(IPaleopediaStatsOrdovicianCompleted.class)
    public static final Capability<IPaleopediaStatsOrdovicianCompleted> PALEOPEDIA_STATS = null;

    private IPaleopediaStatsOrdovicianCompleted instance = PALEOPEDIA_STATS.getDefaultInstance();
    ...
    public static class StatsPacket implements IMessage {
        ...
        public static class Handler implements IMessageHandler<StatsPacket, IMessage>
        {
            ...
            void processMessage(StatsPacket message)
            {
                ...
                Minecraft minecraft = Minecraft.getMinecraft();
                IPaleopediaStatsOrdovicianCompleted stats = minecraft.player.getCapability(PaleopediaStatsProviderOrdovicianCompleted.PALEOPEDIA_STATS, null);
