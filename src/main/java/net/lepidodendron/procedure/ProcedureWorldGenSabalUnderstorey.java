...
public class ProcedureWorldGenSabalUnderstorey extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenSabalUnderstorey(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenSabalUnderstorey!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenSabalUnderstorey!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenSabalUnderstorey!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenSabalUnderstorey!");
			return;
		}
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			//Trunk:
			TrunkHeight = world.rand.nextInt(2) - 1;
