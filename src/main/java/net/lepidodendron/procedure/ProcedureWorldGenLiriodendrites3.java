...
public class ProcedureWorldGenLiriodendrites3 extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenLiriodendrites3(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenLiriodendrites3!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenLiriodendrites3!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenLiriodendrites3!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenLiriodendrites3!");
			return;
		}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) TopCount, (int) (z - 3))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) TopCount, (int) (z - 3)), BlockLiriodendronLog.block.getDefaultState(), 3);
			try {
				IBlockState _bs = world.getBlockState(new BlockPos((int) (x + 1), (int) TopCount, (int) (z - 3)));
				for (IProperty<?> prop : _bs.getProperties().keySet()) {
					if (prop.getName().equals("facing")) {
						Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) TopCount, (int) (z - 3)),
								_bs.withProperty((PropertyDirection) prop, EnumFacing.UP), 3);
						break;
					}
				}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 3), (int) TopCount, (int) (z + 1))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 3), (int) TopCount, (int) (z + 1)), BlockLiriodendronLog.block.getDefaultState(), 3);
			try {
				IBlockState _bs = world.getBlockState(new BlockPos((int) (x - 3), (int) TopCount, (int) (z + 1)));
				for (IProperty<?> prop : _bs.getProperties().keySet()) {
					if (prop.getName().equals("facing")) {
						Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 3), (int) TopCount, (int) (z + 1)),
								_bs.withProperty((PropertyDirection) prop, EnumFacing.EAST), 3);
						break;
					}
				}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) TopCount, (int) (z - 4))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) TopCount, (int) (z - 4)), BlockLiriodendronLog.block.getDefaultState(), 3);
			try {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 4), (int) TopCount, (int) z)), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 4), (int) TopCount, (int) z), BlockLiriodendronLog.block.getDefaultState(), 3);
			try {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (TopCount), (int) (z + 4))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount), (int) (z + 4)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 1), (int) (TopCount + 1), (int) (z + 4))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount + 1), (int) (z + 4)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 5))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount), (int) (z + 5)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 5))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 5)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount), (int) (z + 3))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) (TopCount), (int) (z + 3)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x - 2), (int) (TopCount + 1), (int) (z + 3))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) (TopCount + 1), (int) (z + 3)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 4), (int) (TopCount), (int) (z + 1))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 4), (int) (TopCount), (int) (z + 1)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z + 1))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z + 1)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 5), (int) (TopCount), (int) z)), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 5), (int) (TopCount), (int) z), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 5), (int) (TopCount + 1), (int) z)))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 5), (int) (TopCount + 1), (int) z), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) (z - 2))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) (z - 2)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 2), (int) (z + 4))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount + 2), (int) (z + 4)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 1), (int) (TopCount + 2), (int) (z + 3))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount + 2), (int) (z + 3)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x + 4, (int) (TopCount + 2), (int) (z))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x + 4, (int) (TopCount + 2), (int) (z)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 2), (int) (z + 1))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount + 2), (int) (z + 1)), BlockLiriodendritesFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) (z + 2))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) (z + 2)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		block = world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2))).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2))), world,
				new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2)))) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z + 2))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z + 2)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z - 1))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z - 1)), BlockLiriodendritesLeaves.block.getDefaultState(), 3);
			}	
		block = world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2))).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2))), world,
				new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2)))) {
