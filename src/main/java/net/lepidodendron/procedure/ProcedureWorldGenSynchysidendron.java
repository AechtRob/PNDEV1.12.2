...
public class ProcedureWorldGenSynchysidendron extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenSynchysidendron(ElementsLepidodendronMod instance) {
		super(instance, 13);
	}
	...
	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		...
		if (((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))) ||
			...
			ProcedureTreeLeaf.executeProcedure(x, y + (int)counter, z - 1, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x + 2, y + (int)counter, z, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x - 2, y + (int)counter, z, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x, y + (int)counter, z + 2, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x, y + (int)counter, z - 2, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x + 2, y + (int)counter + 1, z, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x - 2, y + (int)counter + 1, z, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x, y + (int)counter + 1, z + 2, world, BlockSynchysidendronLeaves.block);
			ProcedureTreeLeaf.executeProcedure(x, y + (int)counter + 1, z - 2, world, BlockSynchysidendronLeaves.block);

			counter = counter - 4;
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z + 1, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z - 1, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x + 1, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x - 1, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z + 2, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z - 2, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x + 2, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x - 2, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter + 1, z + 3, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter + 1, z - 3, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x + 3, y + (int)counter + 1, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x - 3, y + (int)counter + 1, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			addShoot(world, x, y + (int)counter + 1, z + 3, vines, vines2);
			addShoot(world, x, y + (int)counter + 1, z - 3, vines, vines2);
			addShoot(world, x + 3, y + (int)counter + 1, z, vines, vines2);
			addShoot(world, x - 3, y + (int)counter + 1, z, vines, vines2);
			...
			ProcedureTreeLog.executeProcedure(x + 2, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x - 2, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z + 3, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x, y + (int)counter, z - 3, world, BlockSynchysidendronLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure(x + 3, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure(x - 3, y + (int)counter, z, world, BlockSynchysidendronLog.block, EnumFacing.UP);
			addShoot(world, x, y + (int)counter - 1, z + 4, vines, vines2);
			addShoot(world, x, y + (int)counter - 1, z - 4, vines, vines2);
			addShoot(world, x + 4, y + (int)counter - 1, z, vines, vines2);
			addShoot(world, x - 4, y + (int)counter - 1, z, vines, vines2);

			ProcedureSpawnOdontopteris.executeProcedure(x, y + 2, z, world, LepidodendronConfigPlants.genOdontopterisSynchysidendron, SaplingSpawn);
			
		}
	}

	public static void addShoot(World world, int x, int y, int z, boolean vines, boolean vines2) {
		ProcedureTreeLeaf.executeProcedure(x, y + 1, z, world, BlockSynchysidendronLeaves.block);
		ProcedureTreeLeaf.executeProcedure(x, y + 2, z, world, BlockSynchysidendronLeaves.block);
		ProcedureTreeLeaf.executeProcedure(x + 1, y + 1, z, world, BlockSynchysidendronLeaves.block);
		ProcedureTreeLeaf.executeProcedure(x - 1, y + 1, z, world, BlockSynchysidendronLeaves.block);
		ProcedureTreeLeaf.executeProcedure(x, y + 1, z + 1, world, BlockSynchysidendronLeaves.block);
		ProcedureTreeLeaf.executeProcedure(x, y + 1, z - 1, world, BlockSynchysidendronLeaves.block);

		//Random vines for world-gen only:
		if ((vines) && (Math.random() > 0.95)) {
			ProcedureVines.executeProcedure(x + 1, y + 1, z, world);
		}
		if ((vines2) && (Math.random() > 0.95)) {
			ProcedureVines2.executeProcedure(x + 1, y + 1, z, world);
		}
		...
		if ((vines) && (Math.random() > 0.95)) {
			ProcedureVines.executeProcedure(x, y + 1, z + 1, world);
		}
		if ((vines2) && (Math.random() > 0.95)) {
			ProcedureVines2.executeProcedure(x, y + 1, z + 1, world);
		}
		...
		strobilus(x + 1, y, z, world);
		strobilus(x - 1, y, z, world);
		strobilus(x, y, z + 1, world);
		strobilus(x, y, z - 1, world);
	}

	public static void strobilus(int x, int y, int z, World world) {
		//Random flowers here:
		if ((Math.random() > 0.4) && (world.isAirBlock(new BlockPos(x, y, z))) && world.getBlockState(new BlockPos(x, y + 1, z)).getBlock() == BlockSynchysidendronLeaves.block) {
			Functions.setBlockStateAndCheckForDoublePlant(world, new BlockPos(x, y, z), BlockSynchysidendronStrobilus.block.getDefaultState(), 3);
			if (!world.isRemote) {
