...
public class ProcedureWorldGenBrachyphyllumStunted extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenBrachyphyllumStunted(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenBrachyphyllumStunted!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenBrachyphyllumStunted!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenBrachyphyllumStunted!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenBrachyphyllumStunted!");
			return;
		}
		...
		int TrunkHeight = 2 + (int) Math.round(Math.random() * 8);
		int counter = 0;
