...
import net.lepidodendron.block.BlockHirmeriellaLeaves;
import net.lepidodendron.block.BlockHirmeriellaLeaves1;
import net.lepidodendron.block.BlockHirmeriellaLog;
...
public class ProcedureWorldGenHirmeriella extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenHirmeriella(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenHirmeriella!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenHirmeriella!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenHirmeriella!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenHirmeriella!");
			return;
		}
		...
		int TrunkHeight = 12 + (int) Math.round(Math.random() * 12);
		int counter = 0;
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			while (counter <= TrunkHeight + 4) {
				ProcedureTreeLog.executeProcedure((int) x, (int) y + counter, (int) z, world, BlockHirmeriellaLog.block, EnumFacing.NORTH);
				//A few decorative nubs:
				if (counter > (TrunkHeight - 4)) {
					if (Math.random() > 0.35) {
						ProcedureLeavesAroundLog.executeProcedure((int) x, (int) y + counter, (int) z, world, BlockHirmeriellaLeaves.block, 1, 0.7);
						//North
						if (Math.random() > 0.45) {
							ProcedureTreeLog.executeProcedure((int) x, (int) y + counter, (int) z - 1, world, BlockHirmeriellaLog.block, EnumFacing.EAST);
							ProcedureLeavesAroundLog.executeProcedure((int) x, (int) y + counter, (int) z - 1, world, BlockHirmeriellaLeaves.block, 1, 0.9);
						}
						//South
						if (Math.random() > 0.45) {
							ProcedureTreeLog.executeProcedure((int) x, (int) y + counter, (int) z + 1, world, BlockHirmeriellaLog.block, EnumFacing.EAST);
						...
						//East
						if (Math.random() > 0.45) {
							ProcedureTreeLog.executeProcedure((int) x + 1, (int) y + counter, (int) z, world, BlockHirmeriellaLog.block, EnumFacing.UP);
							ProcedureLeavesAroundLog.executeProcedure((int) x + 1, (int) y + counter, (int) z, world, BlockHirmeriellaLeaves.block, 1, 0.9);
						}
						//West
						if (Math.random() > 0.45) {
							ProcedureTreeLog.executeProcedure((int) x - 1, (int) y + counter, (int) z, world, BlockHirmeriellaLog.block, EnumFacing.UP);
			...
			int offsetter = world.rand.nextInt(4) - 2;
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.NORTH);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.SOUTH);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.EAST);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.WEST);

			offsetter =  offsetter - world.rand.nextInt(4) - 2;
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.NORTH);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.SOUTH);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.EAST);
			executeSide(world, new BlockPos((int) x, (int) y + TrunkHeight - offsetter, (int) z), EnumFacing.WEST);
	...
	public static void executeSide(World world, BlockPos pos, EnumFacing facing) {
		...
		ProcedureTreeLog.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockHirmeriellaLog.block, axisNS);
		blockpos = getBlockPos(pos, facing, 0, 0, 2);
		ProcedureTreeLeaf.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockHirmeriellaLeaves.block);
		...
		ProcedureNonDecayingTreeLeaf.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockHirmeriellaLeaves1.block); 
	...
	public static Block getLeaves()
	{
		...
		//}
		return BlockHirmeriellaLeaves.block;
	}
