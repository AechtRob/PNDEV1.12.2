...
import net.lepidodendron.block.BlockTrochodendroidesLeaves;
...
public class ProcedureWorldGenTrochodendroides extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenTrochodendroides(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
    ...
    private static List<ProcedureWorldGenTrochodendroides.FoliageCoordinates> foliageCoords;
    ...
    static void generateLeafNodeList()
    {
        ...
        foliageCoords = Lists.<ProcedureWorldGenTrochodendroides.FoliageCoordinates>newArrayList();
        foliageCoords.add(new ProcedureWorldGenTrochodendroides.FoliageCoordinates(basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            foliageCoords.add(new ProcedureWorldGenTrochodendroides.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    {
        for (ProcedureWorldGenTrochodendroides.FoliageCoordinates procedureworldgentrochodendroides$foliagecoordinates : foliageCoords)
        {
            generateLeafNode(procedureworldgentrochodendroides$foliagecoordinates);
        }
    }
    ...
    static void generateLeafNode(BlockPos pos)
    {
        ...
        {
            //crosSection(pos.up(i), leafSize(i), BlockTrochodendroidesLeaves.block.getDefaultState().withProperty(CHECK_DECAY, Boolean.valueOf(false)));
            crosSection(pos.up(i), leafSize(i), BlockTrochodendroidesLeaves.block.getDefaultState().withProperty(CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
