...
public class ProcedureWorldGenOdontopteris extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenOdontopteris(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure(int x, int y, int z, World world) {
		...
		//	System.err.println("Failed to load dependency x for procedure WorldGenOdontopteris!");
		//	return;
		//}
		//if (dependencies.get("y") == null) {
		//	System.err.println("Failed to load dependency y for procedure WorldGenOdontopteris!");
		//	return;
		//}
		//if (dependencies.get("z") == null) {
		//	System.err.println("Failed to load dependency z for procedure WorldGenOdontopteris!");
		//	return;
		//}
		//if (dependencies.get("world") == null) {
		//	System.err.println("Failed to load dependency world for procedure WorldGenOdontopteris!");
		//	return;
		//}
		...
		if (FaceN || FaceS || FaceE || FaceW)
			...
			if (world.isAirBlock(new BlockPos((int) x, (int) y - 1, (int) z))) {
				if (FaceN) {PlaceBlock(new BlockPos((int) x, (int) y - 1, (int) z), world, BlockOdontopterisStem.block, EnumFacing.NORTH);}
				if (FaceS) {PlaceBlock(new BlockPos((int) x, (int) y - 1, (int) z), world, BlockOdontopterisStem.block, EnumFacing.SOUTH);}
				if (FaceE) {PlaceBlock(new BlockPos((int) x, (int) y - 1, (int) z), world, BlockOdontopterisStem.block, EnumFacing.EAST);}
				if (FaceW) {PlaceBlock(new BlockPos((int) x, (int) y - 1, (int) z), world, BlockOdontopterisStem.block, EnumFacing.WEST);}
			}
			
			//Trunk:
			TrunkHeight = 15 + (int) Math.round(Math.random() * 25);
			counter = 0;
					...
					if (facing == EnumFacing.NORTH) {
						if (
							...
							&& (canPlace(pos.west().up(3), world))
								...
								PlaceBlock(pos, world, BlockOdontopterisStemSE.block, facing);
								PlaceBlock(pos.west(), world, BlockOdontopterisStemNW.block, facing);

								if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.west().north().down()).getBlock() != BlockOdontopterisShoot.block)) {
									PlaceBlock(pos.west().north(), world, BlockOdontopterisShoot.block, facing);
								}
							...
							&& (canPlace(pos.west().up(3).south(), world))
								...
								PlaceBlock(pos.west().south(), world, BlockOdontopterisStemNW.block, facing);

								if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.west(2).south().down()).getBlock() != BlockOdontopterisShoot.block)) {
									PlaceBlock(pos.west(2).south(), world, BlockOdontopterisShoot.block, facing);
								}
						...
						if (facing == EnumFacing.SOUTH) {
							if (
								...
								&& (canPlace(pos.east().up(3), world))
									...
									//We can place the bend:
									PlaceBlock(pos, world, BlockOdontopterisStemSE.block, facing);
									PlaceBlock(pos.east(), world, BlockOdontopterisStemNW.block, facing);

									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.east().south().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.east().south(), world, BlockOdontopterisShoot.block, facing);
									}
								...
								&& (canPlace(pos.east().up(3).north(), world))
									...
									PlaceBlock(pos.east().north(), world, BlockOdontopterisStemNW.block, facing);

									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.east(2).north().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.east(2).north(), world, BlockOdontopterisShoot.block, facing);
									}
							...
							if (facing == EnumFacing.EAST) {
								if (
									...
									&& (canPlace(pos.south().up(3), world))
										...
										//We can place the bend:
										PlaceBlock(pos, world, BlockOdontopterisStemSE.block, facing);
										PlaceBlock(pos.south(), world, BlockOdontopterisStemNW.block, facing);
									...
									&& (canPlace(pos.south().up(3).west(), world))
										...
										//We can place the bend round the corner::
										PlaceBlock(pos, world, BlockOdontopterisStemSW.block, facing);
										//And swap to the new axis now:
										facing = EnumFacing.SOUTH;
										PlaceBlock(pos.south().west(), world, BlockOdontopterisStemNE.block, facing);

										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.south(2).west().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.south(2).west(), world, BlockOdontopterisShoot.block, facing);
										}
								...
								if (
									...
									&& (canPlace(pos.south().up(3), world))
										...
										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.west().south().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.west().south(), world, BlockOdontopterisShoot.block, facing);
										}
									...
									&& (canPlace(pos.south().up(3).east(), world))
										...
										//And swap to the new axis now:
										facing = EnumFacing.SOUTH;
										PlaceBlock(pos.south().east(), world, BlockOdontopterisStemNW.block, facing);

										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.south(2).east().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.south(2).east(), world, BlockOdontopterisShoot.block, facing);
										}
					...
					if (facing == EnumFacing.NORTH) {
						if (
							...
							&& (canPlace(pos.east().up(3), world))
								...
								//We can place the bend:									
								PlaceBlock(pos, world, BlockOdontopterisStemSW.block, facing);
								PlaceBlock(pos.east(), world, BlockOdontopterisStemNE.block, facing);

								if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.east().north().down()).getBlock() != BlockOdontopterisShoot.block)) {
									PlaceBlock(pos.east().north(), world, BlockOdontopterisShoot.block, facing);
								}
							...
							&& (canPlace(pos.east().up(3).south(), world))
								...
								//And swap to the new axis now:
								facing = EnumFacing.EAST;
								PlaceBlock(pos.east().south(), world, BlockOdontopterisStemNE.block, facing);

								if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.east(2).south().down()).getBlock() != BlockOdontopterisShoot.block)) {
									PlaceBlock(pos.east(2).south(), world, BlockOdontopterisShoot.block, facing);
								}
						...
						if (facing == EnumFacing.SOUTH) {
							if (
								...
								&& (canPlace(pos.west().up(3), world))
									...
									//We can place the bend:									
									PlaceBlock(pos, world, BlockOdontopterisStemSW.block, facing);
									PlaceBlock(pos.west(), world, BlockOdontopterisStemNE.block, facing);
								...
								&& (canPlace(pos.west().up(3).north(), world))
									...
									//And swap to the new axis now:
									facing = EnumFacing.WEST;
									PlaceBlock(pos.west().north(), world, BlockOdontopterisStemNE.block, facing);

									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.west(2).north().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.west(2).north(), world, BlockOdontopterisShoot.block, facing);
									}
							...
							if (facing == EnumFacing.EAST) {
								if (
									...
									&& (canPlace(pos.south().up(3), world))
										...
										//We can place the bend:									
										PlaceBlock(pos, world, BlockOdontopterisStemSW.block, facing);
										PlaceBlock(pos.south(), world, BlockOdontopterisStemNE.block, facing);
								...
								if (
									...
									&& (canPlace(pos.north().up(3), world))
										...
										//We can place the bend:									
										PlaceBlock(pos, world, BlockOdontopterisStemSW.block, facing);
										PlaceBlock(pos.north(), world, BlockOdontopterisStemNE.block, facing);
									...
									&& (canPlace(pos.north().up(3).east(), world))
										...
										PlaceBlock(pos.north().east(), world, BlockOdontopterisStemNE.block, facing);

										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.north(2).east().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.north(2).east(), world, BlockOdontopterisShoot.block, facing);
										}
				...
				if (facing == EnumFacing.NORTH) {
					if ((world.getBlockState(pos.south().up()).getBlockFaceShape(world, pos.south().up(), facing) == BlockFaceShape.SOLID) 
						...
						&& (canPlace(pos.up(2), world))
							...
							PlaceBlock(pos, world, BlockOdontopterisStem.block, facing);
							if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.north().down()).getBlock() != BlockOdontopterisShoot.block)) {
								PlaceBlock(pos.north(), world, BlockOdontopterisShoot.block, facing);
							}
							counter = counter + 1;
							if (counter >= TrunkHeight) {
								PlaceBlock(pos.up(), world, BlockOdontopterisShoot.block, EnumFacing.UP);
							}
							Upplaced = true;
					...
					if (facing == EnumFacing.SOUTH) {
						if ((world.getBlockState(pos.north().up()).getBlockFaceShape(world, pos.north().up(), facing) == BlockFaceShape.SOLID) 
							...
							&& (canPlace(pos.up(2), world))
								...
								PlaceBlock(pos, world, BlockOdontopterisStem.block, facing);
								if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
								&& (world.getBlockState(pos.south().down()).getBlock() != BlockOdontopterisShoot.block)) {
									PlaceBlock(pos.south(), world, BlockOdontopterisShoot.block, facing);
								}
								counter = counter + 1;
								if (counter >= TrunkHeight) {
									PlaceBlock(pos.up(), world, BlockOdontopterisShoot.block, EnumFacing.UP);
						...
						if (facing == EnumFacing.EAST) {
							if ((world.getBlockState(pos.west().up()).getBlockFaceShape(world, pos.west().up(), facing) == BlockFaceShape.SOLID) 
								...
								&& (canPlace(pos.up(2), world))
									...
									PlaceBlock(pos, world, BlockOdontopterisStem.block, facing);
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.east().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.east(), world, BlockOdontopterisShoot.block, facing);
									}
									counter = counter + 1;
									if (counter >= TrunkHeight) {
										PlaceBlock(pos.up(), world, BlockOdontopterisShoot.block, EnumFacing.UP);
							...
							if ((world.getBlockState(pos.east().up()).getBlockFaceShape(world, pos.east().up(), facing) == BlockFaceShape.SOLID) 
								...
								&& (canPlace(pos.up(2), world))
									...
									PlaceBlock(pos, world, BlockOdontopterisStem.block, facing);
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.west().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.west(), world, BlockOdontopterisShoot.block, facing);
									}
									counter = counter + 1;
									if (counter >= TrunkHeight) {
										PlaceBlock(pos.up(), world, BlockOdontopterisShoot.block, EnumFacing.UP);
						...
						if (facing == EnumFacing.NORTH) {
							if (rightSpace) {
								if (!changeRightAxis) {
									...
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.north().west().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.north().west(), world, BlockOdontopterisShoot.block, facing);
									}
									...
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.south().west(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.south().west(2), world, BlockOdontopterisShoot.block, facing);
									}
								...
								if (!changeLeftAxis) {
									...
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.north().east().down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.north().east(), world, BlockOdontopterisShoot.block, facing);
									}
									...
									if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
									&& (world.getBlockState(pos.south().east(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
										PlaceBlock(pos.south().east(2), world, BlockOdontopterisShoot.block, facing);
									}
							...
							if (facing == EnumFacing.SOUTH) {
								if (rightSpace) {
									if (!changeRightAxis) {
										...
										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.south().east().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.south().east(), world, BlockOdontopterisShoot.block, facing);
										}
										...
										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.north().east(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.north().east(2), world, BlockOdontopterisShoot.block, facing);
										}
									...
									if (!changeLeftAxis) {
										...
										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.south().west().down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.south().west(), world, BlockOdontopterisShoot.block, facing);
										}
										...
										if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
										&& (world.getBlockState(pos.north().west(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
											PlaceBlock(pos.north().west(2), world, BlockOdontopterisShoot.block, facing);
										}
								...
								if (facing == EnumFacing.EAST) {
									if (rightSpace) {
										if (!changeRightAxis) {
											//place the bend:
											PlaceBlock(pos, world, BlockOdontopterisStemSE.block, facing);
											PlaceBlock(pos.north(), world, BlockOdontopterisStemNW.block, facing);
											...
											//And swap to the new axis now:
											facing = EnumFacing.NORTH;
											PlaceBlock(pos.north().west(), world, BlockOdontopterisStemNW.block, facing);

											if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
											&& (world.getBlockState(pos.north(2).west().down()).getBlock() != BlockOdontopterisShoot.block)) {
												PlaceBlock(pos.north(2).west(), world, BlockOdontopterisShoot.block, facing);
											}
										...
										if (!changeLeftAxis) {
											...
											if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
											&& (world.getBlockState(pos.west().south(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
												PlaceBlock(pos.west().south(2), world, BlockOdontopterisShoot.block, facing);
											}
									...
									if (rightSpace) {
										if (!changeRightAxis) {
											...
											if ((Math.random() > 0.3) && (counter >= 5) && (counter < (TrunkHeight - 1))
											&& (world.getBlockState(pos.east().south(2).down()).getBlock() != BlockOdontopterisShoot.block)) {
												PlaceBlock(pos.east().south(2), world, BlockOdontopterisShoot.block, facing);
											}
