...
public class ProcedureWorldGenTsuga extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenTsuga(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenTsuga!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenTsuga!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenTsuga!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenTsuga!");
			return;
		}
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			//Trunk:
			TrunkHeight = 30 + (Math.random() * 8) + (Math.random() * 8) + (Math.random() * 8) + (Math.random() * 8);

			counter = 0;
			while (counter <= TrunkHeight) {
				ProcedureTreeLog.executeProcedure((int) x, (int) (y + counter), (int) z, world, BlockTsugaLog.block, EnumFacing.NORTH);
				counter = counter + 1;
			}
			...
			while (counter <= TrunkHeight + 2 + Math.floor(2 * randomiser)) {
				ProcedureTreeLog.executeProcedure((int) xx, (int) (y + counter), (int) zz, world, BlockTsugaLog.block, EnumFacing.NORTH);
				//Add leaves, but not always:
				if (((Math.random() > 0.2) || (counter == TrunkHeight + 1)) && (counter != TrunkHeight + 2)) {
					ProcedureTreeLeaf.executeProcedure((int) (xx), (int) (y + counter), (int) zz, world, BlockTsugaLeaves.block);
				}
				counter = counter + 1;
			}
			...
			ProcedureTreeLeaf.executeProcedure((int)xx, (int) (y + counter), (int) zz, world, BlockTsugaLeaves.block);
			if (Math.random() > 0.5) {
				ProcedureTreeLeaf.executeProcedure((int)xx, (int) (y + counter + 1), (int) zz, world, BlockTsugaLeaves.block);
			}
			...
			while (counter >= bareTrunk) {
				...
				if (BranchAxis == "east") {
					...
					while (randomiser < Math.ceil((TrunkHeight-counter)/(TrunkHeight/14))) {
						...
						ProcedureLeavesAroundLog.executeProcedure(xx, (int) yy, zz, world, BlockTsugaLeaves.block, 1, 0.6);

						if (Math.ceil((TrunkHeight-counter)/(TrunkHeight/14)) >= 5 && randomiser == 3 + siderandomiser) {
							//Do side branches here too!
							ProcedureTreeLog.executeProcedure((int) xx, (int) yy, (int) zz + 1, world, BlockTsugaLog.block, EnumFacing.EAST);
							ProcedureTreeLog.executeProcedure((int) xx, (int) yy, (int) zz + 2, world, BlockTsugaLog.block, EnumFacing.EAST);
							Object2ObjectOpenHashMap<String, Object> $_dependencies = new Object2ObjectOpenHashMap<>();
							$_dependencies.put("x", xx);
							$_dependencies.put("y", (int) yy);
							$_dependencies.put("z", zz + 2);
							$_dependencies.put("world", world);
							ProcedureWorldGenTsugaBranchSouth.executeProcedure($_dependencies);
							...
							$_dependencies.put("world", world);
							ProcedureWorldGenTsugaBranchNorth.executeProcedure($_dependencies);
						}
					...
					$_dependencies.put("world", world);
					ProcedureWorldGenTsugaBranchEast.executeProcedure($_dependencies);
				}
				...
				if (BranchAxis == "west") {
					...
					$_dependencies.put("z", zz);
					$_dependencies.put("world", world);
					ProcedureWorldGenTsugaBranchWest.executeProcedure($_dependencies);
				}
				...
				if (BranchAxis == "north") {
					...
					while (randomiser < Math.ceil((TrunkHeight-counter)/(TrunkHeight/14))) {
						...
						if (Math.ceil((TrunkHeight-counter)/(TrunkHeight/14)) >= 5 && randomiser == 3 + siderandomiser) {
							//Do side branches here too!
							ProcedureTreeLog.executeProcedure((int) xx + 1, (int) yy, (int) zz, world, BlockTsugaLog.block, EnumFacing.UP);
							ProcedureTreeLog.executeProcedure((int) xx + 2, (int) yy, (int) zz, world, BlockTsugaLog.block, EnumFacing.UP);
							Object2ObjectOpenHashMap<String, Object> $_dependencies = new Object2ObjectOpenHashMap<>();
