...
public class ProcedureWorldGenLiriodendron2 extends ElementsLepidodendronMod.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) z)), world,
				new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) z))) {
			world.setBlockState(new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) z), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		block = world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) z)).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) z)), world,
				new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) z))) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount - 1), (int) (z + 1))), world,
				new BlockPos((int) x, (int) (TopCount - 1), (int) (z + 1)))) {
			world.setBlockState(new BlockPos((int) x, (int) (TopCount - 1), (int) (z + 1)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		block = world.getBlockState(new BlockPos((int) x, (int) (TopCount - 1), (int) (z - 1))).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount - 1), (int) (z - 1))), world,
				new BlockPos((int) x, (int) (TopCount - 1), (int) (z - 1)))) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 4))), world,
			...
			world.setBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 4)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}	
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 4))))) {
			world.setBlockState(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 4)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 4), (int) (TopCount), (int) (z))), world,
			...
			world.setBlockState(new BlockPos((int) (x + 4), (int) (TopCount), (int) (z)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}	
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z))))) {
			world.setBlockState(new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
