...
public class ProcedureWorldGenLiriodendron3 extends ElementsLepidodendronMod.ModElement {
	...
	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (TopCount), (int) (z + 4))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount), (int) (z + 4)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 1), (int) (TopCount + 1), (int) (z + 4))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount + 1), (int) (z + 4)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 5))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount), (int) (z + 5)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 5))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 5)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount), (int) (z + 3))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) (TopCount), (int) (z + 3)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x - 2), (int) (TopCount + 1), (int) (z + 3))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) (TopCount + 1), (int) (z + 3)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 4), (int) (TopCount), (int) (z + 1))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 4), (int) (TopCount), (int) (z + 1)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z + 1))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 4), (int) (TopCount + 1), (int) (z + 1)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 5), (int) (TopCount), (int) z)), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 5), (int) (TopCount), (int) z), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 5), (int) (TopCount + 1), (int) z)))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 5), (int) (TopCount + 1), (int) z), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) (z - 2))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) (z - 2)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 2), (int) (z + 4))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount + 2), (int) (z + 4)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 1), (int) (TopCount + 2), (int) (z + 3))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount + 2), (int) (z + 3)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x + 4, (int) (TopCount + 2), (int) (z))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x + 4, (int) (TopCount + 2), (int) (z)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 2), (int) (z + 1))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount + 2), (int) (z + 1)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) (z + 2))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (TopCount - 1), (int) (z + 2)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		block = world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2))).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2))), world,
				new BlockPos((int) (x - 1), (int) (TopCount - 1), (int) (z + 2)))) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z + 2))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z + 2)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z - 1))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) (TopCount - 1), (int) (z - 1)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}	
		block = world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2))).getBlock();
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2))), world,
				new BlockPos((int) (x - 2), (int) (TopCount - 1), (int) (z + 2)))) {
