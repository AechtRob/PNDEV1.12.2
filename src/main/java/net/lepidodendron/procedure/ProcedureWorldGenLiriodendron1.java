...
public class ProcedureWorldGenLiriodendron1 extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenLiriodendron1(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenLiriodendron1!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenLiriodendron1!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenLiriodendron1!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenLiriodendron1!");
			return;
		}
		if (dependencies.get("TopCount") == null) {
			System.err.println("Failed to load dependency TopCount for procedure WorldGenLiriodendron1!");
			return;
		}
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 3))), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount), (int) (z + 3)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 3))))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (TopCount + 1), (int) (z + -3)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 3), (int) (TopCount), (int) z)), world,
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount), (int) z), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) z)))) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) z), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
