...
public class ProcedureWorldGenLiriodendron1 extends ElementsLepidodendronMod.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 3))), world,
			...
			world.setBlockState(new BlockPos((int) x, (int) (TopCount), (int) (z + 3)), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + 3))))) {
			world.setBlockState(new BlockPos((int) x, (int) (TopCount + 1), (int) (z + -3)), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
		...
		if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 3), (int) (TopCount), (int) z)), world,
			...
			world.setBlockState(new BlockPos((int) (x + 3), (int) (TopCount), (int) z), BlockLiriodendronLeaves.block.getDefaultState(), 3);
			}
		//Random flowers here:
		if ((Math.random() > 0.6) && (world.isAirBlock(new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) z)))) {
			world.setBlockState(new BlockPos((int) (x + 3), (int) (TopCount + 1), (int) z), BlockLiriodendronFlower.block.getDefaultState(), 3);
			if (!world.isRemote) {
