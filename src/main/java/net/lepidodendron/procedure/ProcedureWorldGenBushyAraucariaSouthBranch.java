...
public class ProcedureWorldGenBushyAraucariaSouthBranch extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenBushyAraucariaSouthBranch(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
		if (dependencies.get("TrunkHeight") == null) {
			System.err.println("Failed to load dependency TrunkHeight for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
		if (dependencies.get("smalltree") == null) {
			System.err.println("Failed to load dependency smalltree for procedure WorldGenBushyAraucariaSouthBranch!");
			return;
		}
