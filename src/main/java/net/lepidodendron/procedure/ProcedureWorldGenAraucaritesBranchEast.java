...
public class ProcedureWorldGenAraucaritesBranchEast extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenAraucaritesBranchEast(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenAraucaritesBranchEast!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenAraucaritesBranchEast!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenAraucaritesBranchEast!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenAraucaritesBranchEast!");
			return;
		}
