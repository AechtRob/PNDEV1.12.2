...
public class ProcedureWorldGenAgathisWestBranch extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenAgathisWestBranch(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenAgathisWestBranch!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenAgathisWestBranch!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenAgathisWestBranch!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenAgathisWestBranch!");
			return;
		}
		if (dependencies.get("posCrown") == null) {
			System.err.println("Failed to load dependency posBranch for procedure WorldGenAgathisWestBranch!");
			return;
		}
