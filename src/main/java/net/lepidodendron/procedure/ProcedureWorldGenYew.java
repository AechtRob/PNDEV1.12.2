...
public class ProcedureWorldGenYew extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenYew(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			//Trunk:
			yy = y;
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x + 1, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x + 2, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x - 1, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x - 2, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z + 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z + 2, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z - 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z - 2, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x + 1, (int) yy, (int) z + 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x - 1, (int) yy, (int) z + 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x + 1, (int) yy, (int) z - 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x - 1, (int) yy, (int) z - 1, world, BlockYewLog.block, EnumFacing.NORTH);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z + 3, world, BlockYewLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure((int) x, (int) yy, (int) z - 3, world, BlockYewLog.block, EnumFacing.EAST);
			ProcedureTreeLog.executeProcedure((int) x + 3, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.UP);
			ProcedureTreeLog.executeProcedure((int) x - 3, (int) yy, (int) z, world, BlockYewLog.block, EnumFacing.UP);
	...
	public static void executeBranch(World world, BlockPos pos, EnumFacing facing) {
		...
		ProcedureTreeLog.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockYewLog.block, axisUD);
		...
		ProcedureTreeLog.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockYewLog.block, axisNS);
		PlaceLeaves(world, blockpos);
		...
		ProcedureTreeLog.executeProcedure(blockpos.getX(), blockpos.getY(), blockpos.getZ(), world, BlockYewLog.block, axisEW);
