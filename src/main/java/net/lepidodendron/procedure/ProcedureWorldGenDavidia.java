...
public class ProcedureWorldGenDavidia extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenDavidia(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			while (counter <= BareTrunkHeight) {
				...
				if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + counter), (int) z)), world,
					...
					Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + counter), (int) z), BlockDavidiaLog.block.getDefaultState(), 3);
					counter = (double) (counter + 1);
					}
				}
			
			MainTrunkHeight = (double) (10) + world.rand.nextInt(8);
			counter = 1;
			while (counter <= MainTrunkHeight) {
				...
				if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight +  counter), (int) z)), world,
					...
					Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight +  counter), (int) z), BlockDavidiaLog.block.getDefaultState(), 3);
					counter = (double) (counter + 1);
					}
				}
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter), (int) z)), world,
					new BlockPos((int) x, (int) (y + BareTrunkHeight + counter), (int) z))) {
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter + 1), (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter + 1), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 1), (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 1), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 1), (int) z)).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 1), (int) z)), world,
					new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 1), (int) z))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 1), (int) (z + 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 1), (int) (z + 1)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 1), (int) (z - 1))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 1), (int) (z - 1))), world,
					new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 1), (int) (z - 1)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 2), (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 2), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 2), (int) z)).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 2), (int) z)), world,
					new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 2), (int) z))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 2), (int) (z + 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 2), (int) (z + 1)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 2), (int) (z - 1))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 2), (int) (z - 1))), world,
					new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 2), (int) (z - 1)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 4), (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 4), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 4), (int) z)).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 4), (int) z)), world,
					new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 4), (int) z))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 4), (int) (z + 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 4), (int) (z + 1)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 4), (int) (z - 1))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 4), (int) (z - 1))), world,
					new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 4), (int) (z - 1)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 6), (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (y + BareTrunkHeight + counter - 6), (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 6), (int) z)).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 6), (int) z)), world,
					new BlockPos((int) (x - 1), (int) (y + BareTrunkHeight + counter - 6), (int) z))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 6), (int) (z + 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 6), (int) (z + 1)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 6), (int) (z - 1))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 6), (int) (z - 1))), world,
					new BlockPos((int) x, (int) (y + BareTrunkHeight + counter - 6), (int) (z - 1)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) counter, (int) (z - 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) counter, (int) (z - 1)), BlockDavidiaLog.block.getDefaultState(), 3);
				try {
					IBlockState _bs = world.getBlockState(new BlockPos((int) x, (int) counter, (int) (z - 1)));
					for (IProperty<?> prop : _bs.getProperties().keySet()) {
						if (prop.getName().equals("facing")) {
							Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) counter, (int) (z - 1)),
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) counter, (int) z)), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 1), (int) counter, (int) z), BlockDavidiaLog.block.getDefaultState(), 3);
				try {
					IBlockState _bs = world.getBlockState(new BlockPos((int) (x - 1), (int) counter, (int) z));
					for (IProperty<?> prop : _bs.getProperties().keySet()) {
						if (prop.getName().equals("facing")) {
							Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 1), (int) counter, (int) z),
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 1), (int) (counter), (int) (z + 1))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) (counter), (int) (z + 1)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 1), (int) (counter), (int) (z + 1))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 1), (int) (counter), (int) (z + 1))), world,
					new BlockPos((int) (x - 1), (int) (counter), (int) (z + 1)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x + 2), (int) (counter), (int) (z))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) (counter), (int) (z)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) (x - 2), (int) (counter), (int) (z))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) (x - 2), (int) (counter), (int) (z))), world,
					new BlockPos((int) (x - 2), (int) (counter), (int) (z)))) {
			...
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (counter), (int) (z + 2))), world,
				...
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) (counter), (int) (z + 2)), BlockDavidiaLeaves.block.getDefaultState(), 3);
				}
			block = world.getBlockState(new BlockPos((int) x, (int) (counter), (int) (z - 2))).getBlock();
			if (block.canBeReplacedByLeaves(world.getBlockState(new BlockPos((int) x, (int) (counter), (int) (z - 2))), world,
					new BlockPos((int) x, (int) (counter), (int) (z - 2)))) {
			...
			while (LayerCounter <= Layer1Number) {
				...
				ProcedureWorldGenDavidia1.executeProcedure($_dependencies);
			...
			while (LayerCounter <= Layer23Number) {
				...
				$_dependencies.put("world", world);
				$_dependencies.put("TopCount", TopCount);
				ProcedureWorldGenDavidia2.executeProcedure($_dependencies);
			...
			while ((LayerCounter <= Layer23Number) && (TopCount > (y + BareTrunkHeight))) {
				...
				$_dependencies.put("world", world);
				$_dependencies.put("TopCount", TopCount);
				ProcedureWorldGenDavidia3.executeProcedure($_dependencies);
			...
			while ((LayerCounter <= Layer4Number) && (TopCount > (y + BareTrunkHeight))) {
				...
				$_dependencies.put("world", world);
				$_dependencies.put("TopCount", TopCount);
				ProcedureWorldGenDavidia4.executeProcedure($_dependencies);
			...
			//Bushiness:
			counter = (double) BareTrunkHeight;
			while (counter < BareTrunkHeight + MainTrunkHeight) {
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 1), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z + 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z - 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
				counter ++;
			}
			counter = (double) BareTrunkHeight;
			while (counter < BareTrunkHeight + MainTrunkHeight - 3) {
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z + 2), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z - 2), BlockDavidiaLeaves.block.getDefaultState(), 3);

				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) y + counter, (int) z + 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 1), (int) y + counter, (int) z + 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 1), (int) y + counter, (int) z - 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
				Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 1), (int) y + counter, (int) z - 1), BlockDavidiaLeaves.block.getDefaultState(), 3);
		...
		counter = (double) BareTrunkHeight;
		while (counter < BareTrunkHeight + MainTrunkHeight - 7) {
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 3), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 3), (int) y + counter, (int) z), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z + 3), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x), (int) y + counter, (int) z - 3), BlockDavidiaLeaves.block.getDefaultState(), 3);

			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) y + counter, (int) z + 2), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) y + counter, (int) z + 2), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x + 2), (int) y + counter, (int) z - 2), BlockDavidiaLeaves.block.getDefaultState(), 3);
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) (x - 2), (int) y + counter, (int) z - 2), BlockDavidiaLeaves.block.getDefaultState(), 3);
