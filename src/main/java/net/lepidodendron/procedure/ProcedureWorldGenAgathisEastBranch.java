...
public class ProcedureWorldGenAgathisEastBranch extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenAgathisEastBranch(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenAgathisEastBranch!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenAgathisEastBranch!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenAgathisEastBranch!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenAgathisEastBranch!");
			return;
		}
		if (dependencies.get("posCrown") == null) {
			System.err.println("Failed to load dependency posBranch for procedure WorldGenAgathisEastBranch!");
			return;
		}
