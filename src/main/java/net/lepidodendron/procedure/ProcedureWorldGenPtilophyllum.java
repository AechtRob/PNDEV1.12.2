...
public class ProcedureWorldGenPtilophyllum extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenPtilophyllum(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure ( Object2ObjectOpenHashMap <String, Object> dependencies ) {
		...
		if ((world.canSeeSky(new BlockPos((int) x, (int) y, (int) z)))
			...
			Functions.setBlockStateAndCheckForDoublePlant(world,new BlockPos((int) x, (int) y, (int) z), BlockPtilophyllumLog.block.getDefaultState(), 3);
