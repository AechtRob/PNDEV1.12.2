...
public class LepidodendronMod {
	...
	public static final int ENTITY_TITANOSUCHUS = 346;
	public static final ResourceLocation TITANOSUCHUS_LOOT = LootTableList.register(new ResourceLocation(LepidodendronMod.MODID, "entity/titanosuchus"));
	public static final ResourceLocation TITANOSUCHUS_LOOT_YOUNG = LootTableList.register(new ResourceLocation(LepidodendronMod.MODID, "entity/titanosuchus_young"));
