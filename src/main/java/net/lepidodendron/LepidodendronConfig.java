...
public class LepidodendronConfig {
    ...
    public static String[] dimTriassicMobsCanyonsPF = new String[]{"lepidodendron:prehistoric_flora_xenacanthus:2:84:3"};
