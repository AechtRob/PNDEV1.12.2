...
public class LepidodendronConfig {
    ...
    public static String[] dimDevonianMobsSpringsPF = new String[]{"lepidodendron:prehistoric_flora_eoarthropleura:2:2:1","lepidodendron:prehistoric_flora_harvestman:2:2:1","lepidodendron:prehistoric_flora_trigonotarbid_palaeocharinus:5:2:1"};
