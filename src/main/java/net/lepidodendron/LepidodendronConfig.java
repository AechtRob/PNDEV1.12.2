...
public class LepidodendronConfig {
    ...
    public static boolean babifyMobs = true;
...
//    public static boolean doSpawnsReborn = false;
    ...
    public static boolean syncConfigGeneral() {
        ...
        propOrder.add(prop.getName());
        prop = cfg.get("Global World-Gen", "babifyMobs", babifyMobs);
        prop.setComment("Clicking the enchanted bone wand on a mob reverts it to baby age [default: true]");
        babifyMobs = prop.getBoolean();
        propOrder.add(prop.getName());
