...
public class GUIOligopoolMachine extends ElementsLepidodendronMod.ModElement {
    public static int GUIID = LepidodendronMod.GUI_OLIGOPOOL_MACHINE_ID;
    public static HashMap guistate = new HashMap();
    public GUIOligopoolMachine(ElementsLepidodendronMod instance) {
        super(instance, 1);
    }
    ...
    public static class GUILepidodendronOligopoolMachine extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        public GUILepidodendronOligopoolMachine(World world, int x, int y, int z, EntityPlayer player) {
            this.world = world;
            this.entity = player;
            this.x = x;
            this.y = y;
            ...
            this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 59 - 3, 39) {
                ...
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockOligopoolMachine.TileEntityOligopoolMachine) {
                        BlockOligopoolMachine.TileEntityOligopoolMachine te = (BlockOligopoolMachine.TileEntityOligopoolMachine) ent;
    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
            super(new GUILepidodendronOligopoolMachine(world, x, y, z, entity));
            this.world = world;
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        private static final ResourceLocation texture = new ResourceLocation("lepidodendron:textures/gui/oligopool_machine_gui.png");
        @Override
