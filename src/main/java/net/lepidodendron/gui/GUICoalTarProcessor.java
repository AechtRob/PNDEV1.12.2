...
public class GUICoalTarProcessor extends ElementsLepidodendronMod.ModElement {
    public static int GUIID = LepidodendronMod.GUI_COAL_TAR_PROCESSOR_ID;
    ...
    public static class GUILepidodendronCoalTarProcessor extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        public GUILepidodendronCoalTarProcessor(World world, int x, int y, int z, EntityPlayer player) {
            this.world = world;
            this.entity = player;
            this.x = x;
            this.y = y;
    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
            super(new GUILepidodendronCoalTarProcessor(world, x, y, z, entity));
            this.world = world;
            this.x = x;
            this.y = y;
            this.z = z;
