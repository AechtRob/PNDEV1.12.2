...
import net.lepidodendron.block.BlockLabBench;
...
public class GUILabBench extends ElementsLepidodendronMod.ModElement {
    public static int GUIID = LepidodendronMod.GUI_LAB_BENCH_ID;
    public static HashMap guistate = new HashMap();
    public GUILabBench(ElementsLepidodendronMod instance) {
        super(instance, 1);
    }
    ...
    public static class GUILepidodendronLabBench extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        public GUILepidodendronLabBench(World world, int x, int y, int z, EntityPlayer player) {
            this.world = world;
            this.entity = player;
            this.x = x;
            this.y = y;
            ...
            this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 31, 23) {
                ...
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockLabBench.TileEntityLabBench) {
                        BlockLabBench.TileEntityLabBench te = (BlockLabBench.TileEntityLabBench) ent;
    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
            super(new GUILepidodendronLabBench(world, x, y, z, entity));
            this.world = world;
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        private static final ResourceLocation texture = new ResourceLocation("lepidodendron:textures/gui/lab_bench_gui.png");
        @Override
        ...
        private int getProgressBarLength() {
            ...
            if (tileEntity != null) {
                if (tileEntity instanceof BlockLabBench.TileEntityLabBench) {
                    BlockLabBench.TileEntityLabBench te = (BlockLabBench.TileEntityLabBench) tileEntity;
        ...
        protected void drawGuiContainerForegroundLayer(int par1, int par2) {
            this.fontRenderer.drawString("Laboratory Bench", 43, 7, 4210752);
