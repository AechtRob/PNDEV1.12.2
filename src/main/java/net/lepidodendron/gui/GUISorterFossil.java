...
public class GUISorterFossil extends ElementsLepidodendronMod.ModElement {
    public static int GUIID = LepidodendronMod.GUI_SORTER_FOSSIL_ID;
    public static HashMap guistate = new HashMap();
    public GUISorterFossil(ElementsLepidodendronMod instance) {
        super(instance, 1);
    }
    ...
    public static class GUILepidodendronSorterFossil extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        public GUILepidodendronSorterFossil(World world, int x, int y, int z, EntityPlayer player) {
            this.world = world;
            this.entity = player;
            this.x = x;
            this.y = y;
            ...
            this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 44, 20) {
                @Override
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockSorterFossil.TileEntitySorterFossil) {
                        BlockSorterFossil.TileEntitySorterFossil te = (BlockSorterFossil.TileEntitySorterFossil) ent;
            ...
            this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 62, 20) {
                @Override
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockSorterFossil.TileEntitySorterFossil) {
                        BlockSorterFossil.TileEntitySorterFossil te = (BlockSorterFossil.TileEntitySorterFossil) ent;
                        return te.isItemValidForSlot(1, stack);
                    }
                    return false;
                }
            ...
            this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 80, 20) {
                @Override
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockSorterFossil.TileEntitySorterFossil) {
                        BlockSorterFossil.TileEntitySorterFossil te = (BlockSorterFossil.TileEntitySorterFossil) ent;
            ...
            this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 98, 20) {
                @Override
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockSorterFossil.TileEntitySorterFossil) {
                        BlockSorterFossil.TileEntitySorterFossil te = (BlockSorterFossil.TileEntitySorterFossil) ent;
            ...
            this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 116, 20) {
                @Override
                public boolean isItemValid(ItemStack stack) {
                    if (ent instanceof BlockSorterFossil.TileEntitySorterFossil) {
                        BlockSorterFossil.TileEntitySorterFossil te = (BlockSorterFossil.TileEntitySorterFossil) ent;
                        return te.isItemValidForSlot(4, stack);
                    }
                    return false;
                }
            ...
            for (si = 0; si < 3; ++si)
                for (sj = 0; sj < 9; ++sj)
                    this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 0 + 8 + sj * 18, (0 + 84 + si * 18) - 33));
            for (si = 0; si < 9; ++si)
                this.addSlotToContainer(new Slot(player.inventory, si, 0 + 8 + si * 18, 0 + 142 - 33));
    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
            super(new GUILepidodendronSorterFossil(world, x, y, z, entity));
            this.world = world;
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        protected void drawGuiContainerForegroundLayer(int par1, int par2) {
            this.fontRenderer.drawString("Fossil Sorter", 55, 7, 4210752);
