...
public class GUIBatterySubmarine extends ElementsLepidodendronMod.ModElement {
    public static int GUIID = LepidodendronMod.GUI_BATTERY_SUBMARINE_ID;
    public static HashMap guistate = new HashMap();
    public GUIBatterySubmarine(ElementsLepidodendronMod instance) {
        super(instance, 1);
    }
    ...
    public static class GUILepidodendronBatterySubmarine extends Container implements Supplier<Map<Integer, Slot>> {
        private IInventory internal;
        private World world;
        private EntityPlayer entity;
        private int x, y, z;
        private Map<Integer, Slot> customSlots = new HashMap<>();
        public GUILepidodendronBatterySubmarine(World world, int x, int y, int z, EntityPlayer player) {
            this.world = world;
            this.entity = player;
            this.x = x;
            this.y = y;
    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public GuiWindow(World world, int x, int y, int z, EntityPlayer entity) {
            super(new GUILepidodendronBatterySubmarine(world, x, y, z, entity));
            this.world = world;
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        private static final ResourceLocation texture = new ResourceLocation("lepidodendron:textures/gui/battery_submarine_gui.png");
        @Override
        ...
        protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
            ...
            this.drawTexturedModalRect(k + 29 + (124 - this.getRFHeight()), l + 29, 0, 166, this.getRFHeight(), 33);
        ...
        protected void drawGuiContainerForegroundLayer(int par1, int par2) {
            ...
            if (!LepidodendronConfig.machinesRF) {
                this.fontRenderer.drawString("Single-Use Submarine", 35, 7, 4210752);
            }
            else {
                this.fontRenderer.drawString("Rechargeable Submarine", 27, 7, 4210752);
            }
            this.fontRenderer.drawString("Battery Pack: " + df.format((getRFHeight() / 124D) * 100) + "% charged", 15, 17, 4210752);
